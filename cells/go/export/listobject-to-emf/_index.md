---
title: Export LISTOBJECT to EMF from spreadsheet using Go  API 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Go API to export LISTOBJECT to EMF file" h2="Go library to export LISTOBJECT to EMF file" p="Use Cells Export REST API to export spreadsheet internal object workflows in Go. This is a professional solution to export LISTOBJECT to EMF format file from spreadsheet online using Go." urlsection="export/listobject-to-emf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Export LISTOBJECT object to EMF format file in Go" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Go using REST API to export LISTOBJECT to EMF format from spreadsheet" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Go API to export  LISTOBJECT to EMF" >}}
