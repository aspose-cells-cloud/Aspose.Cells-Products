---
title: Export Workbook to GIF file via Go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Workbook to GIF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for WORKBOOK to GIF Conversion" gistPath="" %}}
```go
