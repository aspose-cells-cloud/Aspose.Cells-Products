---
title: Convert TSV to XPS via Go 
...
outformat: XPS
platform: Go
otherformats: XLT HTML DIF XPS TIFF ODS XLS PDF XLTX SVG CSV TXT XLSB FODS MHTML MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XPS with Go" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to XPS Conversion" gistPath="" %}}
```go
