---
title: Convert XLS to XLT via Go 
...
outformat: XLT
platform: Go
otherformats: XLTX ODS XML MHTML TSV DIF XLSB PDF XPS XLSM SVG FODS XLTM TIFF MD CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLT with Go" h2="Read, Edit & Export Excel data to other formats like XLT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to XLT Conversion" gistPath="" %}}
```go
