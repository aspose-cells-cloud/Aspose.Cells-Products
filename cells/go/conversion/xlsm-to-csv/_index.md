---
title: Convert XLSM to CSV via Go 
...
outformat: CSV
platform: Go
otherformats: HTML SXC TIFF FODS PDF XLTM SVG MD DIF TSV XML XLSB MHTML XPS CSV XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to CSV with Go" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to CSV Conversion" gistPath="" %}}
```go
