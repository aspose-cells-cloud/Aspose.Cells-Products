...
outformat: DIF
platform: Go
otherformats: XML XLTX PDF MD XLSB XPS SVG DIF TSV SXC HTML TIFF XLSX XLTM FODS CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
