...
outformat: SXC
platform: Go
otherformats: XLTM MHTML XLSB TIFF XLSM ODS SVG CSV DIF PDF SXC XLSX MD XML TXT FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to SXC Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to SXC Conversion" gistPath="" %}}
```go
