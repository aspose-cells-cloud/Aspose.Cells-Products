---
title: Convert TXT to FODS via Go 
...
outformat: FODS
platform: Go
otherformats: XLS TIFF SVG MD TSV XML DIF FODS XLTX MHTML CSV XLSB XLSX XPS XLTM PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to FODS with Go" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to FODS Conversion" gistPath="" %}}
```go
