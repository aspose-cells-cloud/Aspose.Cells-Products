---
title: Convert XLSX to CSV via Go 
...
outformat: CSV
platform: Go
otherformats: XLSB CSV XLT SXC PDF DIF XLSM TIFF MD MHTML XLTX XPS TXT XML SVG XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to CSV with Go" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSX to CSV Conversion" gistPath="" %}}
```go
