---
title: Convert XML to XLSB via Go 
...
outformat: XLSB
platform: Go
otherformats: FODS XLT TSV TIFF DIF TXT SVG XLSM XLSX CSV PDF XLSB XPS SXC MHTML XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to XLSB Conversion" gistPath="" %}}
```go
