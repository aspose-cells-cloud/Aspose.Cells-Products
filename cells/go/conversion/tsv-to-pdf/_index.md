---
title: Convert TSV to PDF via Go 
...
outformat: PDF
platform: Go
otherformats: PDF XPS HTML XLTM TXT XLSX TIFF ODS FODS XLSM XML SXC XLSB MD DIF CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to PDF with Go" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to PDF Conversion" gistPath="" %}}
```go
