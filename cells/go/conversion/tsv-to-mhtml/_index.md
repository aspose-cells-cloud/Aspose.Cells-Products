---
title: Convert TSV to MHTML via Go 
...
outformat: MHTML
platform: Go
otherformats: SXC XLT XML CSV XLTX TXT XLSX XLSB SVG HTML ODS PDF XPS XLTM DIF XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to MHTML with Go" h2="Read, Edit & Export Excel data to other formats like MHTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to MHTML Conversion" gistPath="" %}}
```go
