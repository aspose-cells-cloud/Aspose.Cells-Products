...
outformat: DIF
platform: Go
otherformats: XLTM XLS XLSM MD XPS PDF TXT SXC XLTX SVG XLSX FODS XLSB MHTML CSV DIF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
