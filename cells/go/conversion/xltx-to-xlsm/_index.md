---
title: Convert XLTX to XLSM via Go 
...
outformat: XLSM
platform: Go
otherformats: TSV DIF ODS MHTML FODS SXC XLT XML SVG XLSB MD CSV XPS XLSM XLTM PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to XLSM Conversion" gistPath="" %}}
```go
