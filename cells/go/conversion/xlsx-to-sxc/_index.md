---
title: Convert XLSX to SXC via Go 
...
outformat: SXC
platform: Go
otherformats: DIF SXC FODS XLT PDF TIFF TXT CSV XML SVG XLS XLTM MHTML XLTX TSV XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSX to SXC Conversion" gistPath="" %}}
```go
