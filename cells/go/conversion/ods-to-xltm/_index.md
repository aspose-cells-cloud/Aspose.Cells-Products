---
title: Convert ODS to XLTM via Go 
...
outformat: XLTM
platform: Go
otherformats: XPS XLTX TIFF XLSB DIF HTML SVG MHTML XLSX CSV TSV PDF SXC MD XLTM XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLTM with Go" h2="Read, Edit & Export Excel data to other formats like XLTM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to XLTM Conversion" gistPath="" %}}
```go
