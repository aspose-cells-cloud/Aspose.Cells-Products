---
title: Convert XLTX to XPS via Go 
...
outformat: XPS
platform: Go
otherformats: SXC XLSX FODS DIF TSV CSV TIFF MHTML TXT SVG MD XLSM XLTM XML PDF XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to XPS with Go" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to XPS Conversion" gistPath="" %}}
```go
