---
title: Convert XLSX to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: XLSM HTML XML CSV SXC TSV MHTML PDF TIFF XLSB XLTM XPS XLTX DIF MD FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSX to TSV Conversion" gistPath="" %}}
```go
