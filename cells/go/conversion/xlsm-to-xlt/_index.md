---
title: Convert XLSM to XLT via Go 
...
outformat: XLT
platform: Go
otherformats: XLTM MD XLSX MHTML XPS XML TIFF TXT FODS XLSB SXC TSV SVG XLTX PDF CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLT with Go" h2="Read, Edit & Export Excel data to other formats like XLT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to XLT Conversion" gistPath="" %}}
```go
