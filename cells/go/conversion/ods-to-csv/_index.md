---
title: Convert ODS to CSV via Go 
...
outformat: CSV
platform: Go
otherformats: MHTML XLS TSV FODS PDF XPS XLTM TXT DIF TIFF CSV XLSB XLSX SXC MD XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to CSV with Go" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to CSV Conversion" gistPath="" %}}
```go
