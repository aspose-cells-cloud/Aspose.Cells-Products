---
title: Convert TSV to XLSB via Go 
...
outformat: XLSB
platform: Go
otherformats: XLSM XLTM FODS TIFF MHTML SXC XLSB SVG DIF XLTX TXT XPS MD XML CSV PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to XLSB Conversion" gistPath="" %}}
```go
