---
title: Convert TXT to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: SXC TIFF DIF XLS SVG PDF XLSX XLSM HTML XML XLSB FODS TSV XLTX XPS XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to DIF Conversion" gistPath="" %}}
```go
