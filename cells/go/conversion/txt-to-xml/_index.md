---
title: Convert TXT to XML via Go 
...
outformat: XML
platform: Go
otherformats: SVG XLTX PDF XLTM XLSM SXC XLSB MHTML DIF MD TIFF ODS CSV XPS XML TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to XML Conversion" gistPath="" %}}
```go
