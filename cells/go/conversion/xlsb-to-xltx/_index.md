---
title: Convert XLSB to XLTX via Go 
...
outformat: XLTX
platform: Go
otherformats: TXT PDF TIFF FODS MHTML DIF XLT XPS SXC MD XLSM XLSX XLTX SVG XML XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLTX with Go" h2="Read, Edit & Export Excel data to other formats like XLTX with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to XLTX Conversion" gistPath="" %}}
```go
