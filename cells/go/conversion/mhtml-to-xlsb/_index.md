...
outformat: XLSB
platform: Go
otherformats: XLTX XLSM XLSX FODS TSV MD CSV XML TXT PDF TIFF SVG DIF SXC HTML XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
