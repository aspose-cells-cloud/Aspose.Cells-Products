...
outformat: TSV
platform: Go
otherformats: XLS DIF XLSX TXT ODS PDF TSV SXC HTML XLTM XLTX XLSM XML MD FODS XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
