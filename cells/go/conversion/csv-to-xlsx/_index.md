---
title: Convert CSV to XLSX via Go 
...
outformat: XLSX
platform: Go
otherformats: ODS FODS DIF SXC XLSX XLSM HTML MHTML SVG XML XLTX TIFF PDF XLSB TSV XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XLSX with Go" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for CSV to XLSX Conversion" gistPath="" %}}
```go
