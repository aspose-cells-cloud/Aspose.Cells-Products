---
title: Convert TXT to XLSM via Go 
...
outformat: XLSM
platform: Go
otherformats: TIFF XLS XLTM HTML SXC TSV DIF XML SVG FODS XPS PDF MHTML MD XLSX XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to XLSM Conversion" gistPath="" %}}
```go
