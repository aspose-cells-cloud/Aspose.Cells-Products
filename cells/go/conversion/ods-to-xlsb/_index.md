---
title: Convert ODS to XLSB via Go 
...
outformat: XLSB
platform: Go
otherformats: XLTM XLSM XML XLTX DIF SVG TSV FODS MHTML TXT XLSB PDF XPS MD SXC CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to XLSB Conversion" gistPath="" %}}
```go
