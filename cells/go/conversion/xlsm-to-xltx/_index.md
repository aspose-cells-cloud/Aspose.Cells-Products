---
title: Convert XLSM to XLTX via Go 
...
outformat: XLTX
platform: Go
otherformats: TIFF TXT MD MHTML SVG DIF XLTX XLSB SXC XLSX PDF XLTM TSV XML FODS CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLTX with Go" h2="Read, Edit & Export Excel data to other formats like XLTX with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to XLTX Conversion" gistPath="" %}}
```go
