---
title: Convert CSV to MD via Go 
...
outformat: MD
platform: Go
otherformats: XLTM SXC ODS XLS DIF TSV XLTX XLSB XML SVG MHTML XLSX TXT TIFF PDF XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to MD with Go" h2="Read, Edit & Export Excel data to other formats like MD with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for CSV to MD Conversion" gistPath="" %}}
```go
