...
outformat: DIF
platform: Go
otherformats: DIF SVG TSV FODS MHTML XPS TIFF XML XLSB XLTX XLTM TXT SXC CSV XLSM MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to DIF Conversion in the Cloud" %}}
