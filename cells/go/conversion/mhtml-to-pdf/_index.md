---
title: Convert MHTML to PDF via Go 
...
outformat: PDF
platform: Go
otherformats: XLTX SVG DIF TSV TXT TIFF XPS XML XLSM HTML SXC XLSX XLSB CSV MD XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to PDF with Go" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for MHTML to PDF Conversion" gistPath="" %}}
```go
