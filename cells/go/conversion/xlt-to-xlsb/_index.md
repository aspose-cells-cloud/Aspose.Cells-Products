---
title: Convert XLT to XLSB via Go 
...
outformat: XLSB
platform: Go
otherformats: FODS SVG XLSX CSV TSV HTML DIF SXC XML MD TXT MHTML PDF XLTM XPS TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLT to XLSB Conversion" gistPath="" %}}
```go
