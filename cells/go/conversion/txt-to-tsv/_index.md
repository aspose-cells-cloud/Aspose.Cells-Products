---
title: Convert TXT to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: MD XLS FODS XML TIFF XPS CSV SXC SVG DIF XLTX XLSX MHTML PDF TSV XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to TSV Conversion" gistPath="" %}}
```go
