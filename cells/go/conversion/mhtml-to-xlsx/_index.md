...
outformat: XLSX
platform: Go
otherformats: XLSX HTML XLTM XLSM DIF XPS PDF XLSB XML SVG ODS XLTX TIFF FODS CSV SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XLSX with Go" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Go">}}
