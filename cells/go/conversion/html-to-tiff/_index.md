---
title: Convert HTML to TIFF via Go 
...
outformat: TIFF
platform: Go
otherformats: MD XLSB XLTX XLTM PDF XPS CSV SXC DIF SVG MHTML XLSX FODS TIFF XML TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to TIFF with Go" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for HTML to TIFF Conversion" gistPath="" %}}
```go
