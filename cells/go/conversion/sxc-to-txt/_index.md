---
title: Convert SXC to TXT via Go 
...
outformat: TXT
platform: Go
otherformats: XLSM XLSB HTML FODS XLTM XLSX XLTX TSV MD CSV SXC MHTML SVG XPS TIFF XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for SXC to TXT Conversion" gistPath="" %}}
```go
