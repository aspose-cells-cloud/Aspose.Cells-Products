---
title: Convert ODS to XPS via Go 
...
outformat: XPS
platform: Go
otherformats: DIF XML PDF TIFF XLTX TSV XLSM HTML XPS TXT CSV MHTML FODS XLSB XLSX XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XPS with Go" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to XPS Conversion" gistPath="" %}}
```go
