---
title: Convert XML to XLS via Go 
...
outformat: XLS
platform: Go
otherformats: MHTML ODS XLSB SXC PDF DIF MD TXT SVG XLSM XLSX CSV XLTM TIFF TSV FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLS with Go" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to XLS Conversion" gistPath="" %}}
```go
