---
title: Convert TSV to CSV via Go 
...
outformat: CSV
platform: Go
otherformats: XLSX XML DIF SXC XPS MD FODS SVG TIFF MHTML XLSM TXT XLT CSV PDF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to CSV with Go" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to CSV Conversion" gistPath="" %}}
```go
