---
title: Convert XLSX to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: SXC TIFF DIF SVG TSV XPS XLT MD XLTM XLSB MHTML CSV ODS FODS PDF XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSX to DIF Conversion" gistPath="" %}}
```go
