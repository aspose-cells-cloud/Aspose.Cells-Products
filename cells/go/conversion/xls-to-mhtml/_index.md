---
title: Convert XLS to MHTML via Go 
...
outformat: MHTML
platform: Go
otherformats: DIF XLTX XLSX TXT SXC XML MD XLSB PDF ODS HTML TIFF SVG CSV TSV XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to MHTML with Go" h2="Read, Edit & Export Excel data to other formats like MHTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to MHTML Conversion" gistPath="" %}}
```go
