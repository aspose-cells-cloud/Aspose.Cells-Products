---
title: Convert XLSM to TIFF via Go 
...
outformat: TIFF
platform: Go
otherformats: XLSX XLT SXC XLTX MHTML XPS TXT XLTM DIF XML CSV TSV SVG TIFF XLSB ODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to TIFF with Go" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to TIFF Conversion" gistPath="" %}}
```go
