---
title: Convert XLSX to XLSM via Go 
...
outformat: XLSM
platform: Go
otherformats: MD XLSM TIFF PDF FODS XLSB TSV XLTX TXT XLTM DIF MHTML SVG XML SXC CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSX to XLSM Conversion" gistPath="" %}}
```go
