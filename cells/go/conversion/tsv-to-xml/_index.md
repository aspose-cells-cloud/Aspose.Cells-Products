...
outformat: XML
platform: Go
otherformats: XLSB MHTML TIFF CSV TXT XLT XML XLTM FODS XLTX PDF XLSM DIF XPS XLSX SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to XML Conversion" gistPath="" %}}
```go
