---
title: Convert XLTX to ODS via Go 
...
outformat: ODS
platform: Go
otherformats: XLSM TSV MHTML XPS SVG TIFF SXC XLSX PDF DIF XLTM MD TXT XML FODS XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to ODS with Go" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to ODS Conversion" gistPath="" %}}
```go
