---
title: Convert ODS to XLSM via Go 
...
outformat: XLSM
platform: Go
otherformats: XLTM TIFF TSV DIF SXC FODS TXT XLTX XML XLSM CSV XLSX HTML XLSB MHTML SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to XLSM Conversion" gistPath="" %}}
```go
