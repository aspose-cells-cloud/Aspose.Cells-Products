---
title: Convert XLS to XLTM via Go 
...
outformat: XLTM
platform: Go
otherformats: XLSM XML MD XLTM FODS XPS MHTML SVG DIF SXC TSV XLSB XLTX XLSX CSV TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLTM with Go" h2="Read, Edit & Export Excel data to other formats like XLTM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to XLTM Conversion" gistPath="" %}}
```go
