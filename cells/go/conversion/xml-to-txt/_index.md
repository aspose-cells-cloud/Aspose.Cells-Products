---
title: Convert XML to TXT via Go 
...
outformat: TXT
platform: Go
otherformats: XLSX TXT XLSM SVG MHTML DIF TSV TIFF XLT SXC PDF XPS CSV XLTX XLSB ODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to TXT Conversion" gistPath="" %}}
```go
