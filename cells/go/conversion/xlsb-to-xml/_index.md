---
title: Convert XLSB to XML via Go 
...
outformat: XML
platform: Go
otherformats: XLTX XLS DIF HTML TIFF SXC XML MHTML XLSX FODS XLTM XLSM MD TSV XPS CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to XML Conversion" gistPath="" %}}
```go
