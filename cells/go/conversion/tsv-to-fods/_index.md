...
outformat: FODS
platform: Go
otherformats: XLTX SXC XLSB HTML DIF MHTML XLSM CSV XLTM PDF SVG FODS XPS TXT TIFF MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to FODS with Go" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to FODS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to FODS Conversion" gistPath="" %}}
```go
