---
title: Convert XML to PDF via Go 
...
outformat: PDF
platform: Go
otherformats: FODS MHTML XLTM DIF SXC XPS XLS TIFF XLTX TSV CSV PDF XLSM SVG XLSX XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to PDF with Go" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to PDF Conversion" gistPath="" %}}
```go
