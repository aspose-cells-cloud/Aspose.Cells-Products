---
title: Convert ODS to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: XLSM XLTM MHTML XLSX TIFF XLTX XLSB MD CSV SVG TXT TSV PDF SXC DIF XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to DIF Conversion" gistPath="" %}}
```go
