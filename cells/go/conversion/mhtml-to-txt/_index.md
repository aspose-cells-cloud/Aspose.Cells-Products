...
outformat: TXT
platform: Go
otherformats: XML DIF SXC XLSX PDF XLT MD XLTM TIFF CSV TXT HTML XLSM TSV XLSB FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
