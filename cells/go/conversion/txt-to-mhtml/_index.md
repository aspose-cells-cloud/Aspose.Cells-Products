---
title: Convert TXT to MHTML via Go 
...
outformat: MHTML
platform: Go
otherformats: TSV HTML CSV TIFF SVG XLSM XPS PDF MD ODS XLTM XLSB SXC XLTX XML FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to MHTML with Go" h2="Read, Edit & Export Excel data to other formats like MHTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to MHTML Conversion" gistPath="" %}}
```go
