---
title: Convert XLTM to ODS via Go 
...
outformat: ODS
platform: Go
otherformats: XLSM DIF XLSX FODS TSV SXC HTML MD TIFF TXT XML XLSB XLTX PDF MHTML SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to ODS with Go" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTM to ODS Conversion" gistPath="" %}}
```go
