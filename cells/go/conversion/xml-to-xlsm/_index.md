---
title: Convert XML to XLSM via Go 
...
outformat: XLSM
platform: Go
otherformats: XLSM DIF XLSX PDF TXT HTML XLT MHTML XLTM XPS SVG XLTX TSV MD TIFF XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to XLSM Conversion" gistPath="" %}}
```go
