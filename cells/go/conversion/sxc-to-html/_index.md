---
title: Convert SXC to HTML via Go 
...
outformat: HTML
platform: Go
otherformats: XLSX TIFF TXT PDF ODS XLTM XML MD CSV TSV XPS HTML XLSM MHTML SXC SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to HTML with Go" h2="Read, Edit & Export Excel data to other formats like HTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for SXC to HTML Conversion" gistPath="" %}}
```go
