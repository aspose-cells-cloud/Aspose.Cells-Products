---
title: Convert XLS to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: XLTM XLSM CSV TXT PDF MHTML DIF SVG MD ODS FODS XLSB SXC XML XPS XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to TSV Conversion" gistPath="" %}}
```go
