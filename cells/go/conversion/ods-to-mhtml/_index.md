---
title: Convert ODS to MHTML via Go 
...
outformat: MHTML
platform: Go
otherformats: MHTML XLTM XLSB TXT TSV PDF XML SXC XLSM TIFF XPS FODS CSV MD DIF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to MHTML with Go" h2="Read, Edit & Export Excel data to other formats like MHTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to MHTML Conversion" gistPath="" %}}
```go
