---
title: Convert XLS to XLSX via Go 
...
outformat: XLSX
platform: Go
otherformats: MHTML SVG XLTM ODS CSV TXT XLSM XPS XML PDF TIFF DIF MD SXC XLSB TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSX with Go" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to XLSX Conversion" gistPath="" %}}
```go
