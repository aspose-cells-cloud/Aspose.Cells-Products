---
title: Convert XLT to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: MHTML XML PDF ODS TSV MD XLSM DIF XLSX SVG SXC TIFF CSV XLTX TXT FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLT to DIF Conversion" gistPath="" %}}
```go
