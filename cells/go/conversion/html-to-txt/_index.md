...
outformat: TXT
platform: Go
otherformats: ODS XPS MD XLTX XML SXC XLSB TIFF DIF XLSM TSV FODS TXT XLSX XLTM MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
