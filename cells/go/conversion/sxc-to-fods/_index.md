---
title: Convert SXC to FODS via Go 
...
outformat: FODS
platform: Go
otherformats: TSV SVG PDF CSV XLTX ODS SXC TIFF XLS XPS HTML XLSM FODS MD TXT XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to FODS with Go" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for SXC to FODS Conversion" gistPath="" %}}
```go
