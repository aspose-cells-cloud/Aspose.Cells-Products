---
title: Convert XLSB to PDF via Go 
...
outformat: PDF
platform: Go
otherformats: CSV MD ODS MHTML DIF SVG PDF XLSM XLTM TXT XML TSV XPS FODS XLTX XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to PDF with Go" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to PDF Conversion" gistPath="" %}}
```go
