...
outformat: XML
platform: Go
otherformats: XLSX XLT CSV XML ODS XPS TXT PDF XLTM DIF SXC SVG TIFF XLSM FODS MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
