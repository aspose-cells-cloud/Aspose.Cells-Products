...
outformat: DIF
platform: Go
otherformats: TSV XPS XLTM DIF PDF XLTX XML SVG TIFF SXC ODS XLSM MD TXT CSV HTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
