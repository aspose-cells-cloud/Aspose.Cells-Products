...
outformat: SXC
platform: Go
otherformats: PDF HTML CSV XLT XLSM MD XLTX SXC ODS TIFF FODS DIF TXT XLTM TSV XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
