---
title: Convert ODS to XML via Go 
...
outformat: XML
platform: Go
otherformats: XLS DIF FODS CSV XLSX SVG XPS MHTML XLSM TXT TSV XLTM MD SXC PDF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to XML Conversion" gistPath="" %}}
```go
