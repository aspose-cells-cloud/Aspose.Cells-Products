---
title: Convert TXT to TIFF via Go 
...
outformat: TIFF
platform: Go
otherformats: HTML XML DIF XLS XLSM XLSB FODS MD XPS MHTML XLT XLTX CSV SVG XLTM PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to TIFF with Go" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to TIFF Conversion" gistPath="" %}}
```go
