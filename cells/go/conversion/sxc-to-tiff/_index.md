---
title: Convert SXC to TIFF via Go 
...
outformat: TIFF
platform: Go
otherformats: XLT XLSB PDF XLTX FODS HTML MD XLSX TXT XLTM MHTML CSV SXC XML SVG TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TIFF with Go" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for SXC to TIFF Conversion" gistPath="" %}}
```go
