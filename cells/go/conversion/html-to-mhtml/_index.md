---
title: Convert HTML to MHTML via Go 
...
outformat: MHTML
platform: Go
otherformats: TSV XLSM XLSX TIFF CSV PDF XLT DIF XLTM SVG TXT MHTML XML SXC XPS XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to MHTML with Go" h2="Read, Edit & Export Excel data to other formats like MHTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for HTML to MHTML Conversion" gistPath="" %}}
```go
