---
title: Convert CSV to ODS via Go 
...
outformat: ODS
platform: Go
otherformats: MHTML DIF XLS XLSX XLSM XLSB FODS XPS TSV PDF MD TXT XLTX SVG XML TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to ODS with Go" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for CSV to ODS Conversion" gistPath="" %}}
```go
