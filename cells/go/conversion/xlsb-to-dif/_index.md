...
outformat: DIF
platform: Go
otherformats: XML XLTM XLS XPS PDF XLSX HTML TXT SXC XLSM SVG MD CSV MHTML DIF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
