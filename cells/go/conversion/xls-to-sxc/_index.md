---
title: Convert XLS to SXC via Go 
...
outformat: SXC
platform: Go
otherformats: XLSB XLTM DIF TIFF MD FODS CSV HTML PDF XPS SXC SVG XLTX TXT XML XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to SXC Conversion" gistPath="" %}}
```go
