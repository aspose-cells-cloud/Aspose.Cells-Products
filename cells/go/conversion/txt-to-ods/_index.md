---
title: Convert TXT to ODS via Go 
...
outformat: ODS
platform: Go
otherformats: PDF XLT ODS XLS XLTM MHTML SXC TIFF XLSM CSV FODS XLTX DIF XLSB TSV XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to ODS with Go" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to ODS Conversion" gistPath="" %}}
```go
