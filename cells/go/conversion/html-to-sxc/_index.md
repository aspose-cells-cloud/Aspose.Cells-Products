---
title: Convert HTML to SXC via Go 
...
outformat: SXC
platform: Go
otherformats: TSV FODS XLSX TXT XLTX CSV XPS DIF XLSB XLSM SXC MHTML MD PDF TIFF XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for HTML to SXC Conversion" gistPath="" %}}
```go
