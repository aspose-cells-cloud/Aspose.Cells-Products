---
title: Convert TXT to XLSB via Go 
...
outformat: XLSB
platform: Go
otherformats: XLSB PDF DIF MHTML FODS XLT MD TSV XML XLTX XLSM XPS XLTM SXC SVG XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TXT to XLSB Conversion" gistPath="" %}}
```go
