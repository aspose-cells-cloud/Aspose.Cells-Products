---
title: Convert CSV to XML via Go 
...
outformat: XML
platform: Go
otherformats: MHTML TIFF XLTM XPS TXT ODS XLSM MD PDF DIF SXC XLTX XLSB FODS TSV XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for CSV to XML Conversion" gistPath="" %}}
```go
