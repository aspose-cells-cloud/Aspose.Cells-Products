---
title: Convert XLTM to XPS via Go 
...
outformat: XPS
platform: Go
otherformats: MHTML XLT XLTX XLSB ODS TIFF PDF XLSX FODS SXC TSV DIF XML XLSM SVG XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to XPS with Go" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTM to XPS Conversion" gistPath="" %}}
```go
