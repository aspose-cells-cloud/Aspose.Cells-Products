---
title: Convert XLTX to MHTML via Go 
...
outformat: MHTML
platform: Go
otherformats: HTML XPS XLSX TSV TXT XLSM PDF ODS TIFF XLSB FODS SVG XLT SXC CSV XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to MHTML with Go" h2="Read, Edit & Export Excel data to other formats like MHTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to MHTML Conversion" gistPath="" %}}
```go
