...
outformat: TSV
platform: Go
otherformats: XLTX XLSM XML SVG DIF TSV XLSB HTML MHTML TIFF FODS CSV PDF XPS SXC MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTM to TSV Conversion" gistPath="" %}}
```go
