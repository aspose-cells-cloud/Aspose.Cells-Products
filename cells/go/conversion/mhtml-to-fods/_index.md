---
title: Convert MHTML to FODS via Go 
...
outformat: FODS
platform: Go
otherformats: SVG TXT DIF MD FODS CSV XLSX XML HTML XLTX XPS SXC XLSM XLSB PDF TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to FODS with Go" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for MHTML to FODS Conversion" gistPath="" %}}
```go
