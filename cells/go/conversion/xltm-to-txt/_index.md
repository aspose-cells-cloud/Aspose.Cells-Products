---
title: Convert XLTM to TXT via Go 
...
outformat: TXT
platform: Go
otherformats: XLSX HTML DIF SVG FODS PDF TIFF TXT XLT SXC XPS XLSB MD MHTML XML XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTM to TXT Conversion" gistPath="" %}}
```go
