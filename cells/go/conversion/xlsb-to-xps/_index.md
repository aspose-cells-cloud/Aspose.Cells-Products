...
outformat: XPS
platform: Go
otherformats: XLTX TIFF XLS TSV XLTM DIF HTML XPS FODS PDF XML MD SXC XLSX XLSM CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XPS with Go" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Go">}}
