---
title: Convert XLSB to TXT via Go 
...
outformat: TXT
platform: Go
otherformats: DIF HTML SVG MHTML FODS TSV XLSX XLSM XML TIFF XLTX XLTM PDF SXC TXT CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to TXT Conversion" gistPath="" %}}
```go
