---
title: Convert XML to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: PDF XLSM XLT DIF MD CSV ODS XLSB TSV SXC XPS FODS TIFF XLTX SVG XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to TSV Conversion" gistPath="" %}}
```go
