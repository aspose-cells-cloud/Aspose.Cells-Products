---
title: Convert CSV to XLS via Go 
...
outformat: XLS
platform: Go
otherformats: PDF TSV MD ODS MHTML XLSM DIF FODS XLT XLTM XPS XLTX TXT XLSX XLSB XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XLS with Go" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for CSV to XLS Conversion" gistPath="" %}}
```go
