---
title: Convert TSV to XLS via Go 
...
outformat: XLS
platform: Go
otherformats: XLSB XPS DIF TIFF TXT XLSM ODS XLTX MD CSV SXC HTML XLTM MHTML SVG PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XLS with Go" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for TSV to XLS Conversion" gistPath="" %}}
```go
