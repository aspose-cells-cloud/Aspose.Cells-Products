---
title: Convert XLTM to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: SXC HTML TXT XPS MHTML XLTX PDF TSV TIFF XLSX ODS DIF CSV XLSB SVG XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTM to DIF Conversion" gistPath="" %}}
```go
