---
title: Convert XML to CSV via Go 
...
outformat: CSV
platform: Go
otherformats: XLTM XLS DIF ODS SVG XPS PDF FODS XLSB HTML MD TSV XLSX TIFF XLSM MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to CSV with Go" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to CSV Conversion" gistPath="" %}}
```go
