---
title: Convert XLSB to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: XML TXT CSV PDF XLSM TIFF MHTML SVG FODS XPS XLT DIF MD XLTM XLTX TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to TSV Conversion" gistPath="" %}}
```go
