---
title: Convert XLSB to XLTM via Go 
...
outformat: XLTM
platform: Go
otherformats: XLTM ODS TIFF FODS TXT XLSM PDF XLSX XML CSV DIF SXC MD HTML TSV MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLTM with Go" h2="Read, Edit & Export Excel data to other formats like XLTM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to XLTM Conversion" gistPath="" %}}
```go
