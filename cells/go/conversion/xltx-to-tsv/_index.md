---
title: Convert XLTX to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: TSV XLS PDF MD SXC DIF ODS MHTML SVG XLSB TXT XLT XLTM XLSX CSV XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to TSV Conversion" gistPath="" %}}
```go
