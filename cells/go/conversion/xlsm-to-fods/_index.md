---
title: Convert XLSM to FODS via Go 
...
outformat: FODS
platform: Go
otherformats: DIF ODS HTML TIFF MD XML SXC XLTM XPS XLS PDF FODS MHTML SVG XLTX TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to FODS with Go" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to FODS Conversion" gistPath="" %}}
```go
