---
title: Convert HTML to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: XLSX XPS DIF CSV MHTML XLSM PDF TXT TIFF ODS XML XLTM SVG XLSB TSV MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for HTML to DIF Conversion" gistPath="" %}}
```go
