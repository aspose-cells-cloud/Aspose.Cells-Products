---
title: Convert XLS to XLTX via Go 
...
outformat: XLTX
platform: Go
otherformats: XML FODS MD CSV XPS PDF XLTX XLSM SVG SXC DIF TIFF TSV HTML TXT XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLTX with Go" h2="Read, Edit & Export Excel data to other formats like XLTX with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to XLTX Conversion" gistPath="" %}}
```go
