---
title: Convert XLSX to ODS via Go 
...
outformat: ODS
platform: Go
otherformats: XLTM XPS DIF XLS HTML XLTX XLSM FODS PDF TIFF XLSB TXT SVG MHTML TSV MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to ODS with Go" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSX to ODS Conversion" gistPath="" %}}
```go
