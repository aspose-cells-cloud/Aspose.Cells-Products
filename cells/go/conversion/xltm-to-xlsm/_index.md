---
title: Convert XLTM to XLSM via Go 
...
outformat: XLSM
platform: Go
otherformats: SVG ODS XLSB XML PDF DIF XLTX XLSX MHTML TIFF XPS FODS SXC TXT MD CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTM to XLSM Conversion" gistPath="" %}}
```go
