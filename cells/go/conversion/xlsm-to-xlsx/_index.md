---
title: Convert XLSM to XLSX via Go 
...
outformat: XLSX
platform: Go
otherformats: ODS MD XLTX PDF XLSB TIFF TXT XML XPS SVG XLTM SXC XLSX DIF FODS CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLSX with Go" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to XLSX Conversion" gistPath="" %}}
```go
