---
title: Convert ODS to SXC via Go 
...
outformat: SXC
platform: Go
otherformats: XLS XLTM DIF TSV CSV XLSX SXC XLTX TIFF XML PDF MD FODS TXT XLSM XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for ODS to SXC Conversion" gistPath="" %}}
```go
