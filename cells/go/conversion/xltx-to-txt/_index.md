...
outformat: TXT
platform: Go
otherformats: TIFF PDF XLT MD DIF XLS HTML XLTM SXC XPS SVG TSV ODS XLSM TXT XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to TXT with Go" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Go">}}
