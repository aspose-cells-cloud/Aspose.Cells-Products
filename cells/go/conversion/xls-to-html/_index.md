---
title: Convert XLS to HTML via Go 
...
outformat: HTML
platform: Go
otherformats: XLSX XLTX SXC FODS XPS CSV XLSB TXT SVG XLSM MD MHTML TIFF TSV DIF XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to HTML with Go" h2="Read, Edit & Export Excel data to other formats like HTML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to HTML Conversion" gistPath="" %}}
```go
