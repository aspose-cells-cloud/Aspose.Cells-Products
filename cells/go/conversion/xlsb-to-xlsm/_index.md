...
outformat: XLSM
platform: Go
otherformats: MHTML CSV XLT XLSM XPS FODS XML SVG TXT PDF XLSX TIFF XLTX DIF MD SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLSM with Go" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Go">}}
