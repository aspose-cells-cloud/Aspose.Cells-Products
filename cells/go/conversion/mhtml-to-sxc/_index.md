---
title: Convert MHTML to SXC via Go 
...
outformat: SXC
platform: Go
otherformats: SXC CSV FODS XLSB HTML TIFF XPS TXT MD DIF XLSM XLTX TSV XLTM XML PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for MHTML to SXC Conversion" gistPath="" %}}
```go
