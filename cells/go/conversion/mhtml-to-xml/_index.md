---
title: Convert MHTML to XML via Go 
...
outformat: XML
platform: Go
otherformats: XPS XLSM SVG TSV DIF PDF CSV SXC TIFF XLTM XML XLTX ODS HTML XLSX FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XML with Go" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for MHTML to XML Conversion" gistPath="" %}}
```go
