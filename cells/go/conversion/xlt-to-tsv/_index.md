---
title: Convert XLT to TSV via Go 
...
outformat: TSV
platform: Go
otherformats: SXC DIF XLSB PDF TSV TXT XLSX ODS HTML XLTM XML MD FODS CSV XPS XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to TSV with Go" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLT to TSV Conversion" gistPath="" %}}
```go
