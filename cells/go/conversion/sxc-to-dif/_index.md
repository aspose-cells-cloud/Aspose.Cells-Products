---
title: Convert SXC to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: XLT HTML XLSM FODS XML XLSB TSV TIFF MHTML SXC CSV MD PDF XLSX XPS SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for SXC to DIF Conversion" gistPath="" %}}
```go
