---
title: Convert XLTX to DIF via Go 
...
outformat: DIF
platform: Go
otherformats: MHTML XLSX SVG XLT XPS MD XLSM DIF XLSB TIFF ODS FODS XML TXT SXC TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to DIF with Go" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTX to DIF Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to DIF Conversion" gistPath="" %}}
```go
