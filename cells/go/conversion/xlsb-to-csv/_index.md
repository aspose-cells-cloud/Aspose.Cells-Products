...
outformat: CSV
platform: Go
otherformats: ODS TIFF XLSM SVG TSV HTML XPS MHTML PDF TXT MD XLTX CSV DIF SXC XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to CSV with Go" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Go">}}
