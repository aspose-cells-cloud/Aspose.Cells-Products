---
title: Convert XML to TIFF via Go 
...
outformat: TIFF
platform: Go
otherformats: XPS XLTX PDF HTML XLS XLSM MHTML XLSB SVG TSV XLSX DIF TIFF MD ODS TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to TIFF with Go" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XML to TIFF Conversion" gistPath="" %}}
```go
