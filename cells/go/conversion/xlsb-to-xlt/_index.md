---
title: Convert XLSB to XLT via Go 
...
outformat: XLT
platform: Go
otherformats: SXC XLT XLTX MHTML TXT XLSX SVG XLTM DIF CSV TSV XLSM TIFF ODS MD PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLT with Go" h2="Read, Edit & Export Excel data to other formats like XLT with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSB to XLT Conversion" gistPath="" %}}
```go
