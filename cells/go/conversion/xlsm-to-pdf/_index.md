---
title: Convert XLSM to PDF via Go 
...
outformat: PDF
platform: Go
otherformats: XLT XLTM SVG XLSX XPS XLTX TIFF MD DIF HTML CSV TXT XML SXC MHTML TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to PDF with Go" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLSM to PDF Conversion" gistPath="" %}}
```go
