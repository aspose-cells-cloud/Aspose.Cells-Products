---
title: Convert XLTX to SXC via Go 
...
outformat: SXC
platform: Go
otherformats: XML CSV XLTM HTML PDF DIF XLSM XLSX TSV XPS MHTML SXC SVG ODS XLSB FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to SXC with Go" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLTX to SXC Conversion" gistPath="" %}}
```go
