...
outformat: XLSB
platform: Go
otherformats: TIFF HTML MHTML XLSB XPS XLSX TSV ODS XLT XLSM PDF XLTX CSV SVG XLTM MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSB with Go" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Go">}}
...
{{% blocks/products/pf/agp/code-autogen title="Go Code for XLS to XLSB Conversion" gistPath="" %}}
```go
