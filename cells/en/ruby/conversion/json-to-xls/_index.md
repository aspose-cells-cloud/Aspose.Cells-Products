---
title: Ruby - Convert JSON to Excel (XLS) with Aspose.Cells Cloud API
description: Convert JSON to Excel (XLS) in Ruby with Aspose.Cells Cloud API. Grab free API quota, explore ready‑to‑run sample code, and start converting now!
