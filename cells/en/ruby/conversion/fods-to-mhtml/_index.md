...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to MHTML with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to MHTML Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for FODS to MHTML Conversion" gistPath="" %}}
```ruby
