...
{{< blocks/products/cells/cells-cloud-banner h1="Export SHAPE to EMF from Excel" h2="Ruby library for exporting SHAPE to EMF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export SHAPE to EMF format file from spreadsheet online using Ruby." urlsection="export/shape-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export SHAPE object to EMF format file using Cells Cloud SDK for Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Ruby using REST API to export SHAPE to EMF format from spreadsheet" gistPath="" %}}
