---
title: Export PICTURE to PNG from Excel using Cells Cloud SDK for Ruby  
...
{{< blocks/products/cells/cells-cloud-banner h1="Export PICTURE to PNG from Excel" h2="Ruby library for exporting PICTURE to PNG file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export PICTURE to PNG format file from spreadsheet online using Ruby." urlsection="export/picture-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export PICTURE object to PNG format file using Cells Cloud SDK for Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Ruby using REST API to export PICTURE to PNG format from spreadsheet" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Ruby to export objects from Excel PICTURE to PNG" >}}
