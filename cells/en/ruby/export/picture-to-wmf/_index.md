...
{{< blocks/products/cells/cells-cloud-banner h1="Export PICTURE to WMF from Excel" h2="Ruby library for exporting PICTURE to WMF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export PICTURE to WMF format file from spreadsheet online using Ruby." urlsection="export/picture-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export PICTURE object to WMF format file using Cells Cloud SDK for Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Ruby using REST API to export PICTURE to WMF format from spreadsheet" gistPath="" %}}
