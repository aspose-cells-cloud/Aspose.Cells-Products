...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Export PICTURE to JPG from Excel" h2="Ruby library for exporting PICTURE to JPG file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export PICTURE to JPG format file from spreadsheet online using Ruby." urlsection="export/picture-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Export PICTURE object to JPG format file using Cells Cloud SDK for Ruby" >}}
