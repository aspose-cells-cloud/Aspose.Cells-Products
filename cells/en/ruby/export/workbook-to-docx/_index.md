...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Export WORKBOOK to DOCX from Excel" h2="Ruby library for exporting WORKBOOK to DOCX file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export WORKBOOK to DOCX format file from spreadsheet online using Ruby." urlsection="export/workbook-to-docx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Export WORKBOOK object to DOCX format file using Cells Cloud SDK for Ruby" >}}
