...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKSHEET to WMF from Excel" h2="Ruby library for exporting WORKSHEET to WMF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export WORKSHEET to WMF format file from spreadsheet online using Ruby." urlsection="export/worksheet-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKSHEET object to WMF format file using Cells Cloud SDK for Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Ruby using REST API to export WORKSHEET to WMF format from spreadsheet" gistPath="" %}}
