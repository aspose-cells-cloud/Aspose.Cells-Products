---
title: Export Excel objects using Ruby 
...
{{< blocks/products/cells/cells-cloud-card-row title="Export Excel objects using Ruby Extension links" >}}
