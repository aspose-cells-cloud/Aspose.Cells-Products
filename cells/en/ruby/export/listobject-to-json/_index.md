...
{{< blocks/products/cells/cells-cloud-banner h1="Export LISTOBJECT to JSON from Excel" h2="Ruby library for exporting LISTOBJECT to JSON file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Ruby. This is a professional solution to export LISTOBJECT to JSON format file from spreadsheet online using Ruby." urlsection="export/listobject-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export LISTOBJECT object to JSON format file using Cells Cloud SDK for Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Ruby using REST API to export LISTOBJECT to JSON format from spreadsheet" gistPath="" %}}
