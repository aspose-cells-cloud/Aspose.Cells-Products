---
title: Converts a table of spreadsheet on a local drive to the json file.
...
```cs
    ...
    cellsApi.ConvertTableToHtml(new ConvertTableToHtmlRequest{ Spreadsheet = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1",tableName="table1"}, "result.json");
```
