---
title: Export WORKBOOK to XPS from Excel using Cells Cloud SDK for C#  
...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to XPS from Excel" h2="C# library for exporting WORKBOOK to XPS file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Net. This is a professional solution to export WORKBOOK to XPS format file from spreadsheet online using C#." urlsection="export/workbook-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to XPS format file using Cells Cloud SDK for C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in C# using REST API to export WORKBOOK to XPS format from spreadsheet" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Net to export objects from Excel WORKBOOK to XPS" >}}
