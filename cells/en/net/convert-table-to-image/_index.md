...
```cs
    ...
    cellsApi.ConvertWorksheetToImage(new ConvertWorksheetToImageRequest{ Spreadsheet = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1",tableName="table1",format="png"}, "result.png");
```
