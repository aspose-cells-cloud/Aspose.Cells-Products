...
{{< blocks/products/cells/cells-cloud-banner h1="Save XLSX as DIF" h2="C# library for saving XLSX as DIF" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Net. This is a professional solution to save XLSX as DIF and other document formats online using C#." urlsection="saveas/xlsx-to-dif/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Save a XLSX file as DIF in C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Code Example for saving XLSX as DIF using REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to save XLSX as DIF using the Cells Cloud Net library." >}}
