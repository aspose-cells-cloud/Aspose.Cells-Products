...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save TXT as ODS" h2="C# library for saving TXT as ODS" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Net. This is a professional solution to save TXT as ODS and other document formats online using C#." urlsection="saveas/txt-to-ods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Code Example for saving TXT as ODS using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Net to save Excel files as other formats TXT as ODS" >}}
