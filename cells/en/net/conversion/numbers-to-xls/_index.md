---
title: Convert Numbers to XLS with Aspose.Cells Cloud C# SDK
description: Use Aspose.Cells Cloud C# SDK to quickly convert Numbers files to XLS via REST API. Get free API quota, see code samples and start converting in minutes.
...
```cs
    ...
    cellsApi.ConvertSpreadsheet(new ConvertSpreadsheetRequest { Spreadsheet = "EmployeeSalesSummary.numbers", format = "xls" }, "EmployeeSalesSummary.xls");
```
