---
title: Aspose.Cells Cloud - Convert HTML to SVG with C# API
description: Learn how to quickly convert HTML files to SVG graphics using Aspose.Cells Cloud SDK for C#. Follow step‑by‑step code samples, get free API quota, and start converting today.
...
```cs
    ...
    cellsApi.ConvertSpreadsheet(new ConvertSpreadsheetRequest { Spreadsheet = "EmployeeSalesSummary.html", format = "svg" }, "EmployeeSalesSummary.svg");
```
