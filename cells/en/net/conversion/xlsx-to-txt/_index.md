---
title: Convert XLSX to TXT with Aspose.Cells Cloud .NET API
description: Learn how to convert an XLSX file to TXT using Aspose.Cells Cloud .NET SDK. Follow simple C# code examples, get free API quota, and start converting today!
...
```cs
    ...
    cellsApi.ConvertSpreadsheet(new ConvertSpreadsheetRequest { Spreadsheet = "EmployeeSalesSummary.xlsx", format = "txt" }, "EmployeeSalesSummary.txt");
```
 
{{% /blocks/products/cells/cells-cloud-noreplacecode  %}}
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to convert XLSX to TXT using the Cells Cloud Net library." >}}
