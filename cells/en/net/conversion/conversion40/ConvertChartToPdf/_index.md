...
```cs
    ...
    cellsApi.ConvertChartToImage(new ConvertChartToImageRequest{ Spreadsheet = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1",chartIndex = 0 }, "result.pdf");
```
