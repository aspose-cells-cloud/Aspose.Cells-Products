...
kwords: aspose cells
url: /net/export-spreadsheet-as-format/
---
...
```cs
    ...
    cellsApi.ExportSpreadsheetAsFormat(new ExportSpreadsheetAsFormatRequest{ name = "EmployeeSalesSummary.xlsx", format = "pdf" }, "result.pdf");
```
