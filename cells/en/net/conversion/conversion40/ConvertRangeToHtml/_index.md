...
```cs
    ...
    cellsApi.ConvertRangeToHtml(new ConvertRangeToHtmlRequest{ Spreadsheet = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1",range="A1:C10"}, "result.html");
```
