...
```cs
    ...
    cellsApi.ConvertTableToHtml(new ConvertTableToHtmlRequest{ Spreadsheet = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1",tableName="table1"}, "result.html");
```
