...
kwords: aspose cells
url: /net/export-worksheet-as-format/
---
...
```cs
    ...
    cellsApi.ExportWorksheetAsFormat(new ExportWorksheetAsFormatRequest{ name = "EmployeeSalesSummary.xlsx",worksheet =Sheet1, format = "pdf" }, "result.pdf");
```
