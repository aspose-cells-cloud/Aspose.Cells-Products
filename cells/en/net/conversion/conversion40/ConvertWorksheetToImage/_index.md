...
```cs
    ...
    cellsApi.ConvertWorksheetToImage(new ConvertWorksheetToImageRequest{ Spreadsheets  = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1", format = "png" }, "result.png");
```
