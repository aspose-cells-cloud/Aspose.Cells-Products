...
kwords: aspose cells
url: /net/convert-worksheet-to-pdf/
---
...
```cs
    ...
    cellsApi.ConvertWorksheetToImage(new ConvertWorksheetToImageRequest{ Spreadsheet = "EmployeeSalesSummary.xlsx",worksheet ="Sheet1"}, "result.pdf");
```
