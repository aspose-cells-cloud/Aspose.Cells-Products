---
title: TXT to DOCX Convert API for C# 
description: Using Aspose.Cells Cloud SDK for C# to convert TXT format file to DOCX format file. 
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in C# using REST API to convert TXT to DOCX format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use C# API to convert  TXT to DOCX" >}}
