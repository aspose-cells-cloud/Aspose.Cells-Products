---
title: Aspose.Cells Cloud - Convert XLT to XLSX with C# REST API
description: Learn how to quickly convert XLT to XLSX using Aspose.Cells Cloud SDK for C#. Follow step‑by‑step code, get free API quota, and start converting today!
...
```cs
    ...
    cellsApi.ConvertSpreadsheet(new ConvertSpreadsheetRequest { Spreadsheet = "EmployeeSalesSummary.xlt", format = "xlsx" }, "EmployeeSalesSummary.xlsx");
```
