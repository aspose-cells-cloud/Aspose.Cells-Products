---
title: Convert XLS to TXT with Aspose.Cells Cloud API for C#
description: Use Aspose.Cells Cloud SDK for .NET to instantly convert XLS files to TXT. Get code samples, free API quota, and step‑by‑step guide—start converting now!
...
```cs
    ...
    cellsApi.ConvertSpreadsheet(new ConvertSpreadsheetRequest { Spreadsheet = "EmployeeSalesSummary.xls", format = "txt" }, "EmployeeSalesSummary.txt");
```
