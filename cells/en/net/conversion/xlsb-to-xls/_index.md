---
title: XLSB to XLS Convert API for C# 
description: Using Aspose.Cells Cloud SDK for C# to convert XLSB format file to XLS format file. 
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in C# using REST API to convert XLSB to XLS format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use C# API to convert  XLSB to XLS" >}}
