...
description: Using Aspose.Cells Cloud SDK for C# to convert TXT format file to XLS format file. 
...
{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Convert a TXT file to XLS in C#" >}}
