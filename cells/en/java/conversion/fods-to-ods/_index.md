...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to ODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple FODS to ODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert FODS to ODS" gistPath="" %}}
```java
