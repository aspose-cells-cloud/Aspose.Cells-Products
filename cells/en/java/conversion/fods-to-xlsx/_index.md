---
title: Convert FODS to XLSX in the Cloud via Java 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to XLSX with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple FODS to XLSX Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert FODS to XLSX" gistPath="" %}}
```java
