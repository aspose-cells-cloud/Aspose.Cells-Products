---
title: Save SXC as TSV API for Java 
description: Using Aspose.Cells Cloud SDK for Java to save SXC format file as TSV format file. 
url: /java/saveas/sxc-to-tsv/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save SXC as TSV" h2="Java library to save SXC as TSV" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save SXC as TSV and other document formats online using Java." urlsection="saveas/sxc-to-tsv/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save SXC as TSV format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Java API to save  SXC as TSV" >}}
