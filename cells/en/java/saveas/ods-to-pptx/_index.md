---
title: Save ODS as PPTX API for Java 
description: Using Aspose.Cells Cloud SDK for Java to save ODS format file as PPTX format file. 
url: /java/saveas/ods-to-pptx/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save ODS as PPTX" h2="Java library to save ODS as PPTX" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save ODS as PPTX and other document formats online using Java." urlsection="saveas/ods-to-pptx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save ODS as PPTX format" gistPath="" %}}
