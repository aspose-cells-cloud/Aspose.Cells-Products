---
title: Save HTML as ODS API for Java 
description: Using Aspose.Cells Cloud SDK for Java to save HTML format file as ODS format file. 
url: /java/saveas/html-to-ods/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save HTML as ODS" h2="Java library to save HTML as ODS" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save HTML as ODS and other document formats online using Java." urlsection="saveas/html-to-ods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save HTML as ODS format" gistPath="" %}}
