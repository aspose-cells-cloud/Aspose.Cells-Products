...
{{< blocks/products/cells/cells-cloud-banner h1="Save XLSB as TXT" h2="Java library for saving XLSB as TXT" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Java. This is a professional solution to save XLSB as TXT and other document formats online using Java." urlsection="saveas/xlsb-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Save a XLSB file as TXT in Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Code Example for saving XLSB as TXT using REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="Learn how to save XLSB as TXT using the Cells Cloud Java library." >}}
