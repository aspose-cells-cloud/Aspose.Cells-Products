...
{{< blocks/products/cells/cells-cloud-banner h1="Save XLTX as XLT" h2="Java library for saving XLTX as XLT" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Java. This is a professional solution to save XLTX as XLT and other document formats online using Java." urlsection="saveas/xltx-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Save a XLTX file as XLT in Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Code Example for saving XLTX as XLT using REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="Learn how to save XLTX as XLT using the Cells Cloud Java library." >}}
