...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save JSON as FODS" h2="Java library for saving JSON as FODS" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Java. This is a professional solution to save JSON as FODS and other document formats online using Java." urlsection="saveas/json-to-fods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java Code Example for saving JSON as FODS using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Java to save Excel files as other formats JSON as FODS" >}}
