...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save XLTX as XLSM" h2="Java library for saving XLTX as XLSM" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Java. This is a professional solution to save XLTX as XLSM and other document formats online using Java." urlsection="saveas/xltx-to-xlsm/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java Code Example for saving XLTX as XLSM using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Java to save Excel files as other formats XLTX as XLSM" >}}
