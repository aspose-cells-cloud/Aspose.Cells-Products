---
title: Save XLS as FODS API for Java 
description: Using Aspose.Cells Cloud SDK for Java to save XLS format file as FODS format file. 
url: /java/saveas/xls-to-fods/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save XLS as FODS" h2="Java library to save XLS as FODS" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save XLS as FODS and other document formats online using Java." urlsection="saveas/xls-to-fods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save XLS as FODS format" gistPath="" %}}
