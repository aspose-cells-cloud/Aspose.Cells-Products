...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save TXT as WMF" h2="Java library for saving TXT as WMF" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Java. This is a professional solution to save TXT as WMF and other document formats online using Java." urlsection="saveas/txt-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a TXT file as WMF in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java Code Example for saving TXT as WMF using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Java to save Excel files as other formats TXT as WMF" >}}
