---
title: Save TXT as WMF API for Java 
description: Using Aspose.Cells Cloud SDK for Java to save TXT format file as WMF format file. 
url: /java/saveas/txt-to-wmf/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save TXT as WMF" h2="Java library to save TXT as WMF" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save TXT as WMF and other document formats online using Java." urlsection="saveas/txt-to-wmf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save TXT as WMF format" gistPath="" %}}
