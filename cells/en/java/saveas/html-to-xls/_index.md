...
{{< blocks/products/cells/cells-cloud-section  title="Save a HTML file as XLS in Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Code Example for saving HTML as XLS using REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="Learn how to save HTML as XLS using the Cells Cloud Java library." >}}
