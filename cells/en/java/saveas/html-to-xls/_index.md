---
title: Save HTML as XLS API for Java 
description: Using Aspose.Cells Cloud SDK for Java to save HTML format file as XLS format file. 
url: /java/saveas/html-to-xls/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save HTML as XLS" h2="Java library to save HTML as XLS" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save HTML as XLS and other document formats online using Java." urlsection="saveas/html-to-xls/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save HTML as XLS format" gistPath="" %}}
