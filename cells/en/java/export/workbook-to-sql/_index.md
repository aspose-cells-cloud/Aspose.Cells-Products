---
title: Aspose.Cells Cloud Java API - Export Excel Workbook to SQL
description: Export Excel workbook to SQL with Aspose.Cells Cloud Java SDK. One API call creates SQL scripts or inserts data for any major database. Get free trial and ready‑to‑run code samples now!
...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to SQL from Excel" h2="Java library for exporting WORKBOOK to SQL file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Java. This is a professional solution to export WORKBOOK to SQL format file from spreadsheet online using Java." urlsection="export/workbook-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to SQL format file using Cells Cloud SDK for Java" >}}
{{% blocks/products/cells/cells-cloud-api-reference  apiurl=https://api.aspose.cloud/v3.0/cells/export  apireferenceurl=https://apireference.aspose.cloud/cells/#/LightCells/PostExport  apimethod=POST %}}
<br/>
Export WORKBOOK object to SQL file from Excel file is a complex task. Export WORKBOOK to SQL format transitions is performed by our Java SDK while maintaining the source WORKBOOK spreadsheet's main structural and logical content. Our Java library is a professional solution to export WORKBOOK objects to SQL format files online. This Cloud SDK gives Java developers powerful functionality and perfect SQL output.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Java using REST API to export WORKBOOK to SQL format from spreadsheet" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Java to export objects from Excel WORKBOOK to SQL" >}}
