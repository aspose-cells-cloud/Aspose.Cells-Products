...
{{< blocks/products/cells/cells-cloud-banner h1="Export SHAPE to TIFF from Excel" h2="Perl library for exporting SHAPE to TIFF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Perl. This is a professional solution to export SHAPE to TIFF format file from spreadsheet online using Perl." urlsection="export/shape-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export SHAPE object to TIFF format file using Cells Cloud SDK for Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Perl using REST API to export SHAPE to TIFF format from spreadsheet" gistPath="" %}}
