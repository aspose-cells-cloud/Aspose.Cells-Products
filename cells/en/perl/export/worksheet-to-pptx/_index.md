...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKSHEET to PPTX from Excel" h2="Perl library for exporting WORKSHEET to PPTX file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Perl. This is a professional solution to export WORKSHEET to PPTX format file from spreadsheet online using Perl." urlsection="export/worksheet-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKSHEET object to PPTX format file using Cells Cloud SDK for Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Perl using REST API to export WORKSHEET to PPTX format from spreadsheet" gistPath="" %}}
