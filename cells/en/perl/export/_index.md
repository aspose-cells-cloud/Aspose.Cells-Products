---
title: Export Excel objects using Perl 
...
{{< blocks/products/cells/cells-cloud-card-row title="Export Excel objects using Perl Extension links" >}}
