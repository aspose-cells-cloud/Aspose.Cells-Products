---
title: Export WORKBOOK to PPTX from Excel using Cells Cloud SDK for Perl  
...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to PPTX from Excel" h2="Perl library for exporting WORKBOOK to PPTX file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Perl. This is a professional solution to export WORKBOOK to PPTX format file from spreadsheet online using Perl." urlsection="export/workbook-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to PPTX format file using Cells Cloud SDK for Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Perl using REST API to export WORKBOOK to PPTX format from spreadsheet" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Perl to export objects from Excel WORKBOOK to PPTX" >}}
