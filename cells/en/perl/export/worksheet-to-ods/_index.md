...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKSHEET to ODS from Excel" h2="Perl library for exporting WORKSHEET to ODS file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Perl. This is a professional solution to export WORKSHEET to ODS format file from spreadsheet online using Perl." urlsection="export/worksheet-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKSHEET object to ODS format file using Cells Cloud SDK for Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Perl using REST API to export WORKSHEET to ODS format from spreadsheet" gistPath="" %}}
