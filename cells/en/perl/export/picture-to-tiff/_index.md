...
{{< blocks/products/cells/cells-cloud-banner h1="Export PICTURE to TIFF from Excel" h2="Perl library for exporting PICTURE to TIFF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Perl. This is a professional solution to export PICTURE to TIFF format file from spreadsheet online using Perl." urlsection="export/picture-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export PICTURE object to TIFF format file using Cells Cloud SDK for Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Perl using REST API to export PICTURE to TIFF format from spreadsheet" gistPath="" %}}
