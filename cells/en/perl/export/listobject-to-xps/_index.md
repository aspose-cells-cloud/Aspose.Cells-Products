...
{{< blocks/products/cells/cells-cloud-banner h1="Export LISTOBJECT to XPS from Excel" h2="Perl library for exporting LISTOBJECT to XPS file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Perl. This is a professional solution to export LISTOBJECT to XPS format file from spreadsheet online using Perl." urlsection="export/listobject-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export LISTOBJECT object to XPS format file using Cells Cloud SDK for Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Perl using REST API to export LISTOBJECT to XPS format from spreadsheet" gistPath="" %}}
