---
title: Merge Excel files using Perl 
description: Aspose.Cells Cloud REST API supports merging multiple Excel files into a single Excel file using Perl, and offers SDKs for various programming languages. 
