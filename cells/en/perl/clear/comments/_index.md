...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Removing comments on local Microsoft Excel and OpenOffice Calc spreadsheet" h2="Perl Clear to clear comments on local Microsoft Excel and OpenOffice Calc spreadsheet" p="Use Cells Clear REST API to clear comments on local Microsoft Excel and OpenOffice Calc spreadsheet workflows in Perl. This professional solution clear comments on local Microsoft Excel and OpenOffice Calc spreadsheet using Perl." urlsection="clear/Comments/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to utilize Cells Cloud SDK for Perl to clear comments" >}}
