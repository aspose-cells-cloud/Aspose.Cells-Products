---
title: Convert FODS to XML on Android 
...
url: /android/conversion/fods-to-xml/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to XML in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to XML Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS to XML Conversion" gistPath="" %}}
```java
