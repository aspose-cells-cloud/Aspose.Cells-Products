...
{{< blocks/products/cells/cells-cloud-section  title="Save a GIF file as XLS in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android Code Example for saving GIF as XLS using REST API" gistPath="" %}}
