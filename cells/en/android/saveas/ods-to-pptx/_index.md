...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save ODS as PPTX" h2="Android library for saving ODS as PPTX" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Android. This is a professional solution to save ODS as PPTX and other document formats online using Android." urlsection="saveas/ods-to-pptx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android Code Example for saving ODS as PPTX using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Android to save Excel files as other formats ODS as PPTX" >}}
