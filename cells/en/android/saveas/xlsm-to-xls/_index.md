...
{{< blocks/products/cells/cells-cloud-section  title="Save a XLSM file as XLS in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android Code Example for saving XLSM as XLS using REST API" gistPath="" %}}
