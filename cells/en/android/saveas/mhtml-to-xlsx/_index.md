...
{{< blocks/products/cells/cells-cloud-banner h1="Save MHTML as XLSX" h2="Android library for saving MHTML as XLSX" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Android. This is a professional solution to save MHTML as XLSX and other document formats online using Android." urlsection="saveas/mhtml-to-xlsx/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Save a MHTML file as XLSX in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android Code Example for saving MHTML as XLSX using REST API" gistPath="" %}}
