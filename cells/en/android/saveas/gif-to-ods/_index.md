...
{{< blocks/products/cells/cells-cloud-section  title="Save a GIF file as ODS in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android Code Example for saving GIF as ODS using REST API" gistPath="" %}}
