...
{{< blocks/products/cells/cells-cloud-banner h1="Save XLSM as MHTML" h2="Android library for saving XLSM as MHTML" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in Android. This is a professional solution to save XLSM as MHTML and other document formats online using Android." urlsection="saveas/xlsm-to-mhtml/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Save a XLSM file as MHTML in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android Code Example for saving XLSM as MHTML using REST API" gistPath="" %}}
