---
title: Export SHAPE to JPG from spreadsheet using Go  API 
...
url: /go/export/shape-to-jpg/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Go API to export SHAPE to JPG file" h2="Go library to export SHAPE to JPG file" p="Use Cells Export REST API to export spreadsheet internal object workflows in Go. This is a professional solution to export SHAPE to JPG format file from spreadsheet online using Go." urlsection="export/shape-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Export SHAPE object to JPG format file in Go" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Go API to export  SHAPE to JPG" >}}
