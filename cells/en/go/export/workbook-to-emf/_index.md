...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to EMF from Excel" h2="Go library for exporting WORKBOOK to EMF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Go. This is a professional solution to export WORKBOOK to EMF format file from spreadsheet online using Go." urlsection="export/workbook-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to EMF format file using Cells Cloud SDK for Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Go using REST API to export WORKBOOK to EMF format from spreadsheet" gistPath="" %}}
