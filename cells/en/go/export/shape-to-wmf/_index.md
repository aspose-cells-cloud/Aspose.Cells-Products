...
{{< blocks/products/cells/cells-cloud-banner h1="Export SHAPE to WMF from Excel" h2="Go library for exporting SHAPE to WMF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Go. This is a professional solution to export SHAPE to WMF format file from spreadsheet online using Go." urlsection="export/shape-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export SHAPE object to WMF format file using Cells Cloud SDK for Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Go using REST API to export SHAPE to WMF format from spreadsheet" gistPath="" %}}
