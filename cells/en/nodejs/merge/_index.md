---
title: Merge Excel files using NodeJS 
description: Aspose.Cells Cloud REST API supports merging multiple Excel files into a single Excel file using NodeJS, and offers SDKs for various programming languages. 

---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Merge Excel files using NodeJS" h2="Aspose.Cells Cloud SDK supports merging multiple Excel files into a single Excel file." p="Aspose.Cells Cloud REST API supports merging multiple Excel files into a single Excel file using NodeJS, and offers SDKs for various programming languages." urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Merge Excel files using NodeJS Extension links" >}}
