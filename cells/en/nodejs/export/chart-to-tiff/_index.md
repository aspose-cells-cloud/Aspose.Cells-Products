...
{{< blocks/products/cells/cells-cloud-banner h1="Export CHART to TIFF from Excel" h2="NodeJS library for exporting CHART to TIFF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in NodeJS. This is a professional solution to export CHART to TIFF format file from spreadsheet online using NodeJS." urlsection="export/chart-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export CHART object to TIFF format file using Cells Cloud SDK for NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in NodeJS using REST API to export CHART to TIFF format from spreadsheet" gistPath="" %}}
