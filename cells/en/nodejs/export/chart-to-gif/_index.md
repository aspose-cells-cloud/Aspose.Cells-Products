...
{{< blocks/products/cells/cells-cloud-section  title="Export CHART object to GIF format file using Cells Cloud SDK for NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in NodeJS using REST API to export CHART to GIF format from spreadsheet" gistPath="" %}}
