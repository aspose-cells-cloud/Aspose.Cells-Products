...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save XLT as TXT" h2="PHP library for saving XLT as TXT" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in PHP. This is a professional solution to save XLT as TXT and other document formats online using PHP." urlsection="saveas/xlt-to-txt/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Code Example for saving XLT as TXT using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for PHP to save Excel files as other formats XLT as TXT" >}}
