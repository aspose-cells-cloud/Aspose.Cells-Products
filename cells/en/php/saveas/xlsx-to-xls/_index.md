---
title: Convert XLSX to XLS with Aspose.Cells Cloud PHP SDK
description: Use Aspose.Cells Cloud PHP SDK to quickly convert XLSX files to XLS format. Follow step‑by‑step code, get free API quota, and start converting today.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to save XLSX as XLS using the Cells Cloud PHP library." >}}
