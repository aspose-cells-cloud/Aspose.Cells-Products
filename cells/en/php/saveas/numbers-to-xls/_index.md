...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Code Example for saving NUMBERS as XLS using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for PHP to save Excel files as other formats NUMBERS as XLS" >}}
