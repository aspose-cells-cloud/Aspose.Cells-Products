...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save ODS as XLT" h2="PHP library for saving ODS as XLT" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in PHP. This is a professional solution to save ODS as XLT and other document formats online using PHP." urlsection="saveas/ods-to-xlt/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Code Example for saving ODS as XLT using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for PHP to save Excel files as other formats ODS as XLT" >}}
