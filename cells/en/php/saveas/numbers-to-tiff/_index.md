...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Save NUMBERS as TIFF" h2="PHP library for saving NUMBERS as TIFF" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in PHP. This is a professional solution to save NUMBERS as TIFF and other document formats online using PHP." urlsection="saveas/numbers-to-tiff/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Code Example for saving NUMBERS as TIFF using REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for PHP to save Excel files as other formats NUMBERS as TIFF" >}}
