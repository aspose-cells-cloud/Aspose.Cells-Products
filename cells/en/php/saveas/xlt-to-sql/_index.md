...
{{< blocks/products/cells/cells-cloud-banner h1="Save XLT as SQL" h2="PHP library for saving XLT as SQL" p="Use SaveAs API of Cells Cloud to create customized spreadsheet workflows in PHP. This is a professional solution to save XLT as SQL and other document formats online using PHP." urlsection="saveas/xlt-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Save a XLT file as SQL in PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Code Example for saving XLT as SQL using REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="Learn how to save XLT as SQL using the Cells Cloud PHP library." >}}
