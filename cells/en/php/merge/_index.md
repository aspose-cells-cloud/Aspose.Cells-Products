---
title: Aspose.Cells Cloud API - Merge Excel Files with PHP
description: Learn how to merge multiple Excel files into a single workbook using Aspose.Cells Cloud API with PHP. Download the free PHP SDK, view sample code, and start your integration today!

---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Merge Excel files using PHP" h2="Aspose.Cells Cloud SDK supports merging multiple Excel files into a single Excel file." p="Aspose.Cells Cloud REST API supports merging multiple Excel files into a single Excel file using PHP, and offers SDKs for various programming languages." urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Merge Excel files using PHP Extension links" >}}
