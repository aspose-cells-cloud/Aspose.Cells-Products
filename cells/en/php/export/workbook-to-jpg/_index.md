...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to JPG from Excel" h2="PHP library for exporting WORKBOOK to JPG file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in PHP. This is a professional solution to export WORKBOOK to JPG format file from spreadsheet online using PHP." urlsection="export/workbook-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to JPG format file using Cells Cloud SDK for PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in PHP using REST API to export WORKBOOK to JPG format from spreadsheet" gistPath="" %}}
