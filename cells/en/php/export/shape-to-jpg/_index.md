---
title: Export SHAPE to JPG from spreadsheet using PHP  API 
...
url: /php/export/shape-to-jpg/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API to export SHAPE to JPG file" h2="PHP library to export SHAPE to JPG file" p="Use Cells Export REST API to export spreadsheet internal object workflows in PHP. This is a professional solution to export SHAPE to JPG format file from spreadsheet online using PHP." urlsection="export/shape-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Export SHAPE object to JPG format file in PHP" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in PHP using REST API to export SHAPE to JPG format from spreadsheet" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use PHP API to export  SHAPE to JPG" >}}
