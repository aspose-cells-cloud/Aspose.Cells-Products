...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Export SHAPE to JPG from Excel" h2="PHP library for exporting SHAPE to JPG file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in PHP. This is a professional solution to export SHAPE to JPG format file from spreadsheet online using PHP." urlsection="export/shape-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Export SHAPE object to JPG format file using Cells Cloud SDK for PHP" >}}
