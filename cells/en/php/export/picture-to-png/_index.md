...
{{< blocks/products/cells/cells-cloud-banner h1="Export PICTURE to PNG from Excel" h2="PHP library for exporting PICTURE to PNG file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in PHP. This is a professional solution to export PICTURE to PNG format file from spreadsheet online using PHP." urlsection="export/picture-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export PICTURE object to PNG format file using Cells Cloud SDK for PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in PHP using REST API to export PICTURE to PNG format from spreadsheet" gistPath="" %}}
