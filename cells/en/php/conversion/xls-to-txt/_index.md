---
title: Convert XLS to TXT with Aspose.Cells Cloud API for PHP
description: Use Aspose.Cells Cloud PHP SDK to instantly convert XLS files to TXT. Get free API quota, view sample code, and start converting in minutes.
