---
title: Aspose.Cells Cloud - Convert XLS to TXT with PHP API
description: Use Aspose.Cells Cloud PHP SDK to quickly convert XLS files to TXT format. Get free API quota, simple code example, and start converting in minutes.
