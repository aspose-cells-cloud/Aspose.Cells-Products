---
title: Aspose.Cells Cloud PHP - Convert XLS to TXT (Free API)
description: Use Aspose.Cells Cloud PHP SDK to instantly convert XLS files to TXT. Get free API quota, quick integration, and sample code. Try now!
