...
{{< blocks/products/cells/cells-cloud-banner h1="Convert XLS to HTML" h2="PHP library for converting XLS to HTML" p="Use the Conversion API of of Cells Cloud to create customized spreadsheet workflows in PHP projects. This is a professional solution to convert XLS to HTML and other document formats online using PHP." urlsection="conversion/xls-to-html/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Convert XLS to HTML using Cells Cloud SDK for PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Code Example for converting XLS to HTML using Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="Learn how to convert XLS to HTML using the Cells Cloud PHP library." >}}
