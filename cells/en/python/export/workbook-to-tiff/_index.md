...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to TIFF from Excel" h2="Python library for exporting WORKBOOK to TIFF file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Python. This is a professional solution to export WORKBOOK to TIFF format file from spreadsheet online using Python." urlsection="export/workbook-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to TIFF format file using Cells Cloud SDK for Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Python using REST API to export WORKBOOK to TIFF format from spreadsheet" gistPath="" %}}
