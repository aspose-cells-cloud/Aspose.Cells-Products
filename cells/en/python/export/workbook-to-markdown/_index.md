...
{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to MARKDOWN format file using Cells Cloud SDK for Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Python using REST API to export WORKBOOK to MARKDOWN format from spreadsheet" gistPath="" %}}
