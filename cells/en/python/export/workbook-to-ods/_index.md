---
title: Export WORKBOOK to ODS from Excel using Cells Cloud SDK for Python  
...
{{< blocks/products/cells/cells-cloud-banner h1="Export WORKBOOK to ODS from Excel" h2="Python library for exporting WORKBOOK to ODS file" p="Use Export API of Cells Cloud to export Excel file internal object workflows in Python. This is a professional solution to export WORKBOOK to ODS format file from spreadsheet online using Python." urlsection="export/workbook-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section  title="Export WORKBOOK object to ODS format file using Cells Cloud SDK for Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Code example in Python using REST API to export WORKBOOK to ODS format from spreadsheet" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Cells Cloud SDK for Python to export objects from Excel WORKBOOK to ODS" >}}
