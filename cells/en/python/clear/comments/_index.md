...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Removing comments on local Microsoft Excel and OpenOffice Calc spreadsheet" h2="Python Clear to clear comments on local Microsoft Excel and OpenOffice Calc spreadsheet" p="Use Cells Clear REST API to clear comments on local Microsoft Excel and OpenOffice Calc spreadsheet workflows in Python. This professional solution clear comments on local Microsoft Excel and OpenOffice Calc spreadsheet using Python." urlsection="clear/Comments/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to utilize Cells Cloud SDK for Python to clear comments" >}}
