...
{{< blocks/products/cells/cells-cloud-section  title="Save a XLTX file as XLS in Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Code Example for saving XLTX as XLS using REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="Learn how to save XLTX as XLS using the Cells Cloud Python library." >}}
