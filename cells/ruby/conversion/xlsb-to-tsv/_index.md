---
title: Convert from Excel XLSB to TSV via Ruby 
...
outformat: TSV
platform: Ruby
otherformats: TXT XLS XLSX MD TSV XLT DIF FODS HTML CSV XML XLTX XLSM SVG XPS SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to TSV with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to TSV Conversion with Ruby" %}}
