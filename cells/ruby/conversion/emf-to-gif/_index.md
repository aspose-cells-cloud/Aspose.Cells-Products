---
title: Convert EMF to GIF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert EMF to  GIF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="EMF to GIF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for EMF to GIF Conversion" gistPath="" %}}
```ruby
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=emf  outputformat=gif  %}}
