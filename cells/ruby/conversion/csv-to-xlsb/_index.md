---
title: Convert from Excel CSV to XLSB via Ruby 
...
outformat: XLSB
platform: Ruby
otherformats: XML DIF TIFF XLSX XLT FODS HTML MD XPS SVG XLTM SXC MHTML PDF XLSM XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XLSB with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to XLSB Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for CSV to XLSB Conversion" gistPath="" %}}
```ruby
