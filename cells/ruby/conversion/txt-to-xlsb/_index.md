---
title: Convert from Excel TXT to XLSB via Ruby 
...
outformat: XLSB
platform: Ruby
otherformats: XLS FODS XLT CSV DIF XLTX HTML TSV SVG XLSM TIFF SXC XLSB PDF XLTM XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XLSB with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to XLSB Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for TXT to XLSB Conversion" gistPath="" %}}
```ruby
