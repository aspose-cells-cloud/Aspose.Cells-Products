---
title: Convert SXC to SQL via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to  SQL in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to SQL Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for SXC to SQL Conversion" gistPath="" %}}
```ruby
