---
title: Convert from Excel XLS to MD via Ruby 
...
outformat: MD
platform: Ruby
otherformats: FODS XLSX DIF SVG MHTML XML SXC XLTM XPS XLTX PDF CSV TXT TIFF XLSM MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to MD with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to MD Conversion with Ruby" %}}
