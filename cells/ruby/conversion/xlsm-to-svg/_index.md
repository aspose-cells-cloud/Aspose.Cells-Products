---
title: Convert from Excel XLSM to SVG via Ruby 
...
outformat: SVG
platform: Ruby
otherformats: XML TIFF XLTX DIF PDF TSV XLSX HTML CSV XPS SXC SVG FODS TXT MHTML MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to SVG with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to SVG Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLSM to SVG Conversion" gistPath="" %}}
```ruby
