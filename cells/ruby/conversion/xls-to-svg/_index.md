---
title: Convert from Excel XLS to SVG via Ruby 
...
outformat: SVG
platform: Ruby
otherformats: TIFF TSV HTML FODS XLT DIF XLSX SXC PDF TXT XLSM XPS XLTM XLSB XML CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to SVG with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to SVG Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLS to SVG Conversion" gistPath="" %}}
```ruby
