---
title: Convert PNG to MD via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PNG to  MD in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PNG to MD Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for PNG to MD Conversion" gistPath="" %}}
```ruby
