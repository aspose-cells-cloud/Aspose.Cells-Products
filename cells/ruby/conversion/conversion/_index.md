...
url: /ruby/conversion/conversion/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="" h2="Ruby">}}
...
1. Call ```cells_workbook_put_convert_workbook``` method to 
...
Have a look at the [developer guide](https://docs.aspose.cloud/cells/developer-guide/) API Reference to know more about the []().
