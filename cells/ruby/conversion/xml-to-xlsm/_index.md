---
title: Convert XML to XLSM via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to  XLSM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to XLSM Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XML to XLSM Conversion" gistPath="" %}}
```ruby
