---
title: Convert from Excel XML to XLSM via Ruby 
...
outformat: XLSM
platform: Ruby
otherformats: DIF XLT TIFF FODS XLTX SXC CSV TXT XPS XLTM SVG PDF MHTML TSV XLSM MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSM with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to XLSM Conversion with Ruby" %}}
