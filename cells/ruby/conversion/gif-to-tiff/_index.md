---
title: Convert GIF to TIFF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert GIF to  TIFF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="GIF to TIFF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for GIF to TIFF Conversion" gistPath="" %}}
```ruby
