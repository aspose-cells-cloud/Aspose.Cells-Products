---
title: Convert from Excel TXT to XLSM via Ruby 
...
outformat: XLSM
platform: Ruby
otherformats: XLS XPS DIF SXC FODS SVG MD TIFF TSV HTML XML XLTX XLSX XLSM XLTM XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XLSM with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to XLSM Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for TXT to XLSM Conversion" gistPath="" %}}
```ruby
