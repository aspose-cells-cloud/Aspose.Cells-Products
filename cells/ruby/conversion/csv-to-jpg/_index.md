---
title: Convert CSV to JPG via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to  JPG in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to JPG Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for CSV to JPG Conversion" gistPath="" %}}
```ruby
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=csv  outputformat=jpg  %}}
