---
title: Convert from Excel CSV to PDF via Ruby 
...
outformat: PDF
platform: Ruby
otherformats: XML SVG HTML MHTML XPS XLS XLSB XLT TXT MD DIF SXC ODS PDF FODS TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to PDF with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to PDF Conversion with Ruby" %}}
