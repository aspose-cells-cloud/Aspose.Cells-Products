---
title: Convert JPG to XLSX via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JPG to  XLSX in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JPG to XLSX Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for JPG to XLSX Conversion" gistPath="" %}}
```ruby
