---
title: Convert TSV to XLSB via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to  XLSB in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to XLSB Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for TSV to XLSB Conversion" gistPath="" %}}
```ruby
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=tsv  outputformat=xlsb  %}}
