---
title: Convert from Excel XLS to SXC via Ruby 
...
outformat: SXC
platform: Ruby
otherformats: SXC ODS XLT XLSM PDF XML XLSB DIF SVG FODS CSV TIFF HTML MD MHTML TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to SXC with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to SXC Conversion with Ruby" %}}
