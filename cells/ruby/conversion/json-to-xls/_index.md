---
title: Convert JSON to XLS via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  XLS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to XLS Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for JSON to XLS Conversion" gistPath="" %}}
```ruby
