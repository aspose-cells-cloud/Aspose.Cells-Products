---
title: Convert HTML to WMF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to  WMF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to WMF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for HTML to WMF Conversion" gistPath="" %}}
```ruby
