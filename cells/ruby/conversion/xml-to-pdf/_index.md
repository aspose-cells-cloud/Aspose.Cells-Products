---
title: Convert from Excel XML to PDF via Ruby 
...
outformat: PDF
platform: Ruby
otherformats: XLT PDF XLTM MHTML SXC TIFF CSV DIF ODS SVG TXT XLSB TSV MD XLSM FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to PDF with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to PDF Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XML to PDF Conversion" gistPath="" %}}
```ruby
