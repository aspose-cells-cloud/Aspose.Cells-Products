---
title: Convert from Excel XLS to XLTX via Ruby 
...
outformat: XLTX
platform: Ruby
otherformats: XML SXC XLTM MD DIF XLSM XLSX HTML FODS MHTML XPS TIFF CSV XLSB SVG PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLTX with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLTX Conversion with Ruby" %}}
