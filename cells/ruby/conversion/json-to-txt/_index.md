---
title: Convert JSON to TXT via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  TXT in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to TXT Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for JSON to TXT Conversion" gistPath="" %}}
```ruby
