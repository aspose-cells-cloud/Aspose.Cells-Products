---
title: Convert from Excel XML to SXC via Ruby 
...
outformat: SXC
platform: Ruby
otherformats: SVG DIF MD TXT CSV HTML XLTM TIFF PDF XLSB MHTML XLTX XLSX XLSM FODS SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to SXC with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to SXC Conversion with Ruby" %}}
