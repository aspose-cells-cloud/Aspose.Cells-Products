---
title: Convert from Excel XLSB to XLSX via Ruby 
...
outformat: XLSX
platform: Ruby
otherformats: TIFF DIF MD HTML TSV SVG TXT SXC XLSM CSV PDF ODS XML FODS XPS MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLSX with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to XLSX Conversion with Ruby" %}}
