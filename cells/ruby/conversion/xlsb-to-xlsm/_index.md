---
title: Convert from Excel XLSB to XLSM via Ruby 
...
outformat: XLSM
platform: Ruby
otherformats: PDF TIFF XLSX ODS XML XLTM XLSM DIF XPS SVG TXT CSV XLTX SXC MHTML FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLSM with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to XLSM Conversion with Ruby" %}}
