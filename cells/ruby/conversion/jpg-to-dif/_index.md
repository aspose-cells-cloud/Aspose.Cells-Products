---
title: Convert JPG to DIF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JPG to  DIF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JPG to DIF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for JPG to DIF Conversion" gistPath="" %}}
```ruby
