---
title: Convert XLT to PPTX via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to  PPTX in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLT to PPTX Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLT to PPTX Conversion" gistPath="" %}}
```ruby
