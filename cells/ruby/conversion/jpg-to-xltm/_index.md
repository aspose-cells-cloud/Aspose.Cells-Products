---
title: Convert JPG to XLTM via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JPG to  XLTM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JPG to XLTM Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for JPG to XLTM Conversion" gistPath="" %}}
```ruby
