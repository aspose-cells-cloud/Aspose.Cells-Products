---
title: Convert from Excel XLS to TSV via Ruby 
...
outformat: TSV
platform: Ruby
otherformats: XML XLT MHTML XLTM DIF FODS TXT SVG XLSX SXC TIFF XLTX MD TSV XPS CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to TSV with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to TSV Conversion with Ruby" %}}
