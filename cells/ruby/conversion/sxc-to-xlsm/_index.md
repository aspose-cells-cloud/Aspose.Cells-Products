---
title: Convert from Excel SXC to XLSM via Ruby 
...
outformat: XLSM
platform: Ruby
otherformats: TIFF XLS XPS SVG TSV ODS XLSB CSV SXC FODS XLTM MD XLSX XLSM MHTML TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSM with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to XLSM Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for SXC to XLSM Conversion" gistPath="" %}}
```ruby
