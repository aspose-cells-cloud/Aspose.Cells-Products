---
title: Convert from Excel XLSX to XPS via Ruby 
...
outformat: XPS
platform: Ruby
otherformats: XPS XLSB MHTML SXC XLSM DIF SVG TXT ODS XLTM CSV TSV XLTX FODS PDF XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XPS with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to XPS Conversion with Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLSX to XPS Conversion" gistPath="" %}}
```ruby
