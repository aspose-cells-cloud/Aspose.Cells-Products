---
title: Convert from Excel XLS to XLSB via Ruby 
...
outformat: XLSB
platform: Ruby
otherformats: FODS CSV XLT SVG XLSX DIF HTML XLSB TIFF PDF MD TXT XLSM XML XPS SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSB with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSB Conversion with Ruby" %}}
