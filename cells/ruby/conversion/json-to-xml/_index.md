---
title: Convert JSON to XML via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  XML in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to XML Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for JSON to XML Conversion" gistPath="" %}}
```ruby
