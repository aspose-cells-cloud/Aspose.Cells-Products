---
title: Convert from Excel TSV to XLS via Ruby 
...
outformat: XLS
platform: Ruby
otherformats: MHTML DIF ODS XLTX SXC XLSX XLTM FODS TIFF CSV PDF XLSB TXT MD XML XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XLS with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to XLS Conversion with Ruby" %}}
