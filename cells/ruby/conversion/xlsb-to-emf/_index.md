---
title: Convert XLSB to EMF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to  EMF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to EMF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLSB to EMF Conversion" gistPath="" %}}
```ruby
