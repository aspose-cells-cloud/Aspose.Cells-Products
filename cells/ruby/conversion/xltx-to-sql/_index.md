---
title: Convert XLTX to SQL via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to  SQL in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTX to SQL Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLTX to SQL Conversion" gistPath="" %}}
```ruby
