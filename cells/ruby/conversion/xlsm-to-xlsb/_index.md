---
title: Convert from Excel XLSM to XLSB via Ruby 
...
outformat: XLSB
platform: Ruby
otherformats: XLTX CSV TSV SVG ODS XLS MD XPS XLTM DIF SXC TXT HTML FODS XLSX TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLSB with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to XLSB Conversion with Ruby" %}}
