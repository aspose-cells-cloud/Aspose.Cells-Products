---
title: Convert XLTX to TIFF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to  TIFF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTX to TIFF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=xltx  outputformat=tiff  %}}
