---
title: Convert XLS to CSV via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to  CSV in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to CSV Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=xls  outputformat=csv  %}}
