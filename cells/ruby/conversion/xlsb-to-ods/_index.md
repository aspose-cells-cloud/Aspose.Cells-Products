---
title: Convert from Excel XLSB to ODS via Ruby 
...
outformat: ODS
platform: Ruby
otherformats: DIF PDF XLTM XLSM XPS MD HTML FODS SVG TIFF CSV MHTML XML XLTX TXT TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to ODS with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to ODS Conversion with Ruby" %}}
