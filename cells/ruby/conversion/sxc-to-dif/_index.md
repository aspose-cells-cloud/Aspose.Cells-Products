---
title: Convert from Excel SXC to DIF via Ruby 
...
outformat: DIF
platform: Ruby
otherformats: MD TSV XPS SVG XLTX ODS FODS TXT XLS TIFF XLTM PDF HTML SXC CSV XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to DIF with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to DIF Conversion with Ruby" %}}
