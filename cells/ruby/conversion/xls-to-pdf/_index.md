---
title: Convert XLS to PDF via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to  PDF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to PDF Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for XLS to PDF Conversion" gistPath="" %}}
```ruby
