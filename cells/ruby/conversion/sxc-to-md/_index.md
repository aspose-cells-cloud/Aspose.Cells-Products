---
title: Convert from Excel SXC to MD via Ruby 
...
outformat: MD
platform: Ruby
otherformats: SVG PDF XLSM SXC MD ODS XLSX XML TIFF XLSB TXT MHTML CSV FODS XPS TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to MD with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to MD Conversion with Ruby" %}}
