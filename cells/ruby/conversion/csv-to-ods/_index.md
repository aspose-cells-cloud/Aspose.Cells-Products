---
title: Convert from Excel CSV to ODS via Ruby 
...
outformat: ODS
platform: Ruby
otherformats: HTML FODS XML SVG MD TXT XPS TSV XLSM DIF XLTX XLSB PDF MHTML XLSX TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to ODS with Ruby" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to ODS Conversion with Ruby" %}}
