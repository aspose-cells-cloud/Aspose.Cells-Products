---
title: Convert GIF to XLTM via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert GIF to  XLTM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="GIF to XLTM Conversion in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for GIF to XLTM Conversion" gistPath="" %}}
```ruby
