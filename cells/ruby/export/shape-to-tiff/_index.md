---
title: Export Shape to TIFF file via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Shape to TIFF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Shape to TIFF file in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for SHAPE to TIFF Conversion" gistPath="" %}}
```ruby
...
{{% blocks/products/cells/cells-cloud-api-run-export  InputFormat="xlsx,*.xls,*.csv,*.txt,*.ods"  OutputFormat=tiff  ExportObjectType=shape %}}
