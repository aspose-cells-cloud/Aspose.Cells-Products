---
title: Export Picture to PNG file via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Picture to PNG file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Picture to PNG file in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for PICTURE to PNG Conversion" gistPath="" %}}
```ruby
