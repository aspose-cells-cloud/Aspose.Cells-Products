---
title: Export Listobject to XPS file via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Listobject to XPS file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Listobject to XPS file in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for LISTOBJECT to XPS Conversion" gistPath="" %}}
```ruby
