---
title: Export Worksheet to PPTX file via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Worksheet to PPTX file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Worksheet to PPTX file in Cloud SDK for Ruby " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code for WORKSHEET to PPTX Conversion" gistPath="" %}}
```ruby
