...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Decrypt cloud spreadsheets with password in Cloud" h2="Excel & OpenOffice spreadsheet decrypt with password by open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Decrypt workbook on cloud spreadsheets with password by Cloud SDK for Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby code for decrypting cloud spreadsheets" gistPath="https://gist.github.com/aspose-cells-cloud-gists/36ed8b8727561b92692939513d365fca.js?file=Examples-Ruby-Document-decrypt_document-.rb" %}}
