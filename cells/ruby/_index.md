---
title: Read, View & Convert Cloud Excel Files (via Ruby REST SDK) 
description: Enhances your Ruby applications to process and manipulate Microsoft Excel & OpenOffice spreadsheets in the cloud
weight: 120
url: /ruby
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Build Excel File Reader, Viewer & Converter Apps in Ruby" h2="Enhances your Ruby applications to process and manipulate Microsoft Excel & OpenOffice spreadsheets in the cloud." logoImageSrc="/headers/aspose_cells-for-ruby.png?v2?v2" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Ruby" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Ruby" >}}

{{< blocks/products/pf/sub-menu logoImageSrc="/sdk/aspose_cells-for-ruby.png"  PricingLink="https://purchase.aspose.cloud/pricing" buyLink="https://dashboard.aspose.cloud" docsLink="https://docs.aspose.cloud/cells" directDownloadLink="https://github.com/aspose-cells-cloud/aspose-cells-cloud-go" liveDemosLink="https://products.aspose.app/cells/family"  >}}

{{< blocks/products/pf/tab-content >}}
<p>Aspose.Cells Cloud SDK for Ruby assists developers access and read Excel files hosted on cloud storage, without installing any 3rd party software. Enable your Ruby code to convert XLS, XLSX, ODS files to CSV, XML, Markdown (MD), PDF, XPS, TIFF, DIF and other formats.</p>
<p>Enable your Ruby programs to process cloud worksheets, workbooks, spreadsheets, as well as access and modify individual cells, rows and columns. Apply custom filters, ListObjects, OleObjects, and conditional formatting using Ruby code. Aspose.Cells Cloud SDK for Ruby also lets you encrypt, split, merge, protect and convert spreadsheets.</p>
{{< /blocks/products/pf/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-ruby.png" alt="Ruby Excel SDK"><header>Aspose.Cells</header><footer>Cloud <small> <em>for </em> </small>Ruby</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-go.png" alt="Ruby Cloud Excel SDK"><header>Aspose.Cells</header><footer>Cloud <small> <em>for </em> </small>Ruby</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     In order to get started with Aspose.Cells Cloud SDK for Ruby, you do not need to install anything. All you need to do is create an account at
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose for Cloud
     </a>
     and get your application information. Once you have the App SID &amp; key, you are ready to use Aspose.Cells Cloud SDK for Ruby on any platform which supports REST APIs. Aspose.Cells Cloud SDK for Ruby provides you all the features to create, edit, and convert spreadsheets. It also allows you to extract data from the spreadsheets for further processing or storage.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells Cloud SDK for Ruby allows you to add a pivot table into worksheet, add or delete pivot fields into pivot table, add or remove pivot filter for pivot table index, update cell style for pivot table, and calculate pivot table's data to cells.
    </p>
    <p>
     Aspose.Cells Cloud SDK for Ruby can also be used to get cells list in a range by range name or row column indexes, set column width of range, combine a range of cells into a single cell, move the current range to the destination range, sets outline border around a range of cells., set row height of range, set the style of the range, unmerges merged cells of this range, put a value into the range and convert its data type, and copy range in the worksheet.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-ruby" >}}
