---
title: Save XML as FODS via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XML file as  FODS file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XML file as FODS file in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for saving XML as FODS " gistPath="" %}}
```perl
