---
title: Save NUMBERS as PPTX via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save NUMBERS file as  PPTX file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save NUMBERS file as PPTX file in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for saving NUMBERS as PPTX " gistPath="" %}}
```perl
