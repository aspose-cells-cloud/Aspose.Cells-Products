---
title: Save XLSM as XPS via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XLSM file as  XPS file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XLSM file as XPS file in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for saving XLSM as XPS " gistPath="" %}}
```perl
