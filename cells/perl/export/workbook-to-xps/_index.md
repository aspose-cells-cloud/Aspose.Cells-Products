---
title: Export Workbook to XPS file via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Workbook to XPS file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Workbook to XPS file in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for WORKBOOK to XPS Conversion" gistPath="" %}}
```perl
...
{{% blocks/products/cells/cells-cloud-api-run-export  InputFormat=".xlsx,.xls,.csv,.txt,.ods"  OutputFormat=xps  ExportObjectType=workbook %}}
