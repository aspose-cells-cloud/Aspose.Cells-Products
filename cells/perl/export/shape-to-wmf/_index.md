---
title: Export Shape to WMF file via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Shape to WMF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Shape to WMF file in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for SHAPE to WMF Conversion" gistPath="" %}}
```perl
