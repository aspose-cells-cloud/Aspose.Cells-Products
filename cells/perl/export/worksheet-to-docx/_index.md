---
title: Export Worksheet to DOCX file via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Worksheet to DOCX file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Worksheet to DOCX file in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for WORKSHEET to DOCX Conversion" gistPath="" %}}
```perl
