---
title: Convert CSV to WMF via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to  WMF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to WMF Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for CSV to WMF Conversion" gistPath="" %}}
```perl
