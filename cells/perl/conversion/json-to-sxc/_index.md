---
title: Convert JSON to SXC via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  SXC in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to SXC Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for JSON to SXC Conversion" gistPath="" %}}
```perl
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=json  outputformat=sxc  %}}
