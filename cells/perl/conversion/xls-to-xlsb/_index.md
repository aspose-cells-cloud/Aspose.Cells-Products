---
title: Convert XLS to XLSB via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to  XLSB in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSB Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for XLS to XLSB Conversion" gistPath="" %}}
```perl
// For complete examples and data files, please go to https://github.com/aspose-cells-cloud/aspose-cells-cloud-perl/
    ...
    my $Book1_data =undef;
    my @fileinfos = stat(get_path(file=>"Book1.xls"));
    my $filelength = $fileinfos[7];
    open(DATA, "<".get_path(file=>"Book1.xls")) or die "file.txt  can not open, $!";
    binmode(DATA);
