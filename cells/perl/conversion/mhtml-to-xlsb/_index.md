---
title: Convert MHTML to XLSB via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to  XLSB in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to XLSB Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for MHTML to XLSB Conversion" gistPath="" %}}
```perl
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=mhtml  outputformat=xlsb  %}}
