---
title: Convert ODS to CSV via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to  CSV in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODS to CSV Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for ODS to CSV Conversion" gistPath="" %}}
```perl
