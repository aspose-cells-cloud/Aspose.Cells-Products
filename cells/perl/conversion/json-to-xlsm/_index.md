---
title: Convert JSON to XLSM via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  XLSM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to XLSM Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for JSON to XLSM Conversion" gistPath="" %}}
```perl
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=json  outputformat=xlsm  %}}
