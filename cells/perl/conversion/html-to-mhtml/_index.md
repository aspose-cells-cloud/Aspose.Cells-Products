---
title: Convert HTML to MHTML via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to  MHTML in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to MHTML Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for HTML to MHTML Conversion" gistPath="" %}}
```perl
// For complete examples and data files, please go to https://github.com/aspose-cells-cloud/aspose-cells-cloud-perl/
    ...
    my $Book1_data =undef;
    my @fileinfos = stat(get_path(file=>"Book1.html"));
    my $filelength = $fileinfos[7];
    open(DATA, "<".get_path(file=>"Book1.html")) or die "file.txt  can not open, $!";
    binmode(DATA);
