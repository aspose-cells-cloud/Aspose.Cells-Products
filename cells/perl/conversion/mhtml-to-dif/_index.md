---
title: Convert MHTML to DIF via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to  DIF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to DIF Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for MHTML to DIF Conversion" gistPath="" %}}
```perl
