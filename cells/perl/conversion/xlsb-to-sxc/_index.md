---
title: Convert XLSB to SXC via Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to  SXC in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to SXC Conversion in Cloud SDK for Perl " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Code for XLSB to SXC Conversion" gistPath="" %}}
```perl
