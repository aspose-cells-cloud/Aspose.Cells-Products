...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект WORKBOOK в файл формата XPS с помощью Cloud SDK Cells для C#." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в C# с использованием REST API для экспорта WORKBOOK в формат XPS из электронной таблицы" gistPath="" %}}
