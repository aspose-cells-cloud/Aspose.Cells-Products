...
{{< blocks/products/cells/cells-cloud-upper-banner h1="C# API для экспорта LISTOBJECT в файл ODS" h2="C# библиотека для экспорта LISTOBJECT в файл ODS" p="Используйте Cells Export REST API для экспорта рабочих процессов внутренних объектов электронных таблиц в Net. Это профессиональное решение для экспорта LISTOBJECT в файл формата ODS из электронной таблицы онлайн с использованием C#." urlsection="export/listobject-to-ods/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как использовать C# API для экспорта LISTOBJECT в ODS" >}}
