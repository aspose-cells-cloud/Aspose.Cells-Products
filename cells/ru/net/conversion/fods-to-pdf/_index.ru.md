---
title:  Преобразование FODS в PDF via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в PDF в облаке" h2="Excel и преобразование электронных таблиц OpenOffice с помощью Cloud SDK с открытым исходным кодом for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Код FODS для конвертации PDF" gistPath="" %}}
```cs
