---
title:  Конвертировать FODS в DIF via .NET
...
url: /ru/net/conversion/fods-to-dif/
family: cells
platformtag: net
feature: conversion
informat: FODS
outformat: DIF
platform: .NET
otherformats: XML XLSB MD FODS MHTML DIF TSV SVG TXT XLTX XPS PDF XLSX CSV XLSM XLTM 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование FODS в DIF в облаке" h2="Excel и преобразование электронных таблиц OpenOffice с помощью Cloud SDK с открытым исходным кодом for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Преобразование FODS в DIF в приложениях .NET" %}}
...
1. Вызовите метод ```CellsApi.CellsSaveAsPostDocumentSaveAs```, чтобы получить результирующий файл DIF.
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Код для преобразования FODS в DIF" gistPath="" %}}
```cs
...
var response = instance.CellsSaveAsPostDocumentSaveAs(name, saveOptions,  "output.dif", null, null, folder, "DropBox");
```
