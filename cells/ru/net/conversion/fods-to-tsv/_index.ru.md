...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в TSV в облаке" h2="Excel и преобразование электронных таблиц OpenOffice с помощью Cloud SDK с открытым исходным кодом for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Код для конвертации FODS в TSV" gistPath="" %}}
```cs
