---
title:  Преобразование FODS в SVG via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в SVG в облаке" h2="Excel и преобразование электронных таблиц OpenOffice с помощью Cloud SDK с открытым исходным кодом for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Код FODS для конвертации SVG" gistPath="" %}}
```cs
