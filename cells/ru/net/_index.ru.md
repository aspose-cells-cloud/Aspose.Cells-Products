...
description:  SDK для C#, ASP.NET и других поддерживаемых .NET языков для разработки облачных приложений для обработки Excel и электронных таблиц OpenOffice.
weight: 70
url: /ru/net
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Сборка Excel Приложения для просмотра и конвертации via C# REST SDK" h2="Easy SDK для C#, ASP.NET и других поддерживаемых языков .NET для разработки облачных приложений для обработки электронных таблиц Excel и OpenOffice." logoImageSrc="/headers/aspose_cells-for-net.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for .NET" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK for .NET расширяет возможности ваших приложений .NET за счет плавной интеграции функций обработки электронных таблиц, которые позволяют вашим облачным программам получать доступ и изменять рабочие книги, рабочие листы, электронные таблицы, строки, а также отдельные ячейки без установки какого-либо стороннего программного обеспечения. Aspose.Cells Cloud SDK for .NET распространяется по лицензии MIT.</p>
<p>Aspose.Cells Cloud SDK for .NET работает как интерфейс к базовому Aspose.Cells REST API. Он значительно упрощает вашу работу по программированию .NET, когда дело доходит до работы со сводными таблицами, OleObjects, ListObjects, задачами, фигурами, гиперссылками и комментариями.</p>
<p>Используя Aspose.Cells Cloud SDK for .NET, вы можете включить код C# для выполнения автоматической фильтрации, а также применять условное форматирование к электронным таблицам. Поддержка преобразования файлов также является достаточно полной: с помощью облачного приложения .NET вы сможете конвертировать документы Microsoft Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) и OpenOffice (ODS) в PDF, XPS, SVG, TIFF, форматы Markdown и DIF.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-net.svg" alt="Go SDK for Excel & OpenOffice Spreadsheets"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-net.svg" alt="Excel SDK .NET"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Расширенные возможности Aspose.Cells Cloud SDK for .NET
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Добавьте несколько типов фильтров списков с настраиваемыми критериями.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Доступ к границе области диаграммы или формату заполнения
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Добавить, обновить или удалить диаграммы
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Получить, обновить, показать или скрыть легенду диаграммы и титулы
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Обобщение данных большого объекта ListObject или таблицы с помощью сводной таблицы
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Добавить или удалить объекты OleObjects из листов Excel.
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Начните работу с Excel SDK для обработки электронных таблиц
    ...
    <p>
 Вам не нужно ничего устанавливать, чтобы начать работу с Aspose.Cells Cloud SDK for .NET. Все, что вам нужно сделать, это создать учетную запись на сайте
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose для облака
     </a>
и получите информацию о вашем приложении. Вот и все! Вы готовы использовать Aspose.Cells Cloud SDK for .NET.
    </p>
    <p>
