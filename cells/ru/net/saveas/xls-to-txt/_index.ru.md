...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Сохраните файл XLS как TXT по номеру C#." >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Пример кода для сохранения XLS как TXT с использованием REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как использовать Cells Cloud SDK для Net для сохранения файлов Excel в других форматах XLS как TXT." >}}
