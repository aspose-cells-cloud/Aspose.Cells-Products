---
title:  Сохраните XLSB как SQL API для C#
description:  Использование Aspose.Cells Cloud SDK для C# для сохранения файла формата XLSB в виде файла формата SQL.
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как использовать C# API для сохранения XLSB как SQL" >}}
