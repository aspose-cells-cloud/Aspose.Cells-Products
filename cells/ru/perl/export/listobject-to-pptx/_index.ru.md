...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Экспортируйте объект LISTOBJECT в файл формата PPTX с помощью Cloud SDK Cells для Perl." >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Пример кода Perl с использованием REST API для экспорта LISTOBJECT в формат PPTX из электронной таблицы" gistPath="" %}}
