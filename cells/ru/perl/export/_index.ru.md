---
title:  Экспортируйте объекты Excel, используя Perl.
description:  Aspose.Cells Cloud REST API поддерживает экспорт книг и внутренних объектов во все виды форматов с помощью Perl. SDK поддерживает языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Экспортируйте объекты Excel, используя Perl." h2="Aspose.Cells Cloud SDK поддерживает экспорт книг и внутренних объектов в более чем 30 форматов файлов." p="Aspose.Cells Cloud REST API поддерживает экспорт книг и внутренних объектов во все виды форматов с помощью Perl. SDK поддерживает языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift." urlsection="export/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Экспортируйте объекты Excel, используя ссылки расширения Perl." >}}
