---
title:  Сборка Excel приложений для чтения и преобразования в Perl (via REST API)
description: Создавайте, читайте, записывайте, объединяйте, разделяйте, шифруйте и конвертируйте электронные таблицы Microsoft Excel и OpenOffice в облаке
weight: 90
url: /ru/perl
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Perl REST SDK для электронных таблиц Excel" h2="Создавайте, читайте, записывайте, объединяйте, разделяйте, шифруйте и конвертируйте электронные таблицы Microsoft Excel и OpenOffice в облаке." logoImageSrc="/headers/aspose_cells-for-perl.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Perl" downloadUrl="" >}}
...
Удалить определенные или все объекты ListObject на листе
 ...
 и получите информацию о приложении. Получив SID приложения &amp; key, вы готовы использовать Aspose.Cells Cloud SDK для Perl на любой платформе, поддерживающей REST API. Aspose.Cells Cloud SDK для Perl предоставляет все возможности для создания, редактирования и преобразования электронных таблиц. Он также позволяет извлекать данные из электронных таблиц для дальнейшей обработки или хранения.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Используя Aspose.Cells Cloud SDK для Perl, вы можете удалить определенную строку или все строки на листе, получить данные ячейки рабочего листа или стиль ячейки по имени ячейки, прочитать данные строки или столбца рабочего листа по его индексу, вычислить формулу ячейки, очистить содержимое ячейки, скопировать ячейку в другую ячейку, скопировать столбцы и строки рабочего листа, сгруппировать строки и столбцы рабочего листа, скрыть строки и столбцы рабочего листа, установить стили столбцов и строк рабочего листа, установить значение HTMLSTRING в ячейку, установить значение диапазона ячеек и изменить множество других параметров рабочего листа.
 ...
 Используйте возможности сводных таблиц &amp;amp;amp;amp;amp;amp; Диапазоны
    ...
    <p>
 Aspose.Cells Cloud SDK для Perl позволяет добавить сводную таблицу на лист, добавить или удалить поля сводной таблицы в сводной таблице, добавить или удалить фильтр сводной таблицы для индекса сводной таблицы, обновить стиль ячейки для сводной таблицы и вычислить данные сводной таблицы для ячеек.
    </p>
    <p>
