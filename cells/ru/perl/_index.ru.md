---
title:  Сборка Excel приложений для чтения и конвертации в Perl (via REST API)
description: Создавайте, читайте, записывайте, объединяйте, разделяйте, шифруйте и конвертируйте Microsoft Excel и электронные таблицы OpenOffice в облаке.
weight: 90
url: /ru/perl
---
...
<p>Aspose.Cells Cloud SDk для Perl позволяет быстро разрабатывать конкурентоспособные облачные Microsoft Excel и приложения для создания, чтения, слияния, разделения, шифрования и конвертирования электронных таблиц OpenOffice на языке программирования Perl. Cloud SDK Aspose.Cells для Perl построен на базе Aspose.Cells REST API. Наш Cloud SDK Cells лицензируется MIT.</p>
<p>Aspose.Cells Cloud SDK для Perl позволяет вашему коду Perl получать доступ к облачным листам и изменять автофильтры, книги, ячейки, столбцы, строки, диаграммы, фигуры, гиперссылки, условное форматирование, OleObjects, разрывы страниц, ListObjects, сводные таблицы, задачи и диапазоны. . Включите программу Perl для преобразования XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM, ODS в DIF, PDF, XPS, TIFF, SVG, MD (Markdown), XML (SpreadsheetML), CSV, TSV, TXT (TabDelimited) , HTML и форматы MHTML.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-perl.svg" alt="Perl Excel SDK"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-perl.svg" alt="Excel Perl Cloud SDK"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
Удалить определенные или все объекты OleObjects с рабочего листа
 ...
 Начните работу с Excel SDK для обработки электронных таблиц
    ...
    <p>
 Чтобы начать работу с Aspose.Cells Cloud SDK для Perl, вам не нужно ничего устанавливать. Все, что вам нужно сделать, это создать учетную запись на
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose для облака
     </a>
и получите информацию о вашем приложении. Получив идентификатор приложения SID &amp; ключ, вы готовы использовать Aspose.Cells Cloud SDK для Perl на любой платформе, поддерживающей REST API. Aspose.Cells Cloud SDK для Perl предоставляет вам все функции для создания, редактирования и преобразования электронных таблиц. Он также позволяет извлекать данные из электронных таблиц для дальнейшей обработки или хранения.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Обработка книг via Cloud SDK
    ...
    <p>
 Aspose.Cells Cloud SDK для Perl позволяет создавать, разделять, объединять, искать и заменять текст, защищать паролем, экспортировать в поддерживаемый формат файла, читать текстовые элементы книги, автоматически подгонять строки книги, игнорируя скрытые элементы, шифровать пароль книги и предоставлять ключ шифрования. длину, импортировать данные в рабочую книгу, рассчитать все формулы в рабочей книге, установить параметры расчета формул, предоставив стратегию точности и т. д., использовать интеллектуальный маркер, преобразовать рабочую книгу из содержимого запроса в другой формат, применить пароль, чтобы разрешить изменение содержимого.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
