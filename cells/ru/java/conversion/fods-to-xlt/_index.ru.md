---
title:  Преобразование FODS в XLT в облаке via Java
...
url: /ru/java/conversion/fods-to-xlt/
family: cells
platformtag: java
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в XLT с помощью Java" h2="Автоматизируйте преобразование файлов Excel и OpenOffice с помощью Cloud SDK с открытым исходным кодом for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Простое преобразование FODS в XLT" %}}
...
1. Позвоните по номеру ```CellsApi.cellsWorkbookGetWorkbook```, чтобы получить полученный файл XLT.
...
{{% blocks/products/pf/agp/code-autogen title="Java Код для конвертации FODS в XLT" gistPath="" %}}
```java
