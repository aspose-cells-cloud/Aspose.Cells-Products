---
title:  Преобразование FODS в XML в облаке via Java
...
url: /ru/java/conversion/fods-to-xml/
family: cells
platformtag: java
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в XML с помощью Java" h2="Автоматизируйте преобразование файлов Excel и OpenOffice с помощью Cloud SDK с открытым исходным кодом for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Простое преобразование FODS в XML" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Код для преобразования FODS в XML" gistPath="" %}}
```java
