---
title:  Экспортируйте ИЗОБРАЖЕНИЕ в WMF из Excel с помощью Cloud SDK Cells for Java.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в Java с использованием REST API для экспорта PICTURE в формат WMF из электронной таблицы." gistPath="" %}}
