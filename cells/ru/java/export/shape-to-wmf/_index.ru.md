...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект SHAPE в файл формата WMF с помощью Cloud SDK Cells for Java." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в Java с использованием REST API для экспорта SHAPE в формат WMF из электронной таблицы" gistPath="" %}}
