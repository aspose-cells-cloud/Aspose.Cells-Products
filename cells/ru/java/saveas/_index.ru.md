---
title:  Сохранить как Java
description:  Aspose.Cells Cloud REST API поддерживает сохранение файлов Excel в виде файлов формата с использованием Java. SDK поддерживает языки разработки. Среди них Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
url: /ru/java/saveas/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Сохранить как Java" h2="Aspose.Cells Cloud SDK поддерживает сохранение книг в других форматах. Поддерживаемые форматы файлов имеют более 30 форматов файлов." p="Aspose.Cells Cloud REST API поддерживает сохранение файлов Excel в виде файлов формата с использованием Java. SDK поддерживает языки разработки. Среди них Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Сохранить как с помощью ссылок расширения Java" >}}
