...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Экспортируйте объект PICTURE в файл формата PNG с помощью Cells Cloud SDK for Go." >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Пример кода на Go с использованием REST API для экспорта PICTURE в формат PNG из электронной таблицы" gistPath="" %}}
