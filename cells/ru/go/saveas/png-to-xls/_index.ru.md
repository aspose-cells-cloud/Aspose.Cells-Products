...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Введите API, чтобы сохранить PNG как XLS." h2="Перейти в библиотеку, чтобы сохранить PNG как XLS" p="Используйте Cells SaveAs REST API для создания настраиваемых рабочих процессов электронных таблиц в Go. Это профессиональное решение для сохранения PNG в формате XLS и других форматах документов в Интернете с помощью Go." urlsection="saveas/png-to-xls/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как использовать Go API для сохранения PNG в виде XLS" >}}
