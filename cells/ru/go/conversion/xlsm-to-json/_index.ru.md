...
description:  Использование Aspose.Cells Cloud SDK для Go для преобразования файла формата XLSM в файл формата JSON.
