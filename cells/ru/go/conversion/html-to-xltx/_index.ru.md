...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте HTML в XLTX с помощью Cloud SDK Cells для Go." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Go для преобразования HTML в XLTX с использованием Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как преобразовать HTML в XLTX с помощью библиотеки Cloud Go Cells." >}}
