---
title: Экспорт ods в файл XLSX via Swift
...
url: /ru/swift/export/ods-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Экспорт ODS в файл XLSX в облаке" h2="Excel и экспорт таблиц OpenOffice с помощью Cloud SDK с открытым исходным кодом для Swift." >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Преобразовать ODS в файл XLSX в Cloud SDK для Swift" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift-код для преобразования ODS в XLSX" gistPath="" %}}
```swift
