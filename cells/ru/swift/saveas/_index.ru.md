---
title:  Сохранить как с помощью Swift
description:  Aspose.Cells Cloud REST API поддерживает сохранение файлов Excel в виде файлов форматирования с использованием Swift. SDK поддерживает языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
url: /ru/swift/saveas/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Сохранить как с помощью Swift" h2="Aspose.Cells Cloud SDK поддерживает сохранение книг в других форматах. Поддерживаемые форматы файлов включают более 30+ форматов файлов." p="Aspose.Cells Cloud REST API поддерживает сохранение файлов Excel в виде файлов форматирования с использованием Swift. SDK поддерживает языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Сохранить как с использованием ссылок расширения Swift" >}}
