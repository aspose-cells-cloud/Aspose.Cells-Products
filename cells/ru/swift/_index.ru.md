---
title:  Генератор и конвертер электронных таблиц Swift (облачный REST API)
description: REST API для извлечения, обработки, шифрования, преобразования и экспорта Microsoft и электронных таблиц OpenOffice в облаке via Swift SDK
weight: 130
url: /ru/swift
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Swift SDK для создания и преобразования электронных таблиц Excel" h2="REST API для извлечения, обработки, шифрования, преобразования и экспорта Microsoft и электронных таблиц OpenOffice в облаке via Swift SDK." logoImageSrc="/headers/aspose_cells-for-swift.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Swift" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK для Swift помогает программистам беспрепятственно интегрировать Microsoft Excel и функции просмотра и обработки электронных таблиц OpenOffice в свои облачные приложения, разработанные на Swift. Aspose.Cells Cloud SDK для Swift находится под лицензией MIT.</p>
<p>Aspose.Cells Cloud SDK для Swift позволяет вашим приложениям Swift извлекать электронные таблицы, рабочие листы и рабочие книги, хранящиеся в облаке, а также создавать новые электронные таблицы. Вы также можете настроить свой код Swift для обработки и изменения условного форматирования, диаграмм, задач, форм, фильтров, OleObjects, диапазонов, ListObjects и сводных таблиц из ваших приложений без установки какого-либо стороннего программного обеспечения.</p>
<p>Используйте Aspose.Cells Cloud SDK для Swift для преобразования рабочих листов Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) и OpenOffice (ODS) в другие популярные форматы, такие как XML (SpreadsheetML), TSV, CSV, TXT (TabDelimited). ), HTML, MHTML, DIF, TIFF, SVG, XPS, PDF и Markdown (MD). Вы также можете работать с форматами SXC и FODS, используя Aspose.Cells Cloud SDK для Swift.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-swift.svg" alt="Swift Excel SDK"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>Быстрый</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
Удалить определенные или все объекты ListObject на листе
 ...
 Начните работу с Excel SDK для обработки электронных таблиц
    ...
    <p>
 Чтобы начать работу с Aspose.Cells Cloud SDK для Swift, вам не нужно ничего устанавливать. Все, что вам нужно сделать, это создать учетную запись на
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose для облака
     </a>
 и получите информацию о приложении. Получив SID приложения &amp; ключ, вы готовы использовать Aspose.Cells Cloud SDK для Swift на любой платформе, поддерживающей REST API. Aspose.Cells Cloud SDK для Swift предоставляет все возможности для создания, редактирования и преобразования электронных таблиц. Он также позволяет извлекать данные из электронных таблиц для дальнейшей обработки или хранения.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Используя Aspose.Cells Cloud SDK для Swift, вы можете удалить определенную строку или все строки на листе, получить данные ячейки рабочего листа или стиль ячейки по имени ячейки, прочитать данные строки или столбца рабочего листа по его индексу, вычислить формулу ячейки, очистить содержимое ячейки, скопировать ячейку в другую ячейку, скопировать столбцы и строки рабочего листа, сгруппировать строки и столбцы рабочего листа, скрыть строки и столбцы рабочего листа, установить стили столбцов и строк рабочего листа, установить значение HTMLSTRING в ячейку, установить значение диапазона ячеек и изменить множество других параметров рабочего листа.
 ...
 Используйте возможности сводных таблиц &amp;amp;amp;amp;amp;amp; Диапазоны
    ...
    <p>
 Aspose.Cells Cloud SDK для Swift позволяет добавлять сводную таблицу на лист, добавлять или удалять поля сводной таблицы в сводной таблице, добавлять или удалять фильтр сводной таблицы для индекса сводной таблицы, обновлять стиль ячеек для сводной таблицы и вычислять данные сводной таблицы по ячейкам.
    </p>
    <p>
Aspose.Cells Cloud SDK для Swift также можно использовать для получения списка ячеек в диапазоне по имени диапазона или индексам столбца строки, установке ширины столбца диапазона, объединении диапазона ячеек в одну ячейку, перемещении текущего диапазона в целевой диапазон, наборов обведите границу диапазона ячеек, установите высоту строки диапазона, установите стиль диапазона, разъедините объединенные ячейки этого диапазона, поместите значение в диапазон и преобразуйте его тип данных, а также скопируйте диапазон на рабочий лист.
    </p>
   </div>
  </div>
 </div>
