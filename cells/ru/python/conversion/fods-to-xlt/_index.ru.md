---
title:  Преобразовать Excel FODS в XLT via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование FODS в XLT с Python" h2="Чтение, редактирование и экспорт Excel данных в другие форматы с помощью Cloud SDK с открытым исходным кодом для Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Преобразование FODS в XLT с Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Код для конвертации FODS в XLT" gistPath="" %}}
```python
