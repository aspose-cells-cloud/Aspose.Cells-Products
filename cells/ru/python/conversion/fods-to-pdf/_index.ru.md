---
title:  Конвертировать из Excel FODS в PDF via Python
...
url: /ru/python/conversion/fods-to-pdf/
family: cells
platformtag: python
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразуйте FODS в PDF с помощью Python" h2="Чтение, редактирование и экспорт данных Excel в другие форматы с помощью Cloud SDK с открытым исходным кодом для Python." >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS в PDF Преобразование с Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код Python для преобразования FODS в PDF" gistPath="" %}}
```python
