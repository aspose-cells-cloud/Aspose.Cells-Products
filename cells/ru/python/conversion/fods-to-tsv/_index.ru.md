---
title:  Конвертировать из Excel FODS в TSV via Python
...
url: /ru/python/conversion/fods-to-tsv/
family: cells
platformtag: python
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в TSV с помощью Python" h2="Чтение, редактирование и экспорт данных Excel в другие форматы с помощью Cloud SDK с открытым исходным кодом для Python." >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Преобразование FODS в TSV с Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Код для конвертации FODS в TSV" gistPath="" %}}
```python
