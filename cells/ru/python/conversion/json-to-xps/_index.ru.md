...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте JSON в XPS с помощью Cloud SDK Cells для Python." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Пример кода для преобразования JSON в XPS с помощью Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как преобразовать JSON в XPS с помощью библиотеки Cells Cloud Python." >}}
