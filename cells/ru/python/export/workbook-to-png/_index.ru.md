...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект WORKBOOK в файл формата PNG с помощью Cloud SDK Cells для Python." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в Python с использованием REST API для экспорта WORKBOOK в формат PNG из электронной таблицы" gistPath="" %}}
