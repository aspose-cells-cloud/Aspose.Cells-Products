...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте TXT в XPS с помощью Cloud SDK Cells для Ruby." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Ruby для преобразования TXT в XPS с использованием Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как преобразовать TXT в XPS с помощью библиотеки Cloud Ruby Cells." >}}
