...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте XLSX в SVG с помощью Cloud SDK Cells для Ruby." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Ruby для преобразования XLSX в SVG с использованием Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как преобразовать XLSX в SVG с помощью библиотеки Cloud Ruby Cells." >}}
