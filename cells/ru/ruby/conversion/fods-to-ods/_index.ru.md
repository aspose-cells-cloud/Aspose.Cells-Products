---
title: Преобразовать Excel FODS в ODS via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование FODS в ODS с помощью Ruby" h2="Чтение, редактирование и экспорт Excel данных в другие форматы с помощью Cloud SDK с открытым исходным кодом для Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code для преобразования FODS в ODS" gistPath="" %}}
```ruby
