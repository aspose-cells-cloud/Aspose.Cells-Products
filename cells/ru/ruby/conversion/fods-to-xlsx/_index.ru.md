---
title:  Конвертировать из Excel FODS в XLSX via Ruby
...
url: /ru/ruby/conversion/fods-to-xlsx/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в XLSX с помощью Ruby" h2="Чтение, редактирование и экспорт данных Excel в другие форматы с помощью Cloud SDK с открытым исходным кодом для Ruby." >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Преобразование FODS в XLSX с помощью Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код Ruby для преобразования FODS в XLSX" gistPath="" %}}
```ruby
