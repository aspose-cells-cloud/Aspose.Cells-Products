---
title:  Конвертировать из Excel FODS в PDF via Рубин
...
url: /ru/ruby/conversion/fods-to-pdf/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование FODS в PDF с помощью Ruby" h2="Чтение, редактирование и экспорт данных Excel в другие форматы с помощью Cloud SDK с открытым исходным кодом для Ruby." >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Преобразование FODS в PDF с помощью Ruby" %}}
...
1. Вызовите метод ```CellsApi.cells_save_as_post_document_save_as```, чтобы получить результирующий файл PDF.
...
{{% blocks/products/pf/agp/code-autogen title="Рубиновый код для преобразования FODS в PDF" gistPath="" %}}
```ruby
