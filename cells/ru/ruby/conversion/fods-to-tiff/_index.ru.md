...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование FODS в TIFF с помощью Ruby" h2="Чтение, редактирование и экспорт Excel данных в другие форматы с помощью Cloud SDK с открытым исходным кодом для Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Код Ruby для преобразования FODS в TIFF" gistPath="" %}}
```ruby
