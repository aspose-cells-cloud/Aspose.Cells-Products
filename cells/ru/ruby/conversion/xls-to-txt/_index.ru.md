...
{{< blocks/products/cells/cells-cloud-section title="Преобразование XLS в TXT с помощью Cloud SDK Cells для Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Ruby для преобразования XLS в TXT с использованием Cloud SDK Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как конвертировать XLS в TXT с помощью библиотеки Cloud Ruby Cells." >}}
