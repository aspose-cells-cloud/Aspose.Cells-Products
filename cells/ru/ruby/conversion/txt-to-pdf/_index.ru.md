...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте TXT в PDF с помощью Cloud SDK Cells для Ruby." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Ruby для преобразования TXT в PDF с использованием Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как преобразовать TXT в PDF с помощью библиотеки Cloud Ruby Cells." >}}
