---
title:  Экспорт WORKBOOK в JPG из электронной таблицы с использованием Ruby API
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Пример кода на Ruby с использованием REST API для экспорта WORKBOOK в формат JPG из электронной таблицы" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как использовать Ruby API для экспорта WORKBOOK в JPG" >}}
