...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект PICTURE в файл формата PNG с помощью Cloud SDK Cells для Ruby." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода на Ruby с использованием REST API для экспорта PICTURE в формат PNG из электронной таблицы" gistPath="" %}}
