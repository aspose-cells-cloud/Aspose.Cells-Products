...
{{< blocks/products/cells/cells-cloud-section title="Сохраните GIF-файл под номером SVG в Ruby." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Ruby для сохранения GIF как SVG с использованием REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как сохранить GIF как SVG с помощью библиотеки Cloud Ruby Cells." >}}
