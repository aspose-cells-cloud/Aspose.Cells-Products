...
{{< blocks/products/pf/i18n/upper-banner h1="Сборка Excel Приложения для чтения, просмотра и конвертации файлов via Ruby" h2="Расширяет ваши приложения Ruby для обработки и управления электронными таблицами Microsoft Excel и OpenOffice в облаке." logoImageSrc="/headers/aspose_cells-for-ruby.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Ruby" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK для Ruby помогает разработчикам получать доступ и читать Excel файлов, размещенных в облачном хранилище, без установки какого-либо стороннего программного обеспечения. Включите код Ruby для преобразования файлов XLS, XLSX, ODS в CSV, XML, Markdown (MD), PDF, XPS, TIFF, DIF и другие форматы.</p>
<p>Разрешите своим программам Ruby обрабатывать облачные рабочие листы, рабочие книги, электронные таблицы, а также получать доступ и изменять отдельные ячейки, строки и столбцы. Применяйте настраиваемые фильтры, ListObjects, OleObjects и условное форматирование с помощью кода Ruby. Aspose.Cells Cloud SDK для Ruby также позволяет шифровать, разделять, объединять, защищать и преобразовывать электронные таблицы.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-ruby.svg" alt="Ruby Excel SDK"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>Рубин</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-go.svg" alt="Ruby Cloud Excel SDK"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>Рубин</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
Суммируйте данные большого объекта ListObject или таблицы с помощью сводной таблицы
 ...
 Начните работу с Excel SDK для обработки электронных таблиц
    ...
    <p>
 Чтобы начать работу с Aspose.Cells Cloud SDK для Ruby, вам не нужно ничего устанавливать. Все, что вам нужно сделать, это создать учетную запись на
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose для облака
     </a>
 и получите информацию о приложении. Получив SID приложения &amp; key, вы готовы использовать Aspose.Cells Cloud SDK для Ruby на любой платформе, поддерживающей REST API. Aspose.Cells Cloud SDK для Ruby предоставляет все возможности для создания, редактирования и преобразования электронных таблиц. Он также позволяет извлекать данные из электронных таблиц для дальнейшей обработки или хранения.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-ruby" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Cells Cloud SDK для Ruby?" tabId="success-stories" >}}
