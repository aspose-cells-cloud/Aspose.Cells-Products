...
---
{{< blocks/products/cells/cells-cloud-banner h1="Сохранить ЦИФРЫ в формате XLS" h2="PHP библиотека для сохранения ЧИСЕЛ в формате XLS" p="Используйте SaveAs API из Cells Cloud для создания настраиваемых рабочих процессов с электронными таблицами в PHP. Это профессиональное решение для сохранения ЧИСЕЛ в формате XLS и других форматов документов в Интернете с помощью PHP." urlsection="saveas/numbers-to-xls/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как сохранить ЧИСЛА в формате XLS, используя библиотеку Cells Cloud PHP." >}}
