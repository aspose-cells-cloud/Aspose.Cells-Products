...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Сохраните файл CSV в формате XLSX по номеру PHP." >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Пример кода для сохранения CSV в формате XLSX с использованием REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Как использовать Cloud SDK Cells для PHP, чтобы сохранять файлы Excel в других форматах CSV, как XLSX." >}}
