...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект WORKBOOK в файл формата MD с помощью Cloud SDK Cells для PHP." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в PHP с использованием REST API для экспорта WORKBOOK в формат MD из электронной таблицы" gistPath="" %}}
