...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Экспортируйте объект PICTURE в файл формата WMF с помощью Cells Cloud SDK для PHP." >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Пример кода PHP с использованием REST API для экспорта PICTURE в формат WMF из электронной таблицы." gistPath="" %}}
