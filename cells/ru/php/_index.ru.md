---
title:  PHP Excel Обработка электронных таблиц в облаке (via REST API)
description: Манипулирование электронными таблицами REST API для создания, просмотра, изменения, шифрования и управления файлами Excel и OpenOffice в облаке.
weight: 100
url: /ru/php
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Обработка и преобразование электронных таблиц в облаке via PHP SDK" h2="Манипулирование электронными таблицами REST API для создания, просмотра, изменения, шифрования и управления файлами Excel и OpenOffice." logoImageSrc="/headers/aspose_cells-for-php.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for PHP" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK для PHP создан для разработчиков, чтобы помочь им улучшить свои облачные приложения для создания, просмотра и конвертации электронных таблиц, запрограммированные в PHP. Наш облачный SDK для процессора документов Excel основан на Aspose.Cells REST API. Aspose.Cells Cloud SDK для 076173 481 доступен по ссылке лицензия MIT.</p>
<p>Создайте лист Excel в PHP, работайте с автофигурами, автофильтрами, книгами, листами, строками, ячейками, диаграммами, условным форматированием, ListObjects, гиперссылками, OleObjects, сводными таблицами, фигурами, диапазонами, задачами, безопасностью, проверками листов и облаком. хранилище файлов, и все это с использованием простого облачного SDK Aspose.Cells для PHP.</p>
<p>Он также позволяет вашему коду PHP конвертировать документы электронных таблиц Microsoft Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) и OpenOffice (ODS) в PDF, XPS, TIFF, SVG, DIF. , & MD (уценка).</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-php.svg" alt="PHP Excel SDK"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-php.svg" alt="PHP Cloud Excel"><header>Aspose.Cells</header><footer> Облако<small> <em> для</em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
Advanced Excel Возможности работы с электронными таблицами
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Удалить определенные или все объекты OleObjects с рабочего листа
 ...
 Начните работу с Excel SDK для обработки электронных таблиц
    ...
    <p>
 Чтобы начать работу с Aspose.Cells Cloud SDK для PHP, вам не нужно ничего устанавливать. Все, что вам нужно сделать, это создать учетную запись на
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose для облака
     </a>
и получите информацию о вашем приложении. Получив идентификатор приложения SID &amp; ключ, вы готовы использовать Aspose.Cells Cloud SDK для PHP на любой платформе, поддерживающей REST API. Aspose.Cells Cloud SDK для PHP предоставляет вам все функции для создания, редактирования и преобразования электронных таблиц. Он также позволяет извлекать данные из электронных таблиц для дальнейшей обработки или хранения.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Обработка книг via Cloud SDK
    ...
    <p>
 Aspose.Cells Cloud SDK для PHP позволяет создавать, разделять, объединять, искать и заменять текст, защищать паролем, экспортировать в поддерживаемый формат файла, читать текстовые элементы книги, автоматически подгонять строки книги, игнорируя скрытые элементы, шифровать пароль книги и предоставлять ключ шифрования. длину, импортировать данные в рабочую книгу, рассчитать все формулы в рабочей книге, установить параметры расчета формул, предоставив стратегию точности и т. д., использовать интеллектуальный маркер, преобразовать рабочую книгу из содержимого запроса в другой формат, применить пароль, чтобы разрешить изменение содержимого.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-php" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Cells Cloud SDK для PHP?" tabId="success-stories" >}}
