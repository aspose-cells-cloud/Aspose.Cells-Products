...
description: Работа с электронными таблицами REST API для создания, просмотра, изменения, шифрования и управления файлами Excel и OpenOffice в облаке
weight: 100
url: /ru/php
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Обработка и преобразование электронных таблиц в облаке via PHP SDK" h2="Работа с электронными таблицами REST API для создания, просмотра, изменения, шифрования и управления файлами Excel и OpenOffice." logoImageSrc="/headers/aspose_cells-for-php.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for PHP" downloadUrl="" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Advanced Excel Работа с электронными таблицами Функции
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Используя Aspose.Cells Cloud SDK для PHP, вы можете удалить определенную строку или все строки на листе, получить данные ячейки рабочего листа или стиль ячейки по имени ячейки, прочитать данные строки или столбца рабочего листа по его индексу, вычислить формулу ячейки, очистить содержимое ячейки, скопировать ячейку в другую ячейку, скопировать столбцы и строки рабочего листа, сгруппировать строки и столбцы рабочего листа, скрыть строки и столбцы рабочего листа, установить стили столбцов и строк рабочего листа, установить значение HTMLSTRING в ячейку, установить значение диапазона ячеек и изменить множество других параметров рабочего листа.
 ...
 Используйте возможности сводных таблиц &amp;amp;amp;amp;amp;amp; Диапазоны
    ...
    <p>
 Aspose.Cells Cloud SDK для PHP позволяет добавить сводную таблицу на лист, добавить или удалить поля сводной таблицы в сводной таблице, добавить или удалить фильтр сводной таблицы для индекса сводной таблицы, обновить стиль ячейки для сводной таблицы и вычислить данные сводной таблицы для ячеек.
    </p>
    <p>
