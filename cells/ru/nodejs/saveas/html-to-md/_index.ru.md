...
{{< blocks/products/cells/cells-cloud-section title="Сохраните файл HTML как MD в NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода NodeJS для сохранения HTML как MD с использованием REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как сохранить HTML как MD с помощью библиотеки Cloud NodeJS Cells." >}}
