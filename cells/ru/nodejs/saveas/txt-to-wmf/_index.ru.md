...
{{< blocks/products/cells/cells-cloud-section title="Сохраните файл TXT как WMF в NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода NodeJS для сохранения TXT в формате WMF с использованием REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как сохранить TXT в формате WMF с помощью библиотеки Cloud NodeJS Cells." >}}
