...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте HTML в ODS с помощью Cloud SDK Cells для NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода NodeJS для преобразования HTML в ODS с использованием Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Узнайте, как преобразовать HTML в ODS с помощью облачной библиотеки NodeJS Cells." >}}
