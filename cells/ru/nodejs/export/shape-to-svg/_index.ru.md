...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект SHAPE в файл формата SVG с помощью Cloud SDK Cells для NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в NodeJS с использованием REST API для экспорта SHAPE в формат SVG из электронной таблицы" gistPath="" %}}
