...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект WORKBOOK в файл формата SQL с помощью Cloud SDK Cells для NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в NodeJS с использованием REST API для экспорта WORKBOOK в формат SQL из электронной таблицы" gistPath="" %}}
