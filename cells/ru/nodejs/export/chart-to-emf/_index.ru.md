---
title:  Экспортируйте CHART в EMF из Excel с помощью Cloud SDK Cells для NodeJS.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в NodeJS с использованием REST API для экспорта CHART в формат EMF из электронной таблицы" gistPath="" %}}
