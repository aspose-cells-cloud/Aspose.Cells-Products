...
{{< blocks/products/cells/cells-cloud-section title="Экспортируйте объект PICTURE в файл формата JPG с помощью Cloud SDK Cells для NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода в NodeJS с использованием REST API для экспорта PICTURE в формат JPG из электронной таблицы" gistPath="" %}}
