...
{{< blocks/products/cells/cells-cloud-section title="Преобразование MHTML в JPG с помощью Cloud SDK Cells для Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для преобразования MHTML в JPG с использованием Cloud SDK Cells" gistPath="" %}}
