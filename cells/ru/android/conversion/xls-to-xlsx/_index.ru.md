...
{{< blocks/products/cells/cells-cloud-section title="Конвертируйте XLS в XLSX с помощью Cloud SDK Cells для Android." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для преобразования XLS в XLSX с использованием Cloud SDK Cells" gistPath="" %}}
