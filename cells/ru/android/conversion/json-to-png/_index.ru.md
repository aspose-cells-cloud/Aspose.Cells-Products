...
{{< blocks/products/cells/cells-cloud-section title="Преобразуйте JSON в PNG с помощью Cloud SDK Cells для Android." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для преобразования JSON в PNG с использованием Cells Cloud SDK" gistPath="" %}}
