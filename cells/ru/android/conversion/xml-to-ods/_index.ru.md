...
{{< blocks/products/cells/cells-cloud-section title="Преобразование XML в ODS с помощью Cloud SDK Cells для Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для преобразования XML в ODS с использованием Cloud SDK Cells" gistPath="" %}}
