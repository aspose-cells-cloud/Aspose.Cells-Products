...
{{< blocks/products/cells/cells-cloud-section title="Преобразование XLTX в DIF с помощью Cloud SDK Cells для Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для преобразования XLTX в DIF с использованием Cloud SDK Cells" gistPath="" %}}
