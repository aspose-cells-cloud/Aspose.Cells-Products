---
title:  Защитите файлы Excel с помощью Android
description:  Aspose.Cells Cloud REST API поддерживает шифрование, расшифровку и добавление цифровых подписей в книги с помощью Android, а также предлагает пакеты SDK для различных языков программирования.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Защитите файлы Excel с помощью Android" h2="Aspose.Cells Cloud SDK поддерживает расшифровку, шифрование и цифровую подпись книг." p="Aspose.Cells Cloud REST API поддерживает шифрование, расшифровку и добавление цифровых подписей в книги с помощью Android, а также предлагает пакеты SDK для различных языков программирования." urlsection="protect/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells Cloud" subTitlepfName="Cells Cloud Feature" >}}

{{< blocks/products/cells/cells-cloud-card-row title="Защитите файлы Excel с помощью ссылок на расширения Android." >}}
