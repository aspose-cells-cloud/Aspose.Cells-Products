...
{{< blocks/products/cells/cells-cloud-section title="Сохраните файл CSV как XPS в Android." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для сохранения CSV как XPS с использованием REST API" gistPath="" %}}
