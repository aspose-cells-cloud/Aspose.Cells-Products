...
{{< blocks/products/cells/cells-cloud-section title="Сохраните файл ODS как MHTML в Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для сохранения ODS в формате MHTML с использованием REST API" gistPath="" %}}
