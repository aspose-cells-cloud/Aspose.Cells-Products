---
title:  Сохраните MHTML как XPS с помощью Android.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Пример кода Android для сохранения MHTML как XPS с использованием REST API" gistPath="" %}}
