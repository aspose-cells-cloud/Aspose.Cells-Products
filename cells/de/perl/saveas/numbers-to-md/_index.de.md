...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die Datei im NUMBERS-Format als Datei im MD-Format zu speichern.
url: /de/perl/saveas/numbers-to-md/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um ZAHLEN als MD zu speichern" h2="Perl-Bibliothek zum Speichern von NUMBERS als MD" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS als MD und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/numbers-to-md/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine NUMBERS-Datei als MD unter Perl" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um ZAHLEN als MD zu speichern" >}}
