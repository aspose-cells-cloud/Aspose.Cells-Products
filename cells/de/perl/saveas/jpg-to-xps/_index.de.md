---
title:  Speichern Sie JPG unter XPS mit Perl
description:  Verwendung des Aspose.Cells Cloud SDK für Perl zum Speichern der JPG-Formatdatei als XPS-Formatdatei.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie JPG unter XPS" h2="Perl-Bibliothek zum Speichern von JPG unter XPS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um JPG als XPS und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/jpg-to-xps/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codebeispiel zum Speichern von JPG als XPS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Perl, um Excel-Dateien in anderen JPG-Formaten als XPS zu speichern" >}}
