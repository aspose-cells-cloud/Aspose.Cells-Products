---
title: Speichern Sie XLTM als WMF API für Perl
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die XLTM-Formatdatei als WMF-Formatdatei zu speichern.
url: /de/perl/saveas/xltm-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um XLTM als WMF zu speichern" h2="Perl-Bibliothek zum Speichern von XLTM als WMF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLTM als WMF und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/xltm-to-wmf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von XLTM im WMF-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um XLTM als WMF zu speichern" >}}
