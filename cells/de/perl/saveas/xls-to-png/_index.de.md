...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLS unter PNG" h2="Perl-Bibliothek zum Speichern von XLS unter PNG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLS als PNG und andere Dokumentformate online unter Perl zu speichern." urlsection="saveas/xls-to-png/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codebeispiel zum Speichern von XLS als PNG mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Perl, um Excel-Dateien in anderen XLS-Formaten als PNG zu speichern" >}}
