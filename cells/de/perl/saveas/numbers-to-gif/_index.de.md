---
title:  ZAHLEN als GIF API für Perl speichern
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die Datei im NUMBERS-Format als Datei im GIF-Format zu speichern.
url: /de/perl/saveas/numbers-to-gif/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API um ZAHLEN als GIF zu speichern" h2="Perl-Bibliothek zum Speichern von ZAHLEN als GIF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS als GIF und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/numbers-to-gif/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von NUMBERS im GIF-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um ZAHLEN als GIF zu speichern" >}}
