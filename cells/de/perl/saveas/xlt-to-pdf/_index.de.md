---
title:  Speichern Sie XLT unter PDF mit Perl
description:  Verwendung des Aspose.Cells Cloud SDK für Perl zum Speichern der XLT-Formatdatei als PDF-Formatdatei.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Codebeispiel zum Speichern von XLT als PDF mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als PDF mithilfe der Cells Cloud Perl-Bibliothek." >}}
