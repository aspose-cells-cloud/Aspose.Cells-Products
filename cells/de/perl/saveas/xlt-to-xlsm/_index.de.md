...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLT als XLSM speichern" h2="Perl Bibliothek zum Speichern von XLT als XLSM" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLT als XLSM und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/xlt-to-xlsm/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als XLSM mithilfe der Cells Cloud Perl-Bibliothek." >}}
