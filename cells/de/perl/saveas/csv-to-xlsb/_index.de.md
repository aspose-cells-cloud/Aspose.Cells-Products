---
title:  Speichern Sie CSV als XLSB API für Perl
description:  Verwenden von Aspose.Cells Cloud SDK für Perl zum Speichern von CSV-Formatdateien als XLSB-Formatdateien.
url: /de/perl/saveas/csv-to-xlsb/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um CSV als XLSB zu speichern" h2="Perl-Bibliothek zum Speichern von CSV als XLSB" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um CSV als XLSB und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/csv-to-xlsb/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine CSV-Datei als XLSB unter Perl" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von CSV im XLSB-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um CSV als XLSB zu speichern" >}}
