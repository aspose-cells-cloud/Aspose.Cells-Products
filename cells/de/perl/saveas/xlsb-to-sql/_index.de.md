---
title:  Speichern Sie XLSB als SQL API für Perl
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die XLSB-Formatdatei als SQL-Formatdatei zu speichern.
url: /de/perl/saveas/xlsb-to-sql/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um XLSB als SQL zu speichern" h2="Perl-Bibliothek zum Speichern von XLSB als SQL" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLSB als SQL und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/xlsb-to-sql/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um XLSB als SQL zu speichern" >}}
