---
title:  Speichern Sie XLS als JSON mit Perl
description:  Verwendung des Cloud SDK Aspose.Cells für Perl zum Speichern der XLS-Formatdatei als JSON-Formatdatei.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS als JSON speichern" h2="Perl Bibliothek zum Speichern von XLS als JSON" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLS als JSON und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/xls-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLS-Datei als JSON in Perl" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Das Speichern von Dateiformaten von XLS als JSON ist eine komplexe Aufgabe. Alle Formatübergänge von XLS zu JSON werden von unserem SDK Perl durchgeführt, wobei der strukturelle und logische Hauptinhalt der Quell-XLS-Tabelle erhalten bleibt. Unsere Bibliothek Perl ist eine professionelle Lösung zum Online-Speichern von XLS als JSON-Dateien. Dieses Cloud-SDK bietet Perl-Entwicklern leistungsstarke Funktionen und perfekte JSON-Ausgabe.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Codebeispiel zum Speichern von XLS als JSON mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS als JSON mithilfe der Cells Cloud Perl-Bibliothek." >}}
