...
---
{{< blocks/products/cells/cells-cloud-banner h1="TXT als SXC speichern" h2="Perl Bibliothek zum Speichern von TXT als SXC" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um TXT als SXC und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/txt-to-sxc/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie TXT als SXC mit der Cells Cloud Perl-Bibliothek." >}}
