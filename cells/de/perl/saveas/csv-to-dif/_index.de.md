---
title:  Speichern Sie CSV als DIF API für Perl
description:  Verwenden von Aspose.Cells Cloud SDK für Perl zum Speichern von CSV-Formatdateien als DIF-Formatdateien.
url: /de/perl/saveas/csv-to-dif/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um CSV als DIF zu speichern" h2="Perl-Bibliothek zum Speichern von CSV als DIF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um CSV als DIF und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/csv-to-dif/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine CSV-Datei als DIF unter Perl" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von CSV im DIF-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um CSV als DIF zu speichern" >}}
