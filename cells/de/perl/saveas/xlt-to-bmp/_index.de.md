---
title:  Speichern Sie XLT unter BMP mit Perl
description:  Verwendung des Aspose.Cells Cloud SDK für Perl zum Speichern der XLT-Formatdatei als BMP-Formatdatei.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLT unter BMP" h2="Perl-Bibliothek zum Speichern von XLT als BMP" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLT als BMP und andere Dokumentformate online unter Perl zu speichern." urlsection="saveas/xlt-to-bmp/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei unter BMP in Perl" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Das Speichern von Dateiformaten von XLT als BMP ist eine komplexe Aufgabe. Alle Formatübergänge von XLT zu BMP werden von unserem Perl SDK durchgeführt, wobei der strukturelle und logische Hauptinhalt der Quell-XLT-Tabelle erhalten bleibt. Unsere Perl-Bibliothek ist eine professionelle Lösung zum Online-Speichern von XLT als BMP-Dateien. Dieses Cloud SDK bietet Perl-Entwicklern leistungsstarke Funktionen und perfekte BMP-Ausgabe.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Codebeispiel zum Speichern von XLT als BMP mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als BMP mithilfe der Cells Cloud Perl-Bibliothek." >}}
