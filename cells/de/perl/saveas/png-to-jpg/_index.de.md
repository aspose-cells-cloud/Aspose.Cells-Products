...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die Datei im Format PNG als Datei im JPG-Format zu speichern.
url: /de/perl/saveas/png-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API um PNG als JPG zu speichern" h2="Perl-Bibliothek, um PNG als JPG zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um PNG als JPG und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/png-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine PNG-Datei als JPG unter Perl" >}}
