---
title: Speichern Sie XLS als FODS API für Perl
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die Datei im XLS-Format als Datei im FODS-Format zu speichern.
url: /de/perl/saveas/xls-to-fods/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von XLS als FODS-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um XLS als FODS zu speichern" >}}
