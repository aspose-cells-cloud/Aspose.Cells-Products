...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die XLSX-Formatdatei als SQL-Formatdatei zu speichern.
url: /de/perl/saveas/xlsx-to-sql/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um XLSX als SQL zu speichern" h2="Perl-Bibliothek zum Speichern von XLSX als SQL" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLSX als SQL und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/xlsx-to-sql/" >}}
