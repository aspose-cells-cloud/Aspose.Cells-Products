---
title: Speichern Sie PNG als TSV API für Perl
description:  Verwenden Sie das Aspose.Cells Cloud SDK für Perl, um die Datei im PNG-Format als TSV-Formatdatei zu speichern.
url: /de/perl/saveas/png-to-tsv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API zu speichern PNG als TSV" h2="Perl-Bibliothek zum Speichern von PNG als TSV" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um PNG als TSV und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/png-to-tsv/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von PNG im TSV-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um PNG als TSV zu speichern" >}}
