---
title:  Speichern Sie JPG als GIF mit Perl
description:  Verwendung des Cloud SDK Aspose.Cells für Perl zum Speichern von JPG-Formatdateien als GIF-Formatdateien.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="JPG als GIF speichern" h2="Perl Bibliothek zum Speichern von JPG als GIF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um JPG als GIF und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/jpg-to-gif/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codebeispiel zum Speichern von JPG als GIF mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für Perl, um Excel-Dateien in anderen Formaten wie JPG und GIF zu speichern" >}}
