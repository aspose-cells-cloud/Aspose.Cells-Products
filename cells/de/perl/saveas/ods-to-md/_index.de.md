...
---
{{< blocks/products/cells/cells-cloud-banner h1="ODS als MD speichern" h2="Perl Bibliothek zum Speichern von ODS als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um ODS als MD und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/ods-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine ODS-Datei als MD in Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Codebeispiel zum Speichern von ODS als MD mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie ODS mit der Cells Cloud Perl-Bibliothek als MD speichern." >}}
