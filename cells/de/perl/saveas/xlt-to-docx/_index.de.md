...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLT als DOCX speichern" h2="Perl Bibliothek zum Speichern von XLT als DOCX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um XLT als DOCX und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/xlt-to-docx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codebeispiel zum Speichern von XLT als DOCX mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Perl, um Excel-Dateien in anderen Formaten, XLT und DOCX zu speichern" >}}
