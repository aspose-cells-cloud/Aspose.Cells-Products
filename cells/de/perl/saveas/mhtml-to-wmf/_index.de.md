---
title:  Speichern Sie MHTML als WMF API für Perl
description:  Verwenden von Aspose.Cells Cloud SDK für Perl zum Speichern einer MHTML-Formatdatei als WMF-Formatdatei.
url: /de/perl/saveas/mhtml-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um MHTML als WMF zu speichern" h2="Perl-Bibliothek zum Speichern von MHTML als WMF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um MHTML als WMF und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/mhtml-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine MHTML-Datei als WMF unter Perl" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von MHTML im WMF-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um MHTML als WMF zu speichern" >}}
