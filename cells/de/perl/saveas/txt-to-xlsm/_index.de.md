---
title:  Speichern Sie TXT als XLSM API für Perl
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die TXT-Formatdatei als XLSM-Formatdatei zu speichern.
url: /de/perl/saveas/txt-to-xlsm/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um TXT als XLSM zu speichern" h2="Perl-Bibliothek zum Speichern von TXT als XLSM" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um TXT als XLSM und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/txt-to-xlsm/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine TXT-Datei als XLSM unter Perl" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von TXT im XLSM-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Perl API, um TXT als XLSM zu speichern" >}}
