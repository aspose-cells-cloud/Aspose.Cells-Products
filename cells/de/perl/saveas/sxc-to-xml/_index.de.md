...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Perl, um die SXC-Formatdatei als XML-Formatdatei zu speichern.
url: /de/perl/saveas/sxc-to-xml/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, um SXC als XML zu speichern" h2="Perl-Bibliothek zum Speichern von SXC als XML" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um SXC als XML und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/sxc-to-xml/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine SXC-Datei als XML unter Perl" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Perl mit REST API zum Speichern von SXC als XML-Format" gistPath="" %}}
