...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie SXC als XML" h2="Perl Bibliothek zum Speichern von SXC als XML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung, um SXC als XML und andere Dokumentformate online mit Perl zu speichern." urlsection="saveas/sxc-to-xml/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codebeispiel zum Speichern von SXC als XML mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Perl, um Excel-Dateien in anderen SXC-Formaten als XML zu speichern" >}}
