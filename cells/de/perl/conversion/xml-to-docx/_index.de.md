...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XML in DOCX mit dem Cloud SDK Cells für Perl" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XML mit der Cells Cloud Perl-Bibliothek in DOCX konvertieren." >}}
