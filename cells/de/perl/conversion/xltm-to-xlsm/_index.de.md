...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLTM in XLSM mit dem Cloud SDK Cells für Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Codebeispiel für die Konvertierung von XLTM in XLSM mit Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLTM mit der Cells Cloud Perl-Bibliothek in XLSM konvertieren." >}}
