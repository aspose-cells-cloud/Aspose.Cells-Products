---
title: XLS zu MD konvertieren API für Perl
description:  Cloud-APIs und SDKs für Microsoft Excel und OpenOffice Calc. Konvertieren Sie die Tabelle in ein anderes Dateiformat.
url: /de/perl/conversion/xls-to-md/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API um XLS in MD umzuwandeln" h2="Perl Bibliothek zum Konvertieren von XLS in MD" p="Verwenden Sie Cells Conversion REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Perl zu erstellen. Dies ist eine professionelle Lösung zur Online-Konvertierung von XLS in MD und andere Dokumentformate unter Verwendung von Perl." urlsection="conversion/xls-to-md/" >}}
