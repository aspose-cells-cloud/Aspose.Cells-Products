...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie WORKBOOK nach MARKDOWN von Excel" h2="Perl Bibliothek zum Exportieren von WORKBOOK in eine MARKDOWN-Datei" p="Verwenden Sie Export API von Cells Cloud, um Excel Datei-interne Objekt-Workflows in Perl zu exportieren. Dies ist eine professionelle Lösung, um WORKBOOK online aus einer Tabellenkalkulation in eine MARKDOWN-Formatdatei mit Perl zu exportieren." urlsection="export/workbook-to-markdown/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das WORKBOOK-Objekt in eine Datei im MARKDOWN-Format mit dem Cloud SDK Cells für Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Perl mit REST API zum Exportieren von WORKBOOK aus der Tabellenkalkulation in das MARKDOWN-Format" gistPath="" %}}
