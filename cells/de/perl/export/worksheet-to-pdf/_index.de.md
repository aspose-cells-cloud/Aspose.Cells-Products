...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie das Arbeitsblatt von Excel nach PDF" h2="Perl-Bibliothek zum Exportieren von WORKSHEET in die PDF-Datei" p="Verwenden Sie Export API von Cells Cloud, um Excel-Datei-interne Objekt-Workflows in Perl zu exportieren. Dies ist eine professionelle Lösung, um ARBEITSBLATT online aus einer Tabellenkalkulation in eine PDF-Formatdatei mit Perl zu exportieren." urlsection="export/worksheet-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das WORKSHEET-Objekt in die Formatdatei PDF mit dem Cloud SDK Cells für Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Perl mit REST API zum Exportieren von WORKSHEET in das PDF-Format aus der Tabellenkalkulation" gistPath="" %}}
