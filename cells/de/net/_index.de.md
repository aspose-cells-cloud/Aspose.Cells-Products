---
title: Leichtgewichtige Tabellenkalkulationsverwaltung | Cloud Excel & OpenOffice API
description: Entdecken Sie eine benutzerfreundliche Low-Code-Lösung zur Verwaltung Ihrer Tabellenkalkulationen in der Cloud. Mit unserem RESTful API können Sie Excel- und OpenOffice-Dateien einfach online erstellen, lesen, schreiben, zusammenführen, teilen, verschlüsseln und konvertieren. Optimieren Sie Ihren Workflow mit unseren effizienten, schlanken Cloud-Diensten.
baskewi: hugo,cells
weight: 90
---
...
{{< blocks/products/cells/languge-index-ferturecard title="Konvertieren" desc="Converts a spreadsheet on a local drive to the specified format." url="/cells/net/conversion" imgurl="/cells/images/convert.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Verschmelzen" desc="Merge local spreadsheet files into a specified format file." url="/cells/net/merge" imgurl="/cells/images/merge.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Schützen" desc="Applies dual-layer password protection to Excel spreadsheets, supporting both open and modify passwords with encryption." url="/cells/net/protect" imgurl="/cells/images/protect.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Speichern unter" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/net/saveas" imgurl="/cells/images/saveas.svg" >}}
...
{{< blocks/products/cells/languge-index-ferturecard title="Klar" desc="Clear cell formats in the worksheet." url="/cells/net/clear" imgurl="/cells/images/clear.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Hintergrund" desc="Set background in the workbook." url="/cells/net/background" imgurl="/cells/images/background.svg" >}}
