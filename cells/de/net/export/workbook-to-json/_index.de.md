---
title:  Exportieren Sie WORKBOOK aus der Tabellenkalkulation nach JSON mit C# API
...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportieren Sie das WORKBOOK-Objekt in die JSON-Formatdatei in C#" >}}
