...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie CHART nach WMF von Excel" h2="C#-Bibliothek zum Exportieren von CHART in eine WMF-Datei" p="Verwenden Sie Export API von Cells Cloud, um Excel Datei-interne Objekt-Workflows in Net zu exportieren. Dies ist eine professionelle Lösung, um CHART online mit C# aus einer Tabellenkalkulation in eine WMF-Formatdatei zu exportieren." urlsection="export/chart-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das CHART-Objekt in eine Datei im WMF-Format mit Cells Cloud SDK für C#" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Net, um Objekte von Excel CHART nach WMF zu exportieren" >}}
