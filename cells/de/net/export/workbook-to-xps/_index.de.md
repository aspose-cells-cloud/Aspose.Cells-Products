...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie die Arbeitsmappe von Excel nach XPS" h2="C#-Bibliothek zum Exportieren von WORKBOOK in die Datei XPS" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Net zu exportieren. Dies ist eine professionelle Lösung zum Exportieren einer Arbeitsmappe in das Format XPS aus einer Tabellenkalkulation online mit C#." urlsection="export/workbook-to-xps/" >}}
