...
---
{{< blocks/products/cells/cells-cloud-banner h1="SXC als XLTX speichern" h2="C# Bibliothek zum Speichern von SXC als XLTX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von SXC als XLTX und anderen Dokumentformaten unter C#." urlsection="saveas/sxc-to-xltx/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als XLTX mithilfe der Cloud Net-Bibliothek Cells." >}}
