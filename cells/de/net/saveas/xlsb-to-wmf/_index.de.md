...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um Dateien im XLSB-Format als Dateien im WMF-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLSB als WMF" h2="C# Bibliothek zum Speichern von XLSB als WMF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung, um XLSB als WMF und andere Dokumentformate online mit C# zu speichern." urlsection="saveas/xlsb-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSB-Datei als WMF unter C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Codebeispiel zum Speichern von XLSB als WMF mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als WMF mithilfe der Cloud Net-Bibliothek Cells." >}}
