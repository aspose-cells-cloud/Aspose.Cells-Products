...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS speichern unter XPS" h2="C#-Bibliothek zum Speichern von XLS unter XPS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung, um XLS unter XPS und andere Dokumentformate online unter C# zu speichern." urlsection="saveas/xls-to-xps/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS unter XPS mithilfe der Cloud Net-Bibliothek Cells." >}}
