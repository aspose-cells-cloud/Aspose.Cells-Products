...
{{< blocks/products/cells/cells-cloud-upper-banner h1="CSV als XML speichern" h2="C# Bibliothek zum Speichern von CSV als XML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von CSV als XML und anderen Dokumentformaten unter C#." urlsection="saveas/csv-to-xml/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Codebeispiel zum Speichern von CSV als XML mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Net, um Excel-Dateien in anderen Formaten, CSV und XML, zu speichern" >}}
