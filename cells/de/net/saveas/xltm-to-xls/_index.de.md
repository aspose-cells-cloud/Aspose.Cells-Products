...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLTM als XLS speichern" h2="C# Bibliothek zum Speichern von XLTM als XLS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLTM als XLS und anderen Dokumentformaten unter C#." urlsection="saveas/xltm-to-xls/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLTM als XLS mithilfe der Cloud Net-Bibliothek Cells." >}}
