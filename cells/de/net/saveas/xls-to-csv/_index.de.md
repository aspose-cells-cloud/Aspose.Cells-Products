...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLS als CSV speichern" h2="C# Bibliothek zum Speichern von XLS als CSV" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLS als CSV und anderen Dokumentformaten unter C#." urlsection="saveas/xls-to-csv/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Net, um Excel-Dateien in anderen Formaten, XLS und CSV zu speichern" >}}
