...
---
{{< blocks/products/cells/cells-cloud-banner h1="SXC als SQL speichern" h2="C# Bibliothek zum Speichern von SXC als SQL" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von SXC als SQL und anderen Dokumentformaten unter C#." urlsection="saveas/sxc-to-sql/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als SQL mithilfe der Cloud Net-Bibliothek Cells." >}}
