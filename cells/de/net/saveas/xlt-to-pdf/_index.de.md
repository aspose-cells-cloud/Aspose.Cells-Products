---
title:  Speichern Sie XLT unter PDF mit C#
description:  Verwendung des Aspose.Cells Cloud SDK für C# zum Speichern der XLT-Formatdatei als PDF-Formatdatei.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLT unter PDF" h2="C#-Bibliothek zum Speichern von XLT als PDF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung, um XLT als PDF und andere Dokumentformate online unter C# zu speichern." urlsection="saveas/xlt-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei unter PDF in C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Codebeispiel zum Speichern von XLT als PDF mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als PDF mithilfe der Cloud Net-Bibliothek Cells." >}}
