...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS als TXT speichern" h2="C# Bibliothek zum Speichern von XLS als TXT" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLS als TXT und anderen Dokumentformaten unter C#." urlsection="saveas/xls-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLS-Datei als TXT unter C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Codebeispiel zum Speichern von XLS als TXT mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLS mit der Cloud Net-Bibliothek Cells als TXT speichern." >}}
