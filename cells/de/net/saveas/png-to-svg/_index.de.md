...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie PNG als SVG" h2="C#-Bibliothek zum Speichern von PNG als SVG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net zu erstellen. Dies ist eine professionelle Lösung, um PNG als SVG und andere Dokumentformate online unter C# zu speichern." urlsection="saveas/png-to-svg/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Codebeispiel zum Speichern von PNG als SVG mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Net, um Excel-Dateien in anderen Formaten zu speichern, PNG als SVG" >}}
