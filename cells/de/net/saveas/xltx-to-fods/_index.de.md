...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um Dateien im XLTX-Format als Dateien im FODS-Format zu speichern.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Codebeispiel zum Speichern von XLTX als FODS mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLTX als FODS mithilfe der Cloud Net-Bibliothek Cells." >}}
