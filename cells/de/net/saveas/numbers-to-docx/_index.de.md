...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um Dateien im NUMBERS-Format als Dateien im DOCX-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie NUMBERS als DOCX" h2="C# Bibliothek zum Speichern von NUMBERS als DOCX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows im Internet zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS online als DOCX und andere Dokumentformate mit C# zu speichern." urlsection="saveas/numbers-to-docx/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie NUMBERS als DOCX mithilfe der Cells Cloud Net-Bibliothek." >}}
