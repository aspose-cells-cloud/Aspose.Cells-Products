...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um Dateien im NUMBERS-Format als Dateien im XLSX-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie NUMBERS als XLSX mithilfe der Cloud Net-Bibliothek Cells." >}}
