...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um Dateien im SXC-Format als Dateien im TXT-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie SXC als TXT" h2="C# Bibliothek zum Speichern von SXC als TXT" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows im Internet zu erstellen. Dies ist eine professionelle Lösung, um SXC als TXT und andere Dokumentformate online mit C# zu speichern." urlsection="saveas/sxc-to-txt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als TXT mithilfe der Cloud Net-Bibliothek Cells." >}}
