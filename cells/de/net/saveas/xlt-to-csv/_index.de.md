---
title:  Speichern Sie XLT als CSV mit C#
description:  Verwendung des Cloud SDK Aspose.Cells für C# zum Speichern von XLT-Formatdateien als CSV-Formatdateien.
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Codebeispiel zum Speichern von XLT als CSV mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Net, um Excel-Dateien in anderen Formaten, XLT als CSV, zu speichern" >}}
