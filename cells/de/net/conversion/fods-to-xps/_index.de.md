---
title:  Wandeln Sie FODS in XPS via .NET um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XPS in der Cloud" h2="Excel & OpenOffice-Tabellenkonvertierung mit Open Source Cloud SDK for .NET" >}}
...
1. Rufen Sie die ```CellsApi.CellsSaveAsPostDocumentSaveAs```-Methode auf, um die resultierende XPS-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für FODS zu XPS Konvertierung" gistPath="" %}}
```cs
