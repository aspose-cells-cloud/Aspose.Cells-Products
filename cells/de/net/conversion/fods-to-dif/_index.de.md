...
{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-DIF-Konvertierung in .NET-Apps" %}}
...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende DIF-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Umwandlung von FODS in DIF" gistPath="" %}}
```cs
