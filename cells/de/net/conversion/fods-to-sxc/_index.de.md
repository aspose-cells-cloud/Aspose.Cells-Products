...
{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS zu SXC in .NET-Apps" %}}
...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende SXC-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Umwandlung von FODS in SXC" gistPath="" %}}
```cs
