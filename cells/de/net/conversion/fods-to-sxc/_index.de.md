---
title:  Konvertieren Sie FODS in SXC via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in SXC in der Cloud" h2="Excel & OpenOffice-Tabellenkonvertierung mit Open-Source-Cloud-SDK for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in SXC in .NET Apps" %}}
...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende SXC-Datei abzurufen
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Konvertierung von FODS in SXC" gistPath="" %}}
```cs
