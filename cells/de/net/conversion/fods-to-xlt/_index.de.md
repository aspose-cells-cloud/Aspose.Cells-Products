...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende XLT-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Umwandlung von FODS in XLT" gistPath="" %}}
```cs
