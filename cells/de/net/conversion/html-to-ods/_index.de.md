...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie HTML in ODS mit dem Cloud SDK Cells für C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Codebeispiel für die Konvertierung von HTML in ODS mit Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie HTML mithilfe der Cloud Net-Bibliothek Cells in ODS konvertieren." >}}
