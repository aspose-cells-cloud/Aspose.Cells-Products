...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um eine Datei im XLS-Format in eine Datei im XLTX-Format zu konvertieren.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Konvertieren Sie XLS in XLTX" h2="C# Bibliothek zum Konvertieren von XLS in XLTX" p="Verwenden Sie die Konvertierung API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net-Projekten zu erstellen. Dies ist eine professionelle Lösung zum Online-Konvertieren von XLS in XLTX und andere Dokumentformate mit C#." urlsection="conversion/xls-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLS in XLTX mit Cells Cloud SDK für C#" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XLS in XLTX mithilfe der Cloud Net-Bibliothek Cells." >}}
