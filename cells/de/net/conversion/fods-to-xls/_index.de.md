---
title:  Konvertieren Sie FODS in XLS via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLS in der Cloud" h2="Excel & OpenOffice-Tabellenkonvertierung mit Open Source Cloud SDK for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in XLS in .NET-Apps" %}}
...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende XLS-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Umwandlung von FODS in XLS" gistPath="" %}}
```cs
