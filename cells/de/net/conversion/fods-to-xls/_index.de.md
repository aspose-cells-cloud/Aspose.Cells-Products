...
{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-XLS-Konvertierung in .NET-Apps" %}}
...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende XLS-Datei abzurufen
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Konvertierung von FODS in XLS" gistPath="" %}}
```cs
