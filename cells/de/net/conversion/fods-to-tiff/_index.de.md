---
title:  Wandeln Sie FODS in TIFF via .NET um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in TIFF in der Cloud" h2="Excel & OpenOffice-Tabellenkonvertierung mit Open Source Cloud SDK for .NET" >}}
...
1. Rufen Sie die ```CellsApi.CellsSaveAsPostDocumentSaveAs```-Methode auf, um die resultierende TIFF-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für FODS zu TIFF Konvertierung" gistPath="" %}}
```cs
