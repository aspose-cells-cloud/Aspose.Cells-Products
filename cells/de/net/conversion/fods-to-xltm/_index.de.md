...
{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-XLTM-Konvertierung in .NET-Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Konvertierung von FODS in XLTM" gistPath="" %}}
```cs
