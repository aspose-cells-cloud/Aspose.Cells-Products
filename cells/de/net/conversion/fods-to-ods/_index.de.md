...
{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS zu ODS in .NET-Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Konvertierung von FODS zu ODS" gistPath="" %}}
```cs
