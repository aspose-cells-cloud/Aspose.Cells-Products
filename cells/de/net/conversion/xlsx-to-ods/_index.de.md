...
description:  Verwenden des Aspose.Cells Cloud SDK für C#, um eine Datei im XLSX-Format in eine Datei im ODS-Format zu konvertieren.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Konvertieren Sie XLSX in ODS" h2="C# Bibliothek zur Konvertierung von XLSX in ODS" p="Verwenden Sie die Konvertierung API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Net-Projekten zu erstellen. Dies ist eine professionelle Lösung zum Online-Konvertieren von XLSX in ODS und andere Dokumentformate mit C#." urlsection="conversion/xlsx-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLSX in ODS mit Cells Cloud SDK für C#" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XLSX in ODS mithilfe der Cloud Net-Bibliothek Cells." >}}
