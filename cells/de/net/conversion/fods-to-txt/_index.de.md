...
{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in TXT in .NET-Apps" %}}
...
1. Rufen Sie die Methode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` auf, um die resultierende TXT-Datei abzurufen
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code für die Konvertierung von FODS in TXT" gistPath="" %}}
```cs
