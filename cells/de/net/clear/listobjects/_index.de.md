...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Objekte in der lokalen Liste Microsoft Excel und in der OpenOffice Calc-Tabelle löschen – C# REST API" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Net zum Löschen von Listenobjekten" >}}
