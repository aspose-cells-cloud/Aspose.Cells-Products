...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API zum Speichern von MHTML als XLT" h2="Swift-Bibliothek zum Speichern von MHTML als XLT" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Swift zu erstellen. Dies ist eine professionelle Lösung, um MHTML als XLT und andere Dokumentformate online mit Swift zu speichern." urlsection="saveas/mhtml-to-xlt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Swift API, um MHTML als XLT zu speichern" >}}
