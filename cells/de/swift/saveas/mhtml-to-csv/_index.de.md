---
title:  Speichern Sie MHTML als CSV API für Swift
description:  Verwenden von Aspose.Cells Cloud SDK für Swift zum Speichern von MHTML-Formatdateien als CSV-Formatdateien.
url: /de/swift/saveas/mhtml-to-csv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API zum Speichern von MHTML als CSV" h2="Swift-Bibliothek zum Speichern von MHTML als CSV" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Swift zu erstellen. Dies ist eine professionelle Lösung, um MHTML als CSV und andere Dokumentformate online mit Swift zu speichern." urlsection="saveas/mhtml-to-csv/" >}}
