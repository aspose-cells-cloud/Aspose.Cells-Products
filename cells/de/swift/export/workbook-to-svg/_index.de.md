---
title: Exportieren Sie WORKBOOK aus der Tabelle mit Swift API nach SVG
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API zum Exportieren der Arbeitsmappe in die Datei SVG" h2="Swift-Bibliothek zum Exportieren von WORKBOOK in die Datei SVG" p="Verwenden Sie Cells Export REST API, um Arbeitsabläufe interner Tabellenkalkulationsobjekte in Swift zu exportieren. Dies ist eine professionelle Lösung zum Exportieren einer ARBEITSBUCH-Datei aus einer Tabellenkalkulation online in das Format SVG mit Swift." urlsection="export/workbook-to-svg/" >}}
