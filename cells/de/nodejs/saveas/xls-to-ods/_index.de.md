...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLS als ODS speichern" h2="NodeJS-Bibliothek zum Speichern von XLS als ODS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLS als ODS und anderen Dokumentformaten mit NodeJS." urlsection="saveas/xls-to-ods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="NodeJS-Codebeispiel zum Speichern von XLS als ODS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Node, um Excel-Dateien in anderen Formaten, XLS und ODS zu speichern" >}}
