---
title:  Speichern Sie XLT unter EMF API für NodeJS
description: Verwenden Sie das Cloud SDK Aspose.Cells für NodeJS, um die Datei im XLT-Format als Datei im Format EMF zu speichern.
url: /de/nodejs/saveas/xlt-to-emf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="NodeJS API, um XLT als EMF zu speichern" h2="NodeJS-Bibliothek zum Speichern von XLT als EMF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um XLT als EMF und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/xlt-to-emf/" >}}
