---
title:  Speichern Sie XLT als XML mit NodeJS
description:  Verwenden Sie Aspose.Cells Cloud SDK für NodeJS, um Dateien im XLT-Format als Dateien im XML-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLT als XML speichern" h2="NodeJS-Bibliothek zum Speichern von XLT als XML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um XLT als XML und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/xlt-to-xml/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei als XML in NodeJS" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Das Speichern von Dateiformaten von XLT als XML ist eine komplexe Aufgabe. Alle Formatübergänge von XLT zu XML werden von unserem NodeJS SDK durchgeführt, wobei der strukturelle und logische Hauptinhalt der Quell-XLT-Tabelle erhalten bleibt. Unsere NodeJS-Bibliothek ist eine professionelle Lösung zum Online-Speichern von XLT als XML-Dateien. Dieses Cloud SDK bietet NodeJS-Entwicklern leistungsstarke Funktionen und perfekte XML-Ausgabe.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="NodeJS-Codebeispiel zum Speichern von XLT als XML mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als XML mithilfe der Cloud NodeJS-Bibliothek Cells." >}}
