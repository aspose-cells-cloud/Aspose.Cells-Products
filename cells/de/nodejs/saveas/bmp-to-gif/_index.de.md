...
description: Verwenden Sie das Cloud SDK Aspose.Cells für NodeJS, um die Datei im Format BMP als Datei im GIF-Format zu speichern.
url: /de/nodejs/saveas/bmp-to-gif/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="NodeJS API, um BMP als GIF zu speichern" h2="NodeJS-Bibliothek zum Speichern von BMP als GIF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von BMP als GIF und anderen Dokumentformaten mit NodeJS." urlsection="saveas/bmp-to-gif/" >}}
