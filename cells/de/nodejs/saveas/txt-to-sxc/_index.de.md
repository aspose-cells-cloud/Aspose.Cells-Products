...
---
{{< blocks/products/cells/cells-cloud-banner h1="TXT als SXC speichern" h2="NodeJS-Bibliothek zum Speichern von TXT als SXC" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um TXT als SXC und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/txt-to-sxc/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie TXT als SXC mithilfe der Cloud NodeJS-Bibliothek Cells." >}}
