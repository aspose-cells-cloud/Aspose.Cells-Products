...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLSX als XLTM" h2="NodeJS-Bibliothek zum Speichern von XLSX als XLTM" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um XLSX als XLTM und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/xlsx-to-xltm/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="NodeJS-Codebeispiel zum Speichern von XLSX als XLTM mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Node, um Excel-Dateien in den anderen Formaten XLSX und XLTM zu speichern" >}}
