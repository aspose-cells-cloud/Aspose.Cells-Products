...
---
{{< blocks/products/cells/cells-cloud-banner h1="SXC als XLTX speichern" h2="NodeJS-Bibliothek zum Speichern von SXC als XLTX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um SXC als XLTX und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/sxc-to-xltx/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als XLTX mithilfe der Cloud NodeJS-Bibliothek Cells." >}}
