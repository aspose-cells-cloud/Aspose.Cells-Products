---
title:  Speichern Sie Zahlen als TXT mit NodeJS
description:  Verwenden Sie Aspose.Cells Cloud SDK für NodeJS, um Dateien im NUMBERS-Format als Dateien im TXT-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="ZAHLEN als TXT speichern" h2="NodeJS-Bibliothek zum Speichern von ZAHLEN als TXT" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS als TXT und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/numbers-to-txt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie NUMBERS als TXT mit der Cloud NodeJS-Bibliothek Cells." >}}
