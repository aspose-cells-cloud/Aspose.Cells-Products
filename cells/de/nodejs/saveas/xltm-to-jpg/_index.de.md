...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLTM als JPG speichern" h2="NodeJS-Bibliothek zum Speichern von XLTM als JPG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in NodeJS zu erstellen. Dies ist eine professionelle Lösung, um XLTM als JPG und andere Dokumentformate online mit NodeJS zu speichern." urlsection="saveas/xltm-to-jpg/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="NodeJS-Codebeispiel zum Speichern von XLTM als JPG mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Node, um Excel-Dateien in anderen XLTM-Formaten als JPG zu speichern" >}}
