---
title:  Exportieren Sie ARBEITSBLATT aus der Tabelle mit NodeJS API nach DOCX
description:  Aspose.Cells Cloud REST API unterstützt den Export von Dateien im {0}-Format in {1} mit {2}.
url: /de/nodejs/export/worksheet-to-docx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="NodeJS API zum Exportieren von ARBEITSBLATT in eine DOCX-Datei" h2="NodeJS-Bibliothek zum Exportieren von WORKSHEET in eine DOCX-Datei" p="Verwenden Sie Cells Export REST API, um Arbeitsabläufe interner Tabellenkalkulationsobjekte in NodeJS zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von WORKSHEET in eine DOCX-Formatdatei aus einer Tabellenkalkulation online mit NodeJS." urlsection="export/worksheet-to-docx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportieren Sie das WORKSHEET-Objekt in eine DOCX-Formatdatei in NodeJS" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Knoten API, um ARBEITSBLATT nach DOCX zu exportieren" >}}
