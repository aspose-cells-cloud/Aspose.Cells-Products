...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exportieren Sie JSON in eine DOCX-Datei in der Cloud" h2="Excel & Export von OpenOffice-Tabellenkalkulationen mit Open-Source-Cloud-SDK für NodeJS" >}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS-Code für die JSON-zu-DOCX-Konvertierung" gistPath="" %}}
```js
