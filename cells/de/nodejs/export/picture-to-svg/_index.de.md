---
title:  Exportieren Sie PICTURE aus der Tabelle mit NodeJS API nach SVG
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie den Knoten API, um PICTURE nach SVG zu exportieren" >}}
