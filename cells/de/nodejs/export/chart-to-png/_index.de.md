...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Diagramm von Excel nach PNG exportieren" h2="NodeJS-Bibliothek zum Exportieren von CHART in die Datei PNG" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in NodeJS zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von CHART in eine Datei im Format PNG aus einer Tabellenkalkulation online mit NodeJS." urlsection="export/chart-to-png/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportieren Sie das CHART-Objekt in eine Datei im Format PNG mit dem Cloud SDK Cells für NodeJS" >}}
