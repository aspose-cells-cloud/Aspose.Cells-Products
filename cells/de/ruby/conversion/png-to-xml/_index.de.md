...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie PNG in XML mit dem Cloud SDK Cells für Ruby" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie PNG mithilfe der Cloud Ruby-Bibliothek Cells in XML konvertieren." >}}
