...
description:  Verwenden von Aspose.Cells Cloud SDK für Ruby zum Konvertieren einer Datei im JSON-Format in eine Datei im DIF-Format.
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Ruby API, um JSON in DIF zu konvertieren" >}}
