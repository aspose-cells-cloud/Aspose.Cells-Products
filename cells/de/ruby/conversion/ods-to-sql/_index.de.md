...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Konvertieren Sie ODS in SQL" h2="Ruby-Bibliothek zur Konvertierung von ODS in SQL" p="Verwenden Sie die Konvertierung API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby-Projekten zu erstellen. Dies ist eine professionelle Lösung zum Online-Konvertieren von ODS in SQL und andere Dokumentformate mit Ruby." urlsection="conversion/ods-to-sql/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Konvertieren Sie ODS in SQL mit dem Cloud SDK Cells für Ruby" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby-Codebeispiel für die Konvertierung von ODS in SQL mithilfe des Cloud SDK Cells" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Excel-Dateien in andere Formate, ODS in SQL, zu konvertieren" >}}
