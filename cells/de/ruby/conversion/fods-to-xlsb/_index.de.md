...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in XLSB" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS zu XLSB mit Ruby" %}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende XLSB-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für die Konvertierung von FODS in XLSB" gistPath="" %}}
```ruby
