...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in XLSM" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit dem Open-Source-Cloud-SDK für Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-XLSM-Konvertierung mit Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für die Konvertierung von FODS in XLSM" gistPath="" %}}
```ruby
