---
title:  Wandeln Sie von Excel FODS in PDF via Rubin um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in PDF" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für Konvertierung von FODS in PDF" gistPath="" %}}
```ruby
