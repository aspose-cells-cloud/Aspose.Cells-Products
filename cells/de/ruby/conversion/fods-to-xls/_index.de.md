---
title:  Wandeln Sie von Excel FODS in XLS via Ruby um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in XLS" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Ruby" >}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende XLS-Datei zu erhalten
