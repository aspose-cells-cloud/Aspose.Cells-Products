---
title:  Konvertieren Sie von Excel FODS in XML via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in XML" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für die FODS-zu-XML-Konvertierung" gistPath="" %}}
```ruby
