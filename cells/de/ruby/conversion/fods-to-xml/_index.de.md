...
outformat: XML
platform: Ruby
otherformats: XML HTML FODS DIF XLTX XLTM TIFF XLS XLSX TXT PDF TSV CSV MD MHTML XLSB 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in XML" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit dem Open-Source-Cloud-SDK für Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-XML-Konvertierung mit Ruby" %}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende XML-Datei abzurufen
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für die Konvertierung von FODS in XML" gistPath="" %}}
```ruby
