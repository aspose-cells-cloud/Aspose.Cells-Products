...
outformat: SVG
platform: Ruby
otherformats: XLTX XLSB DIF XLSX TSV XPS HTML MHTML FODS XLTM TIFF XLSM CSV XML PDF MD 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in SVG" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit dem Open-Source-Cloud-SDK für Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS zu SVG Konvertierung mit Ruby" %}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende Datei SVG zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für die Konvertierung von FODS in SVG" gistPath="" %}}
```ruby
