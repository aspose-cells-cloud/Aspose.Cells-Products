---
title:  Wandeln Sie von Excel FODS in SVG via Rubin um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Ruby in SVG" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Ruby" >}}
...
1. Rufen Sie die ```CellsApi.cells_save_as_post_document_save_as```-Methode auf, um die resultierende SVG-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-Code für Konvertierung von FODS in SVG" gistPath="" %}}
```ruby
