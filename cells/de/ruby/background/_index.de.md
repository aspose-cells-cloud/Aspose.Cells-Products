---
title:  Legen Sie mit Ruby einen Hintergrund für Excel-Dateien fest
description:  Aspose.Cells Cloud REST API unterstützt das Festlegen des Hintergrunds für Excel-Dateien mit Ruby und bietet SDKs für verschiedene Programmiersprachen.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Legen Sie mit Ruby einen Hintergrund für Excel-Dateien fest" h2="Aspose.Cells Cloud SDK unterstützt das Festlegen von Hintergründen in Excel-Dateien." p="Aspose.Cells Cloud REST API unterstützt das Festlegen des Hintergrunds für Excel-Dateien mit Ruby und bietet SDKs für verschiedene Programmiersprachen." urlsection="background/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells Cloud" subTitlepfName="Cells Cloud Feature" >}}

{{< blocks/products/cells/cells-cloud-card-row title="Legen Sie mithilfe von Ruby-Erweiterungslinks einen Hintergrund für Excel-Dateien fest" >}}
