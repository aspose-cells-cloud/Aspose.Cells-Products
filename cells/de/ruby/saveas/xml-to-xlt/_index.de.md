...
---
{{< blocks/products/cells/cells-cloud-banner h1="XML als XLT speichern" h2="Ruby-Bibliothek zum Speichern von XML als XLT" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XML als XLT und anderen Dokumentformaten mit Ruby." urlsection="saveas/xml-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XML-Datei als XLT in Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von XML als XLT mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XML als XLT mit der Cloud Ruby-Bibliothek Cells." >}}
