...
---
{{< blocks/products/cells/cells-cloud-banner h1="CSV unter HTML speichern" h2="Ruby-Bibliothek zum Speichern von CSV als HTML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um CSV als HTML und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/csv-to-html/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine CSV-Datei unter dem Namen HTML in Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von CSV als HTML unter Verwendung von REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie CSV als HTML mithilfe der Cloud Ruby-Bibliothek Cells speichern." >}}
