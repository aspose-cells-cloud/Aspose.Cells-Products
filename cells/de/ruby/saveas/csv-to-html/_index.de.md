---
title:  Speichern Sie die CSV-Datei unter HTML API für Ruby
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Ruby, um die Datei im CSV-Format als Datei im Format HTML zu speichern.
url: /de/ruby/saveas/csv-to-html/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API, um CSV als HTML zu speichern" h2="Ruby-Bibliothek zum Speichern von CSV unter HTML" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um CSV als HTML und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/csv-to-html/" >}}
