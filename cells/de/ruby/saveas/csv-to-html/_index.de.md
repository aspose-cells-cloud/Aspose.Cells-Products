...
---
{{< blocks/products/cells/cells-cloud-banner h1="CSV speichern als HTML" h2="Ruby-Bibliothek zum Speichern von CSV als HTML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um CSV als HTML und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/csv-to-html/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie CSV als HTML mithilfe der Cloud Ruby-Bibliothek Cells." >}}
