...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine JSON-Datei als XLSB in Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von JSON als XLSB mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie JSON als XLSB mit der Cloud Ruby-Bibliothek Cells." >}}
