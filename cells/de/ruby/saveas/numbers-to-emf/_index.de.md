---
title:  Speichern Sie NUMBERS als EMF API für Ruby
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Ruby, um die Datei im NUMBERS-Format als Datei im Format EMF zu speichern.
url: /de/ruby/saveas/numbers-to-emf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API, um ZAHLEN als EMF zu speichern" h2="Ruby-Bibliothek zum Speichern von ZAHLEN als EMF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS als EMF und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/numbers-to-emf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Ruby mit REST API zum Speichern von ZAHLEN im Format EMF" gistPath="" %}}
