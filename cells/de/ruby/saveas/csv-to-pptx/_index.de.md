...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Ruby, um Dateien im CSV-Format als Dateien im PPTX-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="CSV als PPTX speichern" h2="Ruby-Bibliothek zum Speichern von CSV als PPTX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um CSV als PPTX und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/csv-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine CSV-Datei als PPTX in Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von CSV als PPTX mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie CSV als PPTX mit der Cloud Ruby-Bibliothek Cells." >}}
