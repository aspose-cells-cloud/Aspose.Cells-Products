---
title:  Speichern Sie XLSM unter PDF API für Ruby
description:  Verwenden von Aspose.Cells Cloud SDK für Ruby zum Speichern der XLSM-Formatdatei als PDF-Formatdatei.
url: /de/ruby/saveas/xlsm-to-pdf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API, um XLSM als PDF zu speichern" h2="Ruby-Bibliothek zum Speichern von XLSM unter PDF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um XLSM als PDF und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/xlsm-to-pdf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Ruby mit REST API zum Speichern von XLSM im Format PDF" gistPath="" %}}
