---
title:  Speichern Sie ODS als CSV API für Ruby
description:  Verwenden von Aspose.Cells Cloud SDK für Ruby zum Speichern der ODS-Formatdatei als CSV-Formatdatei.
url: /de/ruby/saveas/ods-to-csv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API zum Speichern von ODS als CSV" h2="Ruby-Bibliothek zum Speichern von ODS als CSV" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um ODS als CSV und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/ods-to-csv/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Ruby mit REST API zum Speichern von ODS im CSV-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Ruby API, um ODS als CSV zu speichern" >}}
