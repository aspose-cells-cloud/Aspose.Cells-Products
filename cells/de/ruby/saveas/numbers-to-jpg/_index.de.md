...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Ruby, um die Datei im NUMBERS-Format als JPG-Formatdatei zu speichern.
url: /de/ruby/saveas/numbers-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API, um ZAHLEN als JPG zu speichern" h2="Ruby-Bibliothek zum Speichern von ZAHLEN als JPG" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von Zahlen als JPG und anderen Dokumentformaten mit Ruby." urlsection="saveas/numbers-to-jpg/" >}}
