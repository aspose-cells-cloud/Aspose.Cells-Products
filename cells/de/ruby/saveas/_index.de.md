---
title:  Speichern Sie die Datei Excel in anderen Formaten mit Ruby
description:  Aspose.Cells Cloud REST API unterstützt das Speichern von Excel-Dateien in verschiedenen Formaten mit Ruby und bietet SDKs für mehrere Programmiersprachen.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie die Datei Excel in anderen Formaten mit Ruby" h2="Aspose.Cells Cloud SDK unterstützt das Speichern von Arbeitsmappen in über 30 verschiedenen Dateiformaten." p="Aspose.Cells Cloud REST API unterstützt das Speichern von Excel-Dateien in verschiedenen Formaten mit Ruby und bietet SDKs für mehrere Programmiersprachen." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Speichern Sie die Datei Excel mithilfe von Ruby-Erweiterungslinks in anderen Formaten" >}}
