---
title:  Speichern Sie NUMBERS als PNG API für Ruby
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Ruby, um die Datei im NUMBERS-Format als Datei im Format PNG zu speichern.
url: /de/ruby/saveas/numbers-to-png/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API, um ZAHLEN als PNG zu speichern" h2="Ruby-Bibliothek zum Speichern von ZAHLEN als PNG" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS als PNG und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/numbers-to-png/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Ruby mit REST API zum Speichern von ZAHLEN im Format PNG" gistPath="" %}}
