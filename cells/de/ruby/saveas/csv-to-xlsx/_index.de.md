...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Ruby, um Dateien im CSV-Format als Dateien im XLSX-Format zu speichern.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von CSV als XLSX mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie CSV als XLSX mit der Cloud Ruby-Bibliothek Cells." >}}
