...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLS unter XPS" h2="Ruby-Bibliothek zum Speichern von XLS als XPS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um XLS als XPS und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/xls-to-xps/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby-Codebeispiel zum Speichern von XLS als XPS unter Verwendung von REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Excel-Dateien in anderen XLS-Formaten als XPS zu speichern" >}}
