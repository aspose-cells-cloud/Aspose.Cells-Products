...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie PNG als HTML" h2="Ruby-Bibliothek zum Speichern von PNG als HTML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um PNG als HTML und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/png-to-html/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby-Codebeispiel zum Speichern von PNG als HTML unter Verwendung von REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Excel-Dateien in anderen Formaten zu speichern, PNG als HTML" >}}
