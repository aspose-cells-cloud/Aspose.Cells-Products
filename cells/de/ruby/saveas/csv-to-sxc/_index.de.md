...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Ruby, um Dateien im CSV-Format als Dateien im SXC-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie CSV als SXC mit der Cloud Ruby-Bibliothek Cells." >}}
