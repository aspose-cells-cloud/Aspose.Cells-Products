...
description:  Verwenden von Aspose.Cells Cloud SDK für Ruby zum Speichern von XLSM-Formatdateien als XML-Formatdateien.
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Ruby mit REST API zum Speichern von XLSM als XML-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Ruby API, um XLSM als XML zu speichern" >}}
