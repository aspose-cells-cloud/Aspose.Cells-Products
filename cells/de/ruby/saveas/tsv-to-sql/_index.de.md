...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie TSV als SQL" h2="Ruby-Bibliothek zum Speichern von TSV als SQL" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um TSV als SQL und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/tsv-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby-Codebeispiel zum Speichern von TSV als SQL mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Excel-Dateien in anderen TSV-Formaten als SQL zu speichern" >}}
