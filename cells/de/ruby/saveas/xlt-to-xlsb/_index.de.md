...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Ruby, um Dateien im XLT-Format als Dateien im XLSB-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLT als XLSB" h2="Ruby-Bibliothek zum Speichern von XLT als XLSB" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um XLT als XLSB und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/xlt-to-xlsb/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei als XLSB in Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von XLT als XLSB mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als XLSB mit der Cloud Ruby-Bibliothek Cells." >}}
