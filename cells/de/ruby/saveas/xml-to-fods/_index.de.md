---
title:  Speichern Sie XML als FODS mit Ruby
description:  Verwendung von Aspose.Cells Cloud SDK für Ruby zum Speichern von XML-Formatdateien als FODS-Formatdateien.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XML als FODS speichern" h2="Ruby-Bibliothek zum Speichern von XML als FODS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XML als FODS und anderen Dokumentformaten mit Ruby." urlsection="saveas/xml-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XML-Datei als FODS in Ruby" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Das Speichern von Dateiformaten von XML als FODS ist eine komplexe Aufgabe. Alle Formatübergänge von XML zu FODS werden von unserem Ruby SDK durchgeführt, wobei der strukturelle und logische Hauptinhalt der XML-Quelltabelle erhalten bleibt. Unsere Ruby-Bibliothek ist eine professionelle Lösung zum Online-Speichern von XML als FODS-Dateien. Dieses Cloud SDK bietet Ruby-Entwicklern leistungsstarke Funktionen und perfekte FODS-Ausgabe.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby-Codebeispiel zum Speichern von XML als FODS mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XML als FODS mit der Cloud Ruby-Bibliothek Cells." >}}
