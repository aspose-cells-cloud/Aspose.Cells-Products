...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie PNG als DOCX" h2="Ruby-Bibliothek zum Speichern von PNG als DOCX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um PNG als DOCX und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/png-to-docx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby-Codebeispiel zum Speichern von PNG als DOCX mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Excel Dateien in anderen Formaten PNG als DOCX zu speichern" >}}
