...
{{< blocks/products/cells/cells-cloud-upper-banner h1="GIF unter HTML speichern" h2="Ruby-Bibliothek zum Speichern von GIF als HTML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um GIF als HTML und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/gif-to-html/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby-Codebeispiel zum Speichern von GIF als HTML mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Excel-Dateien in anderen GIF-Formaten als HTML zu speichern" >}}
