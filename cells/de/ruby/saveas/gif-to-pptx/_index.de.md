---
title:  Speichern Sie GIF als PPTX API für Ruby
description:  Cloud-APIs und SDKs für Microsoft Excel und OpenOffice Calc. Konvertieren Sie die Tabelle in ein anderes Dateiformat.
url: /de/ruby/saveas/gif-to-pptx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API, um GIF als PPTX zu speichern" h2="Ruby-Bibliothek zum Speichern von GIF als PPTX" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Ruby zu erstellen. Dies ist eine professionelle Lösung, um GIF als PPTX und andere Dokumentformate online mit Ruby zu speichern." urlsection="saveas/gif-to-pptx/" >}}
