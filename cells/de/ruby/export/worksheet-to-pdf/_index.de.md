...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie das Arbeitsblatt von Excel nach PDF" h2="Ruby-Bibliothek zum Exportieren von WORKSHEET in die Datei PDF" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Ruby zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von WORKSHEET in eine Datei im PDF-Format aus einer Tabellenkalkulation online mit Ruby." urlsection="export/worksheet-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das WORKSHEET-Objekt mit dem Cloud SDK for Ruby Cells in eine Datei im Format PDF" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Ruby mit REST API zum Exportieren von WORKSHEET in das PDF-Format aus der Tabellenkalkulation" gistPath="" %}}
