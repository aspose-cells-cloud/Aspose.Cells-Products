...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportieren Sie die Arbeitsmappe von Excel nach DOCX" h2="Ruby-Bibliothek zum Exportieren von WORKBOOK in eine DOCX-Datei" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Ruby zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von WORKBOOK in eine DOCX-Formatdatei aus einer Tabellenkalkulation online mit Ruby." urlsection="export/workbook-to-docx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportieren Sie das WORKBOOK-Objekt in eine Datei im DOCX-Format mit dem Cloud SDK Cells für Ruby" >}}
