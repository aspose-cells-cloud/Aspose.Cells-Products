...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie die Arbeitsmappe von Excel nach JSON" h2="Ruby-Bibliothek zum Exportieren von WORKBOOK in eine JSON-Datei" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Ruby zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von WORKBOOK in eine Datei im JSON-Format aus einer Tabellenkalkulation online mit Ruby." urlsection="export/workbook-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das WORKBOOK-Objekt mit dem Cloud SDK for Ruby Cells in eine Datei im JSON-Format" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Ruby mit REST API zum Exportieren von WORKBOOK aus einer Tabellenkalkulation in das JSON-Format" gistPath="" %}}
