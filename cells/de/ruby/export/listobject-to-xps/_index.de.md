...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie LISTOBJECT von Excel nach XPS" h2="Ruby-Bibliothek zum Exportieren von LISTOBJECT in die Datei XPS" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Ruby zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von LISTOBJECT in eine Datei im Format XPS aus einer Tabellenkalkulation online mit Ruby." urlsection="export/listobject-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das LISTOBJECT-Objekt mit dem Cloud SDK for Ruby Cells in eine Datei im Format XPS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Ruby mit REST API zum Exportieren von LISTOBJECT in das Format XPS aus der Tabellenkalkulation" gistPath="" %}}
