---
title: Exportieren Sie PICTURE nach WMF von Excel mit Cells Cloud SDK für Ruby
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie BILD von Excel nach WMF" h2="Ruby-Bibliothek zum Exportieren von PICTURE in eine WMF-Datei" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Ruby zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von PICTURE in eine WMF-Formatdatei aus einer Tabellenkalkulation online mit Ruby." urlsection="export/picture-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das PICTURE-Objekt mit dem Cloud SDK for Ruby Cells in eine Datei im WMF-Format" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Ruby mit REST API zum Exportieren von PICTURE aus einer Tabellenkalkulation in das WMF-Format" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Ruby, um Objekte von Excel PICTURE nach WMF zu exportieren" >}}
