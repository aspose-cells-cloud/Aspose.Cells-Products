...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie die Arbeitsmappe von Excel nach WMF" h2="Ruby-Bibliothek zum Exportieren von WORKBOOK in eine WMF-Datei" p="Verwenden Sie Export API von Cells Cloud, um interne Objektworkflows der Datei Excel in Ruby zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von Arbeitsmappen in WMF-Formatdateien aus Tabellenkalkulationen online mit Ruby." urlsection="export/workbook-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das WORKBOOK-Objekt in eine Datei im WMF-Format mit dem Cloud SDK Cells für Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Ruby mit REST API zum Exportieren von WORKBOOK aus einer Tabellenkalkulation in das WMF-Format" gistPath="" %}}
