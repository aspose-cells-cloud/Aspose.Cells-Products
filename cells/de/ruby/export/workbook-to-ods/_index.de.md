---
title: Exportieren Sie WORKBOOK aus der Tabellenkalkulation nach ODS mit Ruby API
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Ruby API, um WORKBOOK nach ODS zu exportieren" >}}
