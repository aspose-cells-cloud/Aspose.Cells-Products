...
{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das SHAPE-Objekt mit dem Cloud SDK für Ruby Cells in eine Datei im Format SVG" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in Ruby mit REST API zum Exportieren von SHAPE in das Format SVG aus der Tabellenkalkulation" gistPath="" %}}
