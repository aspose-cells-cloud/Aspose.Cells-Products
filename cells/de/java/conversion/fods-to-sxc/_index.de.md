---
title:  Konvertieren Sie FODS in SXC in der Cloud via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie FODS mit Java in SXC um" h2="Automatisieren Sie die Excel- und OpenOffice-Dateikonvertierung mit dem Open-Source-Cloud-SDK for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Einfache Konvertierung von FODS zu SXC" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code zum Konvertieren von FODS in SXC" gistPath="" %}}
```java
