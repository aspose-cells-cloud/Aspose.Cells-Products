---
title:  ODS in XML konvertieren API for Java
description:  Verwenden von Aspose.Cells Cloud SDK for Java zum Konvertieren einer ODS-Formatdatei in eine XML-Formatdatei.
url: /de/java/conversion/ods-to-xml/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API zum Konvertieren von ODS in XML" h2="Java Bibliothek zur Konvertierung von ODS in XML" p="Verwenden Sie Cells Conversion REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Java zu erstellen. Dies ist eine professionelle Lösung zum Online-Konvertieren von ODS in XML und andere Dokumentformate mit Java." urlsection="conversion/ods-to-xml/" >}}
