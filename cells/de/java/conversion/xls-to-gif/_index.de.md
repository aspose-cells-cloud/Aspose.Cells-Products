...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLS in GIF mit dem Cloud SDK Cells for Java" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLS mit der Cells Cloud Java-Bibliothek in GIF konvertieren." >}}
