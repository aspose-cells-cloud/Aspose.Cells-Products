---
title:  TXT als XML speichern mit Java
description:  Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im TXT-Format als Dateien im XML-Format zu speichern.
...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine TXT-Datei als XML in Java" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie TXT als XML mithilfe der Cells Cloud Java-Bibliothek." >}}
