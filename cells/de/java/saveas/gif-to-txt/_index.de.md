...
description: Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im GIF-Format als Dateien im TXT-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie GIF als TXT mithilfe der Cells Cloud Java-Bibliothek." >}}
