...
description:  Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im XLT-Format als Dateien im PPTX-Format zu speichern.
...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei als PPTX in Java" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als PPTX mithilfe der Cells Cloud Java-Bibliothek." >}}
