...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLTX als MD" h2="Java Bibliothek zum Speichern von XLTX als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Java zu erstellen. Dies ist eine professionelle Lösung, um XLTX als MD und andere Dokumentformate online mit Java zu speichern." urlsection="saveas/xltx-to-md/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java Codebeispiel zum Speichern von XLTX als MD mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Java zum Speichern von Excel-Dateien in anderen Formaten, XLTX und MD" >}}
