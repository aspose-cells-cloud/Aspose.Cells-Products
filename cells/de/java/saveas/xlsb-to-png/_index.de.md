...
description:  Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im XLSB-Format als Dateien im PNG-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als PNG mithilfe der Cells Cloud Java-Bibliothek." >}}
