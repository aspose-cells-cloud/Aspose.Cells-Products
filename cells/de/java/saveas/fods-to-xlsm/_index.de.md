...
description: Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im FODS-Format als Dateien im XLSM-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie FODS als XLSM mithilfe der Cells Cloud Java-Bibliothek." >}}
