...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLSM als MD" h2="Java Bibliothek zum Speichern von XLSM als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Java zu erstellen. Dies ist eine professionelle Lösung, um XLSM als MD und andere Dokumentformate online mit Java zu speichern." urlsection="saveas/xlsm-to-md/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java Codebeispiel zum Speichern von XLSM als MD mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Java zum Speichern von Excel-Dateien in anderen Formaten, XLSM als MD" >}}
