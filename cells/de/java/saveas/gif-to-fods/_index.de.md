...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine GIF-Datei als FODS unter Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Codebeispiel zum Speichern von GIF als FODS mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie GIF mit der Cells Cloud Java-Bibliothek als FODS speichern." >}}
