...
description: Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im GIF-Format als Dateien im XLS-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie GIF als XLS mithilfe der Cells Cloud Java-Bibliothek." >}}
