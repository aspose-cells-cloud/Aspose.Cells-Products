---
title:  Speichern Sie XLSM als PDF mit Java
description:  Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im XLSM-Format als Dateien im PDF-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLSM unter PDF" h2="Java Bibliothek zum Speichern von XLSM als PDF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Java zu erstellen. Dies ist eine professionelle Lösung zum Speichern von XLSM als PDF und anderen Dokumentformaten online mit Java." urlsection="saveas/xlsm-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSM-Datei als PDF in Java" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSM als PDF mithilfe der Cells Cloud Java-Bibliothek." >}}
