---
title:  Speichern Sie XLSX unter PDF API for Java
description:  Verwenden von Aspose.Cells Cloud SDK for Java zum Speichern der XLSX-Formatdatei als PDF-Formatdatei.
