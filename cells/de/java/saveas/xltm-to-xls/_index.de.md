...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLTM als XLS speichern" h2="Java Bibliothek zum Speichern von XLTM als XLS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Java zu erstellen. Dies ist eine professionelle Lösung, um XLTM als XLS und andere Dokumentformate online mit Java zu speichern." urlsection="saveas/xltm-to-xls/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLTM als XLS mithilfe der Cells Cloud Java-Bibliothek." >}}
