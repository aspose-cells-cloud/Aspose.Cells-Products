...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSM als DIF speichern" h2="Java Bibliothek zum Speichern von XLSM als DIF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Java zu erstellen. Dies ist eine professionelle Lösung, um XLSM als DIF und andere Dokumentformate online mit Java zu speichern." urlsection="saveas/xlsm-to-dif/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java Codebeispiel zum Speichern von XLSM als DIF mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK for Java zum Speichern von Excel-Dateien in anderen Formaten, XLSM als DIF" >}}
