...
description:  Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im TXT-Format als Dateien im JSON-Format zu speichern.
...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine TXT-Datei als JSON in Java" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie TXT als JSON mit der Cells Cloud Java-Bibliothek." >}}
