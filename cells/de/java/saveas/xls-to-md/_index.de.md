...
description:  Verwenden Sie Aspose.Cells Cloud SDK for Java, um Dateien im XLS-Format als Dateien im MD-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS als MD mithilfe der Cells Cloud Java-Bibliothek." >}}
