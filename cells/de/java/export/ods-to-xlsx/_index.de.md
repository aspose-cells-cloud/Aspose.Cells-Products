...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exportieren Sie ODS in eine XLSX-Datei in der Cloud" h2="Excel & Export von OpenOffice-Tabellenkalkulationen mit Open Source Cloud SDK for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" ODS in XLSX-Datei im Cloud SDK for Java exportieren" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code für ODS-zu-XLSX-Konvertierung" gistPath="" %}}
```java
