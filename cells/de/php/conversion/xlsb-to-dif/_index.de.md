...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLSB in DIF mit dem Cloud SDK Cells für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLSB mithilfe der Cloud-Bibliothek Cells PHP in DIF konvertieren." >}}
