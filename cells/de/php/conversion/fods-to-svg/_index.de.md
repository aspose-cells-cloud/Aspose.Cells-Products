...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit PHP in SVG" h2="Automatisieren Sie die Excel- und OpenOffice-Dateikonvertierung mit dem Open-Source-Cloud-SDK für PHP" >}}
...
1. Rufen Sie ```CellsApi.cellsSaveAsPostDocumentSaveAs``` an, um die resultierende Datei SVG zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="PHP-Code für die Konvertierung von FODS in SVG" gistPath="" %}}
```php
