...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um eine Datei im XLS-Format in eine Datei im XLTX-Format zu konvertieren.
...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLS in XLTX mit Cells Cloud SDK für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XLS mit der Cells Cloud PHP-Bibliothek in XLTX." >}}
