...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLTX mit PHP" h2="Automatisieren Sie die Excel- und OpenOffice-Dateikonvertierung mit dem Open-Source-Cloud-SDK für PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie FODS schnell in XLTX via PHP" %}}
...
1. Rufen Sie ```CellsApi.cellsSaveAsPostDocumentSaveAs``` an, um die resultierende XLTX-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code für die Konvertierung von FODS in XLTX" gistPath="" %}}
```php
