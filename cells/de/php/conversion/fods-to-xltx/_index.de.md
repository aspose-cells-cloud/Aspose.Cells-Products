...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie FODS mit PHP in XLTX um" h2="Automatisieren Sie die Konvertierung von Excel- und OpenOffice-Dateien mit Open Source Cloud SDK für PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code für die Umwandlung von FODS in XLTX" gistPath="" %}}
```php
