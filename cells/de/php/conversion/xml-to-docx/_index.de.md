...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XML in DOCX mit Cells Cloud SDK für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XML mit der Cells Cloud PHP-Bibliothek in DOCX." >}}
