...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um eine Datei im XLSX-Format in eine Datei im XPS-Format zu konvertieren.
...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLSX in XPS mit Cells Cloud SDK für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XLSX mithilfe der Cells Cloud PHP-Bibliothek in XPS." >}}
