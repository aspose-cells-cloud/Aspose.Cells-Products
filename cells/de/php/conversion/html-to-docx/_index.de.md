...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie HTML in DOCX mit dem Cloud SDK Cells für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie HTML mit der Cells Cloud PHP-Bibliothek in DOCX konvertieren." >}}
