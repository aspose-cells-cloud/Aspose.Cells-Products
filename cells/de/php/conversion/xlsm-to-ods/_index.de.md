...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um eine Datei im XLSM-Format in eine Datei im ODS-Format zu konvertieren.
...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLSM in ODS mit Cells Cloud SDK für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XLSM mithilfe der Cloud-Bibliothek Cells PHP in ODS." >}}
