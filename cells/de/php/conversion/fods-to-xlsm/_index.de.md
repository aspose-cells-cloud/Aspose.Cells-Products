...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit PHP in XLSM" h2="Automatisieren Sie die Konvertierung von Excel- und OpenOffice-Dateien mit Open Source Cloud SDK für PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code für die Umwandlung von FODS in XLSM" gistPath="" %}}
```php
