...
description:  Verwendung des Cloud SDK Aspose.Cells für PHP zum Konvertieren einer Datei im FODS-Format in eine Datei im XLT-Format.
...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie FODS in XLT mit dem Cloud SDK Cells für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie FODS mit der Cells Cloud PHP-Bibliothek in XLT konvertieren." >}}
