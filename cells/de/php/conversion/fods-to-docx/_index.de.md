...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um eine Datei im FODS-Format in eine Datei im DOCX-Format zu konvertieren.
...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie FODS in DOCX mit Cells Cloud SDK für PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie FODS mit der Cells Cloud PHP-Bibliothek in DOCX." >}}
