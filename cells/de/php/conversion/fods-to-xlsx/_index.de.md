...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLSX mit PHP" h2="Automatisieren Sie die Konvertierung von Excel- und OpenOffice-Dateien mit Open Source Cloud SDK für PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code für die Umwandlung von FODS in XLSX" gistPath="" %}}
```php
