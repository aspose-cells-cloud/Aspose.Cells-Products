...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit PHP in XML" h2="Automatisieren Sie die Excel- und OpenOffice-Dateikonvertierung mit dem Open-Source-Cloud-SDK für PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code für die Konvertierung von FODS in XML" gistPath="" %}}
```php
