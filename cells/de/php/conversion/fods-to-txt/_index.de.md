...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in TXT mit PHP" h2="Automatisieren Sie die Excel- und OpenOffice-Dateikonvertierung mit dem Open-Source-Cloud-SDK für PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code für die Konvertierung von FODS in TXT" gistPath="" %}}
```php
