---
title: MHTML in XPS Konvertieren Sie API in PHP
description:  Verwenden Sie das Cloud SDK Aspose.Cells für PHP, um eine MHTML-Formatdatei in eine Datei im XPS-Format zu konvertieren.
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in PHP mit REST API zum Konvertieren von MHTML in das XPS-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie PHP API, um MHTML in XPS zu konvertieren" >}}
