...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um Dateien im XLSB-Format als Dateien im XLS-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLSB als XLS speichern" h2="PHP Bibliothek zum Speichern von XLSB als XLS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLSB als XLS und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xlsb-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSB-Datei als XLS unter PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Codebeispiel zum Speichern von XLSB als XLS mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als XLS mithilfe der Cells Cloud PHP-Bibliothek." >}}
