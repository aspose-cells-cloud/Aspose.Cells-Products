...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSB-Datei als DOCX in PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als DOCX mit der Cells Cloud PHP-Bibliothek." >}}
