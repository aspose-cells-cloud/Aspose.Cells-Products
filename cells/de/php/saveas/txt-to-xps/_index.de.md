...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie TXT unter XPS" h2="PHP-Bibliothek zum Speichern von TXT als XPS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um TXT als XPS und andere Dokumentformate online unter PHP zu speichern." urlsection="saveas/txt-to-xps/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von TXT als XPS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen TXT-Formaten als XPS zu speichern" >}}
