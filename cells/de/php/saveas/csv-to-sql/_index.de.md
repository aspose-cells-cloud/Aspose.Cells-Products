---
title:  Speichern Sie CSV als SQL API für PHP
description:  Verwenden von Aspose.Cells Cloud SDK für PHP zum Speichern von CSV-Formatdateien als SQL-Formatdateien.
url: /de/php/saveas/csv-to-sql/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API, um CSV als SQL zu speichern" h2="PHP-Bibliothek zum Speichern von CSV als SQL" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um CSV als SQL und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/csv-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in PHP mit REST API zum Speichern von CSV im SQL-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie PHP API, um CSV als SQL zu speichern" >}}
