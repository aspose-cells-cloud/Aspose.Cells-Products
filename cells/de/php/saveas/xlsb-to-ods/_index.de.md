...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um Dateien im XLSB-Format als Dateien im ODS-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als ODS mithilfe der Cells Cloud PHP-Bibliothek." >}}
