...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSB als ODS speichern" h2="PHP Bibliothek zum Speichern von XLSB als ODS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLSB als ODS und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xlsb-to-ods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XLSB als ODS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten, XLSB und ODS zu speichern" >}}
