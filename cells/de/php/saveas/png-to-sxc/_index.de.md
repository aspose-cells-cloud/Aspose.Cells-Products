...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie PNG als SXC" h2="PHP-Bibliothek zum Speichern von PNG als SXC" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um PNG als SXC und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/png-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine PNG-Datei als SXC in PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Codebeispiel zum Speichern von PNG als SXC mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie PNG als SXC mithilfe der Cells Cloud PHP-Bibliothek speichern." >}}
