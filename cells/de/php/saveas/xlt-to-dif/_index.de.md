...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLT als DIF speichern" h2="PHP Bibliothek zum Speichern von XLT als DIF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLT als DIF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xlt-to-dif/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei als DIF unter PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Codebeispiel zum Speichern von XLT als DIF mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLT mit der Cells Cloud PHP-Bibliothek als DIF speichern." >}}
