...
---
{{< blocks/products/cells/cells-cloud-banner h1="SXC als SQL speichern" h2="PHP Bibliothek zum Speichern von SXC als SQL" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um SXC als SQL und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/sxc-to-sql/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als SQL mithilfe der Cells Cloud PHP-Bibliothek." >}}
