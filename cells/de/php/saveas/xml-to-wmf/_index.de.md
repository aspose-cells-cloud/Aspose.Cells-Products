---
title: Speichern Sie XML als WMF API für PHP
description:  Verwenden des Cloud SDK Aspose.Cells für PHP zum Speichern der XML-Formatdatei als WMF-Formatdatei.
url: /de/php/saveas/xml-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API, um XML als WMF zu speichern" h2="PHP-Bibliothek zum Speichern von XML als WMF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XML als WMF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xml-to-wmf/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie PHP API, um XML als WMF zu speichern" >}}
