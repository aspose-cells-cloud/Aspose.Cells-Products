...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um Dateien im XLSB-Format als Dateien im MD-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLSB als MD speichern" h2="PHP Bibliothek zum Speichern von XLSB als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLSB als MD und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xlsb-to-md/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als MD mithilfe der Cells Cloud PHP-Bibliothek." >}}
