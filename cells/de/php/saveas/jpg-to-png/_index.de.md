---
title:  Speichern Sie JPG unter PNG mit PHP
description:  Verwendung des Aspose.Cells Cloud SDK für PHP zum Speichern der JPG-Formatdatei als PNG-Formatdatei.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie JPG unter PNG" h2="PHP-Bibliothek zum Speichern von JPG unter PNG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um JPG als PNG und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/jpg-to-png/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von JPG als PNG mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen JPG-Formaten als PNG zu speichern" >}}
