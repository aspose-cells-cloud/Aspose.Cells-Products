...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie SXC als XLSB" h2="PHP Bibliothek zum Speichern von SXC als XLSB" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um SXC als XLSB und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/sxc-to-xlsb/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von SXC als XLSB mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie SXC und XLSB zu speichern" >}}
