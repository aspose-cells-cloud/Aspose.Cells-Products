...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie MHTML als SQL" h2="PHP Bibliothek zum Speichern von MHTML als SQL" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um MHTML als SQL und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/mhtml-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von MHTML als SQL mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie MHTML und SQL zu speichern" >}}
