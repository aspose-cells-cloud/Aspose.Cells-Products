...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLTX als DIF speichern" h2="PHP Bibliothek zum Speichern von XLTX als DIF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLTX als DIF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xltx-to-dif/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XLTX als DIF mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten, XLTX, als DIF zu speichern" >}}
