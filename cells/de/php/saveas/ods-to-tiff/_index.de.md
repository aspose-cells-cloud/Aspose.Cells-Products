...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für PHP, um die Datei im ODS-Format als Datei im Format TIFF zu speichern.
url: /de/php/saveas/ods-to-tiff/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API, um ODS als TIFF zu speichern" h2="PHP-Bibliothek zum Speichern von ODS unter TIFF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um ODS als TIFF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/ods-to-tiff/" >}}
