...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie PNG als XLSX" h2="PHP-Bibliothek zum Speichern von PNG als XLSX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um PNG als XLSX und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/png-to-xlsx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von PNG als XLSX mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel Dateien in anderen Formaten zu speichern, PNG als XLSX" >}}
