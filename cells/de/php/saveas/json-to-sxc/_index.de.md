...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um Dateien im JSON-Format als Dateien im SXC-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie JSON als SXC mithilfe der Cells Cloud PHP-Bibliothek." >}}
