...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLSX unter XPS" h2="PHP-Bibliothek zum Speichern von XLSX als XPS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLSX als XPS und andere Dokumentformate online unter PHP zu speichern." urlsection="saveas/xlsx-to-xps/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XLSX als XPS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen XLSX-Formaten als XPS zu speichern" >}}
