---
title:  Speichern Sie XLSM als PDF mit PHP
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLSM unter PDF" h2="PHP Bibliothek zum Speichern von XLSM als PDF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung zum Speichern von XLSM als PDF und anderen Dokumentformaten online mit PHP." urlsection="saveas/xlsm-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSM-Datei als PDF in PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSM als PDF mithilfe der Cells Cloud PHP-Bibliothek." >}}
