...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XML unter EMF" h2="PHP-Bibliothek zum Speichern von XML als EMF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XML als EMF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xml-to-emf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XML als EMF mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen XML-Formaten als EMF zu speichern" >}}
