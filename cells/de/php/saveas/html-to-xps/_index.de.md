...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine HTML-Datei als XPS in PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Codebeispiel zum Speichern von HTML als XPS mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie HTML mithilfe der Cells Cloud PHP-Bibliothek als XPS speichern." >}}
