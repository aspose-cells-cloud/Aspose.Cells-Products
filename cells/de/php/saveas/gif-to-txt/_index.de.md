...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine GIF-Datei als TXT unter PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie GIF mit der Cells Cloud PHP-Bibliothek als TXT speichern." >}}
