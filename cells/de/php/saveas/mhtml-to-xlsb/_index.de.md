...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie MHTML als XLSB" h2="PHP Bibliothek zum Speichern von MHTML als XLSB" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um MHTML als XLSB und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/mhtml-to-xlsb/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von MHTML als XLSB mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie MHTML und XLSB zu speichern" >}}
