...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XML als JPG" h2="PHP Bibliothek zum Speichern von XML als JPG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XML als JPG und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xml-to-jpg/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XML als JPG mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie XML und JPG zu speichern" >}}
