---
title:  Speichern Sie MHTML als CSV mit PHP
description:  Verwendung des Cloud SDK Aspose.Cells für PHP zum Speichern der MHTML-Formatdatei als CSV-Formatdatei.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie MHTML als CSV" h2="PHP Bibliothek zum Speichern von MHTML als CSV" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um MHTML als CSV und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/mhtml-to-csv/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie MHTML und CSV zu speichern" >}}
