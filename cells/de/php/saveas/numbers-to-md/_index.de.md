...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie NUMBERS als MD" h2="PHP Bibliothek zum Speichern von ZAHLEN als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um NUMBERS als MD und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/numbers-to-md/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von ZAHLEN als MD mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie MD zu speichern" >}}
