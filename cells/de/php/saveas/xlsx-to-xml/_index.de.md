...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSX als XML speichern" h2="PHP Bibliothek zum Speichern von XLSX als XML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLSX als XML und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xlsx-to-xml/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XLSX als XML mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten, XLSX, als XML zu speichern" >}}
