...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSM-Datei als GIF in PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSM als GIF mit der Cells Cloud PHP-Bibliothek." >}}
