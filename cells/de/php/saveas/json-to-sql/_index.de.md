...
description:  Verwendung des Cloud SDK Aspose.Cells für PHP zum Speichern der JSON-Formatdatei als SQL-Formatdatei.
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von JSON als SQL mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten wie JSON oder SQL zu speichern" >}}
