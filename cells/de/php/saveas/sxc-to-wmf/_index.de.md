...
description:  Verwenden des Aspose.Cells Cloud SDK für PHP, um Dateien im SXC-Format als Dateien im WMF-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie SXC als WMF" h2="PHP Bibliothek zum Speichern von SXC als WMF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um SXC als WMF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/sxc-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine SXC-Datei als WMF unter PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Codebeispiel zum Speichern von SXC als WMF mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als WMF mithilfe der Cells Cloud PHP-Bibliothek." >}}
