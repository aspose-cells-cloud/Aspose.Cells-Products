...
description: Verwenden des Aspose.Cells Cloud SDK für PHP, um Dateien im SXC-Format als Dateien im HTML-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als HTML mithilfe der Cells Cloud PHP-Bibliothek." >}}
