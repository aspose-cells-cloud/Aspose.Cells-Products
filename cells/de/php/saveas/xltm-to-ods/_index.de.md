...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLTM als ODS speichern" h2="PHP Bibliothek zum Speichern von XLTM als ODS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLTM als ODS und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xltm-to-ods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von XLTM als ODS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel-Dateien in anderen Formaten, XLTM und ODS zu speichern" >}}
