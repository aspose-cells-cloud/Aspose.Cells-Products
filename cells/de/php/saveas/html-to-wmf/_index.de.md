...
{{< blocks/products/cells/cells-cloud-upper-banner h1="HTML als WMF speichern" h2="PHP-Bibliothek zum Speichern von HTML als WMF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um HTML als WMF und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/html-to-wmf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Codebeispiel zum Speichern von HTML als WMF mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für PHP, um Excel Dateien in anderen Formaten HTML als WMF zu speichern" >}}
