...
description:  Verwenden von Aspose.Cells Cloud SDK für PHP zum Speichern von XLS-Formatdateien als SQL-Formatdateien.
url: /de/php/saveas/xls-to-sql/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API, um XLS als SQL zu speichern" h2="PHP-Bibliothek zum Speichern von XLS als SQL" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in PHP zu erstellen. Dies ist eine professionelle Lösung, um XLS als SQL und andere Dokumentformate online mit PHP zu speichern." urlsection="saveas/xls-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in PHP mit REST API zum Speichern von XLS als SQL-Format" gistPath="" %}}
