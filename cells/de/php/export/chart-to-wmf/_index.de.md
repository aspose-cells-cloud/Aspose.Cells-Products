...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportieren Sie CHART nach WMF von Excel" h2="PHP-Bibliothek zum Exportieren von CHART in eine WMF-Datei" p="Verwenden Sie Export API von Cells Cloud, um Excel Datei-interne Objekt-Workflows in PHP zu exportieren. Dies ist eine professionelle Lösung, um CHART online aus einer Tabellenkalkulation in eine WMF-Formatdatei mit PHP zu exportieren." urlsection="export/chart-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das CHART-Objekt in eine Datei im WMF-Format mit dem Cloud SDK Cells für PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in PHP mit REST API zum Exportieren von CHART aus einer Tabellenkalkulation in das WMF-Format" gistPath="" %}}
