...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportieren Sie die Arbeitsmappe von Excel nach WMF" h2="PHP-Bibliothek zum Exportieren von WORKBOOK in eine WMF-Datei" p="Verwenden Sie Export API von Cells Cloud, um Excel Datei-interne Objekt-Workflows in PHP zu exportieren. Dies ist eine professionelle Lösung, um ARBEITSMAPPE online aus einer Tabellenkalkulation in eine WMF-Formatdatei mit PHP zu exportieren." urlsection="export/workbook-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportieren Sie das WORKBOOK-Objekt in eine Datei im WMF-Format mit dem Cloud SDK Cells für PHP" >}}
