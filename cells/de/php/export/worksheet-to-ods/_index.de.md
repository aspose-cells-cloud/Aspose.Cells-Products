...
{{< blocks/products/cells/cells-cloud-section title="Exportieren Sie das WORKSHEET-Objekt in eine Datei im ODS-Format mit dem Cloud SDK Cells für PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Codebeispiel in PHP mit REST API zum Exportieren von WORKSHEET in das ODS-Format aus der Tabellenkalkulation" gistPath="" %}}
