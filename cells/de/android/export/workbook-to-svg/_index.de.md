---
title:  Exportieren Sie WORKBOOK aus der Tabelle mit Android API nach SVG
description:  Aspose.Cells Cloud REST API unterstützt den Export von Dateien im {0}-Format in {1} mit {2}.
url: /de/android/export/workbook-to-svg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API zum Exportieren der Arbeitsmappe in die Datei SVG" h2="Android-Bibliothek zum Exportieren von WORKBOOK in die Datei SVG" p="Verwenden Sie Cells Export REST API, um Arbeitsabläufe interner Tabellenkalkulationsobjekte in Android zu exportieren. Dies ist eine professionelle Lösung zum Exportieren von WORKBOOK in eine Datei im Format SVG aus einer Tabellenkalkulation online mit Android." urlsection="export/workbook-to-svg/" >}}
