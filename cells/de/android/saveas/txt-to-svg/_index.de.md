...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie TXT unter SVG" h2="Android-Bibliothek zum Speichern von TXT als SVG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um TXT als SVG und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/txt-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine TXT-Datei unter Android als SVG" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-Codebeispiel zum Speichern von TXT als SVG mit REST API" gistPath="" %}}
