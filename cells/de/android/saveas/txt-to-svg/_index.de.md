---
title:  Speichern Sie TXT unter SVG API für Android
description: Verwenden Sie das Cloud SDK Aspose.Cells für Android, um die Datei im TXT-Format als Datei im Format SVG zu speichern.
url: /de/android/saveas/txt-to-svg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API, um TXT als SVG zu speichern" h2="Android-Bibliothek zum Speichern von TXT unter SVG" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um TXT als SVG und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/txt-to-svg/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Android mit REST API zum Speichern von TXT im Format SVG" gistPath="" %}}
