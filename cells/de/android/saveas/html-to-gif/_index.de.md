...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine HTML-Datei als GIF in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-Codebeispiel zum Speichern von HTML als GIF mit REST API" gistPath="" %}}
