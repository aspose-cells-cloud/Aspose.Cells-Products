...
description: Verwenden Sie das Cloud SDK Aspose.Cells für Android, um Dateien im XLTM-Format als JPG-Formatdateien zu speichern.
url: /de/android/saveas/xltm-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API, um XLTM als JPG zu speichern" h2="Android-Bibliothek zum Speichern von XLTM als JPG" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um XLTM als JPG und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/xltm-to-jpg/" >}}
