...
{{< blocks/products/cells/cells-cloud-upper-banner h1="TSV als JPG speichern" h2="Android-Bibliothek zum Speichern von TSV als JPG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um TSV als JPG und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/tsv-to-jpg/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android-Codebeispiel zum Speichern von TSV als JPG mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für Android, um Excel-Dateien in anderen TSV-Formaten als JPG zu speichern" >}}
