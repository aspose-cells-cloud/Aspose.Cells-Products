...
description: Verwenden Sie das Cloud SDK Aspose.Cells für Android, um Dateien im XLTM-Format als TSV-Formatdateien zu speichern.
url: /de/android/saveas/xltm-to-tsv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API zum Speichern von XLTM als TSV" h2="Android-Bibliothek zum Speichern von XLTM als TSV" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um XLTM als TSV und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/xltm-to-tsv/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Android mit REST API zum Speichern von XLTM als TSV-Format" gistPath="" %}}
