...
{{< blocks/products/cells/cells-cloud-upper-banner h1="TSV unter SVG speichern" h2="Android-Bibliothek zum Speichern des TSV als SVG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um TSV als SVG und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/tsv-to-svg/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android-Codebeispiel zum Speichern von TSV als SVG unter Verwendung von REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Android, um Excel-Dateien in anderen TSV-Formaten als SVG zu speichern" >}}
