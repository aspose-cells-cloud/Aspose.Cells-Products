...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLSM als MD" h2="Android-Bibliothek zum Speichern von XLSM als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLSM als MD und anderen Dokumentformaten mit Android." urlsection="saveas/xlsm-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSM-Datei als MD in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-Codebeispiel zum Speichern von XLSM als MD mit REST API" gistPath="" %}}
