---
title:  Speichern Sie TXT unter EMF API für Android
description: Verwenden Sie das Cloud SDK Aspose.Cells für Android, um die Datei im TXT-Format als Datei im Format EMF zu speichern.
url: /de/android/saveas/txt-to-emf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API, um TXT als EMF zu speichern" h2="Android-Bibliothek zum Speichern von TXT unter EMF" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um TXT als EMF und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/txt-to-emf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Android mit REST API zum Speichern von TXT im Format EMF" gistPath="" %}}
