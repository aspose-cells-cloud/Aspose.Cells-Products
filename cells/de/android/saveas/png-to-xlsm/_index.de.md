...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie PNG als XLSM" h2="Android-Bibliothek zum Speichern von PNG als XLSM" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um PNG als XLSM und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/png-to-xlsm/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android-Codebeispiel zum Speichern von PNG als XLSM mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Android, um Excel Dateien in anderen Formaten PNG als XLSM zu speichern" >}}
