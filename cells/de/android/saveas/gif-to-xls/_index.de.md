...
{{< blocks/products/cells/cells-cloud-upper-banner h1="GIF als XLS speichern" h2="Android-Bibliothek zum Speichern von GIF als XLS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um GIF als XLS und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/gif-to-xls/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android-Codebeispiel zum Speichern von GIF als XLS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für Android, um Excel-Dateien in den anderen Formaten GIF und XLS zu speichern" >}}
