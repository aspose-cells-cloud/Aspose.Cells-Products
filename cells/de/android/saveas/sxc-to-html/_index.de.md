...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie SXC unter HTML" h2="Android-Bibliothek zum Speichern von SXC als HTML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um SXC als HTML und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/sxc-to-html/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android-Codebeispiel zum Speichern von SXC als HTML unter Verwendung von REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Android, um Excel-Dateien in anderen SXC-Formaten als HTML zu speichern" >}}
