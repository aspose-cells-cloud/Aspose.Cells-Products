...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine NUMBERS-Datei unter Android als PDF" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-Codebeispiel zum Speichern von ZAHLEN als PDF unter Verwendung von REST API" gistPath="" %}}
