...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie TXT als XLSX" h2="Android-Bibliothek zum Speichern von TXT als XLSX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Android zu erstellen. Dies ist eine professionelle Lösung, um TXT als XLSX und andere Dokumentformate online mit Android zu speichern." urlsection="saveas/txt-to-xlsx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android-Codebeispiel zum Speichern von TXT als XLSX mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für Android, um Excel-Dateien in anderen Formaten wie TXT und XLSX zu speichern" >}}
