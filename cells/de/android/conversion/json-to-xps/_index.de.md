...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie JSON mit dem Cloud SDK Cells für Android in XPS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-Codebeispiel für die Konvertierung von JSON in XPS mithilfe des Cloud SDK Cells" gistPath="" %}}
