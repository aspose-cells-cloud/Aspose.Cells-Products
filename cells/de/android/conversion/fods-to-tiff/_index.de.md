---
title:  Konvertieren Sie FODS auf Android in TIFF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in TIFF in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit Open Source Cloud SDK für Android" >}}
...
1. Rufen Sie ```CellsApi.cellsWorkbookGetWorkbook``` an, um die resultierende TIFF-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Android: Umwandlung von FODS in TIFF" gistPath="" %}}
```java
