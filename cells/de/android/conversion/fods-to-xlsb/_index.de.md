...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLSB in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit Open Source Cloud SDK für Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in XLSB in Android-Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS zu XLSB" gistPath="" %}}
```java
