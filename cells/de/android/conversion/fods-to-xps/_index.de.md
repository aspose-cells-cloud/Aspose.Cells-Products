---
title:  Konvertieren Sie FODS in XPS auf Android
...
url: /de/android/conversion/fods-to-xps/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in der Cloud in XPS" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit dem Open Source Cloud SDK für Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in XPS in Android-Apps" %}}
...
1. Rufen Sie ```CellsApi.cellsWorkbookGetWorkbook``` an, um die resultierende Datei XPS zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS zu XPS" gistPath="" %}}
```java
