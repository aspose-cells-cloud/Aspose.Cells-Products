...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie HTML in BMP mit dem Cloud SDK Cells für Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-Codebeispiel für die Konvertierung von HTML in BMP mithilfe des Cloud SDK Cells" gistPath="" %}}
