...
{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-DIF-Konvertierung in Android-Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS zu DIF Konvertierung" gistPath="" %}}
```java
