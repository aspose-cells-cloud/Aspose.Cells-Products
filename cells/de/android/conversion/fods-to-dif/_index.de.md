---
title:  Konvertieren Sie FODS in DIF auf Android
...
url: /de/android/conversion/fods-to-dif/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in DIF in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit dem Open-Source-Cloud-SDK für Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in DIF in Android-Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS in DIF" gistPath="" %}}
```java
