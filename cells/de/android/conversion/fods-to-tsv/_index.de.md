---
title:  Konvertieren Sie FODS in TSV auf Android
...
url: /de/android/conversion/fods-to-tsv/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in TSV in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit dem Open-Source-Cloud-SDK für Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in TSV in Android-Apps" %}}
...
1. Rufen Sie ```CellsApi.cellsWorkbookGetWorkbook``` an, um die resultierende TSV-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS in TSV" gistPath="" %}}
```java
