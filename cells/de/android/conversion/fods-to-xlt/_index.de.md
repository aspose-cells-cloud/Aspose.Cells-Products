---
title:  Konvertieren Sie FODS in XLT auf Android
...
url: /de/android/conversion/fods-to-xlt/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLT in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit dem Open-Source-Cloud-SDK für Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-XLT-Konvertierung in Android-Apps" %}}
...
1. Rufen Sie ```CellsApi.cellsWorkbookGetWorkbook``` an, um die resultierende XLT-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS in XLT" gistPath="" %}}
```java
