---
title:  Konvertieren Sie FODS in XLTM auf Android
...
url: /de/android/conversion/fods-to-xltm/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLTM in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit Open Source Cloud SDK für Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS in XLTM in Android-Apps" %}}
...
1. Rufen Sie ```CellsApi.cellsWorkbookGetWorkbook``` an, um die resultierende XLTM-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS zu XLTM" gistPath="" %}}
```java
