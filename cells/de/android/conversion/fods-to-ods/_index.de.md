...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in ODS in der Cloud" h2="Konvertieren Sie Excel- und OpenOffice-Tabellen mit Open Source Cloud SDK für Android" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: Konvertierung von FODS zu ODS" gistPath="" %}}
```java
