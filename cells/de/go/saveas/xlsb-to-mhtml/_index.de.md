...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Go, um Dateien im XLSB-Format als Dateien im MHTML-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLSB als MHTML speichern" h2="Go-Bibliothek zum Speichern von XLSB als MHTML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLSB als MHTML und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xlsb-to-mhtml/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSB-Datei als MHTML in Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von XLSB als MHTML mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als MHTML mit der Cloud Go-Bibliothek Cells." >}}
