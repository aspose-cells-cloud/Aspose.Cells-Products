...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Go, um Dateien im XLS-Format als Dateien im XLSM-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLS als XLSM" h2="Go-Bibliothek zum Speichern von XLS als XLSM" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLS als XLSM und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xls-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLS-Datei als XLSM in Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von XLS als XLSM mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS als XLSM mithilfe der Cloud Go-Bibliothek Cells." >}}
