...
---
{{< blocks/products/cells/cells-cloud-banner h1="SXC als XLTX speichern" h2="Go-Bibliothek zum Speichern von SXC als XLTX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von SXC als XLTX und anderen Dokumentformaten mit Go." urlsection="saveas/sxc-to-xltx/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als XLTX mithilfe der Cloud Go-Bibliothek Cells." >}}
