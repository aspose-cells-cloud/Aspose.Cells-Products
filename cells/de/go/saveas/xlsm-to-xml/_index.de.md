...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSM als XML speichern" h2="Go-Bibliothek zum Speichern von XLSM als XML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLSM als XML und anderen Dokumentformaten mit Go." urlsection="saveas/xlsm-to-xml/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go-Codebeispiel zum Speichern von XLSM als XML mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Go, um Excel-Dateien in anderen XLSM-Formaten als XML zu speichern" >}}
