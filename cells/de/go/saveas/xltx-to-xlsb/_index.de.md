...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLTX als XLSB" h2="Go-Bibliothek zum Speichern von XLTX als XLSB" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLTX als XLSB und anderen Dokumentformaten mit Go." urlsection="saveas/xltx-to-xlsb/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go-Codebeispiel zum Speichern von XLTX als XLSB mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Go, um Excel-Dateien in den anderen Formaten XLTX und XLSB zu speichern" >}}
