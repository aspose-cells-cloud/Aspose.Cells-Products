---
title:  Speichern Sie ODS als JPG mit Go
description:  Verwendung von Aspose.Cells Cloud SDK für Go zum Speichern von ODS-Formatdateien als JPG-Formatdateien.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="ODS als JPG speichern" h2="Go-Bibliothek zum Speichern von ODS als JPG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von ODS als JPG und anderen Dokumentformaten mit Go." urlsection="saveas/ods-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine ODS-Datei als JPG in Go" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Das Speichern von Dateiformaten von ODS als JPG ist eine komplexe Aufgabe. Alle Formatübergänge von ODS zu JPG werden von unserem Go SDK durchgeführt, wobei der strukturelle und logische Hauptinhalt der ODS-Quelltabelle erhalten bleibt. Unsere Go-Bibliothek ist eine professionelle Lösung zum Online-Speichern von ODS als JPG-Dateien. Dieses Cloud SDK bietet Go-Entwicklern leistungsstarke Funktionen und perfekte JPG-Ausgabe.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von ODS als JPG mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie ODS als JPG mit der Cloud Go-Bibliothek Cells." >}}
