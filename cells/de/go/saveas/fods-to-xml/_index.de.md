---
title:  Speichern Sie FODS als XML mit Go
description:  Verwendung von Aspose.Cells Cloud SDK für Go zum Speichern der FODS-Formatdatei als XML-Formatdatei.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie FODS als XML" h2="Go-Bibliothek zum Speichern von FODS als XML" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von FODS als XML und anderen Dokumentformaten mit Go." urlsection="saveas/fods-to-xml/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine FODS-Datei als XML in Go" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Das Speichern von Dateiformaten von FODS als XML ist eine komplexe Aufgabe. Alle Formatübergänge von FODS zu XML werden von unserem Go SDK durchgeführt, wobei der strukturelle und logische Hauptinhalt der Quell-FODS-Tabelle erhalten bleibt. Unsere Go-Bibliothek ist eine professionelle Lösung zum Online-Speichern von FODS als XML-Dateien. Dieses Cloud SDK bietet Go-Entwicklern leistungsstarke Funktionen und perfekte XML-Ausgabe.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von FODS als XML mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie FODS als XML mit der Cloud Go-Bibliothek Cells." >}}
