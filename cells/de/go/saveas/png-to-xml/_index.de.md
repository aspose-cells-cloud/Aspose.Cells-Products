...
description:  Verwenden Sie das Aspose.Cells Cloud SDK für Go, um die Datei im PNG-Format als Datei im XML-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie PNG als XML mit der Cells Cloud Go-Bibliothek." >}}
