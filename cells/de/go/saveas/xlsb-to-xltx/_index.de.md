...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLSB als XLTX" h2="Go-Bibliothek zum Speichern von XLSB als XLTX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLSB als XLTX und anderen Dokumentformaten mit Go." urlsection="saveas/xlsb-to-xltx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go-Codebeispiel zum Speichern von XLSB als XLTX mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Go, um Excel-Dateien in den anderen Formaten XLSB und XLTX zu speichern" >}}
