...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Go, um Dateien im XLS-Format als Dateien im MD-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS als MD speichern" h2="Go-Bibliothek zum Speichern von XLS als MD" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLS als MD und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xls-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLS-Datei als MD in Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von XLS als MD mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS als MD mithilfe der Cloud Go-Bibliothek Cells." >}}
