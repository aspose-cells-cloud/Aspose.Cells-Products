...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Go, um XLTX-Formatdateien als TXT-Formatdateien zu speichern.
url: /de/go/saveas/xltx-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um XLTX als TXT zu speichern" h2="Gehen Sie zur Bibliothek, um XLTX als TXT zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLTX als TXT und anderen Dokumentformaten mit Go." urlsection="saveas/xltx-to-txt/" >}}
