...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLSX als XLS" h2="Go-Bibliothek zum Speichern von XLSX als XLS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLSX als XLS und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xlsx-to-xls/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go-Codebeispiel zum Speichern von XLSX als XLS mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Go, um Excel-Dateien in anderen Formaten wie XLSX als XLS zu speichern" >}}
