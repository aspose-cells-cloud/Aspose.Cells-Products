...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLSX unter XPS" h2="Go-Bibliothek zum Speichern von XLSX als XPS" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLSX als XPS und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xlsx-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSX-Datei unter dem Namen XPS in Go" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLSX mithilfe der Cloud Go-Bibliothek Cells als XPS speichern." >}}
