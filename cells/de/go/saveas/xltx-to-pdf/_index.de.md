---
title:  Speichern Sie XLTX unter PDF API für Go
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Go, um die Datei im XLTX-Format als Datei im Format PDF zu speichern.
url: /de/go/saveas/xltx-to-pdf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um XLTX unter PDF zu speichern" h2="Gehen Sie zur Bibliothek, um XLTX unter PDF zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLTX als PDF und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xltx-to-pdf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Go mit REST API zum Speichern von XLTX im Format PDF" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Go API, um XLTX als PDF zu speichern" >}}
