---
title:  Speichern Sie XLSM unter EMF API für Go
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Go, um die Datei im XLSM-Format als Datei im Format EMF zu speichern.
url: /de/go/saveas/xlsm-to-emf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um XLSM unter EMF zu speichern" h2="Gehen Sie zur Bibliothek, um XLSM unter EMF zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLSM als EMF und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xlsm-to-emf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Go mit REST API zum Speichern von XLSM im Format EMF" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Go API, um XLSM unter EMF zu speichern" >}}
