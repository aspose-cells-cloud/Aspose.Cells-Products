...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLT als XLTX speichern" h2="Go-Bibliothek zum Speichern von XLT als XLTX" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLT als XLTX und anderen Dokumentformaten mit Go." urlsection="saveas/xlt-to-xltx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go-Codebeispiel zum Speichern von XLT als XLTX mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie das Cells Cloud SDK für Go, um Excel-Dateien in den anderen Formaten XLT und XLTX zu speichern" >}}
