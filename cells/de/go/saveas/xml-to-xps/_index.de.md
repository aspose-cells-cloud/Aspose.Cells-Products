...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XML-Datei unter dem Namen XPS in Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von XML als XPS mit REST API" gistPath="" %}}
