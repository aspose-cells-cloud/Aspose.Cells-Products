...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Rufen Sie API auf, um XLS als FODS zu speichern" h2="Gehen Sie in die Bibliothek, um XLS als FODS zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLS als FODS und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xls-to-fods/" >}}
...
<br/>
Das Speichern von Dateiformaten aus XLS als FODS ist eine komplexe Aufgabe. Alle XLS-zu-FODS-Formatübergänge werden von unserem Go SDK durchgeführt, während der strukturelle und logische Hauptinhalt der XLS-Quelltabelle beibehalten wird. Unsere Go-Bibliothek ist eine professionelle Lösung, um XLS als FODS-Dateien online zu speichern. Dieses Cloud SDK bietet Go-Entwicklern leistungsstarke Funktionen und eine perfekte FODS-Ausgabe.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Go mit REST API zum Speichern von XLS als FODS-Format" gistPath="" %}}
