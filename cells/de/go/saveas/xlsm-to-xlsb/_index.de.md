...
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Go, um die XLSM-Formatdatei als XLSB-Formatdatei zu speichern.
url: /de/go/saveas/xlsm-to-xlsb/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um XLSM als XLSB zu speichern" h2="Gehen Sie zur Bibliothek, um XLSM als XLSB zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLSM als XLSB und anderen Dokumentformaten mit Go." urlsection="saveas/xlsm-to-xlsb/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Go mit REST API zum Speichern von XLSM im XLSB-Format" gistPath="" %}}
