...
description:  Verwenden Sie das Aspose.Cells Cloud SDK für Go, um die Datei im PNG-Format als TSV-Formatdatei zu speichern.
url: /de/go/saveas/png-to-tsv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um PNG als TSV zu speichern" h2="Gehen Sie zur Bibliothek, um PNG als TSV zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um PNG als TSV und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/png-to-tsv/" >}}
