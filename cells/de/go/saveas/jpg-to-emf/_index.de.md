---
title:  Speichern Sie JPG unter EMF API für Go
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Go, um die Datei im JPG-Format als Datei im Format EMF zu speichern.
url: /de/go/saveas/jpg-to-emf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um JPG als EMF zu speichern" h2="Gehen Sie zur Bibliothek, um JPG unter EMF zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um JPG als EMF und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/jpg-to-emf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Go mit REST API zum Speichern von JPG im Format EMF" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Go API, um JPG als EMF zu speichern" >}}
