...
description:  Verwenden Sie das Aspose.Cells Cloud SDK für Go, um Dateien im XLSX-Format als Dateien im PNG-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLSX speichern unter PNG" h2="Go-Bibliothek zum Speichern von XLSX als PNG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um XLSX als PNG und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/xlsx-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSX-Datei als PNG in Go" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSX als PNG mithilfe der Cloud Go-Bibliothek Cells." >}}
