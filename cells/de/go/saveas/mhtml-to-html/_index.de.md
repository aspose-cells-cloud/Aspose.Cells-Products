...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine MHTML-Datei unter dem Namen HTML in Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go-Codebeispiel zum Speichern von MHTML als HTML unter Verwendung von REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie MHTML mithilfe der Cloud Go-Bibliothek Cells als HTML speichern." >}}
