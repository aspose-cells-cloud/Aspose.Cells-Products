---
title:  Speichern Sie MHTML unter HTML API für Go
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Go, um die Datei im MHTML-Format als Datei im Format HTML zu speichern.
url: /de/go/saveas/mhtml-to-html/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um MHTML unter HTML zu speichern" h2="Gehen Sie zur Bibliothek, um MHTML unter HTML zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung, um MHTML als HTML und andere Dokumentformate online mit Go zu speichern." urlsection="saveas/mhtml-to-html/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Go mit REST API zum Speichern von MHTML im Format HTML" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Go API, um MHTML als HTML zu speichern" >}}
