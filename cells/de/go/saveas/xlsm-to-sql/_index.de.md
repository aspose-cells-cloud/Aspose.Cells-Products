...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie XLSM als SQL" h2="Go-Bibliothek zum Speichern von XLSM als SQL" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Speichern von XLSM als SQL und anderen Dokumentformaten mit Go." urlsection="saveas/xlsm-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go-Codebeispiel zum Speichern von XLSM als SQL mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Go, um Excel-Dateien in anderen Formaten, XLSM als SQL, zu speichern" >}}
