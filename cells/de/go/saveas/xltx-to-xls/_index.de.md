...
description:  Verwenden Sie Aspose.Cells Cloud SDK für Go, um Dateien im XLTX-Format als Dateien im XLS-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLTX als XLS mit der Cloud Go-Bibliothek Cells." >}}
