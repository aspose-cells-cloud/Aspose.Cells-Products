---
title:  XLSM zu FODS Konvertieren Sie API für Go
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Go, um eine XLSM-Formatdatei in eine FODS-Formatdatei zu konvertieren.
url: /de/go/conversion/xlsm-to-fods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Gehen Sie zu API, um XLSM in FODS zu konvertieren" h2="Gehen Sie zur Bibliothek, um XLSM in FODS zu konvertieren" p="Verwenden Sie Cells Conversion REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Go zu erstellen. Dies ist eine professionelle Lösung zum Online-Konvertieren von XLSM in FODS und andere Dokumentformate mit Go." urlsection="conversion/xlsm-to-fods/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Go API, um XLSM in FODS zu konvertieren" >}}
