...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLSM mit Python" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit dem Open-Source-Cloud-SDK für Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierung von FODS zu XLSM mit Python" %}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende XLSM-Datei abzurufen
...
{{% blocks/products/pf/agp/code-autogen title="Python Code für die Konvertierung von FODS in XLSM" gistPath="" %}}
```python
