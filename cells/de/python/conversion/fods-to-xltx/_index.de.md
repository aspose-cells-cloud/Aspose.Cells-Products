---
title:  Konvertieren Sie von Excel FODS zu XLTX via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie FODS mit Python in XLTX um" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Python" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code für die Umwandlung von FODS in XLTX" gistPath="" %}}
```python
