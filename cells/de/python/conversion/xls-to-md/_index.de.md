---
title:  XLS in MD Konvertieren Sie API in Python
description:  Verwendung des Cloud SDK Aspose.Cells für Python zum Konvertieren einer XLS-Formatdatei in eine MD-Formatdatei.
url: /de/python/conversion/xls-to-md/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Python API zum Konvertieren von XLS in MD" h2="Python-Bibliothek zum Konvertieren von XLS in MD" p="Verwenden Sie Cells Conversion REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung zum Online-Konvertieren von XLS in MD und andere Dokumentformate mit Python." urlsection="conversion/xls-to-md/" >}}
