---
title:  Wandeln Sie von Excel FODS in ODS via Python um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie FODS mit Python in ODS um" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Python" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code für die Konvertierung von FODS zu ODS" gistPath="" %}}
```python
