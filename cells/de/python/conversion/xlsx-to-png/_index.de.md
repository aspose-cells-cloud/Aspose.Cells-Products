...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie XLSX in PNG mit dem Cloud SDK Cells für Python" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie XLSX mithilfe der Cells Cloud Python-Bibliothek in PNG konvertieren." >}}
