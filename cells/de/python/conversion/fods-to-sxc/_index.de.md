---
title:  Wandeln Sie von Excel FODS in SXC via Python um
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie FODS mit Python in SXC um" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Python" >}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende SXC-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Python Code für die Umwandlung von FODS in SXC" gistPath="" %}}
```python
