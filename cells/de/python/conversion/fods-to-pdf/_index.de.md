---
title:  Konvertieren von Excel FODS zu PDF via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Python in PDF" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit dem Open-Source-Cloud-SDK für Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS zu PDF Umstellung mit Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python-Code für die Konvertierung von FODS in PDF" gistPath="" %}}
```python
