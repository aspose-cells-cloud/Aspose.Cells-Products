---
title:  SXC zu XPS Konvertieren Sie API in Python
description:  Verwenden von Aspose.Cells Cloud SDK für Python zum Konvertieren einer Datei im SXC-Format in eine Datei im XPS-Format.
url: /de/python/conversion/sxc-to-xps/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Python API, um SXC in XPS umzuwandeln" h2="Python-Bibliothek zum Konvertieren von SXC in XPS" p="Verwenden Sie Cells Conversion REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um SXC in XPS und andere Dokumentformate online mit Python zu konvertieren." urlsection="conversion/sxc-to-xps/" >}}
