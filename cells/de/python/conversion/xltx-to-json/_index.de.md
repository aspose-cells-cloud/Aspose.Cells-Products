---
title:  Konvertieren Sie XLTX in JSON mit Python
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Codebeispiel für die Konvertierung von XLTX in JSON mit Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So konvertieren Sie XLTX mithilfe der Cells Cloud Python-Bibliothek in JSON." >}}
