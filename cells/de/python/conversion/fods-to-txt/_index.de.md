...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS mit Python in TXT" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS-zu-TXT-Konvertierung mit Python" %}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende TXT-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Python Code für die Umwandlung von FODS in TXT" gistPath="" %}}
```python
