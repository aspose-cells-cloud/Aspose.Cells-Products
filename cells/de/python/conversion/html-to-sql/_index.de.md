...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Konvertieren Sie HTML in SQL mit dem Cloud SDK Cells für Python" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python Codebeispiel für die Konvertierung von HTML in SQL mithilfe des Cloud SDK Cells" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Python zum Konvertieren von Excel-Dateien in andere Formate HTML in SQL" >}}
