...
{{< blocks/products/cells/cells-cloud-section title="Konvertieren Sie HTML in XLTX mit dem Cloud SDK Cells für Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Codebeispiel für die Konvertierung von HTML in XLTX mit Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Erfahren Sie, wie Sie HTML mit der Cells Cloud Python-Bibliothek in XLTX konvertieren." >}}
