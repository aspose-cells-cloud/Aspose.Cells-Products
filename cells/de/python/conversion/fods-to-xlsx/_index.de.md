---
title:  Konvertieren Sie von Excel FODS zu XLSX via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie FODS in XLSX mit Python" h2="Lesen, bearbeiten und exportieren Sie Excel-Daten in andere Formate mit Open Source Cloud SDK für Python" >}}
...
1. Rufen Sie die Methode ```CellsApi.cells_save_as_post_document_save_as``` auf, um die resultierende XLSX-Datei zu erhalten
...
{{% blocks/products/pf/agp/code-autogen title="Python Code für die Umwandlung von FODS in XLSX" gistPath="" %}}
```python
