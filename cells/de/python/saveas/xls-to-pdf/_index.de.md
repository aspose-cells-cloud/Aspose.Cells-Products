...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS speichern unter PDF" h2="Python-Bibliothek zum Speichern von XLS unter PDF" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um XLS als PDF und andere Dokumentformate online unter Python zu speichern." urlsection="saveas/xls-to-pdf/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS als PDF mithilfe der Cells Cloud Python-Bibliothek." >}}
