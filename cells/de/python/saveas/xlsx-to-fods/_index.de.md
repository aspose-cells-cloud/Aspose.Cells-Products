...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSX-Datei als FODS in Python" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSX als FODS mithilfe der Cells Cloud Python-Bibliothek." >}}
