...
description:  Verwenden des Aspose.Cells Cloud SDK für Python, um Dateien im ODS-Format als Dateien im FODS-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie ODS als FODS mithilfe der Cells Cloud Python-Bibliothek." >}}
