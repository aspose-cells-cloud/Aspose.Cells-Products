---
title:  Speichern Sie XLSM unter SVG API für Python
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Python, um die Datei im XLSM-Format als Datei im Format SVG zu speichern.
url: /de/python/saveas/xlsm-to-svg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Python API, um XLSM unter SVG zu speichern" h2="Python-Bibliothek, um XLSM unter SVG zu speichern" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um XLSM als SVG und andere Dokumentformate online mit Python zu speichern." urlsection="saveas/xlsm-to-svg/" >}}
