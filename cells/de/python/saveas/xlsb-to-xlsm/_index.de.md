...
description:  Verwenden des Aspose.Cells Cloud SDK für Python, um Dateien im XLSB-Format als Dateien im XLSM-Format zu speichern.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Speichern Sie XLSB als XLSM" h2="Python Bibliothek zum Speichern von XLSB als XLSM" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um XLSB als XLSM und andere Dokumentformate online mit Python zu speichern." urlsection="saveas/xlsb-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLSB-Datei als XLSM unter Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Codebeispiel zum Speichern von XLSB als XLSM mit REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als XLSM mithilfe der Cells Cloud Python-Bibliothek." >}}
