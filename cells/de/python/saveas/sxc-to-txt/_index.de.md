...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Speichern Sie SXC als TXT" h2="Python Bibliothek zum Speichern von SXC als TXT" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um SXC als TXT und andere Dokumentformate online mit Python zu speichern." urlsection="saveas/sxc-to-txt/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python Codebeispiel zum Speichern von SXC als TXT mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Python, um Excel-Dateien in anderen Formaten wie SXC und TXT zu speichern" >}}
