...
description:  Verwenden des Aspose.Cells Cloud SDK für Python, um Dateien im XLSB-Format als Dateien im WMF-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLSB als WMF mithilfe der Cells Cloud Python-Bibliothek." >}}
