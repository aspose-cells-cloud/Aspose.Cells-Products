...
{{< blocks/products/cells/cells-cloud-section title="Speichern Sie eine XLT-Datei als PPTX in Python" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLT als PPTX mithilfe der Cells Cloud Python-Bibliothek." >}}
