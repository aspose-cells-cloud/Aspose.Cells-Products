...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS speichern unter PNG" h2="Python-Bibliothek zum Speichern von XLS unter PNG" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um XLS als PNG und andere Dokumentformate online unter Python zu speichern." urlsection="saveas/xls-to-png/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie XLS als PNG mithilfe der Cells Cloud Python-Bibliothek." >}}
