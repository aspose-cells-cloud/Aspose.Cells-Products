---
title:  Speichern Sie MHTML als JPG API für Python
description:  Verwenden Sie das Cloud SDK Aspose.Cells für Python, um eine Datei im MHTML-Format als Datei im JPG-Format zu speichern.
url: /de/python/saveas/mhtml-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Python API, um MHTML als JPG zu speichern" h2="Python-Bibliothek zum Speichern von MHTML als JPG" p="Verwenden Sie Cells SaveAs REST API, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um MHTML als JPG und andere Dokumentformate online mit Python zu speichern." urlsection="saveas/mhtml-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Speichern Sie eine MHTML-Datei als JPG unter Python" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Codebeispiel in Python mit REST API zum Speichern von MHTML im JPG-Format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Python API, um MHTML als JPG zu speichern" >}}
