...
description: Verwenden des Aspose.Cells Cloud SDK für Python, um Dateien im SXC-Format als Dateien im XPS-Format zu speichern.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So speichern Sie SXC als XPS mithilfe der Cells Cloud Python-Bibliothek." >}}
