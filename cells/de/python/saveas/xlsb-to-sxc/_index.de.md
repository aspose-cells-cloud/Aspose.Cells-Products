...
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSB als SXC speichern" h2="Python Bibliothek zum Speichern von XLSB als SXC" p="Verwenden Sie SaveAs API von Cells Cloud, um benutzerdefinierte Tabellenkalkulations-Workflows in Python zu erstellen. Dies ist eine professionelle Lösung, um XLSB als SXC und andere Dokumentformate online mit Python zu speichern." urlsection="saveas/xlsb-to-sxc/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python Codebeispiel zum Speichern von XLSB als SXC mit REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="So verwenden Sie Cells Cloud SDK für Python, um Excel-Dateien in anderen Formaten, XLSB und SXC zu speichern" >}}
