---
title: Convert MHTML to XLSM on Android 
...
outformat: XLSM
platform: Android
otherformats: TSV TIFF FODS SXC XLSX CSV HTML TXT MD XML DIF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XLSM in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to XLSM Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: MHTML to XLSM Conversion" gistPath="" %}}
```java
