---
title: Convert PNG to BMP via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PNG to  BMP in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PNG to BMP Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for PNG to BMP Conversion" gistPath="" %}}
```java
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=png  outputformat=bmp  %}}
