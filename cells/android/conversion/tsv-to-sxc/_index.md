---
title: Convert TSV to SXC on Android 
...
outformat: SXC
platform: Android
otherformats: XLT PDF XLTX XLSX ODS SXC XPS DIF TIFF XLSM CSV MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to SXC in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to SXC Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: TSV to SXC Conversion" gistPath="" %}}
```java
