---
title: Convert XML to HTML on Android 
...
outformat: HTML
platform: Android
otherformats: ODS DIF XLT XLSM XLTX XLTM XLSB TXT MHTML CSV XPS TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to HTML in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to HTML Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XML to HTML Conversion" gistPath="" %}}
```java
