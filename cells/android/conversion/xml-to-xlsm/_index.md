---
title: Convert XML to XLSM on Android 
...
outformat: XLSM
platform: Android
otherformats: HTML XLT XLSM TXT TIFF SVG ODS SXC FODS XLTM XPS DIF XLSB MHTML PDF TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSM in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to XLSM Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XML to XLSM Conversion" gistPath="" %}}
```java
