---
title: Convert SXC to XLSX on Android 
...
outformat: XLSX
platform: Android
otherformats: XLSB XLSM PDF FODS MD TSV XLTX MHTML XPS XML CSV TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSX in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to XLSX Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: SXC to XLSX Conversion" gistPath="" %}}
```java
