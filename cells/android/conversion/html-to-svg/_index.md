---
title: Convert HTML to SVG on Android 
...
outformat: SVG
platform: Android
otherformats: TXT XLTX SXC TSV XLS TIFF DIF MHTML SVG PDF XLTM MD CSV ODS XLSB XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to SVG in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to SVG Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: HTML to SVG Conversion" gistPath="" %}}
```java
