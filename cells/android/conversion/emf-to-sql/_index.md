---
title: Convert EMF to SQL via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert EMF to  SQL in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="EMF to SQL Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for EMF to SQL Conversion" gistPath="" %}}
```java
