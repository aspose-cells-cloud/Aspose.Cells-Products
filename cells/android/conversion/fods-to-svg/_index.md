---
title: Convert FODS to SVG on Android 
...
url: /android/conversion/fods-to-svg/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to SVG in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to SVG Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS to SVG Conversion" gistPath="" %}}
```java
