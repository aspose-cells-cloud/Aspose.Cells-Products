---
title: Convert XML to SVG on Android 
...
outformat: SVG
platform: Android
otherformats: FODS MHTML CSV SXC TSV PDF XLSB DIF TIFF XLSM XPS XLTX XLSX XLTM TXT MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to SVG in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to SVG Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XML to SVG Conversion" gistPath="" %}}
```java
