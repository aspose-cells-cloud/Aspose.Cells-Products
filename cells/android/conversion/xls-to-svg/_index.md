---
title: Convert XLS to SVG on Android 
...
outformat: SVG
platform: Android
otherformats: TXT ODS DIF HTML XML XLTX PDF SVG TSV FODS XLSB MD SXC CSV XLSX XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to SVG in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to SVG Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLS to SVG Conversion" gistPath="" %}}
```java
