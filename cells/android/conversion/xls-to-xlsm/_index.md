---
title: Convert XLS to XLSM via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to  XLSM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSM Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for XLS to XLSM Conversion" gistPath="" %}}
```java
