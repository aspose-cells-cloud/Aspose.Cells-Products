---
title: Convert XLSB to HTML on Android 
...
outformat: HTML
platform: Android
otherformats: XLSM HTML XLTX FODS DIF SXC MD XLSX PDF SVG TXT XPS XLTM XML TSV MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to HTML in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to HTML Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLSB to HTML Conversion" gistPath="" %}}
```java
