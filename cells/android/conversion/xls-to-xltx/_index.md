---
title: Convert XLS to XLTX on Android 
...
outformat: XLTX
platform: Android
otherformats: MHTML TIFF XLTX XLSM XLTM XML SVG MD DIF ODS XPS XLSB SXC TXT TSV XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLTX in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLTX Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLS to XLTX Conversion" gistPath="" %}}
```java
