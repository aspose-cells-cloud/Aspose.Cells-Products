---
title: Convert BMP to FODS via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert BMP to  FODS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="BMP to FODS Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for BMP to FODS Conversion" gistPath="" %}}
```java
