---
title: Convert XLTX to DIF via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to  DIF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTX to DIF Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for XLTX to DIF Conversion" gistPath="" %}}
```java
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=xltx  outputformat=dif  %}}
