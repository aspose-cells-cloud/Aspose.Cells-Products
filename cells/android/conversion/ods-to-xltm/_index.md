---
title: Convert ODS to XLTM via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to  XLTM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODS to XLTM Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for ODS to XLTM Conversion" gistPath="" %}}
```java
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=ods  outputformat=xltm  %}}
