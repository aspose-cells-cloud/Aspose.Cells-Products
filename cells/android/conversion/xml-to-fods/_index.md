---
title: Convert XML to FODS on Android 
...
outformat: FODS
platform: Android
otherformats: DIF PDF MHTML XLSX TIFF CSV XLTM FODS TSV XLSM XPS SXC XLTX XLSB TXT SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to FODS in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to FODS Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XML to FODS Conversion" gistPath="" %}}
```java
