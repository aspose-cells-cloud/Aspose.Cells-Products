---
title: Convert BMP to PNG via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert BMP to  PNG in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="BMP to PNG Conversion in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for BMP to PNG Conversion" gistPath="" %}}
```java
