---
title: Convert HTML to TXT on Android 
...
outformat: TXT
platform: Android
otherformats: MD FODS XLT CSV DIF XLSX XML SXC XLTM TIFF XLTX XPS TXT MHTML SVG PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to TXT in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to TXT Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: HTML to TXT Conversion" gistPath="" %}}
```java
