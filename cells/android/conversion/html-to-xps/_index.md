---
title: Convert HTML to XPS on Android 
...
outformat: XPS
platform: Android
otherformats: MD XLS TIFF MHTML SVG XPS XLSB TSV DIF PDF XLSM XLTX FODS SXC CSV TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XPS in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to XPS Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: HTML to XPS Conversion" gistPath="" %}}
```java
