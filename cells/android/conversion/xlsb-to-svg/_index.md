---
title: Convert XLSB to SVG on Android 
...
outformat: SVG
platform: Android
otherformats: CSV PDF HTML XML XLSM SXC DIF MHTML ODS XLT TSV XLSX FODS TXT XLTM TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to SVG in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to SVG Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLSB to SVG Conversion" gistPath="" %}}
```java
