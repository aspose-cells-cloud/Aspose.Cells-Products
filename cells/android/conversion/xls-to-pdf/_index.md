---
title: Convert XLS to PDF on Android 
...
outformat: PDF
platform: Android
otherformats: TXT MD MHTML SXC DIF XPS ODS XML XLTX XLSB FODS TSV XLSX SVG XLTM TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to PDF in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to PDF Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLS to PDF Conversion" gistPath="" %}}
```java
