---
title: Convert MHTML to FODS on Android 
...
outformat: FODS
platform: Android
otherformats: PDF DIF XLT ODS HTML XLSX XLTM SVG TIFF CSV MD FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to FODS in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to FODS Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: MHTML to FODS Conversion" gistPath="" %}}
```java
