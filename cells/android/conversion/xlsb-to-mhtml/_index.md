---
title: Convert XLSB to MHTML on Android 
...
outformat: MHTML
platform: Android
otherformats: XLT FODS CSV DIF MD XLTX XLS XLSM TXT PDF XPS XLSX TSV SXC TIFF XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to MHTML in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to MHTML Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLSB to MHTML Conversion" gistPath="" %}}
```java
