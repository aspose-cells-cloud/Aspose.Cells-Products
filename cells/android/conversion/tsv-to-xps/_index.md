...
outformat: XPS
platform: Android
otherformats: XML CSV FODS HTML TXT XLTX XLSX MD DIF XLTM XLSB TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XPS in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to XPS Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: TSV to XPS Conversion" gistPath="" %}}
```java
