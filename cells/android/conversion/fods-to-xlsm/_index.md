...
outformat: XLSM
platform: Android
otherformats: ODS MD DIF SVG XLTX TXT MHTML FODS XLSX TIFF PDF XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to XLSM in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to XLSM Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS to XLSM Conversion" gistPath="" %}}
```java
