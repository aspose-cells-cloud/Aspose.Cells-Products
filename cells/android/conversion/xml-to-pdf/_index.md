---
title: Convert XML to PDF on Android 
...
outformat: PDF
platform: Android
otherformats: XLSM DIF XLSX XLTM TXT SXC CSV FODS SVG MHTML XPS TIFF XLSB MD PDF TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to PDF in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to PDF Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XML to PDF Conversion" gistPath="" %}}
```java
