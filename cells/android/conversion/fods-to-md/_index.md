---
title: Convert FODS to MD on Android 
...
url: /android/conversion/fods-to-md/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to MD in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to MD Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS to MD Conversion" gistPath="" %}}
```java
