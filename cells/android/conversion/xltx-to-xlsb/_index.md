---
title: Convert XLTX to XLSB on Android 
...
outformat: XLSB
platform: Android
otherformats: XPS XLSB CSV MD ODS DIF SXC FODS XLSM SVG HTML MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to XLSB in the Cloud" h2="Convert Excel & OpenOffice spreadsheets with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLSB Conversion in Android Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: XLTX to XLSB Conversion" gistPath="" %}}
```java
