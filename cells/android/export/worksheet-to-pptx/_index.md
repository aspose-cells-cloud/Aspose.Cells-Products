---
title: Export Worksheet to PPTX file via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Worksheet to PPTX file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Worksheet to PPTX file in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for WORKSHEET to PPTX Conversion" gistPath="" %}}
```java
