---
title: Export Worksheet to PDF file via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Worksheet to PDF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Worksheet to PDF file in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for WORKSHEET to PDF Conversion" gistPath="" %}}
```java
...
{{% blocks/products/cells/cells-cloud-api-run-export  InputFormat="xlsx,*.xls,*.csv,*.txt,*.ods"  OutputFormat=pdf  ExportObjectType=worksheet %}}
