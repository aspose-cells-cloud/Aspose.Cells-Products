---
title: Export Chart to SVG file via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Chart to SVG file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Chart to SVG file in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for CHART to SVG Conversion" gistPath="" %}}
```java
