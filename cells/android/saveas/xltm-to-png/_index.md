---
title: Save XLTM as PNG via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XLTM file as  PNG file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XLTM file as PNG file in Cloud SDK for Android " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android Code for saving XLTM as PNG " gistPath="" %}}
```java
