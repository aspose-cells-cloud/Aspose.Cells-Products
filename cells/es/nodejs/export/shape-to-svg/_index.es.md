...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar FORMA a SVG desde Excel" h2="Biblioteca NodeJS para exportar SHAPE al archivo SVG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en NodeJS. Esta es una solución profesional para exportar SHAPE a un archivo de formato SVG desde una hoja de cálculo en línea usando NodeJS." urlsection="export/shape-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto SHAPE al archivo de formato SVG usando Cells Cloud SDK para NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en NodeJS usando REST API para exportar SHAPE al formato SVG desde una hoja de cálculo" gistPath="" %}}
