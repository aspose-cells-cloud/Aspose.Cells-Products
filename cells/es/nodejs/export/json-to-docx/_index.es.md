---
title: Exportar Json al archivo DOCX via NodeJS
...
url: /es/nodejs/export/json-to-docx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exportar JSON a archivo DOCX en la Nube" h2="Excel y exportación de hojas de cálculo de OpenOffice con Cloud SDK de código abierto para NodeJS" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Exoptar JSON a archivo DOCX en Cloud SDK para NodeJS" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código NodeJS para la conversión de JSON a DOCX" gistPath="" %}}
```js
