...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar LIBRO DE TRABAJO a SVG desde Excel" h2="Biblioteca NodeJS para exportar WORKBOOK al archivo SVG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en NodeJS. Esta es una solución profesional para exportar WORKBOOK a un archivo con formato SVG desde una hoja de cálculo en línea usando NodeJS." urlsection="export/workbook-to-svg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto WORKBOOK a un archivo de formato SVG usando Cells Cloud SDK para NodeJS" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en NodeJS usando REST API para exportar WORKBOOK al formato SVG desde una hoja de cálculo" gistPath="" %}}
