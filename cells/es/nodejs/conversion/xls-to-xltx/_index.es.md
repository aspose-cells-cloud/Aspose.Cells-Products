...
---
{{< blocks/products/cells/cells-cloud-banner h1="Convertir XLS a XLTX" h2="Biblioteca NodeJS para convertir XLS a XLTX" p="Utilice la nube de conversión API de Cells para crear flujos de trabajo de hojas de cálculo personalizados en proyectos NodeJS. Esta es una solución profesional para convertir XLS a XLTX y otros formatos de documentos en línea usando NodeJS." urlsection="conversion/xls-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Convierta XLS a XLTX usando Cells Cloud SDK para NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código NodeJS para convertir XLS a XLTX usando Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo convertir XLS a XLTX usando la biblioteca Cells Cloud NodeJS." >}}
