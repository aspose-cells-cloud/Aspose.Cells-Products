...
description: Usando Aspose.Cells Cloud SDK para NodeJS para convertir un archivo de formato XLT a un archivo de formato PPTX.
url: /es/nodejs/conversion/xlt-to-pptx/
---
