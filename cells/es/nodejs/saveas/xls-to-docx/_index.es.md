...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guardar XLS como DOCX" h2="Biblioteca NodeJS para guardar XLS como DOCX" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en NodeJS. Esta es una solución profesional para guardar XLS como DOCX y otros formatos de documentos en línea usando NodeJS." urlsection="saveas/xls-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo XLS como DOCX en NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código NodeJS para guardar XLS como DOCX usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar XLS como DOCX usando la biblioteca Cells Cloud NodeJS." >}}
