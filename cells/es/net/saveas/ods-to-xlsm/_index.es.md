---
title:  Guarde ODS como XLSM usando C#
description:  Utilizando Aspose.Cells Cloud SDK para C# para guardar el archivo en formato ODS como archivo en formato XLSM.
kwords: Excel, Save ODS as XLSM, REST, C#
howto: How to save ODS as XLSM using Aspose.Cells Cloud C# library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Guardar ODS como XLSM" h2="Biblioteca C# para guardar ODS como XLSM" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en Net. Esta es una solución profesional para guardar ODS como XLSM y otros formatos de documentos en línea usando C#." urlsection="saveas/ods-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo ODS como XLSM en C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Ejemplo de código para guardar ODS como XLSM usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar ODS como XLSM usando la biblioteca Cloud Net Cells." >}}
