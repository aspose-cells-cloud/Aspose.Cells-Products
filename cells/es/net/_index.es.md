---
title: Gestión ligera de hojas de cálculo | Cloud Excel y OpenOffice API
description: Descubra una solución intuitiva y de bajo código para gestionar sus hojas de cálculo en la nube. Nuestro RESTful API le permite crear, leer, escribir, fusionar, dividir, cifrar y convertir fácilmente archivos Excel y OpenOffice en línea. Optimice su flujo de trabajo con nuestros servicios en la nube, eficientes y ligeros.
baskewi: hugo,cells
weight: 90
---
...
{{< blocks/products/cells/languge-index-ferturecard title="Unir" desc="Merge local spreadsheet files into a specified format file." url="/cells/net/merge" imgurl="/cells/images/merge.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Proteger" desc="Applies dual-layer password protection to Excel spreadsheets, supporting both open and modify passwords with encryption." url="/cells/net/protect" imgurl="/cells/images/protect.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Guardar como" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/net/saveas" imgurl="/cells/images/saveas.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Exportar" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/net/export" imgurl="/cells/images/export.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Claro" desc="Clear cell formats in the worksheet." url="/cells/net/clear" imgurl="/cells/images/clear.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Fondo" desc="Set background in the workbook." url="/cells/net/background" imgurl="/cells/images/background.svg" >}}
