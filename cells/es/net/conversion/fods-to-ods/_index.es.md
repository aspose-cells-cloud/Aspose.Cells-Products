---
title:  Convertir FODS a ODS via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a ODS en la nube" h2="Excel y conversión de hojas de cálculo de OpenOffice con Cloud SDK de código abierto for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Código para conversión de FODS a ODS" gistPath="" %}}
```cs
