---
title:  Convertir FODS a XLSM via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a XLSM en la nube" h2="Excel y conversión de hoja de cálculo de OpenOffice con SDK de nube de código abierto for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a XLSM en aplicaciones .NET" %}}
...
1. Llame al método ```CellsApi.CellsSaveAsPostDocumentSaveAs``` para obtener el archivo XLSM resultante
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Código para conversión de FODS a XLSM" gistPath="" %}}
```cs
