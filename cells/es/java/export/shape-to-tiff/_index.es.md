...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar FORMA a TIFF desde Excel" h2="Biblioteca Java para exportar SHAPE al archivo TIFF" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Java. Esta es una solución profesional para exportar FORMA a un archivo de formato TIFF desde una hoja de cálculo en línea usando Java." urlsection="export/shape-to-tiff/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto SHAPE al archivo de formato TIFF usando Cells Cloud SDK for Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Java usando REST API para exportar FORMA al formato TIFF desde una hoja de cálculo" gistPath="" %}}
