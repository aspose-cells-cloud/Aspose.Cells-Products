...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar FORMA a PNG desde Excel" h2="Biblioteca Java para exportar SHAPE al archivo PNG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Java. Esta es una solución profesional para exportar FORMA a un archivo de formato PNG desde una hoja de cálculo en línea usando Java." urlsection="export/shape-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto SHAPE al archivo de formato PNG usando Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en Java usando REST API para exportar FORMA al formato PNG desde una hoja de cálculo" gistPath="" %}}
