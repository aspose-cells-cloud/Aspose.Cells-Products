...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar FORMA a WMF desde Excel" h2="Biblioteca Java para exportar SHAPE a un archivo WMF" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Java. Esta es una solución profesional para exportar archivos de formato SHAPE a WMF desde una hoja de cálculo en línea usando Java." urlsection="export/shape-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto SHAPE a un archivo en formato WMF usando Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en Java usando REST API para exportar SHAPE al formato WMF desde una hoja de cálculo" gistPath="" %}}
