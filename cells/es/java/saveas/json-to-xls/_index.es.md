---
title:  Guardar JSON como XLS API for Java
description:  Usando Aspose.Cells Cloud SDK for Java para guardar el archivo de formato JSON como archivo de formato XLS.
url: /es/java/saveas/json-to-xls/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API para guardar JSON como XLS" h2="Java biblioteca para guardar JSON como XLS" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Java. Esta es una solución profesional para guardar JSON como XLS y otros formatos de documentos en línea usando Java." urlsection="saveas/json-to-xls/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Java usando REST API para guardar JSON como formato XLS" gistPath="" %}}
