---
title:  Guardar JSON como ODS API for Java
description:  Usando Aspose.Cells Cloud SDK for Java para guardar el archivo de formato JSON como archivo de formato ODS.
url: /es/java/saveas/json-to-ods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API para guardar JSON como ODS" h2="Java biblioteca para guardar JSON como ODS" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Java. Esta es una solución profesional para guardar JSON como ODS y otros formatos de documentos en línea usando Java." urlsection="saveas/json-to-ods/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Guarde un archivo JSON como ODS en Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Java usando REST API para guardar JSON como formato ODS" gistPath="" %}}
