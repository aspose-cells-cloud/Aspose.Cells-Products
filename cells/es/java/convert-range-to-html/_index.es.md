---
title: Convierte un rango de hoja de cálculo en una unidad local a un archivo html.
description: Este método lee un archivo de hoja de cálculo del sistema de archivos local, convierte su rango al archivo html deseado y devuelve el resultado convertido. \nLa ruta del archivo fuente y el formato objetivo deben especificarse correctamente. \nAsegúrese de que los permisos necesarios estén habilitados para leer el archivo fuente y escribir el archivo convertido, si corresponde. \nEl proceso de conversión ocurre completamente en el servidor en la nube, eliminando la necesidad de cualquier almacenamiento en la nube o descargas externas. \nSi el archivo fuente no existe, es inaccesible, o si ocurre un error durante el proceso de conversión, se lanzará una excepción apropiada. \nLos formatos soportados para la conversión dependen de las bibliotecas disponibles y sus capacidades.
kwords: aspose cells
url: /es/java/convert-range-to-html/
---
