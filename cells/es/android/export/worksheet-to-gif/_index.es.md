---
title:  Exporte HOJA DE TRABAJO a GIF desde Excel usando Cells Cloud SDK para Android
description:  Aspose.Cells Cloud REST API admite la exportación de archivos de formato {0} a {1} usando {2}.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar HOJA DE TRABAJO a GIF desde Excel" h2="Biblioteca de Android para exportar HOJA DE TRABAJO a archivo GIF" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Android. Esta es una solución profesional para exportar HOJA DE TRABAJO a un archivo en formato GIF desde una hoja de cálculo en línea usando Android." urlsection="export/worksheet-to-gif/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Cells Cloud SDK para Android para exportar objetos de Excel WORKSHEET a GIF" >}}
