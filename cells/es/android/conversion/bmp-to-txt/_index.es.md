---
title:  BMP a TXT Convertir API para Android
description: Usando Aspose.Cells Cloud SDK para Android para convertir un archivo de formato BMP a un archivo de formato TXT.
url: /es/android/conversion/bmp-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API para convertir BMP a TXT" h2="Biblioteca de Android para convertir BMP a TXT" p="Use Cells Conversion REST API para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para convertir BMP a TXT y otros formatos de documentos en línea usando Android." urlsection="conversion/bmp-to-txt/" >}}
