---
title:  Convertir FODS a XML en Android
...
url: /es/android/conversion/fods-to-xml/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a XML en la nube" h2="Convierta Excel y hojas de cálculo de OpenOffice con Cloud SDK de código abierto para Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a XML en aplicaciones de Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: conversión de FODS a XML" gistPath="" %}}
```java
