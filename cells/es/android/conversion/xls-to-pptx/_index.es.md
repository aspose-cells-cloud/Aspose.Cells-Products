...
description: Usando Aspose.Cells Cloud SDK para Android para convertir un archivo de formato XLS a un archivo de formato PPTX.
url: /es/android/conversion/xls-to-pptx/
---
