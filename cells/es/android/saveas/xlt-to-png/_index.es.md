...
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato XLT como archivo de formato PNG.
url: /es/android/saveas/xlt-to-png/
---
