---
title:  Guardar EMF como XLS API para Android
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato EMF como archivo de formato XLS.
url: /es/android/saveas/emf-to-xls/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API para guardar EMF como XLS" h2="Biblioteca de Android para guardar EMF como XLS" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para guardar EMF como XLS y otros formatos de documentos en línea usando Android." urlsection="saveas/emf-to-xls/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Java API para guardar EMF como XLS" >}}
