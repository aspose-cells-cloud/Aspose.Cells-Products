...
{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo PNG como JPG en Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código de Android para guardar PNG como JPG usando REST API" gistPath="" %}}
