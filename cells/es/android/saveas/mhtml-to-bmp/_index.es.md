---
title:  Guardar MHTML como BMP API para Android
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato MHTML como archivo de formato BMP.
url: /es/android/saveas/mhtml-to-bmp/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API para guardar MHTML como BMP" h2="Biblioteca de Android para guardar MHTML como BMP" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para guardar MHTML como BMP y otros formatos de documentos en línea usando Android." urlsection="saveas/mhtml-to-bmp/" >}}
