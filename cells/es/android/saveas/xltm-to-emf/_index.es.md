...
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato XLTM como archivo de formato EMF.
url: /es/android/saveas/xltm-to-emf/
---
