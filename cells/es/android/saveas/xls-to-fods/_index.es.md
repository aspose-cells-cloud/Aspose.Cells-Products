...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guarde XLS como FODS" h2="Biblioteca de Android para guardar XLS como FODS" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para guardar XLS como FODS y otros formatos de documentos en línea usando Android." urlsection="saveas/xls-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo XLS como FODS en Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código de Android para guardar XLS como FODS usando REST API" gistPath="" %}}
