...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guarde JSON como XPS" h2="Biblioteca de Android para guardar JSON como XPS" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para guardar JSON como XPS y otros formatos de documentos en línea usando Android." urlsection="saveas/json-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo JSON como XPS en Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código de Android para guardar JSON como XPS usando REST API" gistPath="" %}}
