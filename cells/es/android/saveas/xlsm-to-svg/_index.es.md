...
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato XLSM como archivo de formato SVG.
url: /es/android/saveas/xlsm-to-svg/
---
