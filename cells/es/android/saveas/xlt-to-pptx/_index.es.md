...
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato XLT como archivo de formato PPTX.
url: /es/android/saveas/xlt-to-pptx/
---
