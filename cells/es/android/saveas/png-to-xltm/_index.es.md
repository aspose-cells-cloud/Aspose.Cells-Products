...
{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo PNG como XLTM en Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código de Android para guardar PNG como XLTM usando REST API" gistPath="" %}}
