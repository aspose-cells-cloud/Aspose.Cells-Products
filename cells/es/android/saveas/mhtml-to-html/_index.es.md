---
title:  Guardar MHTML como HTML API para Android
description: Usando Aspose.Cells Cloud SDK para Android para guardar el archivo de formato MHTML como archivo de formato HTML.
url: /es/android/saveas/mhtml-to-html/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API para guardar MHTML como HTML" h2="Biblioteca de Android para guardar MHTML como HTML" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para guardar MHTML como HTML y otros formatos de documentos en línea usando Android." urlsection="saveas/mhtml-to-html/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Java API para guardar MHTML como HTML" >}}
