...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guarde XLSM como SQL" h2="Biblioteca de Android para guardar XLSM como SQL" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en Android. Esta es una solución profesional para guardar XLSM como SQL y otros formatos de documentos en línea usando Android." urlsection="saveas/xlsm-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo XLSM como SQL en Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código de Android para guardar XLSM como SQL usando REST API" gistPath="" %}}
