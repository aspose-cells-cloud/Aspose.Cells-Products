...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a XLS con Python" h2="Lea, edite y exporte datos de Excel a otros formatos con el SDK de nube de código abierto para Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a XLS con Python" %}}
...
1. Llame al método ```CellsApi.cells_save_as_post_document_save_as``` para obtener el archivo XLS resultante
...
{{% blocks/products/pf/agp/code-autogen title="Python Código para conversión de FODS a XLS" gistPath="" %}}
```python
