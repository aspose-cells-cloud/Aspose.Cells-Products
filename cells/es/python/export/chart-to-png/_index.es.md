...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar TABLA a PNG desde Excel" h2="Biblioteca Python para exportar CHART al archivo PNG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Python. Esta es una solución profesional para exportar CHART a un archivo de formato PNG desde una hoja de cálculo en línea usando Python." urlsection="export/chart-to-png/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto CHART al archivo de formato PNG usando Cells Cloud SDK para Python" >}}
