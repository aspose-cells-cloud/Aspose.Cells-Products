...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar IMAGEN al PNG desde Excel" h2="Biblioteca Python para exportar IMAGEN al archivo PNG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Python. Esta es una solución profesional para exportar IMAGEN a un archivo de formato PNG desde una hoja de cálculo en línea usando Python." urlsection="export/picture-to-png/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto IMAGEN al archivo de formato PNG usando Cells Cloud SDK para Python" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Python usando REST API para exportar IMAGEN al formato PNG desde una hoja de cálculo" gistPath="" %}}
