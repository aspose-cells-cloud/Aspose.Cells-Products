...
url: /es/python/export/json-to-docx/
---
...
{{% blocks/products/pf/agp/feature-section-col title=" Exoprt de archivo JSON a DOCX en Cloud SDK para Python" %}}
...
1. Llame al método ```cells_workbook_put_convert_workbook``` para obtener la secuencia DOCX resultante
...
{{% blocks/products/pf/agp/code-autogen title="Python Código para conversión de JSON a DOCX" gistPath="" %}}
```python
