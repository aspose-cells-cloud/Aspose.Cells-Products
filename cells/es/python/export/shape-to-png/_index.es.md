...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar FORMA a PNG desde Excel" h2="Biblioteca Python para exportar SHAPE al archivo PNG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Python. Esta es una solución profesional para exportar FORMA a un archivo de formato PNG desde una hoja de cálculo en línea usando Python." urlsection="export/shape-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto SHAPE al archivo de formato PNG usando Cells Cloud SDK para Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en Python usando REST API para exportar FORMA al formato PNG desde una hoja de cálculo" gistPath="" %}}
