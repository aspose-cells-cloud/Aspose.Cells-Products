...
description: Usando Aspose.Cells Cloud SDK para Python para guardar el archivo de formato PNG como archivo de formato TIFF.
url: /es/python/saveas/png-to-tiff/
---
