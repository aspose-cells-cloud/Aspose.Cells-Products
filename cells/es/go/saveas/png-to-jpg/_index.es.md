---
title:  Guarde PNG como JPG API para Go
description:  Usando Aspose.Cells Cloud SDK for Go para guardar el archivo de formato PNG como archivo de formato JPG.
url: /es/go/saveas/png-to-jpg/
---
...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Guarde un archivo PNG como JPG en Go" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Go usando REST API para guardar PNG como formato JPG" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Go API para guardar PNG como JPG" >}}
