---
title:  Guarde PNG como TIFF API para Ir
description:  Usando Aspose.Cells Cloud SDK for Go para guardar el archivo de formato PNG como archivo de formato TIFF.
url: /es/go/saveas/png-to-tiff/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Vaya al API para guardar el PNG como TIFF" h2="Vaya a la biblioteca para guardar PNG como TIFF" p="Utilice Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Go. Esta es una solución profesional para guardar PNG como TIFF y otros formatos de documentos en línea usando Go." urlsection="saveas/png-to-tiff/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Go usando REST API para guardar PNG como formato TIFF" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Go API para guardar PNG como TIFF" >}}
