---
title:  Establecer fondo en el archivo Excel
description:  Aspose.Cells Cloud REST API admite la configuración de fondos para archivos Excel y proporciona SDK para varios lenguajes de programación, incluidos Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Establecer fondo en el archivo Excel" h2="Aspose.Cells Cloud SDK admite la configuración de fondos o marcas de agua para archivos Excel." p="Aspose.Cells Cloud REST API admite la configuración de fondos para archivos Excel y proporciona SDK para varios lenguajes de programación, incluidos Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift." urlsection="" >}}
...
{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Net" title="Agregar marca de agua para múltiples archivos Excel" imgSrc="/cells/app-logos/cells_cloud_conversion.svg" productLink="/cells/net/background/add-watermark/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Java" title="Agregar marca de agua para múltiples archivos Excel" imgSrc="/cells/app-logos/cells_cloud_conversion.svg" productLink="/cells/java/background/add-watermark/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Go" title="Agregar marca de agua para múltiples archivos Excel" imgSrc="/cells/app-logos/cells_cloud_conversion.svg" productLink="/cells/go/background/add-watermark/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for PHP" title="Agregar marca de agua para múltiples archivos Excel" imgSrc="/cells/app-logos/cells_cloud_conversion.svg" productLink="/cells/php/background/add-watermark/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Node" title="Agregar marca de agua para múltiples archivos Excel" imgSrc="/cells/app-logos/cells_cloud_conversion.svg" productLink="/cells/nodejs/background/add-watermark/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Python" title="Agregar marca de agua para múltiples archivos Excel" imgSrc="/cells/app-logos/cells_cloud_conversion.svg" productLink="/cells/python/background/add-watermark/" >}}
