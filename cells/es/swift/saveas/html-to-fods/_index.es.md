...
description:  Uso de Aspose.Cells Cloud SDK para Swift para guardar el archivo de formato HTML como archivo de formato FODS.
url: /es/swift/saveas/html-to-fods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para guardar HTML como FODS" h2="Biblioteca Swift para guardar HTML como FODS" p="Utilice Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Swift. Esta es una solución profesional para guardar HTML como FODS y otros formatos de documentos en línea usando Swift." urlsection="saveas/html-to-fods/" >}}
