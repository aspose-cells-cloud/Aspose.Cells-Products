---
title:  Guarde PNG como XLS API para Swift
description: Uso de Aspose.Cells Cloud SDK para Swift para guardar el archivo de formato PNG como archivo de formato XLS.
...
<br/>
Guardar formatos de archivo de PNG como XLS es una tarea compleja. Todas las transiciones de formato PNG a XLS las realiza nuestro Swift SDK mientras se mantiene el contenido estructural y lógico principal de la hoja de cálculo de origen PNG. Nuestra biblioteca Swift es una solución profesional para guardar PNG como archivos XLS en línea. Este Cloud SDK ofrece a los desarrolladores de Swift una potente funcionalidad y una salida XLS perfecta.
<br/>
<br/>
