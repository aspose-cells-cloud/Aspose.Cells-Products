...
description:  Usando Aspose.Cells Cloud SDK para Swift para guardar el archivo de formato HTML como archivo de formato XLSM.
url: /es/swift/saveas/html-to-xlsm/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para guardar HTML como XLSM" h2="Biblioteca Swift para guardar HTML como XLSM" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Swift. Esta es una solución profesional para guardar HTML como XLSM y otros formatos de documentos en línea usando Swift." urlsection="saveas/html-to-xlsm/" >}}
