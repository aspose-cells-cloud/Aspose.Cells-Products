...
description: REST API para obtener, procesar, cifrar, convertir y exportar Microsoft y hojas de cálculo de OpenOffice en la nube via Swift SDK
weight: 130
url: /es/swift
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Swift SDK para generar y convertir Excel hojas de cálculo" h2="REST API para buscar, procesar, cifrar, convertir y exportar Microsoft y hojas de cálculo de OpenOffice en la nube via Swift SDK." logoImageSrc="/headers/aspose_cells-for-swift.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Swift" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK for Swift ayuda a los programadores a integrar a la perfección Microsoft Excel y funciones de procesamiento y visualización de hojas de cálculo de OpenOffice en sus aplicaciones basadas en la nube desarrolladas en Swift. Aspose.Cells Cloud SDK for Swift tiene licencia de MIT.</p>
<p>Aspose.Cells Cloud SDK for Swift permite que sus aplicaciones de Swift recuperen hojas de cálculo, hojas de cálculo y libros de trabajo almacenados en la nube, así como generar nuevas hojas de cálculo. También puede ajustar su código Swift para procesar y modificar formato condicional, gráficos, tareas, formas, filtros, OleObjects, rangos, ListObjects y tablas dinámicas, desde sus aplicaciones sin instalar ningún software de terceros.</p>
<p>Use Aspose.Cells Cloud SDK for Swift para convertir Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) y hojas de trabajo de OpenOffice (ODS) a otros formatos populares, como XML (SpreadsheetML), TSV, CSV, TXT (TabDelimited ), HTML, MHTML, DIF, TIFF, SVG, XPS, PDF y Markdown (MD). También puede trabajar con los formatos SXC y FODS usando Aspose.Cells Cloud SDK for Swift.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-swift.svg" alt="Swift Excel SDK"><header>Aspose.Cells</header><footer> Nube<small> <em> para</em> </small>Rápido</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-swift.svg" alt="Swift Excel Cloud SDK"><header>Aspose.Cells</header><footer> Nube<small> <em> para</em> </small>Rápido</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
Eliminar ListObjects específicos o todos en una hoja de trabajo
 ...
 Comience con Excel SDK de procesamiento de hojas de cálculo
    ...
    <p>
 Para comenzar con Aspose.Cells Cloud SDK for Swift, no necesita instalar nada. Todo lo que necesita hacer es crear una cuenta en
...
Cloud SDK para procesar hojas de trabajo
    ...
    <p>
Con Aspose.Cells Cloud SDK para Swift, puede eliminar una fila específica o todas las filas de la hoja de cálculo, obtener datos de celda de la hoja de cálculo o estilo de celda por nombre de celda, leer datos de fila o columna de la hoja de cálculo por su índice, calcular fórmula de celda, borrar contenido de celda, copiar celda en otra celda, copiar columnas y filas de la hoja de trabajo, agrupar filas y columnas de la hoja de trabajo, ocultar filas y columnas de la hoja de trabajo, establecer estilos de columna y fila de la hoja de trabajo, establecer el valor HTMLSTRING en la celda, establecer el valor del rango de celda y modificar muchas otras configuraciones de la hoja de trabajo.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-swift" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Cells Cloud SDK para Swift?" tabId="success-stories" >}}
