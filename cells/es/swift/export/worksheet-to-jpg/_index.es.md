---
title:  Exporte HOJA DE TRABAJO a JPG desde una hoja de cálculo usando Swift API
description:  Aspose.Cells Cloud REST API admite la exportación de archivos de formato {0} a {1} usando {2}.
url: /es/swift/export/worksheet-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para exportar HOJA DE TRABAJO a archivo JPG" h2="Biblioteca Swift para exportar HOJA DE TRABAJO a archivo JPG" p="Utilice Cells Exportar REST API para exportar flujos de trabajo de objetos internos de hojas de cálculo en Swift. Esta es una solución profesional para exportar HOJA DE TRABAJO a un archivo en formato JPG desde una hoja de cálculo en línea usando Swift." urlsection="export/worksheet-to-jpg/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Swift API para exportar HOJA DE TRABAJO a JPG" >}}
