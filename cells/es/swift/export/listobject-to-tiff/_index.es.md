...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Swift usando REST API para exportar LISTOBJECT al formato TIFF desde la hoja de cálculo" gistPath="" %}}
