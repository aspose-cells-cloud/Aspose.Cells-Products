...
description:  Uso de Aspose.Cells Cloud SDK para Swift para convertir un archivo de formato PNG a un archivo de formato JSON.
url: /es/swift/conversion/png-to-json/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para convertir PNG a JSON" h2="Biblioteca Swift para convertir PNG a JSON" p="Utilice Cells Conversion REST API para crear flujos de trabajo de hojas de cálculo personalizados en Swift. Esta es una solución profesional para convertir PNG a JSON y otros formatos de documentos en línea usando Swift." urlsection="conversion/png-to-json/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Swift API para convertir PNG a JSON" >}}
