---
title:  Convertir XLTX a SXC API para Swift
description: Uso de Aspose.Cells Cloud SDK para Swift para convertir un archivo de formato XLTX a un archivo de formato SXC.
url: /es/swift/conversion/xltx-to-sxc/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para convertir XLTX a SXC" h2="Biblioteca Swift para convertir XLTX a SXC" p="Utilice Cells Conversion REST API para crear flujos de trabajo de hojas de cálculo personalizados en Swift. Esta es una solución profesional para convertir XLTX a SXC y otros formatos de documentos en línea usando Swift." urlsection="conversion/xltx-to-sxc/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Swift API para convertir XLTX a SXC" >}}
