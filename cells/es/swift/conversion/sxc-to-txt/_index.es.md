...
description: Uso de Aspose.Cells Cloud SDK para Swift para convertir un archivo de formato SXC a un archivo de formato TXT.
url: /es/swift/conversion/sxc-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para convertir SXC a TXT" h2="Biblioteca Swift para convertir SXC a TXT" p="Utilice Cells Conversion REST API para crear flujos de trabajo de hojas de cálculo personalizados en Swift. Esta es una solución profesional para convertir SXC a TXT y otros formatos de documentos en línea usando Swift." urlsection="conversion/sxc-to-txt/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Convertir un archivo SXC a TXT en Swift" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Swift API para convertir SXC a TXT" >}}
