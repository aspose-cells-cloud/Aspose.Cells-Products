---
title:  Convertir TXT a XLSB API para Swift
description: Uso de Aspose.Cells Cloud SDK para Swift para convertir un archivo de formato TXT a un archivo de formato XLSB.
url: /es/swift/conversion/txt-to-xlsb/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API para convertir TXT a XLSB" h2="Biblioteca Swift para convertir TXT a XLSB" p="Utilice Cells Conversion REST API para crear flujos de trabajo de hojas de cálculo personalizados en Swift. Esta es una solución profesional para convertir TXT a XLSB y otros formatos de documentos en línea usando Swift." urlsection="conversion/txt-to-xlsb/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Convertir un archivo TXT a XLSB en Swift" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Swift API para convertir TXT a XLSB" >}}
