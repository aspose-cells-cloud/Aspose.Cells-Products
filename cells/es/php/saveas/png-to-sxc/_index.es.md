...
<br/>
Guardar formatos de archivo de PNG como SXC es una tarea compleja. Todas las transiciones de formato PNG a SXC las realiza nuestro SDK PHP manteniendo el contenido estructural y lógico principal de la hoja de cálculo fuente PNG. Nuestra biblioteca PHP es una solución profesional para guardar PNG como archivos SXC en línea. Este SDK de nube ofrece a los desarrolladores de PHP una potente funcionalidad y una salida SXC perfecta.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Ejemplo de código para guardar PNG como SXC usando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo utilizar Cells Cloud SDK para PHP para guardar archivos Excel en otros formatos PNG como SXC" >}}
