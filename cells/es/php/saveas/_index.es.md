---
title:  Guarde el archivo Excel en otros formatos usando PHP
description: Aspose.Cells Cloud REST API admite guardar archivos Excel en varios formatos utilizando PHP y ofrece SDK para múltiples lenguajes de programación.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Guarde el archivo Excel en otros formatos usando PHP" h2="Aspose.Cells Cloud SDK admite guardar libros en más de 30 formatos de archivo diferentes." p="Aspose.Cells Cloud REST API admite guardar archivos Excel en varios formatos utilizando PHP y ofrece SDK para múltiples lenguajes de programación." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Guarde el archivo Excel en otros formatos utilizando los enlaces de extensión PHP" >}}
