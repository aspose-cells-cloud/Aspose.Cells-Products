...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guardar HTML como XPS" h2="Biblioteca PHP para guardar HTML como XPS" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en PHP. Esta es una solución profesional para guardar HTML como XPS y otros formatos de documentos en línea usando PHP." urlsection="saveas/html-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo HTML como XPS en PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Ejemplo de código para guardar HTML como XPS usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar HTML como XPS usando la biblioteca Cells Cloud PHP." >}}
