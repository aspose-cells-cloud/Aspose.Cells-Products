---
title: Guardar XML como CSV API para PHP
description:  Usando Aspose.Cells Cloud SDK para PHP para guardar el archivo de formato XML como archivo de formato CSV.
url: /es/php/saveas/xml-to-csv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API para guardar XML como CSV" h2="PHP biblioteca para guardar XML como CSV" p="Use Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en PHP. Esta es una solución profesional para guardar XML como CSV y otros formatos de documentos en línea usando PHP." urlsection="saveas/xml-to-csv/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en PHP usando REST API para guardar XML como formato CSV" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar PHP API para guardar XML como CSV" >}}
