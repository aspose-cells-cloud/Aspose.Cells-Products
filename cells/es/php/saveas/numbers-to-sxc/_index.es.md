...
{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo NUMBERS como SXC en PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Ejemplo de código para guardar NÚMEROS como SXC usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar NÚMEROS como SXC usando la biblioteca Cells Cloud PHP." >}}
