...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guardar XLT como PNG" h2="Biblioteca PHP para guardar XLT como PNG" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en PHP. Esta es una solución profesional para guardar XLT como PNG y otros formatos de documentos en línea usando PHP." urlsection="saveas/xlt-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo XLT como PNG en PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Ejemplo de código para guardar XLT como PNG usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar XLT como PNG usando la biblioteca Cells Cloud PHP." >}}
