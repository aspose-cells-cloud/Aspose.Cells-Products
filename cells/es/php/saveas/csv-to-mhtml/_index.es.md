---
title:  Guarde CSV como MHTML usando PHP
description: Utilizando Aspose.Cells Cloud SDK para PHP para guardar el archivo en formato CSV como archivo en formato MHTML.
kwords: Excel, Save CSV as MHTML, REST, PHP
howto: How to save CSV as MHTML using Aspose.Cells Cloud PHP library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Guardar CSV como MHTML" h2="Biblioteca PHP para guardar CSV como MHTML" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en PHP. Esta es una solución profesional para guardar CSV como MHTML y otros formatos de documentos en línea usando PHP." urlsection="saveas/csv-to-mhtml/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo CSV como MHTML en PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Ejemplo de código para guardar CSV como MHTML usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar CSV como MHTML usando la biblioteca Cells Cloud PHP." >}}
