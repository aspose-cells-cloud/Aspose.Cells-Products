...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar FORMA a GIF desde Excel" h2="Biblioteca PHP para exportar SHAPE a un archivo GIF" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en PHP. Esta es una solución profesional para exportar archivos de formato SHAPE a GIF desde una hoja de cálculo en línea usando PHP." urlsection="export/shape-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto SHAPE a un archivo en formato GIF usando Cells Cloud SDK para PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en PHP usando REST API para exportar FORMA a formato GIF desde una hoja de cálculo" gistPath="" %}}
