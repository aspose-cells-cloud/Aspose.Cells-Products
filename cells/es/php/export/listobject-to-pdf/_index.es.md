---
title:  Exporte LISTOBJECT a PDF desde una hoja de cálculo usando PHP API
...
url: /es/php/export/listobject-to-pdf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API para exportar LISTOBJECT al archivo PDF" h2="Biblioteca PHP para exportar LISTOBJECT al archivo PDF" p="Use Cells Exportar REST API para exportar flujos de trabajo de objetos internos de hoja de cálculo en PHP. Esta es una solución profesional para exportar LISTOBJECT a un archivo de formato PDF desde una hoja de cálculo en línea usando PHP." urlsection="export/listobject-to-pdf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportar objeto LISTOBJECT al archivo de formato PDF en PHP" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar PHP API para exportar LISTOBJECT a PDF" >}}
