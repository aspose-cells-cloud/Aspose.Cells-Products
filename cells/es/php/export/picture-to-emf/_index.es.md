...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar IMAGEN al EMF desde Excel" h2="Biblioteca PHP para exportar IMAGEN al archivo EMF" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en PHP. Esta es una solución profesional para exportar IMAGEN a un archivo de formato EMF desde una hoja de cálculo en línea usando PHP." urlsection="export/picture-to-emf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto IMAGEN al archivo de formato EMF usando Cells Cloud SDK para PHP" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en PHP usando REST API para exportar IMAGEN al formato EMF desde una hoja de cálculo" gistPath="" %}}
