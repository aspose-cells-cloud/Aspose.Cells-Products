...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar TABLA a PDF desde Excel" h2="Biblioteca PHP para exportar CHART al archivo PDF" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en PHP. Esta es una solución profesional para exportar CHART a un archivo de formato PDF desde una hoja de cálculo en línea usando PHP." urlsection="export/chart-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto CHART al archivo de formato PDF usando Cells Cloud SDK para PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en PHP usando REST API para exportar CHART al formato PDF desde una hoja de cálculo" gistPath="" %}}
