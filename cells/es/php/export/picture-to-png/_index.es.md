...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar IMAGEN al PNG desde Excel" h2="Biblioteca PHP para exportar IMAGEN al archivo PNG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en PHP. Esta es una solución profesional para exportar IMAGEN a un archivo de formato PNG desde una hoja de cálculo en línea usando PHP." urlsection="export/picture-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto IMAGEN al archivo de formato PNG usando Cells Cloud SDK para PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en PHP usando REST API para exportar IMAGEN al formato PNG desde una hoja de cálculo" gistPath="" %}}
