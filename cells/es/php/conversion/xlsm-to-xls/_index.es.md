...
description:  Usando Aspose.Cells Cloud SDK para PHP para convertir un archivo de formato XLSM a un archivo de formato XLS.
url: /es/php/conversion/xlsm-to-xls/
---
