...
url: /es/perl/export/json-to-docx/
---
...
{{% blocks/products/pf/agp/feature-section-col title=" Exoprt de archivo JSON a DOCX en Cloud SDK para Perl" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Código para conversión de JSON a DOCX" gistPath="" %}}
```perl
