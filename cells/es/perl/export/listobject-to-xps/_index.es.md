...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ejemplo de código en Perl usando REST API para exportar LISTOBJECT al formato XPS desde la hoja de cálculo" gistPath="" %}}
