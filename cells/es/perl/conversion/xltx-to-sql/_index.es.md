...
description: Usando Aspose.Cells Cloud SDK para Perl para convertir un archivo de formato XLTX a un archivo de formato SQL.
url: /es/perl/conversion/xltx-to-sql/
---
