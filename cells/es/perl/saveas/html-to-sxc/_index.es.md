...
{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo HTML como SXC en Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Ejemplo de código para guardar HTML como SXC usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo guardar HTML como SXC usando la biblioteca Cells Cloud Perl." >}}
