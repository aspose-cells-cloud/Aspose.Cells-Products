...
---
{{< blocks/products/cells/cells-cloud-banner h1="Convertir JSON a FODS" h2="Biblioteca Ruby para convertir JSON a FODS" p="Utilice la nube de conversión API de Cells para crear flujos de trabajo de hojas de cálculo personalizados en proyectos Ruby. Esta es una solución profesional para convertir JSON a FODS y otros formatos de documentos en línea usando Ruby." urlsection="conversion/json-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Convierta JSON a FODS usando Cells Cloud SDK para Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código Ruby para convertir JSON a FODS usando Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo convertir JSON a FODS usando la biblioteca Cells Cloud Ruby." >}}
