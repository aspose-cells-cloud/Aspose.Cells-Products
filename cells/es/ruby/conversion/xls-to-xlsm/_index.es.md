---
title:  Convertir XLS a XLSM API para Ruby
description:  Usando Aspose.Cells Cloud SDK para Ruby para convertir un archivo de formato XLS a un archivo de formato XLSM.
url: /es/ruby/conversion/xls-to-xlsm/
---
