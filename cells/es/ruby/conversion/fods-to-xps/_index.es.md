...
url: /es/ruby/conversion/fods-to-xps/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a XPS con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para conversión de FODS a XPS" gistPath="" %}}
```ruby
