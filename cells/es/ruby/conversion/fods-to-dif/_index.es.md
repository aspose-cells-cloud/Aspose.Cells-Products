...
{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a DIF con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para la conversión de FODS a DIF" gistPath="" %}}
```ruby
