...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS a XLSM con Ruby" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para conversión de FODS a XLSM" gistPath="" %}}
```ruby
