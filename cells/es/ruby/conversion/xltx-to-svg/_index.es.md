...
---
{{< blocks/products/cells/cells-cloud-banner h1="Convertir XLTX a SVG" h2="Biblioteca Ruby para convertir XLTX a SVG" p="Utilice la nube de conversión API de Cells para crear flujos de trabajo de hojas de cálculo personalizados en proyectos Ruby. Esta es una solución profesional para convertir XLTX a SVG y otros formatos de documentos en línea usando Ruby." urlsection="conversion/xltx-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Convierta XLTX a SVG usando Cells Cloud SDK para Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código Ruby para convertir XLTX a SVG usando Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo convertir XLTX a SVG usando la biblioteca Cells Cloud Ruby." >}}
