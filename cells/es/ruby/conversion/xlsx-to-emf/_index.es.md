...
description:  Usando Aspose.Cells Cloud SDK para Ruby para convertir un archivo de formato XLSX a un archivo de formato EMF.
url: /es/ruby/conversion/xlsx-to-emf/
---
