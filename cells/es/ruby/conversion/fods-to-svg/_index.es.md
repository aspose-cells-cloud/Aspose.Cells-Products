...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a SVG con Ruby" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a SVG con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para conversión de FODS a SVG" gistPath="" %}}
```ruby
