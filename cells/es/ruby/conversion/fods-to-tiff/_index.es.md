...
url: /es/ruby/conversion/fods-to-tiff/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a TIFF con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para conversión de FODS a TIFF" gistPath="" %}}
```ruby
