...
{{% blocks/products/pf/agp/feature-section-col title="FODS a PDF Conversión con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para FODS a PDF Conversión" gistPath="" %}}
```ruby
