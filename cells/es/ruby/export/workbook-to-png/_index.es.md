...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportar LIBRO DE TRABAJO a PNG desde Excel" h2="Biblioteca Ruby para exportar WORKBOOK al archivo PNG" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Ruby. Esta es una solución profesional para exportar WORKBOOK a un archivo con formato PNG desde una hoja de cálculo en línea usando Ruby." urlsection="export/workbook-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporte el objeto WORKBOOK a un archivo de formato PNG usando Cells Cloud SDK para Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código en Ruby usando REST API para exportar WORKBOOK al formato PNG desde una hoja de cálculo" gistPath="" %}}
