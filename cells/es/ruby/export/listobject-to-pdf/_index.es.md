---
title:  Exporte LISTOBJECT a PDF desde una hoja de cálculo usando Ruby API
...
url: /es/ruby/export/listobject-to-pdf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API para exportar LISTOBJECT al archivo PDF" h2="Biblioteca Ruby para exportar LISTOBJECT al archivo PDF" p="Use Cells Exportar REST API para exportar flujos de trabajo de objetos internos de hojas de cálculo en Ruby. Esta es una solución profesional para exportar LISTOBJECT a un archivo de formato PDF desde una hoja de cálculo en línea usando Ruby." urlsection="export/listobject-to-pdf/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Ruby API para exportar LISTOBJECT a PDF" >}}
