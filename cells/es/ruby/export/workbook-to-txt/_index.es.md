...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar LIBRO DE TRABAJO a TXT desde Excel" h2="Biblioteca Ruby para exportar WORKBOOK a archivo TXT" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Ruby. Esta es una solución profesional para exportar WORKBOOK a un archivo en formato TXT desde una hoja de cálculo en línea usando Ruby." urlsection="export/workbook-to-txt/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto WORKBOOK a un archivo en formato TXT usando Cells Cloud SDK para Ruby" >}}
