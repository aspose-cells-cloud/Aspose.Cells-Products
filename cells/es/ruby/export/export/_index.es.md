---
title:
description: API y SDK en la nube para proteger Microsoft Excel y OpenOffice Calc. Cifre las hojas de cálculo locales con la contraseña de Cells Cloud API.
url: /es/ruby/export/export/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="" h2="Rubí" >}}
...
1. Inicialice ```LightCellsAPI``` con ID de cliente, Secreto de cliente, URL base y versión API
1.  Llame al ```post_export``` método para
