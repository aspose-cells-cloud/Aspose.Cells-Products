...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportar HOJA DE TRABAJO a JSON desde Excel" h2="Biblioteca Ruby para exportar HOJA DE TRABAJO a archivo JSON" p="Utilice Exportar API de Cells Cloud para exportar flujos de trabajo de objetos internos de archivos Excel en Ruby. Esta es una solución profesional para exportar HOJA DE TRABAJO a un archivo en formato JSON desde una hoja de cálculo en línea usando Ruby." urlsection="export/worksheet-to-json/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporte el objeto WORKSHEET a un archivo en formato JSON usando Cells Cloud SDK para Ruby" >}}
