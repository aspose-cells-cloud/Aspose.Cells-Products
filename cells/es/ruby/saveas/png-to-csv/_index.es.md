---
title:  Guarde PNG como CSV API para Ruby
description:  Usando Aspose.Cells Cloud SDK para Ruby para guardar el archivo de formato PNG como archivo de formato CSV.
url: /es/ruby/saveas/png-to-csv/
---
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Ruby API para guardar PNG como CSV" >}}
