...
---
{{< blocks/products/cells/cells-cloud-banner h1="Guardar TXT como XLSX" h2="Biblioteca Ruby para guardar TXT como XLSX" p="Utilice SaveAs API de Cells Cloud para crear flujos de trabajo de hojas de cálculo personalizados en Ruby. Esta es una solución profesional para guardar TXT como XLSX y otros formatos de documentos en línea usando Ruby." urlsection="saveas/txt-to-xlsx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Guarde un archivo TXT como XLSX en Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ejemplo de código Ruby para guardar TXT como XLSX usando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Aprenda cómo guardar TXT como XLSX usando la biblioteca Cloud Ruby Cells." >}}
