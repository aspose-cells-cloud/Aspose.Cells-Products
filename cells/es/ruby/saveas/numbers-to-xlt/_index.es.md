---
title:  Guarde NÚMEROS como XLT API para Ruby
description:  Usando Aspose.Cells Cloud SDK para Ruby para guardar el archivo de formato NUMBERS como archivo de formato XLT.
url: /es/ruby/saveas/numbers-to-xlt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API para guardar NÚMEROS como XLT" h2="Biblioteca Ruby para guardar NUMBERS como XLT" p="Utilice Cells SaveAs REST API para crear flujos de trabajo de hojas de cálculo personalizados en Ruby. Esta es una solución profesional para guardar NÚMEROS como XLT y otros formatos de documentos en línea usando Ruby." urlsection="saveas/numbers-to-xlt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cómo usar Ruby API para guardar NÚMEROS como XLT" >}}
