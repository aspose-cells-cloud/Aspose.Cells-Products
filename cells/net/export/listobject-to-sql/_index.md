---
title: Export Listobject to SQL file via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Listobject to SQL file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Listobject to SQL file in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for LISTOBJECT to SQL Conversion" gistPath="" %}}
```cs
