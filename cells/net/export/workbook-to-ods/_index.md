---
title: Export Workbook to ODS file via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Workbook to ODS file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exoprt Workbook to ODS file in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for WORKBOOK to ODS Conversion" gistPath="" %}}
```cs
