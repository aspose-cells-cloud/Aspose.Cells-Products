...
outformat: XLSX
platform: .NET
otherformats: XLSB XLSX XML MHTML SXC MD ODS DIF XLSM TSV FODS XLT XPS TXT PDF XLTM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLSX Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to XLSX Conversion" gistPath="" %}}
```cs
