...
outformat: XLSX
platform: .NET
otherformats: MD XLT TIFF XLS SXC XLSM DIF XLSX XML ODS XLSB SVG FODS MHTML CSV XLTM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to XLSX Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to XLSX Conversion" gistPath="" %}}
```cs
