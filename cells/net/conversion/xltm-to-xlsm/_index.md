...
outformat: XLSM
platform: .NET
otherformats: MD XLSM XLSX HTML ODS XPS CSV DIF SVG TIFF TSV XML MHTML XLTX SXC TXT 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTM to XLSM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTM to XLSM Conversion" gistPath="" %}}
```cs
