...
outformat: MD
platform: .NET
otherformats: FODS XLSB XLTX SXC MHTML XML MD SVG TSV DIF XPS CSV TIFF TXT XLTM XLSM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX to MD Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSX to MD Conversion" gistPath="" %}}
```cs
