...
outformat: TXT
platform: .NET
otherformats: XLSM CSV FODS DIF XLSB XPS MD XLTX HTML SXC TSV XML SVG TIFF PDF XLSX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="ODS to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for ODS to TXT Conversion" gistPath="" %}}
```cs
