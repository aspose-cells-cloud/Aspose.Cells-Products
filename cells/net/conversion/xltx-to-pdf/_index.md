...
outformat: PDF
platform: .NET
otherformats: HTML CSV DIF MHTML XLSM PDF XPS XLT ODS TXT FODS TIFF XLSB XLSX SVG MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to PDF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to PDF Conversion" gistPath="" %}}
```cs
