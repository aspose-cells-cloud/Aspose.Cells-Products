...
outformat: XLSX
platform: .NET
otherformats: HTML MD TXT CSV FODS XLTM XLTX PDF TSV XLS XML XLSM TIFF DIF XLSX SVG 
---
...
{{% blocks/products/pf/agp/feature-section-col title="MHTML to XLSX Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for MHTML to XLSX Conversion" gistPath="" %}}
```cs
