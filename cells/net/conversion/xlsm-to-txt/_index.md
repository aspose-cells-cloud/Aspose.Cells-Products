...
outformat: TXT
platform: .NET
otherformats: TSV HTML PDF XPS XLTM XLSB XLSX SVG XML SXC FODS MD DIF TXT XLTX TIFF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSM to TXT Conversion" gistPath="" %}}
```cs
