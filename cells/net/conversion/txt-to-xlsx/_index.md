...
outformat: XLSX
platform: .NET
otherformats: XLSB MHTML SXC XLSM PDF TSV XML TIFF XLTX DIF ODS XLTM FODS CSV SVG MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="TXT to XLSX Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TXT to XLSX Conversion" gistPath="" %}}
```cs
