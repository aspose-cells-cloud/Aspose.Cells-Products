...
outformat: MD
platform: .NET
otherformats: SVG TSV SXC CSV XLTX FODS DIF XML MD TIFF XLTM TXT XLS XLSB XLSM XLSX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLT to MD Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLT to MD Conversion" gistPath="" %}}
```cs
