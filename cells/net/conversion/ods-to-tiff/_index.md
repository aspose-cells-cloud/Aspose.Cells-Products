---
title: Convert ODS to TIFF via .NET 
...
outformat: TIFF
platform: .NET
otherformats: XLT TXT XLSM FODS XLSB SXC PDF XLTM SVG DIF MD MHTML XLTX TSV CSV TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to TIFF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODS to TIFF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for ODS to TIFF Conversion" gistPath="" %}}
```cs
