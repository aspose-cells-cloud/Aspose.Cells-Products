...
outformat: TXT
platform: .NET
otherformats: DIF FODS XPS MHTML XLSX XLSB SXC XLT PDF XML TSV XLSM TIFF SVG CSV TXT 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTM to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTM to TXT Conversion" gistPath="" %}}
```cs
