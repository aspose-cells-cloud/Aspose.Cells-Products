...
outformat: MHTML
platform: .NET
otherformats: MHTML PDF CSV XPS XLTX ODS XLS FODS XML DIF TSV SXC SVG XLSM TXT MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLT to MHTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLT to MHTML Conversion" gistPath="" %}}
```cs
