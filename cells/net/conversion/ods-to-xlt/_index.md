---
title: Convert ODS to XLT via .NET 
...
outformat: XLT
platform: .NET
otherformats: XLSB FODS DIF TSV SXC HTML XLSX PDF XLT TXT XPS XML CSV TIFF XLTX MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLT in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODS to XLT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for ODS to XLT Conversion" gistPath="" %}}
```cs
