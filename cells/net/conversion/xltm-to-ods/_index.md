...
outformat: ODS
platform: .NET
otherformats: DIF XLSM XLT XLTX MD TSV XLSX FODS CSV XLSB TXT PDF XML HTML TIFF SVG 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTM to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTM to ODS Conversion" gistPath="" %}}
```cs
