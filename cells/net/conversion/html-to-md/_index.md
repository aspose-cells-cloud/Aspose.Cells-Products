---
title: Convert HTML to MD via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to  MD in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to MD Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for HTML to MD Conversion" gistPath="" %}}
```cs
