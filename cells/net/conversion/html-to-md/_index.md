...
outformat: MD
platform: .NET
otherformats: XLSM XLSX MD SXC XLSB XPS DIF TXT XML FODS XLT PDF TSV TIFF XLTX XLTM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to MD Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to MD Conversion" gistPath="" %}}
```cs
