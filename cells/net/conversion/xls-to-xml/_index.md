...
outformat: XML
platform: .NET
otherformats: TIFF XLSX TSV XLSM SXC XLT XLTX XLTM HTML SVG XPS PDF MHTML CSV DIF MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLS to XML Conversion" gistPath="" %}}
```cs
