...
outformat: XLSM
platform: .NET
otherformats: MD XLSX PDF XLTM SXC SVG XLSB TXT XPS ODS TIFF HTML MHTML XLSM FODS TSV 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLSM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to XLSM Conversion" gistPath="" %}}
```cs
