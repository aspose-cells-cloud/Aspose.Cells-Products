...
outformat: XLTM
platform: .NET
otherformats: MHTML TIFF ODS SXC XLSX MD XML XLSM TSV XLTM XPS CSV SVG FODS XLSB DIF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLTM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to XLTM Conversion" gistPath="" %}}
```cs
