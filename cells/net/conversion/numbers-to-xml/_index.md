---
title: Convert NUMBERS to XML via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert NUMBERS to  XML in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="NUMBERS to XML Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for NUMBERS to XML Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=numbers  outputformat=xml  %}}
