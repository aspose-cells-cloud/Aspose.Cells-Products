...
outformat: HTML
platform: .NET
otherformats: TIFF DIF XLS XLSM SXC XLSX ODS XLTM TSV TXT PDF XLSB SVG MD MHTML XLTX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XML to HTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to HTML Conversion" gistPath="" %}}
```cs
