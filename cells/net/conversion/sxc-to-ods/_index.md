...
outformat: ODS
platform: .NET
otherformats: TXT XLTX MD ODS TIFF XLTM XLSM XLSX XLSB XPS HTML MHTML SXC SVG CSV XML 
---
...
{{% blocks/products/pf/agp/feature-section-col title="SXC to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for SXC to ODS Conversion" gistPath="" %}}
```cs
