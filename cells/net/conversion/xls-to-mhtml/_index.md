---
title: Convert XLS to MHTML via .NET 
...
outformat: MHTML
platform: .NET
otherformats: DIF MD XLTX MHTML ODS CSV XPS TSV SXC TXT SVG TIFF XLSX PDF FODS XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to MHTML in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to MHTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLS to MHTML Conversion" gistPath="" %}}
```cs
