...
outformat: SXC
platform: .NET
otherformats: SVG XML XLSB CSV SXC DIF TIFF XLSX MHTML XLTX ODS TSV FODS PDF XLTM XLSM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to SXC Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to SXC Conversion" gistPath="" %}}
```cs
