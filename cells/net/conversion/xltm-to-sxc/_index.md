...
{{% blocks/products/pf/agp/feature-section-col title="XLTM to SXC Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XLTM to SXC Conversion" gistPath="" %}}
```cs
