...
outformat: HTML
platform: .NET
otherformats: SVG MD XLTX DIF CSV XLSX TIFF XLSM SXC XML TXT XLTM ODS PDF HTML FODS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB to HTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSB to HTML Conversion" gistPath="" %}}
```cs
