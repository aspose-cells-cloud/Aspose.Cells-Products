...
outformat: XML
platform: .NET
otherformats: TIFF ODS DIF XLS MHTML XML XPS XLSB TXT CSV MD FODS XLTM XLSM XLTX PDF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="TSV to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TSV to XML Conversion" gistPath="" %}}
```cs
