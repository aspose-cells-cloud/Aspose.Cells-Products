---
title: Convert XML to SXC via .NET 
...
outformat: SXC
platform: .NET
otherformats: TXT XLTX MD XPS TSV HTML XLSX SVG CSV XLSM FODS TIFF SXC DIF MHTML XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to SXC in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to SXC Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to SXC Conversion" gistPath="" %}}
```cs
