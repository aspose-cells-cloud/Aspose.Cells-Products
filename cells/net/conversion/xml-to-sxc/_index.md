...
{{% blocks/products/pf/agp/feature-section-col title="XML to SXC Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XML to SXC Conversion" gistPath="" %}}
```cs
