...
outformat: SVG
platform: .NET
otherformats: SVG SXC XLSX XLT PDF TXT MHTML XML MD XLTM FODS TIFF CSV DIF XLTX XLSB 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM to SVG Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSM to SVG Conversion" gistPath="" %}}
```cs
