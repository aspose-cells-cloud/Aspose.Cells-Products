...
outformat: HTML
platform: .NET
otherformats: XPS XLTM TSV XLSM SVG FODS SXC CSV TIFF DIF XLSX TXT XLSB XML MD PDF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="MHTML to HTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for MHTML to HTML Conversion" gistPath="" %}}
```cs
