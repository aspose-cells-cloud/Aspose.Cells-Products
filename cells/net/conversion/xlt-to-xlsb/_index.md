...
{{% blocks/products/pf/agp/feature-section-col title="XLT to XLSB Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XLT to XLSB Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=xlt  outputformat=xlsb  %}}
