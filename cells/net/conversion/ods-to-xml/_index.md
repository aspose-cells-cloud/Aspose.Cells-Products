...
outformat: XML
platform: .NET
otherformats: XLTX DIF TSV MHTML FODS TIFF XLSB XPS XLSX PDF SVG XLSM MD TXT CSV SXC 
---
...
{{% blocks/products/pf/agp/feature-section-col title="ODS to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for ODS to XML Conversion" gistPath="" %}}
```cs
