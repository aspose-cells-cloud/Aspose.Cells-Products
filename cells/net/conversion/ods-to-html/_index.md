...
outformat: HTML
platform: .NET
otherformats: MD TXT FODS SXC HTML XLSX XLTX XLSB PDF SVG TIFF XLTM XLSM DIF XML TSV 
---
...
{{% blocks/products/pf/agp/feature-section-col title="ODS to HTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for ODS to HTML Conversion" gistPath="" %}}
```cs
