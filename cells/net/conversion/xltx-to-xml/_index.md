...
outformat: XML
platform: .NET
otherformats: XML XLSX TIFF HTML SVG MHTML XLSB DIF XLSM ODS TXT PDF XLTM XPS FODS TSV 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to XML Conversion" gistPath="" %}}
```cs
