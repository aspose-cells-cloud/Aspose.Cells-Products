...
outformat: MD
platform: .NET
otherformats: ODS FODS MHTML XLSB SXC XLTM TIFF TSV XPS PDF DIF XLSX MD SVG TXT XML 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM to MD Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSM to MD Conversion" gistPath="" %}}
```cs
