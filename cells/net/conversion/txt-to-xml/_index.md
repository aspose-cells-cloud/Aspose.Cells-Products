...
outformat: XML
platform: .NET
otherformats: SVG XLSM XLSX XPS XLTM XLTX PDF MD TIFF HTML SXC TSV XML ODS CSV DIF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="TXT to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TXT to XML Conversion" gistPath="" %}}
```cs
