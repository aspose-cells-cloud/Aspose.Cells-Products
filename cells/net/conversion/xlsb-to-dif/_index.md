...
{{% blocks/products/pf/agp/feature-section-col title="XLSB to DIF Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XLSB to DIF Conversion" gistPath="" %}}
```cs
