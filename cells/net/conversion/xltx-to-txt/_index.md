...
outformat: TXT
platform: .NET
otherformats: MHTML TIFF XPS XLSX XML SVG XLT XLTM FODS CSV MD TSV XLSM TXT SXC DIF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to TXT Conversion" gistPath="" %}}
```cs
