...
outformat: ODS
platform: .NET
otherformats: SVG XML XLSM CSV XLT FODS XLSX PDF TXT TSV MD XLSB DIF XLTX MHTML TIFF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to ODS Conversion" gistPath="" %}}
```cs
