...
outformat: XLSX
platform: .NET
otherformats: XLSM XLSB TSV PDF XLTX MHTML SVG XLSX TXT XLTM FODS DIF XPS CSV TIFF SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to XLSX in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLT to XLSX Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLT to XLSX Conversion" gistPath="" %}}
```cs
