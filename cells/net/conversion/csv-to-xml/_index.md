...
outformat: XML
platform: .NET
otherformats: XLTM XPS HTML ODS MD MHTML TIFF XLSM SXC XLSX XLSB PDF TSV DIF TXT XLTX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="CSV to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for CSV to XML Conversion" gistPath="" %}}
```cs
