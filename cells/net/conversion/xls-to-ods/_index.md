...
outformat: ODS
platform: .NET
otherformats: DIF XLTX TXT XLTM ODS TSV SVG PDF XLSM XLSX MHTML FODS XLSB SXC XML XPS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLS to ODS Conversion" gistPath="" %}}
```cs
