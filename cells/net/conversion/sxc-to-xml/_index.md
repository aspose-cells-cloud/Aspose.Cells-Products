---
title: Convert SXC to XML via .NET 
...
outformat: XML
platform: .NET
otherformats: XLSB PDF ODS TIFF TXT XLSX MHTML XPS CSV XML TSV SXC XLTM FODS SVG XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XML in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for SXC to XML Conversion" gistPath="" %}}
```cs
