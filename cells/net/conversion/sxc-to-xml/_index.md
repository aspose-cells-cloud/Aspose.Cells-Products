...
{{% blocks/products/pf/agp/feature-section-col title="SXC to XML Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for SXC to XML Conversion" gistPath="" %}}
```cs
