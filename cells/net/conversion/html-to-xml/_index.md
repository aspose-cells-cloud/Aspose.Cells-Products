...
outformat: XML
platform: .NET
otherformats: TIFF XLTX XLS XLSM FODS CSV XLSB PDF SXC XLTM MHTML MD XPS DIF XML XLSX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to XML Conversion" gistPath="" %}}
```cs
