...
outformat: SXC
platform: .NET
otherformats: DIF FODS CSV XML XLTX XLS XLSB XPS XLTM HTML TSV MHTML XLSX SXC SVG XLSM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLT to SXC Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLT to SXC Conversion" gistPath="" %}}
```cs
