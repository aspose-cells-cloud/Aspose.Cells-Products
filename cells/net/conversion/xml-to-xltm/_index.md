...
outformat: XLTM
platform: .NET
otherformats: XLSB XLSX CSV DIF XLTX PDF FODS MHTML TSV SXC XLSM TXT XLTM MD SVG XPS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XML to XLTM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to XLTM Conversion" gistPath="" %}}
```cs
