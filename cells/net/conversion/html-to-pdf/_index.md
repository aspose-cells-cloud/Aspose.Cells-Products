...
outformat: PDF
platform: .NET
otherformats: TIFF XLSB MHTML SVG DIF XLSM MD ODS TXT XLTX SXC CSV PDF TSV XLSX XPS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to PDF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to PDF Conversion" gistPath="" %}}
```cs
