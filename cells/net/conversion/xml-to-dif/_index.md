...
{{% blocks/products/pf/agp/feature-section-col title="XML to DIF Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XML to DIF Conversion" gistPath="" %}}
```cs
