...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to SXC Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XLTX to SXC Conversion" gistPath="" %}}
```cs
