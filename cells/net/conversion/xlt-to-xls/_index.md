...
outformat: XLS
platform: .NET
otherformats: XLSB TXT XLTX CSV ODS SVG HTML TIFF XML MHTML XLSX XLTM DIF FODS PDF MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLT to XLS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLT to XLS Conversion" gistPath="" %}}
```cs
