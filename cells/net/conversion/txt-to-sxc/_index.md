...
outformat: SXC
platform: .NET
otherformats: DIF CSV TIFF MD SXC FODS XML MHTML TSV PDF XLTM XLSB XLTX SVG XLSM XPS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="TXT to SXC Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TXT to SXC Conversion" gistPath="" %}}
```cs
