...
{{% blocks/products/pf/agp/feature-section-col title="XLSB to XLT Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for XLSB to XLT Conversion" gistPath="" %}}
```cs
