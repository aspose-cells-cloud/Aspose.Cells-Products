...
outformat: ODS
platform: .NET
otherformats: HTML XLT ODS DIF XLTX TIFF PDF XLS SVG TSV MHTML XLSX XLSM FODS XPS XLSB 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XML to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to ODS Conversion" gistPath="" %}}
```cs
