...
outformat: XLS
platform: .NET
otherformats: XLTM SXC CSV MHTML XLSB SVG TSV XLTX XPS PDF TXT TIFF XML ODS DIF FODS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to XLS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to XLS Conversion" gistPath="" %}}
```cs
