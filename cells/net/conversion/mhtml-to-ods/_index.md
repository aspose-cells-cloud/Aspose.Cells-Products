...
outformat: ODS
platform: .NET
otherformats: XLTX TIFF DIF XLSM CSV MD FODS SVG SXC XLSX XLSB XML HTML XPS PDF TSV 
---
...
{{% blocks/products/pf/agp/feature-section-col title="MHTML to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for MHTML to ODS Conversion" gistPath="" %}}
```cs
