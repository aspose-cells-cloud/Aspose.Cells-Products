...
outformat: TXT
platform: .NET
otherformats: XLSX XLSB PDF XLTX HTML DIF CSV TIFF ODS XLTM SXC TSV FODS TXT SVG MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XML to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to TXT Conversion" gistPath="" %}}
```cs
