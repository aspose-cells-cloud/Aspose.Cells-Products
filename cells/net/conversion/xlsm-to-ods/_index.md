...
outformat: ODS
platform: .NET
otherformats: XML DIF XLSB FODS SVG HTML MD MHTML XLSX TXT XLTX TSV XPS PDF CSV TIFF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM to ODS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSM to ODS Conversion" gistPath="" %}}
```cs
