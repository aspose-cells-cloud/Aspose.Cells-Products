...
outformat: XLTM
platform: .NET
otherformats: XLTX TSV XLS MD TXT ODS XLTM TIFF DIF HTML CSV PDF XLSX SXC MHTML FODS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM to XLTM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSM to XLTM Conversion" gistPath="" %}}
```cs
