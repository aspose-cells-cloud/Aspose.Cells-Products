...
outformat: XLT
platform: .NET
otherformats: XLTM HTML MHTML MD TIFF SVG SXC XPS XLSB FODS XLSM XML DIF XLSX TXT TSV 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to XLT Conversion" gistPath="" %}}
```cs
