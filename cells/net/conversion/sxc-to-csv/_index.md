---
title: Convert SXC to CSV via .NET 
...
outformat: CSV
platform: .NET
otherformats: MHTML ODS FODS XLSX XPS SVG TSV XLTM TIFF XLSB XML TXT CSV XLTX PDF SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to CSV in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to CSV Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for SXC to CSV Conversion" gistPath="" %}}
```cs
