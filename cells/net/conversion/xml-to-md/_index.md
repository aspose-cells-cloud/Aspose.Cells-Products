...
outformat: MD
platform: .NET
otherformats: XPS XLTM DIF PDF CSV SVG FODS TIFF TSV HTML SXC TXT MHTML XLSX XLSM XLSB 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XML to MD Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to MD Conversion" gistPath="" %}}
```cs
