...
outformat: XLSM
platform: .NET
otherformats: XLTX TSV DIF XPS XLS TXT PDF XLSB XLSX XLTM SVG MD ODS FODS XML TIFF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="HTML to XLSM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for HTML to XLSM Conversion" gistPath="" %}}
```cs
