...
outformat: HTML
platform: .NET
otherformats: HTML MHTML XPS XML XLT TSV FODS XLTX XLTM XLSB DIF XLSM PDF XLSX SVG TIFF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="TXT to HTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TXT to HTML Conversion" gistPath="" %}}
```cs
