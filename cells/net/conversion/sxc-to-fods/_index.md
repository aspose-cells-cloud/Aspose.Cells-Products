...
{{% blocks/products/pf/agp/feature-section-col title="SXC to FODS Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for SXC to FODS Conversion" gistPath="" %}}
```cs
