...
outformat: XML
platform: .NET
otherformats: DIF MD XLSM TSV ODS CSV XLSX TXT XLT SXC SVG XLTX HTML XLSB PDF MHTML 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTM to XML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTM to XML Conversion" gistPath="" %}}
```cs
