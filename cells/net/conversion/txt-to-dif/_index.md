...
{{% blocks/products/pf/agp/feature-section-col title="TXT to DIF Conversion in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for TXT to DIF Conversion" gistPath="" %}}
```cs
