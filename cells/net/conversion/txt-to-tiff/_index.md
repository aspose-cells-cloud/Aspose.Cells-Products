...
outformat: TIFF
platform: .NET
otherformats: HTML MD TIFF XPS XLS DIF XML CSV XLSM XLSB SXC TSV XLSX SVG ODS XLT 
---
...
{{% blocks/products/pf/agp/feature-section-col title="TXT to TIFF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TXT to TIFF Conversion" gistPath="" %}}
```cs
