...
outformat: XLS
platform: .NET
otherformats: HTML TSV XLSX FODS XLTM SVG TIFF MD SXC XLSM DIF CSV PDF XPS XML TXT 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to XLS Conversion" gistPath="" %}}
```cs
