...
outformat: PDF
platform: .NET
otherformats: CSV XLT XML SXC XPS XLSX TIFF HTML XLTM XLSM MHTML FODS PDF TSV XLTX SVG 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB to PDF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSB to PDF Conversion" gistPath="" %}}
```cs
