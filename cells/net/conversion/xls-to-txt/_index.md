...
outformat: TXT
platform: .NET
otherformats: SXC TIFF SVG HTML TXT XLSM TSV FODS XLTX MD PDF XLSB XLTM MHTML DIF XPS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLS to TXT Conversion" gistPath="" %}}
```cs
