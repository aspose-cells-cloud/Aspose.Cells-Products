---
title: Convert SXC to TIFF via .NET 
...
outformat: TIFF
platform: .NET
otherformats: FODS TIFF XLTX XLSM TSV TXT XLTM SVG XML XPS CSV MD SXC PDF XLSX MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TIFF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to TIFF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for SXC to TIFF Conversion" gistPath="" %}}
```cs
