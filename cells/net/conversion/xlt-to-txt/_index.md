...
outformat: TXT
platform: .NET
otherformats: HTML SXC TIFF XLSX DIF MHTML PDF XLTM XLSM MD ODS TSV XML CSV XLTX XPS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLT to TXT Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLT to TXT Conversion" gistPath="" %}}
```cs
