---
title: Convert TXT to TSV via .NET 
...
outformat: TSV
platform: .NET
otherformats: XLTX XLSX SVG XLSM DIF TIFF FODS HTML CSV XPS SXC PDF XLTM MHTML MD XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to TSV in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to TSV Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for TXT to TSV Conversion" gistPath="" %}}
```cs
