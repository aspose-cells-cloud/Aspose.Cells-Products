...
outformat: PDF
platform: .NET
otherformats: MHTML TXT XLS XLTM MD DIF XPS XML PDF TIFF XLSB XLSM SXC XLTX CSV ODS 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX to PDF Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSX to PDF Conversion" gistPath="" %}}
```cs
