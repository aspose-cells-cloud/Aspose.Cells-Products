...
outformat: HTML
platform: .NET
otherformats: SVG SXC PDF TXT CSV MHTML TIFF DIF XLSB XLTM FODS TSV XLSX MD XLTX XML 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to HTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLS to HTML Conversion" gistPath="" %}}
```cs
