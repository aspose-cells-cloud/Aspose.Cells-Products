...
outformat: SVG
platform: .NET
otherformats: ODS CSV SXC DIF XLS MHTML TSV PDF XLTM XLSM XLSX TXT XPS XML TIFF MD 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to SVG Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to SVG Conversion" gistPath="" %}}
```cs
