...
outformat: XLTM
platform: .NET
otherformats: FODS TXT SXC XLSX XLT XML CSV TIFF PDF SVG XPS HTML XLSM MD TSV XLTX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="MHTML to XLTM Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for MHTML to XLTM Conversion" gistPath="" %}}
```cs
