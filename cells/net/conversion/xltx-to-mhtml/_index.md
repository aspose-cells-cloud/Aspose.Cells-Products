...
outformat: MHTML
platform: .NET
otherformats: TIFF TXT XLSX MD MHTML XLSM XML DIF TSV PDF ODS FODS SXC XPS SVG XLTM 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX to MHTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLTX to MHTML Conversion" gistPath="" %}}
```cs
