...
outformat: MHTML
platform: .NET
otherformats: ODS CSV MHTML SXC XLSM PDF TSV XLT MD DIF FODS XLTX XLTM XPS XLSX TIFF 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XML to MHTML Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XML to MHTML Conversion" gistPath="" %}}
```cs
