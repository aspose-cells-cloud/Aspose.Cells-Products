...
outformat: XLS
platform: .NET
otherformats: XLT TIFF CSV TXT DIF ODS SXC TSV HTML XLS XLTX MD XLTM XPS SVG XLSX 
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM to XLS Conversion in .NET Apps" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code for XLSM to XLS Conversion" gistPath="" %}}
```cs
