...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save JPG file as  XLS file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save JPG file as XLS file in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for saving JPG as XLS " gistPath="" %}}
```cs
