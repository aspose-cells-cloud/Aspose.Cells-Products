...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XLS file as  WMF file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XLS file as WMF file in Cloud SDK for .NET " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Net Code for saving XLS as WMF " gistPath="" %}}
```cs
