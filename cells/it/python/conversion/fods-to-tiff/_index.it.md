---
title:  Convertire da Excel FODS a TIFF via Python
description: Crea, modifica o converti file Excel con REST API e SDK Open Source Python
url: /it/python/conversion/fods-to-tiff/
family: cells
platformtag: python
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertire FODS in TIFF con Python" h2="Leggi, modifica ed esporta i dati Excel in altri formati con Cloud SDK open source per Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS allo TIFF Conversione con Python" %}}
...
1. Chiama il metodo ```CellsApi.cells_save_as_post_document_save_as``` per ottenere il file TIFF risultante
...
{{% blocks/products/pf/agp/code-autogen title="Python Codice per FODS in TIFF Conversione" gistPath="" %}}
```python
