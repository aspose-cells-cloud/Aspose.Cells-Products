---
title:  Excel & Elaborazione OpenOffice via Python nel cloud (REST SDK)
description: REST API per l'integrazione della funzionalità di elaborazione dei fogli di calcolo Excel e OpenOffice nelle app Python basate su cloud
weight: 110
url: /it/python
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python SDK per manipolare i file Excel" h2="REST API per l\'integrazione della funzionalità di elaborazione dei fogli di calcolo Excel e OpenOffice nelle app Python basate su cloud." logoImageSrc="/headers/aspose_cells-for-python.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Python" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK per Python ti aiuta a sviluppare app cloud Spreadsheet builder, visualizzatore, fusione, divisione, crittografia e conversione nel linguaggio di programmazione Python. Aspose.Cells Cloud SDK per Python è distribuito con una licenza MIT ed è alimentato dal sottostante Aspose.Cells REST API.</p>
<p>Aspose.Cells Cloud SDK per Python consente al codice Python di eseguire funzioni di livello da base a avanzato su Microsoft Excel e fogli di calcolo OpenOffice ospitati nel cloud storage. Usa il tuo programma Python per lavorare con le tabelle pivot, lavorare con XML (SpreadsheetML), leggere i file Excel nel cloud via Python, convertire XLSX in HTML, CSV, PDF, XPS, MD (Markdown), DIF, 076112 3481 e altri formati di file supportati.</p>
<p>Aspose.Cells Cloud SDK per Python consente ai programmi Python di creare più fogli di calcolo, gestire fogli di lavoro, cartelle di lavoro, impostazione del foglio, applicare la formattazione condizionale, gestire attività, formule, filtri automatici, Oleobjects, ListObjects e altre entità del foglio di calcolo Excel, senza installare terze parti Software.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-python.svg" alt="Python Excel SDK"><header>Aspose.Cells</header><footer> Nuvola<small> <em> per</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-python.svg" alt="Python Cloud Excel"><header>Aspose.Cells</header><footer> Nuvola<small> <em> per</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
Riassumi i dati di ListObject o Table di grandi dimensioni con la tabella pivot
 ...
 Inizia con Excel Spreadsheet Processing SDK
    ...
    <p>
 Per iniziare con Aspose.Cells Cloud SDK per Python, non è necessario installare nulla. Tutto quello che devi fare è creare un account su
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose per Nuvola
     </a>
 e ottenere le informazioni sull'applicazione. Una volta ottenuto l'App SID &amp; key, sei pronto per utilizzare Aspose.Cells Cloud SDK per Python su qualsiasi piattaforma che supporti le API REST. Aspose.Cells Cloud SDK per Python offre tutte le funzionalità per creare, modificare e convertire fogli di calcolo. Consente inoltre di estrarre i dati dai fogli di calcolo per un'ulteriore elaborazione o archiviazione.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-python" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Cells Cloud SDK per Python?" tabId="success-stories" >}}
