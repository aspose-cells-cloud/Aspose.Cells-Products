...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK nel file in formato SVG utilizzando Cells Cloud SDK per Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in Python utilizzando REST API per esportare WORKBOOK nel formato SVG dal foglio di calcolo" gistPath="" %}}
