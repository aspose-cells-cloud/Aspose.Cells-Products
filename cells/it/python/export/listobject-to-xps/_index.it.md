...
---
{{< blocks/products/cells/cells-cloud-banner h1="Esporta LISTOBJECT a XPS da Excel" h2="Libreria Python per esportare LISTOBJECT nel file XPS" p="Utilizza Esporta API di Cells Cloud per esportare i flussi di lavoro degli oggetti interni del file Excel in Python. Questa è una soluzione professionale per esportare LISTOBJECT nel file in formato XPS dal foglio di calcolo online utilizzando Python." urlsection="export/listobject-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto LISTOBJECT nel file in formato XPS utilizzando Cells Cloud SDK per Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in Python utilizzando REST API per esportare LISTOBJECT nel formato XPS dal foglio di calcolo" gistPath="" %}}
