...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Esporta SHAPE a PNG da Excel" h2="Libreria Python per esportare SHAPE nel file PNG" p="Utilizza Esporta API di Cells Cloud per esportare i flussi di lavoro degli oggetti interni del file Excel in Python. Questa è una soluzione professionale per esportare SHAPE nel file in formato PNG dal foglio di calcolo online utilizzando Python." urlsection="export/shape-to-png/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Esporta l\'oggetto SHAPE nel file in formato PNG utilizzando Cells Cloud SDK per Python" >}}
