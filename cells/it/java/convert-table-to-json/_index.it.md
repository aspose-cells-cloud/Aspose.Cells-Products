---
title: Converte una tabella di foglio di calcolo su un'unità locale in un file json.
description: Questo metodo legge un file di foglio di calcolo dal file system locale, converte la sua tabella nel file html desiderato e restituisce il risultato convertito. \nIl percorso del file di origine e il formato di destinazione devono essere specificati correttamente. \nAssicurarsi che le autorizzazioni necessarie siano presenti per leggere il file di origine e scrivere il file convertito, se applicabile. \nIl processo di conversione avviene interamente sul server cloud, eliminando la necessità di alcun storage cloud o download esterni. \nSe il file di origine non esiste, non è accessibile, o si verifica un errore durante il processo di conversione, verrà generata un'eccezione appropriata. \nI formati supportati per la conversione dipendono dalle librerie disponibili e dalle loro capacità.
kwords: aspose cells
url: /it/net/convert-table-to-json/
---
