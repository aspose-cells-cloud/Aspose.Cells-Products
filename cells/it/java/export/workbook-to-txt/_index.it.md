...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK in un file in formato TXT utilizzando Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in Java utilizzando REST API per esportare WORKBOOK in formato TXT dal foglio di calcolo" gistPath="" %}}
