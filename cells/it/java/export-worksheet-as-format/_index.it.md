---
title: Converti i file Excel in altri formati.
description: Aspose.Cells Cloud offre un supporto completo per la conversione dei formati di file Excel, un processo noto per la sua complessità. Aspose.Cells Cloud supporta più di 30 formati di file, tra cui Excel, Pdf, Markdown, Json, XML, Csv, Html e così via.
kwords: aspose cells
url: /it/java/export-worksheet-as-format/
---
