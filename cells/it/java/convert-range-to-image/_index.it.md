---
title: Converte un intervallo di foglio di calcolo su un'unità locale in un file immagine.
description: Questo metodo legge un file di foglio di calcolo dal file system locale, ne converte l'intervallo nel file immagine desiderato e restituisce il risultato convertito. \nIl percorso del file di origine e il formato di destinazione devono essere specificati correttamente. \nAssicurati che le autorizzazioni necessarie siano impostate per leggere il file di origine e scrivere il file convertito, se applicabile. \nIl processo di conversione avviene interamente sul server cloud, eliminando la necessità di qualsiasi archiviazione cloud o download esterni. \nSe il file di origine non esiste, è inaccessibile o si verifica un errore durante il processo di conversione, verrà sollevata un'eccezione appropriata. \nI formati supportati per la conversione dipendono dalle librerie disponibili e dalle loro capacità.
kwords: aspose cells
url: /it/java/convert-table-to-json/
---
