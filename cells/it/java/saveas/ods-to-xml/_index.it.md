...
{{< blocks/products/cells/cells-cloud-section title="Salva un file ODS come XML in Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Esempio di codice per salvare ODS come XML utilizzando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Scopri come salvare ODS come XML utilizzando la libreria Cells Cloud Java." >}}
