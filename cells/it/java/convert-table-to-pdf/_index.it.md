---
title: Converte una tabella di foglio di calcolo su un'unità locale in file PDF.
description: Questo metodo legge un file di foglio di calcolo dal file system locale, converte la sua tabella nel file PDF desiderato e restituisce il risultato della conversione. \nIl percorso del file di origine e il formato di destinazione devono essere specificati correttamente. \nAssicurarsi che le autorizzazioni necessarie siano impostate per leggere il file di origine e scrivere il file convertito, se applicabile. \nIl processo di conversione avviene interamente sul server cloud, eliminando la necessità di alcuno storage cloud o download esterni. \nSe il file di origine non esiste, è inaccessibile, o si verifica un errore durante il processo di conversione, viene sollevata un'eccezione appropriata. \nI formati supportati per la conversione dipendono dalle librerie disponibili e dalle loro capacità.
kwords: aspose cells
url: /it/java/convert-table-to-pdf/
---
