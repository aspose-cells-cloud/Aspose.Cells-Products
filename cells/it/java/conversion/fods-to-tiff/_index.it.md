---
title:  Converti FODS in TIFF nel Cloud via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertire FODS in TIFF con Java" h2="Automatizza la conversione di file Excel e OpenOffice con Cloud SDK open source for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione semplice da FODS a TIFF" %}}
...
1. Chiama lo ```CellsApi.cellsWorkbookGetWorkbook``` per ottenere il file TIFF risultante
...
{{% blocks/products/pf/agp/code-autogen title="Java Codice per convertire FODS in TIFF" gistPath="" %}}
```java
