...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XML con Java" h2="Automatizza la conversione dei file Excel e OpenOffice con Cloud SDK open source for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Semplice conversione da FODS a XML" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Codice per convertire FODS in XML" gistPath="" %}}
```java
