...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XLSM con Java" h2="Automatizza la conversione dei file Excel e OpenOffice con Cloud SDK open source for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Semplice conversione da FODS a XLSM" %}}
...
1. Chiama lo ```CellsApi.cellsWorkbookGetWorkbook``` per ottenere il file XLSM risultante
...
{{% blocks/products/pf/agp/code-autogen title="Java Codice per convertire FODS in XLSM" gistPath="" %}}
```java
