---
title: Converte un foglio di lavoro di un foglio di calcolo su un'unità locale in un file PDF.
description: Questo metodo legge un file di foglio di calcolo dal file system locale, converte il suo foglio di lavoro nel file PDF desiderato e restituisce il risultato convertito. \nIl percorso del file sorgente e il formato di destinazione devono essere specificati correttamente. \nAssicurati che le autorizzazioni necessarie siano presenti per leggere il file sorgente e scrivere il file convertito, se applicabile. \nIl processo di conversione avviene interamente sul server cloud, eliminando la necessità di archiviazione cloud o download esterni. \nSe il file sorgente non esiste, è inaccessibile o si verifica un errore durante il processo di conversione, verrà generata un'eccezione appropriata. \nI formati supportati per la conversione dipendono dalle librerie disponibili e dalle loro capacità.
kwords: aspose cells
---
