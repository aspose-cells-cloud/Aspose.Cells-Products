...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API per salvare XLT come SXC" h2="Libreria Android per salvare XLT come SXC" p="Usa Cells SaveAs REST API per creare flussi di lavoro di fogli di calcolo personalizzati in Android. Questa è una soluzione professionale per salvare XLT come SXC e altri formati di documenti online utilizzando Android." urlsection="saveas/xlt-to-sxc/" >}}
