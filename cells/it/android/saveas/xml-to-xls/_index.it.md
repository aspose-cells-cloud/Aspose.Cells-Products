...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva XML come XLS" h2="Libreria Android per salvare XML come XLS" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati con fogli di calcolo in Android. Questa è una soluzione professionale per salvare XML come XLS e altri formati di documenti online utilizzando Android." urlsection="saveas/xml-to-xls/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Esempio di codice Android per salvare XML come XLS utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK per Android per salvare i file Excel in altri formati XML come XLS" >}}
