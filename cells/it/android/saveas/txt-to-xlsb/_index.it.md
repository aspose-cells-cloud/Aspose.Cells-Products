...
---
{{< blocks/products/cells/cells-cloud-banner h1="Salva TXT come XLSB" h2="Libreria Android per salvare TXT come XLSB" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati con fogli di calcolo in Android. Questa è una soluzione professionale per salvare TXT come XLSB e altri formati di documenti online utilizzando Android." urlsection="saveas/txt-to-xlsb/" >}}

{{< blocks/products/cells/cells-cloud-section title="Salva un file TXT come XLSB in Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice Android per salvare TXT come XLSB utilizzando REST API" gistPath="" %}}
