---
title:  Converti FODS in XLT su Android
...
url: /it/android/conversion/fods-to-xlt/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XLT nel Cloud" h2="Converti fogli di calcolo Excel e OpenOffice con Cloud SDK open source per Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da FODS a XLT nelle app Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: conversione da FODS a XLT" gistPath="" %}}
```java
