---
title:  Converti FODS in XPS su Android
...
url: /it/android/conversion/fods-to-xps/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XPS nel Cloud" h2="Converti fogli di calcolo Excel e OpenOffice con Cloud SDK open source per Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da FODS a XPS nelle app Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: conversione da FODS a XPS" gistPath="" %}}
```java
