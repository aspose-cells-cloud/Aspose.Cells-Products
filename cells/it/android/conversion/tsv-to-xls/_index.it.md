---
title:  Conversione da TSV a XLS API per Android
description:  Utilizzo di Aspose.Cells Cloud SDK per Android per convertire il file in formato TSV in un file in formato XLS.
url: /it/android/conversion/tsv-to-xls/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API per convertire TSV in XLS" h2="Libreria Android per convertire TSV in XLS" p="Utilizza Cells Conversion REST API per creare flussi di lavoro di fogli di calcolo personalizzati in Android. Questa è una soluzione professionale per convertire TSV in XLS e altri formati di documenti online utilizzando Android." urlsection="conversion/tsv-to-xls/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Java API per convertire TSV in XLS" >}}
