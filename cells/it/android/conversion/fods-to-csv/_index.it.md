---
title:  Converti FODS in CSV su Android
...
url: /it/android/conversion/fods-to-csv/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in CSV nel cloud" h2="Converti fogli di calcolo Excel e OpenOffice con Cloud SDK open source per Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da FODS a CSV nelle app Android" %}}
...
1. Chiama lo ```CellsApi.cellsWorkbookGetWorkbook``` per ottenere il file CSV risultante
...
{{% blocks/products/pf/agp/code-autogen title="Android: conversione da FODS a CSV" gistPath="" %}}
```java
