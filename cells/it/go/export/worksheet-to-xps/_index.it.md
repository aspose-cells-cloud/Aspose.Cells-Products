---
title:  Esporta FOGLIO DI LAVORO in XPS dal foglio di calcolo utilizzando Go API
...
url: /it/go/export/worksheet-to-xps/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Esempio di codice in Go utilizzando REST API per esportare WORKSHEET nel formato XPS dal foglio di calcolo" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come usare Go API per esportare WORKSHEET in XPS" >}}
