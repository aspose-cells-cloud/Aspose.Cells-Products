...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK in un file in formato SQL utilizzando Cells Cloud SDK per Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in Go utilizzando REST API per esportare WORKBOOK in formato SQL dal foglio di calcolo" gistPath="" %}}
