...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Vai ad esempio codice per salvare XLTM come XLS utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK for Go per salvare i file Excel in altri formati XLTM come XLS" >}}
