---
title:  Salva HTML come WMF API per Go
description:  Utilizzo di Aspose.Cells Cloud SDK for Go per salvare il file in formato HTML come file in formato WMF.
url: /it/go/saveas/html-to-wmf/
---
...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Salva un file HTML come WMF in Go" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Esempio di codice in Go utilizzando REST API per salvare HTML come formato WMF" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Go API per salvare HTML come WMF" >}}
