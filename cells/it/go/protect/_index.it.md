---
title:  Proteggi i file Excel utilizzando Go
description: Aspose.Cells Cloud REST API supporta la crittografia, la decrittografia e l'aggiunta di firme digitali alle cartelle di lavoro utilizzando Go e offre SDK per vari linguaggi di programmazione.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Proteggi i file Excel utilizzando Go" h2="Aspose.Cells Cloud SDK supporta la decrittografia, la crittografia e la firma digitale delle cartelle di lavoro." p="Aspose.Cells Cloud REST API supporta la crittografia, la decrittografia e l\'aggiunta di firme digitali alle cartelle di lavoro utilizzando Go e offre SDK per vari linguaggi di programmazione." urlsection="protect/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells Cloud" subTitlepfName="Cells Cloud Feature" >}}

{{< blocks/products/cells/cells-cloud-card-row title="Proteggi i file Excel utilizzando i collegamenti Go Extension" >}}
