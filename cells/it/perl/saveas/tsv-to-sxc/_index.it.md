...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva TSV come SXC" h2="Perl libreria per salvare TSV come SXC" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati per fogli di calcolo in Perl. Si tratta di una soluzione professionale per salvare TSV come SXC e altri formati di documenti online utilizzando Perl." urlsection="saveas/tsv-to-sxc/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codice Esempio per salvare TSV come SXC utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK per Perl per salvare i file Excel in altri formati TSV come SXC" >}}
