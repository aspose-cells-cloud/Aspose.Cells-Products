...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva XLT come ODS" h2="Libreria Perl per il salvataggio di XLT come ODS" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati per fogli di calcolo in Perl. Si tratta di una soluzione professionale per salvare XLT come ODS e altri formati di documenti online utilizzando Perl." urlsection="saveas/xlt-to-ods/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codice Esempio per salvare XLT come ODS utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK per Perl per salvare i file Excel in altri formati XLT come ODS" >}}
