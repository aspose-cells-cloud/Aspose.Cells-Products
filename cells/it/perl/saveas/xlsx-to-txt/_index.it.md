...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva XLSX come TXT" h2="Libreria Perl per il salvataggio di XLSX come TXT" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati per fogli di calcolo in Perl. Si tratta di una soluzione professionale per salvare XLSX come TXT e altri formati di documenti online utilizzando Perl." urlsection="saveas/xlsx-to-txt/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codice Esempio per salvare XLSX come TXT utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK per Perl per salvare i file Excel in altri formati XLSX come TXT" >}}
