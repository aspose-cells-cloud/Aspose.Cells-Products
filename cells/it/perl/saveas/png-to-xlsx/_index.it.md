...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva PNG come XLSX" h2="Libreria Perl per salvare PNG come XLSX" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati per fogli di calcolo in Perl. Si tratta di una soluzione professionale per salvare PNG come XLSX e altri formati di documenti online utilizzando Perl." urlsection="saveas/png-to-xlsx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl Codice Esempio per salvare PNG come XLSX utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK per Perl per salvare i file Excel in altri formati PNG come XLSX" >}}
