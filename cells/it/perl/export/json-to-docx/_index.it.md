---
title: Esporta Json nel file DOCX via Perl
...
url: /it/perl/export/json-to-docx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Esporta JSON in file DOCX nel Cloud" h2="Excel ed esportazione di fogli di calcolo OpenOffice con Cloud SDK open source per Perl" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Esporta il file JSON in DOCX in Cloud SDK per Perl" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Perl Codice per la conversione da JSON a DOCX" gistPath="" %}}
```perl
