---
title:  Crea app di lettura e conversione Excel in Perl (via REST API)
description: Crea, leggi, scrivi, unisci, dividi, crittografa e converti Microsoft Excel e fogli di calcolo OpenOffice nel cloud
weight: 90
url: /it/perl
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Perl REST SDK per fogli di calcolo Excel" h2="Crea, leggi, scrivi, unisci, dividi, crittografa e converti Microsoft Excel e fogli di calcolo OpenOffice nel cloud." logoImageSrc="/headers/aspose_cells-for-perl.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Perl" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDk per Perl consente di sviluppare rapidamente app competitive basate su cloud Microsoft Excel e generatore di fogli di calcolo OpenOffice, lettore, fusione, divisione, crittografia e conversione nel linguaggio di programmazione Perl. Aspose.Cells Cloud SDK per Perl è basato su Aspose.Cells REST API. Il nostro Cells Cloud SDK è concesso in licenza con MIT.</p>
<p>Aspose.Cells Cloud SDK per Perl rende il tuo codice Perl in grado di accedere a fogli di lavoro cloud e modificare filtri automatici, cartelle di lavoro, celle, colonne, righe, grafici, forme, collegamenti ipertestuali, formattazione condizionale, OleObjects, interruzioni di pagina, ListObjects, tabelle pivot, attività e intervalli . Abilita il tuo programma Perl per convertire XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM, ODS in DIF, PDF, XPS, TIFF, SVG, MD (Markdown), XML (SpreadsheetML), CSV, TSV, TXT (TabDelimited) , HTML e formati MHTML.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-perl.svg" alt="Perl Excel SDK"><header>Aspose.Cells</header><footer> Nuvola<small> <em> per</em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-perl.svg" alt="Excel Perl Cloud SDK"><header>Aspose.Cells</header><footer> Nuvola<small> <em> per</em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
Elimina specifici o tutti gli OleObject dal foglio di lavoro
 ...
 Inizia con Excel Spreadsheet Processing SDK
    ...
    <p>
 Per iniziare con Aspose.Cells Cloud SDK per Perl, non è necessario installare nulla. Tutto quello che devi fare è creare un account su
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose per Nuvola
     </a>
 e ottenere le informazioni sull'applicazione. Una volta ottenuto l'App SID &amp; key, sei pronto per utilizzare Aspose.Cells Cloud SDK per Perl su qualsiasi piattaforma che supporti le API REST. Aspose.Cells Cloud SDK per Perl offre tutte le funzionalità per creare, modificare e convertire fogli di calcolo. Consente inoltre di estrarre i dati dai fogli di calcolo per un'ulteriore elaborazione o archiviazione.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
