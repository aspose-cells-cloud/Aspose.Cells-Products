...
description: Crea, leggi, scrivi, unisci, dividi, crittografa e converti fogli di calcolo Microsoft Excel e OpenOffice nel cloud
weight: 90
url: /it/perl
---
...
<p>Aspose.Cells Cloud SDk per Perl ti consente di sviluppare rapidamente applicazioni competitive basate su cloud Microsoft Excel e generatore di fogli di calcolo OpenOffice, lettore, fusione, suddivisione, crittografia e conversione nel linguaggio di programmazione Perl. Aspose.Cells Cloud SDK per Perl è basato su Aspose.Cells REST API. Il nostro Cells Cloud SDK è concesso in licenza dal MIT.</p>
<p>Aspose.Cells Cloud SDK per Perl rende il tuo codice Perl in grado di accedere ai fogli di lavoro cloud e modificare filtri automatici, cartelle di lavoro, celle, colonne, righe, grafici, forme, collegamenti ipertestuali, formattazione condizionale, OleObject, interruzioni di pagina, ListObject, tabelle pivot, attività e intervalli . Abilita il tuo programma Perl per convertire XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM, ODS in DIF, PDF, XPS, TIFF, SVG, MD (Markdown), XML (SpreadsheetML), CSV, TSV, TXT (TabDelimited) , HTML e formati MHTML.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
