...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK nel file in formato WMF utilizzando Cells Cloud SDK per C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in C# utilizzando REST API per esportare WORKBOOK in formato WMF dal foglio di calcolo" gistPath="" %}}
