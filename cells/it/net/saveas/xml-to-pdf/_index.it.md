...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva XML come PDF" h2="Libreria C# per salvare XML come PDF" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati con fogli di calcolo in Net. Questa è una soluzione professionale per salvare XML come PDF e altri formati di documenti online utilizzando C#." urlsection="saveas/xml-to-pdf/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Esempio di codice per salvare XML come PDF utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK for Net per salvare i file Excel in altri formati XML come PDF" >}}
