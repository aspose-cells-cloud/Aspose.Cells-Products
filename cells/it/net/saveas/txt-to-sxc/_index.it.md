...
---
{{< blocks/products/cells/cells-cloud-banner h1="Salva TXT come SXC" h2="C# libreria per salvare TXT come SXC" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati con fogli di calcolo in Net. Questa è una soluzione professionale per salvare TXT come SXC e altri formati di documenti online utilizzando C#." urlsection="saveas/txt-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="Salva un file TXT come SXC in C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Codice Esempio per salvare TXT come SXC utilizzando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Scopri come salvare TXT come SXC utilizzando la libreria Cloud Net Cells." >}}
