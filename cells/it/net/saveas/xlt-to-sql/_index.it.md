...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Salva XLT come SQL" h2="Libreria C# per il salvataggio di XLT come SQL" p="Utilizza SaveAs API di Cells Cloud per creare flussi di lavoro personalizzati con fogli di calcolo in Net. Questa è una soluzione professionale per salvare XLT come SQL e altri formati di documenti online utilizzando C#." urlsection="saveas/xlt-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# Esempio di codice per salvare XLT come SQL utilizzando REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come utilizzare Cells Cloud SDK for Net per salvare i file Excel in altri formati XLT come SQL" >}}
