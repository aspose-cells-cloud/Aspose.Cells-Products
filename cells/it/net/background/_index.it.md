---
title:  Imposta uno sfondo per i file Excel utilizzando C#
description:  Aspose.Cells Cloud REST API supporta l'impostazione dello sfondo per i file Excel utilizzando C# e offre SDK per vari linguaggi di programmazione.
---
...
{{< blocks/products/cells/cells-cloud-card-row title="Imposta uno sfondo per i file Excel utilizzando i collegamenti dell\'estensione C#" >}}
