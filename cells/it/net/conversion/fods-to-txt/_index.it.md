...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in TXT nel Cloud" h2="Excel e conversione di fogli di calcolo OpenOffice con Cloud SDK open source for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Codice per conversione da FODS a TXT" gistPath="" %}}
```cs
