...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XML nel cloud" h2="Excel e conversione di fogli di calcolo OpenOffice con Cloud SDK open source for .NET" >}}
...
1. Chiama il metodo ```CellsApi.CellsSaveAsPostDocumentSaveAs``` per ottenere il file XML risultante
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Codice per conversione da FODS a XML" gistPath="" %}}
```cs
