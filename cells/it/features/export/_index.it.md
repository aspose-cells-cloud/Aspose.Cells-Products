---
title:  Esportare
description:  Aspose.Cells Cloud REST API supporta l'esportazione di cartelle di lavoro e oggetti interni in tutti i tipi di formati. L'SDK supporta i linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift.
url: /it/export/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Esportare" h2="Aspose.Cells Cloud SDK supporta l\'esportazione di cartelle di lavoro e oggetti interni in oltre 30 formati di file." logoImageSrc="/product-logos/aspose_cells-for-cloud.svg" pfName="Aspose.Cells Cloud" downloadUrl="" tryOnlineUrl="" >}}
...
{{< blocks/products/cells/cells-cloud-feature pfName="Aspose.Cells Cloud SDK for Net" title="Esporta la cartella di lavoro in Pdf" imgSrc="/cells/app-logos/aspose_conversion-app.png" productLink="/cells/net/export/workbook-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-feature pfName="Aspose.Cells Cloud SDK for Go" title="Esporta la cartella di lavoro in Json" imgSrc="/cells/app-logos/aspose_conversion-app.png" productLink="/cells/go/export/workbook-to-json/" >}}

{{< blocks/products/cells/cells-cloud-feature pfName="Aspose.Cells Cloud SDK for Java" title="Esporta oggetto elenco in Csv" imgSrc="/cells/app-logos/aspose_conversion-app.png" productLink="/cells/java/export/listobject-to-csv/" >}}

{{< blocks/products/cells/cells-cloud-feature pfName="Aspose.Cells Cloud SDK for PHP" title="Esporta grafico in png" imgSrc="/cells/app-logos/aspose_conversion-app.png" productLink="/cells/php/export/chart-to-png/" >}}

{{< blocks/products/cells/cells-cloud-feature pfName="Aspose.Cells Cloud SDK for Python" title="Esporta la cartella di lavoro in MD" imgSrc="/cells/app-logos/aspose_conversion-app.png" productLink="/cells/python/export/workbook-to-md/" >}}

{{< blocks/products/cells/cells-cloud-feature pfName="Aspose.Cells Cloud SDK for Swift" title="Esporta foglio in pdf" imgSrc="/cells/app-logos/aspose_conversion-app.png" productLink="/cells/swift/export/worksheet-to-pdf/" >}}
{{< /blocks/products/pf/product-card-row >}}
