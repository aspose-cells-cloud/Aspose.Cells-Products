...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Esporta GRAFICO in JPG da Excel" h2="Libreria NodeJS per esportare CHART in file JPG" p="Utilizza Export API of Cells Cloud per esportare i flussi di lavoro degli oggetti interni del file Excel in NodeJS. Questa è una soluzione professionale per esportare CHART in file in formato JPG da un foglio di calcolo online utilizzando NodeJS." urlsection="export/chart-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Esporta l\'oggetto CHART in un file in formato JPG utilizzando Cells Cloud SDK per NodeJS" >}}
