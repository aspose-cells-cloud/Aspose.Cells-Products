...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK nel file in formato EMF utilizzando Cells Cloud SDK per NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in NodeJS utilizzando REST API per esportare WORKBOOK nel formato EMF dal foglio di calcolo" gistPath="" %}}
