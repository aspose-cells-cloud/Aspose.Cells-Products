---
title:  Accesso, lettura ed elaborazione dei file Cloud Excel (SDK Node.js via)
description:  Sviluppa Microsoft Excel e applicazioni di visualizzazione, esportazione e conversione di fogli di calcolo basate su cloud OpenOffice in Node.js via REST API
weight: 80
url: /it/nodejs
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SDK REST Node.js per elaborare ed esportare file Excel" h2="Sviluppa Microsoft Excel e applicazioni di visualizzazione, esportazione e conversione di fogli di calcolo basate su cloud OpenOffice in Node.js via REST API." logoImageSrc="/headers/aspose_cells-for-node.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Node.js" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK per Node.js consente alle tue applicazioni basate su cloud di leggere fogli di calcolo Excel, esportare cartelle di lavoro XLSX, convertire documenti Microsoft Excel e OpenOffice in PDF, XPS, TIFF, Markdown (MD), DIF, SVG, XML (foglio di calcolo ML), CSV , TSV, HTML e altri formati supportati, senza installare software di terze parti.</p>
<p>Aspose.Cells Cloud SDK per Node.js ottiene le sue robuste funzionalità dal sottostante Aspose.Cells REST API e consente al codice Node.js di funzionare con Excel formattazione condizionale, filtri automatici, forme automatiche, grafici, OleObject, interruzioni di pagina, ListObject, tabelle pivot, compiti e intervalli. Utilizza semplici comandi Node.js per creare, aggiornare, crittografare, unire, proteggere con password, esportare e convertire a livello di codice file XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM e ODS in altri formati supportati.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Funzionalità avanzate per manipolare i fogli di calcolo Excel
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Elimina specifici o tutti gli OleObject dal foglio di lavoro
 ...
 Inizia con l'SDK per l'elaborazione dei fogli di calcolo Excel
    ...
    <p>
 Per iniziare con Aspose.Cells Cloud SDK per Node.js, non è necessario installare nulla. Tutto quello che devi fare è creare un account su
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose per Nuvola
     </a>
 ottieni le informazioni sulla tua richiesta. Una volta che hai l'App SID &amp; chiave, sei pronto per utilizzare Aspose.Cells Cloud SDK per Node.js su qualsiasi piattaforma che supporti le API REST. Aspose.Cells Cloud SDK per Node.js fornisce tutte le funzionalità per creare, modificare e convertire fogli di calcolo. Consente inoltre di estrarre dati dai fogli di calcolo per ulteriore elaborazione o archiviazione.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Elaborazione cartelle di lavoro via Cloud SDK
    ...
    <p>
 Aspose.Cells Cloud SDK per Node.js consente di creare, dividere, unire, cercare e sostituire testo, protezione tramite password, esportare in formati di file supportati, leggere elementi di testo della cartella di lavoro, adattare automaticamente le righe della cartella di lavoro ignorando gli elementi nascosti, crittografare la password della cartella di lavoro e fornire lunghezza della chiave di crittografia, importare dati nella cartella di lavoro, calcolare tutte le formule nella cartella di lavoro, impostare le impostazioni di calcolo della formula fornendo una strategia di precisione ecc., utilizzare un marcatore intelligente, convertire la cartella di lavoro dal contenuto della richiesta in un altro formato, applicare la password per consentire la modifica del contenuto.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
