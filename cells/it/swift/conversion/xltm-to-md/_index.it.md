---
title: XLTM in MD Converti API per Swift
description:  Utilizzo di Aspose.Cells Cloud SDK per Swift per convertire il file in formato XLTM in un file in formato MD.
