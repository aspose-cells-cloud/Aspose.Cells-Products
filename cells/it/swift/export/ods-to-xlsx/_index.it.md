---
title: Esporta Ods nel file XLSX via Swift
...
url: /it/swift/export/ods-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Esporta ODS in file XLSX nel Cloud" h2="Excel ed esportazione di fogli di calcolo OpenOffice con Cloud SDK open source per Swift" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Esporta ODS in file XLSX in Cloud SDK per Swift" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Swift per la conversione da ODS a XLSX" gistPath="" %}}
```swift
