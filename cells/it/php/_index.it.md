---
title: Excel® Programmazione di fogli di calcolo API per velocizzare le attività di gestione e elaborazione dei fogli di calcolo utilizzando PHP
...
{{< blocks/products/cells/languge-index-ferturecard title="Convertire" desc="Converts a spreadsheet on a local drive to the specified format." url="/cells/php/conversion" imgurl="/cells/images/convert.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Unisci" desc="Merge local spreadsheet files into a specified format file." url="/cells/php/merge" imgurl="/cells/images/merge.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Proteggere" desc="Applies dual-layer password protection to Excel spreadsheets, supporting both open and modify passwords with encryption." url="/cells/php/protect" imgurl="/cells/images/protect.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Salva con nome" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/php/saveas" imgurl="/cells/images/saveas.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Esportare" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/php/export" imgurl="/cells/images/export.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Chiaro" desc="Clear cell formats in the worksheet." url="/cells/php/clear" imgurl="/cells/images/clear.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Sfondo" desc="Set background in the workbook." url="/cells/php/background" imgurl="/cells/images/background.svg" >}}
