...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertire FODS in XPS con PHP" h2="Automatizza la conversione dei file Excel e OpenOffice con Cloud SDK open source per PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Converti rapidamente FODS in XPS via PHP" %}}
...
1. Chiama lo ```CellsApi.cellsSaveAsPostDocumentSaveAs``` per ottenere il file XPS risultante
...
{{% blocks/products/pf/agp/code-autogen title="PHP Codice per FODS in XPS Conversione" gistPath="" %}}
```php
