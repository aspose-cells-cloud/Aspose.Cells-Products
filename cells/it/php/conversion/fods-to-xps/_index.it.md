...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XPS con PHP" h2="Automatizza la conversione dei file Excel e OpenOffice con Cloud SDK open source per PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Codice per FODS a XPS Conversione" gistPath="" %}}
```php
