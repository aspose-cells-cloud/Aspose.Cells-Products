...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in TSV con PHP" h2="Automatizza la conversione dei file Excel e OpenOffice con Cloud SDK open source per PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Converti rapidamente FODS in TSV via PHP" %}}
...
1. Chiama lo ```CellsApi.cellsSaveAsPostDocumentSaveAs``` per ottenere il file TSV risultante
...
{{% blocks/products/pf/agp/code-autogen title="PHP Codice per conversione da FODS a TSV" gistPath="" %}}
```php
