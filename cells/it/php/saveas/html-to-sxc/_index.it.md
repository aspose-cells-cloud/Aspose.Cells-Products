...
{{< blocks/products/cells/cells-cloud-section title="Salva un file HTML come SXC in PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Codice Esempio per salvare HTML come SXC utilizzando REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Scopri come salvare HTML come SXC utilizzando la libreria Cells Cloud PHP." >}}
