...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK in un file in formato MD utilizzando Cells Cloud SDK per PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in PHP utilizzando REST API per esportare WORKBOOK in formato MD dal foglio di calcolo" gistPath="" %}}
