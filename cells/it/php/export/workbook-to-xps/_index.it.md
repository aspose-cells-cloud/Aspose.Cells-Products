...
{{< blocks/products/cells/cells-cloud-section title="Esporta l\'oggetto WORKBOOK nel file in formato XPS utilizzando Cells Cloud SDK per PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice in PHP utilizzando REST API per esportare WORKBOOK nel formato XPS dal foglio di calcolo" gistPath="" %}}
