...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Esporta SHAPE in JPG da Excel" h2="PHP libreria per esportare SHAPE in file JPG" p="Utilizza Export API di Cells Cloud per esportare i flussi di lavoro degli oggetti interni del file Excel in PHP. Questa è una soluzione professionale per esportare SHAPE in file in formato JPG dal foglio di calcolo online utilizzando PHP." urlsection="export/shape-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Esporta l\'oggetto SHAPE in un file in formato JPG utilizzando Cells Cloud SDK per PHP" >}}
