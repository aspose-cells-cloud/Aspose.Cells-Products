---
title: API per l'analisi del foglio di calcolo Excel disponibili in .NET, Java, Python, C++, PHP e Go.
weight: 10
description: Il cloud Aspose.Cells API ti consente di eseguire un'ampia gamma di attività di elaborazione dei documenti su qualsiasi piattaforma, compresa la creazione, manipolazione, conversione e rendering dei documenti Excel nel cloud. Con questo API, puoi convertire facilmente Excel, OpenOffice e altri formati di file in una varietà di formati di output, inclusi PDF, HTML, ODS, XPS, CSV, JSON, Markdown e altri.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Elabora Excel Fogli di calcolo su più piattaforme" h2="API native per creare, modificare, convertire ed eseguire il rendering dei file Excel. Esporta fogli di calcolo in più formati su qualsiasi piattaforma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells.svg" pfName="Aspose.Cells" downloadUrl="https://downloads.aspose.com/cells" tryOnlineUrl="" >}}
...
{{< blocks/products/cells/cells-cloud-card-support imgSrc="https://products-qa.aspose.cloud/sdk/aspose_cells-for-curl.svg" pfName="Aspose.Cells Cloud" title="SDk per arricciatura" linkurl="/cells/curl" productLink="/cells/curl/" >}}
{{< blocks/products/cells/cells-cloud-card-support imgSrc="https://products-qa.aspose.cloud/sdk/aspose_cells-for-go.svg" pfName="Aspose.Cells Cloud" title="SDk per Go" linkurl="/cells/go" productLink="/cells/go/" >}}
...
{{< blocks/products/cells/cells-cloud-card-support imgSrc="https://products-qa.aspose.cloud/sdk/aspose_cells-for-net.svg" pfName="Aspose.Cells Cloud" title="SDK per la rete" linkurl="/cells/net" productLink="/cells/net/" >}}
{{< blocks/products/cells/cells-cloud-card-support imgSrc="https://products-qa.aspose.cloud/sdk/aspose_cells-for-node.svg" pfName="Aspose.Cells Cloud" title="SDk per Node" linkurl="/cells/node" productLink="/cells/node/" >}}
{{< blocks/products/cells/cells-cloud-card-support imgSrc="https://products-qa.aspose.cloud/sdk/aspose_cells-for-perl.svg" pfName="Aspose.Cells Cloud" title="SDk per Perl" linkurl="/cells/perl" productLink="/cells/perl/" >}}
