...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Esporta SHAPE in WMF da Excel" h2="Libreria Ruby per esportare SHAPE in file WMF" p="Utilizzare Esporta API di Cells Cloud per esportare i flussi di lavoro degli oggetti interni del file Excel in Ruby. Questa è una soluzione professionale per esportare SHAPE in file in formato WMF da un foglio di calcolo online utilizzando Ruby." urlsection="export/shape-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Esporta l\'oggetto SHAPE nel file in formato WMF utilizzando Cells Cloud SDK per Ruby" >}}
