---
title:  Conversione da Excel FODS a XPS via Rubino
...
{{% blocks/products/pf/agp/feature-section-col title="FODS a XPS Conversione con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per FODS a XPS Conversione" gistPath="" %}}
```ruby
