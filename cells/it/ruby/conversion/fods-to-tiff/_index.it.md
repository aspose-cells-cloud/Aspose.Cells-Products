---
title:  Conversione da Excel FODS a TIFF via Rubino
...
{{% blocks/products/pf/agp/feature-section-col title="FODS a TIFF Conversione con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per FODS a TIFF Conversione" gistPath="" %}}
```ruby
