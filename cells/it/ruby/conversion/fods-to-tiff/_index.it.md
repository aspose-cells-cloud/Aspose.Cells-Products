---
title:  Convertire da Excel FODS a TIFF via Rubino
description: Crea, modifica o converti file Excel con REST API e SDK Ruby open source
url: /it/ruby/conversion/fods-to-tiff/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in TIFF con Ruby" h2="Leggi, modifica ed esporta i dati Excel in altri formati con Cloud SDK open source per Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS allo TIFF Conversione con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per conversione da FODS a TIFF" gistPath="" %}}
```ruby
