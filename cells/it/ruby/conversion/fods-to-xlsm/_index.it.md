---
title:  Conversione da Excel FODS a XLSM via Rubino
description: Crea, modifica o converti file Excel con REST API e Open Source Ruby SDK
url: /it/ruby/conversion/fods-to-xlsm/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XLSM con Ruby" h2="Leggi, modifica ed esporta i dati Excel in altri formati con Cloud SDK open source per Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da FODS a XLSM con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per la conversione da FODS a XLSM" gistPath="" %}}
```ruby
