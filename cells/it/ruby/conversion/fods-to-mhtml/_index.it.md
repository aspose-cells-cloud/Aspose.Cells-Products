---
title:  Conversione da Excel FODS a MHTML via Rubino
description: Crea, modifica o converti file Excel con REST API e Open Source Ruby SDK
url: /it/ruby/conversion/fods-to-mhtml/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in MHTML con Ruby" h2="Leggi, modifica ed esporta i dati Excel in altri formati con Cloud SDK open source per Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da FODS a MHTML con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per la conversione da FODS a MHTML" gistPath="" %}}
```ruby
