---
title:  Conversione da Excel FODS a HTML via Rubino
...
{{% blocks/products/pf/agp/feature-section-col title="FODS a HTML Conversione con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per FODS a HTML Conversione" gistPath="" %}}
```ruby
