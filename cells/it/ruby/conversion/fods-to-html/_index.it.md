---
title:  Convertire da Excel FODS a HTML via Rubino
description: Crea, modifica o converti file Excel con REST API e SDK Ruby open source
url: /it/ruby/conversion/fods-to-html/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in HTML con Ruby" h2="Leggi, modifica ed esporta i dati Excel in altri formati con Cloud SDK open source per Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS allo HTML Conversione con Ruby" %}}
...
1. Chiama il metodo ```CellsApi.cells_save_as_post_document_save_as``` per ottenere il file HTML risultante
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per conversione da FODS a HTML" gistPath="" %}}
```ruby
