...
{{< blocks/products/cells/cells-cloud-section title="Converti ODS in PNG utilizzando Cells Cloud SDK per Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Esempio di codice Ruby per convertire ODS in PNG utilizzando Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Scopri come convertire ODS in PNG utilizzando la libreria Cells Cloud Ruby." >}}
