---
title:  Conversione da Excel FODS a XLSB via Rubino
description: Crea, modifica o converti file Excel con REST API e Open Source Ruby SDK
url: /it/ruby/conversion/fods-to-xlsb/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti FODS in XLSB con Ruby" h2="Leggi, modifica ed esporta i dati Excel in altri formati con Cloud SDK open source per Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da FODS a XLSB con Ruby" %}}
...
1. Chiama il metodo ```CellsApi.cells_save_as_post_document_save_as``` per ottenere il file XLSB risultante
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per la conversione da FODS a XLSB" gistPath="" %}}
```ruby
