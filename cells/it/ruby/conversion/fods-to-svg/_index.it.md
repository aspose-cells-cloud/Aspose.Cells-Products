---
title:  Conversione da Excel FODS a SVG via Rubino
...
{{% blocks/products/pf/agp/feature-section-col title="FODS a SVG Conversione con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Codice Ruby per FODS a SVG Conversione" gistPath="" %}}
```ruby
