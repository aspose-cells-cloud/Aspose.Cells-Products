...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API per salvare XLSM come XLTX" h2="Libreria Ruby per salvare XLSM come XLTX" p="Usa Cells SaveAs REST API per creare flussi di lavoro di fogli di calcolo personalizzati in Ruby. Questa è una soluzione professionale per salvare XLSM come XLTX e altri formati di documenti online utilizzando Ruby." urlsection="saveas/xlsm-to-xltx/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Come usare Ruby API per salvare XLSM come XLTX" >}}
