...
url: /nodejs/clear/clear-blank-rows/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Clear blank rows on the local workbook in Cloud" h2="Excel & OpenOffice spreadsheet Clear blank rows by open-source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Clear blank rows on local spreadsheet by Cloud SDK for NodeJS" %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS code for clearing blank rows on local spreadsheets" gistPath="https://gist.github.com/aspose-cells-cloud-gists/e82de2e4189bc27ae92abf73c36b4df0.js?file=Example-Clear-BlankRows.js" %}}
