---
title: Convert BMP to TXT via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert BMP to  TXT in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="BMP to TXT Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for BMP to TXT Conversion" gistPath="" %}}
```js
