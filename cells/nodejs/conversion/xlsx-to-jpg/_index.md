---
title: Convert XLSX to JPG via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to  JPG in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to JPG Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for XLSX to JPG Conversion" gistPath="" %}}
```js
