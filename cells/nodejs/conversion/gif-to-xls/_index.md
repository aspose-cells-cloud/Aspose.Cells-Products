---
title: Convert GIF to XLS via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert GIF to  XLS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="GIF to XLS Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for GIF to XLS Conversion" gistPath="" %}}
```js
