---
title: Convert XLTM to XLSB via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to  XLSB in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTM to XLSB Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for XLTM to XLSB Conversion" gistPath="" %}}
```js
