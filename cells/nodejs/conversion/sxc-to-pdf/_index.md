---
title: Convert SXC to PDF via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to  PDF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to PDF Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for SXC to PDF Conversion" gistPath="" %}}
```js
