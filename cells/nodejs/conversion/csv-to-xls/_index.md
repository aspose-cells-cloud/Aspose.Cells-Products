---
title: Convert CSV to XLS via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to  XLS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to XLS Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for CSV to XLS Conversion" gistPath="" %}}
```js
