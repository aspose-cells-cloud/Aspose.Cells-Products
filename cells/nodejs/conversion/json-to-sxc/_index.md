---
title: Convert JSON to SXC via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  SXC in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to SXC Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for JSON to SXC Conversion" gistPath="" %}}
```js
