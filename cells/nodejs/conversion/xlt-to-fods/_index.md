---
title: Convert XLT to FODS via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to  FODS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLT to FODS Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for XLT to FODS Conversion" gistPath="" %}}
```js
