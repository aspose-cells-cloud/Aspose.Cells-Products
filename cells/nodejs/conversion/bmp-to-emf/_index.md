---
title: Convert BMP to EMF via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert BMP to  EMF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="BMP to EMF Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for BMP to EMF Conversion" gistPath="" %}}
```js
