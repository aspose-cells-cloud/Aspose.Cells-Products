---
title: Convert EMF to SQL via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert EMF to  SQL in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="EMF to SQL Conversion in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for EMF to SQL Conversion" gistPath="" %}}
```js
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=emf  outputformat=sql  %}}
