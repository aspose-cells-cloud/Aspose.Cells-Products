---
title: Export Shape to TIFF file via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Shape to TIFF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Shape to TIFF file in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for SHAPE to TIFF Conversion" gistPath="" %}}
```js
