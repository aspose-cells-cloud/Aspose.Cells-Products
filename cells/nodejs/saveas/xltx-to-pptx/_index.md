---
title: Save XLTX as PPTX via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XLTX file as  PPTX file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XLTX file as PPTX file in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for saving XLTX as PPTX " gistPath="" %}}
```js
