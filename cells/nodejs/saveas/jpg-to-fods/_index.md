---
title: Save JPG as FODS via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save JPG file as  FODS file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save JPG file as FODS file in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for saving JPG as FODS " gistPath="" %}}
```js
