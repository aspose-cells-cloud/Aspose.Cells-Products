---
title: Save XLSM as EMF via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XLSM file as  EMF file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XLSM file as EMF file in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for saving XLSM as EMF " gistPath="" %}}
```js
