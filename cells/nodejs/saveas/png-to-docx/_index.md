---
title: Save PNG as DOCX via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save PNG file as  DOCX file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save PNG file as DOCX file in Cloud SDK for NodeJS " %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS Code for saving PNG as DOCX " gistPath="" %}}
```js
