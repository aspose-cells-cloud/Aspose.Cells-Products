...
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API لتصدير كتاب العمل إلى ملف WMF" h2="مكتبة PHP لتصدير كتاب العمل إلى ملف WMF" p="استخدم Cells Export REST API لتصدير مهام سير عمل الكائنات الداخلية لجدول البيانات في PHP. هذا حل احترافي لتصدير WORKBOOK إلى ملف بتنسيق WMF من جدول بيانات عبر الإنترنت باستخدام PHP." urlsection="export/workbook-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تصدير كائن WORKBOOK إلى ملف بتنسيق WMF في PHP" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام PHP API لتصدير كتاب العمل إلى WMF" >}}
