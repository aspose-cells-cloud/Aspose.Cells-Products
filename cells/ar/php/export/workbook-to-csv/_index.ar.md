...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى CSV من Excel" h2="مكتبة PHP لتصدير المصنف إلى ملف CSV" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في PHP. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق CSV من جدول البيانات عبر الإنترنت باستخدام PHP." urlsection="export/workbook-to-csv/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن المصنف إلى ملف بتنسيق CSV باستخدام Cells Cloud SDK لـ PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في PHP باستخدام REST API لتصدير المصنف إلى تنسيق CSV من جدول البيانات" gistPath="" %}}
