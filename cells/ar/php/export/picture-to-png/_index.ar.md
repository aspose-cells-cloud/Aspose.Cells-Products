...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الصورة إلى PNG من Excel" h2="مكتبة PHP لتصدير الصور إلى ملف PNG" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في PHP. هذا حل احترافي لتصدير PICTURE إلى ملف بتنسيق PNG من جدول البيانات عبر الإنترنت باستخدام PHP." urlsection="export/picture-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن PICTURE إلى ملف بتنسيق PNG باستخدام Cells Cloud SDK لـ PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في PHP باستخدام REST API لتصدير الصورة إلى تنسيق PNG من جدول البيانات" gistPath="" %}}
