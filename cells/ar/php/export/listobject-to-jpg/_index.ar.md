...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير LISTOBJECT إلى JPG من Excel" h2="مكتبة PHP لتصدير LISTOBJECT إلى ملف JPG" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في PHP. يعد هذا حلاً احترافيًا لتصدير LISTOBJECT إلى ملف بتنسيق JPG من جدول البيانات عبر الإنترنت باستخدام PHP." urlsection="export/listobject-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن LISTOBJECT إلى ملف بتنسيق JPG باستخدام Cells Cloud SDK لـ PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في PHP باستخدام REST API لتصدير LISTOBJECT إلى تنسيق JPG من جدول البيانات" gistPath="" %}}
