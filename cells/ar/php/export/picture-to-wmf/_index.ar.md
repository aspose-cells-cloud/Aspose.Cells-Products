...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الصورة إلى WMF من Excel" h2="مكتبة PHP لتصدير الصورة إلى ملف WMF" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في PHP. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق PICTURE إلى WMF من جدول البيانات عبر الإنترنت باستخدام PHP." urlsection="export/picture-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن PICTURE إلى ملف بتنسيق WMF باستخدام Cells Cloud SDK لـ PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في PHP باستخدام REST API لتصدير الصورة إلى تنسيق WMF من جدول البيانات" gistPath="" %}}
