...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS باسم FODS في PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP مثال كودي لحفظ المواد المستنفدة للأوزون على هيئة FODS باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية حفظ المواد المستنفدة للأوزون مثل FODS باستخدام مكتبة Cells Cloud PHP." >}}
