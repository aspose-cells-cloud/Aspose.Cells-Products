...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ ملف CSV كملف ODS" h2="مكتبة PHP لحفظ ملف CSV كملف ODS" p="استخدم SaveAs API من Cells Cloud لإنشاء سير عمل جداول بيانات مخصصة في PHP. يعد هذا حلاً احترافيًا لحفظ ملف CSV بتنسيق ODS وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام PHP." urlsection="saveas/csv-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف CSV بتنسيق ODS في PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP مثال على الكود لحفظ ملف CSV كملف ODS باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ ملف CSV كملف ODS باستخدام مكتبة Cells Cloud PHP." >}}
