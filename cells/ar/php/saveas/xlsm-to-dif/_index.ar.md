...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ XLSM بصيغة DIF" h2="مكتبة PHP لحفظ XLSM بصيغة DIF" p="استخدم SaveAs API من Cells Cloud لإنشاء سير عمل جداول بيانات مخصصة في PHP. يعد هذا حلاً احترافيًا لحفظ XLSM بتنسيق DIF وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام PHP." urlsection="saveas/xlsm-to-dif/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف XLSM باسم DIF في PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP مثال على الكود لحفظ XLSM كـ DIF باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ XLSM كـ DIF باستخدام مكتبة Cells Cloud PHP." >}}
