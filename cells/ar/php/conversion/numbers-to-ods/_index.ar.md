...
{{< blocks/products/cells/cells-cloud-section title="تحويل الأرقام إلى ODS باستخدام Cells Cloud SDK لـ PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP مثال على الكود لتحويل NUMBERS إلى ODS باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية تحويل NUMBERS إلى ODS باستخدام مكتبة Cells Cloud PHP." >}}
