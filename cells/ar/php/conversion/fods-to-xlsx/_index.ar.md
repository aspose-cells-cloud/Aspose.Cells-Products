...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLSX مع PHP" h2="أتمتة Excel وتحويل ملف OpenOffice باستخدام Cloud SDK مفتوح المصدر لـ PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="بسرعة تحويل FODS إلى XLSX via PHP" %}}
...
1. اتصل على ```CellsApi.cellsSaveAsPostDocumentSaveAs``` للحصول على ملف XLSX الناتج
...
{{% blocks/products/pf/agp/code-autogen title="PHP كود لتحويل FODS إلى XLSX" gistPath="" %}}
```php
