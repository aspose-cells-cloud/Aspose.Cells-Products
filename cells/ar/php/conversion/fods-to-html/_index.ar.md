---
title:  تحويل FODS الى HTML في السحابة via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى HTML مع PHP" h2="أتمتة Excel وتحويل ملفات OpenOffice باستخدام Cloud SDK مفتوح المصدر لـ PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS بسرعة إلى HTML via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP كود تحويل FODS إلى HTML" gistPath="" %}}
```php
