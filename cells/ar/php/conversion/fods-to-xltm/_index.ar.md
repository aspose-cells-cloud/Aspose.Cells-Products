...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتحويل FODS إلى XLTM باستخدام PHP" h2="أتمتة Excel وتحويل ملف OpenOffice باستخدام Cloud SDK مفتوح المصدر لـ PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="بسرعة تحويل FODS إلى XLTM via PHP" %}}
...
1. اتصل على ```CellsApi.cellsSaveAsPostDocumentSaveAs``` للحصول على ملف XLTM الناتج
...
{{% blocks/products/pf/agp/code-autogen title="PHP كود لتحويل FODS إلى XLTM" gistPath="" %}}
```php
