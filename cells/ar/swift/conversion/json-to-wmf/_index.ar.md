---
title:  تحويل JSON إلى WMF API لـ Swift
description: استخدام Aspose.Cells Cloud SDK لـ Swift لتحويل ملف تنسيق JSON إلى ملف تنسيق WMF.
url: /ar/swift/conversion/json-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="سويفت API لتحويل JSON إلى WMF" h2="مكتبة سويفت لتحويل JSON إلى WMF" p="استخدم Cells تحويل REST API لإنشاء سير عمل جدول بيانات مخصص في Swift. يعد هذا حلاً احترافيًا لتحويل JSON إلى WMF وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Swift." urlsection="conversion/json-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تحويل ملف JSON إلى WMF في Swift" >}}
