...
description: استخدام Aspose.Cells Cloud SDK لـ Swift لتحويل ملف تنسيق XLTM إلى ملف بتنسيق PPTX.
url: /ar/swift/conversion/xltm-to-pptx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="سويفت API لتحويل XLTM إلى PPTX" h2="مكتبة Swift لتحويل XLTM إلى PPTX" p="استخدم Cells Conversion REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Swift. هذا حل احترافي لتحويل XLTM إلى PPTX وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Swift." urlsection="conversion/xltm-to-pptx/" >}}
