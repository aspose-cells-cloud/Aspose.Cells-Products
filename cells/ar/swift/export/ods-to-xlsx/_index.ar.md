...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تصدير ODS إلى ملف XLSX في السحابة" h2="Excel & تصدير جدول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لـ Swift" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code لتحويل ODS إلى XLSX" gistPath="" %}}
```swift
