...
<br/>
يعد حفظ تنسيقات الملفات من ODS كـ XLT مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق ODS إلى XLT بواسطة Swift SDK مع الحفاظ على المحتوى الهيكلي والمنطقي الرئيسي لجدول بيانات ODS المصدر. مكتبة Swift الخاصة بنا هي حل احترافي لحفظ ODS كملفات XLT عبر الإنترنت. يمنح Cloud SDK مطوري Swift وظائف قوية وإخراج XLT مثالي.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز في Swift باستخدام REST API لحفظ ODS بتنسيق XLT" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Swift API لحفظ ODS كـ XLT" >}}
