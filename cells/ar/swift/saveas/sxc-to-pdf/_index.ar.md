...
description:  استخدام Aspose.Cells Cloud SDK لـ Swift لحفظ ملف تنسيق SXC كملف تنسيق PDF.
url: /ar/swift/saveas/sxc-to-pdf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="سويفت API لحفظ SXC كـ PDF" h2="مكتبة سريعة لحفظ SXC كـ PDF" p="استخدم Cells SaveAs REST API لتكوين مسارات عمل جدول بيانات مهيأة في Swift. هذا حل احترافي لحفظ SXC كـ PDF وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Swift." urlsection="saveas/sxc-to-pdf/" >}}
