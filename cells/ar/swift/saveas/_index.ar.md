---
title:  حفظ باستخدام سويفت
description:  Aspose.Cells Cloud REST API يدعم حفظ ملفات Excel كأنواع ملفات التنسيق باستخدام Swift. يدعم SDK لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
url: /ar/swift/saveas/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="حفظ باستخدام سويفت" h2="Aspose.Cells يدعم Cloud SDK حفظ المصنفات بتنسيقات أخرى. تحتوي تنسيقات الملفات المدعومة على أكثر من 30 تنسيقًا للملفات." p="Aspose.Cells Cloud REST API يدعم حفظ ملفات Excel كأنواع ملفات التنسيق باستخدام Swift. يدعم SDK لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="حفظ باستخدام روابط ملحق Swift" >}}
