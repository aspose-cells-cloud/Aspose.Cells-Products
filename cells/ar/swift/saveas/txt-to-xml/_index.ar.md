...
description:  استخدام Aspose.Cells Cloud SDK لـ Swift لحفظ ملف تنسيق TXT كملف بتنسيق XML.
url: /ar/swift/saveas/txt-to-xml/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="سويفت API لحفظ TXT كملف XML" h2="مكتبة سريعة لحفظ TXT بتنسيق XML" p="استخدم Cells SaveAs REST API لتكوين مسارات عمل جدول بيانات مهيأة في Swift. هذا حل احترافي لحفظ TXT بتنسيق XML وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Swift." urlsection="saveas/txt-to-xml/" >}}
