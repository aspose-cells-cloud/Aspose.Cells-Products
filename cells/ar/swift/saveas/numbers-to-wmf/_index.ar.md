...
<br/>
يعد حفظ تنسيقات الملفات من NUMBERS مثل WMF مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق NUMBERS إلى WMF بواسطة Swift SDK مع الحفاظ على المحتوى الهيكلي والمنطقي الرئيسي لجدول البيانات NUMBERS المصدر. مكتبة Swift الخاصة بنا هي حل احترافي لحفظ الأرقام كملفات WMF عبر الإنترنت. يمنح Cloud SDK مطوري Swift وظائف قوية وإخراج WMF مثالي.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز في Swift باستخدام REST API لحفظ الأرقام بتنسيق WMF" gistPath="" %}}
