---
title:  احفظ XLTM كـ SXC API لـ Swift
description:  استخدام Aspose.Cells Cloud SDK لـ Swift لحفظ ملف تنسيق XLTM كملف تنسيق SXC.
url: /ar/swift/saveas/xltm-to-sxc/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="سويفت API لحفظ XLTM كـ SXC" h2="مكتبة سويفت لحفظ XLTM كـ SXC" p="استخدم Cells SaveAs REST API لإنشاء سير عمل جدول بيانات مخصص في Swift. يعد هذا حلاً احترافيًا لحفظ XLTM بتنسيق SXC وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Swift." urlsection="saveas/xltm-to-sxc/" >}}
