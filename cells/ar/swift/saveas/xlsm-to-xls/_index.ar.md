---
title:  احفظ XLSM كـ XLS API لـ Swift
description:  استخدام Aspose.Cells Cloud SDK لـ Swift لحفظ ملف تنسيق XLSM كملف تنسيق XLS.
url: /ar/swift/saveas/xlsm-to-xls/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="سويفت API لحفظ XLSM كـ XLS" h2="مكتبة سويفت لحفظ XLSM كـ XLS" p="استخدم Cells SaveAs REST API لإنشاء سير عمل جدول بيانات مخصص في Swift. يعد هذا حلاً احترافيًا لحفظ XLSM بتنسيق XLS وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Swift." urlsection="saveas/xlsm-to-xls/" >}}
