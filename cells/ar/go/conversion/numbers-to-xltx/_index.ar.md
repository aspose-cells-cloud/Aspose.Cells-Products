---
title:  NUMBERS إلى XLTX قم بتحويل API من أجل Go
description:  استخدام Aspose.Cells Cloud SDK لـ Go لتحويل ملف تنسيق NUMBERS إلى ملف بتنسيق XLTX.
...
<br/>
يعد تحويل تنسيقات الملفات من NUMBERS إلى XLTX مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق NUMBERS إلى XLTX بواسطة Go SDK مع الحفاظ على المحتوى الهيكلي والمنطقي الرئيسي لجدول بيانات NUMBERS المصدر. تعد مكتبة Go الخاصة بنا حلاً احترافيًا لتحويل ملفات NUMBERS إلى XLTX عبر الإنترنت. يمنح Cloud SDK مطوري Go وظائف قوية وإخراج XLTX مثالي.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز في Go باستخدام REST API لتحويل NUMBERS إلى تنسيق XLTX" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Go API لتحويل NUMBERS إلى XLTX" >}}
