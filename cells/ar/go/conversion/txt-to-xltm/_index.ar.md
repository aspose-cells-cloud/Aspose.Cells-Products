---
title:  TXT إلى XLTM - تحويل API إلى Go
description:  استخدام Aspose.Cells Cloud SDK لـ Go لتحويل ملف تنسيق TXT إلى ملف تنسيق XLTM.
url: /ar/go/conversion/txt-to-xltm/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="انتقل إلى API لتحويل TXT إلى XLTM" h2="انتقل إلى مكتبة لتحويل TXT إلى XLTM" p="استخدم Cells Conversion REST API لإنشاء جداول بيانات سير عمل مخصصة في Go. هذا حل احترافي لتحويل TXT إلى XLTM وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Go." urlsection="conversion/txt-to-xltm/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Go API لتحويل TXT إلى XLTM" >}}
