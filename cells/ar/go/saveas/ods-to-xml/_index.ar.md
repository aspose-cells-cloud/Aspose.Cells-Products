...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="انتقل إلى مثال الرمز لحفظ المواد المستنفدة للأوزون بتنسيق XML باستخدام REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Cells Cloud SDK لـ Go لحفظ ملفات Excel بتنسيقات أخرى ODS مثل XML" >}}
