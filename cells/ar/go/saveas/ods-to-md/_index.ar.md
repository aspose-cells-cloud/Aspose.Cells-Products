...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS بصيغة MD في Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="انتقل إلى مثال الرمز لحفظ المواد المستنفدة للأوزون كـ MD باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ المواد المستنفدة للأوزون كـ MD باستخدام مكتبة Cells Cloud Go." >}}
