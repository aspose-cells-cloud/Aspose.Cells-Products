---
title:  قم بتصدير كتاب العمل إلى MD من جدول البيانات باستخدام Go API
description:  Aspose.Cells Cloud REST API يدعم تصدير {0} إلى {1} تنسيق الملفات باستخدام {2}.
url: /ar/go/export/workbook-to-md/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="انتقل إلى API لتصدير كتاب العمل إلى ملف MD" h2="انتقل إلى المكتبة لتصدير كتاب العمل إلى ملف MD" p="استخدم Cells Export REST API لتصدير مسارات عمل العناصر الداخلية لجدول البيانات في Go. هذا حل احترافي لتصدير كتاب العمل إلى ملف بتنسيق MD من جدول بيانات عبر الإنترنت باستخدام Go." urlsection="export/workbook-to-md/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Go API لتصدير WORKBOOK إلى MD" >}}
