---
title:  تحويل من Excel فودز إلى HTML via Python
...
{{% blocks/products/pf/agp/feature-section-col title="FODS إلى HTML التحويل مع Python" %}}
...
1. اتصل بطريقة ```CellsApi.cells_save_as_post_document_save_as``` لتحصل على الملف HTML الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Python كود تحويل FODS إلى HTML" gistPath="" %}}
```python
