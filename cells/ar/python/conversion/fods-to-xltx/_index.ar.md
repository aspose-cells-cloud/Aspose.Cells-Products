...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLTX مع Python" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى XLTX مع Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python كود لتحويل FODS إلى XLTX" gistPath="" %}}
```python
