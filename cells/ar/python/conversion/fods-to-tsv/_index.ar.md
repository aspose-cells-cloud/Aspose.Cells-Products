...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى TSV مع Python" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى TSV مع Python" %}}
...
1. اتصل بالطريقة ```CellsApi.cells_save_as_post_document_save_as``` للحصول على ملف TSV الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Python كود لتحويل FODS إلى TSV" gistPath="" %}}
```python
