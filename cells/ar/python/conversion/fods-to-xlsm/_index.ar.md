---
title:  تحويل من Excel FODS إلى XLSM via Python
...
1. اتصل بطريقة ```CellsApi.cells_save_as_post_document_save_as``` للحصول على ملف XLSM الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Python كود تحويل FODS إلى XLSM" gistPath="" %}}
```python
