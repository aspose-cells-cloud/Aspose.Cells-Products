...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى TIFF مع Python" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS إلى TIFF التحويل مع Python" %}}
...
1. اتصل بطريقة ```CellsApi.cells_save_as_post_document_save_as``` لتحصل على الملف TIFF الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Python كود تحويل FODS إلى TIFF" gistPath="" %}}
```python
