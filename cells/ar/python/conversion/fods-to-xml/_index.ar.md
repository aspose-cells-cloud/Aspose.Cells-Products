---
title:  التحويل من Excel FODS إلى XML via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XML مع Python" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python" >}}
...
1. اتصل بطريقة ```CellsApi.cells_save_as_post_document_save_as``` للحصول على ملف XML الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Python كود تحويل FODS إلى XML" gistPath="" %}}
```python
