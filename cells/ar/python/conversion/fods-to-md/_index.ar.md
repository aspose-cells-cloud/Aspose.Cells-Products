---
title:  تحويل من Excel FODS إلى MD via Python
...
1. اتصل بطريقة ```CellsApi.cells_save_as_post_document_save_as``` للحصول على ملف MD الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Python كود التحويل من FODS إلى MD" gistPath="" %}}
```python
