...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLT مع Python" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى XLT مع Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python كود لتحويل FODS إلى XLT" gistPath="" %}}
```python
