...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف XLS بتنسيق XLSB في Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python مثال على الكود لحفظ XLS كـ XLSB باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية حفظ XLS كـ XLSB باستخدام مكتبة Cells Cloud Python." >}}
