...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python مثال على حفظ PNG كمواد مستنفدة للأوزون باستخدام REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Cells Cloud SDK لـ Python لحفظ ملفات Excel بتنسيقات أخرى PNG كـ ODS" >}}
