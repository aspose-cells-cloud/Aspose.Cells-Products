...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python مثال على حفظ HTML كـ DIF باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية حفظ HTML كـ DIF باستخدام مكتبة Cells Cloud Python." >}}
