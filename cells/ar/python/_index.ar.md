---
title:  Excel ومعالجة OpenOffice via Python في السحابة (REST SDK)
description: REST API لدمج Excel ووظيفة معالجة جداول البيانات OpenOffice في تطبيقات Python المستندة إلى السحابة
weight: 110
url: /ar/python
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python SDK لمعالجة ملفات Excel" h2="REST API لدمج Excel ووظيفة معالجة جداول البيانات OpenOffice في تطبيقات Python المستندة إلى السحابة." logoImageSrc="/headers/aspose_cells-for-python.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Python" downloadUrl="" >}}
...
<p>يساعدك Aspose.Cells Cloud SDK لـ Python على تطوير تطبيقات إنشاء جداول البيانات السحابية والعارض والدمج والتقسيم والتشفير والمحول بلغة البرمجة Python. يتم توزيع Aspose.Cells Cloud SDK لـ Python بموجب ترخيص MIT ويتم تشغيله بواسطة Aspose.Cells REST API.</p>
<p>Aspose.Cells Cloud SDK لـ Python يسمح لكود Python الخاص بك بأداء وظائف المستوى الأساسي إلى المتقدم على Microsoft Excel وجداول بيانات OpenOffice المستضافة على وحدة التخزين السحابية. استخدم برنامج Python الخاص بك للعمل مع الجداول المحورية، والعمل مع XML (جدول البيانات)، وقراءة Excel ملفًا في السحابة via Python، وتحويل XLSX إلى HTML، وCSV، PDF، XPS، MD (Markdown)، DIF، 07611 23481 وتنسيقات الملفات المدعومة الأخرى.</p>
<p>Aspose.Cells Cloud SDK لـ Python يمكّن برامج Python الخاصة بك من إنشاء جداول بيانات متعددة وإدارة أوراق العمل والمصنفات وإعداد الورقة وتطبيق التنسيق الشرطي وإدارة المهام والصيغ والمرشحات التلقائية وOleobjects وListObjects وغيرها من كيانات جداول البيانات Excel، دون تثبيت أي جهة خارجية برمجة.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 ميزات SDK السحابية لجداول البيانات المتقدمة Excel
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
احذف OleObjects معينة أو كلها من ورقة العمل
 ...
 ابدأ باستخدام Excel SDK لمعالجة جداول البيانات
    ...
    <p>
 من أجل البدء باستخدام Aspose.Cells Cloud SDK لـ Python، لا تحتاج إلى تثبيت أي شيء. كل ما عليك فعله هو إنشاء حساب على
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose للسحاب
     </a>
والحصول على معلومات التطبيق الخاص بك. بمجرد حصولك على التطبيق SID &amp; المفتاح، أنت جاهز لاستخدام Aspose.Cells Cloud SDK لـ Python على أي نظام أساسي يدعم REST APIs. يوفر لك Aspose.Cells Cloud SDK لـ Python جميع الميزات لإنشاء جداول البيانات وتحريرها وتحويلها. كما يسمح لك باستخراج البيانات من جداول البيانات لمزيد من المعالجة أو التخزين.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 معالجة المصنفات via Cloud SDK
    ...
    <p>
 Aspose.Cells Cloud SDK لـ Python يسمح لك بإنشاء النص وتقسيمه ودمجه والبحث فيه واستبداله وحماية كلمة المرور والتصدير إلى تنسيق ملف مدعوم وقراءة العناصر النصية للمصنف وملاءمة صفوف المصنف تلقائيًا أثناء تجاهل العناصر المخفية وتشفير كلمة مرور المصنف وتوفير مفتاح التشفير الطول، واستيراد البيانات إلى المصنف، وحساب جميع الصيغ في المصنف، وتعيين إعدادات حساب الصيغة من خلال توفير استراتيجية دقيقة وما إلى ذلك، واستخدام العلامة الذكية، وتحويل المصنف من محتوى الطلب إلى تنسيق آخر، وتطبيق كلمة المرور للسماح بتعديل المحتوى.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
باستخدام Aspose.Cells Cloud SDK لـ Python، يمكنك حذف صف معين أو جميع الصفوف في ورقة العمل، أو جلب بيانات خلية ورقة العمل أو نمط الخلية حسب اسم الخلية، أو قراءة بيانات صف أو عمود ورقة العمل حسب فهرسها، وحساب صيغة الخلية، ومسح محتويات الخلية، ونسخ الخلية إلى خلية أخرى، ونسخ أعمدة وصفوف ورقة العمل، وتجميع صفوف وأعمدة ورقة العمل، وإخفاء صفوف وأعمدة ورقة العمل، وتعيين عمود ورقة العمل وأنماط الصفوف، وتعيين قيمة HTMLSTRING في الخلية، وتعيين قيمة نطاق الخلية، وتعديل الكثير من إعدادات ورقة العمل الأخرى.
 ...
 الاستفادة من قوة الجداول المحورية &amp; نطاقات
    ...
    <p>
 يتيح لك Aspose.Cells Cloud SDK لـ Python إضافة جدول محوري إلى ورقة العمل، وإضافة أو حذف الحقول المحورية في الجدول المحوري، وإضافة أو إزالة عامل التصفية المحوري لفهرس الجدول المحوري، وتحديث نمط الخلية للجدول المحوري، وحساب بيانات الجدول المحوري على الخلايا.
    </p>
    <p>
يمكن أيضًا استخدام Aspose.Cells Cloud SDK لـ Python للحصول على قائمة الخلايا في نطاق حسب اسم النطاق أو فهارس أعمدة الصف، وتعيين عرض العمود للنطاق، ودمج نطاق من الخلايا في خلية واحدة، ونقل النطاق الحالي إلى النطاق الوجهة، والمجموعات حدود مخطط تفصيلي حول نطاق من الخلايا. وتعيين ارتفاع صف النطاق وتعيين نمط النطاق وإلغاء دمج الخلايا المدمجة في هذا النطاق ووضع قيمة في النطاق وتحويل نوع البيانات الخاص به ونسخ النطاق في ورقة العمل.
    </p>
   </div>
  </div>
 </div>
