...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى TXT من Excel" h2="مكتبة Python لتصدير المصنف إلى ملف TXT" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Python. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق TXT من جدول البيانات عبر الإنترنت باستخدام Python." urlsection="export/workbook-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن كتاب العمل إلى ملف بتنسيق TXT باستخدام Cells Cloud SDK لـ Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في Python باستخدام REST API لتصدير المصنف إلى تنسيق TXT من جدول البيانات" gistPath="" %}}
