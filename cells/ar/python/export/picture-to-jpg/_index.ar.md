...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الصورة إلى JPG من Excel" h2="مكتبة Python لتصدير الصورة إلى ملف JPG" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Python. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق PICTURE إلى JPG من جدول البيانات عبر الإنترنت باستخدام Python." urlsection="export/picture-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن PICTURE إلى ملف بتنسيق JPG باستخدام Cells Cloud SDK لـ Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في Python باستخدام REST API لتصدير PICTURE إلى تنسيق JPG من جدول البيانات" gistPath="" %}}
