...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تصدير المواد المستنفدة للأوزون إلى ملف XLSX في السحابة" h2="Excel وتصدير جداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لـ Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" تصدير ODS إلى ملف XLSX في Cloud SDK لـ Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python رمز لتحويل المواد المستنفدة للأوزون إلى XLSX" gistPath="" %}}
```python
