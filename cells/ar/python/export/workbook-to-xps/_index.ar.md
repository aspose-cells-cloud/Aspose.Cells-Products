...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى XPS من Excel" h2="مكتبة Python لتصدير المصنف إلى ملف XPS" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Python. يعد هذا حلاً احترافيًا لتصدير المصنف إلى ملف بتنسيق XPS من جدول البيانات عبر الإنترنت باستخدام Python." urlsection="export/workbook-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن المصنف إلى ملف تنسيق XPS باستخدام Cells Cloud SDK لـ Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في Python باستخدام REST API لتصدير المصنف إلى تنسيق XPS من جدول البيانات" gistPath="" %}}
