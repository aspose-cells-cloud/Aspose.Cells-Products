...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الشكل إلى EMF من Excel" h2="مكتبة Python لتصدير SHAPE إلى ملف EMF" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Python. يعد هذا حلاً احترافيًا لتصدير SHAPE إلى ملف بتنسيق EMF من جدول البيانات عبر الإنترنت باستخدام Python." urlsection="export/shape-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن SHAPE إلى ملف تنسيق EMF باستخدام Cells Cloud SDK لـ Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في Python باستخدام REST API لتصدير SHAPE إلى تنسيق EMF من جدول البيانات" gistPath="" %}}
