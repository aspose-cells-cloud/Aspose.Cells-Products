...
description:  Aspose.Cells Cloud REST API يسمح بدمج عدة ملفات Excel في ملف Excel واحد ويوفر SDKs للغات برمجة متعددة، بما في ذلك Android، C#، Go، Java، NodeJS، Perl، PHP، 0761 83481، روبي، وسويفت.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="دمج ملفات Excel متعددة" h2="يدعم Aspose.Cells Cloud SDK دمج ملفات Excel المتعددة في ملف Excel واحد." p="Aspose.Cells Cloud REST API يسمح بدمج عدة ملفات Excel في ملف Excel واحد ويوفر SDKs للغات برمجة متعددة، بما في ذلك Android، C#، Go، Java، NodeJS، Perl، PHP، 0761 83481، روبي، وسويفت." urlsection="" >}}
