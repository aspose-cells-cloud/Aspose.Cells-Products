...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS بتنسيق XLSX في Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لحفظ المواد المستنفدة للأوزون بتنسيق XLSX باستخدام REST API" gistPath="" %}}
