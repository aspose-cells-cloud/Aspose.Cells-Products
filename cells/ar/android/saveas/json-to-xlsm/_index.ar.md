...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ JSON بتنسيق XLSM" h2="مكتبة Android لحفظ JSON بتنسيق XLSM" p="استخدم SaveAs API من Cells Cloud لإنشاء مهام سير عمل جدول بيانات مخصصة في Android. يعد هذا حلاً احترافيًا لحفظ JSON بتنسيق XLSM وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Android." urlsection="saveas/json-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف JSON بتنسيق XLSM في Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لحفظ JSON بتنسيق XLSM باستخدام REST API" gistPath="" %}}
