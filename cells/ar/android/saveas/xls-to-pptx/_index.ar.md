...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف XLS بتنسيق PPTX في Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لحفظ XLS كـ PPTX باستخدام REST API" gistPath="" %}}
