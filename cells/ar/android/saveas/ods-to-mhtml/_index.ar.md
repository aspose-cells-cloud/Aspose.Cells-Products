...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS بتنسيق MHTML في Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لحفظ المواد المستنفدة للأوزون كـ MHTML باستخدام REST API" gistPath="" %}}
