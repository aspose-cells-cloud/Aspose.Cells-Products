...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ MHTML بتنسيق XLTX" h2="مكتبة Android لحفظ MHTML بتنسيق XLTX" p="استخدم SaveAs API من Cells Cloud لإنشاء مهام سير عمل جدول بيانات مخصصة في Android. يعد هذا حلاً احترافيًا لحفظ MHTML بتنسيق XLTX وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Android." urlsection="saveas/mhtml-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف MHTML بتنسيق XLTX في Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لحفظ MHTML كـ XLTX باستخدام REST API" gistPath="" %}}
