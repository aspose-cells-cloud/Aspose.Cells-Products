---
title:  REST API لبناء Excel تطبيقات لنظام Android
description:  Android REST SDK لإنشاء جداول بيانات Excel وOpenOffice مستندة إلى السحابة، ودمج أوراق العمل وتقسيمها وعرضها وتشفيرها وتحويلها
weight: 20
url: /ar/android
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء تطبيقات Android لمعالجة جداول البيانات via REST API" h2="Android REST SDK لإنشاء جداول بيانات Excel وOpenOffice مستندة إلى السحابة، ودمج التطبيقات وتقسيمها وعرضها وتشفيرها وتحويلها." logoImageSrc="/headers/aspose_cells-for-android.svg" pfName="Aspose.Cells" subTitlepfName="SDK for Android" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK لنظام Android يساعدك في تطوير Microsoft Excel (XLS، XLSX، XLSB، XLSM، XLT، XLTX، XLTM) وتطبيقات معالجة جداول البيانات OpenOffice (ODS) لأجهزة Android. يتم تقديم Aspose.Cells Cloud SDK لنظام Android بموجب ترخيص MIT ويستند إلى Aspose.Cells REST API.</p>
<p>Aspose.Cells Cloud SDK لنظام Android يمكّن رمز Android الخاص بك من الوصول إلى مستندات جداول البيانات السحابية ومعالجة المصنفات وأوراق العمل والخلايا الفردية والصفوف والأعمدة. سيتمكن برنامج Android الخاص بك من استخراج الرموز الشريطية من صور ورقة العمل، وتطبيق عوامل التصفية التلقائية (مرشح التاريخ، مرشح الرموز، المرشح الديناميكي)، والوصول إلى المخططات، وتطبيق التنسيق الشرطي، وتكوين إعداد صفحة جدول البيانات برمجيًا.</p>
<p>يتيح لك Aspose.Cells Cloud SDK لنظام Android العمل مع OleObjects وListObjects والجداول المحورية والنطاقات والأشكال والمهام ضمن أوراق عمل Excel وODS، دون تثبيت أي برنامج تابع لجهة خارجية.</p>
<p>يمكن أن يساعدك Aspose.Cells Cloud SDK لنظام Android أيضًا في إنشاء تطبيقات محول جداول البيانات للأجهزة المحمولة التي تعمل بنظام Android، حيث يسمح بتحويل Microsoft Excel، OpenOffice، SpreadsheetML، CSV، TSV، TXT (TabDelimited)، HTML، MHTML، SXC، FODS إلى التنسيقات المدعومة الأخرى، مثل PDF، XPS، TIFF، SVG، DIF وMD (Markdown).</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-android.svg" alt="Android SDK to manipulate Spreadsheets"><header>Aspose.Cells</header><footer> سحاب<small> <em> ل</em> </small>ذكري المظهر</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-android.svg" alt="Spreadsheet manipulation via Android"><header>Aspose.Cells</header><footer> سحاب<small> <em> ل</em> </small>ذكري المظهر</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
احذف OleObjects معينة أو كلها من ورقة العمل
 ...
 ابدأ باستخدام Excel SDK لمعالجة جداول البيانات
    ...
    <p>
 من أجل البدء باستخدام Aspose.Cells Cloud SDK لنظام Android، لا تحتاج إلى تثبيت أي شيء. كل ما عليك فعله هو إنشاء حساب على
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose للسحاب
     </a>
والحصول على معلومات التطبيق الخاص بك. بمجرد حصولك على التطبيق SID &amp; المفتاح، أنت جاهز لاستخدام Aspose.Cells Cloud SDK لنظام Android على أي نظام أساسي يدعم REST APIs. يوفر لك Aspose.Cells Cloud SDK لنظام Android جميع الميزات اللازمة لإنشاء جداول البيانات وتحريرها وتحويلها. كما يسمح لك باستخراج البيانات من جداول البيانات لمزيد من المعالجة أو التخزين.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 معالجة المصنفات via Cloud SDK
    ...
    <p>
 Aspose.Cells Cloud SDK لنظام Android يسمح لك بإنشاء النص وتقسيمه ودمجه والبحث فيه واستبداله وحماية كلمة المرور والتصدير إلى تنسيق ملف مدعوم وقراءة العناصر النصية للمصنف وملاءمة صفوف المصنف تلقائيًا مع تجاهل العناصر المخفية وتشفير كلمة مرور المصنف وتوفير مفتاح التشفير الطول، واستيراد البيانات إلى المصنف، وحساب جميع الصيغ في المصنف، وتعيين إعدادات حساب الصيغة من خلال توفير استراتيجية دقيقة وما إلى ذلك، واستخدام العلامة الذكية، وتحويل المصنف من محتوى الطلب إلى تنسيق آخر، وتطبيق كلمة المرور للسماح بتعديل المحتوى.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
Cloud SDK لمعالجة أوراق العمل
 ...
 الاستفادة من قوة الجداول المحورية &amp; نطاقات
    ...
    <p>
 Aspose.Cells يتيح لك Cloud SDK لنظام Android إضافة جدول محوري إلى ورقة العمل، وإضافة أو حذف الحقول المحورية في الجدول المحوري، وإضافة أو إزالة عامل التصفية المحوري لفهرس الجدول المحوري، وتحديث نمط الخلية للجدول المحوري، وحساب بيانات الجدول المحوري على الخلايا.
    </p>
    <p>
Aspose.Cells يمكن أيضًا استخدام Cloud SDK لنظام Android للحصول على قائمة الخلايا في نطاق حسب اسم النطاق أو فهارس عمود الصف، وتعيين عرض العمود للنطاق، ودمج نطاق من الخلايا في خلية واحدة، ونقل النطاق الحالي إلى النطاق الوجهة، والمجموعات حدود مخطط تفصيلي حول نطاق من الخلايا. وتعيين ارتفاع صف النطاق وتعيين نمط النطاق وإلغاء دمج الخلايا المدمجة في هذا النطاق ووضع قيمة في النطاق وتحويل نوع البيانات الخاص به ونسخ النطاق في ورقة العمل.
    </p>
   </div>
  </div>
 </div>
