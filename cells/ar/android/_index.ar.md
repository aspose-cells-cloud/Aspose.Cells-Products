...
description:  Android REST SDK لإنشاء جداول بيانات Excel & OpenOffice المستندة إلى السحابة ، ودمج أوراق العمل وتقسيمها وعرضها وتشفيرها وتحويلها
weight: 20
url: /ar/android
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="بناء معالجة جداول البيانات تطبيقات Android via REST API" h2="Android REST SDK لإنشاء جداول بيانات Excel & OpenOffice المستندة إلى السحابة ، ودمج التطبيقات وتقسيمها وعرضها وتشفيرها وتحويلها." logoImageSrc="/headers/aspose_cells-for-android.svg" pfName="Aspose.Cells" subTitlepfName="SDK for Android" downloadUrl="" >}}
...
<p>يساعدك Aspose.Cells Cloud SDK لنظام Android في تطوير تطبيقات معالجة جداول البيانات Microsoft Excel (XLS و XLSX و XLSB و XLSM و XLT و XLTX و XLTM) و OpenOffice (ODS) لتطبيقات معالجة جداول البيانات لأجهزة Android. يتم تقديم Aspose.Cells Cloud SDK لنظام Android بموجب ترخيص MIT ويستند إلى Aspose.Cells REST API.</p>
<p>Aspose.Cells Cloud SDK لنظام Android يمكّن كود Android الخاص بك من الوصول إلى مستندات جداول البيانات السحابية ومعالجة المصنفات وأوراق العمل والخلايا الفردية والصفوف والأعمدة. سيتمكن برنامج Android الخاص بك من استخراج الرموز الشريطية من صور ورقة العمل ، وتطبيق عوامل التصفية التلقائية (مرشح التاريخ ، ومرشح الرموز ، والمرشح الديناميكي) ، ومخططات الوصول ، وتطبيق التنسيق الشرطي ، وتكوين إعداد صفحة جدول البيانات برمجيًا.</p>
<p>يسمح لك Aspose.Cells Cloud SDK لنظام Android بالعمل مع OleObjects و ListObjects والجداول المحورية والنطاقات والأشكال والمهام ضمن أوراق عمل Excel و ODS ، دون تثبيت أي برنامج تابع لجهة خارجية.</p>
<p>Aspose.Cells Cloud SDK لنظام Android يمكن أن يساعدك أيضًا في إنشاء تطبيقات محول جداول البيانات للأجهزة المحمولة التي تعمل بنظام Android ، حيث يسمح بتحويل Microsoft Excel ، OpenOffice ، SpreadsheetML ، CSV ، TSV ، TXT (TabDelimited) ، HTML ، MHTML ، SXC ، FODS إلى التنسيقات الأخرى المدعومة ، مثل ، PDF ، XPS ، TIFF ، SVG ، DIF و MD (Markdown).</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
تلخيص بيانات ListObject كبيرة أو جدول مع Pivot Table
 ...
 ابدأ مع Excel SDK لمعالجة جداول البيانات
    ...
    <p>
 لبدء استخدام Aspose.Cells Cloud SDK لنظام Android ، لا تحتاج إلى تثبيت أي شيء. كل ما عليك فعله هو إنشاء حساب على
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose للسحابة
     </a>
واحصل على معلومات التطبيق الخاص بك. بمجرد حصولك على التطبيق SID & amp؛ المفتاح ، فأنت جاهز لاستخدام Aspose.Cells Cloud SDK لنظام Android على أي نظام أساسي يدعم واجهات برمجة تطبيقات REST. توفر لك Aspose.Cells Cloud SDK لنظام Android جميع الميزات لإنشاء جداول البيانات وتحريرها وتحويلها. كما يسمح لك باستخراج البيانات من جداول البيانات لمزيد من المعالجة أو التخزين.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Cloud SDK لمعالجة أوراق العمل
 ...
 الاستفادة من قوة الجداول المحورية & amp؛ نطاقات
    ...
    <p>
 Aspose.Cells Cloud SDK لنظام Android يسمح لك بإضافة جدول محوري إلى ورقة العمل ، وإضافة أو حذف الحقول المحورية في الجدول المحوري ، وإضافة أو إزالة عامل التصفية المحوري لفهرس الجدول المحوري ، وتحديث نمط الخلية للجدول المحوري ، وحساب بيانات الجدول المحوري إلى الخلايا.
    </p>
    <p>
يمكن أيضًا استخدام Aspose.Cells Cloud SDK لنظام Android للحصول على قائمة الخلايا في نطاق حسب اسم النطاق أو فهارس أعمدة الصف ، وتعيين عرض العمود للنطاق ، ودمج نطاق من الخلايا في خلية واحدة ، ونقل النطاق الحالي إلى النطاق الوجهة ، والمجموعات حد المخطط التفصيلي حول نطاق من الخلايا. ، قم بتعيين ارتفاع الصف من النطاق ، وقم بتعيين نمط النطاق ، وإلغاء دمج الخلايا المدمجة في هذا النطاق ، ووضع قيمة في النطاق وتحويل نوع بياناته ، ونسخ النطاق في ورقة العمل.
    </p>
   </div>
  </div>
 </div>
