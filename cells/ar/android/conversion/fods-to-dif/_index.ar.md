...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى DIF في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى DIF في تطبيقات Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="أندرويد: تحويل FODS إلى DIF" gistPath="" %}}
```java
