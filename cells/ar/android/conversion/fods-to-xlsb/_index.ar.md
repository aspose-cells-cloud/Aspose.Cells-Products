---
title:  قم بتحويل FODS إلى XLSB على نظام Android
...
url: /ar/android/conversion/fods-to-xlsb/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLSB في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى XLSB في تطبيقات Android" %}}
...
1. اتصل على ```CellsApi.cellsWorkbookGetWorkbook``` للحصول على ملف XLSB الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Android: تحويل FODS إلى XLSB" gistPath="" %}}
```java
