---
title:  تحويل تنسيقات الملفات Excel باستخدام Android
description: Aspose.Cells Cloud REST API يدعم تحويل تنسيق الملفات Excel باستخدام Android ويقدم حزم SDK للغات برمجة متعددة.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="تحويل تنسيقات الملفات Excel باستخدام Android" h2="Aspose.Cells يدعم Cloud SDK التحويل بين أكثر من 30 تنسيقًا للملفات." p="Aspose.Cells Cloud REST API يدعم تحويل تنسيق الملفات Excel باستخدام Android ويقدم حزم SDK للغات برمجة متعددة." urlsection="conversion/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="تحويل تنسيقات الملفات Excel باستخدام روابط امتداد Android" >}}
