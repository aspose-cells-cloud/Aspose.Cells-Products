...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى MD في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى MD في تطبيقات Android" %}}
...
1. اتصل بالرقم ```CellsApi.cellsWorkbookGetWorkbook``` للحصول على ملف MD الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Android: تحويل FODS إلى MD" gistPath="" %}}
```java
