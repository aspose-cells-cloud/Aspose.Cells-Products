---
title:  قم بتحويل FODS إلى HTML على Android
...
url: /ar/android/conversion/fods-to-html/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتحويل FODS إلى HTML في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى HTML في تطبيقات Android" %}}
...
1. اتصل على ```CellsApi.cellsWorkbookGetWorkbook``` للحصول على الملف الناتج HTML
...
{{% blocks/products/pf/agp/code-autogen title="Android: تحويل FODS إلى HTML" gistPath="" %}}
```java
