---
title:  تحويل FODS إلى HTML على الروبوت
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى HTML في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
...
{{% blocks/products/pf/agp/code-autogen title="أندرويد: تحويل FODS إلى HTML" gistPath="" %}}
```java
