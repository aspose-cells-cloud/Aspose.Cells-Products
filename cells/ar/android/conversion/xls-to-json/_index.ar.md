...
---
{{< blocks/products/cells/cells-cloud-banner h1="تحويل XLS إلى JSON" h2="مكتبة Android لتحويل XLS إلى JSON" p="استخدم التحويل API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في مشاريع Android. يعد هذا حلاً احترافيًا لتحويل XLS إلى JSON وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Android." urlsection="conversion/xls-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="قم بتحويل XLS إلى JSON باستخدام Cells Cloud SDK لنظام Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لتحويل XLS إلى JSON باستخدام Cells Cloud SDK" gistPath="" %}}
