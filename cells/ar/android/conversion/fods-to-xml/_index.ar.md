...
{{% blocks/products/pf/agp/feature-section-col title="FODS لتحويل XML في تطبيقات Android" %}}
...
1. اتصل على ```CellsApi.cellsWorkbookGetWorkbook``` للحصول على ملف XML الناتج
