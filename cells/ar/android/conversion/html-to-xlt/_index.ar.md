...
---
{{< blocks/products/cells/cells-cloud-banner h1="تحويل HTML إلى XLT" h2="مكتبة Android لتحويل HTML إلى XLT" p="استخدم التحويل API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في مشاريع Android. يعد هذا حلاً احترافيًا لتحويل HTML إلى XLT وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Android." urlsection="conversion/html-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section title="تحويل HTML إلى XLT باستخدام Cells Cloud SDK لنظام Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز Android لتحويل HTML إلى XLT باستخدام Cells Cloud SDK" gistPath="" %}}
