---
title:  تحويل FODS إلى SVG على الروبوت
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى SVG في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
...
{{% blocks/products/pf/agp/code-autogen title="أندرويد: تحويل FODS إلى SVG" gistPath="" %}}
```java
