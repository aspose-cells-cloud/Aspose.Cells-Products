---
title:  قم بتحويل FODS إلى SVG على Android
...
url: /ar/android/conversion/fods-to-svg/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتحويل FODS إلى SVG في السحابة" h2="قم بتحويل Excel وجداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لنظام Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى SVG في تطبيقات Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: تحويل FODS إلى SVG" gistPath="" %}}
```java
