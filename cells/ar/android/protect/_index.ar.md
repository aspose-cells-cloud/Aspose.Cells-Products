---
title:  حماية ملفات Excel باستخدام Android
description:  Aspose.Cells Cloud REST API يدعم التشفير وفك التشفير وإضافة التوقيعات الرقمية إلى المصنفات باستخدام Android، ويقدم SDKs لمختلف لغات البرمجة.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="حماية ملفات Excel باستخدام Android" h2="Aspose.Cells يدعم Cloud SDK فك تشفير المصنفات وتشفيرها وتوقيعها رقميًا." p="Aspose.Cells Cloud REST API يدعم التشفير وفك التشفير وإضافة التوقيعات الرقمية إلى المصنفات باستخدام Android، ويقدم SDKs لمختلف لغات البرمجة." urlsection="protect/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells Cloud" subTitlepfName="Cells Cloud Feature" >}}

{{< blocks/products/cells/cells-cloud-card-row title="قم بحماية ملفات Excel باستخدام روابط امتداد Android" >}}
