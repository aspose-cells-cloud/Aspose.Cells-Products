...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف NUMBERS بتنسيق XML في C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# مثال على الكود لحفظ الأرقام بتنسيق XML باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية حفظ NUMBERS بتنسيق XML باستخدام مكتبة Cloud Net Cells." >}}
