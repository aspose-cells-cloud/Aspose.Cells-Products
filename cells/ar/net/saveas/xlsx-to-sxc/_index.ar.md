...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ XLSX باسم SXC" h2="مكتبة C# لحفظ XLSX كـ SXC" p="استخدم SaveAs API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في Net. يعد هذا حلاً احترافيًا لحفظ XLSX بتنسيق SXC وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام C#." urlsection="saveas/xlsx-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف XLSX باسم SXC في C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# مثال على الكود لحفظ XLSX كـ SXC باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ XLSX كـ SXC باستخدام مكتبة Cloud Net Cells." >}}
