...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف XLT كـ MD في C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# مثال على الكود لحفظ XLT كـ MD باستخدام REST API" gistPath="" %}}
