...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى MD من Excel" h2="مكتبة C# لتصدير المصنف إلى ملف MD" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي لملف Excel في Net. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق MD من جدول البيانات عبر الإنترنت باستخدام C#." urlsection="export/workbook-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن المصنف إلى ملف بتنسيق MD باستخدام Cells Cloud SDK لـ C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في C# باستخدام REST API لتصدير المصنف إلى تنسيق MD من جدول البيانات" gistPath="" %}}
