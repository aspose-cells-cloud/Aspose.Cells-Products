...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى PPTX من Excel" h2="مكتبة C# لتصدير المصنف إلى ملف PPTX" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي لملف Excel في Net. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق PPTX من جدول البيانات عبر الإنترنت باستخدام C#." urlsection="export/workbook-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن كتاب العمل إلى ملف بتنسيق PPTX باستخدام Cells Cloud SDK لـ C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في C# باستخدام REST API لتصدير المصنف إلى تنسيق PPTX من جدول البيانات" gistPath="" %}}
