...
{{< blocks/products/cells/cells-cloud-upper-banner h1="تصدير الصورة إلى WMF من Excel" h2="مكتبة C# لتصدير الصورة إلى ملف WMF" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي لملف Excel في Net. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق PICTURE إلى WMF من جدول البيانات عبر الإنترنت باستخدام C#." urlsection="export/picture-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تصدير كائن PICTURE إلى ملف بتنسيق WMF باستخدام Cells Cloud SDK لـ C#" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال على الكود في C# باستخدام REST API لتصدير الصورة إلى تنسيق WMF من جدول البيانات" gistPath="" %}}
