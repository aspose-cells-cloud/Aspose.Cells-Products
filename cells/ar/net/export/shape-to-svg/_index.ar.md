...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الشكل إلى SVG من Excel" h2="مكتبة C# لتصدير SHAPE إلى ملف SVG" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي لملف Excel في Net. يعد هذا حلاً احترافيًا لتصدير ملف SHAPE إلى تنسيق SVG من جدول البيانات عبر الإنترنت باستخدام C#." urlsection="export/shape-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن SHAPE إلى ملف تنسيق SVG باستخدام Cells Cloud SDK لـ C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في C# باستخدام REST API لتصدير SHAPE إلى تنسيق SVG من جدول البيانات" gistPath="" %}}
