...
{{< blocks/products/cells/cells-cloud-upper-banner h1="تصدير ورقة العمل إلى PPTX من Excel" h2="مكتبة C# لتصدير ورقة العمل إلى ملف PPTX" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي لملف Excel في Net. يعد هذا حلاً احترافيًا لتصدير ورقة العمل إلى ملف بتنسيق PPTX من جدول البيانات عبر الإنترنت باستخدام C#." urlsection="export/worksheet-to-pptx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تصدير كائن ورقة العمل إلى ملف بتنسيق PPTX باستخدام Cells Cloud SDK لـ C#" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال على الكود في C# باستخدام REST API لتصدير ورقة عمل إلى تنسيق PPTX من جدول البيانات" gistPath="" %}}
