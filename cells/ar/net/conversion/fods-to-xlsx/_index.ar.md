...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLSX في السحابة" h2="Excel & تحويل جدول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر for .NET" >}}
...
1. اتصل بالطريقة ```CellsApi.CellsSaveAsPostDocumentSaveAs``` للحصول على ملف XLSX الناتج
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET كود لتحويل FODS إلى XLSX" gistPath="" %}}
```cs
