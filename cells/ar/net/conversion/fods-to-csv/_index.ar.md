...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى CSV في السحابة" h2="Excel وتحويل جداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر for .NET" >}}
...
1. اتصل بطريقة ```CellsApi.CellsSaveAsPostDocumentSaveAs``` للحصول على ملف CSV الناتج
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET كود تحويل FODS إلى CSV" gistPath="" %}}
```cs
