---
title:  تحويل FODS إلى SVG via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتحويل FODS إلى SVG في السحابة" h2="Excel & تحويل جدول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى SVG في تطبيقات .NET" %}}
...
1. اتصل بالطريقة ```CellsApi.CellsSaveAsPostDocumentSaveAs``` للحصول على الملف SVG الناتج
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET كود FODS لتحويل SVG" gistPath="" %}}
```cs
