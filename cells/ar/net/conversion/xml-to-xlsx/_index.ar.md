...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تحويل XML إلى XLSX باستخدام Cells Cloud SDK لـ C#" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="C# مثال على الكود لتحويل XML إلى XLSX باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Cells Cloud SDK for Net لتحويل ملفات Excel إلى تنسيقات أخرى من XML إلى XLSX" >}}
