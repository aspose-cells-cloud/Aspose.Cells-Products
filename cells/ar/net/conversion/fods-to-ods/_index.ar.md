---
title:  تحويل FODS إلى ODS via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى ODS في السحابة" h2="Excel & تحويل جدول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى ODS في تطبيقات .NET" %}}
...
1. استدعاء طريقة ```CellsApi.CellsSaveAsPostDocumentSaveAs``` للحصول على ملف ODS الناتج
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET كود تحويل FODS إلى ODS" gistPath="" %}}
```cs
