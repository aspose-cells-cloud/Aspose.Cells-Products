---
title:  تحويل FODS إلى DIF via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى DIF في السحابة" h2="Excel وتحويل جداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى DIF في تطبيقات .NET" %}}
...
1. اتصل بطريقة ```CellsApi.CellsSaveAsPostDocumentSaveAs``` للحصول على ملف DIF الناتج
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET كود التحويل من FODS إلى DIF" gistPath="" %}}
```cs
