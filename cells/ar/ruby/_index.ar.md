---
title:  قراءة وعرض وتحويل ملفات Cloud Excel (via Ruby REST SDK)
description: يعزز تطبيقات Ruby الخاصة بك لمعالجة ومعالجة Microsoft Excel وجداول بيانات OpenOffice في السحابة
weight: 120
url: /ar/ruby
---
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-ruby.svg" alt="Ruby Excel SDK"><header>Aspose.Cells</header><footer> سحاب<small> <em> ل</em> </small>روبي</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-go.svg" alt="Ruby Cloud Excel SDK"><header>Aspose.Cells</header><footer> سحاب<small> <em> ل</em> </small>روبي</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
