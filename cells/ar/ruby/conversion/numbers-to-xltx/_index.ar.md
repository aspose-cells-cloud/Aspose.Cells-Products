...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال على رمز Ruby لتحويل NUMBERS إلى XLTX باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Cells Cloud SDK لـ Ruby لتحويل ملفات Excel إلى تنسيقات أخرى من NUMBERS إلى XLTX" >}}
