---
title:  تحويل من Excel FODS إلى XLTX via روبي
...
{{% blocks/products/pf/agp/feature-section-col title="FODS لتحويل XLTX مع روبي" %}}
...
1. اتصل بطريقة ```CellsApi.cells_save_as_post_document_save_as``` للحصول على ملف XLTX الناتج
...
{{% blocks/products/pf/agp/code-autogen title="رمز روبي لتحويل FODS إلى XLTX" gistPath="" %}}
```ruby
