---
title:  تحويل من Excel FODS إلى XLS via روبي
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLS مع روبي" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Ruby" >}}
