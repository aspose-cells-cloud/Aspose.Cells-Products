...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى HTML مع روبي" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS إلى HTML التحويل مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="كود روبي لتحويل FODS إلى HTML" gistPath="" %}}
```ruby
