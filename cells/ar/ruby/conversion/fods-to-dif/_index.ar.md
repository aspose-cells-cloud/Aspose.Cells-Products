---
title:  تحويل من Excel FODS إلى DIF via روبي
...
{{% blocks/products/pf/agp/feature-section-col title="FODS لتحويل DIF مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="رمز روبي لتحويل FODS إلى DIF" gistPath="" %}}
```ruby
