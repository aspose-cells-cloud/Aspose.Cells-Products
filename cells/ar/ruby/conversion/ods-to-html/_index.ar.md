...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تحويل ODS إلى HTML باستخدام Cells Cloud SDK لروبي" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز روبي لتحويل ODS إلى HTML باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Cells Cloud SDK لـ Ruby لتحويل ملفات Excel إلى تنسيقات أخرى ODS إلى HTML" >}}
