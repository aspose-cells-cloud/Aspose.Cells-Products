---
title:  حوّل من Excel FODS إلى SXC via ياقوت
...
{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى SXC مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="كود روبي لتحويل FODS إلى SXC" gistPath="" %}}
```ruby
