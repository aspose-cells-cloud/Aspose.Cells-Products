...
---
{{< blocks/products/cells/cells-cloud-banner h1="تحويل PNG إلى XLS" h2="مكتبة روبي لتحويل PNG إلى XLS" p="استخدم التحويل API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في مشاريع Ruby. يعد هذا حلاً احترافيًا لتحويل PNG إلى XLS وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Ruby." urlsection="conversion/png-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="تحويل PNG إلى XLS باستخدام Cells Cloud SDK لروبي" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على كود روبي لتحويل PNG إلى XLS باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية تحويل PNG إلى XLS باستخدام مكتبة Cells Cloud Ruby." >}}
