---
title:  حوّل Excel FODS إلى XLSB via ياقوت
...
{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS إلى XLSB مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="كود روبي لتحويل FODS إلى XLSB" gistPath="" %}}
```ruby
