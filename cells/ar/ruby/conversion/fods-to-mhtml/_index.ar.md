---
title:  تحويل من Excel FODS إلى MHTML via روبي
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى MHTML مع روبي" h2="قراءة وتحرير وتصدير بيانات Excel إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS لتحويل MHTML مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="رمز روبي لتحويل FODS إلى MHTML" gistPath="" %}}
```ruby
