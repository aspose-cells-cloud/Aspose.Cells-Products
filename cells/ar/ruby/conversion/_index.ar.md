---
title:  تحويل تنسيقات الملفات Excel باستخدام روبي
description:  Aspose.Cells Cloud REST API يدعم تحويل تنسيق الملف Excel باستخدام Ruby ويقدم حزم SDK للغات برمجة متعددة.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="تحويل تنسيقات الملفات Excel باستخدام روبي" h2="Aspose.Cells يدعم Cloud SDK التحويل بين أكثر من 30 تنسيقًا للملفات." p="Aspose.Cells Cloud REST API يدعم تحويل تنسيق الملف Excel باستخدام Ruby ويقدم حزم SDK للغات برمجة متعددة." urlsection="conversion/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="تحويل تنسيقات الملفات Excel باستخدام روابط Ruby Extension" >}}
