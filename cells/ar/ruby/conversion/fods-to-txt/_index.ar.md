---
title:  تحويل من Excel FODS إلى TXT via روبي
...
{{% blocks/products/pf/agp/feature-section-col title="FODS لتحويل TXT مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="كود روبي لتحويل FODS إلى TXT" gistPath="" %}}
```ruby
