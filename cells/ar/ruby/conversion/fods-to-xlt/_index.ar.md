---
title:  حوّل من Excel FODS إلى XLT via ياقوت
...
1. اتصل بالطريقة ```CellsApi.cells_save_as_post_document_save_as``` للحصول على ملف XLT الناتج
...
{{% blocks/products/pf/agp/code-autogen title="كود روبي لتحويل FODS إلى XLT" gistPath="" %}}
```ruby
