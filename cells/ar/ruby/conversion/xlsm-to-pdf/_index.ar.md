...
{{< blocks/products/cells/cells-cloud-section title="تحويل XLSM إلى PDF باستخدام Cells Cloud SDK لروبي" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على كود روبي لتحويل XLSM إلى PDF باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية تحويل XLSM إلى PDF باستخدام مكتبة Cloud Ruby Cells." >}}
