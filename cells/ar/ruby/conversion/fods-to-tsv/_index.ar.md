---
title:  تحويل من Excel FODS إلى TSV via روبي
...
{{% blocks/products/pf/agp/feature-section-col title="FODS لتحويل TSV مع روبي" %}}
...
{{% blocks/products/pf/agp/code-autogen title="رمز روبي لتحويل FODS إلى TSV" gistPath="" %}}
```ruby
