...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ XLS كـ TSV" h2="مكتبة روبي لحفظ XLS كـ TSV" p="استخدم SaveAs API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في Ruby. يعد هذا حلاً احترافيًا لحفظ XLS بتنسيق TSV وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/xls-to-tsv/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ XLS كـ TSV باستخدام مكتبة Cloud Ruby Cells." >}}
