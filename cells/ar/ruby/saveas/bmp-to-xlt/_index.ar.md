...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API لحفظ BMP كـ XLT" h2="مكتبة روبي لحفظ BMP كـ XLT" p="استخدم Cells SaveAs REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Ruby. هذا حل احترافي لحفظ BMP بتنسيق XLT وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/bmp-to-xlt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Ruby API لحفظ BMP كـ XLT" >}}
