...
<br/>
يعد حفظ تنسيقات الملفات من XLT كـ XLTM مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق XLT إلى XLTM بواسطة Ruby SDK مع الحفاظ على المحتوى الإنشائي والمنطقي الرئيسي لجدول بيانات XLT المصدر. تعد مكتبة Ruby الخاصة بنا حلاً احترافيًا لحفظ ملفات XLT كملفات XLTM عبر الإنترنت. يمنح Cloud SDK مطوري Ruby وظائف قوية وإخراج XLTM مثالي.
<br/>
<br/>
