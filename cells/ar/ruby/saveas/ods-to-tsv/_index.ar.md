---
title:  احفظ ODS كـ TSV API لـ Ruby
description:  استخدام Aspose.Cells Cloud SDK لـ Ruby لحفظ ملف بتنسيق ODS كملف بتنسيق TSV.
url: /ar/ruby/saveas/ods-to-tsv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API لحفظ المواد المستنفدة للأوزون كملف TSV" h2="مكتبة روبي لحفظ ODS كملف TSV" p="استخدم Cells SaveAs REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Ruby. هذا حل احترافي لحفظ ODS بتنسيق TSV وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/ods-to-tsv/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Ruby API لحفظ ODS كـ TSV" >}}
