...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API لحفظ XML كـ DIF" h2="مكتبة روبي لحفظ XML كـ DIF" p="استخدم Cells SaveAs REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Ruby. هذا حل احترافي لحفظ XML بتنسيق DIF وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/xml-to-dif/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Ruby API لحفظ XML كـ DIF" >}}
