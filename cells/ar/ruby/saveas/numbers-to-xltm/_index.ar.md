---
title:  احفظ الأرقام باسم XLTM API لروبي
description:  استخدام Aspose.Cells Cloud SDK لـ Ruby لحفظ ملف بتنسيق NUMBERS كملف بتنسيق XLTM.
url: /ar/ruby/saveas/numbers-to-xltm/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API لحفظ الأرقام كـ XLTM" h2="مكتبة روبي لحفظ الأرقام كـ XLTM" p="استخدم Cells SaveAs REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Ruby. هذا حل احترافي لحفظ NUMBERS بتنسيق XLTM وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/numbers-to-xltm/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Ruby API لحفظ الأرقام كـ XLTM" >}}
