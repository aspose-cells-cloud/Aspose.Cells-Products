...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ SXC كمواد مستنفدة للأوزون" h2="مكتبة روبي لحفظ SXC كمواد مستنفدة للأوزون" p="استخدم SaveAs API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في Ruby. يعد هذا حلاً احترافيًا لحفظ SXC كملف ODS وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/sxc-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف SXC كملف ODS في Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على كود روبي لحفظ SXC كمواد مستنفدة للأوزون باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ SXC كمواد مستنفدة للأوزون باستخدام مكتبة Cloud Ruby Cells." >}}
