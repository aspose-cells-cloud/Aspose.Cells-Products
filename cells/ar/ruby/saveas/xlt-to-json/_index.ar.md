...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API لحفظ XLT كـ JSON" h2="مكتبة Ruby لحفظ XLT كـ JSON" p="استخدم Cells SaveAs REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Ruby. هذا حل احترافي لحفظ XLT بتنسيق JSON وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/xlt-to-json/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Ruby API لحفظ XLT كـ JSON" >}}
