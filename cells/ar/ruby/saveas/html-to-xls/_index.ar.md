...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API لحفظ HTML كـ XLS" h2="مكتبة روبي لحفظ HTML كـ XLS" p="استخدم Cells SaveAs REST API لإنشاء مسارات عمل جدول بيانات مخصصة في Ruby. هذا حل احترافي لحفظ HTML بتنسيق XLS وتنسيقات مستندات أخرى عبر الإنترنت باستخدام Ruby." urlsection="saveas/html-to-xls/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Ruby API لحفظ HTML كـ XLS" >}}
