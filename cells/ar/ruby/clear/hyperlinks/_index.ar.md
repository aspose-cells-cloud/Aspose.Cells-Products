...
url: /ar/ruby/clear/hyperlinks/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="روبي API لمسح الارتباطات التشعبية الموجودة على جدول بيانات Microsoft Excel المحلي و OpenOffice Calc" h2="روبي مسح لمسح الارتباطات التشعبية على جدول بيانات Microsoft Excel المحلي و OpenOffice Calc" p="استخدم Cells مسح REST API لمسح الارتباطات التشعبية على Excel Microsoft المحلي و OpenOffice Calc جداول سير عمل جداول البيانات في Ruby. يقوم هذا الحل الاحترافي بإزالة الارتباطات التشعبية على Microsoft Excel المحلي وجدول بيانات OpenOffice Calc باستخدام Ruby." urlsection="clear/Hyperlinks/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title=" كيفية استخدام Ruby API لمسح الارتباطات التشعبية" >}}
