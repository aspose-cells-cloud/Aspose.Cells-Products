...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الصورة إلى GIF من Excel" h2="مكتبة روبي لتصدير الصورة إلى ملف GIF" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق PICTURE إلى GIF من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/picture-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="قم بتصدير كائن PICTURE إلى ملف بتنسيق GIF باستخدام Cells Cloud SDK لـ Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في روبي باستخدام REST API لتصدير الصورة إلى تنسيق GIF من جدول البيانات" gistPath="" %}}
