...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير ورقة العمل إلى CSV من Excel" h2="مكتبة روبي لتصدير ورقة العمل إلى ملف CSV" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير ورقة العمل إلى ملف بتنسيق CSV من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/worksheet-to-csv/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن ورقة العمل إلى ملف بتنسيق CSV باستخدام Cells Cloud SDK لروبي" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في روبي باستخدام REST API لتصدير ورقة عمل إلى تنسيق CSV من جدول البيانات" gistPath="" %}}
