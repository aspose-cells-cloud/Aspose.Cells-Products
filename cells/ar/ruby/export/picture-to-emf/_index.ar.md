...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الصورة إلى EMF من Excel" h2="مكتبة روبي لتصدير الصورة إلى ملف EMF" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق PICTURE إلى EMF من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/picture-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن PICTURE إلى ملف بتنسيق EMF باستخدام Cells Cloud SDK لروبي" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال التعليمات البرمجية في روبي باستخدام REST API لتصدير الصورة إلى تنسيق EMF من جدول البيانات" gistPath="" %}}
