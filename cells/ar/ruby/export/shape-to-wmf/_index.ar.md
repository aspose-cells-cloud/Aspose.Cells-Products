...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير SHAPE إلى WMF من Excel" h2="مكتبة روبي لتصدير SHAPE إلى ملف WMF" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق SHAPE إلى WMF من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/shape-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="قم بتصدير كائن SHAPE إلى ملف بتنسيق WMF باستخدام Cells Cloud SDK لـ Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال التعليمات البرمجية في روبي باستخدام REST API لتصدير SHAPE إلى تنسيق WMF من جدول البيانات" gistPath="" %}}
