...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الشكل إلى SVG من Excel" h2="مكتبة روبي لتصدير SHAPE إلى ملف SVG" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير ملف بتنسيق SHAPE إلى SVG من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/shape-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن SHAPE إلى ملف بتنسيق SVG باستخدام Cells Cloud SDK لـ Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في روبي باستخدام REST API لتصدير SHAPE إلى تنسيق SVG من جدول البيانات" gistPath="" %}}
