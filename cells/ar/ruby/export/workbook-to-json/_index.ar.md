...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى JSON من Excel" h2="مكتبة روبي لتصدير المصنف إلى ملف JSON" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق JSON من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/workbook-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن WORKBOOK إلى ملف بتنسيق JSON باستخدام Cells Cloud SDK لـ Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في روبي باستخدام REST API لتصدير المصنف إلى تنسيق JSON من جدول البيانات" gistPath="" %}}
