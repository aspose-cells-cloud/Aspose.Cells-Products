...
{{< blocks/products/cells/cells-cloud-upper-banner h1="تصدير LISTOBJECT إلى CSV من Excel" h2="مكتبة روبي لتصدير LISTOBJECT إلى ملف CSV" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير ملف LISTOBJECT إلى ملف بتنسيق CSV من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/listobject-to-csv/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تصدير كائن LISTOBJECT إلى ملف بتنسيق CSV باستخدام Cells Cloud SDK لـ Ruby" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال التعليمات البرمجية في روبي باستخدام REST API لتصدير LISTOBJECT إلى تنسيق CSV من جدول البيانات" gistPath="" %}}
