...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى DOCX من Excel" h2="مكتبة روبي لتصدير WORKBOOK إلى ملف DOCX" p="استخدم تصدير API من Cells Cloud لتصدير Excel سير عمل الكائن الداخلي في Ruby. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق DOCX من جدول البيانات عبر الإنترنت باستخدام Ruby." urlsection="export/workbook-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن WORKBOOK إلى ملف بتنسيق DOCX باستخدام Cells Cloud SDK لـ Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في Ruby باستخدام REST API لتصدير WORKBOOK إلى تنسيق DOCX من جدول البيانات" gistPath="" %}}
