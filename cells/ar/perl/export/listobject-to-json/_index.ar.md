...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير LISTOBJECT إلى JSON من Excel" h2="مكتبة Perl لتصدير LISTOBJECT إلى ملف JSON" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Perl. هذا حل احترافي لتصدير LISTOBJECT إلى ملف بتنسيق JSON من جدول البيانات عبر الإنترنت باستخدام Perl." urlsection="export/listobject-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن LISTOBJECT إلى ملف بتنسيق JSON باستخدام Cells Cloud SDK لـ Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في Perl باستخدام REST API لتصدير LISTOBJECT إلى تنسيق JSON من جدول البيانات" gistPath="" %}}
