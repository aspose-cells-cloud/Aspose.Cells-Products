...
<br/>
يعد حفظ تنسيقات الملفات من XLTX كـ XLT مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق XLTX إلى XLT بواسطة Perl SDK مع الحفاظ على المحتوى الإنشائي والمنطقي الرئيسي لجدول بيانات XLTX المصدر. تعتبر مكتبة Perl الخاصة بنا حلاً احترافيًا لحفظ XLTX كملفات XLT عبر الإنترنت. يوفر Cloud SDK للمطورين Perl وظائف قوية وإخراج XLT مثالي.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز في Perl باستخدام REST API لحفظ XLTX بتنسيق XLT" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Perl API لحفظ XLTX كـ XLT" >}}
