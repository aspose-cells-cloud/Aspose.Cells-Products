...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS باسم MD في Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl مثال رمزي لحفظ المواد المستنفدة للأوزون كـ MD باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ المواد المستنفدة للأوزون كـ MD باستخدام مكتبة Cells Cloud Perl." >}}
