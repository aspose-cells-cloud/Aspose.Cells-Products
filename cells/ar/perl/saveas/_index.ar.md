---
title:  حفظ باستخدام Perl
description:  Aspose.Cells Cloud REST API يدعم حفظ ملفات Excel كأنواع من ملفات التنسيق باستخدام Perl. SDK يدعم لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift.
url: /ar/perl/saveas/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="حفظ باستخدام Perl" h2="Aspose.Cells Cloud SDK يدعم حفظ المصنفات كتنسيقات أخرى. تحتوي تنسيقات الملفات المدعومة على أكثر من 30 تنسيقًا للملفات." p="Aspose.Cells Cloud REST API يدعم حفظ ملفات Excel كأنواع من ملفات التنسيق باستخدام Perl. SDK يدعم لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="احفظ باستخدام Perl وصلات الامتداد" >}}
