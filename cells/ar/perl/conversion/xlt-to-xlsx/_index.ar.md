...
<br/>
يعد تحويل تنسيقات الملفات من XLT إلى XLSX مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق XLT إلى XLSX بواسطة Perl SDK مع الحفاظ على المحتوى الإنشائي والمنطقي الرئيسي لجدول بيانات XLT المصدر. تعد مكتبتنا Perl حلاً احترافيًا لتحويل ملفات XLT إلى XLSX عبر الإنترنت. يوفر Cloud SDK للمطورين Perl وظائف قوية وإخراج XLSX مثالي.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز في Perl باستخدام REST API لتحويل XLT إلى تنسيق XLSX" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Perl API لتحويل XLT إلى XLSX" >}}
