---
title:  تحويل FODS إلى XLTM في السحابة via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتحويل FODS إلى XLTM باستخدام Java" h2="أتمتة Excel وتحويل ملف OpenOffice باستخدام Cloud SDK مفتوح المصدر for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="بسيط لتحويل FODS إلى XLTM" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java كود لتحويل FODS إلى XLTM" gistPath="" %}}
```java
