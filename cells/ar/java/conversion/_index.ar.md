---
title:  التحويل باستخدام Java
description:  Aspose.Cells Cloud REST API يدعم تحويل ملفات Excel إلى أنواع مختلفة من ملفات التنسيق باستخدام Java. SDK يدعم لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift.
url: /ar/java/conversion/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="التحويل باستخدام Java" h2="Aspose.Cells Cloud SDK يدعم تحويل تنسيق الملف. يحتوي تنسيق الملف المدعوم على أكثر من 30 تنسيقًا للملفات." p="Aspose.Cells Cloud REST API يدعم تحويل ملفات Excel إلى أنواع مختلفة من ملفات التنسيق باستخدام Java. SDK يدعم لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift." urlsection="conversion/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="التحويل باستخدام Java وصلات الامتداد" >}}
