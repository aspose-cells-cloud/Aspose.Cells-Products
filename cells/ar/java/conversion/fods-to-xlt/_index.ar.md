...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLT مع Java" h2="أتمتة Excel وتحويل ملفات OpenOffice باستخدام Cloud SDK مفتوح المصدر for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل FODS بسيط إلى XLT" %}}
...
1. اتصل بالرقم ```CellsApi.cellsWorkbookGetWorkbook``` للحصول على ملف XLT الناتج
...
{{% blocks/products/pf/agp/code-autogen title="Java كود تحويل FODS إلى XLT" gistPath="" %}}
```java
