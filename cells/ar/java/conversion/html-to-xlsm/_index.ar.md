...
---
{{< blocks/products/cells/cells-cloud-banner h1="تحويل HTML إلى XLSM" h2="مكتبة Java لتحويل HTML إلى XLSM" p="استخدم التحويل API من Cells Cloud لإنشاء سير عمل جدول بيانات مخصص في مشاريع Java. يعد هذا حلاً احترافيًا لتحويل HTML إلى XLSM وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Java." urlsection="conversion/html-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="تحويل HTML إلى XLSM باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java مثال على الكود لتحويل HTML إلى XLSM باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="تعرف على كيفية تحويل HTML إلى XLSM باستخدام مكتبة Cells Cloud Java." >}}
