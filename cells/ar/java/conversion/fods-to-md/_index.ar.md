...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى MD مع Java" h2="أتمتة Excel وتحويل ملف OpenOffice باستخدام Cloud SDK مفتوح المصدر for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="بسيط FODS لتحويل MD" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java كود لتحويل FODS إلى MD" gistPath="" %}}
```java
