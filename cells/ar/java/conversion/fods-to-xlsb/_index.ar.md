...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى XLSB مع Java" h2="أتمتة Excel وتحويل ملفات OpenOffice باستخدام Cloud SDK مفتوح المصدر for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS بسيط لتحويل XLSB" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java كود تحويل FODS إلى XLSB" gistPath="" %}}
```java
