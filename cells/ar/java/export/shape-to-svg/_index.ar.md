...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الشكل إلى SVG من Excel" h2="مكتبة Java لتصدير SHAPE إلى ملف SVG" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. يعد هذا حلاً احترافيًا لتصدير SHAPE إلى ملف بتنسيق SVG من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/shape-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن SHAPE إلى ملف بتنسيق SVG باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في Java باستخدام REST API لتصدير SHAPE إلى تنسيق SVG من جدول البيانات" gistPath="" %}}
