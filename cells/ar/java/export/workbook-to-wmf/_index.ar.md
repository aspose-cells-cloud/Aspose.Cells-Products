...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى WMF من Excel" h2="مكتبة Java لتصدير المصنف إلى ملف WMF" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق WMF من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/workbook-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن المصنف إلى ملف بتنسيق WMF باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في Java باستخدام REST API لتصدير المصنف إلى تنسيق WMF من جدول البيانات" gistPath="" %}}
