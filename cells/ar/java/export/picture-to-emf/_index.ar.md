...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير الصورة إلى EMF من Excel" h2="مكتبة Java لتصدير الصور إلى ملف EMF" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. هذا حل احترافي لتصدير PICTURE إلى ملف بتنسيق EMF من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/picture-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن PICTURE إلى ملف بتنسيق EMF باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في Java باستخدام REST API لتصدير الصورة إلى تنسيق EMF من جدول البيانات" gistPath="" %}}
