...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى TXT من Excel" h2="مكتبة Java لتصدير المصنف إلى ملف TXT" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق TXT من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/workbook-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن كتاب العمل إلى ملف بتنسيق TXT باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في Java باستخدام REST API لتصدير المصنف إلى تنسيق TXT من جدول البيانات" gistPath="" %}}
