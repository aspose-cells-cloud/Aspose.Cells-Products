...
{{< blocks/products/cells/cells-cloud-upper-banner h1="تصدير LISTOBJECT إلى DOCX من Excel" h2="مكتبة Java لتصدير LISTOBJECT إلى ملف DOCX" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. هذا حل احترافي لتصدير LISTOBJECT إلى ملف بتنسيق DOCX من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/listobject-to-docx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تصدير كائن LISTOBJECT إلى ملف بتنسيق DOCX باستخدام Cells Cloud SDK for Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال على الكود في Java باستخدام REST API لتصدير LISTOBJECT إلى تنسيق DOCX من جدول البيانات" gistPath="" %}}
