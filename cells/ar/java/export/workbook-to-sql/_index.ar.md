...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى SQL من Excel" h2="مكتبة Java لتصدير المصنف إلى ملف SQL" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. يعد هذا حلاً احترافيًا لتصدير المصنف إلى ملف بتنسيق SQL من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/workbook-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن المصنف إلى ملف تنسيق SQL باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في Java باستخدام REST API لتصدير المصنف إلى تنسيق SQL من جدول البيانات" gistPath="" %}}
