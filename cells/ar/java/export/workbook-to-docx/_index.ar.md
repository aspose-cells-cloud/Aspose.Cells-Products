...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى DOCX من Excel" h2="مكتبة Java لتصدير المصنف إلى ملف DOCX" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق DOCX من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/workbook-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن WORKBOOK إلى ملف بتنسيق DOCX باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على التعليمات البرمجية في Java باستخدام REST API لتصدير WORKBOOK إلى تنسيق DOCX من جدول البيانات" gistPath="" %}}
