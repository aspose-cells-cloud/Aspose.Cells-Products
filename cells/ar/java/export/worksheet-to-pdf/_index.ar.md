...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير ورقة عمل إلى PDF من Excel" h2="مكتبة Java لتصدير ورقة العمل إلى ملف PDF" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في Java. يعد هذا حلاً احترافيًا لتصدير ورقة العمل إلى ملف بتنسيق PDF من جدول البيانات عبر الإنترنت باستخدام Java." urlsection="export/worksheet-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن ورقة العمل إلى ملف بتنسيق PDF باستخدام Cells Cloud SDK for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على الكود في Java باستخدام REST API لتصدير ورقة العمل إلى تنسيق PDF من جدول البيانات" gistPath="" %}}
