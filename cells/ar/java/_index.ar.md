---
title:  إنشاء وتعديل Excel جداول البيانات في السحابة (Java REST SDK)
...
{{< blocks/products/pf/i18n/upper-banner h1="Java SDK لإنشاء وتعديل Excel الملفات via REST API" h2="يوفر تكاملاً سلسًا لميزات معالجة جداول بيانات Excel و OpenOffice في تطبيقات Java المستندة إلى السحابة." logoImageSrc="/headers/aspose_cells-for-java.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Java" downloadUrl="" >}}
...
<p>يسمح لبرنامج Java الخاص بك بإنشاء مصنف Excel من قالب علامة ذكية. دمج ، وتقسيم ، وتشفير ، وفك تشفير ، وتطبيق كلمة مرور على مصنفات Excel في السحابة. احسب جميع الصيغ في مصنف باستخدام رمز Java السهل via cloud SDK.</p>
<p>باستخدام Aspose.Cells Cloud SDK for Java ، ستكون قادرًا على استخراج الرموز الشريطية من صورة ورقة العمل باستخدام إرشادات بسيطة Java ، وتطبيق أنواع مختلفة من المرشحات (مرشح التاريخ ، عامل تصفية الأيقونة الديناميكي) في ورقة عمل ، والعمل مع كل الصفوف والأعمدة والخلايا الفردية أو في ورقة عمل.</p>
<p>يمكنك أيضًا العمل باستخدام المخططات Microsoft Excel ، والتنسيق الشرطي ، والارتباطات التشعبية ، و ListObjets ، و OleObjects ، وفواصل الصفحات ، وإعداد الصفحة ، والصور ، والجداول المحورية ، وإدارة الملفات والمجلدات السحابية.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-java.svg" alt="Excel Java SDK"><header>Aspose.Cells</header><footer> سحاب<small> <em> ل</em> </small>Java</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-java.svg" alt="Excel Java SDK"><header>Aspose.Cells</header><footer> سحاب<small> <em> ل</em> </small>يذهب</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
حذف ListObjects معينة أو كلها في ورقة العمل
 ...
 ابدأ مع Excel SDK لمعالجة جداول البيانات
    ...
    <p>
 لبدء استخدام Aspose.Cells Cloud SDK for Java ، لا تحتاج إلى تثبيت أي شيء. كل ما عليك فعله هو إنشاء حساب على
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose للسحابة
     </a>
واحصل على معلومات التطبيق الخاص بك. بمجرد حصولك على التطبيق SID & amp؛ المفتاح ، فأنت جاهز لاستخدام Aspose.Cells Cloud SDK for Java على أي نظام أساسي يدعم واجهات برمجة تطبيقات REST. توفر لك Aspose.Cells Cloud SDK for Java كل الميزات لإنشاء جداول البيانات وتحريرها وتحويلها. كما يسمح لك باستخراج البيانات من جداول البيانات لمزيد من المعالجة أو التخزين.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
باستخدام Aspose.Cells Cloud SDK for Java ، يمكنك حذف صف معين أو جميع الصفوف في ورقة العمل ، أو جلب بيانات خلية ورقة العمل أو نمط الخلية حسب اسم الخلية ، أو قراءة صف ورقة العمل أو بيانات العمود بواسطة فهرسها ، وحساب صيغة الخلية ، ومسح محتويات الخلية ، ونسخ خلية إلى أخرى الخلية ، ونسخ أعمدة وصفوف ورقة العمل ، وتجميع صفوف وأعمدة ورقة العمل ، وإخفاء صفوف وأعمدة ورقة العمل ، وتعيين أنماط أعمدة وصفوف ورقة العمل ، وتعيين قيمة HTMLSTRING في الخلية ، وتعيين قيمة نطاق الخلية وتعديل الكثير من إعدادات ورقة العمل الأخرى.
 ...
 الاستفادة من قوة الجداول المحورية & amp؛ نطاقات
    ...
    <p>
 Aspose.Cells Cloud SDK for Java يسمح لك بإضافة جدول محوري إلى ورقة العمل ، وإضافة أو حذف الحقول المحورية في الجدول المحوري ، وإضافة أو إزالة عامل التصفية المحوري لفهرس الجدول المحوري ، وتحديث نمط الخلية للجدول المحوري ، وحساب بيانات الجدول المحوري إلى الخلايا.
    </p>
    <p>
يمكن أيضًا استخدام Aspose.Cells Cloud SDK for Java للحصول على قائمة الخلايا في نطاق حسب اسم النطاق أو فهارس أعمدة الصف ، وتعيين عرض النطاق للعمود ، ودمج نطاق من الخلايا في خلية واحدة ، ونقل النطاق الحالي إلى نطاق الوجهة ، وتحديد الخطوط العريضة حد حول نطاق من الخلايا. ، قم بتعيين ارتفاع الصف من النطاق ، وتعيين نمط النطاق ، وإلغاء دمج الخلايا المدمجة في هذا النطاق ، ووضع قيمة في النطاق وتحويل نوع بياناته ، ونسخ النطاق في ورقة العمل.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Cells Cloud SDK for Java؟" tabId="success-stories" >}}
