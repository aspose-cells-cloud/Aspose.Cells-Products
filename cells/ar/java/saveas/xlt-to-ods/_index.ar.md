...
<br/>
يعد حفظ تنسيقات الملفات من XLT مثل ODS مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق XLT إلى ODS بواسطة Java SDK مع الحفاظ على المحتوى الإنشائي والمنطقي الرئيسي لجدول بيانات XLT المصدر. مكتبتنا Java هي حل احترافي لحفظ XLT كملفات ODS عبر الإنترنت. يوفر Cloud SDK للمطورين Java وظائف قوية وإخراج ODS مثالي.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال رمز في Java باستخدام REST API لحفظ XLT كتنسيق ODS" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Java API لحفظ XLT كـ ODS" >}}
