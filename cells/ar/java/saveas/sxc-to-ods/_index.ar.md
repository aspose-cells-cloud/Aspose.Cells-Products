...
---
{{< blocks/products/cells/cells-cloud-banner h1="احفظ SXC كمواد مستنفدة للأوزون" h2="مكتبة Java لحفظ SXC كمواد مستنفدة للأوزون" p="استخدم SaveAs API من Cells Cloud لإنشاء سير عمل جداول بيانات مخصصة في Java. يعد هذا حلاً احترافيًا لحفظ SXC كملف ODS وتنسيقات المستندات الأخرى عبر الإنترنت باستخدام Java." urlsection="saveas/sxc-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="احفظ ملف SXC بتنسيق ODS في Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java مثال على الكود لحفظ SXC كمواد مستنفدة للأوزون باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ SXC كمواد مستنفدة للأوزون باستخدام مكتبة Cells Cloud Java." >}}
