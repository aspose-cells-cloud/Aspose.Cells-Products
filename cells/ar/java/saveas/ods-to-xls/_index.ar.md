...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS بتنسيق XLS في Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java مثال على الكود لحفظ ODS بصيغة XLS باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ المواد المستنفدة للأوزون بتنسيق XLS باستخدام مكتبة Cells Cloud Java." >}}
