...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير ورقة عمل إلى ODS من Excel" h2="مكتبة NodeJS لتصدير ورقة العمل إلى ملف ODS" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في NodeJS. يعد هذا حلاً احترافيًا لتصدير ورقة العمل إلى ملف بتنسيق ODS من جدول البيانات عبر الإنترنت باستخدام NodeJS." urlsection="export/worksheet-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن ورقة العمل إلى ملف تنسيق ODS باستخدام Cells Cloud SDK لـ NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في NodeJS باستخدام REST API لتصدير ورقة عمل إلى تنسيق ODS من جدول البيانات" gistPath="" %}}
