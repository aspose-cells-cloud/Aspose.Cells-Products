...
---
{{< blocks/products/cells/cells-cloud-banner h1="تصدير المصنف إلى TXT من Excel" h2="مكتبة NodeJS لتصدير WORKBOOK إلى ملف TXT" p="استخدم تصدير API من Cells Cloud لتصدير سير عمل الكائن الداخلي للملف Excel في NodeJS. يعد هذا حلاً احترافيًا لتصدير WORKBOOK إلى ملف بتنسيق TXT من جدول البيانات عبر الإنترنت باستخدام NodeJS." urlsection="export/workbook-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="تصدير كائن WORKBOOK إلى ملف بتنسيق TXT باستخدام Cells Cloud SDK لـ NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال للتعليمات البرمجية في NodeJS باستخدام REST API لتصدير WORKBOOK إلى تنسيق TXT من جدول البيانات" gistPath="" %}}
