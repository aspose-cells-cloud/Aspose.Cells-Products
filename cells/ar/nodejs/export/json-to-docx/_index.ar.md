...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تصدير JSON إلى ملف DOCX في السحابة" h2="Excel وتصدير جداول بيانات OpenOffice باستخدام Cloud SDK مفتوح المصدر لـ NodeJS" >}}
...
{{% blocks/products/pf/agp/code-autogen title="رمز NodeJS لتحويل JSON إلى DOCX" gistPath="" %}}
```js
