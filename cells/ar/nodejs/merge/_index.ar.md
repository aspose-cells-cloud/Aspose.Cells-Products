---
title:  دمج ملفات Excel باستخدام NodeJS
description:  Aspose.Cells Cloud REST API يدعم دمج ملفات Excel المتعددة في ملف Excel واحد باستخدام NodeJS، ويقدم مجموعات SDK للغات البرمجة المختلفة.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="دمج ملفات Excel باستخدام NodeJS" h2="يدعم Aspose.Cells Cloud SDK دمج ملفات Excel المتعددة في ملف Excel واحد." p="Aspose.Cells Cloud REST API يدعم دمج ملفات Excel المتعددة في ملف Excel واحد باستخدام NodeJS، ويقدم مجموعات SDK للغات البرمجة المختلفة." urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="دمج ملفات Excel باستخدام روابط ملحق NodeJS" >}}
