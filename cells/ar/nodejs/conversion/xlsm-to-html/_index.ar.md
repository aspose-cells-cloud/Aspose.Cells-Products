...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="تحويل XLSM إلى HTML باستخدام Cells Cloud SDK لـ NodeJS" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="مثال على رمز NodeJS لتحويل XLSM إلى HTML باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Cells Cloud SDK للعقدة لتحويل ملفات Excel إلى تنسيقات أخرى XLSM إلى HTML" >}}
