...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على كود NodeJS لتحويل الأرقام إلى XPS باستخدام Cells Cloud SDK" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية تحويل الأرقام إلى XPS باستخدام مكتبة Cells Cloud NodeJS." >}}
