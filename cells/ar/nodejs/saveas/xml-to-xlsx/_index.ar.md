...
description: استخدام Aspose.Cells Cloud SDK لـ NodeJS لحفظ ملف تنسيق XML كملف بتنسيق XLSX.
...
<br/>
يعد حفظ تنسيقات الملفات من XML كـ XLSX مهمة معقدة. يتم تنفيذ جميع انتقالات تنسيق XML إلى XLSX بواسطة NodeJS SDK مع الحفاظ على المحتوى الإنشائي والمنطقي الرئيسي لجدول بيانات XML المصدر. مكتبة NodeJS الخاصة بنا هي حل احترافي لحفظ XML كملفات XLSX عبر الإنترنت. يمنح Cloud SDK مطوري NodeJS وظائف قوية وإخراج XLSX مثالي.
<br/>
<br/>
