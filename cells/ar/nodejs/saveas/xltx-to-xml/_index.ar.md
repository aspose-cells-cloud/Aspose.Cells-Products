...
{{< blocks/products/cells/cells-cloud-upper-banner h1="NodeJS API لحفظ XLTX على هيئة XML" h2="مكتبة NodeJS لحفظ XLTX بتنسيق XML" p="استخدم Cells SaveAs REST API لتكوين مسارات عمل جدول بيانات مهيأة في NodeJS. هذا حل احترافي لحفظ XLTX بتنسيق XML وتنسيقات مستندات أخرى عبر الإنترنت باستخدام NodeJS." urlsection="saveas/xltx-to-xml/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية استخدام Node API لحفظ XLTX على هيئة XML" >}}
