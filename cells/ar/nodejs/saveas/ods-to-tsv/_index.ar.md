...
{{< blocks/products/cells/cells-cloud-section title="احفظ ملف ODS بتنسيق TSV في NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="مثال على رمز NodeJS لحفظ المواد المستنفدة للأوزون كـ TSV باستخدام REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="كيفية حفظ المواد المستنفدة للأوزون كـ TSV باستخدام مكتبة Cloud NodeJS Cells." >}}
