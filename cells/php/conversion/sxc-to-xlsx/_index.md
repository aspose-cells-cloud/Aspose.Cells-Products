---
title: Convert SXC to XLSX in the Cloud via PHP 
...
outformat: XLSX
platform: PHP
otherformats: FODS XLT XLTX XML XLSB TXT SXC MD TIFF PDF HTML XPS CSV XLSM XLSX TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert SXC to XLSX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for SXC to XLSX Conversion" gistPath="" %}}
```php
