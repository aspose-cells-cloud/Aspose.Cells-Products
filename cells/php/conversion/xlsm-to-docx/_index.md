---
title: Convert XLSM to DOCX via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to  DOCX in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to DOCX Conversion in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSM to DOCX Conversion" gistPath="" %}}
```php
