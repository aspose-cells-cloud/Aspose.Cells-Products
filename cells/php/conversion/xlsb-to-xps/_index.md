...
outformat: XPS
platform: PHP
otherformats: XLSX TSV XLTM MD DIF SXC XLTX TXT ODS HTML CSV PDF XML FODS MHTML TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSB to XPS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSB to XPS Conversion" gistPath="" %}}
```php
