---
title: Convert HTML to XLSX in the Cloud via PHP 
...
outformat: XLSX
platform: PHP
otherformats: MHTML XLSX XLSB XLTX TIFF PDF CSV SVG XML XLSM XPS TXT XLTM FODS DIF TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XLSX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert HTML to XLSX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for HTML to XLSX Conversion" gistPath="" %}}
```php
