...
outformat: MHTML
platform: PHP
otherformats: TSV XLSM XML SXC MD XLT ODS TXT TIFF HTML MHTML XLSB SVG FODS XLSX XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to MHTML with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert CSV to MHTML via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for CSV to MHTML Conversion" gistPath="" %}}
```php
