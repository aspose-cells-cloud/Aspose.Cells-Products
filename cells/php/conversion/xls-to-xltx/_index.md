---
title: Convert XLS to XLTX in the Cloud via PHP 
...
outformat: XLTX
platform: PHP
otherformats: HTML XLTM MHTML XLSM TSV ODS TXT TIFF FODS DIF SXC XLSX MD CSV SVG PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLTX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to XLTX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLS to XLTX Conversion" gistPath="" %}}
```php
