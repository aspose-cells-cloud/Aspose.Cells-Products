---
title: Convert XLS to CSV in the Cloud via PHP 
...
outformat: CSV
platform: PHP
otherformats: MD ODS DIF SVG XLSX CSV XLTM PDF XLTX SXC TXT XLSB XML XLSM HTML MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to CSV with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to CSV via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLS to CSV Conversion" gistPath="" %}}
```php
