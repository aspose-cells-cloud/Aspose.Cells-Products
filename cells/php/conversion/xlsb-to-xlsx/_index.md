---
title: Convert XLSB to XLSX in the Cloud via PHP 
...
outformat: XLSX
platform: PHP
otherformats: XML XLT XLSX DIF PDF FODS XLSM XLTX MHTML TIFF MD TSV XLTM CSV XPS TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLSX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSB to XLSX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSB to XLSX Conversion" gistPath="" %}}
```php
