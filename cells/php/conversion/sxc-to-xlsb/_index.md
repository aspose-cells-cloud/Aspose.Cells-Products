---
title: Convert SXC to XLSB in the Cloud via PHP 
...
outformat: XLSB
platform: PHP
otherformats: XLT XLTX MHTML XLS XML TIFF XLSB PDF XLSM TSV ODS XLTM FODS MD TXT CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSB with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert SXC to XLSB via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for SXC to XLSB Conversion" gistPath="" %}}
```php
