---
title: Convert XLS to XLSX in the Cloud via PHP 
...
outformat: XLSX
platform: PHP
otherformats: XLSM XPS CSV SVG MHTML XLSB TSV PDF XLTX TIFF SXC FODS DIF MD TXT XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to XLSX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLS to XLSX Conversion" gistPath="" %}}
```php
