---
title: Convert XLTX to FODS in the Cloud via PHP 
...
outformat: FODS
platform: PHP
otherformats: XLT PDF XLSX HTML XLSB DIF TIFF MHTML MD SVG XLTM TSV TXT XLSM ODS FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to FODS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLTX to FODS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLTX to FODS Conversion" gistPath="" %}}
```php
