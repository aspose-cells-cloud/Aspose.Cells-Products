---
title: Convert XLSX to XPS in the Cloud via PHP 
...
outformat: XPS
platform: PHP
otherformats: PDF FODS SXC HTML SVG MHTML TIFF XLTX XML TXT XLTM XLS CSV DIF TSV XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSX to XPS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSX to XPS Conversion" gistPath="" %}}
```php
