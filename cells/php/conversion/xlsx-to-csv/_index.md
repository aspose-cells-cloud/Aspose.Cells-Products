---
title: Convert XLSX to CSV in the Cloud via PHP 
...
outformat: CSV
platform: PHP
otherformats: TXT ODS MD MHTML XLS TIFF TSV XLTX DIF XLTM FODS SXC XLSB XML CSV SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to CSV with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSX to CSV via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSX to CSV Conversion" gistPath="" %}}
```php
