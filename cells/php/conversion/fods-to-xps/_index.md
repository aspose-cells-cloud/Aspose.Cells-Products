...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert FODS to XPS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for FODS to XPS Conversion" gistPath="" %}}
```php
