---
title: Convert XLSX to TSV in the Cloud via PHP 
...
outformat: TSV
platform: PHP
otherformats: XPS FODS TIFF XML CSV SXC XLSM XLTM TSV TXT SVG PDF MD MHTML DIF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to TSV with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSX to TSV via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSX to TSV Conversion" gistPath="" %}}
```php
