---
title: Convert JSON to XLS via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JSON to  XLS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JSON to XLS Conversion in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for JSON to XLS Conversion" gistPath="" %}}
```php
