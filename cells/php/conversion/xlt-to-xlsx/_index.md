---
title: Convert XLT to XLSX in the Cloud via PHP 
...
outformat: XLSX
platform: PHP
otherformats: TXT SXC PDF ODS XLTX CSV XPS XML TIFF MD SVG XLSX FODS XLSB DIF TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to XLSX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLT to XLSX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLT to XLSX Conversion" gistPath="" %}}
```php
