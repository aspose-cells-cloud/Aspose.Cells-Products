---
title: Convert XLSB to FODS in the Cloud via PHP 
...
outformat: FODS
platform: PHP
otherformats: XPS XLTX XLSX TIFF CSV XLSM SXC MD PDF HTML XLTM DIF ODS TXT TSV SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to FODS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSB to FODS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSB to FODS Conversion" gistPath="" %}}
```php
