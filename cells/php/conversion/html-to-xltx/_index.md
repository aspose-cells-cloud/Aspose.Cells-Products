---
title: Convert HTML to XLTX in the Cloud via PHP 
...
outformat: XLTX
platform: PHP
otherformats: XPS XLSM ODS TSV FODS XLSB DIF SVG PDF CSV TXT XLTX XML MD MHTML TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XLTX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert HTML to XLTX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for HTML to XLTX Conversion" gistPath="" %}}
```php
