---
title: Convert HTML to XLSB in the Cloud via PHP 
...
outformat: XLSB
platform: PHP
otherformats: XLSB XLSM XLSX TSV TXT XLTX ODS TIFF SXC XPS DIF XLTM MHTML XML FODS PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XLSB with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert HTML to XLSB via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for HTML to XLSB Conversion" gistPath="" %}}
```php
