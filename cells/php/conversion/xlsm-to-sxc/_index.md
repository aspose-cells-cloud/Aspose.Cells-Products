---
title: Convert XLSM to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: XLS XLTX DIF TXT FODS TIFF XLTM PDF MD TSV SVG XML XLSX XLSB XPS MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSM to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSM to SXC Conversion" gistPath="" %}}
```php
