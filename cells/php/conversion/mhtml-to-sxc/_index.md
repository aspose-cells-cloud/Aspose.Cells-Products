---
title: Convert MHTML to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: XLS XLSX TIFF ODS SVG DIF XLTM HTML TXT SXC TSV FODS XML XPS MD CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert MHTML to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for MHTML to SXC Conversion" gistPath="" %}}
```php
