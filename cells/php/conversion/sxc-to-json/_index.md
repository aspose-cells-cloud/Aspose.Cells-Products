---
title: Convert SXC to JSON via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to  JSON in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to JSON Conversion in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for SXC to JSON Conversion" gistPath="" %}}
```php
