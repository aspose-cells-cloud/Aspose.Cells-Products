---
title: Convert CSV to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: DIF XPS TSV MHTML XLSB TXT MD XLTX SXC SVG TIFF XLSM XML ODS FODS PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert CSV to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for CSV to SXC Conversion" gistPath="" %}}
```php
