---
title: Convert XLT to XPS in the Cloud via PHP 
...
outformat: XPS
platform: PHP
otherformats: XLSX PDF TXT XLTX HTML DIF TIFF ODS MHTML XPS MD XLSM TSV XLSB SVG SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLT to XPS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLT to XPS Conversion" gistPath="" %}}
```php
