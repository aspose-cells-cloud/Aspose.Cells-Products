---
title: Convert XLT to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: XLTX XLSX MHTML FODS XML SXC XLTM XLSB DIF TIFF MD CSV XLSM TSV XPS SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLT to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLT to SXC Conversion" gistPath="" %}}
```php
