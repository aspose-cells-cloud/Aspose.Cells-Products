---
title: Convert XLS to XLSB in the Cloud via PHP 
...
outformat: XLSB
platform: PHP
otherformats: TSV CSV FODS XLSB XPS MD TXT DIF XLTX TIFF SXC SVG XML MHTML PDF XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSB with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to XLSB via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLS to XLSB Conversion" gistPath="" %}}
```php
