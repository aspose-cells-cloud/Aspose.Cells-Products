---
title: Convert XLS to TSV in the Cloud via PHP 
...
outformat: TSV
platform: PHP
otherformats: XLTX HTML XLTM XPS SVG TIFF TSV FODS MD TXT XLSM PDF MHTML DIF SXC CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to TSV with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to TSV via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLS to TSV Conversion" gistPath="" %}}
```php
