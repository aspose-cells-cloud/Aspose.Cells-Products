---
title: Convert HTML to XPS in the Cloud via PHP 
...
outformat: XPS
platform: PHP
otherformats: XLSX TSV ODS DIF XLTX XLSB XML FODS MHTML TXT TIFF CSV SXC PDF XLSM SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert HTML to XPS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for HTML to XPS Conversion" gistPath="" %}}
```php
