---
title: Convert XLSX to XLSB in the Cloud via PHP 
...
outformat: XLSB
platform: PHP
otherformats: FODS XLSB PDF XLTM MHTML MD XLSM DIF CSV XPS TXT TIFF SVG TSV XLTX SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XLSB with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSX to XLSB via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSX to XLSB Conversion" gistPath="" %}}
```php
