---
title: Convert XLT to XLSB in the Cloud via PHP 
...
outformat: XLSB
platform: PHP
otherformats: TSV MHTML XLSB DIF XPS CSV PDF FODS MD TIFF SXC XLSX XLTM SVG XML TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to XLSB with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLT to XLSB via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLT to XLSB Conversion" gistPath="" %}}
```php
