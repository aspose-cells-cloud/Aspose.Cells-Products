---
title: Convert XLS to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: MHTML XLTX TSV TXT XPS XLSM TIFF SXC SVG XLTM XLSX FODS CSV DIF XML MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLS to SXC Conversion" gistPath="" %}}
```php
