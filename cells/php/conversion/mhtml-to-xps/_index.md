---
title: Convert MHTML to XPS in the Cloud via PHP 
...
outformat: XPS
platform: PHP
otherformats: DIF HTML PDF TIFF TSV MD XLSX XLT ODS XLTM XPS XML CSV SVG TXT XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert MHTML to XPS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for MHTML to XPS Conversion" gistPath="" %}}
```php
