---
title: Convert HTML to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: MD TSV SXC ODS XLT XPS TIFF XLSB XLSM TXT SVG DIF XLTX XLSX XML PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert HTML to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for HTML to SXC Conversion" gistPath="" %}}
```php
