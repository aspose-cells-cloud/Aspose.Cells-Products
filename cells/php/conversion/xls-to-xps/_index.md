---
title: Convert XLS to XPS in the Cloud via PHP 
...
outformat: XPS
platform: PHP
otherformats: XLSM HTML XLTM CSV MHTML FODS TXT SXC PDF XLSX SVG TSV DIF MD XPS XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XPS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLS to XPS via PHP" %}}
