---
title: Convert XLT to TSV in the Cloud via PHP 
...
outformat: TSV
platform: PHP
otherformats: XPS XML FODS XLTM XLSX TSV TIFF DIF MD XLTX TXT CSV MHTML PDF XLSM XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to TSV with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLT to TSV via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLT to TSV Conversion" gistPath="" %}}
```php
