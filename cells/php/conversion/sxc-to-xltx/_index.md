---
title: Convert SXC to XLTX in the Cloud via PHP 
...
outformat: XLTX
platform: PHP
otherformats: XLTX HTML XLS ODS TIFF MHTML XLSM MD TXT TSV SVG XPS XML FODS XLSB PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLTX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert SXC to XLTX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for SXC to XLTX Conversion" gistPath="" %}}
```php
