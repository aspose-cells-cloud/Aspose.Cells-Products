---
title: Convert XML to FODS in the Cloud via PHP 
...
outformat: FODS
platform: PHP
otherformats: XLTX PDF XLS XLSB MD TXT XPS DIF CSV ODS HTML XLSX TIFF MHTML XLSM TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to FODS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XML to FODS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XML to FODS Conversion" gistPath="" %}}
```php
