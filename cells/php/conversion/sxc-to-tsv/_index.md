---
title: Convert SXC to TSV in the Cloud via PHP 
...
outformat: TSV
platform: PHP
otherformats: XLSB TXT CSV MHTML SVG TSV XML PDF ODS SXC TIFF XLTX XLSM XLTM XPS FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TSV with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert SXC to TSV via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for SXC to TSV Conversion" gistPath="" %}}
```php
