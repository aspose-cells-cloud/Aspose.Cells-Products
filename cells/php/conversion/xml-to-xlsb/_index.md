---
title: Convert XML to XLSB in the Cloud via PHP 
...
outformat: XLSB
platform: PHP
otherformats: XLSX SXC HTML XLTX TIFF MD XLTM FODS DIF CSV XLSM TXT SVG TSV XLSB MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSB with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XML to XLSB via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XML to XLSB Conversion" gistPath="" %}}
```php
