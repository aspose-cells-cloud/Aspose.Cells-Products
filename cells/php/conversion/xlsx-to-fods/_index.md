---
title: Convert XLSX to FODS in the Cloud via PHP 
...
outformat: FODS
platform: PHP
otherformats: XLSB TSV MHTML XML XLT XLTX PDF CSV XLSM ODS SVG FODS TXT TIFF MD DIF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to FODS with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSX to FODS via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSX to FODS Conversion" gistPath="" %}}
```php
