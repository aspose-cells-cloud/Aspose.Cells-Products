---
title: Convert XLTX to SXC in the Cloud via PHP 
...
outformat: SXC
platform: PHP
otherformats: ODS XLT FODS TSV DIF XLSM MHTML PDF XLTM TXT XPS SXC XLSB SVG TIFF XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to SXC with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLTX to SXC via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLTX to SXC Conversion" gistPath="" %}}
```php
