---
title: Convert XLSX to XLTX in the Cloud via PHP 
...
outformat: XLTX
platform: PHP
otherformats: FODS TIFF SVG MHTML XLSM XLTX TSV MD XPS XLSB SXC TXT DIF CSV PDF XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XLTX with PHP" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Quickly Convert XLSX to XLTX via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for XLSX to XLTX Conversion" gistPath="" %}}
```php
