---
title: Export Workbook to TXT file via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Workbook to TXT file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Workbook to TXT file in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for WORKBOOK to TXT Conversion" gistPath="" %}}
```php
