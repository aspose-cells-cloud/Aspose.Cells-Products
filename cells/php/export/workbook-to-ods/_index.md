---
title: Export Workbook to ODS file via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Workbook to ODS file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Workbook to ODS file in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for WORKBOOK to ODS Conversion" gistPath="" %}}
```php
...
{{% blocks/products/cells/cells-cloud-api-run-export  InputFormat="xlsx;*.xls;*.csv;*.ods"  OutputFormat=ods  ExportObjectType=workbook %}}
