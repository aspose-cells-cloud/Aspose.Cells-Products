---
title: Save TXT as JSON via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save TXT file as  JSON file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save TXT file as JSON file in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for saving TXT as JSON " gistPath="" %}}
```php
