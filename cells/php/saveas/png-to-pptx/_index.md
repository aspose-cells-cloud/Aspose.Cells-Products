---
title: Save PNG as PPTX via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save PNG file as  PPTX file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save PNG file as PPTX file in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for saving PNG as PPTX " gistPath="" %}}
```php
