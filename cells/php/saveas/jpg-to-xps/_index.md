...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save JPG file as  XPS file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save JPG file as XPS file in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for saving JPG as XPS " gistPath="" %}}
```php
