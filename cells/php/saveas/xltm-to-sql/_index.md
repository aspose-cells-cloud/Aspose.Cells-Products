---
title: Save XLTM as SQL via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save XLTM file as  SQL file in the Cloud" h2="Excel & OpenOffice spreadsheet save as with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save XLTM file as SQL file in Cloud SDK for PHP " %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code for saving XLTM as SQL " gistPath="" %}}
```php
