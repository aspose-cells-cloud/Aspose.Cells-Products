...
description:  Använder Aspose.Cells Cloud SDK för NodeJS för att spara PNG filformat som ODS-formatfil.
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="NodeJS-kodexempel för att spara PNG som ODS med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man sparar PNG som ODS med hjälp av Cells Cloud NodeJS-biblioteket." >}}
