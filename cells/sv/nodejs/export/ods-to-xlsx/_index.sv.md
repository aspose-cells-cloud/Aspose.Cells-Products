---
title: Exportera Ods till XLSX-fil via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exportera ODS till XLSX-fil i molnet" h2="Excel & OpenOffice-kalkylbladsexport med open source Cloud SDK för NodeJS" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Exoprt ODS till XLSX-fil i Cloud SDK för NodeJS" %}}
...
{{% blocks/products/pf/agp/code-autogen title="NodeJS-kod för ODS till XLSX-konvertering" gistPath="" %}}
```js
