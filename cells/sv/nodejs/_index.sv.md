---
title:  Åtkomst, läs och bearbeta moln Excel filer (via Node.js SDK)
description:  Utveckla Microsoft Excel & OpenOffice molnbaserade kalkylbladsvisnings-, export- och omvandlarappar i Node.js via REST API
weight: 80
url: /sv/nodejs
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js REST SDK för att bearbeta och exportera Excel-filer" h2="Utveckla Microsoft Excel & OpenOffice molnbaserade kalkylbladsvisnings-, export- och omvandlarappar i Node.js via REST API." logoImageSrc="/headers/aspose_cells-for-node.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Node.js" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK för Node.js gör det möjligt för dina molnbaserade applikationer att läsa excel-kalkylblad, exportera XLSX-arbetsböcker, konvertera Microsoft Excel & OpenOffice-dokument till PDF, 0761487615, 6MD, 401487615, 6, 40148615, 6, 40148481, 6,400 481, XML (SpreadsheetML), CSV , TSV, HTML och andra format som stöds, utan att installera någon programvara från tredje part.</p>
<p>Aspose.Cells Cloud SDK för Node.js får sin robusta funktionalitet från underliggande Aspose.Cells REST API och låter din Node.js-kod fungera med Excel villkorlig formatering, auto-filter, auto-former, diagram, OleOb, tabeller, pivot, listor uppgifter och intervall. Använd enkla Node.js-kommandon för att programmatiskt skapa, uppdatera, kryptera, sammanfoga, lösenordsskydda, exportera och konvertera XLS-, XLSX-, XLSB-, XLSM-, XLT-, XLTX-, XLTM- och ODS-filer till andra format som stöds.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-node.svg" alt="Node.js Excel SDK"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-node.svg" alt="Spreadsheet manipulation via Node.js"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
Ta bort specifika eller alla OleObjects från kalkylbladet
 ...
 Kom igång med Excel Spreadsheet Processing SDK
    ...
    <p>
 För att komma igång med Aspose.Cells Cloud SDK för Node.js behöver du inte installera någonting. Allt du behöver göra är att skapa ett konto på
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose för Cloud
     </a>
och få din ansökningsinformation. När du har appens SID &amp; nyckel är du redo att använda Aspose.Cells Cloud SDK för Node.js på vilken plattform som helst som stöder REST API:er. Aspose.Cells Cloud SDK för Node.js ger dig alla funktioner för att skapa, redigera och konvertera kalkylblad. Det låter dig också extrahera data från kalkylbladen för vidare bearbetning eller lagring.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Cloud SDK för att bearbeta arbetsblad
    ...
    <p>
Genom att använda Aspose.Cells Cloud SDK för Node.js kan du ta bort specifik rad eller alla rader i kalkylbladet, hämta kalkylbladscelldata eller cellstil efter cellnamn, läsa kalkylbladsrad- eller kolumndata efter dess index, beräkna cellformel, rensa cellinnehåll, kopiera cell till en annan cell, kopiera kalkylbladskolumner och rader, gruppera kalkylbladsrader och kolumner, dölj kalkylbladsrader och kolumner, ställ in kalkylbladskolumner och radstilar, ställ in HTMLSTRING-värde i cell, ställ in cellintervallsvärde och ändra många andra kalkylbladsinställningar.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Utnyttja kraften i pivottabeller &amp; Avstånd
    ...
    <p>
 Aspose.Cells Cloud SDK för Node.js låter dig lägga till en pivottabell i kalkylbladet, lägga till eller ta bort pivotfält i pivottabellen, lägga till eller ta bort pivotfilter för pivottabellindex, uppdatera cellstil för pivottabellen och beräkna pivottabellens data till celler .
    </p>
    <p>
Aspose.Cells Cloud SDK för Node.js kan också användas för att få en celllista i ett intervall efter intervallnamn eller radkolumnindex, ställa in kolumnbredd på intervall, kombinera ett intervall av celler till en enda cell, flytta det aktuella intervallet till destinationsintervallet , ställer in konturgränsen runt ett cellintervall., ställ in radhöjd för intervall, ställ in stilen för intervallet, tar bort sammanslagna celler i detta intervall, sätter ett värde i intervallet och konverterar dess datatyp, och kopiera intervall i kalkylbladet.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-node" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Cells Cloud SDK för Node.js?" tabId="success-stories" >}}
