---
title: Excel® Kalkylarksprogrammering API för att snabba upp hantering och bearbetning av kalkylblad med Node
...
{{< blocks/products/cells/languge-index-ferturecard title="Konvertera" desc="Converts a spreadsheet on a local drive to the specified format." url="/cells/nodejs/conversion" imgurl="/cells/images/convert.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Slå ihop" desc="Merge local spreadsheet files into a specified format file." url="/cells/nodejs/merge" imgurl="/cells/images/merge.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Skydda" desc="Applies dual-layer password protection to Excel spreadsheets, supporting both open and modify passwords with encryption." url="/cells/nodejs/protect" imgurl="/cells/images/protect.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Spara som" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/nodejs/saveas" imgurl="/cells/images/saveas.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Exportera" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/nodejs/export" imgurl="/cells/images/export.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Rensa" desc="Clear cell formats in the worksheet." url="/cells/nodejs/clear" imgurl="/cells/images/clear.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="Bakgrund" desc="Set background in the workbook." url="/cells/nodejs/background" imgurl="/cells/images/background.svg" >}}
