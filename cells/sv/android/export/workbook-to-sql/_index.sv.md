---
title:  Exportera ARBETSBOK till SQL från kalkylblad med Android API
description:  Aspose.Cells Cloud REST API stöder export av filer från {0} till {1}-format med {2}.
url: /sv/android/export/workbook-to-sql/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API för att exportera ARBETSBOK till SQL-fil" h2="Android-bibliotek för att exportera ARBETSBOK till SQL-fil" p="Använd Cells Export REST API för att exportera arbetsflöden för interna objekt i kalkylark i Android. Detta är en professionell lösning för att exportera ARBETSBOK till SQL-formatfil från kalkylblad online med Android." urlsection="export/workbook-to-sql/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportera WORKBOOK-objekt till SQL-formatfil i Android" >}}
