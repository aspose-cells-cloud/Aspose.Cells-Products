---
title:  Konvertera FODS till XLTX på Android
...
url: /sv/android/conversion/fods-to-xltx/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLTX i molnet" h2="Konvertera Excel och OpenOffice-kalkylblad med open source Cloud SDK för Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till XLTX-konvertering i Android-appar" %}}
...
1. Ring ```CellsApi.cellsWorkbookGetWorkbook``` för att få den resulterande XLTX-filen
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS till XLTX-konvertering" gistPath="" %}}
```java
