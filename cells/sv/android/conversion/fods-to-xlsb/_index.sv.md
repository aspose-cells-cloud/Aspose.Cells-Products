---
title:  Konvertera FODS till XLSB på Android
...
url: /sv/android/conversion/fods-to-xlsb/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLSB i molnet" h2="Konvertera Excel och OpenOffice-kalkylblad med open source Cloud SDK för Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till XLSB-konvertering i Android-appar" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS till XLSB-konvertering" gistPath="" %}}
```java
