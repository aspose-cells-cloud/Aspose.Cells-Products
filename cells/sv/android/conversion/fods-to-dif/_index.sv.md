---
title:  Konvertera FODS till DIF på Android
...
url: /sv/android/conversion/fods-to-dif/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till DIF i molnet" h2="Konvertera Excel och OpenOffice-kalkylblad med open source Cloud SDK för Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till DIF-konvertering i Android-appar" %}}
...
1. Ring ```CellsApi.cellsWorkbookGetWorkbook``` för att få den resulterande DIF-filen
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS till DIF-konvertering" gistPath="" %}}
```java
