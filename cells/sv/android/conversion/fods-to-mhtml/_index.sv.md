---
title:  Konvertera FODS till MHTML på Android
...
url: /sv/android/conversion/fods-to-mhtml/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till MHTML i molnet" h2="Konvertera Excel och OpenOffice-kalkylblad med open source Cloud SDK för Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till MHTML-konvertering i Android-appar" %}}
...
1. Ring ```CellsApi.cellsWorkbookGetWorkbook``` för att få den resulterande MHTML-filen
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS till MHTML-konvertering" gistPath="" %}}
```java
