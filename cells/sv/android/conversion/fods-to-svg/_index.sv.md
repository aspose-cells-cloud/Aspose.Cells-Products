---
title:  Convierta FODS a SVG en Android
...
url: /sv/android/conversion/fods-to-svg/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a SVG en la nube" h2="Convierta Excel y hojas de cálculo de OpenOffice con Cloud SDK de código abierto para Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a SVG en aplicaciones de Android" %}}
...
1. Llame al ```CellsApi.cellsWorkbookGetWorkbook``` para obtener el archivo SVG resultante
...
{{% blocks/products/pf/agp/code-autogen title="Android: Conversión de FODS a SVG" gistPath="" %}}
```java
