---
title:  Konvertera FODS till XLSX på Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLSX i molnet" h2="Konvertera Excel och OpenOffice-kalkylblad med open source Cloud SDK för Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till XLSX-konvertering i Android-appar" %}}
...
1. Ring ```CellsApi.cellsWorkbookGetWorkbook``` för att få den resulterande XLSX-filen
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS till XLSX-konvertering" gistPath="" %}}
```java
