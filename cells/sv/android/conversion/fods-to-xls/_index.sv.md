---
title:  Convertir FODS a XLS en Android
...
url: /sv/android/conversion/fods-to-xls/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a XLS en la nube" h2="Convierta Excel y hojas de cálculo de OpenOffice con Cloud SDK de código abierto para Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a XLS en aplicaciones de Android" %}}
...
1. Llame al ```CellsApi.cellsWorkbookGetWorkbook``` para obtener el archivo XLS resultante
...
{{% blocks/products/pf/agp/code-autogen title="Android: conversión de FODS a XLS" gistPath="" %}}
```java
