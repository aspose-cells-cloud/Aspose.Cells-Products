...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara GIF som XLS" h2="Android-bibliotek för att spara GIF som XLS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara GIF som XLS och andra dokumentformat online med Android." urlsection="saveas/gif-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en GIF-fil som XLS i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara GIF som XLS med REST API" gistPath="" %}}
