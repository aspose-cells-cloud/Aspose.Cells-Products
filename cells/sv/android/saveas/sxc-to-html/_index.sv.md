...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara SXC som HTML" h2="Android-bibliotek för att spara SXC som HTML" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara SXC som HTML och andra dokumentformat online med Android." urlsection="saveas/sxc-to-html/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en SXC-fil som HTML i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara SXC som HTML med REST API" gistPath="" %}}
