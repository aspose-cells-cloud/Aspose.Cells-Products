...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara NUMBERS som SVG" h2="Android-bibliotek för att spara NUMBERS som SVG" p="Använd SaveAs API av Cells Cloud för att skapa anpassade arbetsflöden för kalkylblad i Android. Detta är en professionell lösning för att spara NUMMER som SVG och andra dokumentformat online med Android." urlsection="saveas/numbers-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en NUMBERS-fil som SVG i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara NUMBERS som SVG med REST API" gistPath="" %}}
