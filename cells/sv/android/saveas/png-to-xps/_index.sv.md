...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara PNG som XPS" h2="Android-bibliotek för att spara PNG som XPS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara PNG som XPS och andra dokumentformat online med Android." urlsection="saveas/png-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en PNG-fil som XPS i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara PNG som XPS med REST API" gistPath="" %}}
