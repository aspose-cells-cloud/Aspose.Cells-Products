...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara JSON som TXT" h2="Android-bibliotek för att spara JSON som TXT" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara JSON som TXT och andra dokumentformat online med Android." urlsection="saveas/json-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en JSON-fil som TXT i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara JSON som TXT med REST API" gistPath="" %}}
