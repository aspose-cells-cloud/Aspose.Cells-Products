...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara ODS som XLSB" h2="Android-bibliotek för att spara ODS som XLSB" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara ODS som XLSB och andra dokumentformat online med Android." urlsection="saveas/ods-to-xlsb/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en ODS-fil som XLSB i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara ODS som XLSB med REST API" gistPath="" %}}
