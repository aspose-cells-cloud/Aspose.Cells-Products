...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLTM som FODS" h2="Android-bibliotek för att spara XLTM som FODS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara XLTM som FODS och andra dokumentformat online med Android." urlsection="saveas/xltm-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLTM-fil som FODS i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara XLTM som FODS med REST API" gistPath="" %}}
