...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara PNG som BMP" h2="Android-bibliotek för att spara PNG som BMP" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara PNG som BMP och andra dokumentformat online med Android." urlsection="saveas/png-to-bmp/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en PNG-fil som BMP i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara PNG som BMP med REST API" gistPath="" %}}
