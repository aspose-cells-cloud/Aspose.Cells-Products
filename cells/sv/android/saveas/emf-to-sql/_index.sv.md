---
title:  Spara EMF som SQL API för Android
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API för att spara EMF som SQL" h2="Android-bibliotek för att spara EMF som SQL" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara EMF som SQL och andra dokumentformat online med Android." urlsection="saveas/emf-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Kodexempel i Android med REST API för att spara EMF som SQL-format" gistPath="" %}}
