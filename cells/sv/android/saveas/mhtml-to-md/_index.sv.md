...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara MHTML som MD" h2="Android-bibliotek för att spara MHTML som MD" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara MHTML som MD och andra dokumentformat online med Android." urlsection="saveas/mhtml-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en MHTML-fil som MD i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara MHTML som MD med REST API" gistPath="" %}}
