...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLSM som XML" h2="Android-bibliotek för att spara XLSM som XML" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara XLSM som XML och andra dokumentformat online med Android." urlsection="saveas/xlsm-to-xml/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLSM-fil som XML i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara XLSM som XML med REST API" gistPath="" %}}
