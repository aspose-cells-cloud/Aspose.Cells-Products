...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara ODS som HTML" h2="Android-bibliotek för att spara ODS som HTML" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara ODS som HTML och andra dokumentformat online med Android." urlsection="saveas/ods-to-html/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en ODS-fil som HTML i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara ODS som HTML med REST API" gistPath="" %}}
