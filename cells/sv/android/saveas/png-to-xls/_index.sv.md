...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara PNG som XLS" h2="Android-bibliotek för att spara PNG som XLS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara PNG som XLS och andra dokumentformat online med Android." urlsection="saveas/png-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en PNG-fil som XLS i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara PNG som XLS med REST API" gistPath="" %}}
