...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara PNG som JPG" h2="Android-bibliotek för att spara PNG som JPG" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara PNG som JPG och andra dokumentformat online med Android." urlsection="saveas/png-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en PNG-fil som JPG i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara PNG som JPG med REST API" gistPath="" %}}
