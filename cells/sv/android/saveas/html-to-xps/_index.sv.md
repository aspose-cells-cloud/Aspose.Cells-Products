...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara HTML som XPS" h2="Android-bibliotek för att spara HTML som XPS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara HTML som XPS och andra dokumentformat online med Android." urlsection="saveas/html-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en HTML-fil som XPS i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara HTML som XPS med REST API" gistPath="" %}}
