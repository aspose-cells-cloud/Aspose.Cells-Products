...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara TXT som DIF" h2="Android-bibliotek för att spara TXT som DIF" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Android. Detta är en professionell lösning för att spara TXT som DIF och andra dokumentformat online med Android." urlsection="saveas/txt-to-dif/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en TXT-fil som DIF i Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Android-kodexempel för att spara TXT som DIF med REST API" gistPath="" %}}
