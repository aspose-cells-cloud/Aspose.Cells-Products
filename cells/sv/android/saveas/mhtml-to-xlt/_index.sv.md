...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara MHTML som XLT" h2="Android-bibliotek för att spara MHTML som XLT" p="Använd SaveAs API av Cells Cloud för att skapa anpassade arbetsflöden för kalkylblad i Android. Detta är en professionell lösning för att spara MHTML som XLT och andra dokumentformat online med Android." urlsection="saveas/mhtml-to-xlt/" >}}
