...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till CSV i molnet" h2="Excel & OpenOffice kalkylarkskonvertering med open source Cloud SDK for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till CSV-konvertering i .NET-appar" %}}
...
1. Ring ```CellsApi.CellsSaveAsPostDocumentSaveAs```-metoden för att få den resulterande CSV-filen
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Kod för FODS till CSV-konvertering" gistPath="" %}}
```cs
