...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till TIFF i molnet" h2="Excel & OpenOffice kalkylarkskonvertering med open source Cloud SDK for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till TIFF Konvertering i .NET appar" %}}
...
1. Ring ```CellsApi.CellsSaveAsPostDocumentSaveAs```-metoden för att få den resulterande TIFF-filen
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Kod för FODS till TIFF Konvertering" gistPath="" %}}
```cs
