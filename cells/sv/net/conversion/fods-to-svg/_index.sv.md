...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a SVG en la nube" h2="Excel y conversión de hoja de cálculo de OpenOffice con SDK de nube de código abierto for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS a SVG Conversión en .NET Aplicaciones" %}}
...
1. Llame al método ```CellsApi.CellsSaveAsPostDocumentSaveAs``` para obtener el archivo SVG resultante
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Código para FODS a SVG Conversión" gistPath="" %}}
```cs
