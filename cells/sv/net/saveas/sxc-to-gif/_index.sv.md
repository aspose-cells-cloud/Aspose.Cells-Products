...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Kod Exempel för att spara SXC som GIF med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar SXC som GIF med hjälp av Cells Cloud Net-biblioteket." >}}
