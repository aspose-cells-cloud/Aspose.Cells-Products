---
title:  Spara JPG som SQL API för C#
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="C# API för att spara JPG som SQL" h2="C# bibliotek för att spara JPG som SQL" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i Net. Detta är en professionell lösning för att spara JPG som SQL och andra dokumentformat online med C#." urlsection="saveas/jpg-to-sql/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Kodexempel i C# med REST API för att spara JPG som SQL-format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder C# API för att spara JPG som SQL" >}}
