---
title:  Spara NUMBERS som XPS API för C#
description:  Använder Aspose.Cells Cloud SDK för C# för att spara NUMBERS-formatfilen som XPS-fil.
url: /sv/net/saveas/numbers-to-xps/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="C# API för att spara NUMBERS som XPS" h2="C# bibliotek för att spara NUMBERS som XPS" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i Net. Detta är en professionell lösning för att spara NUMMER som XPS och andra dokumentformat online med C#." urlsection="saveas/numbers-to-xps/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Kodexempel i C# med REST API för att spara NUMBERS i formatet XPS" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder C# API för att spara NUMBERS som XPS" >}}
