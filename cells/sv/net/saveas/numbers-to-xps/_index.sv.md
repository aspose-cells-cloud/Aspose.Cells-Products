...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara NUMBERS som XPS" h2="C# bibliotek för att spara NUMBERS som XPS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Net. Detta är en professionell lösning för att spara NUMMER som XPS och andra dokumentformat online med C#." urlsection="saveas/numbers-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en NUMBERS-fil som XPS i C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Kod Exempel för att spara NUMBERS som XPS med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar NUMBERS som XPS med hjälp av Cells Cloud Net-biblioteket." >}}
