---
title: Spara filen Excel som fil i annat format
description: " Aspose.Cells Cloud REST API gör det möjligt att spara Excel-filer i olika format och tillhandahåller SDK:er för flera programmeringsspråk, inklusive Android, C#, Go, Java, NodeJS, 081,3457, 081, 3457, 081, 3457, Aspose.Cells av och Swift."
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Spara filen Excel som fil i annat format" h2="Aspose.Cells Cloud SDK stöder att spara arbetsböcker i över 30 olika filformat." p="Aspose.Cells Cloud REST API gör det möjligt att spara Excel-filer i olika format och tillhandahåller SDK:er för flera programmeringsspråk, inklusive Android, C#, Go, Java, NodeJS, 081,3457, 081, 3457, 081, 3457, Aspose.Cells av och Swift." urlsection="" >}}
...
{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Java" title="Spara Xlsx som pdf" imgSrc="/cells/app-logos/cells_cloud_saveas.svg" productLink="/cells/java/saveas/xlsx-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Java" title="Spara Xlsx som Json" imgSrc="/cells/app-logos/cells_cloud_saveas.svg" productLink="/cells/java/saveas/xlsx-to-json/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for Java" title="Spara Xlsx som Csv" imgSrc="/cells/app-logos/cells_cloud_saveas.svg" productLink="/cells/java/saveas/xlsx-to-csv/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for PHP" title="Spara Xlsx till pdf" imgSrc="/cells/app-logos/cells_cloud_saveas.svg" productLink="/cells/php/saveas/xlsx-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for PHP" title="Spara Xlsx som Json" imgSrc="/cells/app-logos/cells_cloud_saveas.svg" productLink="/cells/php/saveas/xlsx-to-json/" >}}

{{< blocks/products/cells/cells-cloud-card-popular pfName="Aspose.Cells Cloud SDK for PHP" title="Spara Xlsx som Csv" imgSrc="/cells/app-logos/cells_cloud_saveas.svg" productLink="/cells/php/saveas/xlsx-to-csv/" >}}
{{< /blocks/products/pf/product-card-row >}}
