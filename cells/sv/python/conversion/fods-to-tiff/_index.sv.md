...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a TIFF con Python" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS a TIFF Conversión con Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Código para FODS a TIFF Conversión" gistPath="" %}}
```python
