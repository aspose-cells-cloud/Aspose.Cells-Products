---
title: Konvertera från Excel FODS till MHTML via Python
description: Skapa, redigera eller konvertera Excel-filer med REST API & Open Source Python SDK
url: /sv/python/conversion/fods-to-mhtml/
family: cells
platformtag: python
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till MHTML med Python" h2="Läs, redigera och exportera Excel-data till andra format med open source Cloud SDK för Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till MHTML-konvertering med Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Kod för FODS till MHTML-konvertering" gistPath="" %}}
```python
