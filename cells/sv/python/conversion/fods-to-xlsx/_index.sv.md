...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLSX med Python" h2="Läs, redigera och exportera Excel-data till andra format med open source Cloud SDK för Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till XLSX Konvertering med Python" %}}
...
1. Ring ```CellsApi.cells_save_as_post_document_save_as```-metoden för att få den resulterande XLSX-filen
...
{{% blocks/products/pf/agp/code-autogen title="Python Kod för FODS till XLSX-konvertering" gistPath="" %}}
```python
