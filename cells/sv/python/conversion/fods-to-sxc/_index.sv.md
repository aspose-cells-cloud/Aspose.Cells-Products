...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a SXC con Python" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Python" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Código para conversión de FODS a SXC" gistPath="" %}}
```python
