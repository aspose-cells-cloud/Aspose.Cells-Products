---
title:  Excel & OpenOffice Processing via Python i molnet (REST SDK)
description: REST API för att integrera Excel och OpenOffice kalkylbladsbehandlingsfunktioner i dina molnbaserade Python appar
weight: 110
url: /sv/python
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python SDK för att manipulera Excel filer" h2="REST API för att integrera Excel och OpenOffice kalkylbladsbehandlingsfunktioner i dina molnbaserade Python appar." logoImageSrc="/headers/aspose_cells-for-python.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Python" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK For Python hjälper dig att utveckla moln-kalkylbladsbyggare, visningsprogram, sammanslagnings-, splitter-, kryptering- och omvandlarappar i programmeringsspråket Python. Aspose.Cells Cloud SDK för Python distribueras under en MIT-licens och drivs av underliggande Aspose.Cells REST API.</p>
<p>Aspose.Cells Cloud SDK för Python låter din Python-kod utföra grundläggande till avancerade funktioner på Microsoft Excel och OpenOffice-kalkylblad som finns på molnlagringen. Använd ditt Python-program för att arbeta med pivottabeller, arbeta med XML (SpreadsheetML), läs Excel-filer i moln via Python, konvertera XLSX till HTML, CSV, PDF, PDF, PDF, PDF, PDF, PDF, PDF, 61123481 och andra filformat som stöds.</p>
<p>Aspose.Cells Cloud SDK för Python gör det möjligt för dina Python-program att skapa flera kalkylblad, hantera kalkylblad, arbetsböcker, arkinställningar, tillämpa villkorlig formatering, hantera uppgifter, formler, autofilter, Oleobjects, ListObjects, ListObjects, ListObjects 3476-kalkylblad och andra installationer från tredje part. programvara.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-python.svg" alt="Python Excel SDK"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-python.svg" alt="Python Cloud Excel"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Avancerade Excel Kalkylblad Cloud SDK-funktioner
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Ta bort specifika eller alla OleObjects från kalkylbladet
 ...
 Kom igång med Excel Spreadsheet Processing SDK
    ...
    <p>
 För att komma igång med Aspose.Cells Cloud SDK för Python behöver du inte installera någonting. Allt du behöver göra är att skapa ett konto på
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose för Cloud
     </a>
 och få din ansökningsinformation. När du har appens SID &amp; nyckel är du redo att använda Aspose.Cells Cloud SDK för Python på vilken plattform som helst som stöder REST API:er. Aspose.Cells Cloud SDK för Python ger dig alla funktioner för att skapa, redigera och konvertera kalkylblad. Det låter dig också extrahera data från kalkylbladen för vidare bearbetning eller lagring.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Cloud SDK för att bearbeta arbetsblad
    ...
    <p>
Genom att använda Aspose.Cells Cloud SDK för Python kan du ta bort specifik rad eller alla rader i kalkylbladet, hämta kalkylbladscelldata eller cellstil efter cellnamn, läsa kalkylbladsrads- eller kolumndata efter dess index, beräkna cellformel, rensa cellinnehåll, kopiera cell till en annan cell, kopiera kalkylbladskolumner och rader, gruppera kalkylbladsrader och kolumner, dölj kalkylbladsrader och kolumner, ställ in kalkylbladskolumner och radstilar, ställ in HTMLSTRING-värde i cell, ställ in cellintervallsvärde och ändra många andra kalkylbladsinställningar.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Utnyttja kraften i pivottabeller &amp; Avstånd
    ...
    <p>
 Aspose.Cells Cloud SDK för Python låter dig lägga till en pivottabell i kalkylbladet, lägga till eller ta bort pivotfält i pivottabellen, lägga till eller ta bort pivotfilter för pivottabellindex, uppdatera cellstil för pivottabell och beräkna pivottabellens data till celler.
    </p>
    <p>
Aspose.Cells Cloud SDK för Python kan också användas för att få en celllista i ett intervall efter intervallnamn eller radkolumnindex, ställa in intervallets kolumnbredd, kombinera ett intervall av celler till en enda cell, flytta det aktuella intervallet till destinationsintervallet, ställa in kontur gränsen runt ett cellintervall., ställ in radhöjd för intervall, ställ in stilen för intervallet, tar bort sammanslagna celler i det här intervallet, sätt ett värde i intervallet och konvertera dess datatyp och kopiera intervall i kalkylbladet.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-python" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Cells Cloud SDK för Python?" tabId="success-stories" >}}
