...
description:  Använda Aspose.Cells Cloud SDK för Perl för att konvertera en fil i formatet HTML till en fil i XLSX-format.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man konverterar HTML till XLSX med hjälp av Cells Cloud Perl-biblioteket." >}}
