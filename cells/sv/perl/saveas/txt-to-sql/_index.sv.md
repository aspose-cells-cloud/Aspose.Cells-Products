---
title:  Spara TXT som SQL med Perl
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara TXT som SQL" h2="Perl bibliotek för att spara TXT som SQL" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Perl. Detta är en professionell lösning för att spara TXT som SQL och andra dokumentformat online med Perl." urlsection="saveas/txt-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en TXT-fil som SQL i Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Kod Exempel för att spara TXT som SQL med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar TXT som SQL med hjälp av Cells Cloud Perl-biblioteket." >}}
