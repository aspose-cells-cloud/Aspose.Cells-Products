---
title:  Spara XLTX som XLSM med Perl
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLTX som XLSM" h2="Perl bibliotek för att spara XLTX som XLSM" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Perl. Detta är en professionell lösning för att spara XLTX som XLSM och andra dokumentformat online med Perl." urlsection="saveas/xltx-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLTX-fil som XLSM i Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Kod Exempel för att spara XLTX som XLSM med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar XLTX som XLSM med hjälp av Cells Cloud Perl-biblioteket." >}}
