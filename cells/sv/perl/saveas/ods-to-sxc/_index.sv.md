---
title:  Spara ODS som SXC med Perl
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara ODS som SXC" h2="Perl bibliotek för att spara ODS som SXC" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Perl. Detta är en professionell lösning för att spara ODS som SXC och andra dokumentformat online med Perl." urlsection="saveas/ods-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en ODS-fil som SXC i Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Kod Exempel för att spara ODS som SXC med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar ODS som SXC med hjälp av Cells Cloud Perl-biblioteket." >}}
