---
title:  Exportera BILD till WMF från kalkylblad med Swift API
description:  Aspose.Cells Cloud REST API stöder export av filer från {0} till {1}-format med {2}.
url: /sv/swift/export/picture-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API för att exportera BILD till WMF-fil" h2="Swift-bibliotek för att exportera BILD till WMF-fil" p="Använd Cells Export REST API för att exportera arbetsflöden för interna objekt i kalkylark i Swift. Detta är en professionell lösning för att exportera BILD till WMF-formatfil från kalkylblad online med Swift." urlsection="export/picture-to-wmf/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder Swift API för att exportera BILD till WMF" >}}
