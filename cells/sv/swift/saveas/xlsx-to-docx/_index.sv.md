---
title:  Spara XLSX som DOCX API för Swift
description:  Använder Aspose.Cells Cloud SDK för Swift för att spara XLSX-formatfil som DOCX-formatfil.
url: /sv/swift/saveas/xlsx-to-docx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API för att spara XLSX som DOCX" h2="Swift-bibliotek för att spara XLSX som DOCX" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i Swift. Detta är en professionell lösning för att spara XLSX som DOCX och andra dokumentformat online med Swift." urlsection="saveas/xlsx-to-docx/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder Swift API för att spara XLSX som DOCX" >}}
