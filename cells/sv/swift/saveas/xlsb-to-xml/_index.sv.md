---
title:  Spara XLSB som XML API för Swift
description:  Använder Aspose.Cells Cloud SDK för Swift för att spara XLSB-formatfil som XML-formatfil.
url: /sv/swift/saveas/xlsb-to-xml/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API för att spara XLSB som XML" h2="Swift-bibliotek för att spara XLSB som XML" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i Swift. Detta är en professionell lösning för att spara XLSB som XML och andra dokumentformat online med Swift." urlsection="saveas/xlsb-to-xml/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder Swift API för att spara XLSB som XML" >}}
