...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLSM med Java" h2="Automatisera Excel & OpenOffice-filkonvertering med open source Cloud SDK for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Enkel FODS till XLSM-konvertering" %}}
...
1. Ring ```CellsApi.cellsWorkbookGetWorkbook``` för att få den resulterande XLSM-filen
...
{{% blocks/products/pf/agp/code-autogen title="Java Kod för att konvertera FODS till XLSM" gistPath="" %}}
```java
