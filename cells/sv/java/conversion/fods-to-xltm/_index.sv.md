...
outformat: XLTM
platform: Java
otherformats: TIFF MD SVG XML HTML XLSM DIF XLTX XLSX XLSB TSV CSV TXT MHTML XPS XLTM 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a XLTM con Java" h2="Automatice Excel y la conversión de archivos de OpenOffice con el SDK de nube de código abierto for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión simple de FODS a XLTM" %}}
...
1. Llame al ```CellsApi.cellsWorkbookGetWorkbook``` para obtener el archivo XLTM resultante
...
{{% blocks/products/pf/agp/code-autogen title="Java Código para convertir FODS a XLTM" gistPath="" %}}
```java
