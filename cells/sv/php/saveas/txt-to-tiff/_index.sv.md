---
title:  Spara TXT som TIFF med PHP
description:  Använder Aspose.Cells Cloud SDK för PHP för att spara fil i TXT-format som fil i TIFF-format.
kwords: Excel, Save TXT as TIFF, REST, PHP
howto: How to save TXT as TIFF using Aspose.Cells Cloud PHP library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara TXT som TIFF" h2="PHP bibliotek för att spara TXT som TIFF" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara TXT som TIFF och andra dokumentformat online med PHP." urlsection="saveas/txt-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en TXT-fil som TIFF i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara TXT som TIFF med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar TXT som TIFF med Cells Cloud PHP-biblioteket." >}}
