---
title:  Spara XML som MD API för PHP
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API för att spara XML som MD" h2="PHP-biblioteket för att spara XML som MD" p="Använd Cells SaveAs REST API för att skapa anpassade arbetsflöden för kalkylblad i PHP. Detta är en professionell lösning för att spara XML som MD och andra dokumentformat online med PHP." urlsection="saveas/xml-to-md/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Kodexempel i PHP med REST API för att spara XML som MD-format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder PHP API för att spara XML som MD" >}}
