---
title:  Spara ODS som SQL API för PHP
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API för att spara ODS som SQL" h2="PHP bibliotek för att spara ODS som SQL" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara ODS som SQL och andra dokumentformat online med PHP." urlsection="saveas/ods-to-sql/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Spara en ODS-fil som SQL i PHP" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Kodexempel i PHP med REST API för att spara ODS som SQL-format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder PHP API för att spara ODS som SQL" >}}
