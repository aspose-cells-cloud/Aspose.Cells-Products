---
title:  Spara XLSM som JSON med PHP
description: Använder Aspose.Cells Cloud SDK för PHP för att spara XLSM-formatfilen som JSON-formatfil.
kwords: Excel, Save XLSM as JSON, REST, PHP
howto: How to save XLSM as JSON using Aspose.Cells Cloud PHP library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLSM som JSON" h2="PHP bibliotek för att spara XLSM som JSON" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara XLSM som JSON och andra dokumentformat online med PHP." urlsection="saveas/xlsm-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLSM-fil som JSON i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara XLSM som JSON med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar XLSM som JSON med hjälp av Cells Cloud PHP-biblioteket." >}}
