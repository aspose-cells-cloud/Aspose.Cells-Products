---
title:  Spara XLS som XLSX med PHP
description:  Använder Aspose.Cells Cloud SDK för PHP för att spara XLS-formatfil som XLSX-formatfil.
kwords: Excel, Save XLS as XLSX, REST, PHP
howto: How to save XLS as XLSX using Aspose.Cells Cloud PHP library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLS som XLSX" h2="PHP bibliotek för att spara XLS som XLSX" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara XLS som XLSX och andra dokumentformat online med PHP." urlsection="saveas/xls-to-xlsx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLS-fil som XLSX i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara XLS som XLSX med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar XLS som XLSX med hjälp av Cells Cloud PHP-biblioteket." >}}
