---
title:  Spara XML som DOCX API för PHP
description:  Använder Aspose.Cells Cloud SDK för PHP för att spara XML-formatfil som DOCX-formatfil.
url: /sv/php/saveas/xml-to-docx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API för att spara XML som DOCX" h2="PHP-biblioteket för att spara XML som DOCX" p="Använd Cells SaveAs REST API för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara XML som DOCX och andra dokumentformat online med PHP." urlsection="saveas/xml-to-docx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Spara en XML-fil som DOCX i PHP" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Kodexempel i PHP med REST API för att spara XML som DOCX-format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder PHP API för att spara XML som DOCX" >}}
