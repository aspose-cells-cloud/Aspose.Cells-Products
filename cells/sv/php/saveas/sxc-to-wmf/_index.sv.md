---
title:  Spara SXC som WMF med PHP
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara SXC som WMF" h2="PHP bibliotek för att spara SXC som WMF" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara SXC som WMF och andra dokumentformat online med PHP." urlsection="saveas/sxc-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en SXC-fil som WMF i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara SXC som WMF med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar SXC som WMF med hjälp av Cells Cloud PHP-biblioteket." >}}
