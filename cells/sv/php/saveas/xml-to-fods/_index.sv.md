...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XML som FODS" h2="PHP bibliotek för att spara XML som FODS" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara XML som FODS och andra dokumentformat online med PHP." urlsection="saveas/xml-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XML-fil som FODS i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara XML som FODS med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar XML som FODS med hjälp av Cells Cloud PHP-biblioteket." >}}
