---
title:  Spara TXT som XLTX med PHP
description:  Använder Aspose.Cells Cloud SDK för PHP för att spara TXT-formatfil som XLTX-formatfil.
kwords: Excel, Save TXT as XLTX, REST, PHP
howto: How to save TXT as XLTX using Aspose.Cells Cloud PHP library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara TXT som XLTX" h2="PHP bibliotek för att spara TXT som XLTX" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara TXT som XLTX och andra dokumentformat online med PHP." urlsection="saveas/txt-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en TXT-fil som XLTX i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara TXT som XLTX med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar TXT som XLTX med hjälp av Cells Cloud PHP-biblioteket." >}}
