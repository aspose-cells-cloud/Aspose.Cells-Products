---
title:  Spara JSON som XLT med PHP
description:  Använder Aspose.Cells Cloud SDK för PHP för att spara JSON-formatfil som XLT-formatfil.
kwords: Excel, Save JSON as XLT, REST, PHP
howto: How to save JSON as XLT using Aspose.Cells Cloud PHP library.
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara JSON som XLT" h2="PHP bibliotek för att spara JSON som XLT" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i PHP. Detta är en professionell lösning för att spara JSON som XLT och andra dokumentformat online med PHP." urlsection="saveas/json-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en JSON-fil som XLT i PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Kod Exempel för att spara JSON som XLT med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar JSON som XLT med hjälp av Cells Cloud PHP-biblioteket." >}}
