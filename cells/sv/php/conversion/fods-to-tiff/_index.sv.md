...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a TIFF con PHP" h2="Automatice la conversión de archivos Excel y OpenOffice con SDK de nube de código abierto para PHP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Código para FODS a TIFF Conversión" gistPath="" %}}
```php
