...
description:  Använda Aspose.Cells Cloud SDK för PHP för att konvertera en fil i formatet PNG till en fil i XLSX-format.
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man konverterar PNG till XLSX med hjälp av Cells Cloud PHP-biblioteket." >}}
