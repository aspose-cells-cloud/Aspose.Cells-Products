...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till MHTML med PHP" h2="Automatisera Excel & OpenOffice-filkonvertering med open source Cloud SDK för PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertera snabbt FODS till MHTML via PHP" %}}
...
1. Ring ```CellsApi.cellsSaveAsPostDocumentSaveAs``` för att få den resulterande MHTML-filen
...
{{% blocks/products/pf/agp/code-autogen title="PHP Kod för FODS till MHTML-konvertering" gistPath="" %}}
```php
