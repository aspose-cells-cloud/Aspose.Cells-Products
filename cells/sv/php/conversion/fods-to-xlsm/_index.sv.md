---
title:  Konvertera FODS till XLSM i molnet via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLSM med PHP" h2="Automatisera Excel & OpenOffice-filkonvertering med open source Cloud SDK för PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertera snabbt FODS till XLSM via PHP" %}}
...
1. Ring ```CellsApi.cellsSaveAsPostDocumentSaveAs``` för att få den resulterande XLSM-filen
...
{{% blocks/products/pf/agp/code-autogen title="PHP Kod för FODS till XLSM-konvertering" gistPath="" %}}
```php
