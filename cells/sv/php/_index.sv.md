---
title:  PHP Excel Kalkylarksbearbetning i molnet (via REST API)
description: Kalkylarksmanipulation REST API för att generera, visa, modifiera, kryptera och hantera Excel & OpenOffice-filer i molnet
weight: 100
url: /sv/php
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bearbeta och konvertera kalkylblad i molnet via PHP SDK" h2="Kalkylarksmanipulation REST API för att generera, visa, modifiera, kryptera och hantera Excel & OpenOffice-filer." logoImageSrc="/headers/aspose_cells-for-php.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for PHP" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDK för PHP är byggd för utvecklare för att hjälpa dem att förbättra deras molnbaserade kalkylarksgenerator, visnings- och omvandlarappar programmerade i PHP. Vårt Excel dokumentprocessor moln SDK är baserat på Aspose.Cells. Cloud S43481, 4016143481. DK för PHP finns under en MIT-licens.</p>
<p>Skapa Excel-ark i PHP, arbeta med auto-former, auto-filter, arbetsböcker, kalkylblad, rader, celler, diagram, villkorlig formatering, ListObjects, hyperlänkar, OleObjects, pivottabeller, former, intervall, uppgifter, säkerhet, kalkylbladsvalidering fillagring, allt med enkla Aspose.Cells Cloud SDK för PHP.</p>
<p>Den tillåter också din PHP-kod att konvertera Microsoft Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) & OpenOffice (ODS) kalkylarksdokument till PDF, 0761434, 8161434, 8161434, 8161434, 8161434, 8161434, 800 DIF och MD (Markdown).</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-php.svg" alt="PHP Excel SDK"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-php.svg" alt="PHP Cloud Excel"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
Avancerad Excel Funktioner för hantering av kalkylblad
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Ta bort specifika eller alla OleObjects från kalkylbladet
 ...
 Kom igång med Excel Spreadsheet Processing SDK
    ...
    <p>
 För att komma igång med Aspose.Cells Cloud SDK för PHP behöver du inte installera någonting. Allt du behöver göra är att skapa ett konto på
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose för Cloud
     </a>
och få din ansökningsinformation. När du har appens SID &amp; nyckel är du redo att använda Aspose.Cells Cloud SDK för PHP på vilken plattform som helst som stöder REST API:er. Aspose.Cells Cloud SDK för PHP ger dig alla funktioner för att skapa, redigera och konvertera kalkylblad. Det låter dig också extrahera data från kalkylbladen för vidare bearbetning eller lagring.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Cloud SDK för att bearbeta arbetsblad
    ...
    <p>
Genom att använda Aspose.Cells Cloud SDK för PHP kan du ta bort specifik rad eller alla rader i kalkylbladet, hämta kalkylbladscelldata eller cellstil efter cellnamn, läsa kalkylbladsrads- eller kolumndata efter dess index, beräkna cellformel, rensa cellinnehåll, kopiera cell till en annan cell, kopiera kalkylbladskolumner och rader, gruppera kalkylbladsrader och kolumner, dölj kalkylbladsrader och kolumner, ställ in kalkylbladskolumner och radstilar, ställ in HTMLSTRING-värde i cell, ställ in cellintervallsvärde och ändra många andra kalkylbladsinställningar.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Utnyttja kraften i pivottabeller &amp; Avstånd
    ...
    <p>
 Aspose.Cells Cloud SDK för PHP låter dig lägga till en pivottabell i kalkylbladet, lägga till eller ta bort pivotfält i pivottabellen, lägga till eller ta bort pivotfilter för pivottabellindex, uppdatera cellstil för pivottabell och beräkna pivottabellens data till celler.
    </p>
    <p>
Aspose.Cells Cloud SDK för PHP kan också användas för att få en celllista i ett intervall efter intervallnamn eller radkolumnindex, ställa in intervallets kolumnbredd, kombinera ett intervall av celler till en enda cell, flytta det aktuella intervallet till destinationsintervallet, ställa in kontur gränsen runt ett cellintervall., ställ in radhöjd för intervall, ställ in stilen för intervallet, tar bort sammanslagna celler i det här intervallet, sätt ett värde i intervallet och konvertera dess datatyp och kopiera intervall i kalkylbladet.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-php" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Cells Cloud SDK för PHP?" tabId="success-stories" >}}
