...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exportar ODS a archivo XLSX en la nube" h2="Excel y exportación de hojas de cálculo de OpenOffice con Cloud SDK de código abierto para PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Exoptar ODS a archivo XLSX en Cloud SDK para PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Código para conversión de ODS a XLSX" gistPath="" %}}
```php
