---
title: Exportera Ods till XLSX-fil via PHP
...
url: /sv/php/export/ods-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exportera ODS till XLSX-fil i molnet" h2="Excel & OpenOffice-kalkylbladsexport med open source Cloud SDK för PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Exoprera ODS till XLSX-fil i Cloud SDK för PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Kod för ODS till XLSX-konvertering" gistPath="" %}}
```php
