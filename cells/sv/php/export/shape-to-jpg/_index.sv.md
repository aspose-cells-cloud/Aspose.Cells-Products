...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera SHAPE till JPG från Excel" h2="PHP-bibliotek för att exportera SHAPE till JPG-fil" p="Använd Export API av Cells Cloud för att exportera Excel fil interna objekt arbetsflöden i PHP. Detta är en professionell lösning för att exportera SHAPE till JPG-format fil från kalkylblad online med PHP." urlsection="export/shape-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera SHAPE-objekt till JPG-formatfil med Cells Cloud SDK för PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i PHP med REST API för att exportera SHAPE till JPG-format från kalkylark" gistPath="" %}}
