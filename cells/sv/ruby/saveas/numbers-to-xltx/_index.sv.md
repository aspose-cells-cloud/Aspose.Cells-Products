...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara NUMBERS som XLTX" h2="Ruby-bibliotek för att spara NUMBERS som XLTX" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Ruby. Detta är en professionell lösning för att spara NUMBERS som XLTX och andra dokumentformat online med Ruby." urlsection="saveas/numbers-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en NUMBERS-fil som XLTX i Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby Code Exempel för att spara NUMBERS som XLTX med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar NUMBERS som XLTX med hjälp av Cells Cloud Ruby-biblioteket." >}}
