...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till TSV med Ruby" h2="Läs, redigera och exportera Excel data till andra format med open source Cloud SDK för Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till TSV-konvertering med Ruby" %}}
...
1. Ring ```CellsApi.cells_save_as_post_document_save_as```-metoden för att få den resulterande TSV-filen
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-kod för FODS till TSV-konvertering" gistPath="" %}}
```ruby
