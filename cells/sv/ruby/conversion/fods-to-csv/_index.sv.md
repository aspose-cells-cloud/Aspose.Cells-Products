---
title:  Convertir de Excel FODS a CSV via Rubí
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a CSV con Ruby" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de FODS a CSV con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para la conversión de FODS a CSV" gistPath="" %}}
```ruby
