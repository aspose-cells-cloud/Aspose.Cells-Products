...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till XLSX med Ruby" h2="Läs, redigera och exportera Excel data till andra format med open source Cloud SDK för Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till XLSX Konvertering med Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby-kod för FODS till XLSX-konvertering" gistPath="" %}}
```ruby
