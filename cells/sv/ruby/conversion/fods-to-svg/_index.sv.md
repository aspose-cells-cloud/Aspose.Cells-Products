...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera FODS till SVG med Ruby" h2="Läs, redigera och exportera Excel data till andra format med open source Cloud SDK för Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS till SVG Konvertering med Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Ruby Code för FODS till SVG Konvertering" gistPath="" %}}
```ruby
