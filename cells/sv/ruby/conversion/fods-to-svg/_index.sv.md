...
{{% blocks/products/pf/agp/feature-section-col title="FODS a SVG Conversión con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para FODS a SVG Conversión" gistPath="" %}}
```ruby
