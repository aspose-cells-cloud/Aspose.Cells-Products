...
{{% blocks/products/pf/agp/feature-section-col title="FODS a HTML Conversión con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para FODS a HTML Conversión" gistPath="" %}}
```ruby
