---
title:  Convertir de Excel FODS a XPS via Rubí
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a XPS con Ruby" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS a XPS Conversión con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para FODS a XPS Conversión" gistPath="" %}}
```ruby
