---
title:  Convertir de Excel FODS a TIFF via Rubí
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta FODS a TIFF con Ruby" h2="Lea, edite y exporte datos Excel a otros formatos con Cloud SDK de código abierto para Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS a TIFF Conversión con Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código Ruby para FODS a TIFF Conversión" gistPath="" %}}
```ruby
