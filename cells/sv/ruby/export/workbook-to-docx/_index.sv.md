...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera ARBETSBOK till DOCX från Excel" h2="Ruby-bibliotek för att exportera WORKBOOK till DOCX-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till DOCX-formatfil från kalkylblad online med Ruby." urlsection="export/workbook-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera WORKBOOK-objekt till DOCX-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby med REST API för att exportera ARBETSBOK till DOCX-format från kalkylblad" gistPath="" %}}
