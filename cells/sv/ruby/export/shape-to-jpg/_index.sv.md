---
title: Exportera SHAPE till JPG från kalkylblad med Ruby API
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API för att exportera SHAPE till JPG-fil" h2="Ruby-bibliotek för att exportera SHAPE till JPG-fil" p="Använd Cells Export REST API för att exportera arbetsflöden för interna objekt i kalkylark i Ruby. Detta är en professionell lösning för att exportera SHAPE till JPG-formatfil från kalkylblad online med Ruby." urlsection="export/shape-to-jpg/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man använder Ruby API för att exportera SHAPE till JPG" >}}
