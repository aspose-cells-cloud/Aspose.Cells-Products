...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera ARBETSBLAD till MD från Excel" h2="Ruby-bibliotek för export av WORKSHEET till MD-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBLAD till MD-formatfil från kalkylblad online med Ruby." urlsection="export/worksheet-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera WORKSHEET-objekt till MD-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby med REST API för att exportera WORKSHEET till MD-format från kalkylblad" gistPath="" %}}
