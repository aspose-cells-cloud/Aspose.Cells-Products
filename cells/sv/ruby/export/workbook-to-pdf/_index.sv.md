...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera ARBETSBOK till PDF från Excel" h2="Ruby-bibliotek för att exportera ARBETSBOK till PDF-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till fil i formatet PDF från kalkylblad online med Ruby." urlsection="export/workbook-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera WORKBOOK-objekt till filformatet PDF med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby med REST API för att exportera ARBETSBOK till PDF-format från kalkylblad" gistPath="" %}}
