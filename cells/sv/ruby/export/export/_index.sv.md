---
title:
description: "Cloud API:er och SDK:er för att skydda Microsoft Excel & OpenOffice Calc. Kryptera lokala kalkylblad med lösenord med Cells Cloud API."
url: /sv/ruby/export/export/
---
...
1. Initiera ```LightCellsAPI``` med klient-id, klienthemlighet, basadress och API-version
1.  Ring ```post_export``` metod för att
