...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportera SHAPE till WMF från Excel" h2="Ruby-bibliotek för att exportera SHAPE till WMF-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera SHAPE till WMF-formatfil från kalkylblad online med Ruby." urlsection="export/shape-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportera SHAPE-objekt till WMF-formatfil med Cells Cloud SDK för Ruby" >}}
