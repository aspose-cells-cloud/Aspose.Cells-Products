...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera SHAPE till EMF från Excel" h2="Ruby-bibliotek för att exportera SHAPE till EMF-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera SHAPE till EMF filformat från kalkylblad online med Ruby." urlsection="export/shape-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera SHAPE-objekt till EMF-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby med REST API för att exportera SHAPE till EMF-format från kalkylark" gistPath="" %}}
