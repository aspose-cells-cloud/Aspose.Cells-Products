...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera LISTOBJECT till SQL från Excel" h2="Ruby-bibliotek för att exportera LISTOBJECT till SQL-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera LISTOBJECT till SQL-formatfil från kalkylblad online med Ruby." urlsection="export/listobject-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera LISTOBJECT-objekt till SQL-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby som använder REST API för att exportera LISTOBJECT till SQL-format från kalkylblad" gistPath="" %}}
