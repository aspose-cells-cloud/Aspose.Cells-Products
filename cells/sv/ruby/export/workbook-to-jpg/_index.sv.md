...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportera ARBETSBOK till JPG från Excel" h2="Ruby-bibliotek för att exportera ARBETSBOK till JPG-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till JPG-formatfil från kalkylblad online med Ruby." urlsection="export/workbook-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportera WORKBOOK-objekt till JPG-formatfil med Cells Cloud SDK för Ruby" >}}
