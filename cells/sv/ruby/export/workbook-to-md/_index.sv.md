...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera ARBETSBOK till MD från Excel" h2="Ruby-bibliotek för att exportera ARBETSBOK till MD-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till fil i MD-format från kalkylblad online med Ruby." urlsection="export/workbook-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera WORKBOOK-objekt till MD-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby med REST API för att exportera ARBETSBOK till MD-format från kalkylblad" gistPath="" %}}
