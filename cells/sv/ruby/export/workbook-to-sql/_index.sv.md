...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera ARBETSBOK till SQL från Excel" h2="Ruby-bibliotek för att exportera ARBETSBOK till SQL-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till SQL-formatfil från kalkylblad online med Ruby." urlsection="export/workbook-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera WORKBOOK-objekt till SQL-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby som använder REST API för att exportera ARBETSBOK till SQL-format från kalkylblad" gistPath="" %}}
