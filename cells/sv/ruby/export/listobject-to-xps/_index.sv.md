...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportera LISTOBJECT till XPS från Excel" h2="Ruby-bibliotek för export av LISTOBJECT till XPS-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera LISTOBJECT till XPS filformat från kalkylblad online med Ruby." urlsection="export/listobject-to-xps/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportera LISTOBJECT-objekt till XPS-formatfil med Cells Cloud SDK för Ruby" >}}
