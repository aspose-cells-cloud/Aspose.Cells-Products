...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exportera ARBETSBOK till JSON från Excel" h2="Ruby-bibliotek för export av WORKBOOK till JSON-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till JSON-formatfil från kalkylblad online med Ruby." urlsection="export/workbook-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportera WORKBOOK-objekt till JSON-formatfil med Cells Cloud SDK för Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Kodexempel i Ruby som använder REST API för att exportera ARBETSBOK till JSON-format från kalkylark" gistPath="" %}}
