...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Exportera ARBETSBOK till WMF från Excel" h2="Ruby-bibliotek för att exportera WORKBOOK till WMF-fil" p="Använd Exportera API av Cells Cloud för att exportera Excel filinterna objektarbetsflöden i Ruby. Detta är en professionell lösning för att exportera ARBETSBOK till WMF-formatfil från kalkylblad online med Ruby." urlsection="export/workbook-to-wmf/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportera WORKBOOK-objekt till WMF-formatfil med Cells Cloud SDK för Ruby" >}}
