---
title:  Skapa kalkylblad i molnet (med cURL via REST API)
...
{{< blocks/products/pf/i18n/upper-banner h1="Process Excel Ark i molnet via cURL" h2="Använd cURL-kommandon för att skapa kalkylarks- och konverterappar som får åtkomst till Microsoft Excel- och OpenOffice-filer från molnlagring för bearbetning." logoImageSrc="/headers/aspose_cells-for-curl.svg" pfName="Aspose.Cells" subTitlepfName="Cloud for cURL" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud för cURL är byggt ovanpå Aspose.Cells Cloud REST API:er som hjälper cURL utvecklare att skapa molnbaserade applikationer för att visa, modifiera och konvertera Microsoft Excel och OpenOffice-kalkylarket, utan någon installation i molnet. Aspose.Cells Cloud för cURL distribueras under en MIT-licens.</p>
<p>Aspose.Cells Cloud för cURL, förbättrar dina molnbaserade program för att fungera med kalkylblad, arbetsböcker, kalkylblad, rader, celler, diagram, bilder, listobjekt, pivottabeller och uppgifter.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-curl.svg" alt="cURL to manipulate Spreadsheets"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-curl.svg" alt="Spreadsheet manipulation via cURL"><header>Aspose.Cells</header><footer> Moln<small> <em> för</em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Cells Cloud för cURL?" tabId="success-stories" >}}
