...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLS som MD" h2="Gå till biblioteket för att spara XLS som MD" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Go. Detta är en professionell lösning för att spara XLS som MD och andra dokumentformat online med hjälp av Go." urlsection="saveas/xls-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLS-fil som MD i Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go Code Exempel för att spara XLS som MD med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Hur man sparar XLS som MD med hjälp av Cells Cloud Go-biblioteket." >}}
