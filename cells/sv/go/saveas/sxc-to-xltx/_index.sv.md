...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara SXC som XLTX" h2="Gå till biblioteket för att spara SXC som XLTX" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Go. Detta är en professionell lösning för att spara SXC som XLTX och andra dokumentformat online med Go." urlsection="saveas/sxc-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en SXC-fil som XLTX i Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go Code Exempel för att spara SXC som XLTX med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar SXC som XLTX med hjälp av Cells Cloud Go-biblioteket." >}}
