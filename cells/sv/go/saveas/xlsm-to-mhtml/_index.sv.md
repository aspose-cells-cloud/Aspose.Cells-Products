...
---
{{< blocks/products/cells/cells-cloud-banner h1="Spara XLSM som MHTML" h2="Gå bibliotek för att spara XLSM som MHTML" p="Använd SaveAs API av Cells Cloud för att skapa anpassade kalkylbladsarbetsflöden i Go. Detta är en professionell lösning för att spara XLSM som MHTML och andra dokumentformat online med Go." urlsection="saveas/xlsm-to-mhtml/" >}}

{{< blocks/products/cells/cells-cloud-section title="Spara en XLSM-fil som MHTML i Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go Code Exempel för att spara XLSM som MHTML med REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Lär dig hur du sparar XLSM som MHTML med hjälp av Cells Cloud Go-biblioteket." >}}
