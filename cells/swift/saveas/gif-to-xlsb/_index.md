---
title: Save GIF as XLSB via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save GIF file as  XLSB file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save GIF file as XLSB file in Cloud SDK for Swift " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for saving GIF as XLSB " gistPath="" %}}
```swift
