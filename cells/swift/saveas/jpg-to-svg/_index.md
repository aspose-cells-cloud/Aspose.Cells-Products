---
title: Save JPG as SVG via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Save JPG file as  SVG file in the Cloud" h2="Excel & OpenOffice spreadsheet saveas with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Save JPG file as SVG file in Cloud SDK for Swift " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for saving JPG as SVG " gistPath="" %}}
```swift
