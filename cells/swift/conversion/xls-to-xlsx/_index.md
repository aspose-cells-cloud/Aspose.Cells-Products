...
outformat: XLSX
platform: Swift
otherformats: DIF TSV XLSX XLTM TIFF XLTX XLSB MHTML SVG MD XLSM ODS CSV FODS PDF TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSX with Swift" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSX Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to XLSX Conversion" gistPath="" %}}
```swift
