---
title: Convert XLS to GIF via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to  GIF in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to GIF Conversion in Cloud SDK for Swift " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to GIF Conversion" gistPath="" %}}
```swift
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=xls  outputformat=gif  %}}
