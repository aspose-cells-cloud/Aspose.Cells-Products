---
title: Convert XML to ODS via Swift 
...
outformat: ODS
platform: Swift
otherformats: TSV XLS XLSB DIF TXT CSV XLTX ODS HTML XLSX XLSM SVG FODS SXC XLTM MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to ODS with Swift" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XML to ODS Conversion" gistPath="" %}}
```swift
