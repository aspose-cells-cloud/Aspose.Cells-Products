---
title: Convert XLT to FODS via Swift 
...
outformat: FODS
platform: Swift
otherformats: CSV TSV TXT TIFF XML FODS XLSB XLSX SVG MHTML DIF XLSM MD SXC XPS PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLT to FODS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLT to FODS Conversion" gistPath="" %}}
```swift
