---
title: Convert TXT to HTML via Swift 
...
outformat: HTML
platform: Swift
otherformats: ODS XLSX SXC PDF XPS XML DIF TSV FODS XLTM TIFF HTML XLSM XLSB MHTML XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to HTML with Swift" h2="Read, Edit & Export Excel data to other formats like HTML with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to HTML Conversion" gistPath="" %}}
```swift
