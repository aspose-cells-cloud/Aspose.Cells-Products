...
outformat: XML
platform: Swift
otherformats: HTML DIF XLTX CSV XLSX PDF XLTM XLSM SXC MD XLSB FODS TIFF XML MHTML TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XML with Swift" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to XML Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to XML Conversion" gistPath="" %}}
```swift
