---
title: Convert XLS to CSV via Swift 
...
outformat: CSV
platform: Swift
otherformats: XML HTML XLTM XLSM TXT XLSX ODS SVG XLTX TIFF XPS SXC DIF TSV CSV MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to CSV with Swift" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to CSV Conversion" gistPath="" %}}
```swift
