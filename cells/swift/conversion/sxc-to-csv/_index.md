---
title: Convert SXC to CSV via Swift 
...
outformat: CSV
platform: Swift
otherformats: CSV XLTX PDF ODS XML XLSX MD XLSB MHTML XLTM SVG TIFF FODS SXC XLSM XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to CSV with Swift" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to CSV Conversion" gistPath="" %}}
```swift
