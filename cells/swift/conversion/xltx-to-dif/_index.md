---
title: Convert XLTX to DIF via Swift 
...
outformat: DIF
platform: Swift
otherformats: MD TXT FODS XLS XLTM SXC DIF PDF TIFF XML TSV XLSX CSV XLSB SVG MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to DIF with Swift" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLTX to DIF Conversion" gistPath="" %}}
```swift
