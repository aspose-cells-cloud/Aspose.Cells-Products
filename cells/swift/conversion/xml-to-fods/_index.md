...
outformat: FODS
platform: Swift
otherformats: XPS MHTML DIF SXC XLS XLSB XLSX TSV CSV XLTM XLSM MD FODS SVG TXT PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
