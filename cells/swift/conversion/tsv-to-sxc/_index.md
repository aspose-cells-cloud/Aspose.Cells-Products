---
title: Convert TSV to SXC via Swift 
...
outformat: SXC
platform: Swift
otherformats: PDF MHTML ODS FODS XLSX MD DIF XLTM XLSM TXT TIFF XLSB XLTX SVG XPS XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TSV to SXC Conversion" gistPath="" %}}
```swift
