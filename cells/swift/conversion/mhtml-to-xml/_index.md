...
outformat: XML
platform: Swift
otherformats: XLSX SXC DIF TXT XLTX XML XPS ODS TSV PDF TIFF XLSB FODS XLTM HTML CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XML with Swift" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to XML Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for MHTML to XML Conversion" gistPath="" %}}
```swift
