---
title: Convert XLSX to HTML via Swift 
...
outformat: HTML
platform: Swift
otherformats: HTML CSV MD XLTX PDF DIF FODS XPS XML XLS XLSM MHTML XLSB SXC TXT TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to HTML with Swift" h2="Read, Edit & Export Excel data to other formats like HTML with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSX to HTML Conversion" gistPath="" %}}
```swift
