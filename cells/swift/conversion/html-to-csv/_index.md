...
outformat: CSV
platform: Swift
otherformats: SVG XLT MD XLTM DIF XLSB XLSM MHTML CSV SXC TXT PDF XML TIFF FODS XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to CSV with Swift" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Swift">}}
