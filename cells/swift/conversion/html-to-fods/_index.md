---
title: Convert HTML to FODS via Swift 
...
outformat: FODS
platform: Swift
otherformats: MHTML SVG MD XLSM XLSB TXT XLTM ODS DIF TSV TIFF XML CSV XLTX XPS XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for HTML to FODS Conversion" gistPath="" %}}
```swift
