---
title: Convert CSV to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: XLTM FODS TSV MHTML TXT PDF XLSM MD XLSB DIF SXC XLSX TIFF SVG XML XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for CSV to XPS Conversion" gistPath="" %}}
```swift
