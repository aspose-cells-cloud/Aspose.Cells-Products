...
outformat: SXC
platform: Swift
otherformats: XLSX ODS TSV SXC XML DIF MHTML TXT FODS MD CSV XPS SVG XLTX XLSB TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to SXC Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to SXC Conversion" gistPath="" %}}
```swift
