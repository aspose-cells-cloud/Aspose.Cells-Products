---
title: Convert SXC to XLSB via Swift 
...
outformat: XLSB
platform: Swift
otherformats: TXT MHTML XML PDF XLS TSV XLSM SXC XLSB TIFF SVG XLTM ODS XPS MD CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSB with Swift" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to XLSB Conversion" gistPath="" %}}
```swift
