---
title: Convert XLSB to FODS via Swift 
...
outformat: FODS
platform: Swift
otherformats: TSV XLSM XLSX CSV SVG TIFF XLTM XML XLTX DIF ODS TXT XPS MHTML FODS SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSB to FODS Conversion" gistPath="" %}}
```swift
