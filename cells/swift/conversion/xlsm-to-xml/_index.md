---
title: Convert XLSM to XML via Swift 
...
outformat: XML
platform: Swift
otherformats: SXC DIF XLS HTML TXT XPS XML XLSX XLT XLTX PDF XLTM TIFF TSV CSV MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XML with Swift" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to XML Conversion" gistPath="" %}}
```swift
