---
title: Convert XLSB to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: ODS SXC XLSM XLTM DIF FODS MHTML MD SVG PDF TSV XPS XML CSV XLSX TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to XPS Conversion in the Cloud" %}}
...
1. Call ```CellsAPI.cellsSaveAsPostDocumentSaveAs``` method to get the resultant XPS file
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSB to XPS Conversion" gistPath="" %}}
```swift
...
let saveOptions:SaveOptions? = XpsSaveOptions(enableHTTPCompression: nil, saveFormat: "xps", clearData: nil, cachedFileFolder: nil, validateMergedAreas: nil, refreshChartCache: nil, createDirectory: nil, sortNames: nil, calculateFormula: nil, checkFontCompatibility: nil, onePagePerSheet: nil, compliance: nil, defaultFont: nil, printingPageType: nil, imageType: nil, desiredPPI: nil, jpegQuality: nil, securityOptions: nil)
let newfilename:String = "output.xps"
