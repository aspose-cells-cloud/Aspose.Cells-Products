---
title: Convert TXT to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: XLTM PDF CSV MD XML SXC XLSX DIF XLSM XLTX TIFF ODS XPS HTML TSV MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to XPS Conversion" gistPath="" %}}
```swift
