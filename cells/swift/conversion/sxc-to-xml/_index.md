---
title: Convert SXC to XML via Swift 
...
outformat: XML
platform: Swift
otherformats: TXT XLSX TIFF PDF XLTM MHTML XPS SXC FODS XLSM MD TSV SVG XLSB CSV XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XML with Swift" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to XML Conversion" gistPath="" %}}
```swift
