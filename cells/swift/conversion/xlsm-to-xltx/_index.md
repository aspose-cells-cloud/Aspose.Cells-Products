---
title: Convert XLSM to XLTX via Swift 
...
outformat: XLTX
platform: Swift
otherformats: DIF XLSX SXC MHTML MD TXT XLSB ODS SVG PDF TSV TIFF XLT XML XLTX CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLTX with Swift" h2="Read, Edit & Export Excel data to other formats like XLTX with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to XLTX Conversion in the Cloud" %}}
1. Create an account at <a href="https://dashboard.aspose.cloud/">Dashboard</a> to get free API quota & authorization details
1. Initialize ```SaveOptions``` as per desired output format
1. Upload XLSM file to default Cloud Storage with ```uploadFile``` method
1. Call ```CellsAPI.cellsSaveAsPostDocumentSaveAs``` method to get the resultant XLTX file
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to XLTX Conversion" gistPath="" %}}
```swift
...
let name:String = "template.xlsm"
let saveOptions:SaveOptions? = XltxSaveOptions(enableHTTPCompression: nil, saveFormat: "xltx", clearData: nil, cachedFileFolder: nil, validateMergedAreas: nil, refreshChartCache: nil, createDirectory: nil, sortNames: nil, calculateFormula: nil, checkFontCompatibility: nil, onePagePerSheet: nil, compliance: nil, defaultFont: nil, printingPageType: nil, imageType: nil, desiredPPI: nil, jpegQuality: nil, securityOptions: nil)
let newfilename:String = "output.xltx"
