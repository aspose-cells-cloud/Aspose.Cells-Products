---
title: Convert TSV to ODS via Swift 
...
outformat: ODS
platform: Swift
otherformats: MHTML DIF SVG ODS XLT SXC XLTX XLSX CSV FODS TIFF PDF XLSB TXT XML XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to ODS with Swift" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TSV to ODS Conversion" gistPath="" %}}
```swift
