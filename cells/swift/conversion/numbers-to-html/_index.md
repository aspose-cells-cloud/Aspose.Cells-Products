---
title: Convert NUMBERS to HTML via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert NUMBERS to  HTML in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="NUMBERS to HTML Conversion in Cloud SDK for Swift " %}}
1. Create an account at <a href="https://dashboard.aspose.cloud/">Dashboard</a> to get free API quota & authorization details
1. Initialize ```CellsApi``` with Client Id, Client Secret, Base URL & API version
1. Call ```cellsWorkbookPutConvertWorkbook``` method to get the resultant HTML stream
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for NUMBERS to HTML Conversion" gistPath="" %}}
```swift
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=numbers  outputformat=html  %}}
