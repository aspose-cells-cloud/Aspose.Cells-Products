---
title: Convert XLS to XLSM via Swift 
...
outformat: XLSM
platform: Swift
otherformats: MD XPS DIF XLT XML XLSM XLSX TSV SVG TXT CSV ODS XLTM FODS PDF MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSM with Swift" h2="Read, Edit & Export Excel data to other formats like XLSM with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSM Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to XLSM Conversion" gistPath="" %}}
```swift
