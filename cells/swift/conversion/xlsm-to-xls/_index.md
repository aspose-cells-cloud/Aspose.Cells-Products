...
outformat: XLS
platform: Swift
otherformats: MHTML PDF SXC CSV XLS XLTM FODS XPS SVG DIF MD TIFF TXT XML XLTX TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLS with Swift" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Swift">}}
