---
title: Convert HTML to XLSB via Swift 
...
outformat: XLSB
platform: Swift
otherformats: TIFF XPS XLTX FODS SXC DIF XLTM XML MHTML MD XLSM TXT TSV SVG XLSX PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XLSB with Swift" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for HTML to XLSB Conversion" gistPath="" %}}
```swift
