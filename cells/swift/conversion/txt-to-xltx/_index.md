---
title: Convert TXT to XLTX via Swift 
...
outformat: XLTX
platform: Swift
otherformats: XLSB XML XLTX XLTM XPS MHTML TSV CSV FODS TIFF DIF XLSM SVG PDF SXC MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XLTX with Swift" h2="Read, Edit & Export Excel data to other formats like XLTX with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to XLTX Conversion" gistPath="" %}}
```swift
