---
title: Convert MHTML to DIF via Swift 
...
outformat: DIF
platform: Swift
otherformats: FODS DIF TXT XLSB XLSM XLTX TSV XLSX TIFF HTML SVG XLTM XML XPS MD CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to DIF with Swift" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to DIF Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for MHTML to DIF Conversion" gistPath="" %}}
```swift
