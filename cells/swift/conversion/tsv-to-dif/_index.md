---
title: Convert TSV to DIF via Swift 
...
outformat: DIF
platform: Swift
otherformats: XLTX XLTM DIF XML XLSX ODS XLSM MHTML FODS TXT CSV SXC PDF SVG TIFF XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to DIF with Swift" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TSV to DIF Conversion" gistPath="" %}}
```swift
