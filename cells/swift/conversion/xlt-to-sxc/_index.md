---
title: Convert XLT to SXC via Swift 
...
outformat: SXC
platform: Swift
otherformats: DIF SXC XLSX MD TIFF XLTX XLTM CSV XLSM XPS XLSB XML TSV TXT FODS PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLT to SXC Conversion" gistPath="" %}}
```swift
