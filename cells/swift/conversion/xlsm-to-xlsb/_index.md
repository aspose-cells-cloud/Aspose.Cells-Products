---
title: Convert XLSM to XLSB via Swift 
...
outformat: XLSB
platform: Swift
otherformats: XLT XLSB MD TSV ODS TXT XPS SXC HTML XLSX TIFF XLTX DIF CSV FODS MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XLSB with Swift" h2="Read, Edit & Export Excel data to other formats like XLSB with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to XLSB Conversion in the Cloud" %}}
...
1. Call ```CellsAPI.cellsSaveAsPostDocumentSaveAs``` method to get the resultant XLSB file
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to XLSB Conversion" gistPath="" %}}
```swift
