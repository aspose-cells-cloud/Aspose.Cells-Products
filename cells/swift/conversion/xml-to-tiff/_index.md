---
title: Convert XML to TIFF via Swift 
...
outformat: TIFF
platform: Swift
otherformats: MHTML XLTX XLSM TXT SVG DIF FODS MD XLTM TIFF XLSX TSV CSV PDF SXC XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to TIFF with Swift" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to TIFF Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XML to TIFF Conversion" gistPath="" %}}
```swift
