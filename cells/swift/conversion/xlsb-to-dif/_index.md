...
outformat: DIF
platform: Swift
otherformats: MHTML TXT SXC PDF XLSX XLTX MD TIFF TSV XLSM SVG XPS ODS XML FODS XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to DIF with Swift" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to DIF Conversion in the Cloud" %}}
...
1. Call ```CellsAPI.cellsSaveAsPostDocumentSaveAs``` method to get the resultant DIF file
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSB to DIF Conversion" gistPath="" %}}
```swift
...
let saveOptions:SaveOptions? = DifSaveOptions(enableHTTPCompression: nil, saveFormat: "dif", clearData: nil, cachedFileFolder: nil, validateMergedAreas: nil, refreshChartCache: nil, createDirectory: nil, sortNames: nil, calculateFormula: nil, checkFontCompatibility: nil, onePagePerSheet: nil, compliance: nil, defaultFont: nil, printingPageType: nil, imageType: nil, desiredPPI: nil, jpegQuality: nil, securityOptions: nil)
let newfilename:String = "output.dif"
