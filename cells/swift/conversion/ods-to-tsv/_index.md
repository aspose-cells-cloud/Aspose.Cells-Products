---
title: Convert ODS to TSV via Swift 
...
outformat: TSV
platform: Swift
otherformats: XLSX SXC XML FODS TSV XLSB XLT CSV DIF PDF MHTML XLSM MD TXT SVG XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to TSV with Swift" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for ODS to TSV Conversion" gistPath="" %}}
```swift
