---
title: Convert SXC to XLS via Swift 
...
outformat: XLS
platform: Swift
otherformats: XLT XPS XLTM CSV XLS PDF TSV TIFF MD FODS HTML XLSX XLSB SVG XLSM MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLS with Swift" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to XLS Conversion" gistPath="" %}}
```swift
