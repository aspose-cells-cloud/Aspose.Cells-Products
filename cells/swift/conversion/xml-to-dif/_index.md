...
outformat: DIF
platform: Swift
otherformats: TXT TIFF XLT XLSB MD SVG HTML TSV CSV SXC XPS XLSX DIF ODS XLTM FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to DIF with Swift" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to DIF Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XML to DIF Conversion" gistPath="" %}}
```swift
