---
title: Convert CSV to XLS via Swift 
...
outformat: XLS
platform: Swift
otherformats: MD SXC TIFF XLTX TXT XLSB ODS FODS HTML DIF XPS XLSX SVG XML XLSM MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XLS with Swift" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to XLS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for CSV to XLS Conversion" gistPath="" %}}
```swift
