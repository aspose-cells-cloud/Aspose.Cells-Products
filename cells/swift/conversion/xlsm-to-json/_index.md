---
title: Convert XLSM to JSON via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to  JSON in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to JSON Conversion in Cloud SDK for Swift " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to JSON Conversion" gistPath="" %}}
```swift
