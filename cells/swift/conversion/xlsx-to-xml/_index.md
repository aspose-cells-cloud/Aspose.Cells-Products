---
title: Convert XLSX to XML via Swift 
...
outformat: XML
platform: Swift
otherformats: XLSM FODS SXC DIF MD HTML MHTML XLT XPS TIFF TXT XLSB XLTM XLTX TSV SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XML with Swift" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSX to XML Conversion" gistPath="" %}}
```swift
