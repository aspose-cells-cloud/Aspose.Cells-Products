---
title: Convert HTML to TSV via Swift 
...
outformat: TSV
platform: Swift
otherformats: PDF XPS XLT CSV XLSB FODS XLSM MD XML DIF TIFF TSV XLTM TXT XLSX SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to TSV with Swift" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to TSV Conversion in the Cloud" %}}
...
1. Call ```CellsAPI.cellsSaveAsPostDocumentSaveAs``` method to get the resultant TSV file
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for HTML to TSV Conversion" gistPath="" %}}
```swift
...
let saveOptions:SaveOptions? = TsvSaveOptions(enableHTTPCompression: nil, saveFormat: "tsv", clearData: nil, cachedFileFolder: nil, validateMergedAreas: nil, refreshChartCache: nil, createDirectory: nil, sortNames: nil, calculateFormula: nil, checkFontCompatibility: nil, onePagePerSheet: nil, compliance: nil, defaultFont: nil, printingPageType: nil, imageType: nil, desiredPPI: nil, jpegQuality: nil, securityOptions: nil)
let newfilename:String = "output.tsv"
