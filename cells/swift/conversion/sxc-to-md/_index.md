...
outformat: MD
platform: Swift
otherformats: HTML SXC XPS XML XLTX TIFF XLSX MHTML FODS XLSM TSV PDF TXT XLSB CSV SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to MD with Swift" h2="Read, Edit & Export Excel data to other formats like MD with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to MD Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to MD Conversion" gistPath="" %}}
```swift
