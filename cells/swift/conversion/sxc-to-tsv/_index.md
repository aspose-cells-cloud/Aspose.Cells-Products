---
title: Convert SXC to TSV via Swift 
...
outformat: TSV
platform: Swift
otherformats: HTML XLSB TXT SVG XLSX SXC XLSM PDF XLTX MD XML MHTML ODS TSV TIFF XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TSV with Swift" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to TSV Conversion" gistPath="" %}}
```swift
