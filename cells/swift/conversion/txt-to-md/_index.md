---
title: Convert TXT to MD via Swift 
...
outformat: MD
platform: Swift
otherformats: XML HTML DIF XLSM PDF SVG XLSB XLSX ODS MHTML TIFF FODS XPS SXC CSV XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to MD with Swift" h2="Read, Edit & Export Excel data to other formats like MD with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to MD Conversion" gistPath="" %}}
```swift
