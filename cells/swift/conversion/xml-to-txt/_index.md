---
title: Convert XML to TXT via Swift 
...
outformat: TXT
platform: Swift
otherformats: ODS XLSM TIFF XLTX MD XLTM TXT SVG XLSX XPS HTML SXC CSV PDF FODS DIF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to TXT with Swift" h2="Read, Edit & Export Excel data to other formats like TXT with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to TXT Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XML to TXT Conversion" gistPath="" %}}
```swift
