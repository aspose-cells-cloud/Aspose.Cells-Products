...
outformat: CSV
platform: Swift
otherformats: XLT HTML MD DIF XLTX MHTML XML CSV XPS PDF SVG XLSX XLSB TSV SXC ODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to CSV with Swift" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Swift">}}
