...
outformat: XLS
platform: Swift
otherformats: XLT HTML TXT DIF XLS MHTML SXC XML PDF XLTM XLSX XLTX ODS MD SVG FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLS with Swift" h2="Read, Edit & Export Excel data to other formats like XLS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to XLS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSB to XLS Conversion" gistPath="" %}}
```swift
