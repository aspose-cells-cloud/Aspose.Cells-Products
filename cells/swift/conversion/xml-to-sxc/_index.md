...
outformat: SXC
platform: Swift
otherformats: HTML SXC XLS CSV DIF XLSB TIFF XLTM SVG XLSX TXT XPS PDF MHTML TSV FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
