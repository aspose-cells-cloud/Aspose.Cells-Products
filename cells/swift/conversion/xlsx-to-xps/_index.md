---
title: Convert XLSX to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: SVG CSV TXT FODS DIF PDF XLS XLTX XLSM TIFF HTML XLTM MD XML MHTML XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to XPS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSX to XPS Conversion" gistPath="" %}}
```swift
