---
title: Convert XLS to HTML via Swift 
...
outformat: HTML
platform: Swift
otherformats: XLSX TSV SVG XLSB XLTM TXT XML CSV ODS SXC XLSM XLTX TIFF MHTML FODS XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to HTML with Swift" h2="Read, Edit & Export Excel data to other formats like HTML with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to HTML Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to HTML Conversion" gistPath="" %}}
```swift
