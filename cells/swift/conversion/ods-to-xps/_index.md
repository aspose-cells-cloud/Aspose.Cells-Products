---
title: Convert ODS to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: CSV MD XLT HTML DIF TIFF XLS XLSM XLTM XLSX XLTX TSV FODS MHTML SVG PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODS to XPS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for ODS to XPS Conversion" gistPath="" %}}
```swift
