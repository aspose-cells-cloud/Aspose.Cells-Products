...
outformat: MD
platform: Swift
otherformats: MHTML XLT XLSX DIF ODS TSV PDF XML CSV SVG XPS XLSB FODS XLTM MD SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to MD with Swift" h2="Read, Edit & Export Excel data to other formats like MD with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to MD Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to MD Conversion" gistPath="" %}}
```swift
...
let saveOptions:SaveOptions? = MdSaveOptions(enableHTTPCompression: nil, saveFormat: "md", clearData: nil, cachedFileFolder: nil, validateMergedAreas: nil, refreshChartCache: nil, createDirectory: nil, sortNames: nil, calculateFormula: nil, checkFontCompatibility: nil, onePagePerSheet: nil, compliance: nil, defaultFont: nil, printingPageType: nil, imageType: nil, desiredPPI: nil, jpegQuality: nil, securityOptions: nil)
let newfilename:String = "output.md"
