---
title: Convert TXT to SXC via Swift 
...
outformat: SXC
platform: Swift
otherformats: DIF XLSB FODS XLT XLSX MHTML XLSM PDF TSV SXC CSV MD XLTM XLTX SVG XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to SXC Conversion" gistPath="" %}}
```swift
