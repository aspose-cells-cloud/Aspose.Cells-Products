---
title: Convert CSV to SXC via Swift 
...
outformat: SXC
platform: Swift
otherformats: TXT FODS PDF XLTX XLS XPS DIF XLSX XML TSV XLSM SXC HTML SVG XLSB MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for CSV to SXC Conversion" gistPath="" %}}
```swift
