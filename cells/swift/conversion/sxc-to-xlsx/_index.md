...
outformat: XLSX
platform: Swift
otherformats: HTML XLTX TIFF XLSB SXC XLSX SVG PDF TXT TSV XML XLSM MHTML FODS XPS MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSX with Swift" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Swift">}}
