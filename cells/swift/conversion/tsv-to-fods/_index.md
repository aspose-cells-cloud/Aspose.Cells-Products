---
title: Convert TSV to FODS via Swift 
...
outformat: FODS
platform: Swift
otherformats: DIF XLTM XLS SVG XLTX XLSX XLSM XML ODS MHTML XPS MD PDF SXC TXT TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TSV to FODS Conversion" gistPath="" %}}
```swift
