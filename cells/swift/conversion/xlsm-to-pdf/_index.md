---
title: Convert XLSM to PDF via Swift 
...
outformat: PDF
platform: Swift
otherformats: TXT CSV SVG DIF MD TIFF SXC FODS PDF XLS XLT XLTM XLSB MHTML XML XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to PDF with Swift" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to PDF Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to PDF Conversion" gistPath="" %}}
```swift
