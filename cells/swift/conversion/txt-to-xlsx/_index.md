---
title: Convert TXT to XLSX via Swift 
...
outformat: XLSX
platform: Swift
otherformats: XLSX FODS DIF PDF XLTX SXC CSV MHTML XML XLTM XPS XLSB TSV TIFF XLSM SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XLSX with Swift" h2="Read, Edit & Export Excel data to other formats like XLSX with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for TXT to XLSX Conversion" gistPath="" %}}
```swift
