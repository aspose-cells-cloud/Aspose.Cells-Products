...
outformat: FODS
platform: Swift
otherformats: XLS SVG CSV XLSX DIF XLTM SXC HTML TIFF MD PDF FODS XPS XLSM MHTML TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to FODS Conversion in the Cloud" %}}
