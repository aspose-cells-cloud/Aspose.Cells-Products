---
title: Convert XLSM to TSV via Swift 
...
outformat: TSV
platform: Swift
otherformats: MD FODS SXC HTML SVG XLTM TSV PDF TXT MHTML XML XLSB DIF XLTX TIFF XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to TSV with Swift" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSM to TSV Conversion" gistPath="" %}}
```swift
