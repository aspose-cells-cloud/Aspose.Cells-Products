---
title: Convert XLS to PDF via Swift 
...
outformat: PDF
platform: Swift
otherformats: ODS TXT XLTX PDF XLSX XML FODS XLSB SXC XLTM SVG XPS TSV XLSM DIF HTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to PDF with Swift" h2="Read, Edit & Export Excel data to other formats like PDF with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to PDF Conversion" gistPath="" %}}
```swift
