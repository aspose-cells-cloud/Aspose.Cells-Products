---
title: Convert XLSX to SXC via Swift 
...
outformat: SXC
platform: Swift
otherformats: XLTM PDF XPS CSV DIF XML XLSB MD HTML TSV SXC XLTX XLSM SVG TIFF MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to SXC with Swift" h2="Read, Edit & Export Excel data to other formats like SXC with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to SXC Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSX to SXC Conversion" gistPath="" %}}
```swift
