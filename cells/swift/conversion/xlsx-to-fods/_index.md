...
outformat: FODS
platform: Swift
otherformats: DIF ODS SXC FODS SVG XPS MD XLSM PDF HTML XML TSV TIFF XLT CSV XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
