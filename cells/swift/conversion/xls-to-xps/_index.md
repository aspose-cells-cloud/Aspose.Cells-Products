---
title: Convert XLS to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: XLSM PDF DIF TIFF XLT CSV SXC ODS XLSX TSV MHTML XLTX FODS TXT XLSB XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to XPS Conversion" gistPath="" %}}
```swift
