---
title: Convert XLS to DIF via Swift 
...
outformat: DIF
platform: Swift
otherformats: CSV XPS TIFF XLSB HTML TSV FODS DIF SVG XLSX XLTX MHTML XML XLTM XLSM TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to DIF with Swift" h2="Read, Edit & Export Excel data to other formats like DIF with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to DIF Conversion" gistPath="" %}}
```swift
