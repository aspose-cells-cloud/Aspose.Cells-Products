---
title: Convert XLSB to TIFF via Swift 
...
outformat: TIFF
platform: Swift
otherformats: MHTML XLS FODS TXT XLSM TIFF XLT XLTM XML XLTX TSV SXC DIF PDF XLSX CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to TIFF with Swift" h2="Read, Edit & Export Excel data to other formats like TIFF with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to TIFF Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLSB to TIFF Conversion" gistPath="" %}}
```swift
