---
title: Convert XML to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: XPS XLTM MHTML ODS TIFF SXC TXT MD DIF FODS XLSX CSV XLSB XLSM SVG PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XML to XPS Conversion" gistPath="" %}}
```swift
