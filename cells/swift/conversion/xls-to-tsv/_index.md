---
title: Convert XLS to TSV via Swift 
...
outformat: TSV
platform: Swift
otherformats: XLSM DIF FODS XLT TIFF XLTM XLTX TXT XLSB MD SXC MHTML SVG CSV XPS XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to TSV with Swift" h2="Read, Edit & Export Excel data to other formats like TSV with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to TSV Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to TSV Conversion" gistPath="" %}}
```swift
