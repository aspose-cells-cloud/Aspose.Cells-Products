...
outformat: FODS
platform: Swift
otherformats: PDF XLS DIF XPS SXC HTML ODS FODS XLSM CSV TIFF XLTM SVG MD XLSB TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
