...
outformat: CSV
platform: Swift
otherformats: HTML SXC MHTML TSV TXT TIFF XLT CSV XLS XLTM SVG MD XLTX XLSM XML XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to CSV with Swift" h2="Read, Edit & Export Excel data to other formats like CSV with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to CSV Conversion in the Cloud" %}}
