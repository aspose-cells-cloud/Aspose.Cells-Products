---
title: Convert XLS to XML via Swift 
...
outformat: XML
platform: Swift
otherformats: XLT DIF FODS TIFF XLSB XLSM XPS SXC MD TXT HTML XLSX MHTML SVG XLTX XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XML with Swift" h2="Read, Edit & Export Excel data to other formats like XML with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for XLS to XML Conversion" gistPath="" %}}
```swift
