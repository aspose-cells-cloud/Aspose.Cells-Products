---
title: Convert HTML to ODS via Swift 
...
outformat: ODS
platform: Swift
otherformats: XLTX XLS XML TIFF TSV DIF MHTML SVG TXT FODS PDF XPS XLSB SXC XLTM XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to ODS with Swift" h2="Read, Edit & Export Excel data to other formats like ODS with Open Source Cloud SDK for Swift">}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for HTML to ODS Conversion" gistPath="" %}}
```swift
