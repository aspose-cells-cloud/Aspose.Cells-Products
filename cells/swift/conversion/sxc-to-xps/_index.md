---
title: Convert SXC to XPS via Swift 
...
outformat: XPS
platform: Swift
otherformats: XLT XLTX PDF XLTM FODS MHTML XLSB SXC XLSX XPS TSV XML CSV MD XLSM TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XPS with Swift" h2="Read, Edit & Export Excel data to other formats like XPS with Open Source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to XPS Conversion in the Cloud" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SXC to XPS Conversion" gistPath="" %}}
```swift
