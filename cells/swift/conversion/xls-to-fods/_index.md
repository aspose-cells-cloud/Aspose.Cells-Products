...
outformat: FODS
platform: Swift
otherformats: XLSB MD XML TSV MHTML SVG FODS CSV XLT SXC XPS TXT DIF XLSX XLSM XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to FODS with Swift" h2="Read, Edit & Export Excel data to other formats like FODS with Open Source Cloud SDK for Swift">}}
