---
title: Export Chart to WMF file via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Chart to WMF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Chart to WMF file in Cloud SDK for Swift " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for CHART to WMF Conversion" gistPath="" %}}
```swift
