---
title: Export Shape to GIF file via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Shape to GIF file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Export Shape to GIF file in Cloud SDK for Swift " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Swift Code for SHAPE to GIF Conversion" gistPath="" %}}
```swift
