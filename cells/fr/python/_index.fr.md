...
<p>Aspose.Cells Cloud SDK pour Python vous aide à développer des applications cloud de création, de visualisation, de fusion, de séparation, de chiffrement et de conversion de feuilles de calcul dans le langage de programmation Python. Aspose.Cells Cloud SDK pour Python est distribué sous une licence MIT et est alimenté par Aspose.Cells REST API sous-jacent.</p>
<p>Le SDK Cloud Aspose.Cells pour Python permet à votre code Python d'exécuter des fonctions de niveau basique à avancé sur les feuilles de calcul Microsoft Excel et OpenOffice hébergées sur le stockage cloud. Utilisez votre programme Python pour travailler avec des tableaux croisés dynamiques, travailler avec XML (SpreadsheetML), lire des fichiers Excel dans le cloud via Python, convertir XLSX en HTML, CSV, PDF, XPS, MD (Markdown), DIF, 0761123 481 et autres formats de fichiers pris en charge.</p>
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-python.svg" alt="Python Excel SDK"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Fonctionnalités avancées du SDK Cloud Spreadsheet Excel
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Supprimer des OleObjects spécifiques ou tous les OleObjects de la feuille de calcul
 ...
 Premiers pas avec le SDK de traitement de feuilles de calcul Excel
    ...
    <p>
 Pour démarrer avec le SDK Cloud Aspose.Cells pour Python, vous n'avez rien besoin d'installer. Il vous suffit de créer un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose pour le Cloud
     </a>
et obtenez les informations relatives à votre candidature. Une fois que vous avez l'App SID &amp; clé, vous êtes prêt à utiliser le SDK Cloud Aspose.Cells pour Python sur n'importe quelle plate-forme prenant en charge les API REST. Aspose.Cells Cloud SDK pour Python vous offre toutes les fonctionnalités nécessaires pour créer, modifier et convertir des feuilles de calcul. Il vous permet également d'extraire des données des feuilles de calcul pour un traitement ou un stockage ultérieur.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi le SDK Cloud Aspose.Cells pour Python ?" tabId="success-stories" >}}
