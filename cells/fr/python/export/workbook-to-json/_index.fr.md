...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKBOOK vers un fichier au format JSON à l\'aide du SDK Cloud Cells pour Python." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Python utilisant REST API pour exporter WORKBOOK au format JSON à partir d\'une feuille de calcul" gistPath="" %}}
