...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet CHART vers un fichier au format PNG à l\'aide du SDK Cloud Cells pour Python." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Python utilisant REST API pour exporter CHART au format PNG à partir d\'une feuille de calcul" gistPath="" %}}
