...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet CHART vers un fichier au format JPG à l\'aide du SDK Cloud Cells pour Python." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Python utilisant REST API pour exporter CHART au format JPG à partir d\'une feuille de calcul" gistPath="" %}}
