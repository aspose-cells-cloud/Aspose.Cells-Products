...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet LISTOBJECT vers un fichier au format PDF à l\'aide du SDK Cloud Cells pour Python." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Python utilisant REST API pour exporter LISTOBJECT au format PDF à partir d\'une feuille de calcul" gistPath="" %}}
