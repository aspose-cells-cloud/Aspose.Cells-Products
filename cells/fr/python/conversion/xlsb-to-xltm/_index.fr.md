...
{{< blocks/products/cells/cells-cloud-section title="Convertissez XLSB en XLTM à l\'aide du SDK Cloud Cells pour Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour convertir XLSB en XLTM à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLSB en XLTM à l\'aide de la bibliothèque Cells Cloud Python." >}}
