...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertissez FODS en XML avec Python" h2="Lisez, modifiez et exportez les données Excel vers d\'autres formats avec le SDK Cloud open source pour Python" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en XML avec Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code pour la conversion FODS en XML" gistPath="" %}}
```python
