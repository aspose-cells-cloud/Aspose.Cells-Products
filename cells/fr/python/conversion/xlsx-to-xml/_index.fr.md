...
{{< blocks/products/cells/cells-cloud-section title="Convertissez XLSX en XML à l\'aide du SDK Cloud Cells pour Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour convertir XLSX en XML à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLSX en XML à l\'aide de la bibliothèque Cells Cloud Python." >}}
