...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier SXC en tant que MD dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer SXC en tant que MD à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer SXC en tant que MD à l\'aide de la bibliothèque Cells Cloud Python." >}}
