...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier TXT au format FODS dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer TXT en tant que FODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer TXT au format FODS à l\'aide de la bibliothèque Cells Cloud Python." >}}
