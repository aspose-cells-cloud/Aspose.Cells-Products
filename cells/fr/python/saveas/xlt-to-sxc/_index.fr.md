...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLT sous SXC dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer XLT en tant que SXC à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLT au format SXC à l\'aide de la bibliothèque Cells Cloud Python." >}}
