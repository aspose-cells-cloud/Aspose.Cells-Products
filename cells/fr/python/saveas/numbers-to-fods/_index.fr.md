...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Enregistrez un fichier NUMBERS sous FODS dans Python" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python Exemple de code pour enregistrer des NUMBERS sous forme de FODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser le SDK Cloud Cells pour Python afin d\'enregistrer les fichiers Excel sous d\'autres formats NUMBERS en tant que FODS" >}}
