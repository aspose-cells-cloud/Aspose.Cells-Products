...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLS au format TXT dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer XLS au format TXT à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLS au format TXT à l\'aide de la bibliothèque Cells Cloud Python." >}}
