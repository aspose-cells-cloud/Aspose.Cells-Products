...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLTX sous TIFF dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer XLTX sous TIFF à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLTX sous le nom TIFF à l\'aide de la bibliothèque Cells Cloud Python." >}}
