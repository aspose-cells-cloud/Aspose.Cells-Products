...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier HTML en tant que FODS dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer HTML en tant que FODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer HTML en tant que FODS à l\'aide de la bibliothèque Cells Cloud Python." >}}
