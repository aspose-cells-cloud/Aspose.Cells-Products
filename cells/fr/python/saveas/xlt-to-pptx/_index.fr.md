...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment enregistrer XLT au format PPTX à l\'aide de la bibliothèque Cells Cloud Python." >}}
