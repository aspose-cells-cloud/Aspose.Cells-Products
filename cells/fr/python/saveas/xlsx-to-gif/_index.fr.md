...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLSX au format GIF dans Python" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python Exemple de code pour enregistrer XLSX au format GIF à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLSX au format GIF à l\'aide de la bibliothèque Cells Cloud Python." >}}
