...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Convertir XML en HTML à l\'aide du SDK Cloud Cells pour PHP" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PHP Exemple de code pour convertir XML en HTML à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser le SDK Cloud Cells pour PHP pour convertir des fichiers Excel vers d\'autres formats XML en HTML" >}}
