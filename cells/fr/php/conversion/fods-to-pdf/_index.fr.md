...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en PDF avec PHP" h2="Automatisez la conversion de fichiers Excel et OpenOffice avec le SDK Cloud open source pour PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir rapidement FODS en PDF via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code pour FODS à PDF Conversion" gistPath="" %}}
```php
