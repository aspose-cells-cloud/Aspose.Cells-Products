...
{{< blocks/products/cells/cells-cloud-section title="Convertissez ODS en XLS à l\'aide du SDK Cloud Cells pour PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour convertir ODS en XLS à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir ODS en XLS à l\'aide de la bibliothèque Cells Cloud PHP." >}}
