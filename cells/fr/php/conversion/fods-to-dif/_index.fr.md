...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertissez FODS en DIF avec PHP" h2="Automatisez la conversion de fichiers Excel et OpenOffice avec le SDK Cloud open source pour PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Convertissez rapidement FODS en DIF via PHP" %}}
...
1. Appelez le ```CellsApi.cellsSaveAsPostDocumentSaveAs``` pour obtenir le fichier DIF résultant
...
{{% blocks/products/pf/agp/code-autogen title="PHP Code pour la conversion FODS en DIF" gistPath="" %}}
```php
