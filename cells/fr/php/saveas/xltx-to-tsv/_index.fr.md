...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLTX au format TSV dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer XLTX au format TSV à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLTX au format TSV à l\'aide de la bibliothèque Cells Cloud PHP." >}}
