...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XML au format XLTM dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer XML au format XLTM à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer du XML au format XLTM à l\'aide de la bibliothèque Cells Cloud PHP." >}}
