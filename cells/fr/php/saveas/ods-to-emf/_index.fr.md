...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier ODS sous EMF dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer l\'ODS sous EMF à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer ODS sous le nom EMF à l\'aide de la bibliothèque Cells Cloud PHP." >}}
