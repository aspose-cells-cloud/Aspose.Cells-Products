...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier TSV au format XLTX dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer TSV au format XLTX à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer TSV au format XLTX à l\'aide de la bibliothèque Cells Cloud PHP." >}}
