...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier ODS au format XLSB dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer ODS au format XLSB à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer ODS au format XLSB à l\'aide de la bibliothèque Cells Cloud PHP." >}}
