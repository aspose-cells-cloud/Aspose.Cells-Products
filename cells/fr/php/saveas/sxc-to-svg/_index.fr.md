...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier SXC sous SVG dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer SXC sous SVG à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer SXC sous le nom SVG à l\'aide de la bibliothèque Cells Cloud PHP." >}}
