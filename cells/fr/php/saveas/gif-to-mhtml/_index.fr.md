...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier GIF au format MHTML dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer un GIF au format MHTML à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer un GIF au format MHTML à l\'aide de la bibliothèque Cells Cloud PHP." >}}
