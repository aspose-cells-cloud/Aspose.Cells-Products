...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier HTML sous TIFF dans PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP Exemple de code pour enregistrer HTML sous TIFF en utilisant REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer HTML sous TIFF à l\'aide de la bibliothèque Cells Cloud PHP." >}}
