---
title:  Exporter CHART vers JPG à partir d'une feuille de calcul en utilisant PHP API
...
url: /fr/php/export/chart-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API pour exporter CHART vers un fichier JPG" h2="PHP bibliothèque pour exporter CHART vers un fichier JPG" p="Utilisez Cells Export REST API pour exporter les workflows d\'objets internes de la feuille de calcul dans PHP. Il s\'agit d\'une solution professionnelle pour exporter CHART vers un fichier au format JPG à partir d\'une feuille de calcul en ligne à l\'aide de PHP." urlsection="export/chart-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporter l\'objet CHART vers un fichier au format JPG en PHP" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser PHP API pour exporter CHART vers JPG" >}}
