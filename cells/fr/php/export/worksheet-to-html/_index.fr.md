...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKSHEET vers un fichier au format HTML à l\'aide du SDK Cloud Cells pour PHP." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans PHP utilisant REST API pour exporter WORKSHEET au format HTML à partir d\'une feuille de calcul" gistPath="" %}}
