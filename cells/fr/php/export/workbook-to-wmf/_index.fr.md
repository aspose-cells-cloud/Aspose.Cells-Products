...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKBOOK vers un fichier au format WMF à l\'aide du SDK Cloud Cells pour PHP." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans PHP utilisant REST API pour exporter WORKBOOK au format WMF à partir d\'une feuille de calcul" gistPath="" %}}
