...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet CHART vers un fichier au format EMF à l\'aide du SDK Cloud Cells pour PHP." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans PHP utilisant REST API pour exporter CHART au format EMF à partir d\'une feuille de calcul" gistPath="" %}}
