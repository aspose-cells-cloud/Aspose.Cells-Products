...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier SXC sous le nom HTML dans NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code NodeJS pour enregistrer SXC sous HTML à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer SXC sous le nom HTML à l\'aide de la bibliothèque Cloud NodeJS Cells." >}}
