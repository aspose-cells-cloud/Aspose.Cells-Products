---
title:  Enregistrez TSV sous TIFF API pour NodeJS
description: Utilisation du SDK Cloud Aspose.Cells pour NodeJS pour enregistrer le fichier au format TSV en tant que fichier au format TIFF.
url: /fr/nodejs/saveas/tsv-to-tiff/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="NodeJS API pour enregistrer TSV sous TIFF" h2="Bibliothèque NodeJS pour enregistrer TSV sous TIFF" p="Utilisez Cells SaveAs REST API pour créer des workflows de feuille de calcul personnalisés dans NodeJS. Il s\'agit d\'une solution professionnelle pour enregistrer TSV sous TIFF et d\'autres formats de documents en ligne à l\'aide de NodeJS." urlsection="saveas/tsv-to-tiff/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser le nœud API pour enregistrer TSV sous TIFF" >}}
