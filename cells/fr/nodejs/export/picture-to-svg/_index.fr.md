...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet PICTURE vers un fichier au format SVG à l\'aide du SDK Cloud Cells pour NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans NodeJS utilisant REST API pour exporter PICTURE au format SVG à partir d\'une feuille de calcul" gistPath="" %}}
