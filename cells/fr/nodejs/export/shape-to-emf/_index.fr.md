...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet SHAPE vers un fichier au format EMF à l\'aide du SDK Cloud Cells pour NodeJS." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans NodeJS utilisant REST API pour exporter SHAPE au format EMF à partir d\'une feuille de calcul" gistPath="" %}}
