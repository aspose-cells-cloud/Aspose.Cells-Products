...
{{< blocks/products/cells/cells-cloud-section title="Exporter l\'objet CHART vers un fichier au format PNG à l\'aide du SDK Cloud Cells pour NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans NodeJS utilisant REST API pour exporter CHART au format PNG à partir d\'une feuille de calcul" gistPath="" %}}
