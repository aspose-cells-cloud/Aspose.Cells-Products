---
title: Exporter les Ods vers le fichier XLSX via NodeJS
...
url: /fr/nodejs/export/ods-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exporter ODS vers un fichier XLSX dans le Cloud" h2="Excel et exportation de feuilles de calcul OpenOffice avec le SDK Cloud open source pour NodeJS" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Exporter ODS vers un fichier XLSX dans le SDK Cloud pour NodeJS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Commencez avec Excel REST API" %}}
 Obtenez le code source du SDK Cloud Excel for .NET à partir de[GitHub](https://github.com/aspose-cells-cloud/aspose-cells-cloud-node) pour compiler le SDK vous-même ou rendez-vous sur[Sorties](https://github.com/aspose-cells-cloud/aspose-cells-cloud-node/releases) pour des options de téléchargement alternatives.
...
{{% blocks/products/pf/agp/code-autogen title="Code NodeJS pour la conversion ODS en XLSX" gistPath="" %}}
```js
