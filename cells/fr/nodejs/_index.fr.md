---
title:  Accéder, lire et traiter les fichiers Cloud Excel (via Node.js SDK)
description:  Développer Microsoft Excel & OpenOffice basé sur le cloud Spreadsheet viewer, exporter et convertir des applications dans Node.js via REST API
weight: 80
url: /fr/nodejs
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js REST SDK pour traiter et exporter les fichiers Excel" h2="Développez Microsoft Excel et des applications de visualisation, d\'exportation et de conversion de feuilles de calcul basées sur le cloud OpenOffice dans Node.js via REST API." logoImageSrc="/headers/aspose_cells-for-node.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Node.js" downloadUrl="" >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-node.svg" alt="Node.js Excel SDK"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-node.svg" alt="Spreadsheet manipulation via Node.js"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Cells SDK Cloud pour Node.js ?" tabId="success-stories" >}}
