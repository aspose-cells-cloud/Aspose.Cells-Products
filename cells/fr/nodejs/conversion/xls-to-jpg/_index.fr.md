...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Convertissez XLS en JPG à l\'aide du SDK Cloud Cells pour NodeJS" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code NodeJS pour convertir XLS en JPG à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser le SDK Cloud Cells pour Node pour convertir des fichiers Excel vers d\'autres formats XLS en JPG" >}}
