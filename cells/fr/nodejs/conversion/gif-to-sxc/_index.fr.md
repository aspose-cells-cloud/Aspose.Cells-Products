...
{{< blocks/products/cells/cells-cloud-section title="Convertir GIF en SXC à l\'aide du SDK Cloud Cells pour NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code NodeJS pour convertir GIF en SXC à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment convertir GIF en SXC à l\'aide de la bibliothèque Cloud NodeJS Cells." >}}
