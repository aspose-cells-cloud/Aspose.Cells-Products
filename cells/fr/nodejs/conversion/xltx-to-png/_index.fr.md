...
{{< blocks/products/cells/cells-cloud-section title="Convertir XLTX en PNG à l\'aide du SDK Cloud Cells pour NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code NodeJS pour convertir XLTX en PNG à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLTX en PNG à l\'aide de la bibliothèque Cloud NodeJS Cells." >}}
