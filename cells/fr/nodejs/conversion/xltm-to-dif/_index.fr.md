...
{{< blocks/products/cells/cells-cloud-section title="Convertissez XLTM en DIF à l\'aide du SDK Cloud Cells pour NodeJS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code NodeJS pour convertir XLTM en DIF à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLTM en DIF à l\'aide de la bibliothèque Cloud NodeJS Cells." >}}
