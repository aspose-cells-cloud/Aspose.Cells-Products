---
title:  Générateur et convertisseur de feuille de calcul Swift (Cloud REST API)
description: REST API pour récupérer, traiter, chiffrer, convertir et exporter Microsoft et des feuilles de calcul OpenOffice sur le cloud via Swift SDK
weight: 130
url: /fr/swift
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Swift SDK pour générer et convertir des feuilles de calcul Excel" h2="REST API pour récupérer, traiter, chiffrer, convertir et exporter des feuilles de calcul Microsoft et OpenOffice sur le cloud via Swift SDK." logoImageSrc="/headers/aspose_cells-for-swift.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Swift" downloadUrl="" >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-swift.svg" alt="Swift Excel SDK"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>Rapide</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
Résumer les données d'un grand ListObject ou d'une table avec un tableau croisé dynamique
 ...
 Premiers pas avec le SDK de traitement de feuille de calcul Excel
    ...
    <p>
 Pour démarrer avec Aspose.Cells Cloud SDK for Swift, vous n'avez rien à installer. Il vous suffit de créer un compte sur
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Cells SDK Cloud pour Swift ?" tabId="success-stories" >}}
