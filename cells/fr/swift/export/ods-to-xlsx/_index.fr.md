---
title: Exporter les Ods vers le fichier XLSX via Swift
...
url: /fr/swift/export/ods-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Exporter ODS vers un fichier XLSX dans le Cloud" h2="Excel et exportation de feuilles de calcul OpenOffice avec le SDK Cloud open source pour Swift" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Exporter ODS vers un fichier XLSX dans le SDK Cloud pour Swift" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Code Swift pour la conversion ODS en XLSX" gistPath="" %}}
```swift
