---
title:  XLS en XLSM Convertir API pour Swift
description: Utilisation du SDK Cloud Aspose.Cells pour Swift pour convertir un fichier au format XLS en fichier au format XLSM.
...
<br/>
La conversion des formats de fichiers XLS vers XLSM est une tâche complexe. Toutes les transitions du format XLS vers XLSM sont effectuées par notre SDK Swift tout en conservant le contenu structurel et logique principal de la feuille de calcul XLS source. Notre bibliothèque Swift est une solution professionnelle pour convertir des fichiers XLS en XLSM en ligne. Ce SDK Cloud offre aux développeurs Swift des fonctionnalités puissantes et une sortie XLSM parfaite.
<br/>
<br/>
