...
description:  Utilisation du SDK Cloud Aspose.Cells pour Swift pour enregistrer le fichier au format XML en tant que fichier au format XLTM.
url: /fr/swift/saveas/xml-to-xltm/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Swift API pour enregistrer XML en XLTM" h2="Bibliothèque Swift pour enregistrer XML en XLTM" p="Utilisez Cells SaveAs REST API pour créer des workflows de feuille de calcul personnalisés dans Swift. Il s\'agit d\'une solution professionnelle pour enregistrer XML au format XLTM et d\'autres formats de documents en ligne à l\'aide de Swift." urlsection="saveas/xml-to-xltm/" >}}
