...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet SHAPE vers un fichier au format JPG à l\'aide du SDK Cloud Cells pour Perl." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Perl utilisant REST API pour exporter SHAPE au format JPG à partir d\'une feuille de calcul" gistPath="" %}}
