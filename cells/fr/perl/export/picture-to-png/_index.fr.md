...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet PICTURE vers un fichier au format PNG à l\'aide du SDK Cloud Cells pour Perl." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Perl utilisant REST API pour exporter PICTURE au format PNG à partir d\'une feuille de calcul" gistPath="" %}}
