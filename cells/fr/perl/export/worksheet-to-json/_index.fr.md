...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKSHEET vers un fichier au format JSON à l\'aide du SDK Cloud Cells pour Perl." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Perl utilisant REST API pour exporter WORKSHEET au format JSON à partir d\'une feuille de calcul" gistPath="" %}}
