---
title:  Enregistrez EMF comme TXT API pour Perl
description:  Utilisation du SDK Cloud Aspose.Cells pour Perl pour enregistrer le fichier au format EMF en tant que fichier au format TXT.
url: /fr/perl/saveas/emf-to-txt/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Perl utilisant REST API pour enregistrer EMF au format TXT" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Perl API pour enregistrer EMF en tant que TXT" >}}
