...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLSM au format FODS dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer XLSM en tant que FODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLSM au format FODS à l\'aide de la bibliothèque Cells Cloud Perl." >}}
