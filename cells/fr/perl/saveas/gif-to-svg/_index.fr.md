...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier GIF sous SVG dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer le GIF sous SVG à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer un GIF sous le nom SVG à l\'aide de la bibliothèque Cells Cloud Perl." >}}
