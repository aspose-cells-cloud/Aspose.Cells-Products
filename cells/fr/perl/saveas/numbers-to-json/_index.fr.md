...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier NUMBERS au format JSON dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer NUMBERS au format JSON à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer des NUMBERS au format JSON à l\'aide de la bibliothèque Cells Cloud Perl." >}}
