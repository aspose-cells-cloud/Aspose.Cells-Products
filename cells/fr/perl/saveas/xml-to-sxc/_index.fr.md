...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XML au format SXC dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer XML au format SXC à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer du XML au format SXC à l\'aide de la bibliothèque Cells Cloud Perl." >}}
