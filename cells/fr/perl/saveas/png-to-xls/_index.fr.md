...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier PNG au format XLS dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer PNG au format XLS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer PNG au format XLS à l\'aide de la bibliothèque Cells Cloud Perl." >}}
