---
title:  Enregistrer ODS sous SXC API pour Perl
description:  Utilisation de Aspose.Cells Cloud SDK pour Perl pour enregistrer le fichier au format ODS en tant que fichier au format SXC.
url: /fr/perl/saveas/ods-to-sxc/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Perl utilisant REST API pour enregistrer ODS au format SXC" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Perl API pour enregistrer ODS en tant que SXC" >}}
