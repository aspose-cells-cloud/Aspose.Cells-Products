...
---
{{< blocks/products/cells/cells-cloud-banner h1="Enregistrer HTML en tant que XLT" h2="Bibliothèque Perl pour enregistrer HTML au format XLT" p="Utilisez SaveAs API de Cells Cloud pour créer des flux de travail de feuille de calcul personnalisés dans Perl. Il s\'agit d\'une solution professionnelle pour enregistrer HTML au format XLT et d\'autres formats de documents en ligne à l\'aide de Perl." urlsection="saveas/html-to-xlt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer HTML au format XLT à l\'aide de la bibliothèque Cells Cloud Perl." >}}
