...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier TXT au format ODS dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer TXT en tant qu\'ODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment enregistrer TXT en tant qu\'ODS à l\'aide de la bibliothèque Cells Cloud Perl." >}}
