...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier NUMBERS sous le nom TIFF dans Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl Exemple de code pour enregistrer des NUMÉROS sous TIFF à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer des NUMÉROS sous le nom TIFF à l\'aide de la bibliothèque Cells Cloud Perl." >}}
