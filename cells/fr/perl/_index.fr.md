---
title:  Construire des applications de lecture et de conversion Excel dans Perl (via REST API)
description: Créez, lisez, écrivez, fusionnez, divisez, cryptez et convertissez des feuilles de calcul Microsoft Excel et OpenOffice dans le cloud
weight: 90
url: /fr/perl
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Perl SDK REST pour les feuilles de calcul Excel" h2="Créez, lisez, écrivez, fusionnez, divisez, cryptez et convertissez des feuilles de calcul Microsoft Excel et OpenOffice dans le cloud." logoImageSrc="/headers/aspose_cells-for-perl.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Perl" downloadUrl="" >}}
...
<p>Aspose.Cells Cloud SDk pour Perl vous permet de développer rapidement des applications compétitives basées sur le cloud Microsoft Excel et générateur de feuille de calcul OpenOffice, lecteur, fusion, séparateur, chiffrement et convertisseur dans le langage de programmation Perl. Aspose.Cells Cloud SDK pour Perl est construit sur Aspose.Cells REST API. Notre Cells Cloud SDK est sous licence MIT.</p>
<p>Aspose.Cells Cloud SDK pour Perl permet à votre code Perl d'accéder aux feuilles de calcul cloud et de modifier les filtres automatiques, les classeurs, les cellules, les colonnes, les lignes, les graphiques, les formes, les hyperliens, la mise en forme conditionnelle, les OleObjects, les sauts de page, les ListObjects, les tableaux croisés dynamiques, les tâches et les plages . Activez votre programme Perl pour convertir XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM, ODS en DIF, PDF, XPS, TIFF, SVG, MD (Markdown), XML (SpreadsheetML), CSV, TSV, TXT (TabDelimited) , HTML & MHTML.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-perl.svg" alt="Perl Excel SDK"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-perl.svg" alt="Excel Perl Cloud SDK"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
Fonctionnalités avancées de manipulation de feuilles de calcul
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Supprimer des ListObjects spécifiques ou tous dans une feuille de calcul
 ...
 Premiers pas avec le SDK de traitement de feuille de calcul Excel
    ...
    <p>
 Pour démarrer avec Aspose.Cells Cloud SDK pour Perl, vous n'avez rien à installer. Il vous suffit de créer un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose pour le Cloud
     </a>
 et obtenez les informations de votre candidature. Une fois que vous avez l'App SID &amp; clé, vous êtes prêt à utiliser Aspose.Cells Cloud SDK pour Perl sur n'importe quelle plate-forme prenant en charge les API REST. Aspose.Cells Le SDK Cloud pour Perl vous fournit toutes les fonctionnalités pour créer, modifier et convertir des feuilles de calcul. Il vous permet également d'extraire des données des feuilles de calcul pour un traitement ou un stockage ultérieur.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-cells-cloud/aspose-cells-cloud-perl" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Cells SDK Cloud pour Perl ?" tabId="success-stories" >}}
