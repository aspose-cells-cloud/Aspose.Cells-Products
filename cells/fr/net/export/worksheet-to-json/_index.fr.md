---
title:  Exportez la FEUILLE DE TRAVAIL vers JSON à partir de Excel à l'aide du SDK Cloud Cells pour C#.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exporter la FEUILLE DE TRAVAIL vers JSON à partir du Excel" h2="Bibliothèque C# pour exporter WORKSHEET vers un fichier JSON" p="Utilisez Export API de Cells Cloud pour exporter les workflows d\'objets internes du fichier Excel dans Net. Il s\'agit d\'une solution professionnelle pour exporter WORKSHEET vers un fichier au format JSON à partir d\'une feuille de calcul en ligne en utilisant le C#." urlsection="export/worksheet-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKSHEET vers un fichier au format JSON à l\'aide du SDK Cloud Cells pour C#." >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
Exporter l'objet WORKSHEET vers le fichier JSON à partir du fichier Excel est une tâche complexe. Les transitions d'exportation de WORKSHEET au format JSON sont effectuées par notre SDK C# tout en conservant le contenu structurel et logique principal de la feuille de calcul WORKSHEET source. Notre bibliothèque C# est une solution professionnelle pour exporter des objets WORKSHEET vers des fichiers au format JSON en ligne. Ce SDK Cloud offre aux développeurs C# des fonctionnalités puissantes et une sortie JSON parfaite.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans C# utilisant REST API pour exporter WORKSHEET au format JSON à partir d\'une feuille de calcul" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Cells Cloud SDK for Net pour exporter des objets de Excel WORKSHEET vers JSON" >}}
