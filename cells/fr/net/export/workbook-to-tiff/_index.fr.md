...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKBOOK vers un fichier au format TIFF à l\'aide du SDK Cloud Cells pour C#." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans C# utilisant REST API pour exporter WORKBOOK au format TIFF à partir d\'une feuille de calcul" gistPath="" %}}
