...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet LISTOBJECT vers un fichier au format GIF à l\'aide du SDK Cloud Cells pour C#." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans C# utilisant REST API pour exporter LISTOBJECT au format GIF à partir d\'une feuille de calcul" gistPath="" %}}
