...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier TSV au format FODS dans C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Exemple de code pour enregistrer TSV en tant que FODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer TSV au format FODS à l\'aide de la bibliothèque Cloud Net Cells." >}}
