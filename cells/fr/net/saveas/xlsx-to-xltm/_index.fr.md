...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLSX au format XLTM dans C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Exemple de code pour enregistrer XLSX en tant que XLTM à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment enregistrer XLSX au format XLTM à l\'aide de la bibliothèque Cloud Net Cells." >}}
