---
title:  Enregistrez XLSX sous BMP en utilisant C#
description:  Utilisation du SDK Cloud Aspose.Cells pour C# pour enregistrer le fichier au format XLSX au format BMP.
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Enregistrer XLSX sous le numéro BMP" h2="Bibliothèque C# pour enregistrer XLSX sous BMP" p="Utilisez SaveAs API sur Cells Cloud pour créer des flux de travail de feuilles de calcul personnalisés dans Net. Il s\'agit d\'une solution professionnelle pour enregistrer XLSX sous le numéro BMP et d\'autres formats de documents en ligne sous le numéro C#." urlsection="saveas/xlsx-to-bmp/" >}}

{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLSX sous BMP dans C#" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
Enregistrer les formats de fichiers de XLSX sous le nom BMP est une tâche complexe. Toutes les transitions du format XLSX vers BMP sont effectuées par notre SDK C# tout en conservant le contenu structurel et logique principal de la feuille de calcul XLSX source. Notre bibliothèque C# est une solution professionnelle pour enregistrer XLSX en tant que fichiers BMP en ligne. Ce SDK Cloud offre aux développeurs C# des fonctionnalités puissantes et une sortie BMP parfaite.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Exemple de code pour enregistrer XLSX sous BMP à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment enregistrer XLSX sous BMP à l\'aide de la bibliothèque Cloud Net Cells." >}}
