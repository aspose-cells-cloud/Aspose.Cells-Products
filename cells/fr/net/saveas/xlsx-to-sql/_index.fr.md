...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLSX au format SQL dans C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Exemple de code pour enregistrer XLSX au format SQL à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment enregistrer XLSX au format SQL à l\'aide de la bibliothèque Cloud Net Cells." >}}
