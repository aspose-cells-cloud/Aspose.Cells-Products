...
<br/>
L'enregistrement des formats de fichiers à partir de PNG en tant que JPG est une tâche complexe. Toutes les transitions du format PNG vers le format JPG sont effectuées par notre SDK C# tout en conservant le contenu structurel et logique principal de la feuille de calcul source PNG. Notre bibliothèque C# est une solution professionnelle pour enregistrer PNG sous forme de fichiers JPG en ligne. Ce SDK Cloud offre aux développeurs C# des fonctionnalités puissantes et une sortie JPG parfaite.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans C# utilisant REST API pour enregistrer PNG au format JPG" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser C# API pour enregistrer PNG au format JPG" >}}
