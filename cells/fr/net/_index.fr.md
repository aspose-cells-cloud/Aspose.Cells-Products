...
<p>Aspose.Cells Cloud SDK for .NET améliore la capacité de vos applications .NET en intégrant de manière transparente des fonctionnalités de traitement de feuille de calcul qui permettent à vos programmes basés sur le cloud d'accéder et de modifier des classeurs, des feuilles de calcul, des feuilles de calcul, des lignes ainsi que des cellules individuelles, sans installer de logiciel tiers. Aspose.Cells Le SDK Cloud for .NET est distribué sous une licence MIT.</p>
...
<p>À l'aide du Aspose.Cells Cloud SDK for .NET, vous pouvez activer votre code C# pour effectuer un filtrage automatique et appliquer une mise en forme conditionnelle aux feuilles de calcul. La prise en charge de la conversion de fichiers est également assez complète, car en utilisant votre application cloud .NET, vous pourrez convertir des documents Microsoft Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) et OpenOffice (ODS) en PDF, XPS, SVG, TIFF, formats Markdown et DIF.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 Fonctionnalités avancées du SDK Cloud Aspose.Cells for .NET
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Ajouter plusieurs types de filtres de liste avec des critères personnalisés
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Accéder à la bordure ou au format de remplissage de la zone de graphique
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Ajouter, mettre à jour ou supprimer des graphiques
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Obtenez, mettez à jour, affichez ou masquez la légende du graphique et amp; titres
    </p>
   </div>
   <div class="col-lg-4">
...
Résumer les données d'un grand ListObject ou d'une table avec un tableau croisé dynamique
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Ajouter ou supprimer des OleObjects à partir des feuilles de calcul Excel
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Premiers pas avec le SDK de traitement de feuille de calcul Excel
    ...
    <p>
 Vous n'avez rien besoin d'installer pour commencer avec Aspose.Cells Cloud SDK for .NET. Il vous suffit de créer un compte sur
