...
<p>Aspose.Cells Cloud SDK for .NET améliore les capacités de vos applications .NET en intégrant de manière transparente des fonctionnalités de traitement de feuilles de calcul qui permettent à vos programmes basés sur le cloud d'accéder et de modifier des classeurs, des feuilles de calcul, des feuilles de calcul, des lignes ainsi que des cellules individuelles, sans installer de logiciel tiers. Aspose.Cells Cloud SDK for .NET est distribué sous licence MIT.</p>
<p>Aspose.Cells Cloud SDK for .NET fonctionne comme une interface avec Aspose.Cells REST API sous-jacent. Il rend votre travail de programmation .NET très simple lorsqu'il s'agit de travailler avec des tableaux croisés dynamiques, des OleObjects, des ListObjects, des tâches, des formes, des hyperliens et des commentaires.</p>
<p>À l'aide du SDK Cloud Aspose.Cells for .NET, vous pouvez activer votre code C# pour effectuer un filtrage automatique et appliquer une mise en forme conditionnelle aux feuilles de calcul. La prise en charge de la conversion de fichiers est également assez complète, car en utilisant votre application cloud .NET, vous pourrez convertir les documents Microsoft Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) et OpenOffice (ODS) en PDF, XPS, SVG, TIFF, formats Markdown et DIF.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-net.svg" alt="Go SDK for Excel & OpenOffice Spreadsheets"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-net.svg" alt="Excel SDK .NET"><header>Aspose.Cells</header><footer> Nuage<small> <em> pour</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Fonctionnalités avancées du SDK Cloud Aspose.Cells for .NET
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Ajoutez plusieurs types de filtres de liste avec des critères personnalisés
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Accéder à la bordure de la zone du graphique ou au format de remplissage
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Ajouter, mettre à jour ou supprimer des graphiques
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Obtenez, mettez à jour, affichez ou masquez la légende et l'amp; titres
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Résumer les données d'un grand ListObject ou d'un tableau avec un tableau croisé dynamique
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Ajouter ou supprimer des OleObjects des feuilles de calcul Excel
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Premiers pas avec le SDK de traitement de feuilles de calcul Excel
    ...
    <p>
 Vous n'avez rien à installer pour démarrer avec Aspose.Cells Cloud SDK for .NET. Tout ce que vous avez à faire est de créer un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose pour le Cloud
     </a>
et obtenez les informations relatives à votre candidature. C'est tout! Vous êtes prêt à utiliser le SDK Cloud Aspose.Cells for .NET.
    </p>
    <p>
 Aspose.Cells Cloud SDK for .NET fournit toutes les fonctionnalités nécessaires pour créer, modifier et convertir des feuilles de calcul vers d'autres formats de fichiers populaires.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Charger et amp; Processus Excel Feuilles de calcul via SDK Cloud
    </h2>
    <p>
 Aspose.Cells Cloud SDK for .NET vous permet de créer, diviser, fusionner, rechercher et remplacer du texte, protéger par mot de passe, exporter vers un format de fichier pris en charge, lire les éléments de texte du classeur, ajuster automatiquement les lignes du classeur tout en ignorant les éléments masqués, chiffrer le mot de passe du classeur et fournir la longueur de la clé de chiffrement. , importer des données dans un classeur, calculer toutes les formules du classeur, définir les paramètres de calcul de formule en fournissant une stratégie de précision, etc., utiliser un marqueur intelligent, convertir le classeur du contenu de la demande vers un autre format, appliquer un mot de passe pour permettre la modification du contenu.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 SDK Cloud à lire et à lire Traiter les feuilles de calcul Excel
    </h2>
    <p>
À l'aide du SDK Cloud Aspose.Cells for .NET, vous pouvez supprimer une ligne spécifique ou toutes les lignes de la feuille de calcul, récupérer les données de cellule ou le style de cellule de la feuille de calcul par nom de cellule, lire les données de ligne ou de colonne de la feuille de calcul par son index, calculer la formule de cellule, effacer le contenu de la cellule, copier la cellule dans une autre. cellule, copier les colonnes et les lignes de la feuille de calcul, regrouper les lignes et les colonnes de la feuille de calcul, masquer les lignes et les colonnes de la feuille de calcul, définir les styles de colonne et de ligne de la feuille de calcul, définir la valeur HTMLSTRING dans la cellule, définir la valeur de la plage de cellules et modifier de nombreux autres paramètres de la feuille de calcul.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
