...
{{< blocks/products/cells/cells-cloud-section title="Convertissez XLSX en WMF à l\'aide du SDK Cloud Cells pour C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# Exemple de code pour convertir XLSX en WMF à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLSX en WMF à l\'aide de la bibliothèque Cloud Net Cells." >}}
