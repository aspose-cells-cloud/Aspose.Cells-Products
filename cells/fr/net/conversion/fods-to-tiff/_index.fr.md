...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en TIFF dans le Cloud" h2="Excel et conversion de feuille de calcul OpenOffice avec le SDK Cloud open source for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code pour FODS à TIFF Conversion" gistPath="" %}}
```cs
