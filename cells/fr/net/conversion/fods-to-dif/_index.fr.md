...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en DIF dans le cloud" h2="Excel et conversion de feuilles de calcul OpenOffice avec le SDK Cloud open source for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en DIF dans les applications .NET" %}}
...
1. Appelez la méthode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` pour obtenir le fichier DIF résultant
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code pour la conversion FODS en DIF" gistPath="" %}}
```cs
