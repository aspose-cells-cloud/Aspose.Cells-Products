...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XPS dans le Cloud" h2="Excel et conversion de feuille de calcul OpenOffice avec le SDK Cloud open source for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code pour FODS à XPS Conversion" gistPath="" %}}
```cs
