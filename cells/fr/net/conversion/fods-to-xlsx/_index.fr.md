---
title:  Convertir FODS en XLSX via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLSX dans le cloud" h2="Excel et conversion de feuilles de calcul OpenOffice avec le SDK Cloud open source for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en XLSX dans les applications .NET" %}}
...
1. Appelez la méthode ```CellsApi.CellsSaveAsPostDocumentSaveAs``` pour obtenir le fichier XLSX résultant
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code pour la conversion FODS en XLSX" gistPath="" %}}
```cs
