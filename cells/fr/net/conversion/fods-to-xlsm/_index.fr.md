...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLSM dans le cloud" h2="Excel et conversion de feuilles de calcul OpenOffice avec le SDK Cloud open source for .NET" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET Code pour la conversion FODS en XLSM" gistPath="" %}}
```cs
