...
{{< blocks/products/cells/cells-cloud-section title="Convertissez CSV en TXT à l\'aide du SDK Cloud Cells for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Exemple de code pour convertir CSV en TXT à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir CSV en TXT à l\'aide de la bibliothèque Cells Cloud Java." >}}
