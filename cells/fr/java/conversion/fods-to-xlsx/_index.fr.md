---
title:  Convertir FODS en XLSX dans le Cloud via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertissez FODS en XLSX avec Java" h2="Automatisez la conversion de fichiers Excel et OpenOffice avec le SDK Cloud open source for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion simple de FODS en XLSX" %}}
...
1. Appelez le ```CellsApi.cellsWorkbookGetWorkbook``` pour obtenir le fichier XLSX résultant
...
{{% blocks/products/pf/agp/code-autogen title="Java Code pour convertir FODS en XLSX" gistPath="" %}}
```java
