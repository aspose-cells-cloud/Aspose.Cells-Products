---
title:  Convertir XLTM en XLSX API for Java
description:  Utilisation de Aspose.Cells Cloud SDK for Java pour convertir le fichier au format XLTM en fichier au format XLSX.
url: /fr/java/conversion/xltm-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API pour convertir XLTM en XLSX" h2="Bibliothèque Java pour convertir XLTM en XLSX" p="Utilisez Cells Conversion REST API pour créer des flux de travail de feuille de calcul personnalisés dans Java. Il s\'agit d\'une solution professionnelle pour convertir XLTM en XLSX et d\'autres formats de documents en ligne à l\'aide de Java." urlsection="conversion/xltm-to-xlsx/" >}}
