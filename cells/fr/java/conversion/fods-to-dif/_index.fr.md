...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertissez FODS en DIF avec Java" h2="Automatisez la conversion de fichiers Excel et OpenOffice avec le SDK Cloud open source for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion simple de FODS en DIF" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code pour convertir FODS en DIF" gistPath="" %}}
```java
