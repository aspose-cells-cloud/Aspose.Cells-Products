...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier MHTML au format SQL dans Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java Exemple de code pour enregistrer MHTML au format SQL à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer du MHTML au format SQL à l\'aide de la bibliothèque Cells Cloud Java." >}}
