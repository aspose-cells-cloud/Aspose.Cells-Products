---
title:  Enregistrez XLSM sous SVG API for Java
description:  Utilisation de Aspose.Cells Cloud SDK for Java pour enregistrer le fichier au format XLSM en tant que fichier au format SVG.
url: /fr/java/saveas/xlsm-to-svg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API pour enregistrer XLSM sous SVG" h2="Bibliothèque Java pour enregistrer XLSM sous SVG" p="Utilisez Cells SaveAs REST API pour créer des flux de travail de feuille de calcul personnalisés dans Java. Il s\'agit d\'une solution professionnelle pour enregistrer XLSM sous SVG et d\'autres formats de documents en ligne à l\'aide de Java." urlsection="saveas/xlsm-to-svg/" >}}
