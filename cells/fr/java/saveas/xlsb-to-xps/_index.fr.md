...
<br/>
L'enregistrement des formats de fichier à partir de XLSB sous le nom XPS est une tâche complexe. Toutes les transitions de format XLSB vers XPS sont effectuées par notre SDK Java tout en conservant le contenu structurel et logique principal de la feuille de calcul XLSB source. Notre bibliothèque Java est une solution professionnelle pour enregistrer en ligne des fichiers XLSB sous le nom XPS. Ce SDK Cloud offre aux développeurs Java des fonctionnalités puissantes et une sortie XPS parfaite.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Java utilisant REST API pour enregistrer XLSB au format XPS" gistPath="" %}}
