---
title: Effacer les lignes en double sur le classeur local avec Java dans le Cloud
description:  API Cloud et SDK pour effacer les lignes en double sur Microsoft Excel et OpenOffice Calc avec Java. Effacer les lignes en double sur les feuilles de calcul locales par le Cells Cloud API SDK for Java
url: /fr/java/clear/duplicate-rows/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API pour effacer les lignes en double sur la feuille de calcul locale Microsoft Excel et OpenOffice Calc" h2="Java Effacer pour effacer les lignes en double sur la feuille de calcul locale Microsoft Excel et OpenOffice Calc" p="Utilisez Cells Effacer REST API pour effacer les lignes en double sur les flux de travail locaux Microsoft Excel et de tableur OpenOffice Calc dans Java. Cette solution professionnelle efface les lignes en double sur les feuilles de calcul locales Microsoft Excel et OpenOffice Calc à l\'aide de Java." urlsection="clear/Duplicate-rows/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Effacer les lignes en double sur la feuille de calcul locale Microsoft Excel et OpenOffice Calc - Java REST API" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java code pour effacer les lignes en double sur les feuilles de calcul locales" gistPath="https://gist.github.com/aspose-cells-cloud-gists/c59aa5c02f735466a5e34751cee73f5f.js?file=Example-Clear-DuplicateRows.java" %}}
