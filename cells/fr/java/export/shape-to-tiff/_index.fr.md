...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet SHAPE vers un fichier au format TIFF à l\'aide du SDK Cloud Cells for Java." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter SHAPE au format TIFF à partir d\'une feuille de calcul" gistPath="" %}}
