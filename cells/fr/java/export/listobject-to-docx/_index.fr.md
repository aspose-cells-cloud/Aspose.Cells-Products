...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet LISTOBJECT vers un fichier au format DOCX à l\'aide du SDK Cloud Cells for Java." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter LISTOBJECT au format DOCX à partir d\'une feuille de calcul" gistPath="" %}}
