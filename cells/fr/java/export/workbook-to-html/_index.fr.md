...
{{< blocks/products/cells/cells-cloud-section title="Exporter l\'objet WORKBOOK vers un fichier au format HTML à l\'aide du SDK Cloud Cells for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter WORKBOOK au format HTML à partir d\'une feuille de calcul" gistPath="" %}}
