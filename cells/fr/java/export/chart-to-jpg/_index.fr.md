---
title:  Exportez CHART vers JPG à partir de Excel à l'aide du SDK Cloud Cells for Java
...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet CHART vers un fichier au format JPG à l\'aide du SDK Cloud Cells for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter CHART au format JPG à partir d\'une feuille de calcul" gistPath="" %}}
