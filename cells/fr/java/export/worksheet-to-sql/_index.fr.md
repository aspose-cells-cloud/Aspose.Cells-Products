...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet WORKSHEET vers un fichier au format SQL à l\'aide du SDK Cloud Cells for Java." >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter WORKSHEET au format SQL à partir d\'une feuille de calcul" gistPath="" %}}
