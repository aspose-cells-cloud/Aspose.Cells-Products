---
title:  Exportez SHAPE vers SVG à partir de Excel à l'aide du SDK Cloud Cells for Java
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exporter SHAPE vers SVG à partir de Excel" h2="Bibliothèque Java pour exporter SHAPE vers le fichier SVG" p="Utilisez Export API de Cells Cloud pour exporter les flux de travail d\'objets internes du fichier Excel dans Java. Il s\'agit d\'une solution professionnelle pour exporter SHAPE au format SVG à partir d\'une feuille de calcul en ligne à l\'aide de Java." urlsection="export/shape-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet SHAPE vers un fichier au format SVG à l\'aide du SDK Cloud Cells for Java." >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
Exporter l'objet SHAPE vers le fichier SVG à partir du fichier Excel est une tâche complexe. L'exportation des transitions au format SHAPE vers SVG est effectuée par notre SDK Java tout en conservant le contenu structurel et logique principal de la feuille de calcul SHAPE source. Notre bibliothèque Java est une solution professionnelle pour exporter des objets SHAPE vers des fichiers au format SVG en ligne. Ce SDK Cloud offre aux développeurs Java des fonctionnalités puissantes et une sortie SVG parfaite.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter SHAPE au format SVG à partir d\'une feuille de calcul" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Cells Cloud SDK for Java pour exporter des objets de Excel SHAPE vers SVG" >}}
