...
{{< blocks/products/cells/cells-cloud-section title="Exporter l\'objet CHART vers un fichier au format WMF à l\'aide du SDK Cloud Cells for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Java utilisant REST API pour exporter CHART au format WMF à partir d\'une feuille de calcul" gistPath="" %}}
