...
{{< blocks/products/cells/cells-cloud-section title="Convertissez TXT en HTML à l\'aide du SDK Cloud Cells pour Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour convertir TXT en HTML à l\'aide du SDK Cloud Cells" gistPath="" %}}
