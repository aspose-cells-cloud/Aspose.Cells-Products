...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en SXC dans le Cloud" h2="Convertir les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Androïd : conversion FODS en SXC" gistPath="" %}}
```java
