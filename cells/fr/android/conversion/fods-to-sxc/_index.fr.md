---
title:  Convertir FODS en SXC sur Android
...
url: /fr/android/conversion/fods-to-sxc/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en SXC dans le cloud" h2="Convertissez les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en SXC dans les applications Android" %}}
...
1. Appelez le ```CellsApi.cellsWorkbookGetWorkbook``` pour obtenir le fichier SXC résultant
...
{{% blocks/products/pf/agp/code-autogen title="Android : conversion FODS en SXC" gistPath="" %}}
```java
