---
title:  Convertir XLTM en XML API pour Android
description:  Utiliser Aspose.Cells Cloud SDK pour Android pour convertir le fichier au format XLTM en fichier au format XML.
url: /fr/android/conversion/xltm-to-xml/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour convertir XLTM au format XML" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Java API pour convertir XLTM en XML" >}}
