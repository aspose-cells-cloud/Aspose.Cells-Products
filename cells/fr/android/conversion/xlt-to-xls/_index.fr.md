...
{{< blocks/products/cells/cells-cloud-section title="Convertissez XLT en XLS à l\'aide du SDK Cloud Cells pour Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour convertir XLT en XLS à l\'aide du SDK Cloud Cells" gistPath="" %}}
