---
title:  Convertir FODS en TXT sur Android
...
url: /fr/android/conversion/fods-to-txt/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en TXT dans le cloud" h2="Convertissez les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en TXT dans les applications Android" %}}
...
1. Appelez le ```CellsApi.cellsWorkbookGetWorkbook``` pour obtenir le fichier TXT résultant
...
{{% blocks/products/pf/agp/code-autogen title="Android : conversion FODS en TXT" gistPath="" %}}
```java
