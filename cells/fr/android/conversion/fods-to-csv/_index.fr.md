---
title:  Convertir FODS en CSV sur Android
...
url: /fr/android/conversion/fods-to-csv/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en CSV dans le cloud" h2="Convertissez les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en CSV dans les applications Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android : conversion FODS en CSV" gistPath="" %}}
```java
