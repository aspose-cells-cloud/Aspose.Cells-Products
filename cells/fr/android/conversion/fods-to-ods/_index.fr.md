---
title:  Convertir FODS en ODS sur Android
...
url: /fr/android/conversion/fods-to-ods/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en ODS dans le Cloud" h2="Convertir les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en ODS dans les applications Android" %}}
...
1. Appelez le ```CellsApi.cellsWorkbookGetWorkbook``` pour obtenir le fichier ODS résultant
...
{{% blocks/products/pf/agp/code-autogen title="Androïd : conversion de FODS en ODS" gistPath="" %}}
```java
