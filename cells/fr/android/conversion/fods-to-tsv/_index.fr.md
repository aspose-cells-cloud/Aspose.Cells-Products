...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en TSV dans le Cloud" h2="Convertir les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Androïde : conversion FODS en TSV" gistPath="" %}}
```java
