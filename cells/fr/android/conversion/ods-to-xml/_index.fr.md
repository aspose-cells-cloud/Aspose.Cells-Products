---
title:  Convertir ODS en XML API pour Android
description:  Utilisation du SDK Cloud Aspose.Cells pour Android pour convertir le fichier au format ODS en fichier au format XML.
url: /fr/android/conversion/ods-to-xml/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API pour convertir ODS en XML" h2="Bibliothèque Android pour convertir ODS en XML" p="Utilisez Cells Conversion REST API pour créer des workflows de feuille de calcul personnalisés dans Android. Il s\'agit d\'une solution professionnelle pour convertir ODS en XML et d\'autres formats de documents en ligne à l\'aide d\'Android." urlsection="conversion/ods-to-xml/" >}}
