---
title:  Convertir FODS en XLTX sur Android
...
url: /fr/android/conversion/fods-to-xltx/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLTX dans le Cloud" h2="Convertir les feuilles de calcul Excel et OpenOffice avec le SDK Cloud open source pour Android" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en XLTX dans les applications Android" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Androïde : conversion de FODS en XLTX" gistPath="" %}}
```java
