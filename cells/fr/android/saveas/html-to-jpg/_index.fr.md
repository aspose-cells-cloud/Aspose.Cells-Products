---
title:  Enregistrer HTML au format JPG API pour Android
description:  Utilisation du SDK Cloud Aspose.Cells pour Android pour enregistrer le fichier au format HTML en tant que fichier au format JPG.
url: /fr/android/saveas/html-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API pour enregistrer HTML au format JPG" h2="Bibliothèque Android pour enregistrer HTML au format JPG" p="Utilisez Cells SaveAs REST API pour créer des workflows de feuille de calcul personnalisés dans Android. Il s\'agit d\'une solution professionnelle pour enregistrer HTML au format JPG et d\'autres formats de documents en ligne à l\'aide d\'Android." urlsection="saveas/html-to-jpg/" >}}
