---
title:  Enregistrer XLSB sous FODS API pour Android
description: Utilisation de Aspose.Cells Cloud SDK pour Android pour enregistrer le fichier au format XLSB en tant que fichier au format FODS.
url: /fr/android/saveas/xlsb-to-fods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API pour enregistrer XLSB en tant que FODS" h2="Bibliothèque Android pour enregistrer XLSB en tant que FODS" p="Utilisez Cells SaveAs REST API pour créer des workflows de feuille de calcul personnalisés dans Android. Il s\'agit d\'une solution professionnelle pour enregistrer XLSB en tant que FODS et d\'autres formats de documents en ligne à l\'aide d\'Android." urlsection="saveas/xlsb-to-fods/" >}}
