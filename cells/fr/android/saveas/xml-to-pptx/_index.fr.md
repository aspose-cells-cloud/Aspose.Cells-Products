...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier XML au format PPTX sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer XML au format PPTX à l\'aide de REST API" gistPath="" %}}
