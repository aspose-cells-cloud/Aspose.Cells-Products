---
title:  Enregistrer XLTX sous XLSB API pour Android
description: Utilisation de Aspose.Cells Cloud SDK pour Android pour enregistrer le fichier au format XLTX en tant que fichier au format XLSB.
url: /fr/android/saveas/xltx-to-xlsb/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer XLTX au format XLSB" gistPath="" %}}
