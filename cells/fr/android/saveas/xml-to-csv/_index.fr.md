---
title: Enregistrer XML au format CSV API pour Android
description:  Utilisation de Aspose.Cells Cloud SDK pour Android pour enregistrer le fichier au format XML en tant que fichier au format CSV.
url: /fr/android/saveas/xml-to-csv/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer XML au format CSV" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Java API pour enregistrer XML au format CSV" >}}
