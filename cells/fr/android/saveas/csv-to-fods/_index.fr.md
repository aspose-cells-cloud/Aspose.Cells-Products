...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier CSV au format FODS sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer CSV en tant que FODS à l\'aide de REST API" gistPath="" %}}
