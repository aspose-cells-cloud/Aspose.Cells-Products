...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier CSV au format WMF sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer CSV au format WMF à l\'aide de REST API" gistPath="" %}}
