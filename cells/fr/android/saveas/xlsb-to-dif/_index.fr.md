---
title:  Enregistrer XLSB sous DIF API pour Android
description: Utilisation de Aspose.Cells Cloud SDK pour Android pour enregistrer le fichier au format XLSB en tant que fichier au format DIF.
url: /fr/android/saveas/xlsb-to-dif/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer XLSB au format DIF" gistPath="" %}}
