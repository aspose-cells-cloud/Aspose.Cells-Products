---
title:  Enregistrer EMF au format JPG API pour Android
description:  Utilisation du SDK Cloud Aspose.Cells pour Android pour enregistrer le fichier au format EMF en tant que fichier au format JPG.
url: /fr/android/saveas/emf-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API pour enregistrer EMF au format JPG" h2="Bibliothèque Android pour enregistrer EMF au format JPG" p="Utilisez Cells SaveAs REST API pour créer des workflows de feuille de calcul personnalisés dans Android. Il s\'agit d\'une solution professionnelle pour enregistrer EMF au format JPG et d\'autres formats de documents en ligne à l\'aide d\'Android." urlsection="saveas/emf-to-jpg/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Java API pour enregistrer EMF au format JPG" >}}
