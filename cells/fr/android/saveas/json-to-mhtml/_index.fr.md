---
title:  Enregistrer JSON sous MHTML API pour Android
description: Utilisation du SDK Cloud Aspose.Cells pour Android pour enregistrer le fichier au format JSON en tant que fichier au format MHTML.
url: /fr/android/saveas/json-to-mhtml/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer JSON au format MHTML" gistPath="" %}}
