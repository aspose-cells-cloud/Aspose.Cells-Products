...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier PNG en tant qu\'ODS sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer PNG en tant qu\'ODS à l\'aide de REST API" gistPath="" %}}
