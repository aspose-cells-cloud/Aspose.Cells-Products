...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier TSV sous HTML dans Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer TSV sous HTML à l\'aide de REST API" gistPath="" %}}
