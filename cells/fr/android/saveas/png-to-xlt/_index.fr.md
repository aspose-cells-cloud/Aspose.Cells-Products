---
title:  Enregistrer PNG sous XLT API pour Android
description:  Utilisation du SDK Cloud Aspose.Cells pour Android pour enregistrer le fichier au format PNG en tant que fichier au format XLT.
url: /fr/android/saveas/png-to-xlt/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer PNG au format XLT" gistPath="" %}}
