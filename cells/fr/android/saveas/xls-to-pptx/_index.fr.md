---
title:  Enregistrer XLS sous PPTX API pour Android
description: Utilisation de Aspose.Cells Cloud SDK pour Android pour enregistrer le fichier au format XLS en tant que fichier au format PPTX.
url: /fr/android/saveas/xls-to-pptx/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer XLS au format PPTX" gistPath="" %}}
