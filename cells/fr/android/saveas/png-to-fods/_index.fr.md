...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier PNG en tant que FODS sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer PNG en tant que FODS à l\'aide de REST API" gistPath="" %}}
