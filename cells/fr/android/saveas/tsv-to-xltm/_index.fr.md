...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier TSV au format XLTM sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer TSV au format XLTM à l\'aide de REST API" gistPath="" %}}
