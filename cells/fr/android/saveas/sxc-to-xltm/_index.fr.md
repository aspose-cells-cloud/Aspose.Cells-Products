---
title:  Enregistrer SXC sous XLTM API pour Android
description: Utilisation de Aspose.Cells Cloud SDK pour Android pour enregistrer le fichier au format SXC en tant que fichier au format XLTM.
url: /fr/android/saveas/sxc-to-xltm/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Android utilisant REST API pour enregistrer SXC au format XLTM" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Java API pour enregistrer SXC en tant que XLTM" >}}
