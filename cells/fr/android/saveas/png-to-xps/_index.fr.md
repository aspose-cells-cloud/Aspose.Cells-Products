...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier PNG sous XPS dans Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer PNG sous XPS à l\'aide de REST API" gistPath="" %}}
