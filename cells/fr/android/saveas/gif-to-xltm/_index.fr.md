...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier GIF au format XLTM sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer un GIF au format XLTM à l\'aide de REST API" gistPath="" %}}
