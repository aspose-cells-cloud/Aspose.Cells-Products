...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier JSON sous le nom BMP dans Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer JSON sous BMP à l\'aide de REST API" gistPath="" %}}
