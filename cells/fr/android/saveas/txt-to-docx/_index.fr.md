...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier TXT au format DOCX sous Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer TXT au format DOCX à l\'aide de REST API" gistPath="" %}}
