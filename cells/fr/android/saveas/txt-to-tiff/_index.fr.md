...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier TXT sous TIFF dans Android" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Android pour enregistrer TXT sous TIFF à l\'aide de REST API" gistPath="" %}}
