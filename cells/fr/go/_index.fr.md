---
title:  Go Cloud SDK pour générer, modifier et convertir des fichiers Excel API REST via
...
<p>Aspose.Cells Cloud Go SDK prend entièrement en charge plusieurs fonctionnalités avancées liées à la lecture et à l'écriture de feuilles de calcul telles que créer une nouvelle feuille de calcul à partir de zéro, modifier un fichier existant, ajouter une nouvelle feuille de calcul, importer des données dans une feuille de calcul Excel, masquer et afficher une feuille de calcul, déplacer une feuille de calcul, trier des données dans une feuille de calcul, copier ou renommer une feuille, geler ou dégeler une feuille de calcul, ajouter ou supprimer un classeur, chiffrer ou déchiffrer un classeur, protéger par mot de passe un classeur Excel, fusionner des classeurs Excel et bien d'autres.</p>
<p>À l'aide de Aspose.Cells, le développeur du SDK Cloud Go peut facilement effectuer le filtrage automatique, la gestion des tableaux croisés dynamiques et la mise en forme conditionnelle des feuilles de calcul à l'aide des commandes Go. Le SDK a fourni une opération de conversion de fichier de feuille de calcul très puissante et prend entièrement en charge l'inter-conversion entre les formats Microsoft Excel comme XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM ainsi que la conversion vers d'autres formats de fichiers populaires comme PDF, XPS, SVG , TIFF, formats Markdown et DIF.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
Résumer les données d'un grand ListObject ou d'une table avec un tableau croisé dynamique
 ...
 Premiers pas avec le SDK de traitement de feuille de calcul Excel
    ...
    <p>
Pour démarrer avec Aspose.Cells Cloud SDK for Go, vous n'avez rien à installer. Il vous suffit de créer un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
 Aspose pour le Cloud
     </a>
 et obtenez les informations de votre candidature. Une fois que vous avez l'App SID &amp; clé, vous êtes prêt à utiliser Aspose.Cells Cloud SDK for Go sur n'importe quelle plate-forme prenant en charge les API REST. Aspose.Cells Le SDK Cloud pour Ruby vous fournit toutes les fonctionnalités pour créer, modifier et convertir des feuilles de calcul. Il vous permet également d'extraire des données des feuilles de calcul pour un traitement ou un stockage ultérieur.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Générer un classeur Excel à partir d'un modèle
    ...
    <p>
Aspose.Cells Le SDK Cloud Go inclut une fonctionnalité permettant de créer par programmation le classeur Excel à partir d'un fichier de modèle à l'aide du langage Go. Une fois le classeur créé, vous pouvez facilement le modifier en fonction de vos propres besoins. Vous pouvez ajouter une nouvelle feuille au classeur, attribuer un nom, définir les polices de votre choix, appliquer des styles aux cellules, supprimer une feuille et bien plus encore. Vous pouvez également créer un classeur à partir d'un fichier de modèle SmartMarker avec seulement quelques lignes de code.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Chart est un outil puissant qui aide les utilisateurs à présenter les données de manière à mieux comprendre les données et les utilisateurs peuvent afficher visuellement les données dans différents formats de graphique tels que Bar, Column, Pie, Line, Area, Doughnut, Scatter, Surface, ou des cartes radar pour une meilleure compréhension. Aspose.Cells Le SDK Cloud Go offre la possibilité d'ajouter et de gérer des graphiques dans une feuille de calcul. Il a fourni des fonctionnalités telles que l'obtention d'un graphique à partir de la feuille de calcul, la suppression de tous les graphiques ou d'un graphique spécifique, la conversion d'un graphique en image, l'ajout d'un titre à un graphique, le masquage du graphique, l'affichage des légendes de discussion, etc.
 ...
 Poignée Cells &amp; Lignes dans une feuille de calcul
    ...
    <p>
Aspose.Cells Cloud Go SDK a inclus plusieurs fonctionnalités importantes pour la gestion des lignes dans l'application Microsoft Excel Worksheet via Go. Il prend en charge l'ajout de nouvelles lignes à une feuille de calcul, le masquage et l'affichage de lignes, l'obtention de données de ligne à partir d'une feuille de calcul, la copie de lignes, le regroupement et le dégroupement de lignes, l'ajustement automatique des lignes et des colonnes d'une feuille de calcul, la suppression de lignes de la feuille de calcul et bien plus encore. Comme les développeurs de lignes, ils peuvent également gérer facilement leurs cellules dans la feuille de calcul. Il prend en charge des fonctionnalités telles que l'ajout de cellules, la fusion de plusieurs cellules, la définition d'une formule dans une cellule, la suppression du contenu d'une cellule, l'application d'une mise en forme de texte enrichi, etc.
    </p>
    <h2 class="h2title">
 Rechercher et remplacer des classeurs de texte
    </h2>
    <p>
 Aspose.Cells Le SDK Cloud Go prend en charge l'utilisation de texte dans un classeur à l'aide des commandes de langage Go. Le SDK a fourni des fonctionnalités très utiles liées à la recherche de texte et à leur mise à jour, telles que la recherche et le remplacement de texte dans un classeur ou dans une feuille de calcul, l'obtention d'éléments de texte à partir de feuilles de calcul, etc. De plus, vous pouvez également extraire du texte, des images ou des formes d'une feuille de calcul avec de simples commandes Go.
    </p>
    <p>
    </p>
   </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Cells SDK Cloud pour Go ?" tabId="success-stories" >}}
