...
---
{{< blocks/products/cells/cells-cloud-banner h1="Enregistrer XLSB en tant que FODS" h2="Accédez à la bibliothèque pour enregistrer XLSB en tant que FODS" p="Utilisez SaveAs API sur Cells Cloud pour créer des flux de travail de feuille de calcul personnalisés dans Go. Il s\'agit d\'une solution professionnelle pour enregistrer XLSB au format FODS et autres formats de documents en ligne à l\'aide de Go." urlsection="saveas/xlsb-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier XLSB au format FODS dans Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go Exemple de code pour enregistrer XLSB en tant que FODS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLSB au format FODS à l\'aide de la bibliothèque Cloud Go Cells." >}}
