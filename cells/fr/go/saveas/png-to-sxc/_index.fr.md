---
title:  Enregistrez PNG en tant que SXC API pour Go
...
<br/>
L'enregistrement des formats de fichiers à partir de PNG en tant que SXC est une tâche complexe. Toutes les transitions du format PNG vers le format SXC sont effectuées par notre SDK Go tout en conservant le contenu structurel et logique principal de la feuille de calcul source PNG. Notre bibliothèque Go est une solution professionnelle pour enregistrer PNG sous forme de fichiers SXC en ligne. Ce SDK Cloud offre aux développeurs Go des fonctionnalités puissantes et une sortie SXC parfaite.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Go utilisant REST API pour enregistrer PNG au format SXC" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Go API pour enregistrer PNG en tant que SXC" >}}
