...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier XLT au format JSON dans Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Go Exemple de code pour enregistrer XLT au format JSON à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLT au format JSON à l\'aide de la bibliothèque Cloud Go Cells." >}}
