---
title:  BMP à XLSX Convertir API pour Go
description: Utilisation du SDK Cloud Aspose.Cells pour Go pour convertir le fichier au format BMP en fichier au format XLSX.
url: /fr/go/conversion/bmp-to-xlsx/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Go utilisant REST API pour convertir BMP au format XLSX" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Go API pour convertir BMP en XLSX" >}}
