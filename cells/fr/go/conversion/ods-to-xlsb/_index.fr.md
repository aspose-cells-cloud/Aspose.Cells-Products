---
title:  ODS en XLSB Convertir API pour Go
description:  Utilisation du SDK Cloud Aspose.Cells pour Go pour convertir le fichier au format ODS en fichier au format XLSB.
url: /fr/go/conversion/ods-to-xlsb/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code dans Go utilisant REST API pour convertir ODS au format XLSB" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Go API pour convertir ODS en XLSB" >}}
