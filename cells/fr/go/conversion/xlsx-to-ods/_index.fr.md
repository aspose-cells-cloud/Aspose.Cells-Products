---
title:  Convertir XLSX en ODS API pour Go
description:  Utilisation du SDK Cloud Aspose.Cells pour Go pour convertir le fichier au format XLSX en fichier au format ODS.
url: /fr/go/conversion/xlsx-to-ods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Allez API pour convertir XLSX en ODS" h2="Aller à la bibliothèque pour convertir XLSX en ODS" p="Utilisez Cells Conversion REST API pour créer des workflows de feuille de calcul personnalisés dans Go. Il s\'agit d\'une solution professionnelle pour convertir XLSX en ODS et d\'autres formats de documents en ligne à l\'aide de Go." urlsection="conversion/xlsx-to-ods/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Go API pour convertir XLSX en ODS" >}}
