...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exporter la FEUILLE DE TRAVAIL vers le PNG à partir du Excel" h2="Accédez à la bibliothèque pour exporter WORKSHEET vers le fichier PNG" p="Utilisez Export API de Cells Cloud pour exporter les workflows d\'objets internes du fichier Excel dans Go. Il s\'agit d\'une solution professionnelle pour exporter WORKSHEET au format PNG à partir d\'une feuille de calcul en ligne à l\'aide de Go." urlsection="export/worksheet-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporter l\'objet WORKSHEET vers un fichier au format PNG à l\'aide du SDK Cloud Cells pour Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Go utilisant REST API pour exporter WORKSHEET au format PNG à partir d\'une feuille de calcul" gistPath="" %}}
