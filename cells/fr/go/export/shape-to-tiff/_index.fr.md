...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exporter SHAPE vers TIFF à partir de Excel" h2="Accédez à la bibliothèque pour exporter SHAPE vers le fichier TIFF" p="Utilisez Export API de Cells Cloud pour exporter les workflows d\'objets internes du fichier Excel dans Go. Il s\'agit d\'une solution professionnelle pour exporter SHAPE au format TIFF à partir d\'une feuille de calcul en ligne à l\'aide de Go." urlsection="export/shape-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet SHAPE vers un fichier au format TIFF à l\'aide du SDK Cloud Cells pour Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Go utilisant REST API pour exporter SHAPE au format TIFF à partir d\'une feuille de calcul" gistPath="" %}}
