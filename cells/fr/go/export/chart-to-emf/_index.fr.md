...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exporter le graphique vers EMF à partir de Excel" h2="Accédez à la bibliothèque pour exporter CHART vers le fichier EMF" p="Utilisez Export API de Cells Cloud pour exporter les workflows d\'objets internes du fichier Excel dans Go. Il s\'agit d\'une solution professionnelle pour exporter CHART au format EMF à partir d\'une feuille de calcul en ligne à l\'aide de Go." urlsection="export/chart-to-emf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exporter l\'objet CHART vers un fichier au format EMF à l\'aide du SDK Cloud Cells pour Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Go utilisant REST API pour exporter CHART au format EMF à partir d\'une feuille de calcul" gistPath="" %}}
