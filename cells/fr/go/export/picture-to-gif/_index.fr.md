...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet PICTURE vers un fichier au format GIF à l\'aide du SDK Cloud Cells pour Go" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Go utilisant REST API pour exporter PICTURE au format GIF à partir d\'une feuille de calcul" gistPath="" %}}
