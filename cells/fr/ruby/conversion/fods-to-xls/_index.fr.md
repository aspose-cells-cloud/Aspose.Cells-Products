...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLS avec Ruby" h2="Lisez, modifiez et exportez les données Excel vers d\'autres formats avec le SDK Cloud open source pour Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en XLS avec Ruby" %}}
...
1. Appelez la méthode ```CellsApi.cells_save_as_post_document_save_as``` pour obtenir le fichier XLS résultant
...
{{% blocks/products/pf/agp/code-autogen title="Code Ruby pour la conversion FODS en XLS" gistPath="" %}}
```ruby
