...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLT avec Ruby" h2="Lisez, modifiez et exportez les données Excel vers d\'autres formats avec le SDK Cloud open source pour Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Code Ruby pour la conversion FODS en XLT" gistPath="" %}}
```ruby
