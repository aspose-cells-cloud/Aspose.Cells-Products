...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en HTML avec Ruby" h2="Lire, modifier et exporter des données Excel vers d\'autres formats avec le SDK Cloud open source pour Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Conversion du code Ruby pour FODS en HTML" gistPath="" %}}
```ruby
