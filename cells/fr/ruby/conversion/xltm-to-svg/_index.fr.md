...
{{< blocks/products/cells/cells-cloud-section title="Convertir XLTM en SVG à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour convertir XLTM en SVG à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLTM en SVG à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
