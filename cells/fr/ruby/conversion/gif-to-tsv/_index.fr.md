...
{{< blocks/products/cells/cells-cloud-section title="Convertir GIF en TSV à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour convertir GIF en TSV à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir un GIF en TSV à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
