...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Convertir MHTML en GIF à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Exemple de code Ruby pour convertir MHTML en GIF à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser le SDK Cloud Cells pour Ruby pour convertir des fichiers Excel vers d\'autres formats MHTML en GIF" >}}
