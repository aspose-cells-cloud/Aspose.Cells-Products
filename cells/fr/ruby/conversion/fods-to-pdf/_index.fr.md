...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en PDF avec Ruby" h2="Lisez, modifiez et exportez les données Excel vers d\'autres formats avec le SDK Cloud open source pour Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en PDF avec Ruby" %}}
...
1. Appelez la méthode ```CellsApi.cells_save_as_post_document_save_as``` pour obtenir le fichier PDF résultant
...
{{% blocks/products/pf/agp/code-autogen title="Code Ruby pour la conversion FODS en PDF" gistPath="" %}}
```ruby
