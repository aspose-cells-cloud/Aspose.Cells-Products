...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API pour convertir HTML en XLTX" h2="Bibliothèque Ruby pour convertir HTML en XLTX" p="Utilisez Cells Conversion REST API pour créer des workflows de feuille de calcul personnalisés dans Ruby. Il s\'agit d\'une solution professionnelle pour convertir HTML en XLTX et d\'autres formats de documents en ligne à l\'aide de Ruby." urlsection="conversion/html-to-xltx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Convertir un fichier HTML en XLTX en Ruby" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Ruby API pour convertir HTML en XLTX" >}}
