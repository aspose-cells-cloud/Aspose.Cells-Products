...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLTM avec Ruby" h2="Lire, modifier et exporter des données Excel vers d\'autres formats avec le SDK Cloud open source pour Ruby" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion FODS en XLTM avec Ruby" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Code Ruby pour la conversion de FODS en XLTM" gistPath="" %}}
```ruby
