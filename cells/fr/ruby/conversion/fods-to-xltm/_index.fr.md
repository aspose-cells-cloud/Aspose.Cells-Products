---
title:  Convertir de Excel FODS à XLTM via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en XLTM avec Ruby" h2="Lisez, modifiez et exportez les données Excel vers d\'autres formats avec le SDK Cloud open source pour Ruby" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Code Ruby pour la conversion FODS en XLTM" gistPath="" %}}
```ruby
