...
{{< blocks/products/cells/cells-cloud-section title="Convertissez XLTM en DOCX à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour convertir XLTM en DOCX à l\'aide du SDK Cloud Cells" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment convertir XLTM en DOCX à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
