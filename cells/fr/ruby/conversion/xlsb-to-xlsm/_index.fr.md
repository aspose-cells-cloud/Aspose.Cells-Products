...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Ruby API pour convertir XLSB en XLSM" h2="bibliothèque Ruby pour convertir XLSB en XLSM" p="Utilisez Cells Conversion REST API pour créer des workflows de feuille de calcul personnalisés dans Ruby. Il s\'agit d\'une solution professionnelle pour convertir XLSB en XLSM et d\'autres formats de documents en ligne à l\'aide de Ruby." urlsection="conversion/xlsb-to-xlsm/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser Ruby API pour convertir XLSB en XLSM" >}}
