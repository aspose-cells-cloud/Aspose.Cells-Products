...
{{< blocks/products/cells/cells-cloud-section title="Exporter l\'objet LISTOBJECT vers un fichier au format XPS à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Ruby utilisant REST API pour exporter LISTOBJECT au format XPS à partir d\'une feuille de calcul" gistPath="" %}}
