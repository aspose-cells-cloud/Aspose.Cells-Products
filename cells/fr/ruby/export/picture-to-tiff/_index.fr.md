...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet PICTURE vers un fichier au format TIFF à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Ruby utilisant REST API pour exporter PICTURE au format TIFF à partir d\'une feuille de calcul" gistPath="" %}}
