...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exportez l\'objet SHAPE vers un fichier au format JPG à l\'aide du SDK Cloud Cells pour Ruby" >}}
