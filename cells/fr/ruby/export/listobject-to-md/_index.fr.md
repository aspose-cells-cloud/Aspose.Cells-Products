...
{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet LISTOBJECT vers un fichier au format MD à l\'aide du SDK Cloud Cells pour Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Ruby utilisant REST API pour exporter LISTOBJECT au format MD à partir d\'une feuille de calcul" gistPath="" %}}
