...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Exporter l\'objet SHAPE vers un fichier au format WMF à l\'aide du SDK Cloud Cells pour Ruby" >}}
