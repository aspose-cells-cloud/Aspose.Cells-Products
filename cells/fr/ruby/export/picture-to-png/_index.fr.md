---
title:  Exportez PICTURE vers PNG à partir de Excel à l'aide du SDK Cloud Cells pour Ruby
...
---
{{< blocks/products/cells/cells-cloud-banner h1="Exporter l\'IMAGE vers le PNG à partir du Excel" h2="Bibliothèque Ruby pour exporter PICTURE vers le fichier PNG" p="Utilisez Export API de Cells Cloud pour exporter les workflows d\'objets internes du fichier Excel dans Ruby. Il s\'agit d\'une solution professionnelle pour exporter une image au format PNG à partir d\'une feuille de calcul en ligne à l\'aide de Ruby." urlsection="export/picture-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="Exportez l\'objet PICTURE vers un fichier au format PNG à l\'aide du SDK Cloud Cells pour Ruby" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
Exporter un objet PICTURE vers le fichier PNG à partir du fichier Excel est une tâche complexe. Les transitions d'exportation du format PICTURE au format PNG sont effectuées par notre SDK Ruby tout en conservant le contenu structurel et logique principal de la feuille de calcul PICTURE source. Notre bibliothèque Ruby est une solution professionnelle pour exporter des objets PICTURE vers des fichiers au format PNG en ligne. Ce SDK Cloud offre aux développeurs Ruby des fonctionnalités puissantes et une sortie PNG parfaite.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code dans Ruby utilisant REST API pour exporter PICTURE au format PNG à partir d\'une feuille de calcul" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Comment utiliser le SDK Cloud Cells pour Ruby pour exporter des objets de Excel PICTURE vers PNG" >}}
