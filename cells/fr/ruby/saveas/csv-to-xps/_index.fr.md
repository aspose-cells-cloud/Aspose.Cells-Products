...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier CSV sous XPS dans Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour enregistrer le CSV sous XPS à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer un fichier CSV sous le nom XPS à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
