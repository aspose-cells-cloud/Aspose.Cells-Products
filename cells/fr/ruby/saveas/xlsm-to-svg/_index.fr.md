...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLSM sous SVG dans Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour enregistrer XLSM sous SVG à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLSM sous le nom SVG à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
