...
{{< blocks/products/cells/cells-cloud-section title="Enregistrer un fichier XLS au format XLTM dans Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour enregistrer XLS au format XLTM à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLS au format XLTM à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
