...
{{< blocks/products/cells/cells-cloud-section title="Enregistrez un fichier XLTX sous PNG dans Ruby" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Exemple de code Ruby pour enregistrer XLTX sous PNG à l\'aide de REST API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Découvrez comment enregistrer XLTX sous le nom PNG à l\'aide de la bibliothèque Cloud Ruby Cells." >}}
