---
title: 将 XLSB 保存为适用于 Android 的 XLTM API
...
<br/>
将 XLSB 的文件格式保存为 XLTM 是一项复杂的任务。所有 XLSB 到 XLTM 格式的转换都由我们的 Android SDK 执行，同时保持源 XLSB 电子表格的主要结构和逻辑内容。我们的 Android 库是将 XLSB 在线保存为 XLTM 文件的专业解决方案。此 Cloud SDK 为 Android 开发人员提供了强大的功能和完美的 XLTM 输出。
<br/>
<br/>
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Java API将XLSB另存为XLTM" >}}
