...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 TXT 保存为 DIF" h2="用于将 TXT 保存为 DIF 的 Android 库" p="使用 Cells Cloud 的 SaveAs API 在 Android 中创建自定义电子表格工作流程。这是使用Android在线将TXT保存为DIF和其他文档格式的专业解决方案。" urlsection="saveas/txt-to-dif/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 Android 中将 TXT 文件保存为 DIF" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST 将 TXT 保存为 DIF 的 Android 代码示例 API" gistPath="" %}}
