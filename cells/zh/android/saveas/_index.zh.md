---
title: 使用Android将Excel文件另存为其他格式
description: Aspose.Cells Cloud REST API支持使用Android以各种格式保存Excel文件，并提供多种编程语言的SDK。
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="使用Android将Excel文件另存为其他格式" h2="Aspose.Cells Cloud SDK 支持以 30 多种不同的文件格式保存工作簿。" p="Aspose.Cells Cloud REST API支持使用Android以各种格式保存Excel文件，并提供多种编程语言的SDK。" urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="使用 Android 扩展链接将 Excel 文件另存为其他格式" >}}
