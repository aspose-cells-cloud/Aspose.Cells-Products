...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android API 将 XLSB 保存为 MHTML" h2="将 XLSB 保存为 MHTML 的 Android 库" p="使用 Cells SaveAs REST API 在 Android 中创建自定义电子表格工作流程。这是使用 Android 在线将 XLSB 保存为 MHTML 和其他文档格式的专业解决方案。" urlsection="saveas/xlsb-to-mhtml/" >}}
