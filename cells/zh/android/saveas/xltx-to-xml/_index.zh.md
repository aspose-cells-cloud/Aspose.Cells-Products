---
title: 将 XLTX 另存为 XML API for Android
...
<br/>
将 XLTX 中的文件格式保存为 XML 是一项复杂的任务。所有 XLTX 到 XML 格式的转换都由我们的 Android SDK 执行，同时保持源 XLTX 电子表格的主要结构和逻辑内容。我们的 Android 库是将 XLTX 在线保存为 XML 文件的专业解决方案。此 Cloud SDK 为 Android 开发人员提供了强大的功能和完美的 XML 输出。
<br/>
<br/>
