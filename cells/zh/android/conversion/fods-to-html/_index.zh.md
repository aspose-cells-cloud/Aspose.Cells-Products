...
{{% blocks/products/pf/agp/feature-section-col title="Android 应用中 FODS 到 HTML 的转换" %}}
...
1. 调用```CellsApi.cellsWorkbookGetWorkbook```得到结果HTML文件
...
{{% blocks/products/pf/agp/code-autogen title="安卓：FODS 到 HTML 的转换" gistPath="" %}}
```java
