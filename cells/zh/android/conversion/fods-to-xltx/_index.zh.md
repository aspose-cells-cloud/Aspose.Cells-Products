---
title: 在 Android 上将 FODS 转换为 XLTX
description: 自动化 Excel 文件操作操作，例如使用云 API 和开源 Android SDK 创建、编辑和转换
url: /zh/android/conversion/fods-to-xltx/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云端将 FODS 转换为 XLTX" h2="使用适用于 Android 的开源 Cloud SDK 转换 Excel 和 OpenOffice 电子表格" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android 应用程序中 FODS 到 XLTX 的转换" %}}
...
1. 致电 ```CellsApi.cellsWorkbookGetWorkbook``` 获取生成的 XLTX 文件
...
{{% blocks/products/pf/agp/code-autogen title="Android：FODS 到 XLTX 转换" gistPath="" %}}
```java
