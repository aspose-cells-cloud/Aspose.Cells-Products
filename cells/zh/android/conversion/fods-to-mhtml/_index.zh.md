...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云中将 FODS 转换为 MHTML" h2="使用适用于 Android 的开源 Cloud SDK 转换 Excel 和 OpenOffice 电子表格" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android 应用程序中的 FODS 到 MHTML 转换" %}}
...
1. 调用 ```CellsApi.cellsWorkbookGetWorkbook``` 获取生成的 MHTML 文件
...
{{% blocks/products/pf/agp/code-autogen title="安卓：FODS 到 MHTML 的转换" gistPath="" %}}
```java
