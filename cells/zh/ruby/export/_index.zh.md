...
{{< blocks/products/cells/cells-cloud-upper-banner h1="使用 Ruby 导出" h2="Aspose.Cells Cloud SDK 支持将工作簿和内部对象导出为 30 多种文件格式。" p="Aspose.Cells Cloud REST API 支持使用 Ruby 将工作簿和内部对象导出为各种格式。 SDK支持开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift。" urlsection="export/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="使用 Ruby 扩展链接导出" >}}
