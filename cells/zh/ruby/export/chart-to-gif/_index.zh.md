...
---
{{< blocks/products/cells/cells-cloud-banner h1="将图表从 Excel 导出为 GIF" h2="用于将图表导出为 GIF 文件的 Ruby 库" p="使用 Cells Cloud 的 Export API 在 Ruby 中导出 Excel 文件内部对象工作流。这是使用 Ruby 在线将电子表格中的 CHART 导出为 GIF 格式文件的专业解决方案。" urlsection="export/chart-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for Ruby 将 CHART 对象导出为 GIF 格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby 中的代码示例，使用 REST API 将电子表格中的 CHART 导出为 GIF 格式" gistPath="" %}}
