---
title: 使用 Cells Cloud SDK for Ruby 将 WORKBOOK 从 Excel 导出为 JPG
...
---
{{< blocks/products/cells/cells-cloud-banner h1="从 Excel 导出 WORKBOOK 到 JPG" h2="用于将 WORKBOOK 导出为 JPG 文件的 Ruby 库" p="使用 Cells Cloud 的 Export API 以 Ruby 格式导出 Excel 文件内部对象工作流。这是一个使用 Ruby 在线将 WORKBOOK 从电子表格导出为 JPG 格式文件的专业解决方案。" urlsection="export/workbook-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for Ruby 将 WORKBOOK 对象导出为 JPG 格式文件" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
将 WORKBOOK 对象从 Excel 文件导出到 JPG 文件是一项复杂的任务。将 WORKBOOK 导出到 JPG 格式的转换由我们的 Ruby SDK 执行，同时保留源 WORKBOOK 电子表格的主要结构和逻辑内容。我们的 Ruby 库是一个专业的解决方案，可在线将 WORKBOOK 对象导出到 JPG 格式文件。此 Cloud SDK 为 Ruby 开发人员提供了强大的功能和完美的 JPG 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby 中的代码示例，使用 REST API 将电子表格中的 WORKBOOK 导出为 JPG 格式" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud SDK for Ruby 将对象从 Excel WORKBOOK 导出为 JPG" >}}
