...
---
{{< blocks/products/cells/cells-cloud-banner h1="将工作表从 Excel 导出到 WMF" h2="用于将 WORKSHEET 导出到 WMF 文件的 Ruby 库" p="使用 Cells Cloud 的 Export API 以 Ruby 格式导出 Excel 文件内部对象工作流。这是使用 Ruby 在线将 WORKSHEET 从电子表格导出为 WMF 格式文件的专业解决方案。" urlsection="export/worksheet-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for Ruby 将 WORKSHEET 对象导出为 WMF 格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST API 将电子表格中的 WORKSHEET 导出为 WMF 格式的 Ruby 代码示例" gistPath="" %}}
