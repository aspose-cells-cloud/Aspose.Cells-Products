...
---
{{< blocks/products/cells/cells-cloud-banner h1="从 Excel 导出 WORKSHEET 到 JSON" h2="用于将 WORKSHEET 导出到 JSON 文件的 Ruby 库" p="使用 Cells Cloud 的 Export API 在 Ruby 中导出 Excel 文件内部对象工作流。这是使用 Ruby 将电子表格在线导出 WORKSHEET 到 JSON 格式文件的专业解决方案。" urlsection="export/worksheet-to-json/" >}}
...
<br/>
从 Excel 文件将 WORKSHEET 对象导出到 JSON 文件是一项复杂的任务。将 WORKSHEET 导出到 JSON 格式的转换由我们的 Ruby SDK 执行，同时保留源 WORKSHEET 电子表格的主要结构和逻辑内容。我们的 Ruby 库是一个专业的解决方案，可在线将 WORKSHEET 对象导出到 JSON 格式的文件。此云 SDK 为 Ruby 开发人员提供了强大的功能和完美的 JSON 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST API 将 WORKSHEET 从电子表格导出为 JSON 格式的 Ruby 代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud SDK for Ruby 将对象从 Excel WORKSHEET 导出为 JSON" >}}
