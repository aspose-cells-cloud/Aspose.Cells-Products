...
<br/>
将文件格式从 XLSM 保存为 XLT 是一项复杂的任务。所有 XLSM 到 XLT 格式的转换均由我们的 Ruby SDK 执行，同时保留源 XLSM 电子表格的主要结构和逻辑内容。我们的 Ruby 库是将 XLSM 在线保存为 XLT 文件的专业解决方案。此 Cloud SDK 为 Ruby 开发人员提供了强大的功能和完美的 XLT 输出。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 XLSM 保存为 XLT。" >}}
