...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 XLTX 格式文件保存为 PPTX 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLTX 保存为 PPTX" h2="用于将 XLTX 保存为 PPTX 的 Ruby 库" p="使用 Cells Cloud 中的 SaveAs API 在 Ruby 中创建自定义电子表格工作流程。这是使用 Ruby 在线将 XLTX 保存为 PPTX 和其他文档格式的专业解决方案。" urlsection="saveas/xltx-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 Ruby 中将 XLTX 文件保存为 PPTX" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST 将 XLTX 保存为 PPTX 的 Ruby 代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 XLTX 另存为 PPTX。" >}}
