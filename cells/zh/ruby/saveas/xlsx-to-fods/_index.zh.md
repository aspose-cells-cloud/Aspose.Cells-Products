...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 XLSX 格式文件保存为 FODS 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSX 保存为 FODS" h2="用于将 XLSX 保存为 FODS 的 Ruby 库" p="使用 Cells Cloud 中的 SaveAs API 在 Ruby 中创建自定义电子表格工作流。这是一个专业的解决方案，可使用 Ruby 在线将 XLSX 保存为 FODS 和其他文档格式。" urlsection="saveas/xlsx-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 Ruby 中将 XLSX 文件保存为 FODS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST 将 XLSX 保存为 FODS 的 Ruby 代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 XLSX 保存为 FODS。" >}}
