...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 HTML 格式文件保存为 XLTX 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="另存 HTML 为 XLTX" h2="用于将 HTML 保存为 XLTX 的 Ruby 库" p="使用 Cells Cloud 的 SaveAs API 在 Ruby 中创建自定义电子表格工作流。这是使用 Ruby 在线将 HTML 保存为 XLTX 和其他文档格式的专业解决方案。" urlsection="saveas/html-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Ruby 将 HTML 文件保存为 XLTX" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 HTML 另存为 XLTX。" >}}
