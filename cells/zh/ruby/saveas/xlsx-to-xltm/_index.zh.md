...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSX 另存为 XLTM" h2="用于将 XLSX 保存为 XLTM 的 Ruby 库" p="使用 Cells Cloud 的 SaveAs API 在 Ruby 中创建自定义电子表格工作流程。这是使用 Ruby 在线将 XLSX 保存为 XLTM 和其他文档格式的专业解决方案。" urlsection="saveas/xlsx-to-xltm/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 XLSX 保存为 XLTM。" >}}
