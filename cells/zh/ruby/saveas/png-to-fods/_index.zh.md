...
---
{{< blocks/products/cells/cells-cloud-banner h1="保存 PNG 为 FODS" h2="用于将 PNG 保存为 FODS 的 Ruby 库" p="使用 Cells Cloud 的 SaveAs API 在 Ruby 中创建自定义电子表格工作流程。这是使用 Ruby 在线将 PNG 保存为 FODS 和其他文档格式的专业解决方案。" urlsection="saveas/png-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 Ruby 中将 PNG 文件另存为 FODS" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
将 PNG 的文件格式保存为 FODS 是一项复杂的任务。所有 PNG 到 FODS 格式的转换均由我们的 Ruby SDK 执行，同时保留源 PNG 电子表格的主要结构和逻辑内容。我们的 Ruby 库是将 PNG 在线保存为 FODS 文件的专业解决方案。此云 SDK 为 Ruby 开发人员提供了强大的功能和完美的 FODS 输出。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 PNG 保存为 FODS。" >}}
