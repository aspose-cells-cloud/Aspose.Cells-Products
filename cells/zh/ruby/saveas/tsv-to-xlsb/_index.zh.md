...
<br/>
将文件格式从 TSV 保存为 XLSB 是一项复杂的任务。所有 TSV 到 XLSB 格式的转换均由我们的 Ruby SDK 执行，同时保留源 TSV 电子表格的主要结构和逻辑内容。我们的 Ruby 库是将 TSV 在线保存为 XLSB 文件的专业解决方案。此云 SDK 为 Ruby 开发人员提供了强大的功能和完美的 XLSB 输出。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 TSV 保存为 XLSB。" >}}
