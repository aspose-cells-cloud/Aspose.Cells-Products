...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 HTML 格式文件保存为 MD 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="另存 HTML 为 MD" h2="用于将 HTML 保存为 MD 的 Ruby 库" p="使用 Cells Cloud 的 SaveAs API 在 Ruby 中创建自定义电子表格工作流。这是使用 Ruby 在线将 HTML 保存为 MD 和其他文档格式的专业解决方案。" urlsection="saveas/html-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Ruby 将 HTML 文件保存为 MD" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST API 将 HTML 保存为 MD 的 Ruby 代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 HTML 保存为 MD。" >}}
