---
title: 从 Excel FODS 转换为 XLSB via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Ruby 将 FODS 转换为 XLSB" h2="使用开源 Cloud SDK for Ruby 读取、编辑和导出 Excel 数据为其他格式" >}}
...
1. 调用```CellsApi.cells_save_as_post_document_save_as```方法得到生成的XLSB文件
...
{{% blocks/products/pf/agp/code-autogen title="FODS 到 XLSB 转换的 Ruby 代码" gistPath="" %}}
```ruby
