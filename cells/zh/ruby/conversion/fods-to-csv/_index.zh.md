---
title: 从 Excel FODS 转换为 CSV via Ruby
description: 使用 REST API 和开源 Ruby SDK 创建、编辑或转换 Excel 文件
url: /zh/ruby/conversion/fods-to-csv/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Ruby 将 FODS 转换为 CSV" %}}
...
1. 调用 ```CellsApi.cells_save_as_post_document_save_as``` 方法获取结果 CSV 文件
