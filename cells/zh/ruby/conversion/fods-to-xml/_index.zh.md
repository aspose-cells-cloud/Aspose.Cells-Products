---
title: 从 Excel FODS 转换为 XML via Ruby
description: 使用 REST API 和开源 Ruby SDK 创建、编辑或转换 Excel 文件
url: /zh/ruby/conversion/fods-to-xml/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Ruby 将 FODS 转换为 XML" h2="使用开源 Cloud SDK for Ruby 读取、编辑 Excel 数据并将其导出为其他格式" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Ruby 将 FODS 转换为 XML" %}}
...
{{% blocks/products/pf/agp/code-autogen title="用于 FODS 到 XML 转换的 Ruby 代码" gistPath="" %}}
```ruby
