...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 HTML 格式文件转换为 JPG 格式文件。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 HTML 转换为 JPG。" >}}
