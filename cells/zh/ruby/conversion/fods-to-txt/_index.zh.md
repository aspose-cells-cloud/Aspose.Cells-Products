---
title: 从 Excel FODS 转换为 TXT via 红宝石
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Ruby 将 FODS 转换为 TXT" h2="使用开源 Cloud SDK for Ruby 读取、编辑 Excel 数据并将其导出为其他格式" >}}
...
{{% blocks/products/pf/agp/code-autogen title="用于 FODS 到 TXT 转换的 Ruby 代码" gistPath="" %}}
```ruby
