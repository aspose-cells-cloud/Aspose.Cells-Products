...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 CSV 格式文件转换为 XPS 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 CSV 转换为 XPS" h2="用于将 CSV 转换为 XPS 的 Ruby 库" p="使用 Cells Cloud 的转换 API 在 Ruby 项目中创建自定义电子表格工作流。这是一个专业的解决方案，可使用 Ruby 在线将 CSV 转换为 XPS 和其他文档格式。" urlsection="conversion/csv-to-xps/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 CSV 转换为 XPS。" >}}
