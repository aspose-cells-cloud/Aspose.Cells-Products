...
{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for Ruby 将 CSV 转换为 XLS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 Cells Cloud SDK 将 CSV 转换为 XLS 的 Ruby 代码示例" gistPath="" %}}
