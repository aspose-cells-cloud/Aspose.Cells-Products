---
title: 从 Excel FODS 转换为 XLSM via Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Ruby 将 FODS 转换为 XLSM" h2="使用开源 Cloud SDK for Ruby 读取、编辑和导出 Excel 数据为其他格式" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS 到 XLSM 转换的 Ruby 代码" gistPath="" %}}
```ruby
