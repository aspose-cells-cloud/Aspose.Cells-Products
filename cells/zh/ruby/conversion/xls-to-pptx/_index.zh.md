...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS 转换为 PPTX" h2="用于将 XLS 转换为 PPTX 的 Ruby 库" p="使用 Cells Cloud 的 Conversion API 在 Ruby 项目中创建自定义电子表格工作流程。这是使用 Ruby 在线将 XLS 转换为 PPTX 和其他文档格式的专业解决方案。" urlsection="conversion/xls-to-pptx/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 XLS 转换为 PPTX。" >}}
