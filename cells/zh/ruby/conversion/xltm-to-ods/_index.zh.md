...
description: 利用 Aspose.Cells Cloud SDK for Ruby 将 XLTM 格式文件转换为 ODS 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLTM 转换为 ODS" h2="用于将 XLTM 转换为 ODS 的 Ruby 库" p="使用 Cells Cloud 的转换 API 在 Ruby 项目中创建自定义电子表格工作流。这是使用 Ruby 在线将 XLTM 转换为 ODS 和其他文档格式的专业解决方案。" urlsection="conversion/xltm-to-ods/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Ruby 库将 XLTM 转换为 ODS。" >}}
