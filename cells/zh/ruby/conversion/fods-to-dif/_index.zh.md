---
title: 转换 Excel FODS 为 DIF via 红宝石
description: 使用 REST API 和开源 Ruby SDK 创建、编辑或转换 Excel 文件
url: /zh/ruby/conversion/fods-to-dif/
family: cells
platformtag: ruby
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Ruby 将 FODS 转换为 DIF" h2="使用开源 Cloud SDK for Ruby 读取、编辑 Excel 数据并将其导出为其他格式" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Ruby 将 FODS 转换为 DIF" %}}
...
1. 调用```CellsApi.cells_save_as_post_document_save_as```方法获取生成的DIF文件
...
{{% blocks/products/pf/agp/code-autogen title="用于 FODS 到 DIF 转换的 Ruby 代码" gistPath="" %}}
```ruby
