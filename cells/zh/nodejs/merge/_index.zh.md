---
title: 使用 NodeJS 合并 Excel 文件
description: Aspose.Cells Cloud REST API 支持使用 NodeJS 将多个 Excel 文件合并为单个 Excel 文件，并提供适用于各种编程语言的 SDK。
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="使用 NodeJS 合并 Excel 文件" h2="Aspose.Cells Cloud SDK 支持将多个 Excel 文件合并为单个 Excel 文件。" p="Aspose.Cells Cloud REST API 支持使用 NodeJS 将多个 Excel 文件合并为单个 Excel 文件，并提供适用于各种编程语言的 SDK。" urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="使用 NodeJS 扩展链接合并 Excel 文件" >}}
