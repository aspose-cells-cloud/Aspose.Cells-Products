---
title: 使用 Cells Cloud SDK for NodeJS 将 SHAPE 从 Excel 导出到 WMF
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="NodeJS 中使用 REST API 将 SHAPE 从电子表格导出为 WMF 格式的代码示例" gistPath="" %}}
