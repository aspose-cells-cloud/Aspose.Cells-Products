...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 WORKBOOK 从 Excel 导出为 GIF" h2="用于将 WORKBOOK 导出到 GIF 文件的 NodeJS 库" p="使用Cells云的Export API导出NodeJS中的Excel文件内部对象工作流程。这是使用 NodeJS 将电子表格在线导出 WORKBOOK 到 GIF 格式文件的专业解决方案。" urlsection="export/workbook-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for NodeJS 将 WORKBOOK 对象导出为 GIF 格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="NodeJS 中使用 REST API 将电子表格中的 WORKBOOK 导出为 GIF 格式的代码示例" gistPath="" %}}
