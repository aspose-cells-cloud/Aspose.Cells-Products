---
title: 使用 Cells Cloud SDK for NodeJS 将 CHART 从 Excel 导出为 GIF
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将图表从 Excel 导出为 GIF" h2="用于将图表导出为 GIF 文件的 NodeJS 库" p="使用Cells云的Export API导出NodeJS中的Excel文件内部对象工作流程。这是使用 NodeJS 将电子表格在线导出 CHART 到 GIF 格式文件的专业解决方案。" urlsection="export/chart-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for NodeJS 将 CHART 对象导出为 GIF 格式文件" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
从 Excel 文件将 CHART 对象导出到 GIF 文件是一项复杂的任务。将 CHART 导出到 GIF 格式的转换由我们的 NodeJS SDK 执行，同时保留源 CHART 电子表格的主要结构和逻辑内容。我们的 NodeJS 库是一个专业的解决方案，可在线将 CHART 对象导出到 GIF 格式文件。此 Cloud SDK 为 NodeJS 开发人员提供了强大的功能和完美的 GIF 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="NodeJS 中使用 REST API 将 CHART 从电子表格导出为 GIF 格式的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud SDK for Node 将对象从 Excel CHART 导出为 GIF" >}}
