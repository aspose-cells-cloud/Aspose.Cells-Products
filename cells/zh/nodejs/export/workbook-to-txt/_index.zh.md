---
title: 使用 Cells Cloud SDK for NodeJS 将 WORKBOOK 从 Excel 导出到 TXT
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 WORKBOOK 从 Excel 导出到 TXT" h2="用于将 WORKBOOK 导出到 TXT 文件的 NodeJS 库" p="使用 Cells Cloud 的 Export API 在 NodeJS 中导出 Excel 文件内部对象工作流。这是一个使用 NodeJS 在线将 WORKBOOK 从电子表格导出为 TXT 格式文件的专业解决方案。" urlsection="export/workbook-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for NodeJS 将 WORKBOOK 对象导出为 TXT 格式文件" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
将 WORKBOOK 对象从 Excel 文件导出到 TXT 文件是一项复杂的任务。将 WORKBOOK 导出到 TXT 格式的转换由我们的 NodeJS SDK 执行，同时保留源 WORKBOOK 电子表格的主要结构和逻辑内容。我们的 NodeJS 库是一个专业的解决方案，可在线将 WORKBOOK 对象导出到 TXT 格式文件。此 Cloud SDK 为 NodeJS 开发人员提供了强大的功能和完美的 TXT 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="NodeJS 中使用 REST API 将 WORKBOOK 从电子表格导出为 TXT 格式的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Cells Cloud SDK for Node将Excel WORKBOOK中的对象导出到TXT" >}}
