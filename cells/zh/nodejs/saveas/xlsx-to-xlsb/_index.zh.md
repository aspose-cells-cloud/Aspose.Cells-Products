...
description: 利用 Aspose.Cells Cloud SDK for NodeJS 将 XLSX 格式文件保存为 XLSB 格式文件。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud NodeJS 库将 XLSX 保存为 XLSB。" >}}
