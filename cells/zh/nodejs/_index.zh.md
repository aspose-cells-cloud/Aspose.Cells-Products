---
title: 访问、读取和处理云 Excel 文件（via Node.js SDK）
description: 在 Node.js 中开发 Microsoft Excel 和 OpenOffice 基于云的电子表格查看器、导出器和转换器应用程序 via REST API
weight: 80
url: /zh/nodejs
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用于处理和导出 Excel 文件的 Node.js REST SDK" h2="在 Node.js via REST API 中开发 Microsoft Excel 和 OpenOffice 基于云的电子表格查看器、导出器和转换器应用程序。" logoImageSrc="/headers/aspose_cells-for-node.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Node.js" downloadUrl="" >}}
