---
title:  Excel的出口对象
description: Aspose.Cells Cloud REST API 有助于将工作簿及其内部对象导出为各种格式，并提供适用于多种编程语言的 SDK，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Excel的出口对象" h2="Aspose.Cells Cloud SDK 支持将工作簿和内部对象导出为 30 多种文件格式。" p="Aspose.Cells Cloud REST API 有助于将工作簿及其内部对象导出为各种格式，并提供适用于多种编程语言的 SDK，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。" urlsection="" >}}
