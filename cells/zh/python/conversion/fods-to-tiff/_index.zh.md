---
title: 转换 Excel FODS 为 TIFF via Python
description: 使用 REST API 和开源 Python SDK 创建、编辑或转换 Excel 文件
url: /zh/python/conversion/fods-to-tiff/
family: cells
platformtag: python
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Python 将 FODS 转换为 TIFF" h2="使用适用于 Python 的开源 Cloud SDK 读取、编辑 Excel 数据并将其导出为其他格式" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS 到 TIFF 使用 Python 转换" %}}
...
1. 调用```CellsApi.cells_save_as_post_document_save_as```方法得到结果TIFF文件
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS 到 TIFF 转换代码" gistPath="" %}}
```python
