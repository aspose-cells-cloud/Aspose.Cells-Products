---
title: 从 Excel FODS 转换为 TIFF via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Python 将 FODS 转换为 TIFF" h2="使用 Python 的开源 Cloud SDK 读取、编辑和导出 Excel 数据为其他格式" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS 代码到 TIFF 转换" gistPath="" %}}
```python
