...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Python 将 FODS 转换为 MHTML" h2="使用 Python 的开源 Cloud SDK 读取、编辑和导出 Excel 数据为其他格式" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Python 将 FODS 转换为 MHTML" %}}
...
1. 调用```CellsApi.cells_save_as_post_document_save_as```方法得到生成的MHTML文件
