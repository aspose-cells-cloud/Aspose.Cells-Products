...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Python 将 FODS 转换为 XML" h2="使用 Python 的开源 Cloud SDK 读取、编辑和导出 Excel 数据为其他格式" >}}
...
1. 调用```CellsApi.cells_save_as_post_document_save_as```方法获取生成的XML文件
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS 到 XML 转换代码" gistPath="" %}}
```python
