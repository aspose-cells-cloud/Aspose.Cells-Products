---
title: 将号码另存为 SXC API 为 Python
description: 使用Aspose.Cells Cloud SDK for Python将NUMBERS格式文件保存为SXC格式文件。
url: /zh/python/saveas/numbers-to-sxc/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Python API 将数字保存为 SXC" h2="Python 将 NUMBERS 保存为 SXC 的库" p="使用 Cells SaveAs REST API 在 Python 中创建自定义电子表格工作流程。这是使用 Python 在线将 NUMBERS 保存为 SXC 和其他文档格式的专业解决方案。" urlsection="saveas/numbers-to-sxc/" >}}
