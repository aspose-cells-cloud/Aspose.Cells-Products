...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python 使用 REST 将 XLSB 保存为 HTML 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="了解如何使用 Cells Cloud Python 库将 XLSB 另存为 HTML。" >}}
