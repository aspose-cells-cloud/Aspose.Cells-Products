...
description: 利用 Aspose.Cells Cloud SDK for Python 将 SXC 格式文件保存为 XLS 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SXC 保存为 XLS" h2="Python 用于将 SXC 保存为 XLS 的库" p="使用Cells云的SaveAs API在Python中创建自定义电子表格工作流程。这是使用Python在线将SXC保存为XLS和其他文档格式的专业解决方案。" urlsection="saveas/sxc-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 SXC 文件另存为 Python 中的 XLS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python 使用 REST 将 SXC 保存为 XLS 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Python 库将 SXC 保存为 XLS。" >}}
