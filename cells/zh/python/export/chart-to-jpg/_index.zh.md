...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 Excel 中的图表导出为 JPG" h2="Python 用于将图表导出为 JPG 文件的库" p="使用Cells云的导出API导出Python中的Excel文件内部对象工作流程。这是使用Python在线将电子表格中的CHART导出为JPG格式文件的专业解决方案。" urlsection="export/chart-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用Cells Cloud SDK for Python将CHART对象导出为JPG格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python 中的代码示例使用 REST API 将电子表格中的 CHART 导出为 JPG 格式" gistPath="" %}}
