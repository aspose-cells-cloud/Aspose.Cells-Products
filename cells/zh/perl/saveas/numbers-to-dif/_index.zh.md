...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 NUMBERS 另存为 DIF" h2="Perl 用于将 NUMBERS 保存为 DIF 的库" p="使用 Cells Cloud 的 SaveAs API 在 Perl 中创建自定义电子表格工作流程。这是使用 Perl 在线将 NUMBERS 保存为 DIF 和其他文档格式的专业解决方案。" urlsection="saveas/numbers-to-dif/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 Perl 中将 NUMBERS 文件另存为 DIF" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 使用 REST 将 NUMBERS 保存为 DIF 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Perl 库将 NUMBERS 保存为 DIF。" >}}
