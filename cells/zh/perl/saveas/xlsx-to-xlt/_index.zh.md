...
description: 利用 Aspose.Cells Cloud SDK for Perl 将 XLSX 格式文件保存为 XLT 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSX 另存为 XLT" h2="Perl 用于将 XLSX 保存为 XLT 的库" p="使用Cells云的SaveAs API在Perl中创建自定义电子表格工作流程。这是使用Perl在线将XLSX保存为XLT和其他文档格式的专业解决方案。" urlsection="saveas/xlsx-to-xlt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Perl 库将 XLSX 保存为 XLT。" >}}
