...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 TXT 保存为 SXC" h2="Perl 用于将 TXT 保存为 SXC 的库" p="使用 Cells Cloud 的 SaveAs API 在 Perl 中创建自定义电子表格工作流程。这是使用 Perl 在线将 TXT 保存为 SXC 和其他文档格式的专业解决方案。" urlsection="saveas/txt-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 TXT 文件另存为 Perl 中的 SXC" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 使用 REST 将 TXT 保存为 SXC 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Cells云Perl库将TXT另存为SXC。" >}}
