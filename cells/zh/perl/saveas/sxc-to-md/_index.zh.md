...
description: 利用 Aspose.Cells Cloud SDK 将 Perl 将 SXC 格式文件保存为 MD 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将SXC另存为MD" h2="Perl 用于将 SXC 保存为 MD 的库" p="使用 Cells Cloud 的 SaveAs API 在 Perl 中创建自定义电子表格工作流程。这是使用 Perl 在线将 SXC 保存为 MD 和其他文档格式的专业解决方案。" urlsection="saveas/sxc-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 SXC 文件保存为 Perl 中的 MD" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Cells云Perl库将SXC另存为MD。" >}}
