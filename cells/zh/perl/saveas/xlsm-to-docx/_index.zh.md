...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSM 保存为 DOCX" h2="Perl 用于将 XLSM 保存为 DOCX 的库" p="使用Cells云的SaveAs API在Perl中创建自定义电子表格工作流程。这是使用Perl在线将XLSM保存为DOCX和其他文档格式的专业解决方案。" urlsection="saveas/xlsm-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLSM 文件另存为 DOCX 中的 Perl" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="了解如何使用 Cells Cloud Perl 库将 XLSM 保存为 DOCX。" >}}
