...
description: 利用Aspose.Cells Cloud SDK for Perl将PNG格式文件保存为XLS格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 PNG 另存为 XLS" h2="Perl 库，用于将 PNG 保存为 XLS" p="使用Cells云的SaveAs API在Perl中创建自定义电子表格工作流程。这是使用Perl在线将PNG保存为XLS和其他文档格式的专业解决方案。" urlsection="saveas/png-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 PNG 文件另存为 Perl 中的 XLS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 使用 REST API 将 PNG 保存为 XLS 的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Perl 库将 PNG 保存为 XLS。" >}}
