---
title: 将 XLTM 保存为 PPTX API 为 Perl
description: 使用Aspose.Cells Cloud SDK for Perl将XLTM格式文件保存为PPTX格式文件。
url: /zh/perl/saveas/xltm-to-pptx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API 将 XLTM 保存为 PPTX" h2="Perl 将 XLTM 保存为 PPTX 的库" p="使用 Cells SaveAs REST API 在 Perl 中创建自定义电子表格工作流程。这是使用 Perl 在线将 XLTM 保存为 PPTX 和其他文档格式的专业解决方案。" urlsection="saveas/xltm-to-pptx/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Perl API 将XLTM另存为PPTX" >}}
