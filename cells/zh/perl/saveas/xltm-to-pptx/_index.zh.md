...
{{< blocks/products/cells/cells-cloud-upper-banner h1="将 XLTM 保存为 PPTX" h2="Perl 用于将 XLTM 保存为 PPTX 的库" p="使用Cells云的SaveAs API在Perl中创建自定义电子表格工作流程。这是使用Perl在线将XLTM保存为PPTX和其他文档格式的专业解决方案。" urlsection="saveas/xltm-to-pptx/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Perl 使用 REST 将 XLTM 保存为 PPTX 的代码示例 API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Cells云SDK for Perl将Excel文件保存为其他格式XLTM为PPTX" >}}
