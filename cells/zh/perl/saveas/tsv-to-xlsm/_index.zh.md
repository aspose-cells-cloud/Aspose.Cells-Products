...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 TSV 保存为 XLSM" h2="Perl 用于将 TSV 保存为 XLSM 的库" p="使用 Cells Cloud 的 SaveAs API 在 Perl 中创建自定义电子表格工作流程。这是使用 Perl 在线将 TSV 保存为 XLSM 和其他文档格式的专业解决方案。" urlsection="saveas/tsv-to-xlsm/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 TSV 文件保存为 XLSM Perl" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 使用 REST 将 TSV 保存为 XLSM 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Perl 库将 TSV 保存为 XLSM。" >}}
