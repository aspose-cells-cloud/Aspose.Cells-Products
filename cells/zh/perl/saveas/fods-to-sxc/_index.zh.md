---
title: 使用 Perl 将 FODS 保存为 SXC
description: 利用 Aspose.Cells Cloud SDK for Perl 将 FODS 格式文件保存为 SXC 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 FODS 保存为 SXC" h2="Perl 用于将 FODS 保存为 SXC 的库" p="使用Cells云的SaveAs API在Perl中创建自定义电子表格工作流程。这是使用Perl在线将FODS保存为SXC和其他文档格式的专业解决方案。" urlsection="saveas/fods-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 FODS 文件另存为 SXC，位于 Perl 中" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
将 FODS 中的文件格式保存为 SXC 是一项复杂的任务。所有 FODS 到 SXC 格式的转换均由我们的 Perl SDK 执行，同时保留源 FODS 电子表格的主要结构和逻辑内容。我们的 Perl 库是在线将 FODS 保存为 SXC 文件的专业解决方案。该Cloud SDK为Perl开发者提供了强大的功能和完美的SXC输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 使用 REST 将 FODS 保存为 SXC 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Perl 库将 FODS 保存为 SXC。" >}}
