...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SHAPE 从 Excel 导出到 PNG" h2="Perl 用于将 SHAPE 导出到 PNG 文件的库" p="使用Cells云的导出API导出Perl中的Excel文件内部对象工作流程。这是使用Perl在线电子表格将SHAPE导出为PNG格式文件的专业解决方案。" urlsection="export/shape-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for Perl 将 SHAPE 对象导出为 PNG 格式文件" >}}
