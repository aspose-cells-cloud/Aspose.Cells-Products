...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SHAPE 从 Excel 导出到 PNG" h2="Perl 用于将 SHAPE 导出到 PNG 文件的库" p="使用 Cells 云的导出 API 导出 Perl 中的 Excel 文件内部对象工作流。这是一个专业的解决方案，可使用 Perl 在线将电子表格中的 SHAPE 导出为 PNG 格式的文件。" urlsection="export/shape-to-png/" >}}
...
<br/>
将 SHAPE 对象从 Excel 文件导出到 PNG 文件是一项复杂的任务。将 SHAPE 导出到 PNG 格式的转换由我们的 Perl SDK 执行，同时保留源 SHAPE 电子表格的主要结构和逻辑内容。我们的 Perl 库是一个专业的解决方案，可在线将 SHAPE 对象导出到 PNG 格式的文件。此云 SDK 为 Perl 开发人员提供了强大的功能和完美的 PNG 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 中的代码示例使用 REST API 将电子表格中的 SHAPE 导出为 PNG 格式" gistPath="" %}}
