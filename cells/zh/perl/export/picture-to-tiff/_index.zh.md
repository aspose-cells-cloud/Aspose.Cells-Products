...
---
{{< blocks/products/cells/cells-cloud-banner h1="将图片从 Excel 导出到 TIFF" h2="Perl 用于将图片导出到 TIFF 文件的库" p="使用Cells云的导出API导出Perl中的Excel文件内部对象工作流程。这是使用Perl在线电子表格将图片导出为TIFF格式文件的专业解决方案。" urlsection="export/picture-to-tiff/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for Perl 将 PICTURE 对象导出为 TIFF 格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Perl 中的代码示例使用 REST API 将电子表格中的 PICTURE 导出为 TIFF 格式" gistPath="" %}}
