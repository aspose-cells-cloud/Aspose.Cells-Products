---
title: 使用 Cells Cloud SDK for Perl 将 WORKBOOK 从 Excel 导出到 XPS
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将工作簿从 Excel 导出到 XPS" h2="Perl 库用于将 WORKBOOK 导出到 XPS 文件" p="使用 Cells 云的导出 API 导出 Perl 中的 Excel 文件内部对象工作流。这是一个专业的解决方案，可使用 Perl 在线将电子表格中的 WORKBOOK 导出为 XPS 格式的文件。" urlsection="export/workbook-to-xps/" >}}
