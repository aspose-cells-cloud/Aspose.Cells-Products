---
title: 使用 Cells Cloud SDK 将 Perl 的 SHAPE 从 Excel 导出为 GIF
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SHAPE 从 Excel 导出为 GIF" h2="Perl 用于将 SHAPE 导出到 GIF 文件的库" p="使用Cells云的导出API导出Perl中的Excel文件内部对象工作流程。这是使用Perl在线将电子表格中的SHAPE导出为GIF格式文件的专业解决方案。" urlsection="export/shape-to-gif/" >}}
