...
<br/>
将 WORKBOOK 对象从 Excel 文件导出到 PPTX 文件是一项复杂的任务。将 WORKBOOK 导出为 PPTX 格式转换由我们的 Perl SDK 执行，同时保留源 WORKBOOK 电子表格的主要结构和逻辑内容。我们的 Perl 库是在线将 WORKBOOK 对象导出为 PPTX 格式文件的专业解决方案。该Cloud SDK为Perl开发者提供了强大的功能和完美的PPTX输出。
