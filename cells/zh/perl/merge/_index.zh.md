---
title: 使用 Perl 合并 Excel 文件
description: Aspose.Cells Cloud REST API支持使用Perl将多个Excel文件合并为单个Excel文件，并提供各种编程语言的SDK。
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="使用 Perl 合并 Excel 文件" h2="Aspose.Cells Cloud SDK 支持将多个 Excel 文件合并为单个 Excel 文件。" p="Aspose.Cells Cloud REST API支持使用Perl将多个Excel文件合并为单个Excel文件，并提供各种编程语言的SDK。" urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="使用 Perl 扩展链接合并 Excel 文件" >}}
