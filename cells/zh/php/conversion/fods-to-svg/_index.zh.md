...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 PHP 将 FODS 转换为 SVG" h2="使用适用于 PHP 的开源 Cloud SDK 自动执行 Excel 和 OpenOffice 文件转换" >}}
...
1. 调用 ```CellsApi.cellsSaveAsPostDocumentSaveAs``` 获取结果 SVG 文件
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS 到 SVG 转换代码" gistPath="" %}}
```php
