...
description: 利用 Aspose.Cells Cloud SDK for PHP 将 NUMBERS 格式文件转换为 XPS 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将数字转换为 XPS" h2="PHP 库用于将 NUMBERS 转换为 XPS" p="使用 Cells Cloud 的转换 API 在 PHP 项目中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 PHP 在线将 NUMBERS 转换为 XPS 和其他文档格式。" urlsection="conversion/numbers-to-xps/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 NUMBERS 转换为 XPS。" >}}
