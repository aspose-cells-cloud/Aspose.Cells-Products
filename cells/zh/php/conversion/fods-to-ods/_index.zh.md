...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 PHP 将 FODS 转换为 ODS" h2="使用适用于 PHP 的开源 Cloud SDK 自动执行 Excel 和 OpenOffice 文件转换" >}}
...
1. 拨打```CellsApi.cellsSaveAsPostDocumentSaveAs```获取ODS文件
