...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 PHP 将 FODS 转换为 PDF" h2="使用 PHP 的开源 Cloud SDK 自动化 Excel 和 OpenOffice 文件转换" >}}
...
1. 调用```CellsApi.cellsSaveAsPostDocumentSaveAs```得到结果PDF文件
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS 代码到 PDF 转换" gistPath="" %}}
```php
