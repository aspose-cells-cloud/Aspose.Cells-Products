...
description: 利用 Aspose.Cells Cloud SDK for PHP 将 SXC 格式文件转换为 PPTX 格式文件。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 SXC 转换为 PPTX。" >}}
