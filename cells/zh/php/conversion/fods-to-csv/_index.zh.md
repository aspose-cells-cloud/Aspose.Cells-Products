...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 PHP 将 FODS 转换为 CSV" h2="使用 PHP 的开源 Cloud SDK 自动化 Excel 和 OpenOffice 文件转换" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS 到 CSV 转换的代码" gistPath="" %}}
```php
