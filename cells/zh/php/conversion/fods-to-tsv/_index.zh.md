...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 PHP 将 FODS 转换为 TSV" h2="使用 PHP 的开源 Cloud SDK 自动化 Excel 和 OpenOffice 文件转换" >}}
...
1. 拨打```CellsApi.cellsSaveAsPostDocumentSaveAs```获取生成的TSV文件
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS 到 TSV 转换的代码" gistPath="" %}}
```php
