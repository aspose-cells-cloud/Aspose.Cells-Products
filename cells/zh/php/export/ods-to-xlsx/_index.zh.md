...
{{< blocks/products/pf/agp/upper-banner-autogen h1="将 ODS 导出到云端的 XLSX 文件" h2="Excel & 使用开源 Cloud SDK 导出 OpenOffice 电子表格 PHP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="在 Cloud SDK 中将 ODS 导出为 XLSX 文件 PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP ODS 到 XLSX 转换代码" gistPath="" %}}
```php
