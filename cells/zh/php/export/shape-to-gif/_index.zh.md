...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SHAPE 从 Excel 导出为 GIF" h2="PHP 用于将 SHAPE 导出为 GIF 文件的库" p="使用Cells云的导出API导出PHP中的Excel文件内部对象工作流程。这是使用PHP在线将电子表格中的SHAPE导出为GIF格式文件的专业解决方案。" urlsection="export/shape-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for PHP 将 SHAPE 对象导出为 GIF 格式文件" >}}
