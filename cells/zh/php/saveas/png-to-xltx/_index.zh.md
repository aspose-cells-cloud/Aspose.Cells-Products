...
---
{{< blocks/products/cells/cells-cloud-banner h1="另存 PNG 为 XLTX" h2="PHP 库，用于将 PNG 保存为 XLTX" p="使用Cells云的SaveAs API在PHP中创建自定义电子表格工作流程。这是使用PHP在线将PNG保存为XLTX和其他文档格式的专业解决方案。" urlsection="saveas/png-to-xltx/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 PNG 另存为 XLTX。" >}}
