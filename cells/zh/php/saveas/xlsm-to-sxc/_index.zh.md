...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSM 保存为 SXC" h2="PHP 用于将 XLSM 保存为 SXC 的库" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是使用 PHP 在线将 XLSM 保存为 SXC 和其他文档格式的专业解决方案。" urlsection="saveas/xlsm-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 PHP 中将 XLSM 文件另存为 SXC" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 XLSM 保存为 SXC 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 XLSM 保存为 SXC。" >}}
