...
---
{{< blocks/products/cells/cells-cloud-banner h1="将XLTM另存为PNG" h2="PHP 库用于将 XLTM 保存为 PNG" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 PHP 在线将 XLTM 保存为 PNG 和其他文档格式。" urlsection="saveas/xltm-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLTM 文件另存为 PNG，保存为 PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 XLTM 保存为 PNG。" >}}
