...
description: 利用 Aspose.Cells Cloud SDK for PHP 将 JSON 格式文件保存为 XLT 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 JSON 保存为 XLT" h2="PHP 用于将 JSON 保存为 XLT 的库" p="使用Cells云的SaveAs API在PHP中创建自定义电子表格工作流程。这是使用PHP在线将JSON保存为XLT和其他文档格式的专业解决方案。" urlsection="saveas/json-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 JSON 文件另存为 XLT PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 JSON 保存为 XLT 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud PHP 库将 JSON 保存为 XLT。" >}}
