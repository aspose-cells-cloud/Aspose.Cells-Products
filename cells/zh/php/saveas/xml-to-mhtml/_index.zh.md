...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XML 保存为 MHTML" h2="PHP 用于将 XML 保存为 MHTML 的库" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是使用 PHP 在线将 XML 保存为 MHTML 和其他文档格式的专业解决方案。" urlsection="saveas/xml-to-mhtml/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XML 文件另存为 PHP 中的 MHTML" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 XML 保存为 MHTML 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud PHP 库将 XML 保存为 MHTML。" >}}
