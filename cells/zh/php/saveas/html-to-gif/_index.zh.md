...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST API 将 HTML 保存为 GIF 的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="了解如何使用 Cells 云 PHP 库将 HTML 另存为 GIF。" >}}
