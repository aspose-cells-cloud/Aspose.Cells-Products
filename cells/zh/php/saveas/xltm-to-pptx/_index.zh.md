...
<br/>
将 XLTM 的文件格式保存为 PPTX 是一项复杂的任务。所有 XLTM 到 PPTX 格式的转换均由我们的 PHP SDK 执行，同时保留源 XLTM 电子表格的主要结构和逻辑内容。我们的 PHP 库是将 XLTM 在线保存为 PPTX 文件的专业解决方案。此云 SDK 为 PHP 开发人员提供了强大的功能和完美的 PPTX 输出。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 XLTM 保存为 PPTX。" >}}
