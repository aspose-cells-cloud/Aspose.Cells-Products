---
title: 使用 PHP 将 PNG 保存为 DOCX
description: 利用Aspose.Cells Cloud SDK for PHP将PNG格式文件保存为DOCX格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 PNG 另存为 DOCX" h2="PHP 库用于将 PNG 保存为 DOCX" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 PHP 在线将 PNG 保存为 DOCX 和其他文档格式。" urlsection="saveas/png-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 PNG 文件另存为 PHP 中的 DOCX" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 PNG 保存为 DOCX 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 PNG 另存为 DOCX。" >}}
