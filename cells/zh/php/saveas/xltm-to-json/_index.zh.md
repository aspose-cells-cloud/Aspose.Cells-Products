...
description: 利用 Aspose.Cells Cloud SDK for PHP 将 XLTM 格式文件保存为 JSON 格式文件。
...
{{< blocks/products/cells/cells-cloud-section title="将 XLTM 文件另存为 JSON PHP" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud PHP 库将 XLTM 保存为 JSON。" >}}
