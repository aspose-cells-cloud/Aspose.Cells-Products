---
title: 使用 PHP 将 PNG 保存为 ODS
description: 利用Aspose.Cells Cloud SDK for PHP将PNG格式文件保存为ODS格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 PNG 另存为 ODS" h2="PHP 库用于将 PNG 保存为 ODS" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 PHP 在线将 PNG 保存为 ODS 和其他文档格式。" urlsection="saveas/png-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 PNG 文件另存为 PHP 中的 ODS" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/{name}/SaveAs" apireferenceurl="https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs" apimethod="POST" %}}
<br/>
将 PNG 的文件格式保存为 ODS 是一项复杂的任务。所有 PNG 到 ODS 格式的转换均由我们的 PHP SDK 执行，同时保留源 PNG 电子表格的主要结构和逻辑内容。我们的 PHP 库是将 PNG 在线保存为 ODS 文件的专业解决方案。此云 SDK 为 PHP 开发人员提供了强大的功能和完美的 ODS 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 PNG 保存为 ODS 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 PNG 保存为 ODS。" >}}
