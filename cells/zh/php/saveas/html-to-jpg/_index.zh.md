---
title: 使用 PHP 将 HTML 保存为 JPG
description: 利用Aspose.Cells Cloud SDK for PHP将HTML格式文件保存为JPG格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="另存 HTML 为 JPG" h2="PHP 库用于将 HTML 保存为 JPG" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 PHP 在线将 HTML 保存为 JPG 和其他文档格式。" urlsection="saveas/html-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 HTML 文件另存为 JPG 于 PHP" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST API 将 HTML 保存为 JPG 的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Cells云PHP库将HTML另存为JPG。" >}}
