...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SXC 保存为 MHTML" h2="PHP 用于将 SXC 保存为 MHTML 的库" p="使用Cells云的SaveAs API在PHP中创建自定义电子表格工作流程。这是使用PHP在线将SXC保存为MHTML和其他文档格式的专业解决方案。" urlsection="saveas/sxc-to-mhtml/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud PHP 库将 SXC 保存为 MHTML。" >}}
