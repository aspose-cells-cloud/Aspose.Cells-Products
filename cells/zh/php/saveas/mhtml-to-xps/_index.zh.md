...
description: 利用 Aspose.Cells Cloud SDK 将 PHP 的 MHTML 格式文件保存为 XPS 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 MHTML 保存为 XPS" h2="PHP 用于将 MHTML 保存为 XPS 的库" p="使用Cells云的SaveAs API在PHP中创建自定义电子表格工作流程。这是使用PHP在线将MHTML保存为XPS和其他文档格式的专业解决方案。" urlsection="saveas/mhtml-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 MHTML 文件另存为 PHP 中的 XPS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 MHTML 保存为 XPS 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 MHTML 保存为 XPS。" >}}
