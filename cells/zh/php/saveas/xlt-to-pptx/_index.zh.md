...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLT 保存为 PPTX" h2="PHP 用于将 XLT 保存为 PPTX 的库" p="使用 Cells Cloud 的 SaveAs API 在 PHP 中创建自定义电子表格工作流程。这是使用 PHP 在线将 XLT 保存为 PPTX 和其他文档格式的专业解决方案。" urlsection="saveas/xlt-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLT 文件另存为 PHP 中的 PPTX" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 XLT 另存为 PPTX。" >}}
