...
---
{{< blocks/products/cells/cells-cloud-banner h1="保存 HTML 为 FODS" h2="PHP 库，用于将 HTML 保存为 FODS" p="使用Cells云的SaveAs API在PHP中创建自定义电子表格工作流程。这是使用PHP在线将HTML保存为FODS和其他文档格式的专业解决方案。" urlsection="saveas/html-to-fods/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 PHP 库将 HTML 保存为 FODS。" >}}
