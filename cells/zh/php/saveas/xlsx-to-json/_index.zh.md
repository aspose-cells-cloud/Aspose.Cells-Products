...
description: 利用 Aspose.Cells Cloud SDK for PHP 将 XLSX 格式文件保存为 JSON 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSX 保存为 JSON" h2="PHP 用于将 XLSX 保存为 JSON 的库" p="使用Cells云的SaveAs API在PHP中创建自定义电子表格工作流程。这是使用PHP在线将XLSX保存为JSON和其他文档格式的专业解决方案。" urlsection="saveas/xlsx-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 PHP 中将 XLSX 文件另存为 JSON" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP 使用 REST 将 XLSX 保存为 JSON 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud PHP 库将 XLSX 保存为 JSON。" >}}
