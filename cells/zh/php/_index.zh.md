---
title: Excel® 电子表格编程 API，使用 PHP 加速电子表格管理和处理任务
...
{{< blocks/products/cells/languge-index-ferturecard title="转变" desc="Converts a spreadsheet on a local drive to the specified format." url="/cells/php/conversion" imgurl="/cells/images/convert.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="合并" desc="Merge local spreadsheet files into a specified format file." url="/cells/php/merge" imgurl="/cells/images/merge.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="保护" desc="Applies dual-layer password protection to Excel spreadsheets, supporting both open and modify passwords with encryption." url="/cells/php/protect" imgurl="/cells/images/protect.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="另存为" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/php/saveas" imgurl="/cells/images/saveas.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="出口" desc="Converts a spreadsheet in cloud storage to the specified format." url="/cells/php/export" imgurl="/cells/images/export.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="清除" desc="Clear cell formats in the worksheet." url="/cells/php/clear" imgurl="/cells/images/clear.svg" >}}
{{< blocks/products/cells/languge-index-ferturecard title="背景" desc="Set background in the workbook." url="/cells/php/background" imgurl="/cells/images/background.svg" >}}
