...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云中将 FODS 转换为 MHTML" h2="Excel & 使用开源 Cloud SDK for .NET 的 OpenOffice 电子表格转换" >}}
...
1. 调用```CellsApi.CellsSaveAsPostDocumentSaveAs```方法得到生成的MHTML文件
