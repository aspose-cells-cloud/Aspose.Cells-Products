---
title: 将 FODS 转换为 TXT via .NET
description: 使用 Cloud API 和开源 .NET SDK 创建、编辑或转换 Excel 文件
url: /zh/net/conversion/fods-to-txt/
family: cells
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云端将 FODS 转换为 TXT" h2="Excel & 使用开源 Cloud SDK 进行 OpenOffice 电子表格转换 for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 应用程序中的 FODS 到 TXT 转换" %}}
...
1. 调用```CellsApi.CellsSaveAsPostDocumentSaveAs```方法获取生成的TXT文件
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET FODS 到 TXT 转换代码" gistPath="" %}}
```cs
