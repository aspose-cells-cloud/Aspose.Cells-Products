...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云端将 FODS 转换为 XLSB" h2="Excel & 使用开源 Cloud SDK 进行 OpenOffice 电子表格转换 for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 应用程序中的 FODS 到 XLSB 转换" %}}
...
1. 调用```CellsApi.CellsSaveAsPostDocumentSaveAs```方法获取生成的XLSB文件
