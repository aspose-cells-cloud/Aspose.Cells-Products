...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 ODS 转换为 SQL" h2="C# 用于将 ODS 转换为 SQL 的库" p="使用 Cells Cloud 的转换 API 在 Net 项目中创建自定义电子表格工作流。这是使用 C# 在线将 ODS 转换为 SQL 和其他文档格式的专业解决方案。" urlsection="conversion/ods-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK 将 ODS 转换为 SQL 适用于 C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 使用 Cells Cloud SDK 将 ODS 转换为 SQL 的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 ODS 转换为 SQL。" >}}
