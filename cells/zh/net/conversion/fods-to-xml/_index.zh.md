...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云端将 FODS 转换为 XML" h2="Excel & 使用开源 Cloud SDK 进行 OpenOffice 电子表格转换 for .NET" >}}
...
1. 调用```CellsApi.CellsSaveAsPostDocumentSaveAs```方法获取结果XML文件
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET FODS 到 XML 转换的代码" gistPath="" %}}
```cs
