---
title: 将 FODS 转换为 SVG via .NET
description: 使用 Cloud API 和开源 .NET SDK 创建、编辑或转换 Excel 文件
url: /zh/net/conversion/fods-to-svg/
family: cells
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="在云端将 FODS 转换为 SVG" h2="Excel & 使用开源 Cloud SDK 进行 OpenOffice 电子表格转换 for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS 到 SVG 在 .NET 应用程序中的转换" %}}
...
1. 调用```CellsApi.CellsSaveAsPostDocumentSaveAs```方法得到结果SVG文件
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET FODS 到 SVG 转换代码" gistPath="" %}}
```cs
