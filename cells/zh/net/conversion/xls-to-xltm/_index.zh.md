...
description: 利用 Aspose.Cells Cloud SDK for C# 将 XLS 格式文件转换为 XLTM 格式文件。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLS 转换为 XLTM。" >}}
