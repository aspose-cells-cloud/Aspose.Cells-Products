...
---
{{< blocks/products/cells/cells-cloud-banner h1="转换 XLS 到 JSON" h2="C# 用于将 XLS 转换为 JSON 的库" p="使用 Cells 云的转换 API 在 Net 项目中创建自定义电子表格工作流程。这是使用C#在线将XLS转换为JSON和其他文档格式的专业解决方案。" urlsection="conversion/xls-to-json/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLS 转换为 JSON。" >}}
