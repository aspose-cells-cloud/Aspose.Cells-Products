...
---
{{< blocks/products/cells/cells-cloud-banner h1="将工作表从 Excel 导出到 XPS" h2="C# 用于将 WORKSHEET 导出到 XPS 文件的库" p="使用Cells云的导出API导出Net中的Excel文件内部对象工作流程。这是使用 C# 在线电子表格将 WORKSHEET 导出为 XPS 格式文件的专业解决方案。" urlsection="export/worksheet-to-xps/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK for C# 将 WORKSHEET 对象导出为 XPS 格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 中的代码示例使用 REST API 将电子表格中的 WORKSHEET 导出为 XPS 格式" gistPath="" %}}
