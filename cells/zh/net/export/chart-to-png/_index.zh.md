...
---
{{< blocks/products/cells/cells-cloud-banner h1="将图表从 Excel 导出到 PNG" h2="C# 用于将图表导出到 PNG 文件的库" p="使用Cells云的导出API导出Net中的Excel文件内部对象工作流程。这是使用 C# 在线电子表格将图表导出为 PNG 格式文件的专业解决方案。" urlsection="export/chart-to-png/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用Cells Cloud SDK for C#将CHART对象导出为PNG格式文件" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 中的代码示例使用 REST API 将电子表格中的 CHART 导出为 PNG 格式" gistPath="" %}}
