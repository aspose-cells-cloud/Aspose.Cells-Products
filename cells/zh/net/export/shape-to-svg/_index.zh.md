---
title: 使用 Cells Cloud SDK for C# 将 SHAPE 从 Excel 导出到 SVG
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SHAPE 从 Excel 导出到 SVG" h2="C# 用于将 SHAPE 导出到 SVG 文件的库" p="使用 Cells Cloud 的 Export API 导出 Net 中的 Excel 文件内部对象工作流。这是使用 C# 在线将电子表格中的 SHAPE 导出为 SVG 格式文件的专业解决方案。" urlsection="export/shape-to-svg/" >}}
...
<br/>
将 SHAPE 对象从 Excel 文件导出到 SVG 文件是一项复杂的任务。将 SHAPE 导出到 SVG 格式的转换由我们的 C# SDK 执行，同时保留源 SHAPE 电子表格的主要结构和逻辑内容。我们的 C# 库是一个专业的解决方案，可在线将 SHAPE 对象导出到 SVG 格式的文件。此云 SDK 为 C# 开发人员提供了强大的功能和完美的 SVG 输出。

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 中的代码示例使用 REST API 将电子表格中的 SHAPE 导出为 SVG 格式" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud SDK for Net 将对象从 Excel SHAPE 导出到 SVG" >}}
