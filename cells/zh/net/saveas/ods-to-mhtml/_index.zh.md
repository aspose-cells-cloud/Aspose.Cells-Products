...
<br/>
将 ODS 中的文件格式保存为 MHTML 是一项复杂的任务。所有 ODS 到 MHTML 格式的转换均由我们的 C# SDK 执行，同时保留源 ODS 电子表格的主要结构和逻辑内容。我们的 C# 库是将 ODS 在线保存为 MHTML 文件的专业解决方案。此云 SDK 为 C# 开发人员提供了强大的功能和完美的 MHTML 输出。
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 ODS 保存为 MHTML。" >}}
