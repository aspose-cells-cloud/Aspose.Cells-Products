...
description: 利用 Aspose.Cells Cloud SDK 将 C# 的 XLSM 格式文件保存为 JPG 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSM 保存为 JPG" h2="C# 用于将 XLSM 保存为 JPG 的库" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 C# 在线将 XLSM 保存为 JPG 和其他文档格式。" urlsection="saveas/xlsm-to-jpg/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 C# 中将 XLSM 文件另存为 JPG" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 使用 REST 将 XLSM 保存为 JPG 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLSM 保存为 JPG。" >}}
