...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSX 保存为 SXC" h2="C# 用于将 XLSX 保存为 SXC 的库" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是使用 C# 在线将 XLSX 保存为 SXC 等文档格式的专业解决方案。" urlsection="saveas/xlsx-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLSX 文件另存为 C# 中的 SXC" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 使用 REST 将 XLSX 保存为 SXC 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLSX 保存为 SXC。" >}}
