...
description: 利用 Aspose.Cells Cloud SDK 将 C# 的 XLS 格式文件保存为 XLTX 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLS 保存为 XLTX" h2="C# 用于将 XLS 保存为 XLTX 的库" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 C# 在线将 XLS 保存为 XLTX 和其他文档格式。" urlsection="saveas/xls-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLS 文件另存为 XLTX C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 使用 REST 将 XLS 保存为 XLTX 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLS 保存为 XLTX。" >}}
