...
description: 利用 Aspose.Cells Cloud SDK for C# 将 XLTM 格式文件保存为 JSON 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLTM 保存为 JSON" h2="C# 用于将 XLTM 保存为 JSON 的库" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 C# 在线将 XLTM 保存为 JSON 和其他文档格式。" urlsection="saveas/xltm-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLTM 文件另存为 JSON C#" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 使用 REST 将 XLTM 保存为 JSON 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLTM 保存为 JSON。" >}}
