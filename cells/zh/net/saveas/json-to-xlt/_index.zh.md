...
description: 利用 Aspose.Cells Cloud SDK for C# 将 JSON 格式文件保存为 XLT 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 JSON 保存为 XLT" h2="C# 用于将 JSON 保存为 XLT 的库" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 C# 在线将 JSON 保存为 XLT 和其他文档格式。" urlsection="saveas/json-to-xlt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 JSON 保存为 XLT。" >}}
