...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLTX 另存为 SQL" h2="C# 用于将 XLTX 保存为 SQL 的库" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是使用C#在线将XLTX保存为SQL和其他文档格式的专业解决方案。" urlsection="saveas/xltx-to-sql/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 XLTX 保存为 SQL。" >}}
