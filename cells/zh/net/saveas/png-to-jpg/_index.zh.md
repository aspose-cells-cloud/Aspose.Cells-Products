...
---
{{< blocks/products/cells/cells-cloud-banner h1="另存 PNG 为 JPG" h2="C# 库用于将 PNG 保存为 JPG" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是使用C#在线将PNG保存为JPG和其他文档格式的专业解决方案。" urlsection="saveas/png-to-jpg/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用Cells云网库将PNG另存为JPG。" >}}
