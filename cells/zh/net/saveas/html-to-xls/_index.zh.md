...
description: 利用Aspose.Cells Cloud SDK for C#将HTML格式文件保存为XLS格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 HTML 另存为 XLS" h2="C# 库，用于将 HTML 保存为 XLS" p="使用 Cells Cloud 的 SaveAs API 在 Net 中创建自定义电子表格工作流程。这是使用C#在线将HTML保存为XLS和其他文档格式的专业解决方案。" urlsection="saveas/html-to-xls/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 HTML 文件另存为 C# 中的 XLS" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# 使用 REST API 将 HTML 保存为 XLS 的代码示例" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Net 库将 HTML 保存为 XLS。" >}}
