...
---
{{< blocks/products/cells/cells-cloud-banner h1="将XLTM另存为SVG" h2="Java 库用于将 XLTM 保存为 SVG" p="使用 Cells Cloud 的 SaveAs API 在 Java 中创建自定义电子表格工作流程。这是一个专业的解决方案，可使用 Java 在线将 XLTM 保存为 SVG 和其他文档格式。" urlsection="saveas/xltm-to-svg/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 XLTM 文件另存为 SVG，保存为 Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java 使用 REST 将 XLTM 保存为 SVG 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Java 库将 XLTM 保存为 SVG。" >}}
