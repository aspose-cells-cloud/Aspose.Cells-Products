---
title: 将 SXC 保存为 JPG API for Java
description: 使用Aspose.Cells Cloud SDK for Java将SXC格式文件另存为JPG格式文件。
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Java中的代码示例使用REST API将SXC保存为JPG格式" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Java API 将SXC另存为JPG" >}}
