---
title: 使用 Java 将 SXC 另存为 XLTX
description: 利用 Aspose.Cells Cloud SDK for Java 将 SXC 格式文件保存为 XLTX 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 SXC 保存为 XLTX" h2="Java 用于将 SXC 保存为 XLTX 的库" p="使用 Cells Cloud 的 SaveAs API 在 Java 中创建自定义电子表格工作流程。这是使用 Java 在线将 SXC 保存为 XLTX 和其他文档格式的专业解决方案。" urlsection="saveas/sxc-to-xltx/" >}}

{{< blocks/products/cells/cells-cloud-section title="将 SXC 文件另存为 XLTX Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java 使用 REST 将 SXC 保存为 XLTX 的代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells 云 Java 库将 SXC 保存为 XLTX。" >}}
