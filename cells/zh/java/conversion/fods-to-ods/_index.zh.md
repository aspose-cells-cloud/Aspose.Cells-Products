...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Java 将 FODS 转换为 ODS" h2="使用开源 Cloud SDK for Java 自动化 Excel 和 OpenOffice 文件转换" >}}
...
1. 拨打```CellsApi.cellsWorkbookGetWorkbook```获取生成的ODS文件
