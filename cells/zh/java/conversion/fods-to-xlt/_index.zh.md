---
title: 在云端将 FODS 转换为 XLT via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Java 将 FODS 转换为 XLT" h2="使用开源 Cloud SDK for Java 自动化 Excel 和 OpenOffice 文件转换" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="简单的 FODS 到 XLT 转换" %}}
...
1. 拨打```CellsApi.cellsWorkbookGetWorkbook```获取生成的XLT文件
...
{{% blocks/products/pf/agp/code-autogen title="Java 将 FODS 转换为 XLT 的代码" gistPath="" %}}
```java
