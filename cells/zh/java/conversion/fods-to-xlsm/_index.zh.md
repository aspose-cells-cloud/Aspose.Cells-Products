...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Java 将 FODS 转换为 XLSM" h2="使用开源 Cloud SDK 自动化 Excel 和 OpenOffice 文件转换 for Java" >}}
...
1. 致电 ```CellsApi.cellsWorkbookGetWorkbook``` 获取生成的 XLSM 文件
