...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Java 将 FODS 转换为 XLSB" h2="使用开源 Cloud SDK 自动化 Excel 和 OpenOffice 文件转换 for Java" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="简单 FODS 到 XLSB 转换" %}}
...
1. 致电 ```CellsApi.cellsWorkbookGetWorkbook``` 获取生成的 XLSB 文件
