...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 CHART 从 Excel 导出到 WMF" h2="Java 用于将图表导出为 WMF 文件的库" p="使用Cells云的导出API导出Java中的Excel文件内部对象工作流程。这是使用Java在线将电子表格中的CHART导出为WMF格式文件的专业解决方案。" urlsection="export/chart-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="使用 Cells Cloud SDK 将 CHART 对象导出为 WMF 格式文件 for Java" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java 中的代码示例使用 REST API 将电子表格中的 CHART 导出为 WMF 格式" gistPath="" %}}
