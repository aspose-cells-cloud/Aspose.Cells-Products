...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST 将 XLT 保存为 JPG 的 Go 代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="了解如何使用 Cells Cloud Go 库将 XLT 另存为 JPG。" >}}
