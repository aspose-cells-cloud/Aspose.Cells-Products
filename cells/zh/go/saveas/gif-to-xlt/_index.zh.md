---
title: 将 GIF 保存为 XLT API 用于 Go
description: 使用Aspose.Cells Cloud SDK for Go将GIF格式文件保存为XLT格式文件。
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Go 中使用 REST API 将 GIF 保存为 XLT 格式的代码示例" gistPath="" %}}
