...
description: 利用 Aspose.Cells Cloud SDK for Go 将 XLSM 格式文件保存为 TXT 格式文件。
...
---
{{< blocks/products/cells/cells-cloud-banner h1="将 XLSM 保存为 TXT" h2="用于将 XLSM 保存为 TXT 的 Go 库" p="使用 Cells Cloud 中的 SaveAs API 在 Go 中创建自定义电子表格工作流程。这是使用 Go 在线将 XLSM 保存为 TXT 和其他文档格式的专业解决方案。" urlsection="saveas/xlsm-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="在 Go 中将 XLSM 文件保存为 TXT" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="使用 REST 将 XLSM 保存为 TXT 的 Go 代码示例 API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="如何使用 Cells Cloud Go 库将 XLSM 保存为 TXT。" >}}
