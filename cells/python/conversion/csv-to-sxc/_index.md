---
title: Convert from Excel CSV to SXC via Python 
...
outformat: SXC
platform: Python
otherformats: TXT TIFF XLS HTML TSV PDF XLT SXC XLTX DIF XLSX XLSB MHTML XML XLTM FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to SXC with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to SXC Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for CSV to SXC Conversion" gistPath="" %}}
```python
