---
title: Convert from Excel TSV to DIF via Python 
...
outformat: DIF
platform: Python
otherformats: ODS XLSX XML MD HTML SVG TXT CSV MHTML FODS SXC TIFF PDF XLTX XLSM XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to DIF with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to DIF Conversion with Python" %}}
