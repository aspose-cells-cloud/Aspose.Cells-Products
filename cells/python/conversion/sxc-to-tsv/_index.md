---
title: Convert from Excel SXC to TSV via Python 
...
outformat: TSV
platform: Python
otherformats: XLTM FODS XLTX XLSX TXT MD PDF MHTML XLSB XPS XLSM TSV XML SVG TIFF SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TSV with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to TSV Conversion with Python" %}}
