---
title: Convert from Excel XML to SXC via Python 
...
outformat: SXC
platform: Python
otherformats: HTML SVG DIF TIFF XLTX XLS TSV MHTML TXT ODS XLSX FODS MD XLTM XLSB XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to SXC with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to SXC Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XML to SXC Conversion" gistPath="" %}}
```python
