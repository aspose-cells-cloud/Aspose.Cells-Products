---
title: Convert from Excel XLSM to DIF via Python 
...
outformat: DIF
platform: Python
otherformats: MHTML CSV SVG MD XLTM XLS TIFF FODS DIF TXT XLTX SXC XPS TSV PDF XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to DIF with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to DIF Conversion with Python" %}}
