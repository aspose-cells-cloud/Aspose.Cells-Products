---
title: Convert from Excel SXC to XPS via Python 
...
outformat: XPS
platform: Python
otherformats: XLTM MHTML XLS TSV FODS SVG XLTX TIFF XPS XLSB XLSM PDF CSV XLSX SXC TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XPS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to XPS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for SXC to XPS Conversion" gistPath="" %}}
```python
