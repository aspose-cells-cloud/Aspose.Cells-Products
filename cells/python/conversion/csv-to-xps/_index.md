---
title: Convert from Excel CSV to XPS via Python 
...
outformat: XPS
platform: Python
otherformats: XLT XML XLS MD XLSM SXC XLSB XPS TXT TSV DIF FODS XLTM TIFF PDF MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XPS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to XPS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for CSV to XPS Conversion" gistPath="" %}}
```python
