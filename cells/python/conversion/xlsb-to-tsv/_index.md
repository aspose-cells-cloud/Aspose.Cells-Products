---
title: Convert from Excel XLSB to TSV via Python 
...
outformat: TSV
platform: Python
otherformats: DIF TSV TXT PDF XLTX HTML MD MHTML ODS SVG XML FODS XLSX XLSM TIFF CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to TSV with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to TSV Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLSB to TSV Conversion" gistPath="" %}}
```python
