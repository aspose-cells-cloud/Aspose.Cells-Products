...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to XML with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to XML Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for FODS to XML Conversion" gistPath="" %}}
```python
