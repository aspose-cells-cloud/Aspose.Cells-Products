---
title: Convert from Excel CSV to XLS via Python 
...
outformat: XLS
platform: Python
otherformats: XLTM XLSX HTML MHTML TIFF FODS MD DIF XML PDF TXT TSV XLTX XLSB SVG SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XLS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to XLS Conversion with Python" %}}
