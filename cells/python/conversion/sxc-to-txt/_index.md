---
title: Convert from Excel SXC to TXT via Python 
...
outformat: TXT
platform: Python
otherformats: XLTM TXT XLTX CSV SVG XLSB XPS ODS MHTML SXC MD XLSX FODS XLSM TIFF XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TXT with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to TXT Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for SXC to TXT Conversion" gistPath="" %}}
```python
