---
title: Convert from Excel XLS to MD via Python 
...
outformat: MD
platform: Python
otherformats: XLTX XML XLSM SXC XLTM MHTML TIFF DIF PDF MD CSV XLSX FODS XLSB TXT TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to MD with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to MD Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLS to MD Conversion" gistPath="" %}}
```python
