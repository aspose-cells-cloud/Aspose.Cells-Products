---
title: Convert from Excel XLSB to XLSX via Python 
...
outformat: XLSX
platform: Python
otherformats: XLTM XLSX MD TIFF XML XLTX PDF ODS XLSM DIF HTML FODS TXT SVG SXC XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to XLSX with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to XLSX Conversion with Python" %}}
