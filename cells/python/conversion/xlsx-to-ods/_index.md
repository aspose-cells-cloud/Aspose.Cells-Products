---
title: Convert from Excel XLSX to ODS via Python 
...
outformat: ODS
platform: Python
otherformats: XLT XLS XLTX CSV DIF TIFF FODS HTML TSV MD SVG XLSM XPS SXC MHTML XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to ODS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to ODS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLSX to ODS Conversion" gistPath="" %}}
```python
