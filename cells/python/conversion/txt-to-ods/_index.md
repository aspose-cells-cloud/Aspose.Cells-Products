---
title: Convert from Excel TXT to ODS via Python 
...
outformat: ODS
platform: Python
otherformats: HTML CSV SXC XPS TSV SVG XLSM ODS TIFF FODS DIF XLSX XLTM MD MHTML PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to ODS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to ODS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for TXT to ODS Conversion" gistPath="" %}}
```python
