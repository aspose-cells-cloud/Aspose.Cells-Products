---
title: Convert from Excel XML to SVG via Python 
...
outformat: SVG
platform: Python
otherformats: FODS XLTX TIFF XLSB XLSX XLSM PDF SXC DIF SVG MHTML TXT XPS MD XLTM CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to SVG with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to SVG Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XML to SVG Conversion" gistPath="" %}}
```python
