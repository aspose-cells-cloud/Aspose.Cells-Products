---
title: Convert from Excel XLSB to DIF via Python 
...
outformat: DIF
platform: Python
otherformats: CSV DIF XLS XLTX TSV XLTM SXC TXT PDF XPS MD SVG HTML FODS MHTML XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to DIF with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to DIF Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLSB to DIF Conversion" gistPath="" %}}
```python
