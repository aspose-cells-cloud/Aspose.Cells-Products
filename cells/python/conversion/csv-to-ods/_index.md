---
title: Convert from Excel CSV to ODS via Python 
...
outformat: ODS
platform: Python
otherformats: HTML XML MD FODS SXC TSV TIFF XLSX XLT XLTM XPS XLTX TXT PDF DIF XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to ODS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to ODS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for CSV to ODS Conversion" gistPath="" %}}
```python
