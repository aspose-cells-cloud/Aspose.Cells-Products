---
title: Convert from Excel TSV to XPS via Python 
...
outformat: XPS
platform: Python
otherformats: DIF MHTML SXC XLSX PDF XPS XLSB XLSM MD XML XLTX CSV FODS XLTM SVG TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XPS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to XPS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for TSV to XPS Conversion" gistPath="" %}}
```python
