---
title: Convert MHTML to SQL via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to  SQL in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="MHTML to SQL Conversion in Cloud SDK for Python " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for MHTML to SQL Conversion" gistPath="" %}}
```python
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=mhtml  outputformat=sql  %}}
