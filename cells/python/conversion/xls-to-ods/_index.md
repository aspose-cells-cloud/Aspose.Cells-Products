---
title: Convert from Excel XLS to ODS via Python 
...
outformat: ODS
platform: Python
otherformats: DIF HTML XLT TXT XLSM FODS XLSX SXC CSV MHTML XML SVG XLTM TIFF MD XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to ODS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to ODS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLS to ODS Conversion" gistPath="" %}}
```python
