---
title: Convert from Excel TXT to SXC via Python 
...
outformat: SXC
platform: Python
otherformats: XPS XLTM HTML TSV XLSX MD XLSB XLSM DIF SVG CSV XLTX TIFF PDF FODS XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to SXC with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to SXC Conversion with Python" %}}
