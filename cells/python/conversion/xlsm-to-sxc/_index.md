---
title: Convert from Excel XLSM to SXC via Python 
...
outformat: SXC
platform: Python
otherformats: XLTX HTML MD SVG XLS DIF SXC FODS TXT XML CSV XPS TIFF XLSB XLSX PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to SXC with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to SXC Conversion with Python" %}}
