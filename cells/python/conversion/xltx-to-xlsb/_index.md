---
title: Convert from Excel XLTX to XLSB via Python 
...
outformat: XLSB
platform: Python
otherformats: DIF PDF XLSB CSV ODS XLSM TSV XLT TXT TIFF FODS SXC XML MHTML SVG XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to XLSB with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLTX to XLSB Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLTX to XLSB Conversion" gistPath="" %}}
```python
