---
title: Convert from Excel XLS to XLSB via Python 
...
outformat: XLSB
platform: Python
otherformats: XLSX DIF XLT XML SXC HTML FODS CSV PDF XLTM TXT MHTML XLSM XLTX TSV SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSB with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSB Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLS to XLSB Conversion" gistPath="" %}}
```python
