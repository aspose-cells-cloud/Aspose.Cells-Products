---
title: Convert from Excel HTML to MD via Python 
...
outformat: MD
platform: Python
otherformats: XLSM XLTX TIFF CSV SVG XLSB DIF ODS FODS MHTML XML PDF TXT TSV MD XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to MD with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
