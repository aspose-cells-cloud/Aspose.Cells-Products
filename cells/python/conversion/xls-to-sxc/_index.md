---
title: Convert from Excel XLS to SXC via Python 
...
outformat: SXC
platform: Python
otherformats: MD PDF TSV XML XPS XLTX TXT XLSM MHTML ODS DIF XLSB SVG CSV XLTM XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to SXC with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to SXC Conversion with Python" %}}
