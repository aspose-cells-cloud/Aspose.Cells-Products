---
title: Convert from Excel XLS to XLSX via Python 
...
outformat: XLSX
platform: Python
otherformats: ODS PDF XLTX XLSM XLTM CSV HTML XLSX TIFF TSV TXT XLSB FODS XPS SXC MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to XLSX with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to XLSX Conversion with Python" %}}
