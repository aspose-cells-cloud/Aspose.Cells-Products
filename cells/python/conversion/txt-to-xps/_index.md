---
title: Convert from Excel TXT to XPS via Python 
...
outformat: XPS
platform: Python
otherformats: XLT ODS DIF PDF XLS SVG TSV MHTML XLSB XML MD FODS XPS XLSM XLTM TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to XPS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TXT to XPS Conversion with Python" %}}
