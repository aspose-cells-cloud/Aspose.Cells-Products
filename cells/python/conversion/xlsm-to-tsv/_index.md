---
title: Convert from Excel XLSM to TSV via Python 
...
outformat: TSV
platform: Python
otherformats: XLSB ODS TXT XLSX DIF XML XPS SXC XLTM PDF FODS TSV HTML XLTX CSV SVG 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to TSV with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSM to TSV Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLSM to TSV Conversion" gistPath="" %}}
```python
