---
title: Convert from Excel XML to XLSB via Python 
...
outformat: XLSB
platform: Python
otherformats: DIF HTML ODS TXT TIFF XLTM XLSX MHTML MD CSV XLTX XLSB XPS SVG SXC FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSB with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to XLSB Conversion with Python" %}}
