---
title: Convert from Excel XLS to TXT via Python 
...
outformat: TXT
platform: Python
otherformats: TSV MD XLTM XLTX ODS XLSX HTML FODS SVG TIFF PDF TXT DIF MHTML XLSM XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to TXT with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLS to TXT Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLS to TXT Conversion" gistPath="" %}}
```python
