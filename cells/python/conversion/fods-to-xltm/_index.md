...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to XLTM with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to XLTM Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for FODS to XLTM Conversion" gistPath="" %}}
```python
