---
title: Convert from Excel SXC to ODS via Python 
...
outformat: ODS
platform: Python
otherformats: TSV FODS HTML PDF XLS XLTM XLTX SVG XPS SXC XLSM XLSB XML TXT TIFF MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to ODS with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC to ODS Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for SXC to ODS Conversion" gistPath="" %}}
```python
