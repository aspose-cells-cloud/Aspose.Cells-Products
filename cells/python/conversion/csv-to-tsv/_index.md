---
title: Convert from Excel CSV to TSV via Python 
...
outformat: TSV
platform: Python
otherformats: XLTM DIF PDF MD MHTML TXT ODS XLTX SXC FODS XLSX SVG XLSB XLSM XML TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to TSV with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="CSV to TSV Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for CSV to TSV Conversion" gistPath="" %}}
```python
