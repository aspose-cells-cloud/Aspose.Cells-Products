---
title: Convert from Excel XLSB to CSV via Python 
...
outformat: CSV
platform: Python
otherformats: FODS XLSM CSV XLT TIFF MD TXT HTML SVG DIF TSV XPS MHTML XML SXC PDF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to CSV with Python" h2="Read, Edit & Export Excel data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSB to CSV Conversion with Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for XLSB to CSV Conversion" gistPath="" %}}
```python
