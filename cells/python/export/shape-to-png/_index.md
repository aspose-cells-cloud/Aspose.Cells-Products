---
title: Export Shape to PNG file via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Shape to PNG file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exoprt Shape to PNG file in Cloud SDK for Python " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for SHAPE to PNG Conversion" gistPath="" %}}
```python
