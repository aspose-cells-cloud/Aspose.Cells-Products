---
title: Export Worksheet to SQL file via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Export Worksheet to SQL file in the Cloud" h2="Excel & OpenOffice spreadsheet export with open source Cloud SDK for Python">}}
...
{{% blocks/products/pf/agp/code-autogen title="Python Code for WORKSHEET to SQL Conversion" gistPath="" %}}
```python
