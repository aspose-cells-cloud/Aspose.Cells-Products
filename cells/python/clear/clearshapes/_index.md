...
url: /python/clear/clear-shapes/
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Clear shapes on the local workbook in Cloud" h2="Excel & OpenOffice spreadsheet Clear shapes by open-source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Clear shapes on local spreadsheet by Cloud SDK for Python" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python code for clearing shapes on local spreadsheets" gistPath="https://gist.github.com/aspose-cells-cloud-gists/61e922de11e6e7144db88adcad6501c1.js?file=Example-Clear-Shape.py" %}}
