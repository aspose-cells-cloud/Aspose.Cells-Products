---
title: Oranları XLSX dosyasına aktarın via NodeJS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODS\'yi Bulutta XLSX dosyasına aktarın" h2="Excel & NodeJS için açık kaynaklı Cloud SDK ile OpenOffice elektronik tablosu dışa aktarımı" >}}
...
{{% blocks/products/pf/agp/code-autogen title="ODS\'den XLSX\'e Dönüşüm için NodeJS Kodu" gistPath="" %}}
```js
