...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA KİTABI\'nı Excel\'den GIF\'e aktar" h2="ÇALIŞMA KİTABI\'nı GIF dosyasına aktarmak için NodeJS kitaplığı" p="NodeJS\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, NodeJS kullanarak çevrimiçi elektronik tablodan ÇALIŞMA KİTABI\'nı GIF formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="NodeJS için Cells Cloud SDK\'yı kullanarak WORKBOOK nesnesini GIF formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Çalışma kitabını e-tablodan GIF formatına aktarmak için REST API\'i kullanan NodeJS\'deki kod örneği" gistPath="" %}}
