...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA KİTABI\'nı Excel\'den TXT\'ye aktar" h2="ÇALIŞMA KİTAPÇIĞINI TXT dosyasına aktarmak için NodeJS kitaplığı" p="NodeJS\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, NodeJS kullanarak çevrimiçi elektronik tablodan ÇALIŞMA KİTABI\'nı TXT formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="NodeJS için Cells Bulut SDK\'sını kullanarak WORKBOOK nesnesini TXT biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Çalışma kitabını e-tablodan TXT biçimine aktarmak için REST API\'i kullanan NodeJS\'deki kod örneği" gistPath="" %}}
