...
---
{{< blocks/products/cells/cells-cloud-banner h1="HTML\'i MHTML olarak kaydet" h2="HTML\'i MHTML olarak kaydetmek için NodeJS kitaplığı" p="NodeJS\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için SaveAs API of Cells Cloud\'u kullanın. Bu, NodeJS kullanarak HTML\'i MHTML ve diğer belge formatları olarak çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/html-to-mhtml/" >}}

{{< blocks/products/cells/cells-cloud-section title="NodeJS\'de HTML dosyasını MHTML olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API\'i kullanarak HTML\'i MHTML olarak kaydetmek için NodeJS Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud NodeJS kitaplığını kullanarak HTML\'i MHTML olarak kaydetme." >}}
