...
---
{{< blocks/products/cells/cells-cloud-banner h1="PNG\'i FODS olarak kaydet" h2="PNG\'i FODS olarak kaydetmek için NodeJS kütüphanesi" p="NodeJS\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için SaveAs API of Cells Cloud\'u kullanın. Bu, NodeJS kullanarak PNG\'i FODS ve diğer belge formatları olarak çevrimiçi kaydetmek için profesyonel bir çözümdür." urlsection="saveas/png-to-fods/" >}}

{{< blocks/products/cells/cells-cloud-section title="NodeJS\'de PNG dosyasını FODS olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API\'i kullanarak PNG\'i FODS olarak kaydetmek için NodeJS Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud NodeJS kitaplığını kullanarak PNG\'i FODS olarak kaydetme." >}}
