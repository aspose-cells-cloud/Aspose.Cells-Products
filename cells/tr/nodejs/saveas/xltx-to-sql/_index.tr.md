---
title:  XLTX'i NodeJS için SQL API olarak kaydedin
description: XLTX biçim dosyasını SQL biçim dosyası olarak kaydetmek için NodeJS için Aspose.Cells Cloud SDK'yı kullanma.
url: /tr/nodejs/saveas/xltx-to-sql/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLTX\'i SQL olarak kaydetmek için NodeJS API" h2="XLTX\'i SQL olarak kaydetmek için NodeJS kitaplığı" p="NodeJS\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, XLTX\'i NodeJS kullanarak çevrimiçi olarak SQL ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xltx-to-sql/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLTX\'i SQL olarak kaydetmek için Düğüm API nasıl kullanılır?" >}}
