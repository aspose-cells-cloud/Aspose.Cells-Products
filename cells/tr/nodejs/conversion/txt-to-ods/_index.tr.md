---
title:  NodeJS için TXT'den ODS'ye Dönüştürme API
description:  TXT biçim dosyasını ODS biçim dosyasına dönüştürmek için NodeJS için Aspose.Cells Cloud SDK'yı kullanma.
url: /tr/nodejs/conversion/txt-to-ods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="TXT\'yi ODS\'ye dönüştürmek için NodeJS API" h2="TXT\'yi ODS\'ye dönüştürmek için NodeJS kitaplığı" p="NodeJS\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells Conversion REST API\'i kullanın. Bu, TXT\'yi NodeJS kullanarak çevrimiçi olarak ODS\'ye ve diğer belge biçimlerine dönüştürmek için profesyonel bir çözümdür." urlsection="conversion/txt-to-ods/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="TXT\'yi ODS\'ye dönüştürmek için Düğüm API nasıl kullanılır?" >}}
