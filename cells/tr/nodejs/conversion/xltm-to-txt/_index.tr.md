---
title: NodeJS için XLTM'den TXT'ye Dönüştürme API
description:  XLTM biçim dosyasını TXT biçim dosyasına dönüştürmek için NodeJS için Aspose.Cells Cloud SDK'yı kullanma.
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLTM\'yi TXT\'ye dönüştürmek için Düğüm API nasıl kullanılır?" >}}
