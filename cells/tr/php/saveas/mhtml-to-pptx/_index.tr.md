---
title:  MHTML'yi PHP için PPTX API olarak kaydedin
description:  MHTML biçim dosyasını PPTX biçim dosyası olarak kaydetmek için PHP için Aspose.Cells Cloud SDK'yı kullanma.
url: /tr/php/saveas/mhtml-to-pptx/
---
...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Bir MHTML dosyasını PHP\'de PPTX olarak kaydedin" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="MHTML\'yi PPTX formatı olarak kaydetmek için REST API kullanan PHP\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="MHTML\'yi PPTX olarak kaydetmek için PHP API nasıl kullanılır?" >}}
