...
{{< blocks/products/cells/cells-cloud-section title="Bir XLT dosyasını PHP\'e JSON olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP XLT\'yi REST API kullanarak JSON olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud PHP kitaplığını kullanarak XLT\'yi JSON olarak kaydetme." >}}
