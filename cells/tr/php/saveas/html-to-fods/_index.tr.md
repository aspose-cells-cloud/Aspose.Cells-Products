---
title:  HTML'i PHP için FODS API olarak kaydedin
description:  HTML formatındaki dosyayı FODS formatındaki dosya olarak kaydetmek için Aspose.Cells Cloud SDK for PHP'i kullanma.
url: /tr/php/saveas/html-to-fods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="HTML\'i FODS olarak kaydetmek için PHP API" h2="HTML\'i FODS olarak kaydetmek için PHP kitaplığı" p="PHP\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, HTML\'i PHP kullanarak çevrimiçi olarak FODS ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/html-to-fods/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="HTML\'i FODS olarak kaydetmek için PHP API nasıl kullanılır?" >}}
