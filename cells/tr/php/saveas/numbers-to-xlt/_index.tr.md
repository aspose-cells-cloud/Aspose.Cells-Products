...
---
{{< blocks/products/cells/cells-cloud-banner h1="NUMBERS\'ı XLT olarak kaydet" h2="NUMBERS\'ı XLT olarak kaydetmek için PHP kitaplık" p="PHP\'de özelleştirilmiş e-tablo iş akışları oluşturmak için SaveAs Cells Cloud\'un API\'ini kullanın. Bu, NUMBERS\'ı PHP\'i kullanarak çevrimiçi olarak XLT ve diğer belge formatları olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/numbers-to-xlt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Bulut PHP kitaplığını kullanarak NUMBERS\'ı XLT olarak nasıl kaydedeceğinizi öğrenin." >}}
