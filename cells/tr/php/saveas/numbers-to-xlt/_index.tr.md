...
---
{{< blocks/products/cells/cells-cloud-banner h1="NUMBERS\'ı XLT olarak kaydet" h2="NUMBERS\'ı XLT olarak kaydetmek için PHP kitaplık" p="PHP\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells Bulut\'un API\'ini Kaydet\'i kullanın. Bu, PHP\'i kullanarak NUMBERS\'ı XLT ve diğer belge formatları olarak çevrimiçi kaydetmek için profesyonel bir çözümdür." urlsection="saveas/numbers-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section title="NUMBERS dosyasını PHP\'e XLT olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP REST API\'i kullanarak NUMBERS\'ı XLT olarak kaydetmeye yönelik Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud PHP kitaplığını kullanarak NUMBERS\'ı XLT olarak kaydetme." >}}
