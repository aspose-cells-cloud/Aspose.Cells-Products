...
---
{{< blocks/products/cells/cells-cloud-banner h1="SXC\'yi HTML olarak kaydedin" h2="SXC\'yi HTML olarak kaydetmek için PHP kitaplığı" p="PHP\'de özelleştirilmiş e-tablo iş akışları oluşturmak için SaveAs API of Cells Cloud\'u kullanın. Bu, SXC\'yi HTML olarak ve diğer belge formatlarını PHP kullanarak çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/sxc-to-html/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud PHP kitaplığını kullanarak SXC\'yi HTML olarak kaydetme." >}}
