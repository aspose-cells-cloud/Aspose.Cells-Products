---
title:  Excel dosyasını PHP kullanarak diğer formatlarda kaydedin
description:  Aspose.Cells Cloud REST API, PHP kullanılarak Excel dosyasının çeşitli formatlarda kaydedilmesini destekler ve birden fazla programlama dili için SDK'lar sunar.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Excel dosyasını PHP kullanarak diğer formatlarda kaydedin" h2="Aspose.Cells Cloud SDK, çalışma kitaplarının 30\'dan fazla farklı dosya biçiminde kaydedilmesini destekler." p="Aspose.Cells Cloud REST API, PHP kullanılarak Excel dosyasının çeşitli formatlarda kaydedilmesini destekler ve birden fazla programlama dili için SDK\'lar sunar." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Excel dosyasını PHP Uzantı bağlantılarını kullanarak diğer formatlarda kaydedin" >}}
