...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PHP REST API kullanarak HTML\'i XLTX olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud PHP kitaplığını kullanarak HTML\'i XLTX olarak kaydetme." >}}
