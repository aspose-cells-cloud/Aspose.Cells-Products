---
title:  PHP ile birleştir
description: Aspose.Cells Cloud REST API, birden çok Excel dosyasının PHP ile bir Excel dosyasında birleştirilmesini destekler. SDK, birden çok geliştirme dilini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir.
url: /tr/php/merge/
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP ile birleştir" h2="Aspose.Cells Cloud SDK, birden çok Excel dosyasının bir Excel dosyasında birleştirilmesini destekler.." p="Aspose.Cells Cloud REST API, birden çok Excel dosyasının PHP ile bir Excel dosyasında birleştirilmesini destekler. SDK, birden çok geliştirme dilini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift\'i içerir." urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="PHP Uzantı bağlantıları ile birleştirin" >}}
