---
title:  Excel dosyasını PHP'i kullanarak birleştir
description:  Aspose.Cells Cloud REST API, PHP kullanılarak birden fazla Excel dosyasının tek bir Excel dosyasında birleştirilmesini destekler ve çeşitli programlama dilleri için SDK'lar sunar.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Excel dosyasını PHP\'i kullanarak birleştir" h2="Aspose.Cells Cloud SDK, birden fazla Excel dosyasının tek bir Excel dosyasında birleştirilmesini destekler." p="Aspose.Cells Cloud REST API, PHP kullanılarak birden fazla Excel dosyasının tek bir Excel dosyasında birleştirilmesini destekler ve çeşitli programlama dilleri için SDK\'lar sunar." urlsection="merge/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Excel dosyalarını PHP Uzantı bağlantılarını kullanarak birleştirme" >}}
