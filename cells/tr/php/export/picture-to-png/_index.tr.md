...
{{< blocks/products/cells/cells-cloud-section title="PHP için Cells Bulut SDK\'sını kullanarak PICTURE nesnesini PNG biçim dosyasına aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="RESİM\'i e-tablodan PNG formatına aktarmak için REST API\'i kullanan PHP\'deki kod örneği" gistPath="" %}}
