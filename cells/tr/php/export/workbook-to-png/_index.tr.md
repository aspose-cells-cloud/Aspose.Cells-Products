...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="PHP için Cells Cloud SDK\'yı kullanarak ÇALIŞMA KİTABI nesnesini PNG biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="ÇALIŞMA KİTABI\'nı e-tablodan PNG biçimine aktarmak için REST API\'i kullanan PHP\'deki kod örneği" gistPath="" %}}
