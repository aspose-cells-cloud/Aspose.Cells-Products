---
title: PHP API kullanarak ÇALIŞMA TABLOSUNU e-tablodan GIF'e aktarın
description:  Aspose.Cells Cloud REST API, {0} dosyalarını {2} kullanarak {1} biçiminde dışa aktarmayı destekler.
url: /tr/php/export/worksheet-to-gif/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="PHP API ÇALIŞMA TABLOSUNU GIF dosyasına aktarmak için" h2="PHP kitaplığı, ÇALIŞMA TABLOSUNU GIF dosyasına dışa aktarmak için" p="PHP\'deki elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, PHP\'i kullanarak ÇALIŞMA TABLOSUNU çevrimiçi elektronik tablodan GIF formatındaki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-gif/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="WORKSHEET nesnesini PHP\'de GIF formatındaki dosyaya aktarın" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="WORKSHEET\'i GIF\'e dışa aktarmak için PHP API nasıl kullanılır?" >}}
