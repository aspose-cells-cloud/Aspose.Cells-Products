...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="PHP için Cells Bulut SDK\'sını kullanarak PICTURE nesnesini EMF biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="RESİM\'i e-tablodan EMF formatına aktarmak için REST API\'i kullanan PHP\'deki kod örneği" gistPath="" %}}
