---
title:  PHP için Cells Cloud SDK'yı kullanarak ÇALIŞMA SAYFASI'nı Excel'den ODS'ye aktarın
...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA SAYFASINI Excel\'den ODS\'ye aktar" h2="PHP ÇALIŞMA SAYFASI\'nı ODS dosyasına aktarmak için kütüphane" p="PHP\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, PHP\'i kullanarak çevrimiçi tablodan ÇALIŞMA SAYFASI\'nı ODS biçimindeki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-ods/" >}}

{{< blocks/products/cells/cells-cloud-section title="PHP için Cells Cloud SDK\'yı kullanarak WORKSHEET nesnesini ODS biçimindeki dosyaya aktarın" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
WORKSHEET nesnesini Excel dosyasından ODS dosyasına aktarmak karmaşık bir iştir. WORKSHEET'i ODS'ye aktarma format geçişleri PHP SDK'mız tarafından gerçekleştirilir ve kaynak WORKSHEET elektronik tablosunun ana yapısal ve mantıksal içeriği korunur. PHP kitaplığımız, WORKSHEET nesnelerini çevrimiçi olarak ODS formatındaki dosyalara aktarmak için profesyonel bir çözümdür. Bu Bulut SDK'sı, PHP geliştiriciye güçlü işlevsellik ve mükemmel ODS çıkışı sağlar.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="WORKSHEET\'i e-tablodan ODS formatına aktarmak için REST API\'i kullanan PHP\'deki kod örneği" gistPath="" %}}
