...
{{< blocks/products/cells/cells-cloud-section title="PHP için Cells Cloud SDK\'yı kullanarak SHAPE nesnesini JPG formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="SHAPE\'i elektronik tablodan JPG formatına aktarmak için REST API\'i kullanan PHP\'deki kod örneği" gistPath="" %}}
