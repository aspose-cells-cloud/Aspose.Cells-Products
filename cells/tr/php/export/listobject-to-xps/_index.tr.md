...
{{< blocks/products/cells/cells-cloud-upper-banner h1="LISTOBJECT\'i Excel\'den XPS\'e aktar" h2="LISTOBJECT\'i XPS dosyasına aktarmak için PHP kitaplığı" p="PHP\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, PHP\'i kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i XPS biçimindeki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-xps/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="PHP için Cells Cloud SDK\'yı kullanarak LISTOBJECT nesnesini XPS biçimli dosyaya aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i e-tablodan XPS biçimine aktarmak için REST API\'i kullanan PHP\'deki kod örneği" gistPath="" %}}
