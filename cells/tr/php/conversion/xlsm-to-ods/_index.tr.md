---
title:  XLSM'den ODS'ye Dönüştürme API için PHP
description:  XLSM biçim dosyasını ODS biçim dosyasına dönüştürmek için PHP için Aspose.Cells Cloud SDK'yı kullanma.
url: /tr/php/conversion/xlsm-to-ods/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="XLSM\'yi ODS formatına dönüştürmek için REST API kullanan PHP\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLSM\'yi ODS\'ye dönüştürmek için PHP API nasıl kullanılır?" >}}
