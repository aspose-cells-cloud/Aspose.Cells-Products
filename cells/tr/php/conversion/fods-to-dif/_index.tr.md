...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP ile FODS\'yi DIF\'ye dönüştürün" h2="Excel ve OpenOffice dosya dönüştürmesini PHP için açık kaynaklı Cloud SDK ile otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS\'yi DIF\'e Hızla Dönüştürün via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS\'den DIF\'e Dönüşüm Kodu" gistPath="" %}}
```php
