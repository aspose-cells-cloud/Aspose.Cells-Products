...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP ile FODS\'yi MHTML\'ye dönüştürün" h2="Excel için açık kaynak Cloud SDK ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS\'yi hızla MHTML\'ye dönüştürün via PHP" %}}
...
1. Ortaya çıkan MHTML dosyasını almak için ```CellsApi.cellsSaveAsPostDocumentSaveAs```'i arayın
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS\'den MHTML\'ye Dönüştürme Kodu" gistPath="" %}}
```php
