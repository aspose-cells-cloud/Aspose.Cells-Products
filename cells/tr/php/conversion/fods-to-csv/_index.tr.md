...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP ile FODS\'yi CSV\'ye dönüştürün" h2="Excel ve OpenOffice dosya dönüştürmesini PHP için açık kaynaklı Cloud SDK ile otomatikleştirin" >}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS\'den CSV\'ye Dönüşüm Kodu" gistPath="" %}}
```php
