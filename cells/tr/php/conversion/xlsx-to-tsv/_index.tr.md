---
title:  XLSX'den TSV'ye Dönüştürme API için PHP
description:  XLSX biçim dosyasını TSV biçim dosyasına dönüştürmek için Aspose.Cells Cloud SDK for PHP'i kullanma.
url: /tr/php/conversion/xlsx-to-tsv/
---
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="XLSX\'i TSV formatına dönüştürmek için REST API kullanan PHP\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLSX\'i TSV\'ye dönüştürmek için PHP API nasıl kullanılır?" >}}
