...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP ile FODS\'yi TXT\'ye dönüştürün" h2="Excel ve OpenOffice dosya dönüştürmesini PHP için açık kaynaklı Cloud SDK ile otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS\'yi TXT\'ye Hızla Dönüştürün via PHP" %}}
...
1. Ortaya çıkan TXT dosyasını almak için ```CellsApi.cellsSaveAsPostDocumentSaveAs```'i arayın
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS\'den TXT\'ye Dönüştürme Kodu" gistPath="" %}}
```php
