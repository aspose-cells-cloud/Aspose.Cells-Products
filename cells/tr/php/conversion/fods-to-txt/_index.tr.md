...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP ile FODS\'yi TXT\'ye dönüştürün" h2="Excel için açık kaynak Cloud SDK ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS\'yi hızla TXT\'ye dönüştürün via PHP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS\'den TXT\'ye Dönüşüm Kodu" gistPath="" %}}
```php
