---
title:  Bulutta FODS'yi XPS'e dönüştürün via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi PHP ile XPS\'e dönüştürün" h2="Excel için açık kaynak Cloud SDK ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS\'yi hızla XPS via PHP\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS kodunu XPS\'e dönüştürme" gistPath="" %}}
```php
