---
title:  Bulutta FODS'yi HTML'e dönüştürün via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi PHP ile HTML\'e dönüştürün" h2="Excel için açık kaynak Cloud SDK ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS\'yi hızla HTML via PHP\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/code-autogen title="PHP FODS kodunu HTML\'e dönüştürme" gistPath="" %}}
```php
