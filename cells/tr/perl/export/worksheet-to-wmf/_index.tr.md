---
title:  Perl API kullanarak WORKSHEET'i elektronik tablodan WMF'ye aktarın
...
url: /tr/perl/export/worksheet-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Perl API, WORKSHEET\'i WMF dosyasına aktarmak için" h2="WORKSHEET\'i WMF dosyasına dışa aktarmak için Perl kitaplığı" p="Perl\'de elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, WORKSHEET\'i Perl kullanarak çevrimiçi elektronik tablodan WMF formatındaki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-wmf/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="WORKSHEET\'i WMF\'ye dışa aktarmak için Perl API nasıl kullanılır?" >}}
