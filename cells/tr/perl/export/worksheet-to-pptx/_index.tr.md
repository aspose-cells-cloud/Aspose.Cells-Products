---
title:  Perl için Cells Cloud SDK'yı kullanarak ÇALIŞMA SAYFASI'nı Excel'den PPTX'e aktarın
...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA SAYFASINI Excel\'den PPTX\'e aktar" h2="Perl ÇALIŞMA SAYFASINI PPTX dosyasına aktarmak için kütüphane" p="Perl\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Perl\'i kullanarak çevrimiçi tablodan ÇALIŞMA SAYFASINI PPTX biçimindeki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-pptx/" >}}

{{< blocks/products/cells/cells-cloud-section title="Perl için Cells Cloud SDK\'yı kullanarak WORKSHEET nesnesini PPTX biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="WORKSHEET\'i e-tablodan PPTX formatına aktarmak için REST API\'i kullanan Perl\'deki kod örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Nesneleri Excel WORKSHEET\'ten PPTX\'e aktarmak için Perl için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
