...
{{< blocks/products/cells/cells-cloud-upper-banner h1="LISTOBJECT\'i Excel\'den JPG\'ye aktar" h2="LISTOBJECT\'i JPG dosyasına aktarmak için Perl kütüphane" p="Perl\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Perl\'i kullanarak elektronik tablodan LISTOBJECT\'i JPG formatındaki dosyaya çevrimiçi olarak dışa aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-jpg/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Perl için Cells Cloud SDK\'yı kullanarak LISTOBJECT nesnesini JPG formatındaki dosyaya aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i elektronik tablodan JPG formatına aktarmak için REST API\'i kullanan Perl\'deki kod örneği" gistPath="" %}}
