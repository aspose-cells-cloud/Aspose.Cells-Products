---
title:  Perl için Cells Bulut SDK'sını kullanarak ÇALIŞMA KİTABI'nı Excel'den XPS'e aktarın
...
{{< blocks/products/cells/cells-cloud-section title="Perl için Cells Cloud SDK\'yı kullanarak ÇALIŞMA KİTABI nesnesini XPS biçim dosyasına aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="ÇALIŞMA KİTABI\'nı e-tablodan XPS biçimine aktarmak için REST API\'i kullanan Perl\'deki kod örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Nesneleri Excel ÇALIŞMA KİTABI\'ndan XPS\'e dışa aktarmak için Perl için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
