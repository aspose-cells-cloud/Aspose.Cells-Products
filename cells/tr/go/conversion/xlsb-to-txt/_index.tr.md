---
title:  Go için XLSB'den TXT'ye Dönüştürme API
description:  XLSB biçimli dosyayı TXT biçimli dosyaya dönüştürmek için Aspose.Cells Cloud SDK for Go'yu kullanma.
url: /tr/go/conversion/xlsb-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSB\'yi TXT\'ye dönüştürmek için API\'e gidin" h2="XLSB\'yi TXT\'ye dönüştürmek için kitaplığa gidin" p="Go\'da özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells Conversion REST API\'i kullanın. Bu, XLSB\'yi Go kullanarak çevrimiçi olarak TXT\'ye ve diğer belge biçimlerine dönüştürmek için profesyonel bir çözümdür." urlsection="conversion/xlsb-to-txt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLSB\'yi TXT\'ye dönüştürmek için Go API nasıl kullanılır?" >}}
