---
title:  Go'yu kullanarak Excel dosyayı koruyun
description: Aspose.Cells Cloud REST API, Go kullanarak çalışma kitaplarına şifrelemeyi, şifre çözmeyi ve dijital imza eklemeyi destekler ve çeşitli programlama dilleri için SDK'lar sunar.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Go\'yu kullanarak Excel dosyayı koruyun" h2="Aspose.Cells Bulut SDK\'sı çalışma kitaplarının şifresini çözmeyi, şifrelemeyi ve dijital olarak imzalamayı destekler." p="Aspose.Cells Cloud REST API, Go kullanarak çalışma kitaplarına şifrelemeyi, şifre çözmeyi ve dijital imza eklemeyi destekler ve çeşitli programlama dilleri için SDK\'lar sunar." urlsection="protect/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells Cloud" subTitlepfName="Cells Cloud Feature" >}}

{{< blocks/products/cells/cells-cloud-card-row title="Go Uzantısı bağlantılarını kullanarak Excel dosyalarını koruyun" >}}
