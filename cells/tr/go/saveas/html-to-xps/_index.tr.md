...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API\'i kullanarak HTML\'i XPS olarak kaydetmek için Kod Örneğine gidin" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Go kitaplığını kullanarak HTML\'i XPS olarak kaydetme." >}}
