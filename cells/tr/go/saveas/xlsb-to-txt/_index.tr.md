---
title:  XLSB'yi Go için TXT API olarak kaydedin
description:  XLSB biçimli dosyayı TXT biçimli dosya olarak kaydetmek için Aspose.Cells Cloud SDK for Go'yu kullanma.
url: /tr/go/saveas/xlsb-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSB\'yi TXT olarak kaydetmek için API\'e gidin" h2="XLSB\'yi TXT olarak kaydetmek için kitaplığa gidin" p="Go\'da özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, XLSB\'yi Go kullanarak çevrimiçi olarak TXT ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xlsb-to-txt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLSB\'yi TXT olarak kaydetmek için Go API nasıl kullanılır?" >}}
