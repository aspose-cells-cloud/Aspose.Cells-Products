...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API kullanarak XML\'i XLT olarak kaydetmek için Kod Örneğine gidin" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Go kitaplığını kullanarak XML\'i XLT olarak kaydetme." >}}
