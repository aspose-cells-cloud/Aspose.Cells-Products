...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi PDF\'e dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den PDF\'e Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS için Ruby Kodunun PDF\'e Dönüşümü" gistPath="" %}}
```ruby
