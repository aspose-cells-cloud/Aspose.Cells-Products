---
title:  Excel FODS'yi XLTM via Ruby'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi XLTM\'ye dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den XLTM\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den XLTM\'ye Dönüşüm için Ruby Kodu" gistPath="" %}}
```ruby
