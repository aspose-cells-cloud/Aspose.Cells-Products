...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi XLTM\'ye Dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den XLTM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den XLTM\'ye Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
