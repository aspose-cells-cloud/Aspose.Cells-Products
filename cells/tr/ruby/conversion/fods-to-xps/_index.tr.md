---
title:  Excel FODS'i XPS via Ruby'ye dönüştür
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi XPS\'e dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den XPS\'e Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
