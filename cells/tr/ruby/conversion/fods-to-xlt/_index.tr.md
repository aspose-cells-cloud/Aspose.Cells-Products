...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi XLT\'ye dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den XLT\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den XLT\'ye Dönüşüm için Ruby Kodu" gistPath="" %}}
```ruby
