...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi HTML\'e dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den HTML\'e Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS için Ruby Kodunun HTML\'e Dönüşümü" gistPath="" %}}
```ruby
