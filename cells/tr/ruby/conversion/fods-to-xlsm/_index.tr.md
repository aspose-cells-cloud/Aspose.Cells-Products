---
title:  Excel FODS'i XLSM via Ruby'ye dönüştür
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi XLSM\'ye dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
...
1. Ortaya çıkan XLSM dosyasını almak için ```CellsApi.cells_save_as_post_document_save_as``` yöntemini arayın
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den XLSM\'ye Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
