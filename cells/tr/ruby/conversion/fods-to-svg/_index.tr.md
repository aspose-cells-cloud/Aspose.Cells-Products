---
title:  Excel FODS'i SVG via Ruby'ye dönüştür
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi SVG\'e dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den SVG\'e Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
