---
title:  Excel FODS'i TXT via Ruby'ye dönüştür
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi TXT\'ye Dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den TXT\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den TXT\'ye Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
