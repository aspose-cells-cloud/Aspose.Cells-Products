...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi TSV\'ye dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den TSV\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den TSV\'ye Dönüşüm için Ruby Kodu" gistPath="" %}}
```ruby
