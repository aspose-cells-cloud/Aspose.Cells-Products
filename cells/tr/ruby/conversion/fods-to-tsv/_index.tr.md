---
title:  Excel FODS'i TSV via Ruby'ye dönüştür
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi TSV\'ye dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den TSV\'ye Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
