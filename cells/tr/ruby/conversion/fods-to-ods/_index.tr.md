...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi ODS\'ye Dönüştürün" h2="Açık kaynak Cloud SDK for Ruby ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den ODS\'ye Dönüşüm için Yakut Kodu" gistPath="" %}}
```ruby
