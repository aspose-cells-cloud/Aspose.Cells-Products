...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi TIFF\'e dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile FODS\'den TIFF\'e Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS için Ruby Kodunun TIFF\'e Dönüşümü" gistPath="" %}}
```ruby
