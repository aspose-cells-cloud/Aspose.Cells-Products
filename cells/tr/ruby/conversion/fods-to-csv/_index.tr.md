...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi CSV\'ye dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den CSV\'ye Dönüşüm için Ruby Kodu" gistPath="" %}}
```ruby
