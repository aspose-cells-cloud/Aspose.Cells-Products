---
title: Excel FODS'yi SXC via Ruby'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile FODS\'yi SXC\'ye dönüştürün" h2="Ruby için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="FODS\'den SXC\'ye Dönüşüm için Ruby Kodu" gistPath="" %}}
```ruby
