...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Ruby için Cells Cloud SDK\'yı kullanarak SHAPE nesnesini EMF biçimindeki dosyaya aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="SHAPE\'i e-tablodan EMF formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
