...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Ruby için Cells Cloud SDK\'yı kullanarak CHART nesnesini SVG biçimindeki dosyaya aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby\'de, elektronik tablodan CHART\'ı SVG formatına aktarmak için REST API\'i kullanan kod örneği" gistPath="" %}}
