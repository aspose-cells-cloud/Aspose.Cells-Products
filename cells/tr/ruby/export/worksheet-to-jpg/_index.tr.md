---
title:  Ruby API kullanarak WORKSHEET'i e-tablodan JPG'ye aktarın
description:  Aspose.Cells Cloud REST API, {0} dosyalarını {2} kullanarak {1} biçiminde dışa aktarmayı destekler.
url: /tr/ruby/export/worksheet-to-jpg/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="ÇALIŞMA TABLOSUNU JPG dosyasına dışa aktarmak için Ruby API" h2="ÇALIŞMA TABLOSUNU JPG dosyasına dışa aktarmak için Ruby kitaplığı" p="Ruby\'de elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Ruby kullanarak ÇALIŞMA TABLOSUNU elektronik tablodan JPG formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-jpg/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="WORKSHEET\'i JPG\'ye dışa aktarmak için Ruby API nasıl kullanılır?" >}}
