---
title: Ruby API kullanarak ÇALIŞMA KİTABI'nı e-tablodan TXT'ye aktarın
description:  Aspose.Cells Cloud REST API, {0} dosyalarını {2} kullanarak {1} biçiminde dışa aktarmayı destekler.
url: /tr/ruby/export/workbook-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="ÇALIŞMA KİTABI\'nı TXT dosyasına aktarmak için Ruby API" h2="ÇALIŞMA KİTABI\'nı TXT dosyasına aktarmak için Ruby kitaplığı" p="Ruby\'de elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, ÇALIŞMA KİTABI\'nı elektronik tablodan TXT biçimindeki dosyaya Ruby kullanarak çevrimiçi olarak aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-txt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="ÇALIŞMA KİTABI\'nı TXT\'ye dışa aktarmak için Ruby API nasıl kullanılır?" >}}
