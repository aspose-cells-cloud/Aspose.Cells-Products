...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Ruby için Cells Cloud SDK\'yı kullanarak PICTURE nesnesini GIF formatındaki dosyaya aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Ruby\'de elektronik tablodan RESİM\'i GIF formatına aktarmak için REST API\'i kullanan kod örneği" gistPath="" %}}
