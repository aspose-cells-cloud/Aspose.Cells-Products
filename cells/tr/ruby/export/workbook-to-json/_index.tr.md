...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA KİTABI\'nı Excel\'den JSON\'a aktar" h2="ÇALIŞMA KİTABI\'nı JSON dosyasına aktarmak için Ruby kitaplığı" p="Ruby\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Cloud\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Ruby kullanarak çevrimiçi elektronik tablodan ÇALIŞMA KİTABI\'nı JSON formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak WORKBOOK nesnesini JSON formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="ÇALIŞMA KİTABI\'nı e-tablodan JSON formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
