...
{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak PICTURE nesnesini TIFF biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Ruby\'de REST API\'i kullanarak elektronik tablodan RESİM\'i TIFF formatına aktarmak için kod örneği" gistPath="" %}}
