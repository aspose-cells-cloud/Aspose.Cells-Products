...
---
{{< blocks/products/cells/cells-cloud-banner h1="LISTOBJECT\'i Excel\'den SQL\'e aktar" h2="LISTOBJECT\'i SQL dosyasına aktarmak için Ruby kütüphanesi" p="Ruby\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Cloud\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Ruby kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i SQL formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak LISTOBJECT nesnesini SQL formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="LISTOBJECT\'i e-tablodan SQL formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
