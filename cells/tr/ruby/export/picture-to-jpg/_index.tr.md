...
{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak PICTURE nesnesini JPG formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="PICTURE\'ı e-tablodan JPG formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
