...
howto:
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA SAYFASI\'nı Excel\'den GIF\'e aktar" h2="WORKSHEET\'i GIF dosyasına aktarmak için Ruby kütüphanesi" p="Ruby\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Cloud\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Ruby kullanarak ÇALIŞMA SAYFASI\'nı çevrimiçi elektronik tablodan GIF formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-gif/" >}}

{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak WORKSHEET nesnesini GIF formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="WORKSHEET\'i e-tablodan GIF formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
