...
---
{{< blocks/products/cells/cells-cloud-banner h1="LISTOBJECT\'i Excel\'den JSON\'a aktar" h2="LISTOBJECT\'i JSON dosyasına aktarmak için Ruby kütüphanesi" p="Ruby\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Cloud\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Ruby kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i JSON formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak LISTOBJECT nesnesini JSON biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="LISTOBJECT\'i e-tablodan JSON formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
