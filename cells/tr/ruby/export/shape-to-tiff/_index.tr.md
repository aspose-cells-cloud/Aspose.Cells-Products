...
{{< blocks/products/cells/cells-cloud-section title="Ruby için Cells Cloud SDK\'yı kullanarak SHAPE nesnesini TIFF biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="SHAPE\'i e-tablodan TIFF formatına aktarmak için REST API\'i kullanan Ruby\'deki kod örneği" gistPath="" %}}
