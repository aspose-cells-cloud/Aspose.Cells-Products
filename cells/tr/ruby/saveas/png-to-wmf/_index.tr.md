...
<br/>
PNG'den dosya biçimlerini WMF olarak kaydetmek karmaşık bir iştir. PNG'den WMF formatına tüm geçişler, kaynak PNG elektronik tablosunun ana yapısal ve mantıksal içeriği korunurken Ruby SDK'mız tarafından gerçekleştirilir. Ruby kitaplığımız, PNG'i çevrimiçi WMF dosyaları olarak kaydetmek için profesyonel bir çözümdür. Bu Cloud SDK, Ruby geliştiricilerine güçlü işlevsellik ve mükemmel WMF çıktısı sağlar.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="PNG\'i WMF formatı olarak kaydetmek için REST API kullanan Ruby\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="PNG\'i WMF olarak kaydetmek için Ruby API nasıl kullanılır?" >}}
