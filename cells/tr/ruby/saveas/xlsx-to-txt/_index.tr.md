...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak XLSX\'i TXT olarak kaydetmek için Ruby Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer XLSX formatlarında TXT olarak kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
