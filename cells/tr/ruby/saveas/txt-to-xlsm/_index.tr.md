...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API kullanarak TXT\'yi XLSM olarak kaydetmek için Ruby Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Ruby kitaplığını kullanarak TXT\'yi XLSM olarak nasıl kaydedeceğinizi öğrenin." >}}
