...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API\'i kullanarak XML\'i XLSM olarak kaydetmek için Ruby Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Ruby kitaplığını kullanarak XML\'i XLSM olarak kaydetme." >}}
