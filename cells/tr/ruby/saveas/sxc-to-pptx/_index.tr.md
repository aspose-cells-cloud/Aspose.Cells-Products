...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Ruby\'de bir SXC dosyasını PPTX olarak kaydedin" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API\'i kullanarak SXC\'yi PPTX olarak kaydetmek için Ruby Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını PPTX olarak diğer SXC formatları olarak kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
