...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API\'i kullanarak NUMBERS\'ı TXT olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyayı diğer formatlarda NUMBERS olarak TXT olarak kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
