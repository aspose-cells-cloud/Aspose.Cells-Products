...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak TXT\'yi JPG olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını JPG olarak diğer TXT formatlarında kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
