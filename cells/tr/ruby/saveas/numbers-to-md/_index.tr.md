...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API\'i kullanarak NUMBERS\'ı MD olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyayı MD olarak NUMBERS diğer formatlarda kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
