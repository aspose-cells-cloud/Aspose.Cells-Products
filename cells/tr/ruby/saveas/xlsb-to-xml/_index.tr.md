---
title:  XLSB'yi Ruby için XML API olarak kaydedin
description:  XLSB biçim dosyasını XML biçim dosyası olarak kaydetmek için Aspose.Cells Cloud SDK for Ruby'yi kullanma.
url: /tr/ruby/saveas/xlsb-to-xml/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLSB\'yi XML olarak kaydetmek için Ruby API" h2="XLSB\'yi XML olarak kaydetmek için Ruby kitaplığı" p="Ruby\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, XLSB\'yi Ruby kullanarak çevrimiçi olarak XML ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xlsb-to-xml/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLSB\'yi XML olarak kaydetmek için Ruby API nasıl kullanılır?" >}}
