...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API\'i kullanarak HTML\'i XLS olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyasını diğer formatlarda kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır HTML XLS olarak" >}}
