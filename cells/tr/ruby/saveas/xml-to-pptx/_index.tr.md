...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Bir XML dosyasını Ruby\'de PPTX olarak kaydetme" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak XML\'i PPTX olarak kaydetmek için Ruby Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını PPTX olarak diğer XML biçimleri olarak kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
