...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API\'i kullanarak MHTML\'yi XPS olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını MHTML olarak XPS olarak diğer formatlarda kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
