...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak XLT\'yi XML olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer formatlardaki XLT\'yi XML olarak kaydetmek için Ruby için Cells Cloud SDK nasıl kullanılır?" >}}
