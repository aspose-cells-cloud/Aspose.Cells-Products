...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak TXT\'yi ODS olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını ODS olarak TXT olarak diğer formatlarda kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
