---
title:  Ruby için JSON'u CSV API olarak kaydedin
description:  JSON biçim dosyasını CSV biçim dosyası olarak kaydetmek için Aspose.Cells Cloud SDK for Ruby kullanılıyor.
url: /tr/ruby/saveas/json-to-csv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="JSON\'u CSV olarak kaydetmek için Ruby API" h2="JSON\'u CSV olarak kaydetmek için Ruby kitaplığı" p="Ruby\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, JSON\'u Ruby kullanarak çevrimiçi olarak CSV ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/json-to-csv/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="JSON\'u CSV olarak kaydetmek için Ruby API nasıl kullanılır?" >}}
