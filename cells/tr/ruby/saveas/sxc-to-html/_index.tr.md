...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API\'i kullanarak SXC\'yi HTML olarak kaydetmek için Ruby Kodu Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını HTML olarak diğer SXC formatları olarak kaydetmek için Ruby için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
