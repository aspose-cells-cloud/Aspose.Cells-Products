...
description: REST API, bulutta Microsoft ve OpenOffice elektronik tablolarını almak, işlemek, şifrelemek, dönüştürmek ve dışa aktarmak için via Swift SDK
weight: 130
url: /tr/swift
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel Hesap Tabloları Oluşturmak ve Dönüştürmek için Swift SDK" h2="REST API, bulutta Microsoft ve OpenOffice elektronik tablolarını almak, işlemek, şifrelemek, dönüştürmek ve dışa aktarmak için via Swift SDK." logoImageSrc="/headers/aspose_cells-for-swift.svg" pfName="Aspose.Cells" subTitlepfName="Cloud SDK for Swift" downloadUrl="" >}}
...
<p>Aspose.Cells Swift için Bulut SDK'sı, programcıların Microsoft Excel ve OpenOffice elektronik tablo görüntüleme ve işleme özelliklerini Swift'te geliştirilen bulut tabanlı uygulamalarına sorunsuz bir şekilde entegre etmelerine yardımcı olur. Aspose.Cells Swift için Cloud SDK, MIT kapsamında lisanslanmıştır.</p>
<p>Aspose.Cells Swift için Bulut SDK'sı, Swift uygulamalarınızın bulutta depolanan elektronik tabloları, çalışma sayfalarını ve çalışma kitaplarını almasını ve ayrıca yeni elektronik tablo oluşturmasını sağlar. Ayrıca, herhangi bir 3. taraf yazılımı yüklemeden uygulamalarınız içinden koşullu biçimlendirmeyi, çizelgeleri, görevleri, şekilleri, filtreleri, OleObject'leri, aralıkları, ListObject'leri ve pivot tabloları işlemek ve değiştirmek için Swift kodunuzu ince ayar yapabilirsiniz.</p>
<p>Aspose.Cells Cloud SDK for Swift'i kullanarak Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) ve OpenOffice (ODS) çalışma sayfalarını XML (SpreadsheetML), TSV, CSV, TXT (TabDelimited) gibi diğer popüler biçimlere dönüştürün ), HTML, MHTML, DIF, TIFF, SVG, XPS, PDF & Markdown (MD). Aspose.Cells Cloud SDK for Swift'i kullanarak SXC ve FODS biçimleriyle de çalışabilirsiniz.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-swift.svg" alt="Swift Excel SDK"><header>Aspose.Cells</header><footer> Bulut<small> <em> için</em> </small>Süratli</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
Çalışma sayfasından belirli veya tüm OleObject'leri silin
 ...
 Excel Elektronik Tablo İşleme SDK'sını Kullanmaya Başlayın
    ...
    <p>
 Aspose.Cells Cloud SDK for Swift'i kullanmaya başlamak için herhangi bir şey yüklemeniz gerekmez. Tek yapmanız gereken bir hesap oluşturmak
