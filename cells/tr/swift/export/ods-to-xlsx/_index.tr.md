---
title: Oranları XLSX dosyasına aktar via Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODS\'yi Bulutta XLSX dosyasına aktarın" h2="Excel & Swift için açık kaynaklı Cloud SDK ile OpenOffice e-tablo dışa aktarımı" >}}
...
{{% blocks/products/pf/agp/code-autogen title="ODS\'den XLSX\'e Dönüşüm için Swift Kodu" gistPath="" %}}
```swift
