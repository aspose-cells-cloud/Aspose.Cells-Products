---
title:  Swift için TSV'yi FODS API olarak kaydedin
description:  TSV formatındaki dosyayı FODS formatındaki dosya olarak kaydetmek için Swift için Aspose.Cells Cloud SDK'yı kullanma.
