---
title:  Android için XLTX'den TSV'ye Dönüştürme API
description:  XLTX biçim dosyasını TSV biçim dosyasına dönüştürmek için Aspose.Cells Cloud SDK for Android'i kullanma.
url: /tr/android/conversion/xltx-to-tsv/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="XLTX\'i TSV\'ye dönüştürmek için Android API" h2="XLTX\'i TSV\'ye dönüştürmek için Android kitaplığı" p="Android\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells Conversion REST API\'i kullanın. Bu, XLTX\'i Android kullanarak çevrimiçi olarak TSV\'ye ve diğer belge biçimlerine dönüştürmek için profesyonel bir çözümdür." urlsection="conversion/xltx-to-tsv/" >}}
