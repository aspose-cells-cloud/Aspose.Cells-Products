---
title:  Android'de FODS'yi TSV'ye dönüştürün
...
url: /tr/android/conversion/fods-to-tsv/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Bulutta TSV\'ye Dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den TSV\'ye Dönüşüm" %}}
...
1. Ortaya çıkan TSV dosyasını almak için ```CellsApi.cellsWorkbookGetWorkbook```'i arayın
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den TSV\'ye Dönüşüm" gistPath="" %}}
```java
