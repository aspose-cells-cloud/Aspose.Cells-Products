---
title:  Android'de FODS'yi CSV'ye dönüştürün
...
url: /tr/android/conversion/fods-to-csv/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Bulutta CSV\'ye Dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den CSV\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den CSV\'ye Dönüştürme" gistPath="" %}}
```java
