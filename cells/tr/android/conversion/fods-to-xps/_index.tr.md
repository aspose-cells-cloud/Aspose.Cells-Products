---
title:  Android'de FODS'yi XPS'e dönüştürün
...
url: /tr/android/conversion/fods-to-xps/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi XPS\'e dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında XPS Dönüşümüne FODS" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den XPS\'e Dönüşüm" gistPath="" %}}
```java
