---
title:  Android'de FODS'yi XLTM'ye dönüştürün
...
url: /tr/android/conversion/fods-to-xltm/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi XLTM\'ye Dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den XLTM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den XLTM\'ye Dönüştürme" gistPath="" %}}
```java
