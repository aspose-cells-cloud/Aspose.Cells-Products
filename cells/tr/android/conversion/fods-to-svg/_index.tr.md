---
title:  Android'de FODS'yi SVG'e dönüştürün
...
url: /tr/android/conversion/fods-to-svg/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi SVG\'e dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında SVG Dönüşümüne FODS" %}}
...
1. Ortaya çıkan SVG dosyasını almak için ```CellsApi.cellsWorkbookGetWorkbook```'i arayın
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den SVG\'e Dönüşüm" gistPath="" %}}
```java
