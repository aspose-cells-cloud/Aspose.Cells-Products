---
title:  Android'de FODS'yi HTML'e dönüştürün
...
url: /tr/android/conversion/fods-to-html/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi HTML\'e dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında HTML Dönüşümüne FODS" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den HTML\'e Dönüşüm" gistPath="" %}}
```java
