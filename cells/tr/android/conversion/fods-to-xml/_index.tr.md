---
title:  Android'de FODS'yi XML'e dönüştürün
...
url: /tr/android/conversion/fods-to-xml/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Bulutta XML\'e Dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den XML\'e Dönüştürme" %}}
...
1. Ortaya çıkan XML dosyasını almak için ```CellsApi.cellsWorkbookGetWorkbook```'i arayın
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den XML\'e Dönüştürme" gistPath="" %}}
```java
