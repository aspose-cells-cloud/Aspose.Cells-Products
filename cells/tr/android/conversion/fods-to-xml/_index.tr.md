...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi XML\'e dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice e-tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den XML\'e Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den XML\'e Dönüşüm" gistPath="" %}}
```java
