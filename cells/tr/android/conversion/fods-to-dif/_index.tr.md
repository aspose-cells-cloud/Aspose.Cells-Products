...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi DIF\'ye dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice e-tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den DIF\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den DIF\'ye Dönüşüm" gistPath="" %}}
```java
