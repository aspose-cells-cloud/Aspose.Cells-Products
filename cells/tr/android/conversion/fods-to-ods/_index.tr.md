---
title:  Android'de FODS'yi ODS'ye dönüştürün
...
url: /tr/android/conversion/fods-to-ods/
family: cells
platformtag: android
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Bulutta ODS\'ye Dönüştürün" h2="Android için açık kaynaklı Cloud SDK ile Excel ve OpenOffice elektronik tablolarını dönüştürün" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android Uygulamalarında FODS\'den ODS\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android: FODS\'den ODS\'ye Dönüşüm" gistPath="" %}}
```java
