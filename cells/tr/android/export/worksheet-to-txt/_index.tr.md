---
title:  Android API kullanarak ÇALIŞMA TABLOSUNU elektronik tablodan TXT'ye aktarın
description:  Aspose.Cells Cloud REST API, {0} dosyalarını {2} kullanarak {1} biçiminde dışa aktarmayı destekler.
url: /tr/android/export/worksheet-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="ÇALIŞMA TABLOSUNU TXT dosyasına dışa aktarmak için Android API" h2="WORKSHEET\'i TXT dosyasına dışa aktarmak için Android kitaplığı" p="Android\'de elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Android kullanarak ÇALIŞMA TABLOSUNU elektronik tablodan TXT biçimindeki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-txt/" >}}
