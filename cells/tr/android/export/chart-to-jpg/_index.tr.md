---
title:  Android için Cells Cloud SDK'yı kullanarak CHART'ı Excel'den JPG'ye aktarın
...
<br/>
CHART nesnesini Excel dosyasından JPG dosyasına aktarmak karmaşık bir iştir. CHART'ı JPG formatına aktarma geçişleri, kaynak CHART elektronik tablosunun ana yapısal ve mantıksal içeriği korunurken Android SDK'mız tarafından gerçekleştirilir. Android kitaplığımız, CHART nesnelerini çevrimiçi olarak JPG formatındaki dosyalara aktarmak için profesyonel bir çözümdür. Bu Bulut SDK, Android geliştiricilerine güçlü işlevsellik ve mükemmel JPG çıktısı sağlar.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Android\'de CHART\'ı e-tablodan JPG formatına aktarmak için REST API\'i kullanan kod örneği" gistPath="" %}}
