---
title:  Android için Cells Cloud SDK'yı kullanarak WORKSHEET'i Excel'den ODS'ye aktarın
...
<br/>
WORKSHEET nesnesini Excel dosyasından ODS dosyasına aktarmak karmaşık bir iştir. WORKSHEET'i ODS'ye aktarma format geçişleri, kaynak WORKSHEET elektronik tablosunun ana yapısal ve mantıksal içeriği korunurken Android SDK'mız tarafından gerçekleştirilir. Android kitaplığımız, WORKSHEET nesnelerini çevrimiçi olarak ODS formatındaki dosyalara aktarmak için profesyonel bir çözümdür. Bu Bulut SDK, Android geliştiricilerine güçlü işlevsellik ve mükemmel ODS çıkışı sağlar.
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="ÇALIŞMA SAYFASI\'nı e-tablodan ODS formatına aktarmak için REST API\'i kullanan Android\'deki kod örneği" gistPath="" %}}
