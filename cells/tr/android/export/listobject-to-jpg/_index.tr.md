---
title: Android için Cells Cloud SDK'yı kullanarak LISTOBJECT'i Excel'den JPG'ye aktarın
description:  Aspose.Cells Cloud REST API, {2} kullanılarak {0} dosyasının {1} biçimindeki dosyaların dışa aktarılmasını destekler.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="LISTOBJECT\'i Excel\'den JPG\'ye aktar" h2="LISTOBJECT\'i JPG dosyasına aktarmak için Android kütüphanesi" p="Android\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Android kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i JPG formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-jpg/" >}}
