---
title: Oranları XLSX dosyasına aktar via Android
...
url: /tr/android/export/ods-to-xlsx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODS\'yi Bulutta XLSX dosyasına aktarın" h2="Excel & Android için açık kaynaklı Cloud SDK ile OpenOffice e-tablo dışa aktarımı" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" Android için Cloud SDK\'da ODS\'yi XLSX dosyasına aktarma" %}}
...
{{% blocks/products/pf/agp/code-autogen title="ODS\'den XLSX\'e Dönüşüm için Android Kodu" gistPath="" %}}
```java
