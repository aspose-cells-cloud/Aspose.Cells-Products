---
title:  Android API kullanarak ÇALIŞMA KİTABI'nı e-tablodan WMF'ye aktarın
...
url: /tr/android/export/workbook-to-wmf/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="ÇALIŞMA KİTABI\'nı WMF dosyasına aktarmak için Android API" h2="ÇALIŞMA KİTABI\'nı WMF dosyasına aktarmak için Android kitaplığı" p="Android\'de elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Android kullanarak ÇALIŞMA KİTABI\'nı e-tablodan WMF formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-wmf/" >}}
