---
title:  Android için Excel Uygulamaları Oluşturmak için REST API
description:  Bulut tabanlı Excel ve OpenOffice elektronik tabloları oluşturmak, çalışma sayfalarını birleştirmek, bölmek, görüntülemek, şifrelemek ve dönüştürmek için Android REST SDK
weight: 20
url: /tr/android
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Elektronik Tablo İşleme Android Uygulamaları Oluşturun via REST API" h2="Bulut tabanlı Excel ve OpenOffice elektronik tabloları oluşturmak, uygulamaları birleştirmek, bölmek, görüntülemek, şifrelemek ve dönüştürmek için Android REST SDK." logoImageSrc="/headers/aspose_cells-for-android.svg" pfName="Aspose.Cells" subTitlepfName="SDK for Android" downloadUrl="" >}}
...
<p>Aspose.Cells Android için Bulut SDK'sı, Android cihazlar için Microsoft Excel (XLS, XLSX, XLSB, XLSM, XLT, XLTX, XLTM) ve OpenOffice (ODS) Elektronik tablo işleme uygulamalarını geliştirmenize yardımcı olur. Aspose.Cells Android için Bulut SDK'sı, bir MIT lisansı altında sunulur ve Aspose.Cells REST API'i temel alır.</p>
<p>Aspose.Cells Android için Bulut SDK'sı, Android kodunuzun bulut e-tablo belgelerine erişmesini ve çalışma kitaplarını, çalışma sayfalarını, tek tek hücreleri, satırları ve sütunları işlemesini sağlar. Android programınız, çalışma sayfası resimlerinden barkodları çıkarabilecek, otomatik filtreler uygulayabilecek (tarih filtresi, simge filtresi, dinamik filtre), grafiklere erişebilecek, koşullu biçimlendirme uygulayabilecek ve elektronik tablo sayfası kurulumunu programlı olarak yapılandırabilecektir.</p>
<p>Aspose.Cells Android için Bulut SDK'sı, herhangi bir üçüncü taraf yazılımı yüklemeden OleObjects, ListObjects, pivot tablolar, aralıklar, şekiller ve Excel ve ODS çalışma sayfalarındaki görevlerle çalışmanıza olanak tanır.</p>
<p>Aspose.Cells Android için Cloud SDK, Microsoft Excel, OpenOffice, SpreadsheetML, CSV, TSV, TXT (TabDelimited), HTML, MHTML, SXC, FODS'yi dönüştürmeye izin verdiği için Android tabanlı mobil cihazlar için elektronik tablo dönüştürücü uygulamaları oluşturmanıza da yardımcı olabilir. PDF, XPS, TIFF, SVG, DIF ve MD (Markdown) gibi diğer desteklenen biçimler.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-android.svg" alt="Android SDK to manipulate Spreadsheets"><header>Aspose.Cells</header><footer> Bulut<small> <em> için</em> </small>Android</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_cells-for-android.svg" alt="Spreadsheet manipulation via Android"><header>Aspose.Cells</header><footer> Bulut<small> <em> için</em> </small>Android</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Gelişmiş Elektronik Tablo düzenleme Özellikleri
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Çalışma sayfasından belirli veya tüm OleObject'leri silin
 ...
 Excel Elektronik Tablo İşleme SDK'sını Kullanmaya Başlayın
    ...
    <p>
 Android için Aspose.Cells Cloud SDK'yı kullanmaya başlamak için herhangi bir şey yüklemeniz gerekmez. Tek yapmanız gereken bir hesap oluşturmak
     <a href="https://dashboard.aspose.cloud/#/apps">
 Bulut için Aspose
     </a>
ve uygulama bilgilerinizi alın. Uygulama SID'sine sahip olduğunuzda &amp; anahtarıyla, REST API'lerini destekleyen herhangi bir platformda Aspose.Cells Cloud SDK for Android'i kullanmaya hazırsınız. Aspose.Cells Android için Cloud SDK size e-tablo oluşturmanız, düzenlemeniz ve dönüştürmeniz için gereken tüm özellikleri sağlar. Ayrıca, daha fazla işleme veya depolama için elektronik tablolardan veri çıkarmanıza olanak tanır.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Android için neden Aspose.Cells Bulut SDK?" tabId="success-stories" >}}
