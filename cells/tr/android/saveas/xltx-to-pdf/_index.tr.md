...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLTX\'i PDF olarak kaydet" h2="XLTX\'i PDF olarak kaydetmek için Android kitaplığı" p="Android\'de özelleştirilmiş e-tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, XLTX\'i PDF ve diğer belge formatlarını Android kullanarak çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xltx-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="XLTX dosyasını Android\'de PDF olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API\'i kullanarak XLTX\'i PDF olarak kaydetmek için Android Kod Örneği" gistPath="" %}}
