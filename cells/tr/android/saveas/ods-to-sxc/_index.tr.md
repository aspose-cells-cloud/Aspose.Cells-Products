...
{{< blocks/products/cells/cells-cloud-upper-banner h1="ODS\'yi SXC olarak kaydet" h2="ODS\'yi SXC olarak kaydetmek için Android kitaplığı" p="Android\'de özelleştirilmiş e-tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, Android\'i kullanarak ODS\'yi çevrimiçi olarak SXC ve diğer belge formatları olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/ods-to-sxc/" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak ODS\'yi SXC olarak kaydetmek için Android Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer ODS formatlarını SXC olarak kaydetmek için Android için Cells Cloud SDK nasıl kullanılır?" >}}
