...
{{< blocks/products/cells/cells-cloud-section title="Android\'de bir XLT dosyasını JSON olarak kaydetme" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="REST API\'i kullanarak XLT\'yi JSON olarak kaydetmek için Android Kod Örneği" gistPath="" %}}
