---
title:  Android için MHTML'yi ODS API olarak kaydedin
description: MHTML biçim dosyasını ODS biçim dosyası olarak kaydetmek için Aspose.Cells Cloud SDK for Android'i kullanma.
url: /tr/android/saveas/mhtml-to-ods/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="MHTML\'yi ODS olarak kaydetmek için Android API" h2="MHTML\'yi ODS olarak kaydetmek için Android kitaplığı" p="Android\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, Android kullanarak çevrimiçi olarak MHTML\'yi ODS ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/mhtml-to-ods/" >}}
