---
title:  Android kullanarak Excel dosyasını diğer formatlar olarak kaydedin
description:  Aspose.Cells Cloud REST API, Android kullanılarak Excel dosyasının çeşitli formatlarda kaydedilmesini destekler ve birden fazla programlama dili için SDK'lar sunar.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Android kullanarak Excel dosyasını diğer formatlar olarak kaydedin" h2="Aspose.Cells Cloud SDK, çalışma kitaplarının 30\'dan fazla farklı dosya biçiminde kaydedilmesini destekler." p="Aspose.Cells Cloud REST API, Android kullanılarak Excel dosyasının çeşitli formatlarda kaydedilmesini destekler ve birden fazla programlama dili için SDK\'lar sunar." urlsection="saveas/" >}}
...
{{< blocks/products/cells/cells-cloud-card-row title="Android Uzantısı bağlantılarını kullanarak Excel dosyasını diğer formatlarda kaydedin" >}}
