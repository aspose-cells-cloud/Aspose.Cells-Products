...
{{< blocks/products/cells/cells-cloud-upper-banner h1="TXT\'yi XLT olarak kaydet" h2="TXT\'yi XLT olarak kaydetmek için Android kütüphanesi" p="Android\'de özelleştirilmiş e-tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, Android\'i kullanarak TXT\'yi XLT ve diğer belge formatlarını çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/txt-to-xlt/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Android\'de bir TXT dosyasını XLT olarak kaydedin" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="REST API kullanarak TXT\'yi XLT olarak kaydetmek için Android Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer formatlarda TXT olarak XLT olarak kaydetmek için Android için Cells Cloud SDK nasıl kullanılır?" >}}
