...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLS\'yi DIF olarak kaydet" h2="XLS\'yi DIF olarak kaydetmek için Android kitaplığı" p="Android\'de özelleştirilmiş e-tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, XLS\'yi Android kullanarak çevrimiçi olarak DIF ve diğer belge formatları olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xls-to-dif/" >}}
