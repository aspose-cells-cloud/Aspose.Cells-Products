---
title:  MHTML'yi C# için PPTX API olarak kaydedin
description:  MHTML biçim dosyasını PPTX biçim dosyası olarak kaydetmek için C# için Aspose.Cells Cloud SDK'yı kullanma.
url: /tr/net/saveas/mhtml-to-pptx/
---
...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Bir MHTML dosyasını C#\'de PPTX olarak kaydedin" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="MHTML\'yi PPTX formatı olarak kaydetmek için REST API kullanan C#\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="MHTML\'yi PPTX olarak kaydetmek için C# API nasıl kullanılır?" >}}
