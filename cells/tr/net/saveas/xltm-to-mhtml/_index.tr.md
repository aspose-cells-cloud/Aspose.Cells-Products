...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# REST API kullanarak XLTM\'yi MHTML olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak XLTM\'yi MHTML olarak kaydetme." >}}
