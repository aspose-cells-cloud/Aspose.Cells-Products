...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLSX\'i HTML olarak kaydet" h2="XLSX\'i HTML olarak kaydetmek için C# kitaplığı" p="Net\'te özelleştirilmiş elektronik tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, XLSX\'i HTML olarak ve C#\'i kullanarak diğer belge formatlarını çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xlsx-to-html/" >}}

{{< blocks/products/cells/cells-cloud-section title="Bir XLSX dosyasını C#\'e HTML olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# XLSX\'i REST API kullanarak HTML olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak XLSX\'i HTML olarak kaydetme." >}}
