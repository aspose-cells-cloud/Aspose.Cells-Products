...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLSX\'i SQL olarak kaydet" h2="XLSX\'i SQL olarak kaydetmek için C# kitaplığı" p="Net\'te özelleştirilmiş elektronik tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, XLSX\'i C#\'i kullanarak çevrimiçi olarak SQL ve diğer belge formatları olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xlsx-to-sql/" >}}

{{< blocks/products/cells/cells-cloud-section title="XLSX dosyasını C#\'e SQL olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# REST API kullanarak XLSX\'i SQL olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak XLSX\'i SQL olarak kaydetme." >}}
