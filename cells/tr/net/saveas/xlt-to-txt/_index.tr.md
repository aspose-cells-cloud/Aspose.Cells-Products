...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLT\'yi TXT olarak kaydet" h2="XLT\'yi TXT olarak kaydetmek için C# kitaplığı" p="Net\'te özelleştirilmiş elektronik tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, C#\'i kullanarak XLT\'yi TXT ve diğer belge formatlarında çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xlt-to-txt/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak XLT\'yi TXT olarak kaydetme." >}}
