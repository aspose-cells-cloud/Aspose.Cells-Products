...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# REST API kullanarak SXC\'yi XML olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak SXC\'yi XML olarak kaydetme." >}}
