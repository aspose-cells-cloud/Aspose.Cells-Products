...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# REST API kullanarak ODS\'yi XLS olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak ODS\'yi XLS olarak kaydetme." >}}
