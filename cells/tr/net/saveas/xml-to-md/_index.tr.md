---
title:  XML'i C# için MD API olarak kaydedin
description:  Aspose.Cells Cloud SDK for C# kullanılarak XML biçim dosyasını MD biçim dosyası olarak kaydedin.
url: /tr/net/saveas/xml-to-md/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="XML\'i MD olarak kaydetmek için C# API" h2="XML\'i MD olarak kaydetmek için C# kitaplığı" p="Net\'te özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, XML\'i C# kullanarak çevrimiçi olarak MD ve diğer belge biçimleri olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xml-to-md/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XML\'i MD olarak kaydetmek için C# API nasıl kullanılır?" >}}
