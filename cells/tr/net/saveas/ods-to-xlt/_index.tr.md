...
---
{{< blocks/products/cells/cells-cloud-banner h1="ODS\'yi XLT olarak kaydet" h2="ODS\'yi XLT olarak kaydetmek için C# kitaplığı" p="Net\'te özelleştirilmiş elektronik tablo iş akışları oluşturmak için SaveAs API / Cells Cloud\'u kullanın. Bu, C# numaralı telefonu kullanarak ODS\'yi XLT ve diğer belge formatlarında çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/ods-to-xlt/" >}}

{{< blocks/products/cells/cells-cloud-section title="Bir ODS dosyasını C#\'e XLT olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="C# REST API kullanarak ODS\'yi XLT olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Net kitaplığını kullanarak ODS\'yi XLT olarak nasıl kaydedeceğinizi öğrenin." >}}
