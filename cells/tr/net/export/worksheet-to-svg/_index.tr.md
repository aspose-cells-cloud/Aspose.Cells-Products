...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="C# için Cells Cloud SDK\'yı kullanarak ÇALIŞMA SAYFASI nesnesini SVG biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="WORKSHEET\'i e-tablodan SVG formatına aktarmak için REST API\'i kullanan C#\'deki kod örneği" gistPath="" %}}
