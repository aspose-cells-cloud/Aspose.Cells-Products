...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA SAYFASINI Excel\'den JSON\'a aktar" h2="WORKSHEET\'i JSON dosyasına aktarmak için C# kitaplığı" p="Net\'te Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, C# numaralı telefonu kullanarak çevrimiçi elektronik tablodan ÇALIŞMA SAYFASI\'nı JSON formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-json/" >}}

{{< blocks/products/cells/cells-cloud-section title="C# için Cells Cloud SDK\'yı kullanarak WORKSHEET nesnesini JSON biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="WORKSHEET\'i e-tablodan JSON formatına aktarmak için REST API\'i kullanan C#\'deki kod örneği" gistPath="" %}}
