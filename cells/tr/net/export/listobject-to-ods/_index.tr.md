---
title: C# API kullanarak LISTOBJECT'i e-tablodan ODS'ye aktarın
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i elektronik tablodan ODS formatına dışa aktarmak için REST API kullanan C#\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="LISTOBJECT\'i ODS\'ye dışa aktarmak için C# API nasıl kullanılır?" >}}
