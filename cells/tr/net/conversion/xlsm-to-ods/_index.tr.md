---
title:  XLSM'den ODS'ye Dönüştürme API için C#
description:  XLSM biçim dosyasını ODS biçim dosyasına dönüştürmek için C# için Aspose.Cells Cloud SDK'yı kullanma.
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="XLSM\'yi ODS formatına dönüştürmek için REST API kullanan C#\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="XLSM\'yi ODS\'ye dönüştürmek için C# API nasıl kullanılır?" >}}
