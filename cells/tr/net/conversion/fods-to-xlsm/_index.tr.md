---
title:  FODS'yi XLSM'ye dönüştür via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi XLSM\'ye Dönüştürün" h2="Excel ve açık kaynaklı Cloud SDK for .NET ile OpenOffice elektronik tablo dönüştürme" >}}
...
1. Ortaya çıkan XLSM dosyasını almak için ```CellsApi.CellsSaveAsPostDocumentSaveAs``` yöntemini arayın
