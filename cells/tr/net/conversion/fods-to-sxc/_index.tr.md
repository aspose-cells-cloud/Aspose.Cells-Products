---
title:  FODS'yi SXC'ye dönüştür via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Bulutta SXC\'ye Dönüştürün" h2="Excel ve açık kaynaklı Cloud SDK for .NET ile OpenOffice elektronik tablo dönüştürme" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET Uygulamalarında FODS\'den SXC\'ye Dönüştürme" %}}
...
1. Ortaya çıkan SXC dosyasını almak için ```CellsApi.CellsSaveAsPostDocumentSaveAs``` yöntemini çağırın
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET FODS\'den SXC\'ye Dönüşüm Kodu" gistPath="" %}}
```cs
