---
title: FODS'yi TXT'ye dönüştürün via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Bulutta FODS\'yi TXT\'ye dönüştürün" h2="Excel ve açık kaynak Cloud SDK ile OpenOffice elektronik tablo dönüşümü for .NET" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET Uygulamalarında FODS\'den TXT\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET FODS\'den TXT\'ye Dönüşüm Kodu" gistPath="" %}}
```cs
