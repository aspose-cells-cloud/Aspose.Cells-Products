---
title:  FODS'yi CSV'ye dönüştür via .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Bulutta CSV\'ye Dönüştürün" h2="Excel ve açık kaynaklı Cloud SDK for .NET ile OpenOffice elektronik tablo dönüştürme" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# .NET FODS\'den CSV\'ye Dönüşüm Kodu" gistPath="" %}}
```cs
