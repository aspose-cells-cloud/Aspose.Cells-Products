---
title:  CSV'yi Python için XLT API olarak kaydedin
description:  CSV biçimli dosyayı XLT biçimli dosya olarak kaydetmek için Aspose.Cells Cloud SDK for Python'i kullanma.
url: /tr/python/saveas/csv-to-xlt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="CSV\'yi XLT olarak kaydetmek için Python API" h2="CSV\'yi XLT olarak kaydetmek için Python kitaplığı" p="Python\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells SaveAs REST API\'i kullanın. Bu, Python\'i kullanarak CSV\'yi XLT ve diğer belge formatlarını çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/csv-to-xlt/" >}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="CSV\'yi XLT olarak kaydetmek için Python API nasıl kullanılır?" >}}
