...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python REST API\'i kullanarak NUMBERS\'ı XML olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını XML olarak NUMBERS diğer formatlarda kaydetmek için Python için Cells Cloud SDK nasıl kullanılır?" >}}
