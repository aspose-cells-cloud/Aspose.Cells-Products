...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python XML\'i REST kullanarak DOCX olarak kaydetmek için Kod Örneği API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer formatlarda XML olarak DOCX olarak kaydetmek için Python için Cells Cloud SDK nasıl kullanılır?" >}}
