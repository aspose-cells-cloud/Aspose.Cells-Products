...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python XML\'i REST kullanarak XLTX olarak kaydetmek için Kod Örneği API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer XML formatları olarak XLTX olarak kaydetmek için Python için Cells Cloud SDK nasıl kullanılır?" >}}
