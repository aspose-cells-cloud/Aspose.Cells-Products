...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python REST API kullanarak XML\'i XLSM olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer XML formatları olarak XLSM olarak kaydetmek için Python için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
