...
{{< blocks/products/cells/cells-cloud-section title="Bir XLT dosyasını Python\'e JSON olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python XLT\'yi REST API kullanarak JSON olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Python kitaplığını kullanarak XLT\'yi JSON olarak nasıl kaydedeceğinizi öğrenin." >}}
