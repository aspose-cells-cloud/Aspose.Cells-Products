...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python XLTX\'i REST kullanarak XML olarak kaydetmek için Kod Örneği API" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Python kitaplığını kullanarak XLTX\'i XML olarak kaydetme." >}}
