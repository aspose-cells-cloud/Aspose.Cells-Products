...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python XLTX\'i REST API kullanarak XLSX olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Python kitaplığını kullanarak XLTX\'i XLSX olarak nasıl kaydedeceğinizi öğrenin." >}}
