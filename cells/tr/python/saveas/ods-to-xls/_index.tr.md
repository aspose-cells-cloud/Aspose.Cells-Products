...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python REST API kullanarak ODS\'yi XLS olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Python kitaplığını kullanarak ODS\'yi XLS olarak kaydetme." >}}
