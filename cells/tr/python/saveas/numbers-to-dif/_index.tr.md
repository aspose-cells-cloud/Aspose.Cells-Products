...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python REST API kullanarak NUMARALARI DIF olarak kaydetmeye yönelik Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Bulut Python kitaplığını kullanarak NUMBERS\'ı DIF olarak nasıl kaydedeceğinizi öğrenin." >}}
