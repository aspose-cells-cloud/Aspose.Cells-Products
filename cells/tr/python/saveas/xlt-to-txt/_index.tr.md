...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python REST API\'i kullanarak XLT\'yi TXT olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer formatlardaki XLT\'yi TXT olarak kaydetmek için Python için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
