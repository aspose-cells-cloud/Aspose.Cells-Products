...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python XLTM\'yi REST API kullanarak PDF olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer XLTM formatlarında PDF olarak kaydetmek için Python için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
