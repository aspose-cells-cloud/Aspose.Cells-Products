...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python XLT\'yi REST kullanarak JPG olarak kaydetmek için Kod Örneği API" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını JPG olarak diğer XLT formatlarında kaydetmek için Python için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
