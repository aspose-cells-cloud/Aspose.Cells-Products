...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Python JSON\'u REST API kullanarak SXC olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Python kitaplığını kullanarak JSON\'u SXC olarak nasıl kaydedeceğinizi öğrenin." >}}
