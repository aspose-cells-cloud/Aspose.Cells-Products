...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Python ile FODS\'yi MD\'ye dönüştürün" h2="Excel için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Python ile FODS\'den MD\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS\'den MD\'ye Dönüşüm Kodu" gistPath="" %}}
```python
