---
title:  Excel FODS'i TXT'ye dönüştür via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Python ile FODS\'yi TXT\'ye dönüştürün" h2="Excel için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS\'den TXT\'ye Dönüştürme Kodu" gistPath="" %}}
```python
