...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Python ile FODS\'yi ODS\'ye dönüştürün" h2="Excel için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer biçimlere aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Python ile FODS\'den ODS\'ye Dönüşüm" %}}
...
1. Ortaya çıkan ODS dosyasını almak için ```CellsApi.cells_save_as_post_document_save_as``` yöntemini arayın
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS\'den ODS\'ye Dönüşüm Kodu" gistPath="" %}}
```python
