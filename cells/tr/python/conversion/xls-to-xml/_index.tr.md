...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Python Cells Cloud SDK\'yı kullanarak XLS\'yi XML\'e dönüştürmek için Kod Örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Excel dosyalarını diğer formatlara XLS\'den XML\'e dönüştürmek için Python için Cells Bulut SDK\'sı nasıl kullanılır?" >}}
