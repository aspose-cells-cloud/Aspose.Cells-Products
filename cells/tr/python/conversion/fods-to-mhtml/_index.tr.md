---
title:  Excel FODS'yi MHTML'ye dönüştürün via Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Python ile FODS\'yi MHTML\'ye dönüştürün" h2="Python için açık kaynaklı Cloud SDK ile Excel verilerini okuyun, düzenleyin ve diğer formatlara aktarın" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Python FODS\'den MHTML\'ye Dönüştürme Kodu" gistPath="" %}}
```python
