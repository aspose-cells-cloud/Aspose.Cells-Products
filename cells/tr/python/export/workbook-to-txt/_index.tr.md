---
title:  Python için Cells Cloud SDK'yı kullanarak ÇALIŞMA KİTABI'nı Excel'den TXT'ye aktarın
...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA KİTABI\'nı Excel\'den TXT\'ye aktar" h2="ÇALIŞMA KİTABI\'nı TXT dosyasına aktarmak için Python kitaplığı" p="Python\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Python\'i kullanarak çevrimiçi tablodan ÇALIŞMA KİTAPÇIĞINI TXT formatındaki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-txt/" >}}

{{< blocks/products/cells/cells-cloud-section title="Python için Cells Cloud SDK\'yı kullanarak WORKBOOK nesnesini TXT formatındaki dosyaya aktarın" >}}
{{% blocks/products/cells/cells-cloud-api-reference apiurl="https://api.aspose.cloud/v3.0/cells/export" apireferenceurl="https://apireference.aspose.cloud/cells/#/LightCells/PostExport" apimethod="POST" %}}
<br/>
WORKBOOK nesnesini Excel dosyasından TXT dosyasına aktarmak karmaşık bir iştir. ÇALIŞMA KİTABI'nı TXT'ye aktarma format geçişleri Python SDK'mız tarafından gerçekleştirilir ve aynı zamanda kaynak ÇALIŞMA KİTABI e-tablosunun ana yapısal ve mantıksal içeriği korunur. Python kitaplığımız, ÇALIŞMA KİTABI nesnelerini çevrimiçi olarak TXT formatındaki dosyalara aktarmak için profesyonel bir çözümdür. Bu Bulut SDK, Python geliştiriciye güçlü işlevsellik ve mükemmel TXT çıkışı sağlar.

{{< /blocks/products/cells/cells-cloud-section >}}

{{% blocks/products/cells/cells-cloud-noreplacecode title="ÇALIŞMA KİTABI\'nı e-tablodan TXT formatına aktarmak için REST API\'i kullanan Python\'deki kod örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Nesneleri Excel WORKBOOK\'tan TXT\'ye aktarmak için Python için Cells Cloud SDK nasıl kullanılır?" >}}
