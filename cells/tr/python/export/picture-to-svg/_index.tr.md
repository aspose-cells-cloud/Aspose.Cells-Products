...
{{< blocks/products/cells/cells-cloud-section isGrey="true" title="Python için Cells Bulut SDK\'sını kullanarak PICTURE nesnesini SVG biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="RESİM\'i e-tablodan SVG formatına aktarmak için REST API\'i kullanan Python\'deki kod örneği" gistPath="" %}}
