---
title: Excel dosyalarını diğer formatlara dönüştür.
description: Aspose.Cells Cloud, karmaşıklığıyla bilinen Excel dosya formatı dönüşümüne kapsamlı destek sağlar. Aspose.Cells Cloud, Excel, Pdf, Markdown, Json, XML, Csv, Html ve daha fazlası dahil olmak üzere 30+ dosya formatını destekler.
kwords: aspose hücreleri
url: /tr/java/export-worksheet-as-format/
---
