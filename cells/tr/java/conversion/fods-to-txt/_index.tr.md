---
title:  Bulutta FODS'yi TXT'ye dönüştürün via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile FODS\'yi TXT\'ye dönüştürün" h2="Açık kaynak Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Basit FODS\'den TXT\'ye Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi TXT\'ye Dönüştürme Kodu" gistPath="" %}}
```java
