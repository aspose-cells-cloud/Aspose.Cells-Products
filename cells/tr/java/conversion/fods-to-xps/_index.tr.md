---
title:  FODS'yi Bulutta XPS'e dönüştürün via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile FODS\'yi XPS\'e dönüştür" h2="Açık kaynaklı Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Basit FODS - XPS Dönüşümü" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi XPS\'e Dönüştürmek İçin Kod" gistPath="" %}}
```java
