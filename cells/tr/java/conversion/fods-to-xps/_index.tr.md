...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Java ile XPS\'e dönüştürün" h2="Açık kaynak Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Basit FODS\'den XPS\'e Dönüşüm" %}}
...
1. Ortaya çıkan XPS dosyasını almak için ```CellsApi.cellsWorkbookGetWorkbook```'i arayın
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi XPS\'e Dönüştürme Kodu" gistPath="" %}}
```java
