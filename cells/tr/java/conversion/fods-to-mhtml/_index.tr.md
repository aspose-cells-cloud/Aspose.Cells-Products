...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile FODS\'yi MHTML\'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi MHTML\'ye Dönüştürmek İçin Kod" gistPath="" %}}
```java
