---
title:  FODS'yi Bulutta HTML'e dönüştürün via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile FODS\'yi HTML\'e dönüştür" h2="Açık kaynaklı Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Basit FODS - HTML Dönüşümü" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi HTML\'e Dönüştürmek İçin Kod" gistPath="" %}}
```java
