---
title:  FODS'yi Bulutta XML'e dönüştürün via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="FODS\'yi Java ile XML\'e dönüştürün" h2="Açık kaynak Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Basit FODS\'den XML\'e Dönüşüm" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi XML\'e Dönüştürme Kodu" gistPath="" %}}
```java
