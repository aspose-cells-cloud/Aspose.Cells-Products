...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile FODS\'yi SXC\'ye dönüştürün" h2="Açık kaynak Cloud SDK for Java ile Excel ve OpenOffice dosya dönüştürmeyi otomatikleştirin" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Java FODS\'yi SXC\'ye Dönüştürme Kodu" gistPath="" %}}
```java
