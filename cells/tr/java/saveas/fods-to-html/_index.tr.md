...
---
{{< blocks/products/cells/cells-cloud-banner h1="FODS\'yi HTML olarak kaydet" h2="FODS\'yi HTML olarak kaydetmek için Java kütüphanesi" p="Java\'de özelleştirilmiş e-tablo iş akışları oluşturmak için Cells Bulut\'un API\'ini Kaydet\'i kullanın. Bu, FODS\'yi HTML olarak ve Java\'i kullanarak diğer belge formatlarını çevrimiçi olarak kaydetmek için profesyonel bir çözümdür." urlsection="saveas/fods-to-html/" >}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Java kitaplığını kullanarak FODS\'yi HTML olarak nasıl kaydedeceğinizi öğrenin." >}}
