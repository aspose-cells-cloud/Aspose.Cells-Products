...
{{< blocks/products/cells/cells-cloud-section title="Bir GIF dosyasını Java\'de JSON olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java REST API kullanarak GIF\'i JSON olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Java kitaplığını kullanarak GIF\'i JSON olarak kaydetme." >}}
