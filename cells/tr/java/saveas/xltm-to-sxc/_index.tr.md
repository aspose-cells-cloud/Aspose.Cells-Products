...
---
{{< blocks/products/cells/cells-cloud-banner h1="XLTM\'yi SXC olarak kaydet" h2="XLTM\'yi SXC olarak kaydetmek için Java kütüphane" p="Java\'de özelleştirilmiş elektronik tablo iş akışları oluşturmak için Cells Bulut\'un API\'ini Kaydet\'i kullanın. Bu, Java\'i kullanarak XLTM\'yi SXC ve diğer belge formatları olarak çevrimiçi kaydetmek için profesyonel bir çözümdür." urlsection="saveas/xltm-to-sxc/" >}}

{{< blocks/products/cells/cells-cloud-section title="Bir XLTM dosyasını Java\'e SXC olarak kaydedin" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="Java XLTM\'yi REST API kullanarak SXC olarak kaydetmek için Kod Örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Cells Cloud Java kitaplığını kullanarak XLTM\'yi SXC olarak kaydetme." >}}
