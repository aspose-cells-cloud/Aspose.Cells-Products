---
title:  Java API kullanarak LISTOBJECT'i e-tablodan PPTX'e aktarın
...
url: /tr/java/export/listobject-to-pptx/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="LISTOBJECT\'i PPTX dosyasına dışa aktarmak için Java API" h2="LISTOBJECT\'i PPTX dosyasına dışa aktarmak için Java kitaplığı" p="Java\'deki elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Java kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i PPTX formatına dışa aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-pptx/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="LISTOBJECT nesnesini Java\'de PPTX format dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i e-tablodan PPTX formatına dışa aktarmak için REST API kullanan Java\'deki kod örneği" gistPath="" %}}
