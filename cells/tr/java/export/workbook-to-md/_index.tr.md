...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA KİTABI\'nı Excel\'den MD\'ye aktar" h2="Java ÇALIŞMA KİTABI\'nı MD dosyasına aktarmak için kütüphane" p="Java\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Java\'i kullanarak çevrimiçi tablodan ÇALIŞMA KİTAPÇIĞINI MD biçimindeki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/workbook-to-md/" >}}

{{< blocks/products/cells/cells-cloud-section title="Cells Cloud SDK for Java\'i kullanarak ÇALIŞMA KİTABI nesnesini MD formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="ÇALIŞMA KİTABI\'nı e-tablodan MD formatına aktarmak için REST API\'i kullanan Java\'deki kod örneği" gistPath="" %}}
