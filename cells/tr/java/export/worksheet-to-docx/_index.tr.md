...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA SAYFASINI Excel\'den DOCX\'e aktar" h2="Java WORKSHEET\'i DOCX dosyasına aktarmak için kütüphane" p="Java\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Java\'i kullanarak çevrimiçi elektronik tablodan ÇALIŞMA SAYFASI\'nı DOCX formatındaki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-docx/" >}}

{{< blocks/products/cells/cells-cloud-section title="WORKSHEET nesnesini Cells Cloud SDK for Java kullanarak DOCX formatındaki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="WORKSHEET\'i e-tablodan DOCX formatına aktarmak için REST API\'i kullanan Java\'deki kod örneği" gistPath="" %}}
