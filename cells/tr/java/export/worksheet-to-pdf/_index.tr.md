...
---
{{< blocks/products/cells/cells-cloud-banner h1="ÇALIŞMA SAYFASINI Excel\'den PDF\'e aktar" h2="ÇALIŞMA SAYFASI\'nı PDF dosyasına aktarmak için Java kitaplığı" p="Java\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Java\'i kullanarak çevrimiçi elektronik tablodan ÇALIŞMA SAYFASINI PDF biçimindeki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-pdf/" >}}

{{< blocks/products/cells/cells-cloud-section title="WORKSHEET nesnesini Cells Cloud SDK for Java\'i kullanarak PDF biçimli dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="WORKSHEET\'i e-tablodan PDF formatına aktarmak için REST API\'i kullanan Java\'deki kod örneği" gistPath="" %}}
...
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="Nesneleri Excel ÇALIŞMA SAYFASI\'ndan PDF\'e aktarmak için Cells Cloud SDK for Java nasıl kullanılır?" >}}
