---
title:  Java API kullanarak LISTOBJECT'i e-tablodan JSON'a aktarın
...
url: /tr/java/export/listobject-to-json/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="LISTOBJECT\'i JSON dosyasına dışa aktarmak için Java API" h2="LISTOBJECT\'i JSON dosyasına dışa aktarmak için Java kitaplığı" p="Java\'deki e-tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Java kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i JSON biçimindeki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-json/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="LISTOBJECT nesnesini Java\'deki JSON biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i e-tablodan JSON biçimine dışa aktarmak için REST API kullanan Java\'deki kod örneği" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true" title="LISTOBJECT\'i JSON\'a dışa aktarmak için Java API nasıl kullanılır?" >}}
