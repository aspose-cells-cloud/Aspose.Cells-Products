---
title:  Java API kullanarak LISTOBJECT'i e-tablodan MD'ye aktarın
...
url: /tr/java/export/listobject-to-md/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API, LISTOBJECT\'i MD dosyasına aktarmak için" h2="LISTOBJECT\'i MD dosyasına dışa aktarmak için Java kitaplığı" p="Java\'deki elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Java kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i MD formatındaki dosyaya aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-md/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="LISTOBJECT nesnesini Java\'de MD biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i e-tablodan MD biçimine dışa aktarmak için REST API kullanan Java\'deki kod örneği" gistPath="" %}}
