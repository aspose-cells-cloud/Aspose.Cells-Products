---
title:  Java API kullanarak ÇALIŞMA TABLOSUNU e-tablodan GIF'e aktarın
...
url: /tr/java/export/worksheet-to-gif/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API ÇALIŞMA TABLOSUNU GIF dosyasına aktarmak için" h2="Java kitaplığı, ÇALIŞMA TABLOSUNU GIF dosyasına dışa aktarmak için" p="Java\'deki elektronik tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Java\'i kullanarak ÇALIŞMA TABLOSUNU çevrimiçi elektronik tablodan GIF formatındaki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/worksheet-to-gif/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="WORKSHEET nesnesini Java\'de GIF formatındaki dosyaya aktarın" >}}
