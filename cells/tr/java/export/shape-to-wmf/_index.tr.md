...
---
{{< blocks/products/cells/cells-cloud-banner h1="SHAPE\'i Excel\'den WMF\'ye aktar" h2="SHAPE\'i WMF dosyasına aktarmak için Java kitaplığı" p="Java\'de Excel dosya dahili nesne iş akışlarını dışa aktarmak için Cells Bulut\'un API\'ini Dışa Aktar\'ı kullanın. Bu, Java\'i kullanarak çevrimiçi olarak elektronik tablodan SHAPE\'i WMF formatındaki dosyaya dışa aktarmak için profesyonel bir çözümdür." urlsection="export/shape-to-wmf/" >}}

{{< blocks/products/cells/cells-cloud-section title="Cells Cloud SDK for Java\'i kullanarak SHAPE nesnesini WMF biçimindeki dosyaya aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="SHAPE\'i e-tablodan WMF formatına aktarmak için REST API\'i kullanan Java\'deki kod örneği" gistPath="" %}}
