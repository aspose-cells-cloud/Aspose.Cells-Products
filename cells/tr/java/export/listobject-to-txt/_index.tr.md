---
title:  Java API kullanarak LISTOBJECT'i e-tablodan TXT'ye aktarın
...
url: /tr/java/export/listobject-to-txt/
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/cells/cells-cloud-upper-banner h1="LISTOBJECT\'i TXT dosyasına aktarmak için Java API" h2="LISTOBJECT\'i TXT dosyasına dışa aktarmak için Java kitaplığı" p="Java\'deki e-tablo dahili nesne iş akışlarını dışa aktarmak için Cells Export REST API\'i kullanın. Bu, Java kullanarak çevrimiçi elektronik tablodan LISTOBJECT\'i TXT formatına dışa aktarmak için profesyonel bir çözümdür." urlsection="export/listobject-to-txt/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true" title="LISTOBJECT nesnesini Java\'deki TXT biçim dosyasına aktarın" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="LISTOBJECT\'i e-tablodan TXT biçimine dışa aktarmak için REST API kullanan Java\'deki kod örneği" gistPath="" %}}
