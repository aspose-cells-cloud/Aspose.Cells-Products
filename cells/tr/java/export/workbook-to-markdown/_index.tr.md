...
{{< blocks/products/cells/cells-cloud-section title="Cells Cloud SDK for Java\'i kullanarak WORKBOOK nesnesini MARKDOWN format dosyasına aktarın" >}}
...
{{% blocks/products/cells/cells-cloud-noreplacecode title="ÇALIŞMA KİTABI\'nı e-tablodan MARKDOWN formatına aktarmak için REST API\'i kullanan Java\'deki kod örneği" gistPath="" %}}
