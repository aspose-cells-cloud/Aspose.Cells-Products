---
title:  Bulutta E-tablolar oluşturun (cURL via REST API'i kullanarak)
...
{{< blocks/products/pf/i18n/upper-banner h1="İşleme Excel Bulutta Sayfalar via cURL" h2="İşlenmek üzere bulut depolama alanından Microsoft Excel ve OpenOffice dosyalarına erişen Elektronik Tablo oluşturucu ve dönüştürücü uygulamalar oluşturmak için cURL komutlarını kullanın." logoImageSrc="/headers/aspose_cells-for-curl.svg" pfName="Aspose.Cells" subTitlepfName="Cloud for cURL" downloadUrl="" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Neden cURL yerine Aspose.Cells Bulut?" tabId="success-stories" >}}
