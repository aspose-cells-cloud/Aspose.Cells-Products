...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Clear shapes on the local workbook in Cloud" h2="Excel & OpenOffice spreadsheet Clear shapes by open-source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Clear shapes on local spreadsheet by Cloud SDK for Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java code for clearing shapes on local spreadsheets" gistPath="https://gist.github.com/aspose-cells-cloud-gists/c59aa5c02f735466a5e34751cee73f5f.js?file=Example-Clear-Shape.java" %}}
