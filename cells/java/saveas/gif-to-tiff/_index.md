...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save GIF as TIFF" h2="Java library to save GIF as TIFF" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save GIF as TIFF and other document formats online using Java." urlsection="saveas/gif-to-tiff/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a GIF file as TIFF in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save GIF as TIFF format" gistPath="" %}}
