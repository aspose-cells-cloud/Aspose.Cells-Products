---
title: Save XLTM as HTML API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save XLTM as HTML" h2="Java library to save XLTM as HTML" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save XLTM as HTML and other document formats online using Java." urlsection="saveas/xltm-to-html/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a XLTM file as HTML in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save XLTM as HTML format" gistPath="" %}}
