---
title: Save XLT as XLSB API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save XLT as XLSB" h2="Java library to save XLT as XLSB" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save XLT as XLSB and other document formats online using Java." urlsection="saveas/xlt-to-xlsb/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a XLT file as XLSB in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save XLT as XLSB format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Java API to save  XLT as XLSB" >}}
