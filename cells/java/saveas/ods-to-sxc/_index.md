---
title: Save ODS as SXC API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save ODS as SXC" h2="Java library to save ODS as SXC" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save ODS as SXC and other document formats online using Java." urlsection="saveas/ods-to-sxc/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a ODS file as SXC in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save ODS as SXC format" gistPath="" %}}
