---
title: Save XLSX as FODS API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save XLSX as FODS" h2="Java library to save XLSX as FODS" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save XLSX as FODS and other document formats online using Java." urlsection="saveas/xlsx-to-fods/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a XLSX file as FODS in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save XLSX as FODS format" gistPath="" %}}
