---
title: Save SXC as XML API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save SXC as XML" h2="Java library to save SXC as XML" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save SXC as XML and other document formats online using Java." urlsection="saveas/sxc-to-xml/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a SXC file as XML in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save SXC as XML format" gistPath="" %}}
