---
title: Save MHTML as SQL API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save MHTML as SQL" h2="Java library to save MHTML as SQL" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save MHTML as SQL and other document formats online using Java." urlsection="saveas/mhtml-to-sql/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a MHTML file as SQL in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save MHTML as SQL format" gistPath="" %}}
...
<br/>
<br/>
{{< blocks/products/cells/cells-cloud-section-list isGrey="true"  title="How to use Java API to save  MHTML as SQL" >}}
