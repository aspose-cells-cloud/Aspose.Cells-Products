---
title: Save XLSB as CSV API for Java 
...
{{< blocks/products/cells/cells-cloud-upper-banner h1="Java API to save XLSB as CSV" h2="Java library to save XLSB as CSV" p="Use Cells SaveAs REST API to create customized spreadsheet workflows in Java. This is a professional solution to save XLSB as CSV and other document formats online using Java." urlsection="saveas/xlsb-to-csv/" >}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/cells/cells-cloud-section isGrey="true"  title="Save a XLSB file as CSV in Java" >}}
...
<br/>
<br/>
{{% blocks/products/cells/cells-cloud-code-div title="Code example in Java using REST API to save XLSB as CSV format" gistPath="" %}}
