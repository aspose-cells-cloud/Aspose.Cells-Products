---
title: Convert MHTML to XLSX in the Cloud via Java 
...
outformat: XLSX
platform: Java
otherformats: HTML TSV MD XLSB SXC PDF DIF FODS XLSX CSV XML XLT XLTM TXT XLSM XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XLSX with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple MHTML to XLSX Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert MHTML to XLSX" gistPath="" %}}
```java
