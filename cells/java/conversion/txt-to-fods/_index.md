---
title: Convert TXT to FODS in the Cloud via Java 
...
outformat: FODS
platform: Java
otherformats: XLSB SXC XLTX CSV XML ODS XLSX HTML TSV DIF XLSM MHTML XLTM TIFF SVG FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to FODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple TXT to FODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert TXT to FODS" gistPath="" %}}
```java
