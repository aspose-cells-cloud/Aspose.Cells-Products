---
title: Convert ODS to XLTX in the Cloud via Java 
...
outformat: XLTX
platform: Java
otherformats: TSV DIF FODS SVG CSV PDF SXC XML XLSM XLTX MHTML TXT XLSX TIFF XLSB MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLTX with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple ODS to XLTX Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert ODS to XLTX" gistPath="" %}}
```java
