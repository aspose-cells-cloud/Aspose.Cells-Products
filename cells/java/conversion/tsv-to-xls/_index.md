---
title: Convert TSV to XLS in the Cloud via Java 
...
outformat: XLS
platform: Java
otherformats: DIF HTML XLT XLS XLTM SVG PDF MHTML TXT CSV XLSM SXC XLSX TIFF MD XML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to XLS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple TSV to XLS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert TSV to XLS" gistPath="" %}}
```java
