---
title: Convert TXT to ODS in the Cloud via Java 
...
outformat: ODS
platform: Java
otherformats: CSV XPS XLTM XLS XML SXC XLTX DIF TIFF HTML TSV XLSM FODS XLSB MHTML XLSX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to ODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple TXT to ODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert TXT to ODS" gistPath="" %}}
```java
