---
title: Convert SXC to XLSM in the Cloud via Java 
...
outformat: XLSM
platform: Java
otherformats: PDF HTML XLTM SVG XLS ODS CSV TSV SXC TXT XML MHTML XPS XLSB XLSM FODS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XLSM with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple SXC to XLSM Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert SXC to XLSM" gistPath="" %}}
```java
