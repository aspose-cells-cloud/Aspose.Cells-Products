---
title: Convert XML to FODS via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to  FODS in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XML to FODS Conversion in Cloud SDK for Java " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for XML to FODS Conversion" gistPath="" %}}
```java
