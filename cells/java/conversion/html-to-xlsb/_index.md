---
title: Convert HTML to XLSB in the Cloud via Java 
...
outformat: XLSB
platform: Java
otherformats: FODS SVG XLT TIFF TSV SXC XLSM PDF DIF XLSB XLSX MD XLTM XML XPS TXT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XLSB with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple HTML to XLSB Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert HTML to XLSB" gistPath="" %}}
```java
