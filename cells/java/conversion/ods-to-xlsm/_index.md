---
title: Convert ODS to XLSM in the Cloud via Java 
...
outformat: XLSM
platform: Java
otherformats: SXC XLSB MHTML FODS TSV XLSM DIF PDF XML XLT CSV XLTM TXT SVG XLSX TIFF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLSM with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple ODS to XLSM Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert ODS to XLSM" gistPath="" %}}
```java
