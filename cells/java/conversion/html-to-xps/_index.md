---
title: Convert HTML to XPS in the Cloud via Java 
...
outformat: XPS
platform: Java
otherformats: XPS ODS XLSB MD PDF DIF TIFF XLTM XLSX XLSM XML FODS CSV XLTX SVG MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XPS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple HTML to XPS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert HTML to XPS" gistPath="" %}}
```java
