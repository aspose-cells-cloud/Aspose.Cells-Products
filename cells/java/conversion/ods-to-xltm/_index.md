---
title: Convert ODS to XLTM in the Cloud via Java 
...
outformat: XLTM
platform: Java
otherformats: TIFF SXC XLTX DIF FODS CSV XLS HTML XML PDF XLSM MHTML TSV MD XLTM XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLTM with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple ODS to XLTM Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert ODS to XLTM" gistPath="" %}}
```java
