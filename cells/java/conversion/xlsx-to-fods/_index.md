---
title: Convert XLSX to FODS in the Cloud via Java 
...
outformat: FODS
platform: Java
otherformats: DIF TSV CSV XLTX SXC XLSM FODS XLSB MHTML XML XLTM PDF TIFF SVG MD XPS 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to FODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple XLSX to FODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert XLSX to FODS" gistPath="" %}}
```java
