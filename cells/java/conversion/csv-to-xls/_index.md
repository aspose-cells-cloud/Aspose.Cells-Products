---
title: Convert CSV to XLS in the Cloud via Java 
...
outformat: XLS
platform: Java
otherformats: DIF FODS XLTX XLS XLSB MD XPS SXC HTML SVG MHTML TXT XLSM TIFF PDF XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to XLS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple CSV to XLS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert CSV to XLS" gistPath="" %}}
```java
