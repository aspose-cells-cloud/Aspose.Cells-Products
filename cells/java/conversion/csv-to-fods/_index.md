---
title: Convert CSV to FODS in the Cloud via Java 
...
outformat: FODS
platform: Java
otherformats: XLTM SXC XLSB XPS DIF TIFF XML PDF TSV SVG ODS MHTML TXT XLSM FODS MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to FODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple CSV to FODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert CSV to FODS" gistPath="" %}}
```java
