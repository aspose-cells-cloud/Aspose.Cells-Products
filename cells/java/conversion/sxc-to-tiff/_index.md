---
title: Convert SXC to TIFF in the Cloud via Java 
...
outformat: TIFF
platform: Java
otherformats: XLTX SXC FODS TXT TIFF PDF TSV XLSX XLSM HTML XML MHTML CSV XLTM MD XLSB 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to TIFF with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple SXC to TIFF Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert SXC to TIFF" gistPath="" %}}
```java
