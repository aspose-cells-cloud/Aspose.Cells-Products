---
title: Convert MHTML to XPS in the Cloud via Java 
...
outformat: XPS
platform: Java
otherformats: FODS TIFF XLTX DIF XLSB XML XPS TSV XLSX PDF TXT MD XLTM HTML SXC CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert MHTML to XPS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple MHTML to XPS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert MHTML to XPS" gistPath="" %}}
```java
