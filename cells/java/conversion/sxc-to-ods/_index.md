---
title: Convert SXC to ODS in the Cloud via Java 
...
outformat: ODS
platform: Java
otherformats: XPS XLS XLSX XML MHTML XLSM PDF TIFF CSV FODS SXC TXT TSV SVG XLT MD 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to ODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple SXC to ODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert SXC to ODS" gistPath="" %}}
```java
