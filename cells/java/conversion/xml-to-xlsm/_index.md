---
title: Convert XML to XLSM in the Cloud via Java 
...
outformat: XLSM
platform: Java
otherformats: CSV MHTML FODS SXC XLSX DIF PDF XPS TIFF TXT TSV MD XLTM XLSB XLSM XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to XLSM with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple XML to XLSM Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert XML to XLSM" gistPath="" %}}
```java
