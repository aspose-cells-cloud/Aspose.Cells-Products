---
title: Convert XLSM to XPS in the Cloud via Java 
...
outformat: XPS
platform: Java
otherformats: XLTX PDF ODS XML XPS DIF MHTML XLTM XLS MD SXC FODS SVG XLSX TXT TSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSM to XPS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple XLSM to XPS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert XLSM to XPS" gistPath="" %}}
```java
