---
title: Convert CSV to DIF in the Cloud via Java 
...
outformat: DIF
platform: Java
otherformats: XLSM XPS SXC XLSX TSV ODS XLT XLSB HTML XLTX XML DIF PDF FODS SVG MHTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CSV to DIF with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple CSV to DIF Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert CSV to DIF" gistPath="" %}}
```java
