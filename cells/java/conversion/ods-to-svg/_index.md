---
title: Convert ODS to SVG in the Cloud via Java 
...
outformat: SVG
platform: Java
otherformats: DIF XLSM XLSX XML XLT MD CSV PDF XLTX TSV XPS XLSB MHTML FODS XLTM SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to SVG with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple ODS to SVG Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert ODS to SVG" gistPath="" %}}
```java
