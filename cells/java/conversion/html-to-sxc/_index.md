---
title: Convert HTML to SXC in the Cloud via Java 
...
outformat: SXC
platform: Java
otherformats: MD DIF TIFF PDF XML XLTM XLSM XLTX SVG ODS SXC XPS XLSB TSV FODS CSV 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to SXC with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple HTML to SXC Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert HTML to SXC" gistPath="" %}}
```java
