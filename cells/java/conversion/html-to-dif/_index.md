---
title: Convert HTML to DIF in the Cloud via Java 
...
outformat: DIF
platform: Java
otherformats: XLT MD ODS TXT XLS TSV SXC XLTM DIF CSV XML FODS PDF MHTML TIFF XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to DIF with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple HTML to DIF Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert HTML to DIF" gistPath="" %}}
```java
