---
title: Convert SXC to XML in the Cloud via Java 
...
outformat: XML
platform: Java
otherformats: TSV XLS TIFF XLTM CSV XLSB MHTML PDF MD ODS SVG TXT XML FODS XPS XLSM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to XML with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple SXC to XML Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert SXC to XML" gistPath="" %}}
```java
