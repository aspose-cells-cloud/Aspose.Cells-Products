---
title: Convert XML to MD in the Cloud via Java 
...
outformat: MD
platform: Java
otherformats: MHTML ODS DIF SVG XLSX XPS XLSB XLTX PDF TXT CSV SXC TIFF TSV MD XLTM 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to MD with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple XML to MD Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert XML to MD" gistPath="" %}}
```java
