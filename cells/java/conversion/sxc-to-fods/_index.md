---
title: Convert SXC to FODS in the Cloud via Java 
...
outformat: FODS
platform: Java
otherformats: ODS MHTML XLSB XLT XLTX XLSX XLSM XLTM TSV SVG XPS PDF TIFF TXT MD SXC 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to FODS with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple SXC to FODS Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert SXC to FODS" gistPath="" %}}
```java
