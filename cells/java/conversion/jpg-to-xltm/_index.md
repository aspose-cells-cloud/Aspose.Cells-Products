---
title: Convert JPG to XLTM via Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert JPG to  XLTM in the Cloud" h2="Excel & OpenOffice spreadsheet conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JPG to XLTM Conversion in Cloud SDK for Java " %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for JPG to XLTM Conversion" gistPath="" %}}
```java
...
{{% blocks/products/cells/cells-cloud-api-run-conversion  inputformat=jpg  outputformat=xltm  %}}
