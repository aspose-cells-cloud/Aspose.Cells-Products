---
title: Convert ODS to XLT in the Cloud via Java 
...
outformat: XLT
platform: Java
otherformats: DIF XLSB SVG MD XPS TSV XLTM HTML SXC TIFF FODS MHTML CSV XLSM XML XLTX 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to XLT with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple ODS to XLT Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert ODS to XLT" gistPath="" %}}
```java
