---
title: Convert TXT to MHTML in the Cloud via Java 
...
outformat: MHTML
platform: Java
otherformats: XLSX XLT PDF XPS XLSB MHTML ODS XLTM SXC SVG TSV XML CSV MD TIFF DIF 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TXT to MHTML with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple TXT to MHTML Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert TXT to MHTML" gistPath="" %}}
```java
