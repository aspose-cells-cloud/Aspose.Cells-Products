---
title: Convert XML to DIF in the Cloud via Java 
...
outformat: DIF
platform: Java
otherformats: PDF TXT MD DIF XLSB XLT XPS SXC TIFF XLTM XLTX ODS XLSM XLSX FODS HTML 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XML to DIF with Java" h2="Automate Excel & OpenOffice file conversion with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Simple XML to DIF Conversion" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code to Convert XML to DIF" gistPath="" %}}
```java
